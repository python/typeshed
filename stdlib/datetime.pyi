...
class datetime(date):
    ...
    def fold(self) -> int: ...
    @classmethod
    def fromtimestamp(cls: Type[_S], t: float, tz: Optional[tzinfo] = ...) -> _S: ...
    @classmethod
    ...
    if sys.version_info >= (3, 8):
        @classmethod
        def now(cls: Type[_S], tz: Optional[tzinfo] = ...) -> _S: ...
    else:
        @overload
        @classmethod
    ...
    @classmethod
    def combine(cls, date: _date, time: _time, tzinfo: Optional[tzinfo] = ...) -> datetime: ...
    if sys.version_info >= (3, 7):
        @classmethod
        def fromisoformat(cls: Type[_S], date_string: str) -> _S: ...
    def strftime(self, fmt: str) -> str: ...
