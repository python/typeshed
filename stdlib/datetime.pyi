...
class tzinfo:
    ...
    @abstractmethod
    @overload
    def utcoffset(self, __dt: time | None) -> timedelta | None: ...
    @abstractmethod
    def dst(self, __dt: datetime | time | None) -> timedelta | None: ...
...
class timezone(tzinfo):
    ...
    def tzname(self, __dt: datetime | time | None) -> str: ...
    def utcoffset(self, __dt: datetime | time | None) -> timedelta: ...
    def dst(self, __dt: datetime | time | None) -> None: ...
