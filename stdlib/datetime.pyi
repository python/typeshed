...
class datetime(date):
    ...
    @property
    def fold(self) -> int: ...
    # The parameters in `fromtimestamp` are actually both positional-or-keyword parameters,
    # but the first parameter is named "timestamp" in the C implementation and "t" in the Python implementation,
    # so it is only truly *safe* to pass it as a positional argument.
    @classmethod
    def fromtimestamp(cls: Type[_S], __timestamp: float, __tz: _tzinfo | None = ...) -> _S: ...
    @classmethod
