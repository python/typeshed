...
class datetime(date, Generic[_TzInfoT]):
    ...
    def dst(self) -> timedelta | None: ...
    @overload  # type: ignore[override]
    def __le__(self: datetime[_TzInfo], value: datetime[None], /) -> NoReturn: ...
    @overload
    def __le__(self: datetime[None], value: datetime[_TzInfo], /) -> NoReturn: ...
    @overload
    def __le__(self: datetime[Any], value: datetime[Any], /) -> bool: ...
    @overload  # type: ignore[override]
    def __lt__(self: datetime[_TzInfo], value: datetime[None], /) -> NoReturn: ...
    @overload
    def __lt__(self: datetime[None], value: datetime[_TzInfo], /) -> NoReturn: ...
    @overload
    def __lt__(self: datetime[Any], value: datetime[Any], /) -> bool: ...
    @overload  # type: ignore[override]
    def __ge__(self: datetime[_TzInfo], value: datetime[None], /) -> NoReturn: ...
    @overload
    def __ge__(self: datetime[None], value: datetime[_TzInfo], /) -> NoReturn: ...
    @overload
    def __ge__(self: datetime[Any], value: datetime[Any], /) -> bool: ...
    @overload  # type: ignore[override]
    def __gt__(self: datetime[_TzInfo], value: datetime[None], /) -> NoReturn: ...
    @overload
    def __gt__(self: datetime[None], value: datetime[_TzInfo], /) -> NoReturn: ...
    @overload
