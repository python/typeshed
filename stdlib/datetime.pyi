...
class time(Generic[TzT]):
    ...
    @property
    def tzinfo(self) -> TzT | None: ...
    @property
    def fold(self) -> int: ...
    def __le__(self, __value: time[TzT]) -> bool: ...
    def __lt__(self, __value: time[TzT]) -> bool: ...
    def __ge__(self, __value: time[TzT]) -> bool: ...
    def __gt__(self, __value: time[TzT]) -> bool: ...
    def __eq__(self, __value: object) -> bool: ...
    def __hash__(self) -> int: ...
...
class datetime(date, Generic[TzT]):
    ...
    if sys.version_info >= (3, 12):
        @classmethod
        def fromtimestamp(cls, timestamp: float, tz: TzT = ...) -> Self: ...
    else:
        @classmethod
        def fromtimestamp(cls, __timestamp: float, tz: TzT = ...) -> Self: ...

    @classmethod
    def utcfromtimestamp(cls, __t: float) -> datetime[None]: ...
    if sys.version_info >= (3, 8):
        @classmethod
        def now(cls, tz: TzT = None) -> Self: ...  # type: ignore
    else:
        @overload
        @classmethod
        ...
        @overload
        @classmethod
        def now(cls, tz: TzT) -> datetime[TzT]: ...

    @classmethod
    def utcnow(cls) -> Self: ...
    @classmethod
    def combine(cls, date: _Date, time: _Time, tzinfo: TzT = ...) -> Self: ...
    ...
    def tzname(self) -> str | None: ...
    def dst(self) -> timedelta | None: ...
    def __le__(self, __value: datetime[TzT]) -> bool: ...  # type: ignore[override]
    def __lt__(self, __value: datetime[TzT]) -> bool: ...  # type: ignore[override]
    def __ge__(self, __value: datetime[TzT]) -> bool: ...  # type: ignore[override]
    def __gt__(self, __value: datetime[TzT]) -> bool: ...  # type: ignore[override]
    def __eq__(self, __value: object) -> bool: ...
    def __hash__(self) -> int: ...
    if sys.version_info >= (3, 8):
        ...
        def __add__(self, __value: timedelta) -> datetime[TzT]: ...
        def __radd__(self, __value: timedelta) -> datetime[TzT]: ...
        @overload  # type: ignore[override]
        def __sub__(self, __value: datetime) -> timedelta: ...
        @overload
        def __sub__(self, __value: timedelta) -> datetime[TzT]: ...
