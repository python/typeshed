...
@overload
def mkstemp(suffix: None = ..., prefix: None = ..., dir: None = ..., text: bool = ...) -> tuple[int, str]: ...
@overload
def mkstemp(
    suffix: AnyStr, prefix: AnyStr | None = ..., dir: _DirT[AnyStr] | None = ..., text: bool = ...
) -> tuple[int, AnyStr]: ...
@overload
def mkstemp(*, prefix: AnyStr, dir: _DirT[AnyStr] | None = ..., text: bool = ...) -> tuple[int, AnyStr]: ...
@overload
def mkstemp(*, dir: _DirT[AnyStr], text: bool = ...) -> tuple[int, AnyStr]: ...
@overload
...
@overload
def mktemp(suffix: None = ..., prefix: None = ..., dir: None = ...) -> str: ...
@overload
def mktemp(suffix: AnyStr, prefix: AnyStr | None = ..., dir: _DirT[AnyStr] | None = ...) -> AnyStr: ...
@overload
def mktemp(*, prefix: AnyStr, dir: _DirT[AnyStr] | None = ...) -> AnyStr: ...
@overload
def mktemp(*, dir: _DirT[AnyStr]) -> AnyStr: ...
