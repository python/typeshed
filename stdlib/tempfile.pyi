...
# The overloads are overlapping according to mypy, but they should still work fine.
@overload
...
# The overloads are overlapping according to mypy, but they should still work fine.
@overload
def mkdtemp(  # type: ignore[misc]
    suffix: str | None = ..., prefix: str | None = ..., dir: _DirT[str] | None = ...
) -> str: ...
@overload
