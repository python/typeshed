...
@overload
def mkstemp(suffix: str | None, prefix: str | None = ..., dir: _DirT[str] | None = ..., text: bool = ...) -> tuple[int, str]: ...
@overload
def mkstemp(
...
@overload
def mkdtemp(suffix: str | None = ..., prefix: str | None = ..., dir: _DirT[str] | None = ...) -> str: ...
@overload
