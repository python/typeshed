...
class BaseSelector(metaclass=ABCMeta):
    @abstractmethod
    def register(self, fileobj: FileObject, events: EventMask, data: Optional[Any] = None) -> SelectorKey: ...

    @abstractmethod
    def unregister(self, fileobj: FileObject) -> SelectorKey: ...

    def modify(self, fileobj: FileObject, events: EventMask, data: Optional[Any] = None) -> SelectorKey: ...
    ...
    def __exit__(self, *args: Optional[Any]) -> None: ...
