...
class IPv4Network(_BaseV4, _BaseNetwork):
    ...
    def __init__(self, address: Any, strict: bool = ...) -> None: ...
    @property
...
def ip_address(address: Any) -> _ip_address: ...
def ip_network(address: Any, strict: bool = ...) -> _ip_network: ...
def ip_interface(address: Any) -> _ip_interface: ...
