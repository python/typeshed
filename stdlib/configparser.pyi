...
class RawConfigParser(_parser):
    ...
    def read(self, filenames: _Path | Iterable[_Path], encoding: Optional[str] = ...) -> List[str]: ...
...
class SectionProxy(MutableMapping[str, str]):
    ...
    @overload
    def getint(self, option: str, fallback: _T = ..., *, raw: bool = ..., vars: Optional[_section] = ...) -> int | _T: ...
    @overload
