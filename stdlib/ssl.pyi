...
class SSLContext:
    ...
    def __new__(cls: type[Self], protocol: int = None, *args: Any, **kwargs: Any) -> Self: ...
    ...
    def load_verify_locations(
        self, cafile: StrOrBytesPath | None = None, capath: StrOrBytesPath | None = None, cadata: str | ReadableBuffer | None = None
    ) -> None: ...
    @overload
