...
_SrvnmeCbType = Callable[[SSLSocket | SSLObject, Optional[str], SSLSocket], Optional[int]]
...
class SSLSocket(socket.socket):
    ...
    @overload
    def sendto(self, data: bytes, flags_or_addr: int | socket._Address, addr: Optional[socket._Address] = ...) -> int: ...
...
class SSLContext:
    ...
    if sys.version_info >= (3, 7):
        sni_callback: Optional[Callable[[SSLObject, str, SSLContext], None | int]]
...
class SSLObject:
    ...
    if sys.version_info >= (3, 7):
        ...
        def __init__(
            self, sslobj: Any, owner: Optional[SSLSocket | SSLObject] = ..., session: Optional[Any] = ...
        ) -> None: ...
    def read(self, len: int = ..., buffer: Optional[bytearray] = ...) -> bytes: ...
    def write(self, data: bytes) -> int: ...
    @overload
