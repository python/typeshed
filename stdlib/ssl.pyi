...
class SSLSocket(socket.socket):
    ...
    @overload
    def sendto(
        self, data: ReadableBuffer, flags_or_addr: int | socket._Address, addr: socket._Address | None = ...
    ) -> int: ...
...
class SSLContext:
    ...
    def load_cert_chain(
        self, certfile: StrPath, keyfile: StrPath | None = ..., password: _PasswordType | None = ...
    ) -> None: ...
...
class SSLObject:
    ...
    if sys.version_info >= (3, 7):
        ...
        def __init__(
            self, sslobj: Any, owner: SSLSocket | SSLObject | None = ..., session: Any | None = ...
        ) -> None: ...
    def read(self, len: int = ..., buffer: bytearray | None = ...) -> bytes: ...
    def write(self, data: bytes) -> int: ...
    @overload
