...
from typing import Any, AnyStr, Callable, Iterator, RegexString, Union, overload
...
@overload
def split(
    pattern: Pattern[RegexString], string: RegexString, maxsplit: int = ..., flags: _FlagsType = ...
) -> list[RegexString | Any]: ...
@overload
...
@overload
def sub(
    pattern: RegexString, repl: RegexString, string: RegexString, count: int = ..., flags: _FlagsType = ...
) -> RegexString: ...
@overload
def sub(
    pattern: RegexString,
    repl: Callable[[Match[RegexString]], RegexString],
    string: RegexString,
    count: int = ...,
    flags: _FlagsType = ...,
) -> RegexString: ...
