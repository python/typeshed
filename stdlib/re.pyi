...
class Pattern(Generic[AnyStr]):
    ...
    @overload
    def search(self: Pattern[bytes], string: ReadableBuffer, pos: int = 0, endpos: int = 9223372036854775807) -> Match[bytes] | None: ...
    @overload
    def match(self: Pattern[str], string: str, pos: int = 0, endpos: int = 9223372036854775807) -> Match[str] | None: ...
    @overload
    def match(self: Pattern[bytes], string: ReadableBuffer, pos: int = 0, endpos: int = 9223372036854775807) -> Match[bytes] | None: ...
    @overload
    def fullmatch(self: Pattern[str], string: str, pos: int = 0, endpos: int = 9223372036854775807) -> Match[str] | None: ...
    @overload
    def fullmatch(self: Pattern[bytes], string: ReadableBuffer, pos: int = 0, endpos: int = 9223372036854775807) -> Match[bytes] | None: ...
    @overload
    ...
    @overload
    def finditer(self: Pattern[bytes], string: ReadableBuffer, pos: int = 0, endpos: int = 9223372036854775807) -> Iterator[Match[bytes]]: ...
    @overload
