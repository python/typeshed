...
class Packer:
    ...
    def pack_list(self, list: Sequence[_T], pack_item: Callable[[_T], Any]) -> None: ...
    def pack_farray(self, n: int, list: Sequence[_T], pack_item: Callable[[_T], Any]) -> None: ...
    def pack_array(self, list: Sequence[_T], pack_item: Callable[[_T], Any]) -> None: ...
