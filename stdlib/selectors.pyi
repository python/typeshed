...
# Not a real class in runtime, it is just a conditional alias to other real selectors.
# But, since it depends on the platform, we cannot express this in stubs.
