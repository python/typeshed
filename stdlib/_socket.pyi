...
if sys.platform != "win32" and sys.platform != "darwin":
    IPPROTO_BIP: Final[int]
    IPPROTO_MOBILE: Final[int]
    IPPROTO_VRRP: Final[int]
...
if sys.platform == "linux":
    ...
    AF_VSOCK: Final[int]
    IOCTL_VM_SOCKETS_GET_LOCAL_CID: Final[int]
    VMADDR_CID_ANY: Final[int]
    VMADDR_CID_HOST: Final[int]
    VMADDR_PORT_ANY: Final[int]
    SO_VM_SOCKETS_BUFFER_MAX_SIZE: Final[int]
    SO_VM_SOCKETS_BUFFER_SIZE: Final[int]
    SO_VM_SOCKETS_BUFFER_MIN_SIZE: Final[int]
    VM_SOCKETS_INVALID_VERSION: Final[int]  # undocumented
...
if sys.platform != "darwin":
    if sys.platform != "win32" or sys.version_info >= (3, 9):
        BDADDR_ANY: Final[str]
        BDADDR_LOCAL: Final[str]
...
if sys.version_info >= (3, 12) and sys.platform == "win32":
    ...
    HV_GUID_ZERO: Final[str]
    HV_GUID_WILDCARD: Final[str]
    HV_GUID_BROADCAST: Final[str]
    HV_GUID_CHILDREN: Final[str]
    HV_GUID_LOOPBACK: Final[str]
    HV_GUID_PARENT: Final[str]
...
if sys.platform == "linux":
    ...
    NETLINK_ROUTE6: Final[int]
    NETLINK_ROUTE: Final[int]
    NETLINK_SKIP: Final[int]
    NETLINK_TAPBASE: Final[int]
    NETLINK_TCPDIAG: Final[int]
    NETLINK_USERSOCK: Final[int]
    NETLINK_W1: Final[int]
