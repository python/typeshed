...
if sys.platform == "win32":
    ...
    if sys.version_info >= (3, 13):
        STARTF_FORCEOFFFEEDBACK: Final = 0x00000080
        STARTF_FORCEONFEEDBACK: Final = 0x00000040
        STARTF_RUNFULLSCREEN: Final = 0x00000020
        STARTF_TITLEISAPPID: Final = 0x00001000
        STARTF_TITLEISLINKNAME: Final = 0x00000800
        STARTF_UNTRUSTEDSOURCE: Final = 0x00008000
        STARTF_USECOUNTCHARS: Final = 0x00000008
        STARTF_USEFILLATTRIBUTE: Final = 0x00000010
        STARTF_USEHOTKEY: Final = 0x00000200
        STARTF_USEPOSITION: Final = 0x00000004
        STARTF_USESIZE: Final = 0x00000002
        STARTF_USESHOWWINDOW: Final = 0x00000001
