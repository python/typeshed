...
class Counter(dict[_T, int], Generic[_T]):
    ...
    def __iadd__(self, other: Mapping[_T, int]) -> Self: ...  # type: ignore[misc]
    def __isub__(self, other: Mapping[_T, int]) -> Self: ...
    def __iand__(self, other: Mapping[_T, int]) -> Self: ...
    def __ior__(self, other: Mapping[_T, int]) -> Self: ...  # type: ignore[override,misc]
    if sys.version_info >= (3, 10):
        def total(self) -> int: ...
