...
class Counter(dict[_T, int], Generic[_T]):
    ...
    # The Iterable[Tuple[...]] overload from dict.update()
    # is omitted from the stub, as it is undesirable
    ...
    def __sub__(self, other: Counter[object]) -> Counter[_T]: ...
    def __and__(self, other: Counter[object]) -> Counter[_T]: ...
    def __or__(self, other: Counter[_S]) -> Counter[_T | _S]: ...  # type: ignore[override]
    def __pos__(self) -> Counter[_T]: ...
    def __neg__(self) -> Counter[_T]: ...
    # Many type: ignores because __iadd__ is supposedly incompatible with __add__, etc.
    def __iadd__(self: Self, other: Counter[_T]) -> Self: ...  # type: ignore[misc]
    def __isub__(self: Self, other: Counter[_T]) -> Self: ...  # type: ignore[misc]
    def __iand__(self: Self, other: Counter[_T]) -> Self: ...  # type: ignore[misc]
