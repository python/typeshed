...
class deque(MutableSequence[_T], Generic[_T]):
    ...
    def __reduce__(self) -> tuple[type[deque], tuple[()], None, Iterator[_T]]: ...
    def __reversed__(self) -> Iterator[_T]: ...
    def __iadd__(self: _S, __iterable: Iterable[_T]) -> _S: ...
    def __add__(self, __other: deque[_T]) -> deque[_T]: ...
    def __mul__(self, __other: int) -> deque[_T]: ...
    def __imul__(self, __other: int) -> None: ...
