...
from _typeshed import IterableOrSupportsIntGetItem, Self, SupportsKeysAndGetItem, SupportsRichComparison, SupportsRichComparisonT
...
def namedtuple(
    typename: str,
    field_names: str | IterableOrSupportsIntGetItem[str],
    *,
    rename: bool = ...,
    module: str | None = ...,
    defaults: IterableOrSupportsIntGetItem[Any] | None = ...,
) -> type[tuple[Any, ...]]: ...
...
class UserDict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(self: UserDict[str, _VT], __iterable: IterableOrSupportsIntGetItem[tuple[str, _VT]], **kwargs: _VT) -> None: ...
    @overload
    def __init__(self: UserDict[str, str], __iterable: IterableOrSupportsIntGetItem[list[str]]) -> None: ...
    ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: IterableOrSupportsIntGetItem[_T], value: None = ...) -> UserDict[_T, Any | None]: ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: IterableOrSupportsIntGetItem[_T], value: _S) -> UserDict[_T, _S]: ...
    if sys.version_info >= (3, 9):
        ...
        @overload
        def __ior__(self: Self, other: IterableOrSupportsIntGetItem[tuple[_KT, _VT]]) -> Self: ...
...
class UserList(MutableSequence[_T]):
    ...
    @overload
    def __init__(self, initlist: IterableOrSupportsIntGetItem[_T]) -> None: ...
    ...
    @overload
    def __setitem__(self, i: slice, item: IterableOrSupportsIntGetItem[_T]) -> None: ...
    def __delitem__(self, i: SupportsIndex | slice) -> None: ...
    def __add__(self: Self, other: IterableOrSupportsIntGetItem[_T]) -> Self: ...
    def __radd__(self: Self, other: IterableOrSupportsIntGetItem[_T]) -> Self: ...
    def __iadd__(self: Self, other: IterableOrSupportsIntGetItem[_T]) -> Self: ...
    ...
    def extend(self, other: IterableOrSupportsIntGetItem[_T]) -> None: ...
...
class UserString(Sequence[UserString]):
    ...
    def join(self, seq: IterableOrSupportsIntGetItem[str]) -> str: ...
...
class deque(MutableSequence[_T], Generic[_T]):
    ...
    @overload
    def __init__(self, iterable: IterableOrSupportsIntGetItem[_T], maxlen: int | None = ...) -> None: ...
    ...
    def extendleft(self, __iterable: IterableOrSupportsIntGetItem[_T]) -> None: ...
    ...
    def __iadd__(self: Self, __iterable: IterableOrSupportsIntGetItem[_T]) -> Self: ...
...
class Counter(dict[_T, int], Generic[_T]):
    ...
    @overload
    def subtract(self, __iterable: IterableOrSupportsIntGetItem[_T]) -> None: ...
    ...
    # (if it were `IterableOrSupportsIntGetItem[_T] | IterableOrSupportsIntGetItem[tuple[_T, int]]`,
    # the tuples would be added as keys, breaking type safety)
    @overload  # type: ignore[override]
    def update(self, __m: Mapping[_T, int], **kwargs: int) -> None: ...
    @overload
    def update(self, __m: IterableOrSupportsIntGetItem[_T], **kwargs: int) -> None: ...
    @overload
...
class OrderedDict(dict[_KT, _VT], Reversible[_KT], Generic[_KT, _VT]):
    ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: IterableOrSupportsIntGetItem[_T], value: None = ...) -> OrderedDict[_T, Any | None]: ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: IterableOrSupportsIntGetItem[_T], value: _S) -> OrderedDict[_T, _S]: ...
...
class defaultdict(dict[_KT, _VT], Generic[_KT, _VT]):
    ...
    def __init__(
        self: defaultdict[str, _VT],
        __default_factory: Callable[[], _VT] | None,
        __iterable: IterableOrSupportsIntGetItem[tuple[str, _VT]],
        **kwargs: _VT,
    ) -> None: ...
...
class ChainMap(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: IterableOrSupportsIntGetItem[_T], __value: None = ...) -> ChainMap[_T, Any | None]: ...
    @classmethod
    @overload
    def fromkeys(cls, __iterable: IterableOrSupportsIntGetItem[_T], __value: _S) -> ChainMap[_T, _S]: ...
    if sys.version_info >= (3, 9):
