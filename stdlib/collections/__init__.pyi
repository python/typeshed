...
class UserString(Sequence[str]):
    ...
    def endswith(self, suffix: str | Tuple[str, ...], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
    ...
    @staticmethod
    @overload
    def maketrans(x: Union[Dict[int, _T], Dict[str, _T], Dict[str | int, _T]]) -> Dict[int, _T]: ...
    @staticmethod
    @overload
    ...
    def replace(
        self: _UserStringT, old: str | UserString, new: str | UserString, maxsplit: int = ...
    ) -> _UserStringT: ...
    ...
    def startswith(self, prefix: str | Tuple[str, ...], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
