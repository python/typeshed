...
class UserString(Sequence[str]):
    ...
    def __getitem__(self: _UserStringT, i: int | slice) -> _UserStringT: ...
    def __iter__(self: _UserStringT) -> Iterator[_UserStringT]: ...
    def __reversed__(self: _UserStringT) -> Iterator[_UserStringT]: ...
