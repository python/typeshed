...
if sys.version_info >= (3, 12):
    def nextafter(__x: _SupportsFloatOrIndex, __y: _SupportsFloatOrIndex, *, steps_after: int | None = None) -> float: ...
...
if sys.version_info >= (3, 12):
    def sumprod(__p: Iterable[_SupportsFloatOrIndex], __q: Iterable[_SupportsFloatOrIndex]) -> float: ...
