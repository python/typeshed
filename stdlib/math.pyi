...
@overload
def prod(iterable: Iterable[Never], /, *, start: Literal[1] = 1) -> Literal[1]: ...
@overload
def prod(iterable: Iterable[Never], /, *, start: _T_SupportsFloatOrIndex = 1) -> _T_SupportsFloatOrIndex: ...
@overload
def prod(iterable: Iterable[_T_SupportsFloatOrIndex], /, *, start: _T_SupportsFloatOrIndex = 1) -> _T_SupportsFloatOrIndex: ...
