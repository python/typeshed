...
class Bytecode:
    ...
    first_line: int
    def __init__(
        self, x: _have_code_or_string, *, first_line: int | None = ..., current_offset: int | None = ...
    ) -> None: ...
...
if sys.version_info >= (3, 7):
    def dis(x: _have_code_or_string | None = ..., *, file: Optional[IO[str]] = ..., depth: int | None = ...) -> None: ...

else:
    def dis(x: _have_code_or_string | None = ..., *, file: Optional[IO[str]] = ...) -> None: ...

def distb(tb: types.TracebackType | None = ..., *, file: Optional[IO[str]] = ...) -> None: ...
