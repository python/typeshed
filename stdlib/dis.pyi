...
if sys.version_info >= (3, 11):
    def disassemble(
        co: _HaveCodeType, lasti: int = ..., *, file: IO[str] | None = None, show_caches: bool = False, adaptive: bool = False
    ) -> None: ...
    def disco(
        co: _HaveCodeType, lasti: int = ..., *, file: IO[str] | None = None, show_caches: bool = False, adaptive: bool = False
    ) -> None: ...
    ...
    def disassemble(co: _HaveCodeType, lasti: int = ..., *, file: IO[str] | None = None) -> None: ...
    def disco(co: _HaveCodeType, lasti: int = ..., *, file: IO[str] | None = None) -> None: ...
