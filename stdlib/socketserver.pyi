...
class BaseServer:
    ...
    socket_type: int
    timeout: float | None
    def __init__(self, server_address: Any, RequestHandlerClass: _RequestHandlerClassCallable) -> None: ...
    def fileno(self) -> int: ...
...
class TCPServer(BaseServer):
    ...
    request_queue_size: int
    def __init__(
        self, server_address: tuple[str, int], RequestHandlerClass: _RequestHandlerClassCallable, bind_and_activate: bool = ...
    ) -> None: ...
...
if sys.platform != "win32":
    class UnixStreamServer(BaseServer):
        def __init__(
            self, server_address: str | bytes, RequestHandlerClass: _RequestHandlerClassCallable, bind_and_activate: bool = ...
        ) -> None: ...
