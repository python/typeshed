...
class TCPServer(BaseServer):
    ...
    def finish_request(self, request: SocketType, client_address: Any) -> None: ...
    def handle_error(self, request: SocketType, client_address: Any) -> None: ...
    def process_request(self, request: SocketType, client_address: Any) -> None: ...
    def verify_request(self, request: SocketType, client_address: Any) -> bool: ...
...
class UDPServer(BaseServer):
    ...
    def finish_request(self, request: Tuple[bytes, SocketType], client_address: Any) -> None: ...
    def handle_error(self, request: Tuple[bytes, SocketType], client_address: Any) -> None: ...
    def process_request(self, request: Tuple[bytes, SocketType], client_address: Any) -> None: ...
    def verify_request(self, request: Tuple[bytes, SocketType], client_address: Any) -> bool: ...
...
class ThreadingMixIn:
    ...
    if sys.version_info >= (3, 7):
        block_on_close: bool
    def process_request_thread(self, request: Any, client_address: Any) -> None: ...  # undocumented
    def process_request(self, request: Any, client_address: Any) -> None: ...
    def server_close(self) -> None: ...
