...
def decimal(__chr: str, __default: _T = None) -> int | _T: ...
def decomposition(__chr: str) -> str: ...
def digit(__chr: str, __default: _T = None) -> int | _T: ...
...
def name(__chr: str, __default: _T = None) -> str | _T: ...
def normalize(__form: str, __unistr: str) -> str: ...
def numeric(__chr: str, __default: _T = None) -> float | _T: ...
@final
class UCD:
    ...
    def decimal(self, __chr: str, __default: _T = None) -> int | _T: ...
    def decomposition(self, __chr: str) -> str: ...
    def digit(self, __chr: str, __default: _T = None) -> int | _T: ...
    ...
    def name(self, __chr: str, __default: _T = None) -> str | _T: ...
    def normalize(self, __form: str, __unistr: str) -> str: ...
    def numeric(self, __chr: str, __default: _T = None) -> float | _T: ...
