...
class c_char_p(_PointerLike, _SimpleCData[Union[bytes, None]]):
...
class c_void_p(_PointerLike, _SimpleCData[Union[int, None]]): ...
class c_wchar(_SimpleCData[str]): ...

class c_wchar_p(_PointerLike, _SimpleCData[Union[str, None]]):
