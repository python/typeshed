...
def get_path(name: str, scheme: str = 'nt', vars: dict[str, Any] | None = None, expand: bool = True) -> str: ...
def get_paths(scheme: str = 'nt', vars: dict[str, Any] | None = None, expand: bool = True) -> dict[str, str]: ...
