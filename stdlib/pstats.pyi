...
_Func: TypeAlias = tuple[str, int, str]

def func_strip_path(func_name: _Func) -> _Func: ...
def func_get_function_name(func: _Func) -> str: ...
def func_std_string(func_name: _Func) -> str: ...

_Callers: TypeAlias = dict[_Func, tuple[int, int, int, int]]
_StatVal: TypeAlias = tuple[int, int, int, int, _Callers]

def add_func_stats(target: _StatVal, source: _StatVal) -> _StatVal: ...
def add_callers(target: _Callers, source: _Callers) -> _Callers: ...
def count_calls(callers: _Callers) -> int: ...
