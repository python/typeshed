...
if sys.version_info >= (3, 13):
    ...
    @overload
    def open_text(anchor: Anchor, path_names: StrPath, encoding: str = "utf-8", errors: str = "strict") -> TextIO: ...
    @overload
    ...
    @overload
    def read_text(anchor: Anchor, path_names: StrPath, encoding: str = "utf-8", errors: str = "strict") -> str: ...
    @overload
