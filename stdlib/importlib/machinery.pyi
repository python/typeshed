...
class PathFinder:
    ...
    @classmethod
    def find_spec(
        cls, fullname: str, path: Optional[Sequence[bytes | str]] = ..., target: Optional[types.ModuleType] = ...
    ) -> Optional[ModuleSpec]: ...
    @classmethod
    def find_module(cls, fullname: str, path: Optional[Sequence[bytes | str]] = ...) -> Optional[importlib.abc.Loader]: ...
