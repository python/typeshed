...
class BuiltinImporter(importlib.abc.MetaPathFinder, importlib.abc.InspectLoader):
    ...
    @classmethod
    def find_spec(
        cls, fullname: str, path: Optional[Sequence[importlib.abc._Path]] = ..., target: types.ModuleType | None = ...
    ) -> ModuleSpec | None: ...
    # InspectLoader
    @classmethod
...
class PathFinder:
    ...
    @classmethod
    def find_spec(
        cls, fullname: str, path: Optional[Sequence[bytes | str]] = ..., target: types.ModuleType | None = ...
    ) -> ModuleSpec | None: ...
    @classmethod
    def find_module(cls, fullname: str, path: Optional[Sequence[bytes | str]] = ...) -> importlib.abc.Loader | None: ...
