...
class socket:
    ...
    if sys.version_info >= (3, 3):
        def recvmsg(self, __bufsize: int, __ancbufsize: Optional[int] = ...,
                    __flags: Optional[int] = ...) -> Tuple[bytes, List[_CMSG], int, Any]: ...
        def recvmsg_into(self, __buffers: Iterable[bytearray], __ancbufsize: Optional[int] = ...,
                         __flags: Optional[int] = ...) -> Tuple[int, List[_CMSG], int, Any]: ...
        def sendmsg(self, __buffers: Iterable[bytes], __ancdata: Optional[Iterable[_CMSG]] = ...,
                    __flags: Optional[int] = ..., __address: Optional[Any] = ...) -> int: ...
