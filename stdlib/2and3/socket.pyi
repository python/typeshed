...
class socket:
    ...
    if sys.version_info >= (3, 3):
        @overload
        def recvmsg(self, bufsize: int) -> Tuple[bytes, List[_CMSG], int, Any]: ...
        @overload
        def recvmsg(self, bufsize: int, ancbufsize: int) -> Tuple[bytes, List[_CMSG], int, Any]: ...
        @overload
        def recvmsg(self, bufsize: int, ancbufsize: int, flags: int) -> Tuple[bytes, List[_CMSG], int, Any]: ...
        @overload
        def recvmsg_into(self, buffers: Iterable[bytearray]) -> Tuple[int, List[_CMSG], int, Any]: ...
        @overload
        def recvmsg_into(self, buffers: Iterable[bytearray], ancbufsize: int) -> Tuple[int, List[_CMSG], int, Any]: ...
        @overload
        def recvmsg_into(self, buffers: Iterable[bytearray], ancbufsize: int, flags: int) -> Tuple[int, List[_CMSG], int, Any]: ...
        @overload
        def sendmsg(self, buffers: Iterable[bytes]) -> int: ...
        @overload
        def sendmsg(self, buffers: Iterable[bytes], ancdata: Iterable[_CMSG]) -> int: ...
        @overload
        def sendmsg(self, buffers: Iterable[bytes], ancdata: Iterable[_CMSG], flags: int) -> int: ...
        @overload
        def sendmsg(self, buffers: Iterable[bytes], ancdata: Iterable[_CMSG], flags: int, address: Any) -> int: ...
