...
import sys
from typing import IO, Any, Dict as DictT, Mapping, MutableMapping, Optional, Type, TypeVar, Union
...
if sys.version_info >= (3, 4):
    ...
    def loads(
        data: bytes, *, fmt: Optional[PlistFormat] = ..., use_builtin_types: bool = ..., dict_type: Type[_D] = ...
    ) -> _D: ...
    def dump(
