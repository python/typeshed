...
if sys.version_info >= (3, 9):
    ...
    def load(fp: IO[bytes], *, fmt: Optional[PlistFormat] = ..., use_builtin_types: bool = ..., dict_type: Type[_D]) -> Any: ...
    def loads(value: bytes, *, fmt: Optional[PlistFormat] = ..., use_builtin_types: bool = ..., dict_type: Type[_D]) -> Any: ...
