from typing import List, Tuple, Optional, Callable, Any, Protocol, Union, Dict
...
class XMLParserType:
    def Parse(self, data: Union[str, bytes], isfinal: bool = ...) -> int: ...
    ...
    def ExternalEntityParserCreate(self, context: Optional[str], encoding: str = ...) -> XMLParserType: ...
...
def ParserCreate(encoding: Optional[str] = ..., namespace_separator: Optional[str] = ...) -> XMLParserType: ...
