...
_CTT = TypeVar('_CTT', bound=Type[_CData])
...
class _CData:
    ...
    @classmethod
    def from_buffer(cls: _CTT, source: bytearray, offset: int) -> _CTT: ...
    @classmethod
    def from_buffer_copy(cls: _CTT, source: bytearray, offset: int) -> _CTT: ...
    @classmethod
    def from_address(cls: _CTT, address: int) -> _CTT: ...
    @classmethod
    def from_param(cls: _CTT, obj: Any) -> UnionT[_CTT, _cparam]: ...
    @classmethod
    def in_dll(cls: _CTT, library: str, name: _DLL) -> _CTT: ...
