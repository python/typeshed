...
_CVoidPLike = _UnionT[_PointerLike, Array[Any], _cparam, int, bytes]
...
def memmove(dst: _CVoidPLike, src: _CVoidPLike, count: int) -> None: ...
...
def string_at(address: _CVoidPLike, size: int = ...) -> bytes: ...
if sys.platform == 'win32':
    def WinError(code: Optional[int] = ...,
                 desc: Optional[str] = ...) -> OSError: ...
def wstring_at(address: _CVoidPLike, size: int = ...) -> str: ...
