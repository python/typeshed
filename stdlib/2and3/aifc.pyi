...
from typing import Union, IO, Optional, Type, NamedTuple, List, Tuple, Any, Text
...
class Aifc_read:
    ...
    def getmarkers(self) -> Optional[List[_M]]: ...
    def getmark(self, id: int) -> _M: ...
...
def open(f: _F, mode: Text = ...) -> Union[Aifc_read, Aifc_write]: ...
def openfp(f: _F, mode: Text = ...) -> Union[Aifc_read, Aifc_write]: ...
