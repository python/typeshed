...
class FTP:
    ...
    def retrbinary(self, cmd: Text, callback: Union[Callable[bytes, Any], Callable[str, Any]], blocksize: int = ..., rest: Optional[_IntOrStr] = ...) -> str: ...
    def storbinary(self, cmd: Text, fp: BinaryIO, blocksize: int = ..., callback: Optional[Union[Callable[bytes, Any], Callable[str, Any]]] = ..., rest: Optional[_IntOrStr] = ...) -> str: ...
