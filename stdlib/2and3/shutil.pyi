...
def copyfileobj(fsrc: _Reader[AnyStr], fdst: _Writer[AnyStr], length: int = ...) -> None: ...

if sys.version_info >= (3,):
    def copyfile(src: _Path, dst: _AnyPath, *, follow_symlinks: bool = ...) -> _AnyPath: ...
    ...
    def copy2(src: _Path, dst: _Path, *, follow_symlinks: bool = ...) -> _PathReturn: ...
...
if sys.version_info >= (3,):
    ...
    def copytree(src: AnyStr, dst: AnyStr, symlinks: bool = ..., ignore: _IgnoreFn = ...) -> _PathReturn: ...

if sys.version_info >= (3,):
    @overload
    def rmtree(path: bytes, ignore_errors: bool = ..., onerror: Optional[Callable[[Any, str, Any], Any]] = ...) -> None: ...
    @overload
    def rmtree(
...
if sys.version_info >= (3,):
    _ntuple_diskusage = NamedTuple("usage", [("total", int), ("used", int), ("free", int)])
    def disk_usage(path: _Path) -> _ntuple_diskusage: ...
    def chown(path: _Path, user: Optional[str] = ..., group: Optional[str] = ...) -> None: ...
...
if sys.version_info >= (3,):
    ...
    def unpack_archive(filename: str, extract_dir: Optional[_Path] = ..., format: Optional[str] = ...) -> None: ...
