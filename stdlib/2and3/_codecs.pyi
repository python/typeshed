...
def charmap_build(map: Text) -> Dict[int, int]: ...
...
def charmap_decode(data: _Decodable, errors: _Errors = ..., mapping: Optional[Dict[int, int]] = ...) -> Tuple[Text, int]: ...
def charmap_encode(data: _Encodable, errors: _Errors, mapping: Optional[Dict[int, int]] = ...) -> Tuple[bytes, int]: ...
