...
if sys.version_info < (3,):
    def delslice(a: Any, b: int, c: int) -> None: ...
    def __delslice__(a: Any, b: int, c: int) -> None: ...

def getitem(a: Any, b: Any) -> Any: ...
def __getitem__(a: Any, b: Any) -> Any: ...

if sys.version_info < (3,):
    def getslice(a: Any, b: int, c: int) -> Any: ...
    def __getslice__(a: Any, b: int, c: int) -> Any: ...
...
if sys.version_info < (3,):
    def setslice(a: Any, b: int, c: int) -> None: ...
    def __setslice__(a: Any, b: int, c: int) -> None: ...
