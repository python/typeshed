...
if sys.version_info >= (3, 6):
    ...
    def exists(path: Union[AnyStr, PathLike[AnyStr], int]) -> bool: ...
    def isfile(path: Union[AnyStr, PathLike[AnyStr], int]) -> bool: ...
    def isdir(s: Union[AnyStr, PathLike[AnyStr], int]) -> bool: ...
    def getsize(filename: Union[AnyStr, PathLike[AnyStr], int]) -> int: ...
    def getmtime(filename: Union[AnyStr, PathLike[AnyStr], int]) -> float: ...
    def getatime(filename: Union[AnyStr, PathLike[AnyStr], int]) -> float: ...
    def getctime(filename: Union[AnyStr, PathLike[AnyStr], int]) -> float: ...
else:
