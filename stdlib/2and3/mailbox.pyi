...
from typing import Optional, Union, Text, AnyStr, Callable, IO, Any, Iterator, List, Tuple, TypeVar, Protocol, Dict, Iterable, Generic, Type
...
class Mailbox(Generic[_MessageType]):
    ...
    _factory: Optional[Callable[[IO[Any]], _MessageType]]
    ...
    def get(self, key: str, default: Optional[_T] = ...) -> Union[_MessageType, _T]: ...
    ...
    def clear(self) -> None: ...
    def pop(self, key: str, default: Optional[_T] = ...) -> Union[_MessageType, _T]: ...
...
class Message(email.message.Message):
    ...
    def __init__(self, message: Optional[_MessageData[AnyStr]] = ...) -> None: ...
...
class BabylMessage(Message):
    ...
    def set_visible(self, visible: _MessageData[AnyStr]) -> None: ...
...
class _ProxyFile(Generic[AnyStr]):
    ...
    def __init__(self, f: IO[AnyStr], pos: Optional[str] = ...) -> None: ...
