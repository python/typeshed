...
class Fraction(Rational):
    ...
    @overload
    def __new__(cls, __value: float, *, _normalize: bool = ...) -> Fraction: ...
    @overload
    def __new__(cls, __value: Decimal, *, _normalize: bool = ...) -> Fraction: ...
    @overload
    def __new__(cls, __value: str, *, _normalize: bool = ...) -> Fraction: ...
