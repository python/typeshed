...
if sys.platform == 'win32':
    ...
    class Table:
        ...
        def sql(self) -> str: ...
        def create(self, db: DB_TYPE) -> None: ...

    class _Unspecified: ...

    def change_sequence(seq: List[Tuple[str, Optional[str], int]], action, seqno: Union[int, _Unspecified] = ..., cond: Union[str, _Unspecified] = ...) -> None: ...
    def add_data(db: DB_TYPE, table: str, values: List[Tuple[...]]) -> None: ...
    def add_stream(db: DB_TYPE, name: str, path: str) -> None: ...
    def init_database(name: str, schema: ModuleType, ProductName: str, ProductCode: str, ProductVersion: str, Manufacturer: str) -> DB_TYPE: ...
    def add_tables(db: DB_TYPE, module: ModuleType) -> None: ...
    ...
    class CAB:
        ...
        def commit(self, db: DB_TYPE) -> None: ...
    ...
    class Directory:
        ...
        def __init__(self, db: DB_TYPE, cab: CAB, basedir: str, physical: str, _logical: str, default: str, componentflags: Optional[int] = ...) -> None: ...
    ...
    class Feature:
        ...
        def __init__(self, db: DB_TYPE, id: str, title: str, desc: str, display: int, level: int = ..., parent: Optional[Feature] = ..., directory: Optional[str] = ..., attributes: int = ...) -> None: ...
    ...
    class Dialog:
        ...
        def __init__(self, db: DB_TYPE, name: str, x: int, y: int, w: int, h: int, attr: int, title: str, first: str, default: str, cancel: str) -> None: ...
