...
if sys.version_info >= (3, 7):
    def parse_multipart(fp: IO[Any], pdict: Mapping[str, bytes]) -> Dict[str, List[Union[str, bytes]]]: ...
else:
    def parse_multipart(fp: IO[Any], pdict: Mapping[str, bytes], encoding: str, errors: str) -> Dict[str, List[bytes]]: ...
