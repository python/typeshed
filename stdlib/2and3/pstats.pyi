...
from typing import Any, AnyStr, Dict, IO, List, Tuple, TypeVar, Union, overload

_Selector = Union[AnyStr, float, int]
_T = TypeVar('_T', bound='Stats')

class Stats:
    # As best I can tell, the first argument has to be a string or Profile
    # instance and the remaining ones may also be Stats instances
    # the only keyword argument accepted is "stream"
    def __init__(self: _T, *args: Union[AnyStr, Profile, _T],
                 **kwds: IO[Any]) -> None: ...
    def init(self, arg: Union[AnyStr, Profile, cProfile]) -> None: ...
    def load_stats(self, arg: Union[AnyStr, Profile, cProfile]) -> None: ...
    def get_top_level_stats(self) -> None: ...
    def add(self: _T, *arg_list: Union[AnyStr, Profile, cProfile, _T]) -> _T: ...
    ...
    def get_print_list(self, sel_list: List[_Selector]) -> Tuple[int, List[str]]: ...
