...
def select(
    rlist: Sequence[Any], wlist: Sequence[Any], xlist: Sequence[Any], timeout: Optional[float] = ...
...
class kevent(object):
    ...
    udata: Any
    def __init__(
        self, ident: _FileDescriptor, filter: int = ..., flags: int = ..., fflags: int = ..., data: Any = ..., udata: Any = ...
    ) -> None: ...
