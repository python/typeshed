...
class OptionContainer:
    ...
    def add_options(self, option_list: Sequence[Option]) -> None: ...
...
class OptionParser(OptionContainer):
    ...
    def _populate_option_list(self, option_list: Sequence[Option], add_help: bool = ...) -> None: ...
    def _process_args(self, largs: Sequence[_Text], rargs: List, values: Values) -> None: ...
