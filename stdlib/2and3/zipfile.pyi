...
from typing import Callable, Dict, Generator, IO, Iterable, List, Optional, Text, Tuple, Type, Union, Sequence, Pattern
...
if sys.version_info >= (3, 8):
    class Path:
        name: str
        def __init__(self, root: Union[ZipFile, _Path, IO[bytes]], at: _SZI = ...) -> None: ...
