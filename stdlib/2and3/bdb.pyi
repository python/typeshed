...
from typing import Set, Dict, Iterable, Any, Callable, Tuple, Type, SupportsInt, List, Union, TypeVar, Optional, IO, Text
...
class Bdb:
    ...
    def canonic(self, filename: Text) -> str: ...
    def reset(self) -> None: ...
    ...
    def set_until(self, frame: FrameType, lineno: int = ...) -> None: ...
    ...
    def set_break(self, filename: Text, lineno: int, temporary: bool = ..., cond: str = ..., funcname: str = ...) -> None: ...
    def clear_break(self, filename: Text, lineno: int) -> None: ...
    def clear_bpbynumber(self, arg: SupportsInt) -> None: ...
    def clear_all_file_breaks(self, filename: Text) -> None: ...
    def clear_all_breaks(self) -> None: ...
    def get_bpbynumber(self, arg: SupportsInt) -> Breakpoint: ...
    def get_break(self, filename: Text, lineno: int) -> bool: ...
    def get_breaks(self, filename: Text, lineno: int) -> List[Breakpoint]: ...
    ...
    def runcall(self, func: Callable[[Any], _T], *args: Any, **kwds: Any) -> _T: ...
...
class Breakpoint:
    ...
    def __init__(self, file: Text, line: int, temporary: bool = ..., cond: str = ..., funcname: str = ...) -> None: ...
    def deleteMe(self) -> None: ...
    def enable(self) -> None: ...
    def disable(self) -> None: ...
    def bpprint(self, out: IO[str] = ...) -> None: ...
    def bpformat(self) -> str: ...
    def __str__(self) -> str: ...

def checkfuncname(b: Breakpoint, frame: FrameType) -> bool: ...
def effective(file: Text, line: int, frame: FrameType) -> Union[Tuple[Breakpoint, bool], Tuple[None, None]]: ...
def set_trace() -> None: ...
