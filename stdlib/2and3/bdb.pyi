...
class Bdb:
    ...
    def set_break(self, filename: str, lineno: int, temporary: bool = ..., cond: str = ..., funcname: str = ...) -> None: ...
...
class Breakpoint:
    ...
    def __init__(self, file: str, line: int, temporary: bool = ..., cond: str = ..., funcname: str = ...) -> None: ...
