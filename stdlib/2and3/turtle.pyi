from typing import Tuple, overload, Optional, Union, Dict, Mapping, Any, Sequence, TypeVar, List, Callable, Text
import sys
...
Color = Union[Text, Tuple[float, float, float]]
Speed = Union[str, int]
PolygonCoords = Sequence[Tuple[float, float]]
...
class Shape(object):
    def __init__(self, type_: str, data: Union[PolygonCoords, PhotoImage, None] = ...) -> None: ...
    def addcomponent(self, poly: PolygonCoords, fill: Color, outline: Optional[Color] = ...) -> None: ...
...
class TurtleScreen(TurtleScreenBase):
    ...
    def register_shape(self, name: str, shape: Union[PolygonCoords, Shape, None] = ...) -> None: ...
    @overload
...
class TPen(object):
    ...
    @overload
    def pen(self, pen: Optional[Mapping[str, object]]) -> None: ...
    @overload
...
class RawTurtle(TPen, TNavigator):
    ...
    if sys.version_info >= (3,):
        ...
        def get_shapepoly(self) -> Optional[PolygonCoords]: ...
    ...
    def get_poly(self) -> PolygonCoords: ...
    def getscreen(self) -> TurtleScreen: ...
    def getturtle(self) -> Turtle: ...
    getpen = getturtle
    def onclick(self, fun: Callable[[float, float], Any], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def onrelease(self, fun: Callable[[float, float], Any], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def ondrag(self, fun: Callable[[float, float], Any], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def undo(self) -> None: ...
...
def register_shape(name: str, shape: Union[PolygonCoords, Shape, None] = ...) -> None: ...
@overload
def colormode() -> float: ...
@overload
...
@overload
def pen(pen: Optional[Mapping[str, object]]) -> None: ...
@overload
...
if sys.version_info >= (3,):
    ...
    def get_shapepoly() -> Optional[PolygonCoords]: ...
