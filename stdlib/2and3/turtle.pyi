from typing import Tuple, overload, Optional, Union, Dict, Any, Sequence, TypeVar, List, Callable
import sys
if sys.version_info >= (3,):
    from tkinter import Canvas
else:
    # TODO: Replace this with 'from Tkinter import Canvas' once we add stubs for Tkinter
    Canvas = Any
...
class Shape:
    def __init__(self, type_: str, data: Optional[Sequence[Tuple[float, float]]] = ...) -> None: ...
    def addcomponent(self, poly: Sequence[Tuple[float, float]], fill: Color, outline: Optional[Color] = ...) -> None: ...

class TurtleScreen(TurtleScreenBase):
    def __init__(self, cv: Canvas, mode: str = ..., colormode: float = ..., deplay: int = ...) -> None: ...
    def clear(self) -> None: ...
    @overload
    def mode(self) -> str: ...
    @overload
    ...
    def register_shape(self, name: str, shape: Union[Sequence[Tuple[float, float]], Shape, None] = ...) -> None: ...
    @overload
    ...
    @overload
    def bgcolor(self, color: Color) -> None: ...
    @overload
    ...
    def onclick(self, fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def onkey(self, fun: Callable[[], None], key: str) -> None: ...
    def listen(self, xdummy: Optional[float] = ..., ydummy: Optional[float] = ...) -> None: ...
    def ontimer(self, fun: Callable[[], None], t: int = ...) -> None: ...
    @overload
    def bgpic(self) -> str: ...
    @overload
    ...
    @overload
    def screensize(self, canvwidth: int, canvheight: int, bg: Optional[Color] = ...) -> None: ...
    onscreenclick = onclick
    resetscreen = reset
    clearscreen = clear
    addshape = register_shape
    if sys.version_info >= (3,):
        def onkeypress(self, fun: Callable[[], None], key: Optional[str] = ...) -> None: ...
        onkeyrelease = onkey
...
class TNavigator:
    ...
    @overload
    def distance(self, x: Union[Turtle, Tuple[float, float]]) -> float: ...
    @overload
    def distance(self, x: float, y: float) -> float: ...
    @overload
    def towards(self, x: Union[Tuple[float, float]]) -> float: ...
    @overload
...
class TPen:
    ...
    def resizemode(self, rmode: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pencolor(self, color: Color) -> None: ...
    @overload
    def pencolor(self, r: float, g: float, b: float) -> None: ...
    @overload
    def fillcolor(self) -> Color: ...
    @overload
    def fillcolor(self, color: Color) -> None: ...
    @overload
    ...
    @overload
    def color(self, color1: Color, color2: Color) -> None: ...
    def showturtle(self) -> None: ...
    def hideturtle(self) -> None: ...
    def isvisible(self) -> bool: ...
    # Note: signatures 1 and 3 overlap unsafely when no arguments are provided
    @overload
    def pen(self) -> Dict[str, object]: ...  # type: ignore
    @overload
    def pen(self, pen: Optional[Dict[str, object]]) -> None: ...
    @overload
    def pen(self, *, shown: bool = ..., pendown: bool = ..., pencolor: Color = ..., fillcolor: Color = ...,
...
class RawTurtle(TPen, TNavigator):
    ...
    if sys.version_info >= (3,):
        ...
        def get_shapepoly(self) -> Optional[Sequence[Tuple[float, float]]]: ...
    ...
    def dot(self, size: Optional[int], *color: Color) -> None: ...
    def write(self, arg: object, move: bool = ..., align: str = ..., font: Tuple[str, int, str] = ...) -> None: ...
    def begin_poly(self) -> None: ...
    def end_poly(self) -> None: ...
    def get_poly(self) -> Sequence[Tuple[float, float]]: ...
    def getscreen(self) -> TurtleScreen: ...
    def getturtle(self) -> Turtle: ...
    getpen = getturtle
    def onclick(self, fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def onrelease(self, fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def ondrag(self, fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
    def undo(self) -> None: ...
...
def register_shape(name: str, shape: Union[Sequence[Tuple[float, float]], Shape, None] = ...) -> None: ...
@overload
def colormode() -> float: ...
@overload
...
def onclick(fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
def onkey(fun: Callable[[], None], key: str) -> None: ...
def listen(xdummy: Optional[float] = ..., ydummy: Optional[float] = ...) -> None: ...
def ontimer(fun: Callable[[], None], t: int = ...) -> None: ...
@overload
def bgpic() -> str: ...
@overload
...
@overload
def screensize(canvwidth: int, canvheight: int, bg: Optional[Color] = ...) -> None: ...
onscreenclick = onclick
resetscreen = reset
clearscreen = clear
addshape = register_shape
if sys.version_info >= (3,):
    def onkeypress(fun: Callable[[], None], key: Optional[str] = ...) -> None: ...
    onkeyrelease = onkey
...
@overload
def distance(x: Union[Turtle, Tuple[float, float]]) -> float: ...
@overload
def distance(x: float, y: float) -> float: ...
@overload
def towards(x: Union[Tuple[float, float]]) -> float: ...
@overload
...
def resizemode(rmode: Optional[str] = ...) -> None: ...
@overload
def pensize() -> int: ...
@overload
...
def speed() -> int: ...
@overload
def speed(speed: Speed) -> None: ...
@overload
def pencolor() -> Color: ...
@overload
def pencolor(color: Color) -> None: ...
@overload
def pencolor(r: float, g: float, b: float) -> None: ...
@overload
def fillcolor() -> Color: ...
@overload
def fillcolor(color: Color) -> None: ...
@overload
...
@overload
def color(color1: Color, color2: Color) -> None: ...
def showturtle() -> None: ...
def hideturtle() -> None: ...
def isvisible() -> bool: ...
# Note: signatures 1 and 3 overlap unsafely when no arguments are provided
@overload
def pen() -> Dict[str, object]: ...  # type: ignore
@overload
def pen(pen: Optional[Dict[str, object]]) -> None: ...
@overload
def pen(*, shown: bool = ..., pendown: bool = ..., pencolor: Color = ..., fillcolor: Color = ...,
        pensize: int = ..., speed: int = ..., resizemode: str = ..., stretchfactor: Tuple[float, float] = ...,
        outline: int = ..., tilt: float = ...) -> None: ...
width = pensize
up = penup
...
if sys.version_info >= (3,):
    ...
    def get_shapepoly() -> Optional[Sequence[Tuple[float, float]]]: ...
...
def stamp() -> int: ...
def clearstamp(stampid: int) -> None: ...
def clearstamps(n: Optional[int] = ...) -> None: ...
def filling() -> bool: ...
def begin_fill() -> None: ...
def end_fill() -> None: ...
def dot(size: Optional[int], *color: Color) -> None: ...
def write(arg: object, move: bool = ..., align: str = ..., font: Tuple[str, int, str] = ...) -> None: ...
def begin_poly() -> None: ...
def end_poly() -> None: ...
def get_poly() -> Sequence[Tuple[float, float]]: ...
def getscreen() -> TurtleScreen: ...
def getturtle() -> Turtle: ...
getpen = getturtle
def onrelease(fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
def ondrag(fun: Callable[[float, float], None], btn: int = ..., add: Optional[Any] = ...) -> None: ...
def undo() -> None: ...
turtlesize = shapesize
