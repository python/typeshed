...
class TPen(object):
    ...
    @overload
    def pen(self, *, shown: bool = ..., pendown: bool = ..., pencolor: _Color = ..., fillcolor: _Color = ...,
...
class RawTurtle(TPen, TNavigator):
    ...
    def get_poly(self) -> _PolygonCoords: ...
...
@overload
def pen(*, shown: bool = ..., pendown: bool = ..., pencolor: _Color = ..., fillcolor: _Color = ...,
        pensize: int = ..., speed: int = ..., resizemode: str = ..., stretchfactor: Tuple[float, float] = ...,
        outline: int = ..., tilt: float = ...) -> None: ...
width = pensize
up = penup
