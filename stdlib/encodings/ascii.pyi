...
class StreamConverter(StreamWriter, StreamReader):  # type: ignore[misc]  # incompatible methods in base classes
    encode = codecs.ascii_decode  # type: ignore[assignment]  # pyright: ignore[reportAssignmentType]
    decode = codecs.ascii_encode  # type: ignore[assignment]  # pyright: ignore[reportAssignmentType]
