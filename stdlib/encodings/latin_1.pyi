...
class Codec(codecs.Codec):
    encode = codecs.latin_1_encode  # type: ignore[assignment]  # pyright: ignore[reportAssignmentType]
    decode = codecs.latin_1_decode  # type: ignore[assignment]  # pyright: ignore[reportAssignmentType]
