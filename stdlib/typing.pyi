...
from typing_extensions import Literal as _Literal, ParamSpec as _ParamSpec, SupportsIndex as _SupportsIndex, final as _final
...
class Sequence(Collection[_T_co], Reversible[_T_co], Generic[_T_co]):
    @overload
    @abstractmethod
    def __getitem__(self, i: _SupportsIndex) -> _T_co: ...
    @overload
    @abstractmethod
...
class MutableSequence(Sequence[_T], Generic[_T]):
    ...
    @overload
    @abstractmethod
    def __delitem__(self, i: _SupportsIndex) -> None: ...
    @overload
    @abstractmethod
