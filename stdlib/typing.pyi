...
import sys
from _typeshed import ReadableBuffer, ReadOnlyBuffer, Self, SupportsKeysAndGetItem, WriteableBuffer
...
RegexString = TypeVar("RegexString", str, ReadOnlyBuffer, WriteableBuffer)
...
class Match(Generic[RegexString]):
    ...
    # this match instance.
    re: Pattern[RegexString]
    def expand(self, template: RegexString) -> RegexString: ...
    # group() returns "RegexString" or "RegexString | None", depending on the pattern.
    @overload
    def group(self, __group: _Literal[0] = ...) -> RegexString: ...
    @overload
    def group(self, __group: str | int) -> RegexString | Any: ...
    @overload
    def group(self, __group1: str | int, __group2: str | int, *groups: str | int) -> tuple[RegexString | Any, ...]: ...
    # Each item of groups()'s return tuple is either "RegexString" or
    # "RegexString | None", depending on the pattern.
    @overload
    def groups(self) -> tuple[RegexString | Any, ...]: ...
    @overload
    def groups(self, default: _T) -> tuple[RegexString | _T, ...]: ...
    # Each value in groupdict()'s return dict is either "RegexString" or
    # "RegexString | None", depending on the pattern.
    @overload
    def groupdict(self) -> dict[str, RegexString | Any]: ...
    @overload
    def groupdict(self, default: _T) -> dict[str, RegexString | _T]: ...
    def start(self, __group: int | str = ...) -> int: ...
    def end(self, __group: int | str = ...) -> int: ...
    def span(self, __group: int | str = ...) -> tuple[int, int]: ...
    @property
    def regs(self) -> tuple[tuple[int, int], ...]: ...  # undocumented
    # __getitem__() returns "RegexString" or "RegexString | None", depending on the pattern.
    @overload
    def __getitem__(self, __key: _Literal[0]) -> RegexString: ...
    @overload
    def __getitem__(self, __key: int | str) -> RegexString | Any: ...
    if sys.version_info >= (3, 9):
...
class Pattern(Generic[RegexString]):
    ...
    groups: int
    pattern: RegexString
    def search(self, string: RegexString, pos: int = ..., endpos: int = ...) -> Match[RegexString] | None: ...
    def match(self, string: ByteString, pos: int = ..., endpos: int = ...) -> Match[RegexString] | None: ...
    def fullmatch(self, string: RegexString, pos: int = ..., endpos: int = ...) -> Match[RegexString] | None: ...
    def split(self, string: RegexString, maxsplit: int = ...) -> list[RegexString | Any]: ...
    def findall(self, string: RegexString, pos: int = ..., endpos: int = ...) -> list[Any]: ...
    def finditer(self, string: RegexString, pos: int = ..., endpos: int = ...) -> Iterator[Match[RegexString]]: ...
    @overload
    def sub(self, repl: RegexString, string: RegexString, count: int = ...) -> RegexString: ...
    @overload
    def sub(self, repl: Callable[[Match[RegexString]], RegexString], string: RegexString, count: int = ...) -> RegexString: ...
    @overload
    def subn(self, repl: RegexString, string: RegexString, count: int = ...) -> tuple[RegexString, int]: ...
    @overload
    def subn(
