...
class Match(Generic[AnyStr]):
    ...
    @overload
    def group(self, __group: str | int) -> Any: ...
    @overload
    def group(self, __group1: str | int, __group2: str | int, *groups: str | int) -> Tuple[Any, ...]: ...
    # Each item of groups()'s return tuple is either "AnyStr" or
    # "AnyStr | None", depending on the pattern.
    def groups(self, default: AnyStr = ...) -> Tuple[Any, ...]: ...
    # Each value in groupdict()'s return dict is either "AnyStr" or
    # "AnyStr | None", depending on the pattern.
    def groupdict(self, default: AnyStr = ...) -> dict[str, Any]: ...
