...
class AbstractSet(Collection[_KT_co]):
    @abstractmethod
    def __contains__(self, x: object, /) -> bool: ...
    def _hash(self) -> int: ...
    # Mixin methods
    @classmethod
    def _from_iterable(cls, it: Iterable[_KT_co], /) -> AbstractSet[_KT_co]: ...
    def __le__(self, other: AbstractSet[Hashable], /) -> bool: ...
    def __lt__(self, other: AbstractSet[Hashable], /) -> bool: ...
    def __gt__(self, other: AbstractSet[Hashable], /) -> bool: ...
...
class MutableSet(AbstractSet[_KT]):
    @abstractmethod
    def add(self, value: _KT, /) -> None: ...
    @abstractmethod
    def discard(self, value: _KT, /) -> None: ...
    # Mixin methods
    def clear(self) -> None: ...
    def pop(self) -> _KT: ...
    def remove(self, value: _KT, /) -> None: ...
    def __ior__(self, it: AbstractSet[_KT], /) -> typing_extensions.Self: ...  # type: ignore[override,misc]
    def __iand__(self, it: AbstractSet[Hashable], /) -> typing_extensions.Self: ...
    def __ixor__(self, it: AbstractSet[_KT], /) -> typing_extensions.Self: ...  # type: ignore[override,misc]
    def __isub__(self, it: AbstractSet[Hashable], /) -> typing_extensions.Self: ...
