...
class _SubscriptableSpecialForm(_SpecialForm): # type: ignore
...
Union: _SubscriptableSpecialForm = ...
Generic: _SubscriptableSpecialForm = ...
# Protocol is only present in 3.8 and later, but mypy needs it unconditionally
Protocol: _SubscriptableSpecialForm = ...
Callable: _SubscriptableSpecialForm = ...
Type: _SubscriptableSpecialForm = ...
NoReturn: _SpecialForm = ...

Optional: _SubscriptableSpecialForm
Tuple: _SubscriptableSpecialForm
ClassVar: _SubscriptableSpecialForm
if sys.version_info >= (3, 8):
    Final: _SubscriptableSpecialForm
    def final(f: _T) -> _T: ...
    Literal: _SubscriptableSpecialForm
    # TypedDict is a (non-subscriptable) special form.
    TypedDict: object

if sys.version_info >= (3, 11):
    Self: _SubscriptableSpecialForm
    Never: _SpecialForm = ...
