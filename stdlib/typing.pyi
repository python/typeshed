...
class AsyncContextManager(Protocol[_T_co]):
    ...
    def __aexit__(
        self, exc_type: Optional[Type[BaseException]], exc_value: BaseException | None, traceback: TracebackType | None
    ) -> Awaitable[bool | None]: ...
...
class Match(Generic[AnyStr]):
    ...
    @overload
    def group(self, __group1: str | int, __group2: str | int, *groups: str | int) -> Tuple[AnyStr, ...]: ...
    ...
    def __getitem__(self, g: int | str) -> AnyStr: ...
    if sys.version_info >= (3, 9):
...
if sys.version_info >= (3, 7):
    ...
    class ForwardRef:
        ...
        def _evaluate(self, globalns: Optional[Dict[str, Any]], localns: Optional[Dict[str, Any]]) -> Any | None: ...
