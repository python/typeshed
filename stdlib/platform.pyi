...
if sys.version_info >= (3, 8):
    ...
    def libc_ver(executable: str = None, lib: str = '', version: str = '', chunksize: int = 16384) -> tuple[str, str]: ...
...
def architecture(executable: str = '/Users/jelle/py/venvs/py311/bin/python', bits: str = '', linkage: str = '') -> tuple[str, str]: ...
...
def platform(aliased: bool = 0, terse: bool = 0) -> str: ...
