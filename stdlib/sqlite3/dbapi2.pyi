...
class _AnyParamWindowAggreateClass(Protocol)
...
class Connection:
    ...
    if sys.version_info >= (3, 11):
        ...
        @overload
        def create_window_function(
            self, __name: str, __num_params: Literal[-1], __aggregate_class: Callable[[], _AnyParamWindowAggreateClass] | None
        ) -> None: ...
        @overload
        def create_window_function(
            self, __name: str, __num_params: int, __aggregate_class: Callable[[], _WindowAggretateClass] | None
        ) -> None: ...
