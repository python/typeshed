...
class Connection:
    ...
    def create_collation(self, __name: str, __callback: Callable[[str, str], None] | None) -> None: ...
    if sys.version_info >= (3, 8):
        def create_function(
...
class Row(Generic[_T_co]):
    ...
    def __eq__(self, __other: Row[object]) -> bool: ...
    def __ge__(self, __other: Row[object]) -> bool: ...
    def __gt__(self, __other: Row[object]) -> bool: ...
    def __le__(self, __other: Row[object]) -> bool: ...
    def __lt__(self, __other: Row[object]) -> bool: ...
    def __ne__(self, __other: Row[object]) -> bool: ...
