...
class EmailPolicy(Policy[_MessageT]):
    ...
    def header_store_parse(self, name: str, value: Incomplete) -> tuple[str, Incomplete]: ...
    def header_fetch_parse(self, name: str, value: str) -> Incomplete: ...
    def fold(self, name: str, value: str) -> Incomplete: ...
