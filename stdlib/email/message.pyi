...
class Message(Generic[_H]):
    ...
    def __setitem__(self, name: str, val: _H) -> None: ...
    def __delitem__(self, name: str) -> None: ...
    def keys(self) -> list[str]: ...
    def values(self) -> list[_H]: ...
    def items(self) -> list[tuple[str, _H]]: ...
    @overload
    def get(self, name: str, failobj: None = None) -> _H | None: ...
    @overload
    def get(self, name: str, failobj: _T) -> _H | _T: ...
    @overload
    def get_all(self, name: str, failobj: None = None) -> list[_H] | None: ...
    @overload
    def get_all(self, name: str, failobj: _T) -> list[_H] | _T: ...
    def add_header(self, _name: str, _value: str, **_params: _ParamsType) -> None: ...
    def replace_header(self, _name: str, _value: _H) -> None: ...
    ...
    def set_raw(self, name: str, value: _H) -> None: ...
    def raw_items(self) -> Iterator[tuple[str, _H]]: ...
