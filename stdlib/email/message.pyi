...
class Message:
    ...
    def get(self, name: str, failobj: _T = None) -> _HeaderType | _T: ...
    def get_all(self, name: str, failobj: _T = None) -> list[_HeaderType] | _T: ...
    ...
    def get_params(self, failobj: _T = None, header: str = 'content-type', unquote: bool = True) -> list[tuple[str, str]] | _T: ...
    def get_param(self, param: str, failobj: _T = None, header: str = 'content-type', unquote: bool = True) -> _T | _ParamType: ...
    ...
    def get_filename(self, failobj: _T = None) -> _T | str: ...
    def get_boundary(self, failobj: _T = None) -> _T | str: ...
    def set_boundary(self, boundary: str) -> None: ...
    @overload
    def get_content_charset(self) -> str | None: ...
    @overload
    def get_content_charset(self, failobj: _T) -> str | _T: ...
    def get_charsets(self, failobj: _T = None) -> _T | list[str]: ...
