...
_BaseHeaderT = TypeVar("_BaseHeaderT", default=BaseHeader)
...
class Message(Generic[_HeaderT]):
    ...
    def __getitem__(self, name: str) -> _HeaderT: ...
    def __setitem__(self, name: str, val: _HeaderT) -> None: ...
    ...
    def replace_header(self, _name: str, _value: _HeaderT) -> None: ...
    ...
    def set_raw(self, name: str, value: _HeaderT) -> None: ...
    def raw_items(self) -> Iterator[tuple[str, _HeaderT]]: ...

class MIMEPart(Message[_BaseHeaderT]):
    def get_body(self, preferencelist: Sequence[str] = ("related", "html", "plain")) -> MIMEPart[_BaseHeaderT] | None: ...
    def iter_attachments(self) -> Iterator[MIMEPart[_BaseHeaderT]]: ...
    def iter_parts(self) -> Iterator[MIMEPart[_BaseHeaderT]]: ...
