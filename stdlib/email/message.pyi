...
class MIMEPart(Message[_HeaderRegistryT_co, _HeaderRegistryParamT_contra]):
    ...
    def get_content(self, *args: Incomplete, content_manager: ContentManager | None = None, **kw) -> Incomplete: ...
    def set_content(self, *args: Incomplete, content_manager: ContentManager | None = None, **kw) -> None: ...
    ...
    def add_related(self, *args: Incomplete, content_manager: ContentManager | None = ..., **kw) -> None: ...
    def add_alternative(self, *args: Incomplete, content_manager: ContentManager | None = ..., **kw) -> None: ...
    def add_attachment(self, *args: Incomplete, content_manager: ContentManager | None = ..., **kw) -> None: ...
    def clear(self) -> None: ...
