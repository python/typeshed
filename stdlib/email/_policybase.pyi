...
class Policy(_PolicyBase, Generic[_M], metaclass=ABCMeta):
    ...
    mangle_from_: bool
    message_factory: Callable[[Policy], _M] | None
    def __init__(
        self,
        *,
        ...
        message_factory: Callable[[Policy], _M] | None = None,
    ) -> None: ...
    def handle_defect(self, obj: _M, defect: MessageDefect) -> None: ...
    def register_defect(self, obj: _M, defect: MessageDefect) -> None: ...
...
class Compat32(Policy[Message[str, str]]):
    def header_source_parse(self, sourcelines: list[str]) -> tuple[str, str]: ...
    def header_store_parse(self, name: str, value: str) -> tuple[str, str]: ...
