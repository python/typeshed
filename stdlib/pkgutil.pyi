...
from typing import IO, Any, Callable, Iterable, Iterator, List, NamedTuple, Optional, Tuple
...
def walk_packages(
    path: Iterable[str] | None = ..., prefix: str = ..., onerror: Optional[Callable[[str], None]] = ...
) -> Iterator[ModuleInfo]: ...
