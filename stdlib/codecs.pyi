...
def strict_errors(object: UnicodeError, /) -> tuple[str | bytes, int]: ...
def replace_errors(object: UnicodeError, /) -> tuple[str | bytes, int]: ...
def ignore_errors(object: UnicodeError, /) -> tuple[str | bytes, int]: ...
def xmlcharrefreplace_errors(object: UnicodeError, /) -> tuple[str | bytes, int]: ...
def backslashreplace_errors(object: UnicodeError, /) -> tuple[str | bytes, int]: ...
def namereplace_errors(object: UnicodeError, /) -> tuple[str | bytes, int]: ...
