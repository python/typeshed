...
_WriteType: TypeAlias = Callable[[str], object]
...
class Marshaller:
    ...
    def __dump(self, value: _Marshallable, write: _WriteType) -> None: ...  # undocumented
    def dump_nil(self, value: None, write: _WriteType) -> None: ...
    def dump_bool(self, value: bool, write: _WriteType) -> None: ...
    def dump_long(self, value: int, write: _WriteType) -> None: ...
    def dump_int(self, value: int, write: _WriteType) -> None: ...
    def dump_double(self, value: float, write: _WriteType) -> None: ...
    def dump_unicode(self, value: str, write: _WriteType, escape: Callable[[str], str] = ...) -> None: ...
    def dump_bytes(self, value: bytes, write: _WriteType) -> None: ...
    def dump_array(self, value: Iterable[_Marshallable], write: _WriteType) -> None: ...
    def dump_struct(self, value: Mapping[str, _Marshallable], write: _WriteType, escape: Callable[[str], str] = ...) -> None: ...
    def dump_datetime(self, value: _XMLDate, write: _WriteType) -> None: ...
    def dump_instance(self, value: object, write: _WriteType) -> None: ...
