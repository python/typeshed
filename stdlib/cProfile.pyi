...
def run(statement: str, filename: str | None = None, sort: str | int = ...) -> None: ...
def runctx(
    statement: str, globals: dict[str, Any], locals: dict[str, Any], filename: str | None = None, sort: str | int = ...
) -> None: ...
