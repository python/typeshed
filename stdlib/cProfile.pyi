...
from typing import Any, Callable, Dict, Optional, TypeVar, Union, Tuple
...
class Profile:
    stats: dict[_Label, tuple[int, int, int, int, dict[_Label, tuple[int, int, int, int]]]]
    def __init__(
...
def label(code: Union[str, CodeType]) -> _Label: ...
