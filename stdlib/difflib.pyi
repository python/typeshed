...
class SequenceMatcher(Generic[_T]):
    @overload
    def __init__(self, isjunk: Callable[[
                 _T], bool] | None, a: Sequence[_T], b: Sequence[_T], autojunk: bool = True) -> None: ...

    @overload
    def __init__(
        self, *, a: Sequence[_T], b: Sequence[_T], autojunk: bool = True) -> None: ...
    ...
    if sys.version_info >= (3, 9):
        def find_longest_match(self, alo: int = 0, ahi: int | None = None,
                               blo: int = 0, bhi: int | None = None) -> Match: ...
    else:
        def find_longest_match(self, alo: int, ahi: int,
                               blo: int, bhi: int) -> Match: ...

    def get_matching_blocks(self) -> list[Match]: ...
    def get_opcodes(self) -> list[tuple[OpcodeAction, int, int, int, int]]: ...
    def get_grouped_opcodes(
        self, n: int = 3) -> Iterable[list[tuple[str, int, int, int, int]]]: ...
...
def get_close_matches(
    word: AnyStr, possibilities: Iterable[AnyStr], n: int = 3, cutoff: float = 0.6) -> list[AnyStr]: ...
...
class Differ:
    def __init__(self, linejunk: Callable[[str], bool] | None = None, charjunk: Callable[[
                 str], bool] | None = None) -> None: ...
...
def IS_CHARACTER_JUNK(
    ch: str, ws: str = " \t") -> bool: ...  # ws is undocumented
