...
class Task(Future[_T], Generic[_T]):
    ...
    if sys.version_info < (3, 9):
        @classmethod
        def current_task(cls, loop: AbstractEventLoop | None = ...) -> Optional[Task[Any]]: ...
        @classmethod
...
if sys.version_info >= (3, 7):
    ...
    if sys.version_info >= (3, 8):
        def create_task(
            coro: Generator[_TaskYieldType, None, _T] | Awaitable[_T], *, name: str | None = ...
        ) -> Task[_T]: ...
    else:
        def create_task(coro: Generator[_TaskYieldType, None, _T] | Awaitable[_T]) -> Task[_T]: ...
    def current_task(loop: AbstractEventLoop | None = ...) -> Optional[Task[Any]]: ...
