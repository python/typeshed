...
class Handle(Generic[Unpack[_Ts]]):
    _cancelled: bool
    _args: tuple[Unpack[_Ts]]
    def __init__(
        self,
...
class TimerHandle(Handle[Unpack[_Ts]]):
    def __init__(
        self,
        when: float,
        callback: Callable[[Unpack[_Ts]], object],
    ...
    def when(self) -> float: ...
    def __lt__(self, other: TimerHandle[Unpack[tuple[Any, ...]]]) -> bool: ...
    def __le__(self, other: TimerHandle[Unpack[tuple[Any, ...]]]) -> bool: ...
    def __gt__(self, other: TimerHandle[Unpack[tuple[Any, ...]]]) -> bool: ...
    def __ge__(self, other: TimerHandle[Unpack[tuple[Any, ...]]]) -> bool: ...
...
class AbstractEventLoop:
    ...
    if sys.version_info >= (3, 9):  # "context" added in 3.9.10/3.10.2
        ...
        @abstractmethod
        def call_soon(self, callback: Callable[[Unpack[_Ts]], object], *args: Unpack[_Ts]) -> Handle[Unpack[_Ts]]: ...
        @abstractmethod
        def call_later(
    ...
    if sys.version_info >= (3, 9):  # "context" added in 3.9.10/3.10.2
        ...
        @abstractmethod
        def call_soon_threadsafe(self, callback: Callable[[Unpack[_Ts]], object], *args: Unpack[_Ts]) -> Handle[Unpack[_Ts]]: ...
