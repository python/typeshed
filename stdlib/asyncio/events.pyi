...
class AbstractEventLoop:
    ...
    @abstractmethod
    def set_task_factory(self, factory: Callable[[AbstractEventLoop, Coroutine[Any, Any, _T] | Generator[Any, None, _T]], Future[_T]] | None) -> None: ...
    @abstractmethod
    def get_task_factory(self) -> Callable[[AbstractEventLoop, Coroutine[Any, Any, _T] | Generator[Any, None, _T]], Future[_T]] | None: ...
