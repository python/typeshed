...
class Handle:
    ...
    if sys.version_info >= (3, 7):
        ...
        def __init__(self, callback: Callable[..., object], args: Sequence[Any], loop: AbstractEventLoop) -> None: ...
...
class TimerHandle(Handle):
    if sys.version_info >= (3, 7):
        ...
        def __init__(
            self, when: float, callback: Callable[..., object], args: Sequence[Any], loop: AbstractEventLoop
        ) -> None: ...
