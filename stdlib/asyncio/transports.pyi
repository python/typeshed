...
class WriteTransport(BaseTransport):
    ...
    def write(self, data: bytes | bytearray | memoryview | memoryview[bytes]) -> None: ...
    def writelines(self, list_of_data: Iterable[bytes | bytearray | memoryview | memoryview[bytes]]) -> None: ...
