...
class WriteTransport(BaseTransport):
    ...
    def write(self, data: bytes | bytearray | memoryview[int] | memoryview[bytes]) -> None: ...
    def writelines(self, list_of_data: Iterable[bytes | bytearray | memoryview[int] | memoryview[bytes]]) -> None: ...
