...
class dispatcher:
    ...
    def set_socket(self, sock: socket, map: Optional[_maptype] = ...) -> None: ...
    ...
    def accept(self) -> Optional[Tuple[socket, Any]]: ...
...
class dispatcher_with_send(dispatcher):
    def __init__(self, sock: socket = ..., map: Optional[_maptype] = ...) -> None: ...
