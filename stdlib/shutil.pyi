...
if sys.version_info >= (3, 8):
    def copytree(
        ...
        copy_function: Callable[[str, str], Any] = ...,
...
_OnErrorCallback: TypeAlias = Callable[[Callable[..., Any], Any, Any], Any]
...
_CopyFn: TypeAlias = Callable[[str, str], Any] | Callable[[StrPath, StrPath], Any]
...
def register_archive_format(
    name: str, function: Callable[..., Any], extra_args: Sequence[tuple[str, Any] | list[Any]], description: str = ...
) -> None: ...
@overload
def register_archive_format(
    name: str, function: Callable[[str, str], Any], extra_args: None = ..., description: str = ...
) -> None: ...
def unregister_archive_format(name: str) -> None: ...
def unpack_archive(filename: StrPath, extract_dir: StrPath | None = ..., format: str | None = ...) -> None: ...
@overload
def register_unpack_format(
    name: str, extensions: list[str], function: Callable[..., Any], extra_args: Sequence[tuple[str, Any]], description: str = ...
) -> None: ...
@overload
def register_unpack_format(
    name: str, extensions: list[str], function: Callable[[str, str], Any], extra_args: None = ..., description: str = ...
) -> None: ...
