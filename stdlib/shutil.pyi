...
if sys.version_info >= (3, 7):
    def unpack_archive(filename: StrOrBytesPath, extract_dir: StrPath | None = ..., format: str | None = ...) -> None: ...

else:
    # See http://bugs.python.org/issue30218
    def unpack_archive(filename: str | bytes, extract_dir: StrPath | None = ..., format: str | None = ...) -> None: ...
