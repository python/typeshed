...
def rmtree(
    path: bytes | StrPath, ignore_errors: bool = ..., onerror: Optional[Callable[[Any, Any, Any], Any]] = ...
) -> None: ...
...
def chown(path: StrPath, user: Optional[str | int] = ..., group: Optional[str | int] = ...) -> None: ...
...
def register_archive_format(
    ...
    extra_args: Optional[Sequence[Tuple[str, Any] | List[Any]]] = ...,
    description: str = ...,
) -> None: ...
