...
def S_IMODE(object: int, /) -> int: ...
def S_IFMT(object: int, /) -> int: ...
def S_ISBLK(object: int, /) -> bool: ...
def S_ISCHR(object: int, /) -> bool: ...
def S_ISDIR(object: int, /) -> bool: ...
def S_ISDOOR(object: int, /) -> bool: ...
def S_ISFIFO(object: int, /) -> bool: ...
def S_ISLNK(object: int, /) -> bool: ...
def S_ISPORT(object: int, /) -> bool: ...
def S_ISREG(object: int, /) -> bool: ...
def S_ISSOCK(object: int, /) -> bool: ...
def S_ISWHT(object: int, /) -> bool: ...
def filemode(object: int, /) -> str: ...
