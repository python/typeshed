...
@overload
def apply(object: object, args: List) -> Any: ...
@overload
def apply(object: object, args:List, kwargs: Dict) -> Any: ...

def coerce(x: int, y: int) -> Tuple[int,int]: ...

class copyright(site._Printer) -> Any: ...

class credits(site._Printer) -> Any: ...

class license(site._Printer) -> Any: ...
