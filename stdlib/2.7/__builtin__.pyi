...
class basestring(Sequence[basestring], metaclass=ABCMeta):
    ...
    # NOTE: rsplit() is too problematic due to returning a List.
    def rstrip(self, chars: basestring = ...) -> basestring: ...
    def startswith(self, prefix: Union[basestring, Tuple[basestring, ...]], start: int = 0,
                   end: int = ...) -> bool: ...
    # NOTE: split() is too problematic due to returning a List.
    # NOTE: splitlines() is too problematic due to returning a List.
