...
class basestring(Sequence[basestring], metaclass=ABCMeta):
    @abstractmethod
    def __init__(self) -> None: ...

    def capitalize(self) -> basestring: ...
    def center(self, width: int, fillchar: basestring = ...) -> basestring: ...
    def count(self, x: basestring) -> int: ...
    def decode(self, encoding: basestring = ..., errors: basestring = ...) -> unicode: ...
    def encode(self, encoding: basestring = ..., errors: basestring = ...) -> str: ...
    def endswith(self, suffix: Union[basestring, Tuple[basestring, ...]], start: int = 0,
                 end: int = ...) -> bool: ...
    def expandtabs(self, tabsize: int = 8) -> basestring: ...
    def find(self, sub: basestring, start: int = 0, end: int = 0) -> int: ...
    def format(self, *args: Any, **kwargs: Any) -> basestring: ...
    def format_map(self, map: Mapping[basestring, Any]) -> basestring: ...
    def index(self, sub: basestring, start: int = 0, end: int = 0) -> int: ...
    ...
    def join(self, iterable: Iterable[basestring]) -> basestring: ...
    def ljust(self, width: int, fillchar: basestring = ...) -> basestring: ...
    def lower(self) -> basestring: ...
    def lstrip(self, chars: basestring = ...) -> basestring: ...
    def partition(self, sep: basestring) -> Tuple[basestring, basestring, basestring]: ...
    def replace(self, old: basestring, new: basestring, count: int = ...) -> basestring: ...
    def rfind(self, sub: basestring, start: int = 0, end: int = 0) -> int: ...
    def rindex(self, sub: basestring, start: int = 0, end: int = 0) -> int: ...
    def rjust(self, width: int, fillchar: basestring = ...) -> basestring: ...
    def rpartition(self, sep: basestring) -> Tuple[basestring, basestring, basestring]: ...
    def rsplit(self, sep: basestring = ..., maxsplit: int = ...) -> Sequence[basestring]: ...
    def rstrip(self, chars: basestring = ...) -> basestring: ...
    def startswith(self, prefix: Union[basestring, Tuple[basestring, ...]], start: int = 0,
                   end: int = ...) -> bool: ...
    def split(self, sep: basestring = ..., maxsplit: int = ...) -> Sequence[basestring]: ...
    def splitlines(self, keepends: bool = ...) -> Sequence[basestring]: ...
    def strip(self, chars: basestring = ...) -> basestring: ...
    def swapcase(self) -> basestring: ...
    def title(self) -> basestring: ...
    # NOTE: translate() is too problematic; its signature is different for str vs. unicode.
    def upper(self) -> basestring: ...
    def zfill(self, width: int) -> basestring: ...

    @overload
    def __getitem__(self, i: int) -> basestring: ...
    @overload
    def __getitem__(self, s: slice) -> basestring: ...

    def __getslice__(self, start: int, stop: int) -> basestring: ...

    @overload
    def __add__(self, s: basestring) -> basestring: ...
    @overload
    def __add__(self, s: str) -> basestring: ...
    @overload
    def __add__(self, s: unicode) -> unicode: ...

    def __mul__(self, n: int) -> basestring: ...
    def __mod__(self, x: Any) -> basestring: ...
    def __eq__(self, x: object) -> bool: ...
    def __ne__(self, x: object) -> bool: ...
    def __lt__(self, x: basestring) -> bool: ...
    def __le__(self, x: basestring) -> bool: ...
    def __gt__(self, x: basestring) -> bool: ...
    def __ge__(self, x: basestring) -> bool: ...

    def __len__(self) -> int: ...
    def __contains__(self, s: object) -> bool: ...
    def __iter__(self) -> Iterator[basestring]: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __int__(self) -> int: ...
    def __float__(self) -> float: ...
...
class unicode(basestring, Sequence[unicode]):
    ...
    def center(self, width: int, fillchar: basestring = ...) -> unicode: ...
    def expandtabs(self, tabsize: int = 8) -> unicode: ...
    def format(self, *args: Any, **kwargs: Any) -> unicode: ...
    def format_map(self, map: Mapping[basestring, Any]) -> unicode: ...
    def join(self, iterable: Iterable[basestring]) -> unicode: ...
    def ljust(self, width: int, fillchar: basestring = ...) -> unicode: ...
    def lower(self) -> unicode: ...
    def lstrip(self, chars: basestring = ...) -> unicode: ...
    def partition(self, sep: basestring) -> Tuple[unicode, unicode, unicode]: ...
    def replace(self, old: basestring, new: basestring, count: int = ...) -> unicode: ...
    def rjust(self, width: int, fillchar: basestring = ...) -> unicode: ...
    def rpartition(self, sep: basestring) -> Tuple[unicode, unicode, unicode]: ...
    def rsplit(self, sep: basestring = ..., maxsplit: int = ...) -> List[unicode]: ...
    def rstrip(self, chars: basestring = ...) -> unicode: ...
    def split(self, sep: basestring = ..., maxsplit: int = ...) -> List[unicode]: ...
    def splitlines(self, keepends: bool = ...) -> List[unicode]: ...
    def strip(self, chars: basestring = ...) -> unicode: ...
    ...
    def __add__(self, s: basestring) -> unicode: ...
...
class str(basestring, Sequence[str]):
    def __init__(self, object: object = None) -> None: ...

    def capitalize(self) -> str: ...
    def center(self, width: int, fillchar: basestring = ...) -> str: ...
    ...
    def ljust(self, width: int, fillchar: basestring = ...) -> str: ...
    def lower(self) -> str: ...
    ...
    def replace(self, old: basestring, new: basestring, count: int = ...) -> basestring: ...
    @overload
    def replace(self, old: unicode, new: basestring, count: int = ...) -> unicode: ...
    @overload
    def replace(self, old: basestring, new: unicode, count: int = ...) -> unicode: ...

    def rjust(self, width: int, fillchar: basestring = ...) -> str: ...
    ...
    @overload
    def rsplit(self, sep: basestring = ..., maxsplit: int = ...) -> List[basestring]: ...
    @overload
    ...
    @overload
    def split(self, sep: basestring = ..., maxsplit: int = ...) -> List[basestring]: ...
    @overload
    ...
    def title(self) -> str: ...
    def translate(self, table: str, deletechars: str = None) -> str: ...
    def upper(self) -> str: ...
...
# NOTE: Currently mypy treats bytearray as a subclass of str;
# when this changes there might be some surprises here...
