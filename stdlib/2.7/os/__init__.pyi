...
# TODO(MichalPokorny)
def fdopen(fd: int, *args: Any, **kwargs: Any) -> IO[Any]: ...
def popen(command: str, *args: Any, **kwargs: Any) -> Optional[IO[Any]]: ...
def tmpfile() -> IO[Any]: ...

def popen2(cmd: str, *args: Any, **kwargs: Any) -> Tuple[IO[Any], IO[Any]]: ...
def popen3(cmd: str, *args: Any, **kwargs: Any) -> Tuple[IO[Any], IO[Any], IO[Any]]: ...
def popen4(cmd: str, *args: Any, **kwargs: Any) -> Tuple[IO[Any], IO[Any]]: ...
...
def execl(file: AnyStr, *args: Any) -> None: ...
def execle(file: AnyStr, *args: Any) -> None: ...
def execlp(file: AnyStr, *args: Any) -> None: ...
