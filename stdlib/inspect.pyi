...
from typing import Any, ClassVar, NamedTuple, Optional, Tuple, Type, Union, TypeVar
...
if sys.version_info >= (3, 8):
    def isgeneratorfunction(obj: Union[Callable[P, Coroutine[_SendType, _YieldType, _T]], object]) -> TypeGuard[Callable[P, Coroutine[_SendType, _YieldType, _T]]]: ...
    def iscoroutinefunction(obj: Union[Callable[P, Generator[_SendType, _YieldType, _T]], object]) -> TypeGuard[Callable[P, Generator[_SendType, _YieldType, _T]]]: ...

else:
    def isgeneratorfunction(object: Union[Callable[P, Coroutine[_SendType, _YieldType, _T]], object]) -> TypeGuard[Callable[P, Generator[_SendType, _YieldType, _T]]]: ...
    def iscoroutinefunction(object: Union[Callable[P, Generator[_SendType, _YieldType, _T]], object]) -> TypeGuard[Callable[P, Generator[_SendType, _YieldType, _T]]]: ...

def isgenerator(object: Union[Generator[_SendType, _YieldType, _T], object]) -> TypeGuard[Generator[_SendType, _YieldType, _T]]: ...
def iscoroutine(object: Union[Generator[_SendType, _YieldType, _T], object]) -> TypeGuard[Generator[_SendType, _YieldType, _T]]: ...
def isawaitable(object: Union[Awaitable[_T], object]) -> TypeGuard[Awaitable[_T]]: ...

if sys.version_info >= (3, 8):
    def isasyncgenfunction(obj: Union[Callable[P, AsyncGenerator[_YieldType, _SendType]], object]) -> TypeGuard[Callable[P, AsyncGenerator[_YieldType, _SendType]]]: ...

else:
    def isasyncgenfunction(object: Union[Callable[P, AsyncGenerator[_YieldType, _SendType]], object]) -> TypeGuard[Callable[P, AsyncGenerator[_YieldType, _SendType]]]: ...

def isasyncgen(object: Union[AsyncGenerator[_YieldType, _SendType], object]) -> TypeGuard[AsyncGenerator[_YieldType, _SendType]]: ...
