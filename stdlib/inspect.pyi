...
def getgeneratorstate(generator: Generator[Any, Any, Any]) -> GEN_CREATED | GEN_RUNNING | GEN_SUSPENDED | GEN_CLOSED: ...
...
def getcoroutinestate(coroutine: CoroutineType[Any, Any, Any]) -> CORO_CREATED | CORO_RUNNING | CORO_SUSPENDED | CORO_CLOSED: ...
