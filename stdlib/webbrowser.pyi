...
if sys.version_info >= (3, 7):
    def register(
        name: str, klass: Optional[Callable[[], BaseBrowser]], instance: BaseBrowser | None = ..., *, preferred: bool = ...
    ) -> None: ...

else:
    def register(
        name: str, klass: Optional[Callable[[], BaseBrowser]], instance: BaseBrowser | None = ..., update_tryorder: int = ...
    ) -> None: ...
