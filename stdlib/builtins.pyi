...
if sys.version_info >= (3, 10):
    _IsInstanceClassInfo: TypeAlias = type | types.UnionType | tuple[type | types.UnionType | tuple[Any, ...], ...]
else:
...
def issubclass(__obj: object, __class_or_tuple: _IsInstanceClassInfo) -> bool: ...
