...
# See https://github.com/python/typeshed/pull/9141 on why we don't use
# `SupportsRound` from `typing.pyi`
...
# We need these overloads to replicate how stdlib works
@overload
def round(number: float, ndigits: None = ...) -> int: ...
@overload
def round(number: int, ndigits: SupportsIndex) -> int: ...
@overload
def round(number: float, ndigits: SupportsIndex) -> float: ...
@overload
