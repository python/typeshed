...
# anything that can be iterated over in a for loop
_Iterand = Iterable[_T] | _GetItemIterable[_T]  # noqa: Y026  # TODO: Use TypeAlias once mypy bugs are fixed
...
class int:
    ...
    if sys.version_info >= (3, 11):
        ...
        def from_bytes(
            cls,
            bytes: _Iterand[SupportsIndex] | SupportsBytes | ReadableBuffer,
...
class str(Sequence[str]):
    ...
    @overload
    def join(self: LiteralString, iterable: _Iterand[LiteralString], /) -> LiteralString: ...
    @overload
    def join(self, iterable: _Iterand[str], /) -> str: ...  # type: ignore[misc]
    @overload
...
class bytes(Sequence[int]):
    @overload
    def __new__(cls, o: _Iterand[SupportsIndex] | SupportsIndex | SupportsBytes | ReadableBuffer, /) -> Self: ...
    @overload
    ...
    def istitle(self) -> bool: ...
    def isupper(self) -> bool: ...
    def join(self, iterable_of_bytes: _Iterand[ReadableBuffer], /) -> bytes: ...
...
class bytearray(MutableSequence[int]):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, ints: _Iterand[SupportsIndex] | SupportsIndex | ReadableBuffer, /) -> None: ...
    @overload
    ...
    def extend(self, iterable_of_ints: _Iterand[SupportsIndex], /) -> None: ...
    def find(
        self, sub: ReadableBuffer | SupportsIndex, start: SupportsIndex | None = ..., end: SupportsIndex | None = ..., /
    ) -> int: ...
    def hex(self, sep: str | bytes = ..., bytes_per_sep: SupportsIndex = ...) -> str: ...
    ...
    def istitle(self) -> bool: ...
    def isupper(self) -> bool: ...
    def join(self, iterable_of_bytes: _Iterand[ReadableBuffer], /) -> bytearray: ...
    ...
    @overload
    def __setitem__(self, key: slice, value: _Iterand[SupportsIndex] | bytes, /) -> None: ...
...
class tuple(Sequence[_T_co]):
    def __new__(cls, iterable: _Iterand[_T_co] = ..., /) -> Self: ...
    def __len__(self) -> int: ...
...
class list(MutableSequence[_T]):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, iterable: _Iterand[_T], /) -> None: ...
    def copy(self) -> list[_T]: ...
    def append(self, object: _T, /) -> None: ...
    def extend(self, iterable: _Iterand[_T], /) -> None: ...
    ...
    @overload
    def __setitem__(self, key: slice, value: _Iterand[_T], /) -> None: ...
    def __delitem__(self, key: SupportsIndex | slice, /) -> None: ...
    ...
    def __iadd__(self, value: _Iterand[_T], /) -> Self: ...  # type: ignore[misc]
...
class dict(MutableMapping[_KT, _VT]):
    ...
    @overload
    def __init__(self, iterable: _Iterand[tuple[_KT, _VT]], /) -> None: ...
    @overload
    def __init__(
        self: dict[str, _VT],  # pyright: ignore[reportInvalidTypeVarUse]  #11780
        iterable: _Iterand[tuple[str, _VT]],
        /,
        **kwargs: _VT,
    ) -> None: ...
    ...
    @overload
    def __init__(self: dict[str, str], iterable: _Iterand[list[str]], /) -> None: ...
    @overload
    def __init__(self: dict[bytes, bytes], iterable: _Iterand[list[bytes]], /) -> None: ...
    ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: _Iterand[_T], value: None = None, /) -> dict[_T, Any | None]: ...
    @classmethod
    @overload
    def fromkeys(cls, iterable: _Iterand[_T], value: _S, /) -> dict[_T, _S]: ...
    ...
    if sys.version_info >= (3, 9):
        ...
        @overload
        def __ior__(self, value: _Iterand[tuple[_KT, _VT]], /) -> Self: ...
...
class set(MutableSet[_T]):
    ...
    def difference(self, *s: _Iterand[Any]) -> set[_T]: ...
    def difference_update(self, *s: _Iterand[Any]) -> None: ...
    def discard(self, element: _T, /) -> None: ...
    def intersection(self, *s: _Iterand[Any]) -> set[_T]: ...
    def intersection_update(self, *s: _Iterand[Any]) -> None: ...
    def isdisjoint(self, s: _Iterand[Any], /) -> bool: ...
    def issubset(self, s: _Iterand[Any], /) -> bool: ...
    def issuperset(self, s: _Iterand[Any], /) -> bool: ...
    def remove(self, element: _T, /) -> None: ...
    def symmetric_difference(self, s: _Iterand[_T], /) -> set[_T]: ...
    def symmetric_difference_update(self, s: _Iterand[_T], /) -> None: ...
    def union(self, *s: _Iterand[_S]) -> set[_T | _S]: ...
    def update(self, *s: _Iterand[_T]) -> None: ...
    def __len__(self) -> int: ...
...
class frozenset(AbstractSet[_T_co]):
    ...
    def difference(self, *s: _Iterand[object]) -> frozenset[_T_co]: ...
    def intersection(self, *s: _Iterand[object]) -> frozenset[_T_co]: ...
    def isdisjoint(self, s: _Iterand[_T_co], /) -> bool: ...
    def issubset(self, s: _Iterand[object], /) -> bool: ...
    def issuperset(self, s: _Iterand[object], /) -> bool: ...
    def symmetric_difference(self, s: _Iterand[_T_co], /) -> frozenset[_T_co]: ...
    def union(self, *s: _Iterand[_S]) -> frozenset[_T_co | _S]: ...
    def __len__(self) -> int: ...
    def __contains__(self, o: object, /) -> bool: ...
    def __iter__(self) -> Iterator[_T_co]: ...
...
class enumerate(Iterator[tuple[int, _T]]):
    def __new__(cls, iterable: _Iterand[_T], start: int = ...) -> Self: ...
...
def all(iterable: _Iterand[object], /) -> bool: ...
def any(iterable: _Iterand[object], /) -> bool: ...
...
class filter(Iterator[_T]):
    @overload
    def __new__(cls, function: None, iterable: _Iterand[_T | None], /) -> Self: ...
    @overload
    def __new__(cls, function: Callable[[_S], TypeGuard[_T]], iterable: _Iterand[_S], /) -> Self: ...
    @overload
    def __new__(cls, function: Callable[[_S], TypeIs[_T]], iterable: _Iterand[_S], /) -> Self: ...
    @overload
    def __new__(cls, function: Callable[[_T], Any], iterable: _Iterand[_T], /) -> Self: ...
    def __iter__(self) -> Self: ...
...
class map(Iterator[_S]):
    @overload
    def __new__(cls, func: Callable[[_T1], _S], iter1: _Iterand[_T1], /) -> Self: ...
    @overload
    def __new__(cls, func: Callable[[_T1, _T2], _S], iter1: _Iterand[_T1], iter2: _Iterand[_T2], /) -> Self: ...
    @overload
    def __new__(
        cls, func: Callable[[_T1, _T2, _T3], _S], iter1: _Iterand[_T1], iter2: _Iterand[_T2], iter3: _Iterand[_T3], /
    ) -> Self: ...
    @overload
    def __new__(
        cls,
...
@overload
def max(iterable: _Iterand[SupportsRichComparisonT], /, *, key: None = None) -> SupportsRichComparisonT: ...
@overload
def max(iterable: _Iterand[_T], /, *, key: Callable[[_T], SupportsRichComparison]) -> _T: ...
@overload
def max(iterable: _Iterand[SupportsRichComparisonT], /, *, key: None = None, default: _T) -> SupportsRichComparisonT | _T: ...
@overload
def max(iterable: _Iterand[_T1], /, *, key: Callable[[_T1], SupportsRichComparison], default: _T2) -> _T1 | _T2: ...
@overload
def min(
    arg1: SupportsRichComparisonT, arg2: SupportsRichComparisonT, /, *_args: SupportsRichComparisonT, key: None = None
) -> SupportsRichComparisonT: ...
...
@overload
def min(iterable: _Iterand[SupportsRichComparisonT], /, *, key: None = None) -> SupportsRichComparisonT: ...
@overload
def min(iterable: _Iterand[_T], /, *, key: Callable[[_T], SupportsRichComparison]) -> _T: ...
@overload
def min(iterable: _Iterand[SupportsRichComparisonT], /, *, key: None = None, default: _T) -> SupportsRichComparisonT | _T: ...
@overload
def min(iterable: _Iterand[_T1], /, *, key: Callable[[_T1], SupportsRichComparison], default: _T2) -> _T1 | _T2: ...
@overload
...
@overload
def sorted(
    iterable: _Iterand[SupportsRichComparisonT], /, *, key: None = None, reverse: bool = False
) -> list[SupportsRichComparisonT]: ...
@overload
def sorted(iterable: _Iterand[_T], /, *, key: Callable[[_T], SupportsRichComparison], reverse: bool = False) -> list[_T]: ...
...
@overload
def sum(iterable: _Iterand[bool | _LiteralInteger], /, start: int = 0) -> int: ...  # type: ignore[overload-overlap]
@overload
def sum(iterable: _Iterand[_SupportsSumNoDefaultT], /) -> _SupportsSumNoDefaultT | Literal[0]: ...
@overload
def sum(iterable: _Iterand[_AddableT1], /, start: _AddableT2) -> _AddableT1 | _AddableT2: ...
...
class zip(Iterator[_T_co]):
    if sys.version_info >= (3, 10):
        ...
        @overload
        def __new__(cls, iter1: _Iterand[_T1], /, *, strict: bool = ...) -> zip[tuple[_T1]]: ...
        @overload
        def __new__(cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], /, *, strict: bool = ...) -> zip[tuple[_T1, _T2]]: ...
        @overload
        def __new__(
            cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], iter3: _Iterand[_T3], /, *, strict: bool = ...
        ) -> zip[tuple[_T1, _T2, _T3]]: ...
        @overload
        def __new__(
            cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], iter3: _Iterand[_T3], iter4: _Iterand[_T4], /, *, strict: bool = ...
        ...
        @overload
        def __new__(cls, iter1: _Iterand[_T1], /) -> zip[tuple[_T1]]: ...
        @overload
        def __new__(cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], /) -> zip[tuple[_T1, _T2]]: ...
        @overload
        def __new__(cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], iter3: _Iterand[_T3], /) -> zip[tuple[_T1, _T2, _T3]]: ...
        @overload
        def __new__(
            cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], iter3: _Iterand[_T3], iter4: _Iterand[_T4], /
        ) -> zip[tuple[_T1, _T2, _T3, _T4]]: ...
        @overload
        def __new__(
            cls, iter1: _Iterand[_T1], iter2: _Iterand[_T2], iter3: _Iterand[_T3], iter4: _Iterand[_T4], iter5: _Iterand[_T5], /
        ) -> zip[tuple[_T1, _T2, _T3, _T4, _T5]]: ...
        @overload
        def __new__(
            cls,
