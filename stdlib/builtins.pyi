...
class int:
    ...
    if sys.version_info >= (3, 11):
        ...
        def from_bytes(
            cls: type[Self],
            bytes: IterableOrSupportsIntGetItem[SupportsIndex] | SupportsBytes | ReadableBuffer,
...
class str(Sequence[str]):
    ...
    @overload
    def join(self: LiteralString, __iterable: IterableOrSupportsIntGetItem[LiteralString]) -> LiteralString: ...
    @overload
    def join(self, __iterable: IterableOrSupportsIntGetItem[str]) -> str: ...  # type: ignore[misc]
    @overload
...
class bytes(ByteString):
    @overload
    def __new__(cls: type[Self], __ints: IterableOrSupportsIntGetItem[SupportsIndex]) -> Self: ...
    @overload
    ...
    def istitle(self) -> bool: ...
    def isupper(self) -> bool: ...
    def join(self, __iterable_of_bytes: IterableOrSupportsIntGetItem[ReadableBuffer]) -> bytes: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __ints: IterableOrSupportsIntGetItem[SupportsIndex]) -> None: ...
    @overload
    ...
    def extend(self, __iterable_of_ints: IterableOrSupportsIntGetItem[SupportsIndex]) -> None: ...
    def find(
        self, __sub: ReadableBuffer | SupportsIndex, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...
    ) -> int: ...
    if sys.version_info >= (3, 8):
    ...
    def istitle(self) -> bool: ...
    def isupper(self) -> bool: ...
    def join(self, __iterable_of_bytes: IterableOrSupportsIntGetItem[ReadableBuffer]) -> bytearray: ...
    ...
    @overload
    def __setitem__(self, __s: slice, __x: IterableOrSupportsIntGetItem[SupportsIndex] | bytes) -> None: ...
    def __delitem__(self, __i: SupportsIndex | slice) -> None: ...
    def __add__(self, __s: ReadableBuffer) -> bytearray: ...
    # The superclass wants us to accept IterableOrSupportsIntGetItem[int], but that fails at runtime.
...
class tuple(Sequence[_T_co], Generic[_T_co]):
    def __new__(cls: type[Self], __iterable: IterableOrSupportsIntGetItem[_T_co] = ...) -> Self: ...
    def __len__(self) -> int: ...
    def __contains__(self, __x: object) -> bool: ...
    @overload
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    def extend(self, __iterable: IterableOrSupportsIntGetItem[_T]) -> None: ...
    ...
    @overload
    def __setitem__(self, __s: slice, __o: IterableOrSupportsIntGetItem[_T]) -> None: ...
    def __delitem__(self, __i: SupportsIndex | slice) -> None: ...
    ...
    def __iadd__(self: Self, __x: IterableOrSupportsIntGetItem[_T]) -> Self: ...  # type: ignore[misc]
...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(self, __iterable: IterableOrSupportsIntGetItem[tuple[_KT, _VT]]) -> None: ...
    @overload
    def __init__(self: dict[str, _VT], __iterable: IterableOrSupportsIntGetItem[tuple[str, _VT]], **kwargs: _VT) -> None: ...
    # Next overload is for dict(string.split(sep) for string in iterable)
    # Cannot be IterableOrSupportsIntGetItem[Sequence[_T]] or otherwise dict(["foo", "bar", "baz"]) is not an error
    @overload
    def __init__(self: dict[str, str], __iterable: IterableOrSupportsIntGetItem[list[str]]) -> None: ...
    ...
    @classmethod
    @overload
    def fromkeys(cls, __iterable: IterableOrSupportsIntGetItem[_T], __value: None = ...) -> dict[_T, Any | None]: ...
    @classmethod
    @overload
    def fromkeys(cls, __iterable: IterableOrSupportsIntGetItem[_T], __value: _S) -> dict[_T, _S]: ...
    ...
    if sys.version_info >= (3, 9):
        ...
        @overload
        def __ior__(self: Self, __value: IterableOrSupportsIntGetItem[tuple[_KT, _VT]]) -> Self: ...
...
class set(MutableSet[_T], Generic[_T]):
    ...
    def difference(self, *s: IterableOrSupportsIntGetItem[Any]) -> set[_T]: ...
    def difference_update(self, *s: IterableOrSupportsIntGetItem[Any]) -> None: ...
    def discard(self, __element: _T) -> None: ...
    def intersection(self, *s: IterableOrSupportsIntGetItem[Any]) -> set[_T]: ...
    def intersection_update(self, *s: IterableOrSupportsIntGetItem[Any]) -> None: ...
    def isdisjoint(self, __s: IterableOrSupportsIntGetItem[Any]) -> bool: ...
    def issubset(self, __s: IterableOrSupportsIntGetItem[Any]) -> bool: ...
    def issuperset(self, __s: IterableOrSupportsIntGetItem[Any]) -> bool: ...
    def remove(self, __element: _T) -> None: ...
    def symmetric_difference(self, __s: IterableOrSupportsIntGetItem[_T]) -> set[_T]: ...
    def symmetric_difference_update(self, __s: IterableOrSupportsIntGetItem[_T]) -> None: ...
    def union(self, *s: IterableOrSupportsIntGetItem[_S]) -> set[_T | _S]: ...
    def update(self, *s: IterableOrSupportsIntGetItem[_T]) -> None: ...
    def __len__(self) -> int: ...
    def __contains__(self, __o: object) -> bool: ...
    def __iter__(self) -> Iterator[_T]: ...
...
class frozenset(AbstractSet[_T_co], Generic[_T_co]):
    ...
    def difference(self, *s: IterableOrSupportsIntGetItem[object]) -> frozenset[_T_co]: ...
    def intersection(self, *s: IterableOrSupportsIntGetItem[object]) -> frozenset[_T_co]: ...
    def isdisjoint(self, __s: IterableOrSupportsIntGetItem[_T_co]) -> bool: ...
    def issubset(self, __s: IterableOrSupportsIntGetItem[object]) -> bool: ...
    def issuperset(self, __s: IterableOrSupportsIntGetItem[object]) -> bool: ...
    def symmetric_difference(self, __s: IterableOrSupportsIntGetItem[_T_co]) -> frozenset[_T_co]: ...
    def union(self, *s: IterableOrSupportsIntGetItem[_S]) -> frozenset[_T_co | _S]: ...
    def __len__(self) -> int: ...
    def __contains__(self, __o: object) -> bool: ...
    def __iter__(self) -> Iterator[_T_co]: ...
...
class enumerate(Iterator[tuple[int, _T]], Generic[_T]):
    def __init__(self, iterable: IterableOrSupportsIntGetItem[_T], start: int = ...) -> None: ...
...
def all(__iterable: IterableOrSupportsIntGetItem[object]) -> bool: ...
def any(__iterable: IterableOrSupportsIntGetItem[object]) -> bool: ...
...
class filter(Iterator[_T], Generic[_T]):
    @overload
    def __init__(self, __function: None, __iterable: IterableOrSupportsIntGetItem[_T | None]) -> None: ...
    @overload
    def __init__(self, __function: Callable[[_S], TypeGuard[_T]], __iterable: IterableOrSupportsIntGetItem[_S]) -> None: ...
    @overload
    def __init__(self, __function: Callable[[_T], Any], __iterable: IterableOrSupportsIntGetItem[_T]) -> None: ...
    def __iter__(self: Self) -> Self: ...
...
@overload
def iter(__iterable: SupportsIntGetItem[_T]) -> Iterator[_T]: ...
@overload
...
class map(Iterator[_S], Generic[_S]):
    @overload
    def __init__(self, __func: Callable[[_T1], _S], __iter1: IterableOrSupportsIntGetItem[_T1]) -> None: ...
    @overload
    def __init__(
        self,
...
@overload
def max(__iterable: IterableOrSupportsIntGetItem[SupportsRichComparisonT], *, key: None = ...) -> SupportsRichComparisonT: ...
@overload
def max(__iterable: IterableOrSupportsIntGetItem[_T], *, key: Callable[[_T], SupportsRichComparison]) -> _T: ...
@overload
def max(__iterable: IterableOrSupportsIntGetItem[SupportsRichComparisonT], *, key: None = ..., default: _T) -> SupportsRichComparisonT | _T: ...
@overload
def max(__iterable: IterableOrSupportsIntGetItem[_T1], *, key: Callable[[_T1], SupportsRichComparison], default: _T2) -> _T1 | _T2: ...
@overload
def min(
    __arg1: SupportsRichComparisonT, __arg2: SupportsRichComparisonT, *_args: SupportsRichComparisonT, key: None = ...
) -> SupportsRichComparisonT: ...
...
@overload
def min(__iterable: IterableOrSupportsIntGetItem[SupportsRichComparisonT], *, key: None = ...) -> SupportsRichComparisonT: ...
@overload
def min(__iterable: IterableOrSupportsIntGetItem[_T], *, key: Callable[[_T], SupportsRichComparison]) -> _T: ...
@overload
def min(__iterable: IterableOrSupportsIntGetItem[SupportsRichComparisonT], *, key: None = ..., default: _T) -> SupportsRichComparisonT | _T: ...
@overload
def min(__iterable: IterableOrSupportsIntGetItem[_T1], *, key: Callable[[_T1], SupportsRichComparison], default: _T2) -> _T1 | _T2: ...
@overload
...
@overload
def sorted(
    __iterable: IterableOrSupportsIntGetItem[SupportsRichComparisonT], *, key: None = ..., reverse: bool = ...
) -> list[SupportsRichComparisonT]: ...
@overload
def sorted(__iterable: IterableOrSupportsIntGetItem[_T], *, key: Callable[[_T], SupportsRichComparison], reverse: bool = ...) -> list[_T]: ...
...
if sys.version_info >= (3, 8):
    @overload
    def sum(__iterable: IterableOrSupportsIntGetItem[bool | _LiteralInteger], start: int = ...) -> int: ...  # type: ignore[misc]

else:
    @overload
    def sum(__iterable: IterableOrSupportsIntGetItem[bool | _LiteralInteger], __start: int = ...) -> int: ...  # type: ignore[misc]

@overload
def sum(__iterable: IterableOrSupportsIntGetItem[_SupportsSumNoDefaultT]) -> _SupportsSumNoDefaultT | Literal[0]: ...

if sys.version_info >= (3, 8):
    @overload
    def sum(__iterable: IterableOrSupportsIntGetItem[_AddableT1], start: _AddableT2) -> _AddableT1 | _AddableT2: ...

else:
    @overload
    def sum(__iterable: IterableOrSupportsIntGetItem[_AddableT1], __start: _AddableT2) -> _AddableT1 | _AddableT2: ...
...
class zip(Iterator[_T_co], Generic[_T_co]):
    if sys.version_info >= (3, 10):
        @overload
        def __new__(cls, __iter1: IterableOrSupportsIntGetItem[_T1], *, strict: bool = ...) -> zip[tuple[_T1]]: ...
        @overload
        def __new__(
            cls,
            __iter1: IterableOrSupportsIntGetItem[_T1],
        ...
        @overload
        def __new__(cls, __iter1: IterableOrSupportsIntGetItem[_T1]) -> zip[tuple[_T1]]: ...
        @overload
        def __new__(
            cls,
            __iter1: IterableOrSupportsIntGetItem[_T1],
