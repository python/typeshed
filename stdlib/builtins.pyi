...
if sys.version_info >= (3, 15):
    ...
    class frozendict(Mapping[_KT, _VT]):
        ...
        def __init__(self, map: SupportsKeysAndGetItem[_KT, _VT], /) -> None: ...
        @overload
        def __init__(self: frozendict[str, _VT], map: SupportsKeysAndGetItem[str, _VT], /, **kwargs: _VT) -> None: ...
        @overload
        def __init__(self, iterable: Iterable[tuple[_KT, _VT]], /) -> None: ...
        @overload
        def __init__(self: frozendict[str, _VT], iterable: Iterable[tuple[str, _VT]], /, **kwargs: _VT) -> None: ...
        def __new__(cls, /, *args: Any, **kwargs: Any) -> Self: ...
        def copy(self) -> dict[_KT, _VT]: ...
        def keys(self) -> dict_keys[_KT, _VT]: ...
        def values(self) -> dict_values[_KT, _VT]: ...
        ...
        def __hash__(self) -> int: ...
        def __class_getitem__(cls, item: Any, /) -> GenericAlias: ...
        def __or__(self, value: Mapping[_T1, _T2], /) -> frozendict[_KT | _T1, _VT | _T2]: ...
        def __ror__(self, value: Mapping[_T1, _T2], /) -> frozendict[_KT | _T1, _VT | _T2]: ...
