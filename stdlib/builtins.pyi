...
from collections.abc import Awaitable, Callable, Iterable, Iterator, MutableSet, Reversible, Set as AbstractSet
...
class _SupportsLen(Protocol[_N_co]):
    def __len__(self) -> _N_co: ...

def len(obj: _SupportsLen[_N], /) -> _N: ...
def license() -> None: ...
