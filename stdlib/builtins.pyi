...
class set(MutableSet[_T]):
    ...
    def discard(self, __element: _T | None) -> None: ...
    ...
    @overload  # type: ignore[override]
    def __sub__(self: AbstractSet[_S | None], __value: AbstractSet[None]) -> set[_S]: ...
    @overload
    def __sub__(self, __value: AbstractSet[_T | None]) -> set[_T]: ...
    def __isub__(self, __value: AbstractSet[_T | None]) -> Self: ...  # type: ignore[misc]
...
class frozenset(AbstractSet[_T_co]):
    ...
    @overload  # type: ignore[override]
    def __sub__(self: AbstractSet[_S | None], __value: AbstractSet[None]) -> frozenset[_S]: ...
    @overload
    def __sub__(self, __value: AbstractSet[_T_co | None]) -> frozenset[_T_co]: ...
