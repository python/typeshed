...
class property(Generic[_F, _G]):
    ...
    def getter(self, fget: Callable[[_F], _G]) -> property[_F, _G]: ...
    def setter(self, fset: Callable[[_F, _G], None]) -> property[_F, _G]: ...
    def deleter(self, fdel: Callable[[_G], None]) -> property[_F, _G]: ...
    @overload
    def __get__(self, obj: _F, type: type | None = ...) -> _G: ...
    @overload
    def __get__(self, obj: None, type: type | None = ...) -> property[_F, _G]: ...
    def __set__(self, obj: _F, value: _G) -> None: ...
    def __delete__(self, obj: _G) -> None: ...
