...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    # Next overload is specifically for dict(string.split(sep) for string in iterable)
    @overload
    def __init__(self: dict[str, str], iterable: Iterable[list[str]], **kwargs: str) -> None: ...
