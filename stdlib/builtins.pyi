...
class int:
    ...
    @overload
    def __new__(cls: Type[_T], x: str | bytes | bytearray, base: int) -> _T: ...
    ...
    @classmethod
    def from_bytes(
        cls, bytes: Iterable[int] | SupportsBytes, byteorder: str, *, signed: bool = ...
    ...
    def __round__(self, ndigits: int | None = ...) -> int: ...
...
class complex:
    ...
    @overload
    def __new__(cls: Type[_T], real: str | SupportsComplex | SupportsIndex) -> _T: ...
    @property
    def real(self) -> float: ...
    @property
    def imag(self) -> float: ...
...
class bytes(ByteString):
    ...
    def count(self, __sub: bytes | int, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...) -> int: ...
    def decode(self, encoding: str = ..., errors: str = ...) -> str: ...
    def endswith(
        self, __suffix: bytes | Tuple[bytes, ...], __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...
    ) -> bool: ...
    def expandtabs(self, tabsize: int = ...) -> bytes: ...
    def find(self, __sub: bytes | int, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...) -> int: ...
    if sys.version_info >= (3, 8):
        def hex(self, sep: str | bytes = ..., bytes_per_sep: int = ...) -> str: ...
    else:
        def hex(self) -> str: ...
    def index(self, __sub: bytes | int, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...) -> int: ...
    def isalnum(self) -> bool: ...
    def isalpha(self) -> bool: ...
    if sys.version_info >= (3, 7):
        def isascii(self) -> bool: ...
    ...
    def rfind(self, __sub: bytes | int, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...) -> int: ...
    def rindex(self, __sub: bytes | int, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...) -> int: ...
    def rjust(self, __width: int, __fillchar: bytes = ...) -> bytes: ...
    def rpartition(self, __sep: bytes) -> Tuple[bytes, bytes, bytes]: ...
    def rsplit(self, sep: bytes | None = ..., maxsplit: int = ...) -> List[bytes]: ...
    def rstrip(self, __bytes: bytes | None = ...) -> bytes: ...
    def split(self, sep: bytes | None = ..., maxsplit: int = ...) -> List[bytes]: ...
...
@overload
def getattr(__o: Any, name: str, __default: None) -> Any | None: ...
@overload
def getattr(__o: Any, name: str, __default: bool) -> Any | bool: ...
@overload
def getattr(__o: Any, name: str, __default: _T) -> Any | _T: ...
...
if sys.version_info >= (3, 10):
    ...
    def isinstance(__obj: object, __class_or_tuple: Union[type, Tuple[type | Tuple[Any, ...], ...]]) -> bool: ...
    def issubclass(__cls: type, __class_or_tuple: Union[type, Tuple[type | Tuple[Any, ...], ...]]) -> bool: ...
