...
class _SupportsSum(Protocol[_T]):
    def __add__(self, __x: _T) -> _T: ...

@overload
def sum(__iterable: Iterable[_SupportsSum[_T]]) -> _T | Literal[0]: ...

if sys.version_info >= (3, 8):
    @overload
    def sum(__iterable: Iterable[_SupportsSum[_T]], start: _SupportsSum[_S]) -> _SupportsSum[_T] | _SupportsSum[_S]: ...

else:
    @overload
    def sum(__iterable: Iterable[_SupportsSum[_T]], __start: _SupportsSum[_S]) -> _SupportsSum[_T] | _SupportsSum[_S]: ...
