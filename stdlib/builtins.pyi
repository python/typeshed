...
@overload
def iter(__iterable: Iterable[_T]) -> SupportsNext[_T]: ...
@overload
def iter(__function: Callable[[], _T | None], __sentinel: None) -> SupportsNext[_T]: ...
@overload
def iter(__function: Callable[[], _T], __sentinel: Any) -> SupportsNext[_T]: ...
