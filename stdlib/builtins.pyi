...
class int:
    ...
    @overload
    def __pow__(self, __x: int, __modulo: int | None = ...) -> int | float: ...  # Return type can be int or float, depending on x.
    def __rpow__(self, __x: int, __mod: int | None = ...) -> int | float: ...
...
class float:
    ...
    if sys.version_info < (3, 0):
        ...
        @overload
        def __pow__(self, __x: float, __mod: None = ...) -> float | complex: ...
    ...
    if sys.version_info < (3, 0):
        ...
        def __rpow__(self, __x: float, __mod: None = ...) -> float | complex: ...
...
if sys.version_info >= (3, 8):
    ...
    @overload
    def pow(base: int, exp: Literal[2], mod: None = ...) -> int: ...
    @overload
    def pow(base: int, exp: Literal[3], mod: None = ...) -> int: ...
    @overload
    def pow(base: int, exp: int, mod: None = ...) -> int | float: ...  # returns int or float depending on whether exp is non-negative
    @overload
    def pow(base: int, exp: int, mod: int) -> int: ...
    @overload
    def pow(base: float, exp: int, mod: None = ...) -> float: ...
    @overload
    def pow(base: float, exp: float, mod: None = ...) -> float | complex: ...
    @overload
    ...
    @overload
    def pow(__base: int, __exp: Literal[2], __mod: None = ...) -> int: ...
    @overload
    def pow(__base: int, __exp: Literal[3], __mod: None = ...) -> int: ...
    @overload
    def pow(__base: int, __exp: int, __mod: None = ...) -> int | float: ...  # returns int or float depending on whether exp is non-negative
    @overload
    def pow(__base: int, __exp: int, __mod: int) -> int: ...
    @overload
    def pow(__base: float, __exp: int, __mod: None = ...) -> float: ...
    @overload
    def pow(__base: float, __exp: float, __mod: None = ...) -> float | complex: ...
    @overload
