...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @classmethod
    @overload
    def fromkeys(cls, __iterable: Iterable[_T], __value: None = ...) -> dict[_T, object | None]: ...
    @classmethod
    @overload
...
def eval(
    __source: str | bytes | CodeType, __globals: dict[str, object] | None = ..., __locals: Mapping[str, object] | None = ...
) -> object: ...
def exec(
    __source: str | bytes | CodeType, __globals: dict[str, object] | None = ..., __locals: Mapping[str, object] | None = ...
) -> object: ...
...
@overload
def getattr(__o: object, __name: str) -> object: ...
...
@overload
def getattr(__o: object, __name: str, __default: None) -> object | None: ...
@overload
def getattr(__o: object, __name: str, __default: bool) -> object | bool: ...
@overload
def getattr(__o: object, __name: str, __default: _T) -> object | _T: ...
...
if sys.version_info >= (3, 10):
    def isinstance(
        __obj: object, __class_or_tuple: type | types.UnionType | Tuple[type | types.UnionType | Tuple[object, ...], ...]
    ) -> bool: ...
    def issubclass(
        __cls: type, __class_or_tuple: type | types.UnionType | Tuple[type | types.UnionType | Tuple[object, ...], ...]
    ) -> bool: ...

else:
    def isinstance(__obj: object, __class_or_tuple: type | Tuple[type | Tuple[object, ...], ...]) -> bool: ...
    def issubclass(__cls: type, __class_or_tuple: type | Tuple[type | Tuple[object, ...], ...]) -> bool: ...
...
def setattr(__obj: object, __name: str, __value: object) -> None: ...
@overload
...
def vars(__object: object = ...) -> dict[str, object]: ...
