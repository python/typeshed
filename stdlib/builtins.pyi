...
class tuple(Sequence[_T_co], Generic[_T_co]):
    ...
    def index(self, __value: Any, __start: SupportsIndex = 0, __stop: SupportsIndex = 9223372036854775807) -> int: ...
    if sys.version_info >= (3, 9):
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    def index(self, __value: _T, __start: SupportsIndex = 0, __stop: SupportsIndex = 9223372036854775807) -> int: ...
...
def eval(
    __source: str | ReadableBuffer | CodeType, __globals: dict[str, Any] | None = None, __locals: Mapping[str, object] | None = None
) -> Any: ...
