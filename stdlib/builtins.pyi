...
class bytes(ByteString):
    ...
    def count(
        self, __sub: bytes | int, __start: SupportsIndex | None = ..., __end: SupportsIndex | None = ...
    ) -> int: ...
...
def eval(
    __source: str | bytes | CodeType, __globals: Optional[Dict[str, Any]] = ..., __locals: Optional[Mapping[str, Any]] = ...
) -> Any: ...
def exec(
    __source: str | bytes | CodeType, __globals: Optional[Dict[str, Any]] = ..., __locals: Optional[Mapping[str, Any]] = ...
) -> Any: ...
