...
class tuple(Sequence[_T_co]):
    def __new__(cls, iterable: Iterable[_T_co] | _GetItemIterable[_T_co] = ..., /) -> Self: ...
    def __len__(self) -> int: ...
...
class list(MutableSequence[_T]):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, iterable: Iterable[_T] | _GetItemIterable[_T], /) -> None: ...
...
class frozenset(AbstractSet[_T_co]):
    ...
    def __new__(cls) -> Self: ...
    @overload
    def __new__(cls, iterable: Iterable[_T_co] | _GetItemIterable[_T], /) -> Self: ...
...
class enumerate(Iterator[tuple[int, _T]]):
    def __new__(cls, iterable: Iterable[_T] | _GetItemIterable[_T], start: int = ...) -> Self: ...
