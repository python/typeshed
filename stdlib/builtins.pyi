...
_StartEndArg = Optional[Union[int, SupportsIndex]]
...
class str(Sequence[str]):
    ...
    def count(self, x: str, __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    def encode(self, encoding: str = ..., errors: str = ...) -> bytes: ...
    def endswith(self, __suffix: Union[str, Tuple[str, ...]], __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> bool: ...
    def expandtabs(self, tabsize: int = ...) -> str: ...
    def find(self, __sub: str, __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    def format(self, *args: object, **kwargs: object) -> str: ...
    def format_map(self, map: _FormatMapMapping) -> str: ...
    def index(self, __sub: str, __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    ...
    def rfind(self, __sub: str, __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    def rindex(self, __sub: str, __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    ...
    def startswith(
        self, __prefix: Union[str, Tuple[str, ...]], __start: _StartEndArg = ..., __end: _StartEndArg = ...
    ) -> bool: ...
...
class bytes(ByteString):
    ...
    def count(self, __sub: Union[bytes, int], __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    def decode(self, encoding: str = ..., errors: str = ...) -> str: ...
    def endswith(
        self, __suffix: Union[bytes, Tuple[bytes, ...]], __start: _StartEndArg = ..., __end: _StartEndArg = ...
    ) -> bool: ...
    def expandtabs(self, tabsize: int = ...) -> bytes: ...
    def find(self, __sub: Union[bytes, int], __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    if sys.version_info >= (3, 8):
        def hex(self, sep: Union[str, bytes] = ..., bytes_per_sep: int = ...) -> str: ...
    else:
        def hex(self) -> str: ...
    def index(self, __sub: Union[bytes, int], __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    def isalnum(self) -> bool: ...
    def isalpha(self) -> bool: ...
    if sys.version_info >= (3, 7):
        def isascii(self) -> bool: ...
    ...
    def rfind(self, __sub: Union[bytes, int], __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    def rindex(self, __sub: Union[bytes, int], __start: _StartEndArg = ..., __end: _StartEndArg = ...) -> int: ...
    ...
    def startswith(
        self, __prefix: Union[bytes, Tuple[bytes, ...]], __start: _StartEndArg = ..., __end: _StartEndArg = ...
    ) -> bool: ...
