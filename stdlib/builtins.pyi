...
@overload
def max(
    __iterable: IterableOrSupportsIntGetItem[SupportsRichComparisonT], *, key: None = ..., default: _T
) -> SupportsRichComparisonT | _T: ...
@overload
def max(
    __iterable: IterableOrSupportsIntGetItem[_T1], *, key: Callable[[_T1], SupportsRichComparison], default: _T2
) -> _T1 | _T2: ...
@overload
def min(
    __arg1: SupportsRichComparisonT, __arg2: SupportsRichComparisonT, *_args: SupportsRichComparisonT, key: None = ...
...
@overload
def sorted(
    __iterable: IterableOrSupportsIntGetItem[_T], *, key: Callable[[_T], SupportsRichComparison], reverse: bool = ...
) -> list[_T]: ...
...
class zip(Iterator[_T_co], Generic[_T_co]):
    if sys.version_info >= (3, 10):
        ...
        @overload
        def __new__(
            cls, __iter1: IterableOrSupportsIntGetItem[_T1], __iter2: IterableOrSupportsIntGetItem[_T2], *, strict: bool = ...
        ) -> zip[tuple[_T1, _T2]]: ...
        @overload
        def __new__(
            cls,
