...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    # __init__() and update() must match
    @overload
    ...
    # dict.update() with no arguments works at runtime, but it does nothing and is likely a typo
    @overload
    def update(self: dict[str, _VT], **kwargs: _VT) -> None: ...
    @overload
    def update(self, __map: SupportsKeysAndGetItem[_KT, _VT], **kwargs: _VT) -> None: ...
    @overload
    def update(self, __iterable: Iterable[Tuple[_KT, _VT]], **kwargs: _VT) -> None: ...
    @overload
    def update(self: dict[str, str], __iterable: Iterable[list[str]]) -> None: ...
