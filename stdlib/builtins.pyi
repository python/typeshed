...
class slice(Generic[_StartT_co, _StopT_co, _StepT_co]):
    ...
    # unary overloads ------------------------------------------------------------------
    @overload  # 0x None
    def __new__(cls, stop: _T2, /) -> slice[_T2 | None, _T2 | None, Any]: ...
    # binary overloads -----------------------------------------------------------------
    @overload  # 1x None
    def __new__(cls, start: _T1, stop: None, step: None = None, /) -> slice[_T1 | None, _T1 | None, Any]: ...
    @overload  # 1x None
    def __new__(cls, start: None, stop: _T2, step: None = None, /) -> slice[_T2 | None, _T2 | None, Any]: ...
    @overload  # 0x None
