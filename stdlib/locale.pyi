...
if sys.platform == "linux" or sys.platform == "darwin":
    ...
    def dgettext(__domain: _str, __msg: _str) -> _str: ...
    def dcgettext(__domain: _str, __msg: _str, __category: _str) -> _str: ...
    def textdomain(__domain: _str | None) -> _str | None: ...
    def bindtextdomain(__domain: _str, __dir: _str) -> _str | None: ...
