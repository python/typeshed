...
def gettext(msg: _str) -> _str: ...
def dgettext(domain: _str, msg: _str) -> _str: ...
def dcgettext(domain: _str, msg: _str, category: _str) -> _str: ...
def textdomain(domain: _str | None) -> _str | None: ...
def bindtextdomain(domain: _str, dir: _str) -> _str | None: ...
