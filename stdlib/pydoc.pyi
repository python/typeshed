...
def visiblename(name: str, all: Optional[Container[str]] = ..., obj: object | None = ...) -> bool: ...
...
class HTMLDoc(Doc):
    ...
    def formattree(
        self, tree: List[Union[Tuple[type, Tuple[type, ...]], List[Any]]], modname: str, parent: type | None = ...
    ) -> str: ...
...
def resolve(thing: str | object, forceload: bool = ...) -> Optional[Tuple[object, str]]: ...
def render_doc(thing: str | object, title: str = ..., forceload: bool = ..., renderer: Doc | None = ...) -> str: ...
def doc(
    thing: str | object, title: str = ..., forceload: bool = ..., output: Optional[SupportsWrite[str]] = ...
) -> None: ...
