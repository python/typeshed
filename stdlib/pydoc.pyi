...
def visiblename(name: str, all: Container[str] | None = None, obj: object | None = None) -> bool: ...
...
def safeimport(path: str, forceload: bool = 0, cache: MutableMapping[str, ModuleType] = ...) -> ModuleType: ...
...
def locate(path: str, forceload: bool = 0) -> object: ...

text: TextDoc
html: HTMLDoc

def resolve(thing: str | object, forceload: bool = 0) -> tuple[object, str] | None: ...
def render_doc(thing: str | object, title: str = 'Python Library Documentation: %s', forceload: bool = 0, renderer: Doc | None = None) -> str: ...
def doc(thing: str | object, title: str = 'Python Library Documentation: %s', forceload: bool = 0, output: SupportsWrite[str] | None = None) -> None: ...
def writedoc(thing: str | object, forceload: bool = 0) -> None: ...
