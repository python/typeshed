...
def render_doc(thing: str | object, title: str = 'Python Library Documentation: %s', forceload: bool = ..., renderer: Doc | None = None) -> str: ...
def doc(thing: str | object, title: str = 'Python Library Documentation: %s', forceload: bool = ..., output: SupportsWrite[str] | None = None) -> None: ...
