...
class Pickler:
    ...
    @property
    def memo(self) -> _PicklerMemoProxy: ...
    @memo.setter
    def memo(self, value: _PicklerMemoProxy | dict[int, tuple[int, Any]]) -> None: ...
...
class Unpickler:
    ...
    @property
    def memo(self) -> _UnpicklerMemoProxy: ...
    @memo.setter
    def memo(self, value: _UnpicklerMemoProxy | dict[int, tuple[int, Any]]) -> None: ...
    def load(self) -> Any: ...
