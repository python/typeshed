...
def _create_formatters(cp: Dict[_TKey, _TValue]) -> Dict[_TKey, _TValue]: ...
def _install_handlers(
    cp: Dict[_TKey, _TValue], formatters: Dict[_TKey, _TValue]
) -> Dict[_TKey, _TValue]: ...
def _handle_existing_loggers(
    existing: List[Union[str, Logger]], child_loggers: List[Union[str, Logger]], disable_existing: bool
) -> None: ...
def _install_loggers(cp: Dict[_TKey, _TValue], handlers: Dict[_TKey, _TValue], disable_existing: bool) -> None: ...
...
class DictConfigurator(BaseConfigurator[_TKey, _TValue]):
    ...
    def common_logger_config(
        self, logger: Logger, config: Dict[_TKey, _TValue], incremental: Optional[bool] = ...
    ) -> None: ...
    def configure_logger(
        self, name: str, config: Dict[_TKey, _TValue], incremental: Optional[bool] = ...
    ) -> None: ...
