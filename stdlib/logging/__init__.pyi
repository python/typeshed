...
class LoggerAdapter:
    ...
    if sys.version_info >= (3, 10):
        ...
        def __init__(self, logger: Logger | LoggerAdapter, extra: Optional[MutableMapping[str, Any]]) -> None: ...
    else:
        extra: Mapping[str, Any]
        def __init__(self, logger: Logger | LoggerAdapter, extra: MutableMapping[str, Any]) -> None: ...
