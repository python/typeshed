...
class TestResult:
    ...
    tb_locals: bool
    def __init__(
        self, stream: TextIO | None = ..., descriptions: bool | None = ..., verbosity: int | None = ...
    ) -> None: ...
    ...
    def addSubTest(
        self, test: unittest.case.TestCase, subtest: unittest.case.TestCase, err: _SysExcInfoType | None
    ) -> None: ...
