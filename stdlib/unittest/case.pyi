...
class TestCase:
    ...
    if sys.version_info >= (3, 14):
        def assertIsSubclass(self, cls: type[Any], superclass: type[Any] | tuple[type[Any], ...], msg: Any = None) -> None: ...
        def assertNotIsSubclass(self, cls: type[Any], superclass: type[Any] | tuple[type[Any], ...], msg: Any = None) -> None: ...
