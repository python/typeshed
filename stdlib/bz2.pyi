...
class BZ2File(BaseStream, IO[bytes]):
    ...
    def write(self, data: ReadableBuffer) -> int: ...  # type: ignore[override]  # https://github.com/python/mypy/issues/14002
    def writelines(self, seq: Iterable[ReadableBuffer]) -> None: ...  # type: ignore[override]  # https://github.com/python/mypy/issues/14002
