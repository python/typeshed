...
class Random(_random.Random):
    ...
    if sys.version_info >= (3, 9):
        def sample(
            self, population: Sequence[_T] | Set[_T], k: int, *, counts: Optional[Iterable[_T]] = ...
        ) -> list[_T]: ...
    else:
...
if sys.version_info >= (3, 9):
    def sample(population: Sequence[_T] | Set[_T], k: int, *, counts: Optional[Iterable[_T]] = ...) -> list[_T]: ...
