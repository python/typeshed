...
class Random(_random.Random):
    ...
    gauss_next: float | None  # undocumented
    ...
    def getstate(self) -> tuple[int, _random._State, float | None]: ...  # type: ignore[override]
    def setstate(self, state: tuple[int, _random._State, float | None]) -> None: ...  # type: ignore[override]
...
def getstate() -> tuple[int, _random._State, float | None]: ...
def setstate(state: tuple[int, _random._State, float | None]) -> None: ...
