...
class TestCase(Testable):
    ...
    def assertAlmostEquals(self, first: float, second: float, places: Optional[int] = ...,
                           msg: object = ...,
                           delta: Optional[float] = ...) -> None: ...
    def failUnlessAlmostEqual(self, first: float, second: float, places: int = ...,
                              msg: object = ...) -> None: ...
    def assertNotAlmostEqual(self, first: float, second: float, places: Optional[int] = ...,
                             msg: object = ...,
                             delta: Optional[float] = ...) -> None: ...
    def assertNotAlmostEquals(self, first: float, second: float, places: Optional[int] = ...,
                              msg: object = ...,
                              delta: Optional[float] = ...) -> None: ...
