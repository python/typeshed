...
def getclasstree(classes: List[type], unique: bool = ...) -> List[Union[Tuple[type, Tuple[type, ...]], list]]: ...

ArgSpec = NamedTuple(
    "ArgSpec", [("args", List[str]), ("varargs", Optional[str]), ("keywords", Optional[str]), ("defaults", tuple)]
)
...
Arguments = NamedTuple(
    "Arguments", [("args", List[Union[str, List[Any]]]), ("varargs", Optional[str]), ("keywords", Optional[str])]
)
