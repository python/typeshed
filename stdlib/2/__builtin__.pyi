...
if sys.version_info >= (3, 6):
    ...
    def compile(
        ...
        filename: Union[str, bytes, _PathLike],
        mode: str,
        flags: int = ...,
        dont_inherit: int = ...,
        optimize: int = ...,
...
if sys.version_info >= (3,):
    ...
    @overload
    def filter(
        __function: Callable[[AnyStr], Any],  # type: ignore
        __iterable: AnyStr,
    ) -> AnyStr: ...
    @overload
    def filter(
        __function: None,  # type: ignore
        __iterable: Tuple[Optional[_T], ...],
    ) -> Tuple[_T, ...]: ...
    @overload
    def filter(
        __function: Callable[[_T], Any],  # type: ignore
        __iterable: Tuple[_T, ...],
    ) -> Tuple[_T, ...]: ...
    @overload
...
if sys.version_info >= (3, 6):
    def open(
        file: Union[str, bytes, int, _PathLike],
        mode: str = ...,
        buffering: int = ...,
...
if sys.version_info >= (3,):
    def sorted(__iterable: Iterable[_T], *, key: Optional[Callable[[_T], Any]] = ..., reverse: bool = ...) -> List[_T]: ...

else:
    def sorted(
        __iterable: Iterable[_T], *, cmp: Callable[[_T, _T], int] = ..., key: Callable[[_T], Any] = ..., reverse: bool = ...
    ) -> List[_T]: ...
...
def __import__(
    name: Text, globals: Dict[str, Any] = ..., locals: Dict[str, Any] = ..., fromlist: List[str] = ..., level: int = ...
) -> Any: ...
