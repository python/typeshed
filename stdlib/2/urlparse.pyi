...
class SplitResult(
    NamedTuple("SplitResult", [("scheme", str), ("netloc", str), ("path", str), ("query", str), ("fragment", str)]), ResultMixin
):
    def geturl(self) -> str: ...

class ParseResult(
    NamedTuple(
        "ParseResult", [("scheme", str), ("netloc", str), ("path", str), ("params", str), ("query", str), ("fragment", str)]
    ),
    ResultMixin,
):
    def geturl(self) -> str: ...
