...
import sys
from typing import Any, Tuple, Text, Union
...
if sys.version_info >= (3,):
    ...
    _WriteBufferType = Union[bytearray, memoryview]
else:
    _BufferType = Union[bytes, bytearray, buffer, memoryview]
    _WriteBufferType = Union[bytearray, buffer, memoryview]
...
class Struct:
    ...
    def __init__(self, format: Union[bytes, Text]) -> None: ...
