...
from typing import overload, List, Any, Tuple, BinaryIO, TextIO, TypeVar, Callable, AnyStr, Union
EitherStr = Union[bytes, unicode]
...
def exists(path: EitherStr) -> bool: ...
def lexists(path: EitherStr) -> bool: ...
def expanduser(path: AnyStr) -> AnyStr: ...
def expandvars(path: AnyStr) -> AnyStr: ...

# These return float if os.stat_float_times() == True,
# but int is a subclass of float.
def getatime(path: EitherStr) -> float: ...
def getmtime(path: EitherStr) -> float: ...
def getctime(path: EitherStr) -> float: ...

def getsize(path: EitherStr) -> int: ...
def isabs(path: EitherStr) -> bool: ...
def isfile(path: EitherStr) -> bool: ...
def isdir(path: EitherStr) -> bool: ...
def islink(path: EitherStr) -> bool: ...
def ismount(path: EitherStr) -> bool: ...
...
def samefile(path1: EitherStr, path2: EitherStr) -> bool: ...
