...
from typing import Any, AnyStr, Callable, IO, List, Mapping, MutableMapping, Optional, Tuple, Type, Union
...
def splitdoc(doc) -> Tuple[str, str]: ...
def classname(object: object, modname: str) -> str: ...
def isdata(object: object) -> bool: ...
def replace(text: str, *pairs: List[str]) -> str: ...
def cram(text: str, maxlen: int) -> str: ...
def stripid(text: str) -> str: ...
def allmethods(cl: type) -> MutableMapping[str, MethodType]: ...
def visiblename(name: str, all: Optional[List[str]] = ..., obj: Optional[object] = ...) -> bool: ...
def classify_class_attrs(object: object) -> List[Tuple[str, str, type, str]]: ...

def ispackage(path: str) -> bool: ...
def source_synopsis(file: IO[AnyStr]) -> Optional[str]: ...
def synopsis(filename: str, cache: MutableMapping[str, Tuple[int, str]] = ...) -> str: ...
...
class Doc:
    ...
    def fail(self, object: object, name: Optional[str] = ..., *args: Any) -> str: ...
...
class HTMLRepr(Repr):
    ...
    def repr_string(self, x: AnyStr, level: complex) -> str: ...
    def repr_str(self, x: AnyStr, level: complex) -> str: ...
...
class HTMLDoc(Doc):
    ...
    def namelink(self, name: str, *dicts: Tuple[MutableMapping[str, str]]) -> str: ...
...
def getpager() -> Callable[[str], str]: ...
def plain(text: str) -> str: ...
def pipepager(text: str, cmd: str) -> str: ...
def tempfilepager(text: str, cmd: str) -> str: ...
def ttypager(text: str) -> str: ...
def plainpager(text: str) -> str: ...
...
def doc(thing: Union[str, object], title: str = ..., forceload: bool = ...) -> str: ...
def writedoc(thing: Union[str, object], forceload: bool = ...) -> None: ...
def writedocs(dir: str, pkgpath: str = ..., done: Optional[Any] = ...) -> None: ...

class Helper:
    keywords = ...  # type: MutableMapping[str, Union[str, Tuple[str, str]]]
    symbols = ...  # type: MutableMapping[str, str]
    topics = ...  # type: MutableMapping[str, Union[str, Tuple[str, ...]]]
    ...
    def help(self, request: Union[str, Helper]) -> None: ...
    def intro(self) -> None: ...
    def list(self, items: List[Any], columns: int = ..., width: int = ...) -> None: ...
    def listkeywords(self) -> None: ...
    def listsymbols(self) -> None: ...
    def listtopics(self) -> None: ...
    def showtopic(self, topic, more_xrefs: str = ...) -> None: ...
    def showsymbol(self, symbol) -> None: ...
...
class ModuleScanner:
    quit = ...  # type: bool
    def run(self, callback: Callable, key: Optional[Any] = ..., completer: Optional[Callable] = ..., onerror: Optional[Callable] = ...) -> None: ...

def apropos(key: str) -> None: ...
def serve(port: int, callback: Optional[Callable] = ..., completer: Optional[Callable] = ...) -> None: ...
def gui() -> None: ...
