...
class OpenerDirector(object):
    ...
    # Note that this type is somewhat a lie. The return *can* be None if no handler
    # handles the request.
    def open(self, fullurl: Union[Request, _string], data: Optional[_string] = ..., timeout: Optional[float] = ...) -> addinfourl: ...
