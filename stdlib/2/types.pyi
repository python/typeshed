...
class GeneratorType:
    ...
    @overload
    def throw(self, __val: BaseException) -> Any: ...
    # __typ must be an old-style class or a subclass of BaseException
    @overload
    def throw(self, __typ: type, __val: BaseException = ..., __tb: TracebackType = ...) -> Any: ...
