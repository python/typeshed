...
class BaseSet(Iterable[_T]):
    ...
    def copy(self) -> _SelfT: ...
    def __copy__(self) -> _SelfT: ...
    def __deepcopy__(self, memo: MutableMapping[int, BaseSet[_T]]) -> _SelfT: ...
    def __or__(self, other: BaseSet[_T]) -> _SelfT: ...
    def union(self, other: _Setlike) -> _SelfT: ...
    def __and__(self, other: BaseSet[_T]) -> _SelfT: ...
    def intersection(self, other: _Setlike) -> _SelfT: ...
    def __xor__(self, other: BaseSet[_T]) -> _SelfT: ...
    def symmetric_difference(self, other: _Setlike) -> _SelfT: ...
    def __sub__(self, other: BaseSet[_T]) -> _SelfT: ...
    def difference(self, other: _Setlike) -> _SelfT: ...
...
class Set(BaseSet[_T]):
    def __init__(self, iterable: Optional[_Setlike] = ...) -> None: ...
    def __ior__(self, other: BaseSet[_T]) -> _SelfT: ...
    def union_update(self, other: _Setlike) -> None: ...
    def __iand__(self, other: BaseSet[_T]) -> _SelfT: ...
    def intersection_update(self, other: _Setlike) -> None: ...
    def __ixor__(self, other: BaseSet[_T]) -> _SelfT: ...
    def symmetric_difference_update(self, other: _Setlike) -> None: ...
    def __isub__(self, other: BaseSet[_T]) -> _SelfT: ...
