...
class UserString(Sequence[UserString]):
    ...
    @overload
    def __getitem__(self, i: int) -> UserString: ...
    @overload
    def __getitem__(self, s: slice) -> Sequence[UserString]: ...
...
class MutableString(UserString, MutableSequence[MutableString]):
    @overload
    def __getitem__(self, i: int) -> MutableString: ...
    @overload
    def __getitem__(self, s: slice) -> MutableSequence[MutableString]: ...
