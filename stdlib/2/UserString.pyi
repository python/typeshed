...
class UserString(Sequence[UserString]):
    ...
    def __add__(self: _UST, other: object) -> _UST: ...
    def __radd__(self: _UST, other: object) -> _UST: ...
    def __mul__(self: _UST, other: int) -> _UST: ...
    def __rmul__(self: _UST, other: int) -> _UST: ...
    def __mod__(self: _UST, args: object) -> _UST: ...
...
class MutableString(UserString, MutableSequence[MutableString]):
    def __setitem__(self, index: Union[int, slice], sub: object) -> None: ...
    def __delitem__(self, index: Union[int, slice]) -> None: ...
    def immutable(self) -> UserString: ...
    def __iadd__(self: _MST, other: object) -> _MST: ...
