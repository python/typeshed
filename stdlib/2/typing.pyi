...
class Match(Generic[AnyStr]):
    ...
    @overload
    def group(self, group1: int = ...) -> Optional[AnyStr]: ...
    @overload
    def group(self, group1: str) -> Optional[AnyStr]: ...
    @overload
    def group(self, group1: int, group2: int,
              *groups: int) -> Tuple[Optional[AnyStr], ...]: ...
    @overload
    def group(self, group1: str, group2: str,
              *groups: str) -> Tuple[Optional[AnyStr], ...]: ...

    def groups(self, default: Optional[AnyStr] = ...) -> Tuple[Optional[AnyStr], ...]: ...
    def groupdict(self, default: Optional[AnyStr] = ...) -> Dict[str, Optional[AnyStr]]: ...
