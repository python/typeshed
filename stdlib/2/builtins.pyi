...
class type(object):
    ...
    @overload
    def __init__(self, name: Text, bases: Tuple[type, ...], dict: Dict[Text, Any]) -> None: ...
    # TODO: __new__ may have to be special and not a static method.
    @overload
    def __new__(cls, o: object) -> type: ...
    @overload
    def __new__(cls, name: Text, bases: Tuple[type, ...], namespace: Dict[Text, Any]) -> type: ...
...
class unicode(basestring, Sequence[unicode]):
    ...
    def __init__(self, o: object) -> None: ...
    @overload
    def __init__(self, o: Text, encoding: Text = ..., errors: Text = ...) -> None: ...
    def capitalize(self) -> unicode: ...
    def center(self, width: int, fillchar: Text = ...) -> unicode: ...
    def count(self, x: Text) -> int: ...
    def decode(self, encoding: Text = ..., errors: Text = ...) -> unicode: ...
    def encode(self, encoding: Text = ..., errors: Text = ...) -> bytes: ...
    def endswith(self, suffix: Union[Text, Tuple[Text, ...]], start: int = ...,
                 end: int = ...) -> bool: ...
    ...
    def format_map(self, map: Mapping[Text, Any]) -> unicode: ...
    ...
    def join(self, iterable: Iterable[Text]) -> unicode: ...
    def ljust(self, width: int, fillchar: Text = ...) -> unicode: ...
    def lower(self) -> unicode: ...
    def lstrip(self, chars: Text = ...) -> unicode: ...
    def partition(self, sep: Text) -> Tuple[unicode, unicode, unicode]: ...
    def replace(self, old: Text, new: Text, count: int = ...) -> unicode: ...
    def rfind(self, sub: Text, start: int = ..., end: int = ...) -> int: ...
    def rindex(self, sub: Text, start: int = ..., end: int = ...) -> int: ...
    def rjust(self, width: int, fillchar: Text = ...) -> unicode: ...
    def rpartition(self, sep: Text) -> Tuple[unicode, unicode, unicode]: ...
    def rsplit(self, sep: Optional[Text] = ..., maxsplit: int = ...) -> List[unicode]: ...
    def rstrip(self, chars: Text = ...) -> unicode: ...
    def split(self, sep: Optional[Text] = ..., maxsplit: int = ...) -> List[unicode]: ...
    def splitlines(self, keepends: bool = ...) -> List[unicode]: ...
    def startswith(self, prefix: Union[Text, Tuple[Text, ...]], start: int = ...,
                   end: int = ...) -> bool: ...
    def strip(self, chars: Text = ...) -> unicode: ...
    def swapcase(self) -> unicode: ...
    def title(self) -> unicode: ...
    def translate(self, table: Union[Dict[int, Any], Text]) -> unicode: ...
    ...
    def __add__(self, s: Text) -> unicode: ...
...
class str(basestring, Sequence[str]):
    ...
    def center(self, width: int, fillchar: Text = ...) -> str: ...
    def count(self, x: Text, __start: Optional[int] = ..., __end: Optional[int] = ...) -> int: ...
    def decode(self, encoding: Text = ..., errors: Text = ...) -> unicode: ...
    def encode(self, encoding: Text = ..., errors: Text = ...) -> str: ...
    ...
    def ljust(self, width: int, fillchar: Text = ...) -> str: ...
    def lower(self) -> str: ...
    @overload
...
class bytearray(MutableSequence[int]):
    ...
    @overload
    def __init__(self, x: Text, encoding: Text,
                 errors: Text = ...) -> None: ...
    @overload
...
class property(object):
    def __init__(self, fget: Optional[Callable[[Any], Any]] = ...,
                 ...
                 fdel: Optional[Callable[[Any], None]] = ..., doc: Optional[Text] = ...) -> None: ...
...
def compile(source: Any, filename: Text, mode: Text, flags: int = ...,
...
def format(o: object, format_spec: AnyStr = ...) -> AnyStr: ...
def getattr(o: Any, name: Text, default: Optional[Any] = ...) -> Any: ...
...
@overload
def open(file: str, mode: Text = ..., buffering: int = ...) -> BinaryIO: ...
@overload
def open(file: unicode, mode: Text = ..., buffering: int = ...) -> BinaryIO: ...
@overload
...
def zip(iter1: Iterable[Any], iter2: Iterable[Any], iter3: Iterable[Any],
        ...
        *iterables: Iterable[Any]) -> List[Tuple[Any, ...]]: ...
def __import__(name: Text,
               globals: Dict[Text, Any] = ...,
               locals: Dict[Text, Any] = ...,
               fromlist: List[Text] = ..., level: int = ...) -> Any: ...
...
class UnicodeEncodeError(UnicodeError):
    ...
    reason: str
    def __init__(self, __encoding: str, __object: unicode, __start: int, __end: int,
                 __reason: str) -> None: ...
...
def eval(s: Union[str, unicode], globals: Dict[Text, Any] = ..., locals: Dict[Text, Any] = ...) -> Any: ...
def exec(object: Text,
         globals: Optional[Dict[Text, Any]] = ...,
         locals: Optional[Dict[Text, Any]] = ...) -> Any: ...  # TODO code object as source

def cmp(x: Any, y: Any) -> int: ...

def execfile(filename: Text, globals: Optional[Dict[Text, Any]] = ..., locals: Optional[Dict[str, Any]] = ...) -> None: ...

class file(BinaryIO):
    @overload
    def __init__(self, file: str, mode: Text = ..., buffering: int = ...) -> None: ...
    @overload
    def __init__(self, file: unicode, mode: Text = ..., buffering: int = ...) -> None: ...
    @overload
    def __init__(self, file: int, mode: Text = ..., buffering: int = ...) -> None: ...
    def __iter__(self) -> Iterator[bytes]: ...
    def next(self) -> bytes: ...
