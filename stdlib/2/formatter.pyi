...
AS_IS = None
FONT_TYPE = Tuple[str, bool, bool, bool]
STYLES_TYPE = Tuple[Any, ...]
...
class NullFormatter:
    ...
    def add_label_data(self, format, counter: int, blankline: Optional[int] = None) -> None: ...
    ...
    def push_font(self, x: FONT_TYPE) -> None: ...
    ...
    def push_style(self, *styles: STYLES_TYPE) -> None: ...
...
class AbstractFormatter:
    ...
    font_stack = ...  # type: List[FONT_TYPE]
    ...
    def push_alignment(self, align: Optional[str]) -> None: ...
    def pop_alignment(self) -> None: ...
    def push_font(self, font: FONT_TYPE) -> None: ...
    def pop_font(self) -> None: ...
    def push_margin(self, margin: int) -> None: ...
    def pop_margin(self) -> None: ...
    def set_spacing(self, spacing: Optional[str]) -> None: ...
...
class NullWriter:
    ...
    def new_font(self, font: FONT_TYPE) -> None: ...
...
class DumbWriter(NullWriter):
    file = ...  # type: IO
    maxcol = ...  # type: int
    def __init__(self, file: Optional[IO] = None, maxcol: int = 72) -> None: ...
    def reset(self) -> None: ...
    def send_paragraph(self, blankline: int) -> None: ...
    def send_line_break(self) -> None: ...
    def send_hor_rule(self, *args, **kw) -> None: ...
...
def test(file: Optional[str] = None) -> None: ...
