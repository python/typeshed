...
def XML(text: str | bytes, parser: Optional[XMLParser] = ...) -> Element: ...
def XMLID(text: str | bytes, parser: Optional[XMLParser] = ...) -> Tuple[Element, Dict[str, Element]]: ...

# This is aliased to XML in the source.
fromstring = XML

def fromstringlist(sequence: Sequence[str | bytes], parser: Optional[XMLParser] = ...) -> Element: ...
