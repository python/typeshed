...
class Element:
    tag: str | QName
    attrib: dict[str | QName, str | QName]
    text: str | None
    tail: str | None
    def __init__(self, tag: str | QName, attrib: dict[str, str] = ..., **extra: str) -> None: ...
    ...
    @overload
    def get(self, key: str | QName, default: None = None) -> str | QName | None: ...
    @overload
    def get(self, key: str | QName, default: _T) -> str | QName | _T: ...
    ...
    def set(self, key: str | QName, value: str | QName, /) -> None: ...
...
def SubElement(parent: Element, tag: str | QName, attrib: dict[str, str] = ..., **extra: str) -> Element: ...
