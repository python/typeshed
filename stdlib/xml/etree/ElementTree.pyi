...
# This is generic because the target passed in can change the result.
# Using C14NWriterTarget results in a type of XMLParser[None].
# Most of the time it's Element though.
