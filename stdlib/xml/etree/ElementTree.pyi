...
class Element(MutableSequence[Element]):
    ...
    def find(self, path: str, namespaces: Optional[Dict[str, str]] = ...) -> Element | None: ...
    def findall(self, path: str, namespaces: Optional[Dict[str, str]] = ...) -> List[Element]: ...
    @overload
    def findtext(self, path: str, default: None = ..., namespaces: Optional[Dict[str, str]] = ...) -> str | None: ...
    @overload
    def findtext(self, path: str, default: _T, namespaces: Optional[Dict[str, str]] = ...) -> _T | str: ...
    @overload
...
def iterparse(
    source: _File, events: Optional[Sequence[str]] = ..., parser: XMLParser | None = ...
) -> Iterator[Tuple[str, Any]]: ...

class XMLPullParser:
    def __init__(self, events: Optional[Sequence[str]] = ..., *, _parser: XMLParser | None = ...) -> None: ...
