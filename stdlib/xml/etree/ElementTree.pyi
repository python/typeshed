...
class ElementTree(Generic[_Root]):
    ...
    def parse(self, source: _FileRead, parser: XMLParser | None = None) -> Element[Any]: ...
    def iter(self, tag: str | None = None) -> Generator[Element[Any], None, None]: ...
    def find(self, path: str, namespaces: dict[str, str] | None = None) -> Element[Any] | None: ...
    @overload
    def findtext(self, path: str, default: None = None, namespaces: dict[str, str] | None = None) -> str | None: ...
    @overload
    def findtext(self, path: str, default: _T, namespaces: dict[str, str] | None = None) -> _T | str: ...
    def findall(self, path: str, namespaces: dict[str, str] | None = None) -> list[Element[Any]]: ...
    @overload
    def iterfind(self, path: Literal[""], namespaces: dict[str, str] | None = None) -> None: ...  # type: ignore[overload-overlap]
    @overload
    def iterfind(self, path: str, namespaces: dict[str, str] | None = None) -> Generator[Element[Any], None, None]: ...
    def write(
        self,
