...
@overload
def findtext(elem: Element, path: str, default: None = None, namespaces: dict[str, str] | None = None) -> str | None: ...
@overload
def findtext(elem: Element, path: str, default: _T, namespaces: dict[str, str] | None = None) -> _T | str: ...
