...
class ExpatBuilder:
    ...
    def parseFile(self, file: Reader[ReadableBuffer | str]) -> Document: ...
...
class FragmentBuilder(ExpatBuilder):
    ...
    def reset(self) -> None: ...
    def parseFile(self, file: Reader[ReadableBuffer | str]) -> DocumentFragment: ...  # type: ignore[override]
...
class InternalSubsetExtractor(ExpatBuilder):
    ...
    def parseFile(self, file: Reader[ReadableBuffer | str]) -> None: ...  # type: ignore[override]
...
def parse(file: str | Reader[ReadableBuffer | str], namespaces: bool = True) -> Document: ...
def parseString(string: str | ReadableBuffer, namespaces: bool = True) -> Document: ...
def parseFragment(file: str | Reader[ReadableBuffer | str], context: Node, namespaces: bool = True) -> DocumentFragment: ...
