...
_Writer: TypeAlias = StringIO | TextIOWrapper
...
class NamedNodeMap:
    ...
    def __getitem__(self, name_or_tuple: tuple[str, str | None] | str) -> Attr | None: ...
    ...
    def __delitem__(self, attname_or_tuple: str) -> None: ...
    @property
    def length(self) -> int: ...
...
class Element(Node):
    ...
    def writexml(self, writer: _Writer, indent: str = ..., addindent: str = ..., newl: str = ...) -> None: ...
...
class Document(Node, DocumentLS):
    ...
    def createComment(self, data: Incomplete) -> Comment: ...
    ...
    if sys.version_info >= (3, 9):
        ...
        def writexml(
            self, writer: _Writer, indent: str = ..., addindent: str = ..., newl: str = ..., encoding: Any | None = ...
        ) -> None: ...
