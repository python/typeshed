...
from typing import Any, ClassVar, Generic, Literal, NoReturn, Protocol, TypeAlias, TypeVar, overload
...
class Node(xml.dom.Node):
    parentNode: _NodesWithChildren | None
...
class ReadOnlySequentialNamedNodeMap(Generic[_N]):
    ...
    def removeNamedItem(self, name: str) -> None: ...
    def removeNamedItemNS(self, namespaceURI: str | None, localName: str) -> None: ...
...
class Document(Node, DocumentLS):
    ...
    def createElementNS(self, namespaceURI: str | None, qualifiedName: str): ...
