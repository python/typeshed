...
class SMTP:
    ...
    def __exit__(
        self, exc_type: Optional[Type[BaseException]], exc_value: BaseException | None, tb: TracebackType | None
    ) -> None: ...
    ...
    def starttls(
        self, keyfile: str | None = ..., certfile: str | None = ..., context: SSLContext | None = ...
    ) -> _Reply: ...
    def sendmail(
        self,
        from_addr: str,
