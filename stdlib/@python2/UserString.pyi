...
class UserString(Sequence[UserString]):
    ...
    def endswith(self, suffix: Text | Tuple[Text, ...], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
    ...
    def startswith(self, prefix: Text | Tuple[Text, ...], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
