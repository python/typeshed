...
class unicode(basestring, Sequence[unicode]):
    ...
    def __contains__(self, s: unicode | bytes) -> bool: ...
...
class str(Sequence[str], basestring):
    ...
    def __contains__(self, o: str | Text) -> bool: ...
    def __eq__(self, x: object) -> bool: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    # Incompatible with Sequence.__contains__
    def __contains__(self, o: int | bytes) -> bool: ...
    def __eq__(self, x: object) -> bool: ...
    def __ne__(self, x: object) -> bool: ...
...
@overload
def filter(__function: Callable[[AnyStr], Any], __iterable: AnyStr) -> AnyStr: ...
@overload
def filter(__function: None, __iterable: tuple[_T | None, ...]) -> tuple[_T, ...]: ...
@overload
def filter(__function: Callable[[_T], Any], __iterable: tuple[_T, ...]) -> tuple[_T, ...]: ...
@overload
