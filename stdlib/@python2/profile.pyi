...
def run(statement: str, filename: Optional[str] = ..., sort: str | int = ...) -> None: ...
def runctx(
    statement: str, globals: Dict[str, Any], locals: Dict[str, Any], filename: Optional[str] = ..., sort: str | int = ...
) -> None: ...
