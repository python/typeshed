...
class _mboxMMDFMessage(Message):
    ...
    def set_from(
        self, from_: str, time_: Optional[bool | Tuple[int, int, int, int, int, int, int, int, int]] = ...
    ) -> None: ...
    def get_flags(self) -> str: ...
    def set_flags(self, flags: Iterable[str]) -> None: ...
    def add_flag(self, flag: str) -> None: ...
...
class _ProxyFile(Generic[AnyStr]):
    ...
    def __exit__(
        self, exc_type: Optional[Type[BaseException]], exc: BaseException | None, tb: TracebackType | None
    ) -> None: ...
