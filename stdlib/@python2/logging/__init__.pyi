...
from typing import IO, Any, Callable, Dict, List, Mapping, MutableMapping, Sequence, Text, Tuple, Union, overload
...
def critical(
    msg: Any, *args: Any, exc_info: _ExcInfoType = ..., extra: Dict[str, Any] | None = ..., **kwargs: Any
) -> None: ...
def exception(
    msg: Any, *args: Any, exc_info: _ExcInfoType = ..., extra: Dict[str, Any] | None = ..., **kwargs: Any
) -> None: ...
