...
def print_exc(limit: int | None = ..., file: Optional[IO[str]] = ...) -> None: ...
def print_last(limit: int | None = ..., file: Optional[IO[str]] = ...) -> None: ...
...
def format_exception(
    etype: Optional[Type[BaseException]], value: BaseException | None, tb: TracebackType | None, limit: int | None = ...
) -> List[str]: ...
