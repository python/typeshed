...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    @overload
    def parse_known_args(self, args: Sequence[str] | None = ..., namespace: None = ...) -> tuple[Namespace, list[str]]: ...  # type: ignore[misc]
    @overload
    ...
    @overload
    def parse_intermixed_args(self, args: Sequence[str] | None = ..., namespace: None = ...) -> Namespace: ...  # type: ignore[misc]
    @overload
    def parse_intermixed_args(self, args: Sequence[str] | None, namespace: _N) -> _N: ...
    @overload
    def parse_intermixed_args(self, args: Sequence[str] | None = ..., *, namespace: _N) -> _N: ...
    @overload
    def parse_known_intermixed_args(  # type: ignore[misc]
    ...
    def _parse_known_args(self, arg_strings: list[str], namespace: _N) -> tuple[_N, list[str]]: ...
