...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    @overload
    def parse_args(self, args: Sequence[str] | None, namespace: _N | None) -> _N | Namespace: ...
    @overload
    def parse_args(self, args: Sequence[str] | None, namespace: _N) -> _N: ...
    @overload
    def parse_args(self, *, namespace: None) -> Namespace: ...
    @overload
    def parse_args(self, *, namespace: _N | None) -> _N | Namespace: ...
    @overload
    ...
    @overload
    def parse_known_args(self, args: Sequence[str] | None, namespace: _N | None) -> tuple[_N | Namespace, list[str]]: ...
    @overload
    def parse_known_args(self, args: Sequence[str] | None, namespace: _N) -> tuple[_N, list[str]]: ...
    @overload
    def parse_known_args(self, *, namespace: None) -> tuple[Namespace, list[str]]: ...
    @overload
    def parse_known_args(self, *, namespace: _N | None) -> tuple[_N | Namespace, list[str]]: ...
    @overload
    ...
    @overload
    def parse_intermixed_args(self, args: Sequence[str] | None, namespace: _N | None) -> _N | Namespace: ...
    @overload
    def parse_intermixed_args(self, args: Sequence[str] | None, namespace: _N) -> _N: ...
    @overload
    def parse_intermixed_args(self, *, namespace: None) -> Namespace: ...
    @overload
    def parse_intermixed_args(self, *, namespace: _N | None) -> _N | Namespace: ...
    @overload
    ...
    @overload
    def parse_known_intermixed_args(self, *, namespace: None) -> tuple[Namespace, list[str]]: ...
    @overload
    def parse_known_intermixed_args(self, *, namespace: _N | None) -> tuple[_N | Namespace, list[str]]: ...
    @overload
