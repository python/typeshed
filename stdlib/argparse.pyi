...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    @overload
    def parse_known_args(self, args: Sequence[str] | None = ..., namespace: None = ...) -> tuple[Namespace, list[str]]: ...
    @overload
    ...
    @overload
    def parse_intermixed_args(self, args: Sequence[str] | None = ..., namespace: None = ...) -> Namespace: ...
    @overload
