...
from tkinter import Text, Listbox, Event, Toplevel, Widget, Scrollbar
...
class AutoCompleteWindow:
    ...
    hideaid: str
    hidewid: str
    def show_window(self, comp_lists: tuple[list[str], list[str]], index: int, complete: bool, mode: int, userWantsWin: bool) -> None: ...
    def winconfig_event(self, event: Union['Event[Any]', None]) -> None: ...
    def hide_event(self, event: Union['Event[Any]', None]) -> None: ...
    def listselect_event(self, event: Union['Event[Any]', None]) -> None: ...
    def doubleclick_event(self, event: Union['Event[Any]', None]) -> None: ...
    def keypress_event(self, event: Union['Event[Any]', None]) -> str | None: ...
    def keyrelease_event(self, event: Union['Event[Any]', None]) -> None: ...
