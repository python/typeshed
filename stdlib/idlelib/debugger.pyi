...
from tkinter import BaseWidget, BooleanVar, Button, Canvas, Checkbutton, Event, Frame, Label, Scrollbar, Tk, Toplevel
import bdb
import reprlib
...
class Debugger:
    ...
    def interaction(self, message: str, frame: FrameType, info: tuple[Type[BaseException], BaseException, TracebackType] | None = ...) -> None: ...
