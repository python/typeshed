...
from tkinter import Text, Frame, Event
...
class CodeContext:
    ...
    cell00: Frame
    context: Text | None
    def toggle_code_context_event(self, event: Union['Event[Any]', None] = ...) -> str: ...
    def get_context(self, new_topvisible: int, stopline: int = ..., stopindent: int = ...) -> tuple[list[tuple[int, int, str, str | bool]], int]: ...
    topvisible: int
    def update_code_context(self) -> None: ...
    def jumptoline(self, event: Union['Event[Any]', None] = ...) -> None: ...
