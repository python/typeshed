...
from tkinter.ttk import Frame, Scrollbar, Widget, Button
...
class ViewWindow(Toplevel):
    ...
    button_ok: Button
    is_modal: bool
    def __init__(self, parent: Widget, title: str, contents: str, modal: bool = ..., wrap: str=..., *, _htest: bool = ..., _utest: bool = ...) -> None: ...
    def ok(self, event: Union['Event[Any]', None] = ...) -> None: ...

def view_text(parent: Widget, title: str, contents: str, modal: bool = ..., wrap: str = ..., _utest: bool = ...) -> ViewWindow: ...
def view_file(parent: Widget, title: str, filename: str, encoding: str, modal: bool = ..., wrap: str = ..., _utest: bool = ...) -> ViewWindow | None: ...
