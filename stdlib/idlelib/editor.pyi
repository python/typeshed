...
from idlelib import configdialog as configdialog, grep as grep, help as help, help_about as help_about, macosx as macosx, mainmenu as mainmenu, pyparse as pyparse, query as query, replace as replace, search as search, window as window
...
class EditorWindow:
    ...
    ctip: Incomplete
    def __init__(self, flist: Incomplete | None = ..., filename: Incomplete | None = ..., key: Incomplete | None = ..., root: Incomplete | None = ...): ...
