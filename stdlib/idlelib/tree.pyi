...
class TreeNode:
    ...
    def __init__(self, canvas: Canvas, parent: Union["TreeItem", None], item: "TreeItem") -> None: ...
    def destroy(self) -> None: ...
    def geticonimage(self, name: str) -> PhotoImage: ...
    def select(self, event: Union["Event[Any]", None] = ...) -> None: ...
    def deselect(self, event: Union["Event[Any]", None] = ...) -> None: ...
    def deselectall(self) -> None: ...
    def deselecttree(self) -> None: ...
    def flip(self, event: Union["Event[Any]", None] = ...) -> str: ...
    def expand(self, event: Union["Event[Any]", None] = ...) -> None: ...
    def collapse(self, event: Union["Event[Any]", None] = ...) -> None: ...
    def view(self) -> None: ...
    ...
    def select_or_edit(self, event: Union["Event[Any]", None] = ...) -> None: ...
    entry: None | Entry
    def edit(self, event: Union["Event[Any]", None] = ...) -> None: ...
    def edit_finish(self, event: Union["Event[Any]", None] = ...) -> None: ...
    def edit_cancel(self, event: Union["Event[Any]", None] = ...) -> None: ...
