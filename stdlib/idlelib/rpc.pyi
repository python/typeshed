...
class RPCServer(socketserver.TCPServer):
    ...
    def handle_error(self, request: socket.socket | tuple[bytes, socket.socket], client_address: tuple[str, int] | str) -> None: ...
...
class SocketIO:
    ...
    def localcall(self, seq: str, request: tuple[str, tuple[int, str, list[Any], dict[str, Any]]]) -> tuple[str, str | dict[str, Any] | object, None, Exception]: ...
...
class RPCClient(SocketIO):
    ...
    def __init__(self, address: tuple[Any, ...] | str | bytes, family: socket.AddressFamily=..., type: socket.SocketKind=...) -> None: ...
