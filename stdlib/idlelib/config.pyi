...
class IdleConfParser(ConfigParser):
    ...
    def Get(self, section: str, option: str, type: str | None = ..., default: Any | None = ..., raw: bool = ...) -> str | int | bool: ...
...
class IdleConf:
    ...
    def GetOption(self, configType: str, section: str, option: str, default: Any | None = ..., type: Any | None = ..., warn_on_default: bool = ..., raw: bool = ...) -> str | int | bool: ...
