...
if sys.platform != "win32":
    ...
    SCHED_OTHER: Final[int]  # some flavors of Unix
    SCHED_BATCH: Final[int]  # some flavors of Unix
    SCHED_IDLE: Final[int]  # some flavors of Unix
    SCHED_SPORADIC: Final[int]  # some flavors of Unix
    SCHED_FIFO: Final[int]  # some flavors of Unix
    SCHED_RR: Final[int]  # some flavors of Unix
    SCHED_RESET_ON_FORK: Final[int]  # some flavors of Unix
...
SEEK_END: Final[int]
if sys.platform != "win32":
    SEEK_DATA: Final[int]  # some flavors of Unix
    SEEK_HOLE: Final[int]  # some flavors of Unix
...
O_DSYNC: Final[int]  # Unix only
O_RSYNC: Final[int]  # Unix only
O_SYNC: Final[int]  # Unix only
O_NDELAY: Final[int]  # Unix only
O_NONBLOCK: Final[int]  # Unix only
O_NOCTTY: Final[int]  # Unix only
O_CLOEXEC: Final[int]  # Unix only
O_SHLOCK: Final[int]  # Unix only
O_EXLOCK: Final[int]  # Unix only
O_BINARY: Final[int]  # Windows only
O_NOINHERIT: Final[int]  # Windows only
O_SHORT_LIVED: Final[int]  # Windows only
O_TEMPORARY: Final[int]  # Windows only
O_RANDOM: Final[int]  # Windows only
O_SEQUENTIAL: Final[int]  # Windows only
O_TEXT: Final[int]  # Windows only
...
if sys.platform == "win32":
    ...
    POSIX_SPAWN_OPEN: Final[int]
    POSIX_SPAWN_CLOSE: Final[int]
    POSIX_SPAWN_DUP2: Final[int]
