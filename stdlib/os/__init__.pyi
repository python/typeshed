...
def readlink(path: AnyStr | PathLike[AnyStr], *, dir_fd: Optional[int] = ...) -> AnyStr: ...
...
def walk(
    top: AnyStr | PathLike[AnyStr], topdown: bool = ..., onerror: Optional[_OnError] = ..., followlinks: bool = ...
...
if sys.platform != "win32":
    # Unix only
    def confstr(__name: str | int) -> Optional[str]: ...
