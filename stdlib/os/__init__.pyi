...
def access(
    path: _FdOrAnyPath, mode: int, *, dir_fd: int | None = None, effective_ids: bool = False, follow_symlinks: bool = True
) -> bool: ...
...
def getcwd() -> str: ...
def getcwdb() -> bytes: ...
def chmod(path: _FdOrAnyPath, mode: int, *, dir_fd: int | None = None, follow_symlinks: bool = True) -> None: ...
...
if sys.platform != "win32":
    ...
    def chown(path: _FdOrAnyPath, uid: int, gid: int, *, dir_fd: int | None = None, follow_symlinks: bool = True) -> None: ...
...
def stat(path: _FdOrAnyPath, *, dir_fd: int | None = None, follow_symlinks: bool = True) -> stat_result: ...
...
def popen(cmd: str, mode: str = 'r', buffering: int = ...) -> _wrap_close: ...
