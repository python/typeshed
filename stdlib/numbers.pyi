...
class Complex(Number):
    ...
    @abstractmethod
    def __add__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __radd__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __neg__(self) -> SupportsComplex: ...
    @abstractmethod
    def __pos__(self) -> SupportsComplex: ...
    def __sub__(self, other) -> SupportsComplex: ...
    def __rsub__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __mul__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __rmul__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __truediv__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __rtruediv__(self, other) -> SupportsComplex: ...
    @abstractmethod
    def __pow__(self, exponent) -> SupportsComplex: ...
    @abstractmethod
    def __rpow__(self, base) -> SupportsComplex: ...
    @abstractmethod
    def __abs__(self) -> SupportsFloat: ...
    @abstractmethod
    def conjugate(self) -> SupportsComplex: ...
    @abstractmethod
