...
class URLopener:
    ...
    def http_error(
        self, url: str, fp: IO[bytes], errcode: int, errmsg: str, headers: Mapping[str, str], data: bytes | None = ...
...
class FancyURLopener(URLopener):
    ...
    def http_error_301(
        self, url: str, fp: IO[str], errcode: int, errmsg: str, headers: Mapping[str, str], data: bytes | None = ...
