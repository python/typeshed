...
@overload
def quote(string: str, safe: AnyStr = ..., encoding: str | None = ..., errors: str | None = ...) -> str: ...
@overload
def quote(string: bytes, safe: AnyStr = ...) -> str: ...
def quote_from_bytes(bs: bytes, safe: AnyStr = ...) -> str: ...
@overload
def quote_plus(string: str, safe: AnyStr = ..., encoding: str | None = ..., errors: str | None = ...) -> str: ...
@overload
def quote_plus(string: bytes, safe: AnyStr = ...) -> str: ...

if sys.version_info >= (3, 9):
    def unquote(string: AnyStr, encoding: str = ..., errors: str = ...) -> str: ...
...
def urlencode(
    ...
    encoding: str = ...,
    errors: str = ...,
    quote_via: Callable[[AnyStr, AnyStr, str, str], str] = ...,
) -> str: ...
