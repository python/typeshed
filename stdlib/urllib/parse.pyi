...
@overload
def quote(string: str, safe: str | ReadableBuffer = ..., encoding: str | None = ..., errors: str | None = ...) -> str: ...
@overload
def quote(string: bytes | bytearray, safe: str | ReadableBuffer = ...) -> str: ...
def quote_from_bytes(bs: bytes | bytearray, safe: str | ReadableBuffer = ...) -> str: ...
@overload
def quote_plus(string: str, safe: str | ReadableBuffer = ..., encoding: str | None = ..., errors: str | None = ...) -> str: ...
@overload
def quote_plus(string: bytes | bytearray, safe: str | ReadableBuffer = ...) -> str: ...
...
def urlencode(
    ...
    doseq: bool = ...,
    safe: str | ReadableBuffer = ...,
    encoding: str = ...,
    errors: str = ...,
    quote_via: Callable[[AnyStr, str | ReadableBuffer, str, str], str] = ...,
) -> str: ...
