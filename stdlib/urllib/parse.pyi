...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splithost(url: str) -> tuple[str | None, str]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splituser(host: str) -> tuple[str | None, str]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splitpasswd(user: str) -> tuple[str, str | None]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splitport(host: str) -> tuple[str, str | None]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splitnport(host: str, defport: int = -1) -> tuple[str, int | None]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splitquery(url: str) -> tuple[str, str | None]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splittag(url: str) -> tuple[str, str | None]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.urlparse()` instead.")
def splitattr(url: str) -> tuple[str, list[str]]: ...
@deprecated("Deprecated since Python 3.8. Use `urllib.parse.parse_qsl()` instead.")
def splitvalue(attr: str) -> tuple[str, str | None]: ...
