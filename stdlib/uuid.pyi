...
class UUID:
    ...
    def __lt__(self, other: SupportsDunderGT) -> bool: ...
    def __le__(self, other: SupportsDunderGE) -> bool: ...
    def __gt__(self, other: SupportsDunderLT) -> bool: ...
    def __ge__(self, other: SupportsDunderLE) -> bool: ...
