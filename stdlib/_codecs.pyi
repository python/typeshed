...
def escape_decode(__data: str | bytes, __errors: Optional[str] = ...) -> Tuple[str, int]: ...
...
def raw_unicode_escape_decode(__data: str | bytes, __errors: Optional[str] = ...) -> Tuple[str, int]: ...
def raw_unicode_escape_encode(__str: str, __errors: Optional[str] = ...) -> Tuple[bytes, int]: ...
def readbuffer_encode(__data: str | bytes, __errors: Optional[str] = ...) -> Tuple[bytes, int]: ...
def unicode_escape_decode(__data: str | bytes, __errors: Optional[str] = ...) -> Tuple[str, int]: ...
def unicode_escape_encode(__str: str, __errors: Optional[str] = ...) -> Tuple[bytes, int]: ...

if sys.version_info < (3, 8):
    def unicode_internal_decode(__obj: str | bytes, __errors: Optional[str] = ...) -> Tuple[str, int]: ...
    def unicode_internal_encode(__obj: str | bytes, __errors: Optional[str] = ...) -> Tuple[bytes, int]: ...
