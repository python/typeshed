...
if sys.version_info >= (3, 9):
    def raw_unicode_escape_decode(__data: str | ReadableBuffer, __errors: str | None = ..., __final: bool = ...) -> tuple[str, int]: ...
...
if sys.version_info >= (3, 9):
    def unicode_escape_decode(__data: str | ReadableBuffer, __errors: str | None = ..., __final: bool = ...) -> tuple[str, int]: ...
...
if sys.platform == "win32":
    ...
    def code_page_decode(__codepage: int, __data: ReadableBuffer, __errors: str | None = ..., __final: int = ...) -> tuple[str, int]: ...
