...
_Map: TypeAlias = dict[int, int] | _EncodingMap
...
def charmap_build(__map: str) -> _Map: ...
...
def charmap_decode(__data: bytes, __errors: str | None = ..., __mapping: _Map | None = ...) -> tuple[str, int]: ...
def charmap_encode(__str: str, __errors: str | None = ..., __mapping: _Map | None = ...) -> tuple[bytes, int]: ...
