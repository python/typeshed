...
class AsyncGeneratorType(AsyncGenerator[_YieldT_co, _SendT_contra]):
    ...
    def __aiter__(self) -> AsyncGeneratorType[_YieldT_co, _SendT_contra]: ...
    def __anext__(self) -> Coroutine[_YieldT_co]: ...
    def asend(self, __val: _SendT_contra) -> Awaitable[_YieldT_co]: ...
    @overload
    async def athrow(
        self, __typ: type[BaseException], __val: BaseException | object = ..., __tb: TracebackType | None = ...
    ) -> _YieldT_co: ...
...
class CoroutineType(Coroutine[_YieldT_co, _SendT_contra, _ReturnT_co]):
    ...
    @overload
    def throw(self, __typ: BaseException, __val: None = None, __tb: TracebackType | None = ...) -> _ReturnT_co: ...
