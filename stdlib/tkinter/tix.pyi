...
class tixCommand:
    ...
    def tix_cget(self, option: str) -> Incomplete: ...
    def tix_configure(self, cnf: dict[str, Any] | None = ..., **kw) -> Incomplete: ...
    def tix_filedialog(self, dlgclass: str | None = ...) -> str: ...
    def tix_getbitmap(self, name: str) -> str: ...
    def tix_getimage(self, name: str) -> str: ...
    def tix_option_get(self, name: str): ...
...
class TixWidget(tkinter.Widget):
    def __init__(
        ...
        cnf: dict[str, Incomplete] = ...,
        kw: dict[str, Incomplete] = ...,
    ) -> None: ...
    ...
    def config_all(self, option: Incomplete, value: Incomplete) -> None: ...
    def image_create(self, imgtype: str, cnf: dict[str, Incomplete] = ..., master: tkinter.Widget | None = ..., **kw) -> None: ...
...
class DisplayStyle:
    def __init__(self, itemtype: str, cnf: dict[str, Incomplete] = ..., *, master: tkinter.Widget | None = ..., **kw) -> None: ...
    def __getitem__(self, key: str) -> Incomplete: ...
    def __setitem__(self, key: str, value: Incomplete) -> None: ...
    def delete(self) -> None: ...
    def config(self, cnf: dict[str, Incomplete] = ..., **kw): ...

class Balloon(TixWidget):
    def __init__(self, master: tkinter.Widget | None = ..., cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def bind_widget(self, widget: tkinter.Widget, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def unbind_widget(self, widget: tkinter.Widget) -> None: ...

class ButtonBox(TixWidget):
    def __init__(self, master: tkinter.Widget | None = ..., cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def add(self, name: str, cnf: dict[str, Incomplete] = ..., **kw) -> tkinter.Widget: ...
...
class OptionMenu(TixWidget):
    def __init__(self, master: tkinter.Widget | None, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def add_command(self, name: str, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def add_separator(self, name: str, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
...
class HList(TixWidget, tkinter.XView, tkinter.YView):
    def __init__(self, master: tkinter.Widget | None = ..., cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def add(self, entry: str, cnf: dict[str, Incomplete] = ..., **kw) -> tkinter.Widget: ...
    def add_child(self, parent: str | None = ..., cnf: dict[str, Incomplete] = ..., **kw) -> tkinter.Widget: ...
    ...
    def header_create(self, col: int, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def header_configure(self, col: int, cnf: dict[str, Incomplete] = ..., **kw) -> Incomplete | None: ...
    def header_cget(self, col: int, opt: Incomplete) -> Incomplete: ...
    ...
    def indicator_create(self, entry: str, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def indicator_configure(self, entry: str, cnf: dict[str, Incomplete] = ..., **kw) -> Incomplete | None: ...
    def indicator_cget(self, entry: str, opt: Incomplete) -> Incomplete: ...
    ...
    def info_data(self, entry: str) -> Incomplete: ...
    ...
    def item_cget(self, entry: str, col: int, opt: Incomplete): ...
    def item_configure(self, entry: str, col: int, cnf: dict[str, Incomplete] = ..., **kw) -> Incomplete | None: ...
    def item_create(self, entry: str, col: int, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def item_exists(self, entry: str, col: int) -> bool: ...
    def item_delete(self, entry: str, col: int) -> None: ...
    def entrycget(self, entry: str, opt: Incomplete): ...
    def entryconfigure(self, entry: str, cnf: dict[str, Incomplete] = ..., **kw) -> Incomplete | None: ...
    def nearest(self, y: int) -> str: ...
    def see(self, entry: str) -> None: ...
    def selection_clear(self, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
...
class TList(TixWidget, tkinter.XView, tkinter.YView):
    ...
    def dropsite_set(self, index: int) -> None: ...
    def dropsite_clear(self) -> None: ...
    def insert(self, index: int, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
...
class PanedWindow(TixWidget):
    def __init__(self, master: tkinter.Widget | None, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def add(self, name: str, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def delete(self, name: str) -> None: ...
    def forget(self, name: str) -> None: ...  # type: ignore[override]
    def panecget(self, entry: str, opt: Incomplete) -> Incomplete: ...
    def paneconfigure(self, entry: str, cnf: dict[str, Incomplete] = ..., **kw) -> Incomplete | None: ...
...
class Form:
    def __setitem__(self, key: str, value: Incomplete) -> None: ...
    def config(self, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def form(self, cnf: dict[str, Incomplete] = ..., **kw) -> None: ...
    def check(self) -> bool: ...
