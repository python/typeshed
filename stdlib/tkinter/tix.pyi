...
class TixWidget(tk.Widget):
    ...
    def subwidget(self, name: str) -> tk.Widget: ...
    def subwidgets_all(self) -> list[tk.Widget]: ...
    def config_all(self, option: Any, value: Any) -> None: ...
    def image_create(self, imgtype: str, cnf: dict[str, Any] = {}, master: tk.Widget | None = None, **kw) -> None: ...
    def image_delete(self, imgname: str) -> None: ...

class TixSubWidget(TixWidget):
    def __init__(self, master: tk.Widget, name: str, destroy_physically: int = 1, check_intermediate: int = 1) -> None: ...

class DisplayStyle:
    def __init__(self, itemtype: str, cnf: dict[str, Any] = {}, *, master: tk.Widget | None = None, **kw) -> None: ...
...
class Balloon(TixWidget):
    def __init__(self, master: tk.Widget | None = None, cnf: dict[str, Any] = {}, **kw) -> None: ...
    def bind_widget(self, widget: tk.Widget, cnf: dict[str, Any] = {}, **kw) -> None: ...
    def unbind_widget(self, widget: tk.Widget) -> None: ...

class ButtonBox(TixWidget):
    def __init__(self, master: tk.Widget | None = None, cnf: dict[str, Any] = {}, **kw) -> None: ...
    def add(self, name: str, cnf: dict[str, Any] = {}, **kw) -> tk.Widget: ...
...
class OptionMenu(TixWidget):
    def __init__(self, master: tk.Widget | None, cnf: dict[str, Any] = {}, **kw) -> None: ...
...
class PopupMenu(TixWidget):
    ...
    def unbind_widget(self, widget: tk.Widget) -> None: ...
    def post_widget(self, widget: tk.Widget, x: int, y: int) -> None: ...
...
class HList(TixWidget, tk.XView, tk.YView):
    def __init__(self, master: tk.Widget | None = None, cnf: dict[str, Any] = {}, **kw) -> None: ...
    def add(self, entry: str, cnf: dict[str, Any] = {}, **kw) -> tk.Widget: ...
    def add_child(self, parent: str | None = None, cnf: dict[str, Any] = {}, **kw) -> tk.Widget: ...
...
class TList(TixWidget, tk.XView, tk.YView):
    def __init__(self, master: tk.Widget | None = None, cnf: dict[str, Any] = {}, **kw) -> None: ...
...
class PanedWindow(TixWidget):
    ...
    def panes(self) -> list[tk.Widget]: ...

class ListNoteBook(TixWidget):
    def __init__(self, master: tk.Widget | None, cnf: dict[str, Any] = {}, **kw) -> None: ...
    def add(self, name: str, cnf: dict[str, Any] = {}, **kw) -> None: ...
    def page(self, name: str) -> tk.Widget: ...
    def pages(self) -> list[tk.Widget]: ...
...
class Form:
    ...
    def slaves(self) -> list[tk.Widget]: ...
