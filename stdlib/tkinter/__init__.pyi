...
class Misc:
    ...
    @overload
    def bind(
        self, sequence: str | None = ..., func: Optional[Callable[[Event[Misc]], Any]] = ..., add: bool | None = ...
    ) -> str: ...
    @overload
...
class Widget(BaseWidget, Pack, Place, Grid):
    ...
    @overload
    def bind(
        self: _W, sequence: str | None = ..., func: Optional[Callable[[Event[_W]], Any]] = ..., add: bool | None = ...
    ) -> str: ...
    @overload
    def bind(self, sequence: str | None, func: str, add: bool | None = ...) -> None: ...
    @overload
...
class Canvas(Widget, XView, YView):
    ...
    def create_line(
        ...
        *,
        ...
        dash: Tuple[float] | Tuple[float, float] | Tuple[float, float, float, float] = ...,
    ...
    def itemconfigure(self, tagOrId, cnf: Any | None = ..., **kw): ...
    itemconfig: Any
...
class Menu(Widget):
    ...
    def delete(self, index1, index2: Any | None = ...): ...
    def entrycget(self, index, option): ...
    def entryconfigure(self, index, cnf: Any | None = ..., **kw): ...
    entryconfig: Any
    def index(self, index): ...
...
class Text(Widget, XView, YView):
    ...
    @overload
    def tag_bind(
        self, tagName: str, sequence: str | None, func: Optional[Callable[[Event[Text]], Any]], add: bool | None = ...
    ) -> str: ...
    @overload
...
class PhotoImage(Image):
    ...
    def put(
        self, data: str | _TkinterSequence[str] | _TkinterSequence2D[_Color], to: Optional[Tuple[int, int]] = ...
    ) -> None: ...
    def write(
        self, filename: StrOrBytesPath, format: str | None = ..., from_coords: Optional[Tuple[int, int]] = ...
    ) -> None: ...
    if sys.version_info >= (3, 8):
