...
class Misc:
    ...
    def register(
        self, func: Callable[..., Incomplete], subst: Callable[..., Sequence[Incomplete]] | None = ..., needcleanup: int = ...
    ) -> str: ...
    ...
    def cget(self, key: str) -> Incomplete: ...
    def configure(self, cnf: Incomplete = ...) -> Incomplete: ...
...
class XView:
    ...
    @overload
    def xview(self, *args: Incomplete) -> Incomplete: ...
...
class YView:
    ...
    @overload
    def yview(self, *args: Incomplete) -> Incomplete: ...
...
class Wm:
    ...
    aspect = wm_aspect
    @overload
    def wm_attributes(self) -> tuple[Incomplete, ...]: ...
    @overload
    def wm_attributes(self, __option: str) -> Incomplete: ...
    @overload
    def wm_attributes(self, __option: str, __value: Incomplete, *__other_option_value_pairs: Incomplete) -> None: ...
...
class Spinbox(Widget, XView):
    ...
    def selection(self, *args: Incomplete) -> tuple[int, ...]: ...
