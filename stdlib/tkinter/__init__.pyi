...
class Misc:
    ...
    def winfo_fpixels(self, number: str | float) -> float: ...
    ...
    def winfo_pixels(self, number: str | float) -> int: ...
...
class XView:
    ...
    @overload
    def xview_scroll(self, number: str | float, what: Literal["pixels"]) -> None: ...
...
class YView:
    ...
    @overload
    def yview_scroll(self, number: str | float, what: Literal["pixels"]) -> None: ...
...
class _PackInfo(_InMiscTotal):
    ...
    # Paddings come out as int or tuple of int, even though str or float
...
class Pack:
    # _PackInfo is not the valid type for cnf because pad stuff accepts str or
    # float instead of int only. I didn't bother to create another
...
class Button(Widget):
    def __init__(
        ...
        *,
        ...
        background: str = ...,
        bd: str | float = ...,  # same as borderwidth
        bg: str = ...,  # same as background
        bitmap: str = "",
        border: str | float = ...,  # same as borderwidth
        borderwidth: str | float = ...,
        ...
        # ints are also valid str | float
        height: str | float = 0,
        highlightbackground: str = ...,
        highlightcolor: str = ...,
        highlightthickness: str | float = 1,
        image: _Image | str = "",
...
class Canvas(Widget, XView, YView):
    def __init__(
        ...
        *,
        ...
        # part of it describes str | float.
        height: str | float = ...,
        highlightbackground: str = ...,
        highlightcolor: str = ...,
        highlightthickness: str | float = ...,
        insertbackground: str = ...,
        insertborderwidth: str | float = 0,
        insertofftime: int = 300,
        insertontime: int = 600,
        insertwidth: str | float = 2,
        name: str = ...,
        offset=...,  # undocumented
        relief: Literal["raised", "sunken", "flat", "ridge", "solid", "groove"] = "flat",
        ...
        xscrollincrement: str | float = 0,
        yscrollcommand: str | Callable[[float, float], object] = "",
        yscrollincrement: str | float = 0,
    ) -> None: ...
    @overload
    def configure(
        self,
    ...
    def addtag_closest(
        self, newtag: str, x: str | float, y: str | float, halo: str | float | None = None, start: str | int | None = None
    ) -> None: ...
    def addtag_enclosed(self, newtag: str, x1: str | float, y1: str | float, x2: str | float, y2: str | float) -> None: ...
    def addtag_overlapping(self, newtag: str, x1: str | float, y1: str | float, x2: str | float, y2: str | float) -> None: ...
    ...
    def find_closest(
        self, x: str | float, y: str | float, halo: str | float | None = None, start: str | int | None = None
    ) -> tuple[int, ...]: ...
    def find_enclosed(self, x1: str | float, y1: str | float, x2: str | float, y2: str | float) -> tuple[int, ...]: ...
    def find_overlapping(self, x1: str | float, y1: str | float, x2: str | float, y2: float) -> tuple[int, ...]: ...
    ...
    def create_line(
        ...
        *,
        ...
        dashoffset: str | float = ...,
        disableddash: str | int | list[int] | tuple[int, ...] = ...,
        disabledfill: str = ...,
        disabledstipple: str = ...,
        disabledwidth: str | float = ...,
        fill: str = ...,
    ...
    def scale(self, tagOrId: str | int, xOrigin: str | float, yOrigin: str | float, xScale: float, yScale: float, /) -> None: ...
...
class Scrollbar(Widget):
    def __init__(
        ...
        *,
        ...
        cursor: _Cursor = "",
        elementborderwidth: str | float = -1,
        highlightbackground: str = ...,
        highlightcolor: str = ...,
        highlightthickness: str | float = 0,
        jump: bool = False,
...
class Text(Widget, XView, YView):
    def __init__(
        ...
        *,
        ...
        selectforeground: str = ...,
        setgrid: bool = False,
        spacing1: str | float = 0,
        spacing2: str | float = 0,
        spacing3: str | float = 0,
    ...
    def tag_configure(
        ...
        *,
        ...
        bgstipple: str = ...,
        borderwidth: str | float = ...,
        border: str | float = ...,  # alias for borderwidth
        elide: bool = ...,
        fgstipple: str = ...,
        font: _FontDescription = ...,
        foreground: str = ...,
...
class LabelFrame(Widget):
    def __init__(
        ...
        *,
        ...
        highlightcolor: str = ...,
        highlightthickness: str | float = 0,
        # 'ne' and 'en' are valid labelanchors, but only 'ne' is a valid `anchor` parameter.
...
class PanedWindow(Widget):
    def __init__(
        ...
        *,
        ...
        borderwidth: str | float = 1,
        cursor: _Cursor = "",
        handlepad: str | float = 8,
        handlesize: str | float = 8,
        height: str | float = "",
        name: str = ...,
        opaqueresize: bool = True,
        orient: Literal["horizontal", "vertical"] = "horizontal",
        proxybackground: str = "",
        proxyborderwidth: str | float = 2,
