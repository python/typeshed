...
_ListboxIndex: TypeAlias = str | int
...
class Listbox(Widget, XView, YView):
    ...
    def configure(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    config = configure
    def activate(self, index: _ListboxIndex) -> None: ...
    def bbox(self, index: _ListboxIndex) -> tuple[int, int, int, int] | None: ...  # type: ignore[override]
    def curselection(self): ...
    def delete(self, first: _ListboxIndex, last: _ListboxIndex | None = ...) -> None: ...
    def get(self, first: _ListboxIndex, last: _ListboxIndex | None = ...): ...
    def index(self, index: _ListboxIndex) -> int: ...
    def insert(self, index: _ListboxIndex, *elements: str | float) -> None: ...
    def nearest(self, y): ...
    def scan_mark(self, x, y) -> None: ...
    def scan_dragto(self, x, y) -> None: ...
    def see(self, index: _ListboxIndex) -> None: ...
    def selection_anchor(self, index: _ListboxIndex) -> None: ...
    select_anchor = selection_anchor
    def selection_clear(self, first: _ListboxIndex, last: _ListboxIndex | None = ...) -> None: ...  # type: ignore[override]
    select_clear = selection_clear
    def selection_includes(self, index: _ListboxIndex): ...
    select_includes = selection_includes
    def selection_set(self, first: _ListboxIndex, last: _ListboxIndex | None = ...) -> None: ...
    select_set = selection_set
    def size(self) -> int: ...  # type: ignore[override]
    def itemcget(self, index: _ListboxIndex, option): ...
    def itemconfigure(self, index: _ListboxIndex, cnf: Any | None = ..., **kw): ...
    itemconfig = itemconfigure
