...
class Menu(Widget):
    ...
    def delete(self, index1: _MenuIndex, index2: Optional[_MenuIndex] = ...) -> None: ...
    def entrycget(self, index: _MenuIndex, option: str) -> Any: ...
    def entryconfigure(self, index: _MenuIndex, cnf: Optional[Dict[str, Any]] = ..., **kw: Any) -> Optional[Dict[str, Tuple[str, str, str, Any, Any]]]: ...
