...
class Scrollbar(Widget):
    ...
    def identify(self, x: int, y: int) -> Literal["arrow1", "arrow2", "slider", "."]: ...
...
class Spinbox(Widget, XView):
    ...
    def identify(self, x: int, y: int) -> Literal["none", "buttondown", "buttonup", "entry"]: ...
