...
class Misc:
    ...
    def grab_status(self) -> Union[Literal["local", "global"], None]: ...
    def option_add(self, pattern, value, priority: Union[int, Literal["widgetDefault", "startupFile", "userDefault", "interactive"]] | None = ...) -> None: ...
    ...
    def bindtags(self, tagList: Any | None = ...) -> Optional[List[str]]: ...
...
class Wm:
    ...
    def wm_iconposition(self, x: str | int | None = ..., y: str | int | None = ...) -> Optional[Tuple[int, int]]: ...
...
def Tcl(screenName: str | None = ..., baseName: str | None = ..., className: str = ..., useTk: bool = ...) -> tk.Tk: ...
...
class Canvas(Widget, XView, YView):
    ...
    def configure(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    config = configure
    def addtag(self, *args) -> None: ...  # internal method
...
class Listbox(Widget, XView, YView):
    ...
    select_anchor: Any
    def selection_clear(self, first, last: Any | None = ...) -> None: ...  # type: ignore
    select_clear: Any
...
class Menu(Widget):
    ...
    def add(self, itemType, cnf=..., **kw) -> None: ...  # docstring says "Internal function."
    def insert(self, index, itemType, cnf=..., **kw) -> None: ...  # docstring says "Internal function."
    def add_cascade(
        self,
        cnf: dict[str, Any] | None = ...,
        *,
...
class Scale(Widget):
    ...
    def configure(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    config = configure
    def get(self) -> FloatingPointError: ...
    def set(self, value) -> None: ...
    def coords(self, value: str | float | None = ...) -> Tuple[int, int]: ...
    def identify(self, x, y) -> Literal["", "slider", "through1", "through2"]: ...
...
class Scrollbar(Widget):
    ...
    def delta(self, deltax: int | str, deltay: int | str) -> float: ...
    def fraction(self, x: int | str, y: int | str) -> float: ...
    def identify(self, x: int | str, y: int | str) -> Literal["arrow1", "arrow2", "slider", "."]: ...
...
class Text(Widget, XView, YView):
    ...
    def yview_pickplace(self, *what) -> None: ...  # deprecated
...
class Image:
    name: Any
    tk: _tkinter.TkappType
    def __init__(self, imgtype, name: Any | None = ..., cnf=..., master: Misc | _tkinter.TkappType | None = ..., **kw) -> None: ...
...
class Spinbox(Widget, XView):
    ...
    def identify(self, x: int | str, y: int | str) -> Literal["none", "buttondown", "buttonup" ,"entry"]: ...
    def index(self, index) -> int: ...
    def insert(self, index: int, s) -> Literal[""]: ...
...
class PanedWindow(Widget):
    ...
    forget: Any
    def identify(self, x: int | str, y: int | str): ...
    def proxy(self, *args): ...
