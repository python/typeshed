...
class Variable:
    ...
    @deprecated("use trace_remove() instead of trace_variable()")
    def trace_vdelete(self, mode, cbname) -> None: ...
    @deprecated("use trace_vinfo() instead of trace_variable()")
...
class Misc:
    ...
    @overload
    @deprecated(".after(timeout) without a callback function freezes the GUI app, use .after(timeout, func) instead")
