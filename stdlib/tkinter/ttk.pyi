...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    ...
    @overload
    def delete(self, __item: str | int) -> None: ...
    @overload
    def delete(self, *items: str | int) -> None: ...
    @overload
    def detach(self, __item: str | int) -> None: ...
    @overload
    ...
    @overload
    def selection_set(self, __items: str | int | list[str] | tuple[str, ...] | list[int] | tuple[int, ...]) -> None: ...
    @overload
    def selection_set(self, *items: str | int) -> None: ...
    @overload
    def selection_add(self, __items: str | int | list[str] | tuple[str, ...] | list[int] | tuple[int, ...]) -> None: ...
    @overload
    def selection_add(self, *items: str | int) -> None: ...
    @overload
    def selection_remove(self, __items: str | int | list[str] | tuple[str, ...] | list[int] | tuple[int, ...]) -> None: ...
    @overload
