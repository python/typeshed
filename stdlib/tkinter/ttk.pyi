...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    ...
    def get_children(self, item: _TreeviewItemId | None = ...) -> Tuple[_TreeviewItemId, ...]: ...
    def set_children(self, item: _TreeviewItemId, *newchildren: _TreeviewItemId) -> None: ...
    @overload
    ...
    def delete(self, *items: _TreeviewItemId) -> None: ...
    def detach(self, *items: _TreeviewItemId) -> None: ...
    def exists(self, item: _TreeviewItemId) -> bool: ...
    @overload  # type: ignore
    def focus(self, item: None = ...) -> _TreeviewItemId | Literal[""]: ...
    @overload
    def focus(self, item: _TreeviewItemId) -> Literal[""]: ...
    @overload
    ...
    def identify_row(self, y: int) -> _TreeviewItemId | Literal[""]: ...
    ...
    def index(self, item: _TreeviewItemId) -> int: ...
    def insert(
        self,
        parent: _TreeviewItemId,
        index: int | Literal["end"],
        iid: Optional[_TreeviewItemId] = ...,
        *,
        id: _TreeviewItemId = ...,  # same as iid
        text: str = ...,
        image: tkinter._ImageSpec = ...,
    ...
    @overload
    def item(self, item: _TreeviewItemId, option: Literal["text"]) -> str: ...
    @overload
    def item(self, item: _TreeviewItemId, option: Literal["image"]) -> Literal[""] | Tuple[str]: ...
    @overload
    def item(self, item: _TreeviewItemId, option: Literal["values"]) -> Literal[""] | Tuple[Any, ...]: ...
    @overload
    def item(self, item: _TreeviewItemId, option: Literal["open"]) -> bool: ...  # actually 0 or 1
    @overload
    def item(self, item: _TreeviewItemId, option: Literal["tags"]) -> Literal[""] | Tuple[str, ...]: ...
    @overload
    def item(self, item: _TreeviewItemId, option: str) -> Any: ...
    @overload
    def item(
        self,
        item: _TreeviewItemId,
        option: None = ...,
        *,
        text: str = ...,
        image: tkinter._ImageSpec = ...,
    ...
    def move(self, item: _TreeviewItemId, parent: _TreeviewItemId, index: int) -> None: ...
    reattach = move
    def next(self, item: _TreeviewItemId) -> _TreeviewItemId | Literal[""]: ...
    def parent(self, item: _TreeviewItemId) -> _TreeviewItemId: ...
    def prev(self, item: _TreeviewItemId) -> _TreeviewItemId | Literal[""]: ...
    def see(self, item: _TreeviewItemId) -> None: ...
    if sys.version_info >= (3, 8):
        def selection(self) -> Tuple[str, ...]: ...
    else:
        def selection(self, selop: Optional[Any] = ..., items: Optional[Any] = ...) -> Tuple[str, ...]: ...
    def selection_set(self, items: _TreeviewItemId | tkinter._TkinterSequence[_TreeviewItemId]) -> None: ...
    def selection_add(self, items: _TreeviewItemId | tkinter._TkinterSequence[_TreeviewItemId]) -> None: ...
    def selection_remove(self, items: _TreeviewItemId | tkinter._TkinterSequence[_TreeviewItemId]) -> None: ...
    def selection_toggle(self, items: _TreeviewItemId | tkinter._TkinterSequence[_TreeviewItemId]) -> None: ...
    @overload
    def set(self, item: _TreeviewItemId, column: None = ..., value: None = ...) -> dict[str, Any]: ...
    @overload
    def set(self, item: _TreeviewItemId, column: _TreeviewColumnId, value: None = ...) -> Any: ...
    @overload
    def set(self, item: _TreeviewItemId, column: _TreeviewColumnId, value: Any) -> Literal[""]: ...
    ...
    @overload
    def tag_has(self, tagname: str, item: None = ...) -> Tuple[_TreeviewItemId, ...]: ...
    @overload
    def tag_has(self, tagname: str, item: _TreeviewItemId) -> bool: ...
