...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    ...
    def configure(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    config = configure
    def bbox(self, item: str | int, column: _TreeviewColumnId | None = None) -> tuple[int, int, int, int] | Literal[""]: ...  # type: ignore[override]
    def get_children(self, item: str | int | None = None) -> tuple[str, ...]: ...
    def set_children(self, item: str | int, *newchildren: str) -> None: ...
    @overload
    ...
    def delete(self, *items: str | list[str] | tuple[str, ...] | int | list[int] | tuple[int, ...]) -> None: ...
    def detach(self, *items: str | list[str] | tuple[str, ...] | int | list[int] | tuple[int, ...]) -> None: ...
    ...
    @overload
    def set(self, item: str | int, column: _TreeviewColumnId, value: None = None) -> Any: ...
    @overload
    def set(self, item: str | int, column: _TreeviewColumnId, value: Any) -> Literal[""]: ...
