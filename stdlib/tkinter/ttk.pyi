...
from typing import Any, Callable, Tuple, Union, overload, Dict
...
class Widget(tkinter.Widget):
    ...
    def identify(self, x: int | str, y: int | str) -> str: ...
...
class Combobox(Entry):
    ...
    @overload
    def config(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    def current(self, newindex: int | str | None = ...) -> int: ...
...
class Progressbar(Widget):
    ...
    def configure(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    config = configure
    def start(self, interval: Literal['cancel', 'idle', 'info'] | int | None = ...) -> None: ...
    def step(self, amount: float | str | None = ...) -> None: ...
    def stop(self) -> None: ...
...
class Scale(Widget, tkinter.Scale):
    ...
    @overload
    def config(self, cnf: str) -> tuple[str, str, str, Any, Any]: ...
    def get(self, x: int | str | None = ..., y: int | str | None = ...) -> float: ...
...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    ...
    def identify(self, component: Literal["region", "item", "column", "row", "element"], x: int | str, y: int | str) -> str: ...
