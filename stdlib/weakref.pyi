...
if sys.version_info >= (3, 4):
    class WeakMethod(ref[types.MethodType]):
        def __new__(type, meth: types.MethodType, callback: Optional[Callable[[types.MethodType], Any]] = ...) -> WeakMethod: ...
...
class KeyedRef(ref[_T], Generic[_KT, _T]):
    key: _KT
    def __new__(cls, ob: _T, callback: Callable[[_T], Any], key: _KT) -> KeyedRef[_KT, _T]: ...
