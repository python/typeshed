...
class finalize(Generic[_P, _T1, _T2]):
    def __init__(self, __obj: _T1, __func: Callable[_P, _T2], *args: _P.args, **kwargs: _P.kwargs) -> None: ...
    def __call__(self, _: object = ...) -> _T2 | None: ...
    def detach(self) -> tuple[_T1, Callable[_P, _T2], tuple[Any, ...], dict[str, Any]] | None: ...
    def peek(self) -> tuple[_T1, Callable[_P, _T2], tuple[Any, ...], dict[str, Any]] | None: ...
    @property
    def alive(self) -> bool: ...
    atexit: bool
