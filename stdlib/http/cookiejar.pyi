...
from typing import Dict, Iterable, Iterator, Sequence, Tuple, TypeVar, Union, overload
...
class FileCookieJar(CookieJar):
    ...
    if sys.version_info >= (3, 8):
        def __init__(
            self, filename: StrPath | None = ..., delayload: bool = ..., policy: CookiePolicy | None = ...
        ) -> None: ...
    else:
        def __init__(
            self, filename: str | None = ..., delayload: bool = ..., policy: CookiePolicy | None = ...
        ) -> None: ...
