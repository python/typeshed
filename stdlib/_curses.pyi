...
class _CursesWindow:
    ...
    @overload
    def getstr(self) -> None: ...
    @overload
    def getstr(self, n: int) -> None: ...
    @overload
    def getstr(self, y: int, x: int) -> None: ...
    @overload
    def getstr(self, y: int, x: int, n: int) -> None: ...
    ...
    def inch(self) -> bytes: ...
    @overload
    def inch(self, y: int, x: int) -> bytes: ...
    @overload
