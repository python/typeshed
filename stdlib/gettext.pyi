...
def find(domain: str, localedir: StrPath | None = ..., languages: Optional[Iterable[str]] = ..., all: bool = ...) -> Any: ...
...
def install(
    domain: str, localedir: StrPath | None = ..., codeset: str | None = ..., names: Optional[Container[str]] = ...
) -> None: ...
