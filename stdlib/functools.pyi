...
from typing import Any, Generic, Literal, NamedTuple, TypedDict, TypeVar, overload, Protocol, Concatenate
...
@overload
def lru_cache(maxsize: _ProtoMethod[_T, _P, _R], typed: bool = False) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]:...
@overload
def lru_cache(maxsize: _ProtoClassmethod[_T, _P, _R], typed: bool = False) -> _ClassmethodDescriptor[_T, _P, _R] | _ClsHashable[_T, _P, _R]:...
@overload
...
if sys.version_info >= (3, 9):
    @overload
    def cache(user_function: _ProtoMethod[_T, _P, _R], typed: bool = False) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]:...
    @overload
    def cache(user_function: _ProtoClassmethod[_T, _P, _R], typed: bool = False) -> _ClassmethodDescriptor[_T, _P, _R] | _ClsHashable[_T, _P, _R]:...
    @overload
    def cache(user_function: _ProtoFunction[_P, _R], typed: bool = False) -> _FunctionDescriptor[_P, _R] | _FnHashable[_P, _R]:...
