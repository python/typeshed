...
class _lru_cache_wrapper(Generic[_P, _R]):
    ...
    if sys.version_info >= (3, 10):
        ...
        @overload
        def __get__(self: _lru_cache_wrapper[Concatenate[_S, _P1], _R], instance: _S, owner: type[Any] | None = ...) -> Callable[_P1, _R]: ...
    else:
        @overload
        def __get__(self, instance: None, owner: type[Any] | None) -> Self: ...
        @overload
...
if sys.version_info >= (3, 9):
    def cache(__user_function: Callable[_P, _R]) -> _lru_cache_wrapper[_P, _R]: ...
