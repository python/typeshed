...
from typing import Any, Generic, Literal, NamedTuple, Protocol, TypedDict, TypeVar, overload
...
if sys.version_info >= (3, 10):
    ...
    class _MethodDescriptor(Protocol[_T_contra, _P, _R]):
        __wrapped__: Callable[Concatenate[_T_contra, _P], _R]
        def __call__(__self, self: _T_contra, *args: _P.args, **kwds: _P.kwargs) -> _R: ...
        @overload
        def __get__(self, instance: None, owner: type[_T_contra]) -> Self: ...
        @overload
        def __get__(self, instance: _T_contra, owner: type[_T_contra]) -> _FunctionDescriptor[_P, _R]: ...
        def cache_info(self) -> _CacheInfo: ...
        def cache_clear(self) -> None: ...
        def cache_parameters(self) -> _CacheParameters: ...
    ...
    class _ClassmethodDescriptor(Protocol[_T_contra, _P, _R]):
        __wrapped__: Callable[Concatenate[type[_T_contra], _P], _R]
        def __call__(self, cls: type[_T_contra], *args: _P.args, **kwds: _P.kwargs) -> _R: ...
        @overload
        def __get__(self, instance: None, owner: type[_T_contra]) -> _FunctionDescriptor[_P, _R]: ...
        @overload
        def __get__(self, instance: _T_contra, owner: type[_T_contra]) -> _FunctionDescriptor[_P, _R]: ...
        def cache_info(self) -> _CacheInfo: ...
        def cache_clear(self) -> None: ...
    ...
    class _ClsHashable(Protocol[_T_contra, _P, _R]):
        __wrapped__: Callable[Concatenate[type[_T_contra], _P], _R]
        def __call__(__self, cls: type[_T_contra], *args: Hashable, **kwds: Hashable) -> _R: ...
        @overload
        def __get__(self, instance: None, owner: type[_T_contra]) -> _FnHashable[_P, _R]: ...
        @overload
        def __get__(self, instance: _T_contra, owner: type[_T_contra]) -> _FnHashable[_P, _R]: ...
        def cache_info(self) -> _CacheInfo: ...
        def cache_clear(self) -> None: ...
        def cache_parameters(self) -> _CacheParameters: ...
