...
if sys.version_info >= (3, 10):
    ...
    class _LRUInner(Protocol):
        @overload
        def __call__(
            self, fn: _ProtoMethod[_T, _P, _R]
        ) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]: ...
        @overload
        def __call__(
            self, fn: _ProtoClassmethod[_T, _P, _R]
    ...
    @overload
    def cache(user_function: _ProtoMethod[_T, _P, _R]) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]: ...
    @overload
    def cache(user_function: _ProtoClassmethod[_T, _P, _R]) -> _ClassmethodDescriptor[_T, _P, _R] | _ClsHashable[_T, _P, _R]: ...
    @overload
    def cache(user_function: _ProtoFunction[_P, _R]) -> _FunctionDescriptor[_P, _R] | _FnHashable[_P, _R]: ...
