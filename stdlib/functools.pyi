...
class _SingleDispatchCallable(Generic[_T]):
    ...
    @overload
    def register(
        self, cls: type[Any] | types.UnionType, func: None = None
    ...
    @overload
    def register(self, cls: type[Any] | types.UnionType, func: Callable[..., _T]) -> Callable[..., _T]: ...
...
class singledispatchmethod(Generic[_T]):
    ...
    @overload
    def register(
        self, cls: type[Any] | types.UnionType, method: None = None
    ) -> Callable[[Callable[..., _T]], Callable[..., _T]]: ...
    @overload
    def register(self, cls: Callable[..., _T], method: None = None) -> Callable[..., _T]: ...
    @overload
    def register(self, cls: type[Any] | types.UnionType, method: Callable[..., _T]) -> Callable[..., _T]: ...
