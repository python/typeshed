...
class _SingleDispatchCallable(Generic[_S, _P, _T]):
    ...
    @overload
    def register(
        self, cls: type[_T1], func: None = ...
    ) -> Callable[[Callable[Concatenate[_T1, _P], _T]], Callable[Concatenate[_T1, _P], _T]]: ...
    # @fun.register
    # def _(arg: int, verbose=False):
    @overload
    def register(self, cls: Callable[Concatenate[_T1, _P], _T], func: None = ...) -> Callable[Concatenate[_T1, _P], _T]: ...
    # fun.register(int, lambda x: x)
    @overload
    def register(self, cls: type[_T1], func: Callable[Concatenate[_T1, _P], _T]) -> Callable[Concatenate[_T1, _P], _T]: ...
    def _clear_cache(self) -> None: ...
    def __call__(__self, __val: _S, *args: _P.args, **kwargs: _P.kwargs) -> _T: ...

def singledispatch(func: Callable[Concatenate[_S, _P], _T]) -> _SingleDispatchCallable[_S, _P, _T]: ...

if sys.version_info >= (3, 8):
    class singledispatchmethod(Generic[_T2, _S, _P, _T]):
        dispatcher: _SingleDispatchCallable[_S, _P, _T]
        func: Callable[Concatenate[_T2, _S, _P], _T]
        def __init__(self, func: Callable[Concatenate[_T2, _S, _P], _T]) -> None: ...
        @property
        def __isabstractmethod__(self) -> bool: ...
        @overload
        def register(
            self, cls: type[_T1], method: None = ...
        ) -> Callable[[Callable[Concatenate[_T2, _T1, _P], _T]], Callable[Concatenate[_T2, _T1, _P], _T]]: ...
        @overload
        def register(
            self, cls: Callable[Concatenate[_T2, _T1, _P], _T], method: None = ...
        ) -> Callable[Concatenate[_T2, _T1, _P], _T]: ...
        @overload
        def register(
            self, cls: type[_T1], method: Callable[Concatenate[_T2, _T1, _P], _T]
        ) -> Callable[Concatenate[_T2, _T1, _P], _T]: ...
        def __get__(self, obj: _T1, cls: _T1 | None = ...) -> Callable[Concatenate[_T2, _S, _P], _T]: ...
