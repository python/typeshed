...
from typing import Any, Concatenate, Generic, Literal, NamedTuple, Protocol, TypedDict, TypeVar, overload
...
class _ProtoFunction(Protocol[_P, _R_co]):
    def __call__(__self, *args: _P.args, **kwds: _P.kwargs) -> _R_co: ...

class _FunctionDescriptor(Protocol[_P, _R]):
...
class _FnHashable(Protocol[_P, _R]):
    __wrapped__: Callable[_P, _R]
...
class _ProtoMethod(Protocol[_T_contra, _P, _R_co]):
    def __call__(__self, self: _T_contra, *args: _P.args, **kwds: _P.kwargs) -> _R_co: ...

class _MethodDescriptor(Protocol[_T, _P, _R]):
    __wrapped__: Callable[Concatenate[_T, _P], _R]
...
class _ProtoClassmethod(Protocol[_T_contra, _P, _R_co]):
    def __call__(__self, cls: type[_T_contra], *args: _P.args, **kwds: _P.kwargs) -> _R_co: ...

class _ClassmethodDescriptor(Protocol[_T, _P, _R]):
    __wrapped__: Callable[Concatenate[type[_T], _P], _R]
...
class _ClsHashable(Protocol[_T, _P, _R]):
    __wrapped__: Callable[Concatenate[type[_T], _P], _R]
    def __call__(__self, cls: type[_T], *args: Hashable, **kwds: Hashable) -> _R: ...
    @overload
    def __get__(self, instance: None, owner: type[_T]) -> _FnHashable[_P, _R]: ...
    @overload
    def __get__(self, instance: _T, owner: type[_T]) -> _FnHashable[_P, _R]: ...
    def __get__(self, instance: _T | None, owner: type[_T]) -> _FnHashable[_P, _R]: ...
    def cache_info(self) -> _CacheInfo: ...
    def cache_clear(self) -> None: ...
    if sys.version_info >= (3, 9):
        def cache_parameters(self) -> _CacheParameters: ...
...
class _LRUInner(Protocol):
    @overload
    def __call__(self, fn: _ProtoMethod[_T, _P, _R]) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]: ...
    @overload
    def __call__(self, fn: _ProtoClassmethod[_T, _P, _R]) -> _ClassmethodDescriptor[_T, _P, _R] | _ClsHashable[_T, _P, _R]: ...
    @overload
    def __call__(self, fn: _ProtoFunction[_P, _R]) -> _FunctionDescriptor[_P, _R] | _FnHashable[_P, _R]: ...

@overload
def lru_cache(maxsize: int | None = 128, typed: bool = False) -> _LRUInner: ...
@overload
def lru_cache(
    maxsize: _ProtoMethod[_T, _P, _R], typed: bool = False
) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]: ...
@overload
def lru_cache(
    maxsize: _ProtoClassmethod[_T, _P, _R], typed: bool = False
) -> _ClassmethodDescriptor[_T, _P, _R] | _ClsHashable[_T, _P, _R]: ...
@overload
def lru_cache(maxsize: _ProtoFunction[_P, _R], typed: bool = False) -> _FunctionDescriptor[_P, _R] | _FnHashable[_P, _R]: ...
...
if sys.version_info >= (3, 9):
    @overload
    def cache(
        user_function: _ProtoMethod[_T, _P, _R], typed: bool = False
    ) -> _MethodDescriptor[_T, _P, _R] | _FnHashable[Concatenate[_T, _P], _R]: ...
    @overload
    def cache(
        user_function: _ProtoClassmethod[_T, _P, _R], typed: bool = False
    ) -> _ClassmethodDescriptor[_T, _P, _R] | _ClsHashable[_T, _P, _R]: ...
    @overload
    def cache(
        user_function: _ProtoFunction[_P, _R], typed: bool = False
    ) -> _FunctionDescriptor[_P, _R] | _FnHashable[_P, _R]: ...
