...
class _lru_cache_wrapper(Generic[_P, _T]):
    ...
    @overload
    def __get__(self, instance: _S, owner: type[_S]) -> _lru_cache_wrapper_instance[_S, _P, _T]: ...
    @overload
    def __get__(self, instance: _S, owner: None) -> _lru_cache_wrapper[_P, _T]: ...

@final
class _lru_cache_wrapper_instance(Generic[_S, _P, _T]):
    __wrapped__: Callable[Concatenate[_S, _P], _T]
    def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _T: ...
    def cache_info(self) -> _CacheInfo: ...
    def cache_clear(self) -> None: ...
    def __copy__(self) -> _lru_cache_wrapper[Concatenate[_S, _P], _T]: ...
    def __deepcopy__(self, __memo: Any) -> _lru_cache_wrapper[Concatenate[_S, _P], _T]: ...
