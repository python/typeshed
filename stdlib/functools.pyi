...
if sys.version_info >= (3, 12):
    _assigned = ("__module__", "__name__", "__qualname__", "__doc__", "__annotations__", "__type_params__")
else:
    _assigned = ("__module__", "__name__", "__qualname__", "__doc__", "__annotations__")

def update_wrapper(
    wrapper: Callable[_PWrapper, _RWapper],
    wrapped: Callable[_PWrapped, _RWrapped],
    assigned: Sequence[str] = _assigned,
