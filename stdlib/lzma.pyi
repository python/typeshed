...
def compress(
    data: _ReadableBuffer, format: int = ..., check: int = ..., preset: int | None = ..., filters: _FilterChain | None = ...
) -> bytes: ...
def decompress(data: _ReadableBuffer, format: int = ..., memlimit: int | None = ..., filters: _FilterChain | None = ...) -> bytes: ...
