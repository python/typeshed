...
def ip_address(address: int | str) -> IPv4Address | IPv6Address: ...
def ip_network(address: int | str, strict: bool = ...) -> IPv4Network | IPv6Network: ...
def ip_interface(address: int | str) -> IPv4Interface | IPv6Interface: ...
