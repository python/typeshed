...
from typing import IO, Callable, Dict, Iterable, Iterator, List, Optional, Protocol, Sequence, Tuple, Type, overload
...
class ZipFile:
    ...
    def open(
        self, name: str | ZipInfo, mode: str = ..., pwd: bytes | None = ..., *, force_zip64: bool = ...
    ) -> IO[bytes]: ...
    def extract(self, member: str | ZipInfo, path: StrPath | None = ..., pwd: bytes | None = ...) -> str: ...
    def extractall(
        self, path: StrPath | None = ..., members: Iterable[str] | None = ..., pwd: bytes | None = ...
    ) -> None: ...
    ...
    if sys.version_info >= (3, 7):
        ...
        def writestr(
            self, zinfo_or_arcname: str | ZipInfo, data: bytes | str, compress_type: int | None = ...
        ) -> None: ...
...
class ZipInfo:
    ...
    compress_size: int
    file_size: int
    def __init__(self, filename: str | None = ..., date_time: _DateTuple | None = ...) -> None: ...
    if sys.version_info >= (3, 8):
        @classmethod
