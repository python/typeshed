...
class ZipFile:
    ...
    def open(
        self, name: str | ZipInfo, mode: str = ..., pwd: Optional[bytes] = ..., *, force_zip64: bool = ...
    ) -> IO[bytes]: ...
    def extract(self, member: str | ZipInfo, path: Optional[StrPath] = ..., pwd: Optional[bytes] = ...) -> str: ...
    def extractall(
    ...
    def read(self, name: str | ZipInfo, pwd: Optional[bytes] = ...) -> bytes: ...
    ...
    if sys.version_info >= (3, 7):
        ...
        def writestr(
            self, zinfo_or_arcname: str | ZipInfo, data: bytes | str, compress_type: Optional[int] = ...
        ) -> None: ...
