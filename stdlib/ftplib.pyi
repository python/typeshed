...
class FTP:
    ...
    def ntransfercmd(self, cmd: str, rest: Optional[int | str] = ...) -> Tuple[socket, int]: ...
    def transfercmd(self, cmd: str, rest: Optional[int | str] = ...) -> socket: ...
    def retrbinary(
        self, cmd: str, callback: Callable[[bytes], Any], blocksize: int = ..., rest: Optional[int | str] = ...
    ) -> str: ...
    def storbinary(
        self,
        cmd: str,
