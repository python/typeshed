...
class OpenerDirector:
    ...
    def open(self, url: Union[str, Request], data: Optional[bytes] = ..., timeout: float = ...) -> _UrlopenRet: ...
...
class BaseHandler:
    ...
    def close(self) -> None: ...
    def http_error_nnn(self, req: Request, fp: IO[str], code: int, msg: int, hdrs: Mapping[str, str]) -> _UrlopenRet: ...

class HTTPDefaultErrorHandler(BaseHandler): ...

class HTTPRedirectHandler(BaseHandler):
    def redirect_request(
        self, req: Request, fp: IO[str], code: int, msg: str, hdrs: Mapping[str, str], newurl: str
    ) -> Optional[Request]: ...
    def http_error_301(
...
if sys.version_info >= (3, 5):
    class HTTPPasswordMgrWithPriorAuth(HTTPPasswordMgrWithDefaultRealm):
        def add_password(
            self, realm: str, uri: Union[str, Sequence[str]], user: str, passwd: str, is_authenticated: bool = ...
        ) -> None: ...
...
class AbstractHTTPHandler(BaseHandler):  # undocumented
    ...
    def do_open(self, http_class: HTTPConnectionProtocol, req: Request, **http_conn_args: Any) -> HTTPResponse: ...
