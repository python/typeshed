...
_SplitResultBase = NamedTuple(
    "_SplitResultBase", [("scheme", str), ("netloc", str), ("path", str), ("query", str), ("fragment", str)]
)
_SplitResultBytesBase = NamedTuple(
    "_SplitResultBytesBase", [("scheme", bytes), ("netloc", bytes), ("path", bytes), ("query", bytes), ("fragment", bytes)]
)

_ParseResultBase = NamedTuple(
    "_ParseResultBase", [("scheme", str), ("netloc", str), ("path", str), ("params", str), ("query", str), ("fragment", str)]
)
...
def parse_qs(
    qs: AnyStr, keep_blank_values: bool = ..., strict_parsing: bool = ..., encoding: str = ..., errors: str = ...
