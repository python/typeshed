...
from typing import (
    ...
    AnyStr, Optional, Union, TypeVar
)

if sys.version_info >= (3, 6):
    _Path = Union[str, os.PathLike[str]]
    _PathVar = TypeVar('_PathVar', str, os.PathLike[str])
else:
    _Path = str
    _PathVar = str
...
def copyfile(src: _Path, dst: _PathVar) -> _PathVar: ...
...
def rmtree(path: _Path, ignore_errors: bool = ...,
           onerror: Callable[[Any, _Path, Any], None] = ...) -> None: ...

if sys.version_info >= (3, 5):
    def move(src: _Path, dst: _Path,
             copy_function: Callable[[_Path, _Path], None] = ...) -> str: ...
