...
from sre_constants import _NamedIntConstant as NIC, error
...
class SubPattern:
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[SubPattern, ]: ...
...
class Tokenizer:
    ...
    def error(self, msg: str, offset: int = ...) -> error: ...
