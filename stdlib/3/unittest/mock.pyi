...
if sys.version_info >= (3, 3):
    ...
    class _patcher:
        def __call__(self, target: Any, new: Optional[Any] = ..., spec: Optional[Any] = ..., create: Any = ..., spec_set: Optional[Any] = ..., autospec: Optional[Any] = ..., new_callable: Optional[Any] = ..., **kwargs: Any) -> Any: ...
        def object(self, target: Any, attribute: str, new: Optional[Any] = ..., spec: Optional[Any] = ..., create: Any = ..., spec_set: Optional[Any] = ..., autospec: Optional[Any] = ..., new_callable: Optional[Any] = ..., **kwargs: Any) -> _patch: ...
        def multiple(self, target: Any, spec: Optional[Any] = ..., create: Any = ..., spec_set: Optional[Any] = ..., autospec: Optional[Any] = ..., new_callable: Optional[Any] = ..., **kwargs: Any) -> Any: ...
