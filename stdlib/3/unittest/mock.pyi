...
class NonCallableMock(Base, Any):  # type: ignore
    ...
    def assert_has_calls(self, calls: _CallList, any_order: bool = False) -> None: ...
    def reset_mock(self, visited: Any = None, *, return_value: bool = ..., side_effect: bool = False) -> None: ...
    def mock_add_spec(self, spec: Any, spec_set: bool = False) -> None: ...
    def _mock_add_spec(self, spec: Any, spec_set, _spec_as_instance: bool = False, _eat_self: bool = False) -> None: ...
