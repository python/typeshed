import sys
from typing import Any, Callable, Iterable, Iterator, Type, TypeVar, Union, Optional, Awaitable
...
if sys.version_info >= (3, 9):
    ...
    class _ContextManagerMixin(Iterable[_ContextManager]):
        def __init__(self, lock: Union[Lock, Semaphore]) -> None: ...
        # Apparently this exists to *prohibit* use as a context manager.
        def __enter__(self) -> object: ...
        def __exit__(self, *args: Any) -> None: ...
        def __iter__(self) -> Iterator[_ContextManager]: ...
