...
class Task(Future[_T], Generic[_T]):
    @classmethod
    def current_task(cls, loop: Optional[AbstractEventLoop] = ...) -> Task[_T]: ...
    @classmethod
    def all_tasks(cls, loop: Optional[AbstractEventLoop] = ...) -> Set[Task[_T]]: ...
    if sys.version_info >= (3, 8):
        def __init__(
            self,
...
if sys.version_info >= (3, 7):
    def all_tasks(loop: Optional[AbstractEventLoop] = ...) -> Set[Task[_T]]: ...
    if sys.version_info >= (3, 8):
        def create_task(
    ...
    def current_task(loop: Optional[AbstractEventLoop] = ...) -> Optional[Task[_T]]: ...
