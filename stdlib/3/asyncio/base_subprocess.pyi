...
class BaseSubprocessTransport:
    ...
    def set_protocol(self, protocol: protocols.SubprocessProtocol) -> None: ...
    def get_protocol(self) -> protocols.SubprocessProtocol: ...
    def is_closing(self) -> bool: ...
    def close(self) -> None: ...
    def get_pid(self) -> Optional[int]: ...
    def get_returncode(self) -> Optional[int]: ...
    def get_pipe_transport(self, fd: int) -> _File: ...
