...
if sys.version_info >= (3, 5):
    ...
    class HTTPResponse(io.BufferedIOBase, BinaryIO):  # type: ignore
        ...
        reason: str
        def __init__(
            self, sock: socket, debuglevel: int = ..., method: Optional[str] = ..., url: Optional[str] = ...
        ) -> None: ...
...
class HTTPConnectionProtocol(Protocol):
    if sys.version_info >= (3, 7):
        ...
        def __call__(
            self, host: str, port: Optional[int] = ..., timeout: int = ..., source_address: Optional[Tuple[str, int]] = ...
        ): ...
...
class HTTPConnection:
    ...
    def close(self) -> None: ...
    def putrequest(self, request: str, selector: str, skip_host: bool = ..., skip_accept_encoding: bool = ...) -> None: ...
