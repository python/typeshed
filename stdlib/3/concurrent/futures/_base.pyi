...
DoneAndNotDoneFutures = NamedTuple('DoneAndNotDoneFutures', [('done', Set[Future[Any]]), ('not_done', Set[Future[Any]])])
...
def wait(fs: Iterable[Future[_T]], timeout: Optional[float] = ..., return_when: str = ...) -> DoneAndNotDoneFutures: ...
