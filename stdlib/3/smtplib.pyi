...
class SMTP:
    ...
    def __init__(self, host: str = ..., port: int = ...,
                 local_hostname: Optional[str] = ..., timeout: Any = ...,
    ...
    def mail(self, sender: str, options: List[str] = ...) -> _Reply: ...
    def rcpt(self, recip: str, options: List[str] = ...) -> _Reply: ...
    def data(self, msg): ...
    ...
    def sendmail(self, from_addr: str, to_addrs: Union[str, List[str]],
                 msg: Union[bytes, str], mail_options: List[str] = ...,
                 rcpt_options: List[str] = ...) -> _SendErrs: ...
    def send_message(self, msg: _Message, from_addr: str = ...,
