...
def find(domain: str, localedir: Optional[_StrPath] = ..., languages: Optional[Iterable[str]] = ...,
         all: bool = ...) -> Any: ...

_T = TypeVar('_T')
@overload
def translation(domain: str, localedir: Optional[_StrPath] = ..., languages: Optional[Iterable[str]] = ...,
...
def install(domain: str, localedir: Optional[_StrPath] = ..., codeset: Optional[str] = ...,
            names: Optional[Container[str]] = ...) -> None: ...

def textdomain(domain: Optional[str] = ...) -> str: ...
def bindtextdomain(domain: str, localedir: Optional[_StrPath] = ...) -> str: ...
