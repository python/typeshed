...
def ConnectNamedPipe(handle: int, overlapped: Union[int, bool] = ...) -> Overlapped: ...
...
def ReadFile(handle: int, size: int, overlapped: Union[int, bool] = ...) -> Tuple[Overlapped, int]: ...
...
def WriteFile(handle: int, buffer: bytes, overlapped: Union[int, bool] = ...) -> Tuple[Overlapped, int]: ...
