...
if sys.version_info >= (3, 9):
    _TraceTupleT = Union[Tuple[int, int, Tuple[_FrameTupleT, ...], Optional[int]], Tuple[int, int, Tuple[_FrameTupleT, ...]]]
else:
    _TraceTupleT = Tuple[int, int, Tuple[Tuple[_FrameTupleT, ...]]]
...
class Traceback(Sequence[Frame]):
    if sys.version_info >= (3, 9):
        ...
        def __init__(self, frames: Tuple[_FrameTupleT, ...], total_nframe: Optional[int] = ...) -> None: ...
    else:
        def __init__(self, frames: Tuple[_FrameTupleT, ...]) -> None: ...
...
class Snapshot:
    def __init__(self, traces: Tuple[_TraceTupleT, ...], traceback_limit: int) -> None: ...
