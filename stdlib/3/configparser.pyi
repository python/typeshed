...
class RawConfigParser(_parser):
    ...
    def getint(
        self, section: str, option: str, *, raw: bool = ..., vars: Optional[_section] = ..., fallback: int = ...
    ) -> int: ...
    def getfloat(
        self, section: str, option: str, *, raw: bool = ..., vars: Optional[_section] = ..., fallback: float = ...
    ) -> float: ...
    def getboolean(
        self, section: str, option: str, *, raw: bool = ..., vars: Optional[_section] = ..., fallback: bool = ...
    ) -> bool: ...
    def _get_conv(
        self,
        section: str,
    ...
    def write(self, fileobject: IO[str], space_around_delimiters: bool = ...) -> None: ...
...
class SectionProxy(MutableMapping[str, str]):
    ...
    def name(self) -> str: ...
    def get(  # type: ignore
        self, option: str, fallback: Optional[str] = ..., *, raw: bool = ..., vars: Optional[_section] = ..., **kwargs: Any
    ) -> str: ...
