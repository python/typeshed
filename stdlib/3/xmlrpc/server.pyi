...
class SimpleXMLRPCDispatcher:  # undocumented
    ...
    def system_methodSignature(self, method_name: str) -> List[Type[Any]]: ...  # undocumented
...
class SimpleXMLRPCRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def decode_request_content(self, data: bytes) -> bytes: ...
...
class SimpleXMLRPCServer(socketserver.TCPServer, SimpleXMLRPCDispatcher):
    ...
    def __init__(self, addr: Tuple[str, int], requestHandler: SimpleXMLRPCRequestHandler = ..., logRequests: bool = ..., allow_none: bool = ..., encoding: Optional[str] = ..., bind_and_activate: bool = ..., use_builtin_types: bool = ...) -> None: ...
