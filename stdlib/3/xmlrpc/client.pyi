...
from typing import Any, Callable, Dict, IO, Iterable, List, Optional, Protocol, Text, Tuple, Type, TypeVar, Union, overload
...
class Marshaller:
    ...
    def __dump(self, value: Union[_Marshallable]) -> None: ...  # undocumented
    def dump_nil(self, value: None, write: IO[str]) -> None: ...
    def dump_bool(self, value: bool, write: IO[str]) -> None: ...
    def dump_long(self, value: int, write: IO[str]) -> None: ...
    def dump_int(self, value: int, write: IO[str]) -> None: ...
    def dump_double(self, value: float, write: IO[str]) -> None: ...
    def dump_unicode(self, value: str, write: IO[str], escape: Callable[[str], str] = ...) -> None: ...
    def dump_bytes(self, value: bytes, write: IO[str]) -> None: ...
    def dump_array(self, value: Union[Iterable[_Marshallable]], write: IO[str]) -> None: ...
    def dump_struct(self, value: Dict[str, _Marshallable], write: IO[str], escape: Callable[[str], str] = ...) -> None: ...
    def dump_datetime(self, value: _XMLDate, write: IO[str]) -> None: ...
    def dump_instance(self, value: Union[DateTime, Binary], write: IO[str]) -> None: ...
...
class Unmarshaller:
    ...
    def end_dispatch(self, tag: str, data: str) -> Any: ...
