...
class Misc:
    ...
    # bind with isinstance(func, str) doesn't return anything, but all other binds do.
    #
    # The order of overloads matters for a call like bind('<Button-1>'), which should return str.
    @overload
    def bind(
        self,
...
class Canvas(Widget, XView, YView):
    ...
    @overload
    def tag_bind(
        self, tagOrId: Union[str, int], sequence: Optional[str] = ..., func: str = ..., add: Optional[bool] = ...,
    ) -> None: ...
