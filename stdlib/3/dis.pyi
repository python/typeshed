from typing import List, Union, Iterable, Tuple, Optional, Any, IO, NamedTuple, Dict
...
def findlinestarts(code: _have_code) -> Iterable[Tuple[int, int]]: ...
...
if sys.version_info >= (3, 4):
    ...
    def get_instructions(x: _have_code, *, first_line: Optional[int] = ...) -> Iterable[Instruction]: ...
else:
