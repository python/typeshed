...
if sys.version_info >= (3, 3):
    ...
    def open(file: _PathType, flags: int, mode: Optional[int] = ...) -> int: ...
...
if sys.version_info >= (3, 3):
    ...
    def chmod(path: _FdOrPathType, mode: int, *, dir_fd: Optional[int] = ..., follow_symlinks: Optional[bool] = ...) -> None: ...
    def chown(path: _FdOrPathType, uid: int, gid: int, *, dir_fd: Optional[int] = ..., follow_symlinks: Optional[bool] = ...) -> None: ...  # Unix only
else:
...
if sys.version_info >= (3, 3):
    def link(src: _PathType, link_name: _PathType, *, src_dir_fd: Optional[int] = ...,
             dst_dir_fd: Optional[int] = ..., follow_symlinks: Optional[bool] = ...) -> None: ...
else:
...
if sys.version_info >= (3, 3):
    ...
    def mkfifo(path: _PathType, mode: Optional[int] = ..., *, dir_fd: Optional[int] = ...) -> None: ...  # Unix only
else:
    def lstat(path: _PathType) -> stat_result: ...
    def mkdir(path: _PathType, mode: Optional[int] = ...) -> None: ...
    def mkfifo(path: _PathType, mode: Optional[int] = ...) -> None: ...  # Unix only
if sys.version_info >= (3, 4):
    def makedirs(name: _PathType, mode: Optional[int] = ..., exist_ok: Optional[bool] = ...) -> None: ...
else:
    def makedirs(path: _PathType, mode: Optional[int] = ..., exist_ok: Optional[bool] = ...) -> None: ...
if sys.version_info >= (3, 4):
    def mknod(path: _PathType, mode: Optional[int] = ..., device: Optional[int] = ...,
              *, dir_fd: Optional[int] = ...) -> None: ...
elif sys.version_info >= (3, 3):
    def mknod(filename: _PathType, mode: Optional[int] = ..., device: Optional[int] = ...,
              *, dir_fd: Optional[int] = ...) -> None: ...
else:
    def mknod(filename: _PathType, mode: Optional[int] = ..., device: Optional[int] = ...) -> None: ...
...
if sys.version_info >= (3, 3):
    def stat(path: _FdOrPathType, *, dir_fd: Optional[int] = ...,
             follow_symlinks: Optional[bool] = ...) -> stat_result: ...
else:
    def stat(path: _PathType) -> stat_result: ...
def stat_float_times(newvalue: Optional[Union[bool, None]] = ...) -> bool: ...
def statvfs(path: _FdOrPathType) -> statvfs_result: ...  # Unix only
if sys.version_info >= (3, 3):
    def symlink(source: _PathType, link_name: _PathType,
                target_is_directory: Optional[bool] = ..., *, dir_fd: Optional[int] = ...) -> None: ...
...
if sys.version_info >= (3, 6):
    ...
    def walk(top: AnyStr, topdown: bool = ..., onerror: Optional[Callable[[OSError], Any]] = ...,
             followlinks: bool = ...) -> Iterator[Tuple[AnyStr, List[AnyStr],
                                                        List[AnyStr]]]: ...
if sys.version_info >= (3, 3):
    def fwalk(top: Optional[AnyStr] = ..., topdown: Optional[bool] = ...,
              onerror: Optional[Callable] = ..., *, follow_symlinks: Optional[bool] = ...,
              dir_fd: Optional[int] = ...) -> Iterator[Tuple[AnyStr, List[AnyStr],
                                             List[AnyStr], int]]: ...  # Unix only
    def getxattr(path: _FdOrPathType, attribute: AnyStr, *, follow_symlinks: Optional[bool] = ...) -> bytes: ...  # Linux only
    def listxattr(path: _FdOrPathType, *, follow_symlinks: Optional[bool] = ...) -> List[str]: ...  # Linux only
    def removexattr(path: _FdOrPathType, attribute: AnyStr, *, follow_symlinks: Optional[bool] = ...) -> None: ...  # Linux only
    def setxattr(path: _FdOrPathType, attribute: AnyStr, value: bytes, flags: Optional[int] = ..., *,
                 follow_symlinks: Optional[bool] = ...) -> None: ...  # Linux only
...
class popen(_TextIOWrapper):
    def __init__(self, command: str, mode: Optional[str] = ...,
...
if sys.version_info >= (3, 6):
    def getrandom(size: int, flags: Optional[int] = ...) -> bytes: ...
