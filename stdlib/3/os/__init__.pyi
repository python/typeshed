...
def abort() -> 'None': ...
def execl(path: _PathType, arg0: Union[bytes, Text], *args: Union[bytes, Text]) -> NoReturn: ...
def execle(path: _PathType, arg0: Union[bytes, Text],
           *args: Any) -> NoReturn: ...  # Imprecise signature
def execlp(path: _PathType, arg0: Union[bytes, Text], *args: Union[bytes, Text]) -> NoReturn: ...
