...
def abort() -> 'None': ...
def execl(path: _PathType, *args: Union[bytes, Text]) -> NoReturn: ...
def execle(path: _PathType, *args: Any) -> NoReturn: ...  # Imprecise signature
def execlp(file: _PathType, *args: Union[bytes, Text]) -> NoReturn: ...
def execlpe(file: _PathType, *args: Any) -> NoReturn: ...  # Imprecise signature
