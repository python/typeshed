...
class _CursesWindow:
    ...
    @overload
    def border(self, ls: _chtype = ...) -> None: ...
    @overload
    def border(self, ls: _chtype = ..., rs: _chtype = ...) -> None: ...
    @overload
    def border(self, ls: _chtype = ..., rs: _chtype = ..., ts: _chtype = ...) -> None: ...
    @overload
    def border(self, ls: _chtype = ..., rs: _chtype = ..., ts: _chtype = ..., bs: _chtype = ...) -> None: ...
    @overload
    def border(self, ls: _chtype = ..., rs: _chtype = ..., ts: _chtype = ..., bs: _chtype = ..., tl: _chtype = ...) -> None: ...
    @overload
    def border(self, ls: _chtype = ..., rs: _chtype = ..., ts: _chtype = ..., bs: _chtype = ..., tl: _chtype = ..., tr: _chtype = ...) -> None: ...
    @overload
    def border(self, ls: _chtype = ..., rs: _chtype = ..., ts: _chtype = ..., bs: _chtype = ..., tl: _chtype = ..., tr: _chtype = ..., bl: _chtype = ...) -> None: ...
    @overload
