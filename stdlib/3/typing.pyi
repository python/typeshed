...
class Mapping(_Collection[_KT], Generic[_KT, _VT_co]):
    ...
    @overload
    def get(self, key: _KT, default: Union[_VT_co, _T] = None) -> Union[_VT_co, _T]: ...
    # Allow passing "None" to Mapping.get; see the discussion at
    # https://github.com/python/mypy/issues/9430
    @overload
    def get(self, key: None) -> Optional[_VT_co]: ...
    @overload
    def get(self, key: None, default: Union[_VT_co, _T] = None) -> Optional[Union[_VT_co, _T]]: ...
