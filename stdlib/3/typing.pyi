...
class Match(Generic[AnyStr]):
    ...
    @overload
    def group(self, group1: Union[str, int] = ...) -> Optional[AnyStr]: ...
    @overload
    def group(self, group1: Union[str, int], group2: Union[str, int], *groups: Union[str, int]) -> Tuple[Optional[AnyStr], ...]: ...
