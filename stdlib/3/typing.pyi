...
class _ConcreteBinaryIO(BinaryIO):
    """Concretized typeshed-only version of BinaryIO.

    Doesn't actually exist; for inheritance in typeshed by classes that
    support a "file-like" interface (e.g. urllib.response.addbase).

    If these classes inherit BinaryIO directly, mypy won't allow them to
    be instantiated, due to the abstractmethods.
    """
    def close(self) -> None: ...
    def fileno(self) -> int: ...
    def flush(self) -> None: ...
