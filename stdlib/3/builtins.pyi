...
_T_code = TypeVar('_T_code', bound='code')
...
def compile(source: Any, filename: Union[str, bytes], mode: str, flags: int = 0, dont_inherit: int = 0) -> _T_code: ...
def copyright() -> None: ...
def credits() -> None: ...
...
def eval(source: Union[str, bytes, _T_code], globals: Optional[Dict[str, Any]] = None, locals: Optional[Mapping[str, Any]] = None) -> Any: ...
def exec(object: Union[str, bytes, _T_code], globals: Optional[Dict[str, Any]] = None, locals: Optional[Mapping[str, Any]] = None) -> Any: ...
