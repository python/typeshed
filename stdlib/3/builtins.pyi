...
if sys.version_info >= (3, 6):
    ...
    def compile(source: Union[str, bytes, AST], filename: Union[str, bytes, _PathLike], mode: str, flags: int = ..., dont_inherit: int = ..., optimize: int = ...) -> Union[CodeType, AST]: ...
else:
    def compile(source: Union[str, bytes, AST], filename: Union[str, bytes], mode: str, flags: int = ..., dont_inherit: int = ..., optimize: int = ...) -> Union[CodeType, AST]: ...
def copyright() -> None: ...
def credits() -> None: ...
