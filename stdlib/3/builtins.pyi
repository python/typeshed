...
def compile(source: Any, filename: Union[str, bytes], mode: str, flags: int = 0, dont_inherit: int = 0) -> CodeObject: ...
def copyright() -> None: ...
def credits() -> None: ...
...
def eval(source: Union[str, bytes, CodeObject], globals: Optional[Dict[str, Any]] = None, locals: Optional[Mapping[str, Any]] = None) -> Any: ...
def exec(object: Union[str, bytes, CodeObject], globals: Optional[Dict[str, Any]] = None, locals: Optional[Mapping[str, Any]] = None) -> Any: ...
