...
def check_builtin(option: Option, opt, value: str) -> Any: ...
...
class HelpFormatter:
    ...
    def _format_str(self, str: str) -> str: ...
...
class OptionContainer:
    _long_opt = ...  # type: Dict[str, Any]
    _short_opt = ...  # type: Dict[str, Any]
...
class OptionParser(OptionContainer):
    ...
    largs = ...  # type: Union[None, List[str]]
    ...
    def _process_args(self, largs: List[str], rargs: List, values: Values) -> None: ...
