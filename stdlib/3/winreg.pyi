...
_KeyType = Union[PyHKEY, int]

def CloseKey(hkey: _KeyType): ...
def ConnectRegistry(computer_name: Optional[str], key: _KeyType) -> PyHKEY: ...
def CreateKey(key: _KeyType, sub_key: Optional[str]) -> PyHKEY: ...
def CreateKeyEx(key: _KeyType, sub_key: Optional[str], reserved: int = ..., access: int = ...) -> PyHKEY: ...
...
def OpenKey(key: _KeyType, sub_key: str, reserved: int = ..., access: int = ...) -> PyHKEY: ...
def OpenKeyEx(key: _KeyType, sub_key: str, reserved: int = ..., access: int = ...) -> PyHKEY: ...
