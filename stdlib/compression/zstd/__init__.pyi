...
def compress(
    data: ReadableBuffer, level: int | None = ..., options: Mapping[int, int] | None = ..., zstd_dict: ZstdDict | None = ...
) -> bytes: ...
def decompress(data: ReadableBuffer, zstd_dict: ZstdDict | None = ..., options: Mapping[int, int] | None = ...) -> bytes: ...
