...
from typing import Any, Generator, Iterable, NamedTuple, Pattern, Protocol, Sequence, TextIO, Union
...
class _Readline_Bytes(Protocol):
    def __call__(self, __size: int | None = ...) -> bytes: ...

class _Readline_Str(Protocol):
...
def detect_encoding(readline: _Readline_Bytes) -> tuple[str, Sequence[bytes]]: ...
def tokenize(readline: _Readline_Bytes) -> Generator[TokenInfo, None, None]: ...
def generate_tokens(readline: _Readline_Str) -> Generator[TokenInfo, None, None]: ...  # undocumented
