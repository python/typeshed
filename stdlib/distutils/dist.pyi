...
class Distribution:
    ...
    # NOTE: This list comes directly from the distutils/command folder.
    @overload
    ...
    @overload
    def get_command_obj(self, command: Literal["bdist_msi"], create: Literal[1, True] = 1) -> bdist_msi: ...
    @overload
    def get_command_obj(self, command: Literal["bdist_rpm"], create: Literal[1, True] = 1) -> bdist_rpm: ...
    @overload
    def get_command_obj(self, command: Literal["bdist_wininst"], create: Literal[1, True] = 1) -> bdist_wininst: ...
    @overload
    ...
    @overload
    def get_command_class(self, command: Literal["bdist_msi"]) -> type[bdist_msi]: ...
    @overload
    def get_command_class(self, command: Literal["bdist_rpm"]) -> type[bdist_rpm]: ...
    @overload
    def get_command_class(self, command: Literal["bdist_wininst"]) -> type[bdist_wininst]: ...
    @overload
    ...
    @overload
    def reinitialize_command(self, command: Literal["bdist_msi"], reinit_subcommands: bool = False) -> bdist_msi: ...
    @overload
    def reinitialize_command(self, command: Literal["bdist_rpm"], reinit_subcommands: bool = False) -> bdist_rpm: ...
    @overload
    def reinitialize_command(self, command: Literal["bdist_wininst"], reinit_subcommands: bool = False) -> bdist_wininst: ...
    @overload
