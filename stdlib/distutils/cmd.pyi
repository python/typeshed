...
class Command:
    ...
    @overload
    def get_finalized_command(self, command: Literal["bdist_msi"], create: bool | Literal[0, 1] = 1) -> bdist_msi: ...
    @overload
    def get_finalized_command(self, command: Literal["bdist_rpm"], create: bool | Literal[0, 1] = 1) -> bdist_rpm: ...
    @overload
    def get_finalized_command(self, command: Literal["bdist_wininst"], create: bool | Literal[0, 1] = 1) -> bdist_wininst: ...
    @overload
    ...
    @overload
    def reinitialize_command(self, command: Literal["bdist_msi"], reinit_subcommands: bool | Literal[0, 1] = 0) -> bdist_msi: ...
    @overload
    def reinitialize_command(self, command: Literal["bdist_rpm"], reinit_subcommands: bool | Literal[0, 1] = 0) -> bdist_rpm: ...
    @overload
    def reinitialize_command(
        self, command: Literal["bdist_wininst"], reinit_subcommands: bool | Literal[0, 1] = 0
    ) -> bdist_wininst: ...
    @overload
