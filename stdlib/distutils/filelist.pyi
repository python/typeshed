...
class FileList:
    ...
    @overload
    def include_pattern(self, pattern: str | Pattern[str], *, is_regex: Literal[True, 1] = 0) -> bool: ...
    @overload
    def include_pattern(
    ...
    @overload
    def exclude_pattern(self, pattern: str | Pattern[str], *, is_regex: Literal[True, 1] = 0) -> bool: ...
    @overload
    def exclude_pattern(
        self, pattern: str | Pattern[str], anchor: bool | Literal[0, 1] = 1, prefix: str | None = None, is_regex: int = 0
    ) -> bool: ...
...
@overload
def translate_pattern(pattern: str | Pattern[str], *, is_regex: Literal[True, 1] = 0) -> Pattern[str]: ...
@overload
def translate_pattern(
