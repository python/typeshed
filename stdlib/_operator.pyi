...
# We cannot specify the return type in _SupportsMod & _SupportsRMod
# because whether __mod__ or __rmod__ is called first depends
...
# We have to use a union as we get false-positive errors
# if `lt`/`le`/`gt`/`ge` do not all have the same signature.
...
@overload
def mod(__a: _SupportsMod[_T_contra], __b: _T_contra) -> Any: ...
@overload
def mod(__a: _T_contra, __b: _SupportsRMod[_T_contra]) -> Any: ...
