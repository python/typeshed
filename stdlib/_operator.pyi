...
class attrgetter(Generic[_T_co]):
    @overload
    def __new__(cls, __attr: str) -> attrgetter[Any]: ...
    @overload
    def __new__(cls, __attr: str, __attr2: str) -> attrgetter[tuple[Any, Any]]: ...
    @overload
    def __new__(cls, __attr: str, __attr2: str, __attr3: str) -> attrgetter[tuple[Any, Any, Any]]: ...
    @overload
    def __new__(cls, __attr: str, __attr2: str, __attr3: str, __attr4: str) -> attrgetter[tuple[Any, Any, Any, Any]]: ...
    @overload
    def __new__(cls, __attr: str, *attrs: str) -> attrgetter[tuple[Any, ...]]: ...
