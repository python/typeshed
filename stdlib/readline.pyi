...
def read_init_file(__filename: Optional[str] = ...) -> None: ...
def get_line_buffer() -> str: ...
def insert_text(__string: str) -> None: ...
def redisplay() -> None: ...
def read_history_file(__filename: Optional[str] = ...) -> None: ...
def write_history_file(__filename: Optional[str] = ...) -> None: ...

if sys.version_info >= (3, 5):
    def append_history_file(__nelements: int, __filename: Optional[str] = ...) -> None: ...
