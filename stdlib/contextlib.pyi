...
class closing(AbstractContextManager[_SupportsCloseT]):
    ...
    def __exit__(self, *exc_info: Unused) -> None: ...  # noqa: Y036
...
if sys.version_info >= (3, 10):
    ...
    class aclosing(AbstractAsyncContextManager[_SupportsAcloseT]):
        ...
        async def __aexit__(self, *exc_info: Unused) -> None: ...  # noqa: Y036
...
if sys.version_info >= (3, 10):
    class nullcontext(AbstractContextManager[_T], AbstractAsyncContextManager[_T]):
        ...
        def __exit__(self, *exctype: Unused) -> None: ...  # noqa: Y036
        async def __aenter__(self) -> _T: ...
        async def __aexit__(self, *exctype: Unused) -> None: ...  # noqa: Y036
...
if sys.version_info >= (3, 11):
    ...
    class chdir(AbstractContextManager[None], Generic[_T_fd_or_any_path]):
        ...
        def __exit__(self, *excinfo: Unused) -> None: ...  # noqa: Y036
