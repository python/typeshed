...
class HelpFormatter:
    ...
    current_indent: int
    default_tag: str
    help_position: Incomplete
    help_width: Incomplete
...
class Option:
    ...
    TYPES: tuple[str, ...]
    TYPE_CHECKER: dict[str, Callable[..., Incomplete]]
    _long_opts: list[str]
...
class OptionContainer:
    ...
    def __init__(self, option_class: type[Option], conflict_handler, description: str | None) -> None: ...
    def _check_conflict(self, option) -> None: ...
    ...
    @overload
    def add_option(self, *args: str | None, **kwargs): ...
...
class OptionParser(OptionContainer):
    ...
    option_list: list[Option]
    process_default_values: Incomplete
    prog: str | None
    rargs: list[Incomplete] | None
    ...
    def expand_prog_name(self, s: str | None): ...
    def format_epilog(self, formatter: HelpFormatter): ...
    ...
    def get_option_group(self, opt_str: str): ...
