...
class SynchronizedString(SynchronizedBase[_SimpleCData[c_char]]):
    def __len__(self) -> int: ...
    @overload
    ...
    @overload
    def __setitem__(self, i: slice, value: bytes | bytearray) -> None: ...
    @overload
    def __setitem__(self, i: int, value: int | bytes | bytearray) -> None: ...
    def __getslice__(self, start: int, stop: int) -> bytes: ...
    def __setslice__(self, start: int, stop: int, values: bytes | bytearray) -> None: ...
