...
class Workbook:
    ...
    _sheets: list[_WorkbookChild | ReadOnlyWorksheet]
    ...
    @property
    def active(self) -> _WorkbookChild: ...
    @active.setter
    ...
    def remove(self, worksheet: _WorkbookChild | ReadOnlyWorksheet) -> None: ...
    remove_sheet = remove
    def create_chartsheet(self, title: str | _Decodable | None = ..., index: int | None = ...) -> Chartsheet: ...
