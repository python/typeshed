...
class Workbook:
    ...
    calculation: Any
    views: Any
    def __init__(self, write_only: bool = ...,
                 iso_dates: bool = ...) -> None: ...
    ...
    def create_chartsheet(self, title: str | None = ...,
                          index: int | None = ...) -> None: ...
    ...
    def create_named_range(self, name: str, worksheet: Worksheet | None = ...,
                           value: str | Any | None = ..., scope: Any | None = ...) -> None: ...
