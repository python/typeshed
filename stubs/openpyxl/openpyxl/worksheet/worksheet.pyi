...
class Worksheet(_WorkbookChild):
    ...
    def add_chart(self, chart: Incomplete, anchor: Incomplete | None = ...) -> None: ...
    def add_image(self, img: Incomplete, anchor: Incomplete | None = ...) -> None: ...
    def add_table(self, table: Table) -> None: ...
    @property
    def tables(self) -> TableList: ...
    def add_pivot(self, pivot: Incomplete) -> None: ...
    def merge_cells(
        self,
