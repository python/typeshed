...
from openpyxl.descriptors.base import _ConvertibleToBool, _ConvertibleToInt
...
class NamedStyle(Serialisable):  # type: ignore[misc]
    ...
    @builtinId.setter
    def builtinId(self, __value: _ConvertibleToInt | None) -> None: ...
    @property
    ...
    def __init__(
        ...
        protection: Protection = ...,
        builtinId: _ConvertibleToInt | None = ...,
...
class _NamedCellStyle(Serialisable):
    ...
    def xfId(self) -> int: ...
    @xfId.setter
    def xfId(self, __value: _ConvertibleToInt) -> None: ...
    @property
    def builtinId(self) -> int | None: ...
    @builtinId.setter
    def builtinId(self, __value: _ConvertibleToInt | None) -> None: ...
    ...
    @iLevel.setter
    def iLevel(self, __value: _ConvertibleToInt | None) -> None: ...
    @property
    def hidden(self) -> bool: ...
    @hidden.setter
    def hidden(self, __value: _ConvertibleToBool) -> None: ...
    ...
    def customBuiltin(self, __value: _ConvertibleToBool) -> None: ...
    ...
    def __init__(
        ...
        customBuiltin: _ConvertibleToBool = None,
        extLst: Unused = None,
    ) -> None: ...
