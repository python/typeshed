...
class FFI:
    ...
    @overload
    def from_buffer(self, cdecl: ReadableBuffer, require_writable: Literal[False] = ...) -> _CData: ...
    @overload
    def from_buffer(self, cdecl: WriteableBuffer, require_writable: Literal[True]) -> _CData: ...
    @overload
    ...
    @overload
    def gc(self, cdata: _CData, destructor: Callable[[_CData], Any], size: int = ...) -> _CData: ...
    @overload
