...
class VBase:
    ...
    parentBehavior: Any
    isNative: bool
    def __init__(self, group: Any | None = ..., *args, **kwds) -> None: ...
    ...
    def serialize(self, buf: Any | None = ..., lineLength: int = ..., validate: bool = ..., behavior: Any | None = ...): ...
...
class Component(VBase):
    ...
    def add(self, objOrName, group: Any | None = ...): ...
