...
class OleFileIO:
    ...
    def _list(
        self,
        files: list[list[str | bytes]],
        prefix: list[str | bytes],
        node: OleDirectoryEntry,
        streams: bool = True,
        storages: bool = False,
    ) -> None: ...
    def listdir(self, streams: bool = True, storages: bool = False) -> list[list[str | bytes]]: ...
    def _find(self, filename: str | Sequence[str]) -> int: ...
    def openstream(self, filename: str | bytes | Sequence[str | bytes]) -> OleStream: ...
    ...
    def get_type(self, filename: str | bytes | Sequence[str | bytes]) -> bool | int: ...
    def getclsid(self, filename: str | bytes | Sequence[str | bytes]) -> str: ...
    def getmtime(self, filename: str | bytes | Sequence[str | bytes]) -> datetime.datetime | None: ...
    def getctime(self, filename: str | bytes | Sequence[str | bytes]) -> datetime.datetime | None: ...
    def exists(self, filename: str | bytes | Sequence[str | bytes]) -> bool: ...
    def get_size(self, filename: str | bytes | Sequence[str | bytes]) -> int: ...
    def get_rootentry_name(self) -> bytes: ...
    def getproperties(
        self, filename: str | bytes | Sequence[str | bytes], convert_time: bool = False, no_conversion: list[int] | None = None
