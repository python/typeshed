...
class Widget:
    ...
    def render(self, value: Any, obj: Model) -> Any: ...
    @overload
    def render(self, value: Any, obj: None = None) -> Any: ...
...
class ForeignKeyWidget(Widget, Generic[_ModelT]):
    ...
    def get_lookup_kwargs(self, value: Any, row: Mapping[str, Any] | None = None, **kwargs: Any): ...
