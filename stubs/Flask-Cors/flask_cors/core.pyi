...
def get_cors_headers(options: _Options, request_headers: dict[str, Any], request_method: str) -> werkzeug.datastructures.MultiDict: ...
...
def get_cors_options(appInstance: flask.App | None, *dicts: _Options) -> _Options: ...
def get_app_kwarg_dict(appInstance: flask.App | None = ...) -> _Options: ...
