...
if sys.version_info >= (3, 12):
    ...
    def NamedTemporaryFile(
        ...
        loop: AbstractEventLoop | None = None,
        executor: Executor | None = None,
    ) -> AiofilesContextManager[AsyncTextIOWrapper[AnyStr]]: ...
    ...
    def NamedTemporaryFile(
        ...
        loop: AbstractEventLoop | None = None,
        executor: Executor | None = None,
    ) -> AiofilesContextManager[AsyncFileIO[AnyStr]]: ...
    ...
    def NamedTemporaryFile(
        ...
        loop: AbstractEventLoop | None = None,
        executor: Executor | None = None,
    ) -> AiofilesContextManager[AsyncBufferedReader[AnyStr]]: ...
    ...
    def NamedTemporaryFile(
        ...
        loop: AbstractEventLoop | None = None,
        executor: Executor | None = None,
    ) -> AiofilesContextManager[AsyncBufferedIOBase[AnyStr]]: ...
else:
    # Text mode: always returns AsyncTextIOWrapper
    @overload
    def NamedTemporaryFile(
