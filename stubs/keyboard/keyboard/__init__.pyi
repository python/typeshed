...
# is_pressed cannot check multi-step hotkeys
...
def call_later(fn: Callable[_P, None], args: tuple[object, ...] = ..., delay: float = ...) -> None: ...
...
def hook_key(key: _Key, callback: _Callback, suppress: bool = ...) -> Callable[[], None]: ...
def on_press_key(key: _Key, callback: _Callback, suppress: bool = ...) -> Callable[[], None]: ...
def on_release_key(key: _Key, callback: _Callback, suppress: bool = ...) -> Callable[[], None]: ...
def unhook(remove: _Callback) -> None: ...

unhook_key = unhook

def unhook_all() -> None: ...
def block_key(key: _Key) -> Callable[[], None]: ...

unblock_key = unhook_key

def remap_key(src: _Key, dst: _ParseableHotkey) -> Callable[[], None]: ...
...
def add_hotkey(
    ...
    callback: Callable[_P, bool | None],
    args: _P_args = ...,
    suppress: bool = ...,
    timeout: float = ...,
