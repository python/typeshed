...
class TokenStreamRewriter:
    ...
    def deleteProgram(self, program_name=...) -> None: ...
    def insertAfterToken(self, token, text, program_name=...) -> None: ...
    def insertAfter(self, index, text, program_name=...) -> None: ...
    def insertBeforeIndex(self, index, text) -> None: ...
    def insertBeforeToken(self, token, text, program_name=...) -> None: ...
    ...
    def replaceRangeTokens(self, from_token, to_token, text, program_name=...) -> None: ...
