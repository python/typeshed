...
class DiagnosticErrorListener(ErrorListener):
    ...
    def reportAmbiguity(
        self, recognizer, dfa: DFA, startIndex: int, stopIndex: int, exact: bool, ambigAlts: set, configs: ATNConfigSet
    ): ...
    def reportAttemptingFullContext(
        self, recognizer, dfa: DFA, startIndex: int, stopIndex: int, conflictingAlts: set, configs: ATNConfigSet
    ): ...
