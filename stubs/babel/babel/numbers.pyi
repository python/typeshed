...
def get_currency_name(currency: str, count: float | decimal.Decimal | None = None, locale: Locale | str | None = None) -> str: ...
def get_currency_symbol(currency: str, locale: Locale | str | None = None) -> str: ...
def get_currency_precision(currency: str) -> int: ...
def get_currency_unit_pattern(currency: str, count: float | None = None, locale: Locale | str | None = None) -> str: ...
...
def get_decimal_symbol(locale: Locale | str | None = None) -> str: ...
def get_plus_sign_symbol(locale: Locale | str | None = None) -> str: ...
def get_minus_sign_symbol(locale: Locale | str | None = None) -> str: ...
def get_exponential_symbol(locale: Locale | str | None = None) -> str: ...
def get_group_symbol(locale: Locale | str | None = None) -> str: ...
...
def parse_number(string: str, locale: Locale | str | None = None) -> int: ...
def parse_decimal(string: str, locale: Locale | str | None = None, strict: bool = False) -> decimal.Decimal: ...
