...
class Locale:
    ...
    @classmethod
    def default(cls, category: str | None = ..., aliases: dict[str, str] = ...) -> Locale: ...
    @classmethod
    def negotiate(cls, preferred: list[str], available: list[str], sep: str = ..., aliases: dict[str, str] = ...) -> Locale: ...
    @classmethod
    def parse(cls, identifier: str, sep: str = ..., resolve_likely_subtags: bool = ...) -> Locale: ...
...
def default_locale(category: str | None = ..., aliases: dict[str, str] = ...) -> str | None: ...
def negotiate_locale(preferred: list[str], available: list[str], sep: str = ..., aliases: dict[str, str] = ...) -> str | None: ...
...
def get_global(key: _GLOBAL_KEY) -> dict[str, Any]: ...
