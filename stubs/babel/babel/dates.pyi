...
# Basic Parsing
def parse_date(string: str, locale: Locale | str | None = ..., format: str = ...) -> date: ...
def parse_time(string: str, locale: Locale | str | None = ..., format: str = ...) -> time: ...
...
class DateTimeFormat:
    ...
    def format(self, value: float | decimal.Decimal, length: int) -> str: ...
    def get_day_of_year(self, date: date | None = ...) -> int: ...
    def get_week_number(self, day_of_period: date, day_of_week: int | None = ...) -> int: ...

PATTERN_CHARS: dict[str, list[int] | None]
PATTERN_CHAR_ORDER: str

def tokenize_pattern(pattern: str) -> list[tuple[str, tuple[str, int]]]: ...
def untokenize_pattern(tokens: Iterable[tuple[str, tuple[str, int]]]) -> str: ...
def split_interval_pattern(pattern: str) -> list[str]: ...
def match_skeleton(skeleton: str, option: Iterable[str], allow_different_fields: bool = ...) -> str | None: ...
