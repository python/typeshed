...
def format_date(date: date | None = None, format: _PredefinedTimeFormat | str = 'medium', locale: Locale | str | None = None) -> str: ...
def format_time(
...
def get_timezone_location(dt_or_tzinfo: _DtOrTzinfo = None, locale: Locale | str | None = None, return_city: bool = False) -> str: ...
...
def get_period_names(
    width: Literal["abbreviated", "narrow", "wide"] = 'wide', context: _Context = 'stand-alone', locale: Locale | str | None = None
) -> LocaleDataDict: ...
def get_day_names(
    width: Literal["abbreviated", "narrow", "short", "wide"] = 'wide', context: _Context = 'format', locale: Locale | str | None = None
) -> LocaleDataDict: ...
def get_month_names(
...
def get_era_names(width: Literal["abbreviated", "narrow", "wide"] = 'wide', locale: Locale | str | None = None) -> LocaleDataDict: ...
