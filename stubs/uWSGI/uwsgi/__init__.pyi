...
from uwsgi.decorators import manage_spool_request, postfork_chain_hook
...
spooler = manage_spool_request
post_fork_hook = postfork_chain_hook
...
class SymbolsZipImporter:
    ...
    def find_module(self, __fullname: str) -> Self | None: ...
    def load_module(self, __fullname) -> ModuleType | None: ...
...
def add_file_monitor(__filename: str) -> None: ...
...
def websocket_recv(request_context: RequestContext = ...) -> bytes: ...
def websocket_recv_nb(request_context: RequestContext = ...) -> bytes: ...
def websocket_send(message: str | bytes | ReadOnlyBuffer, request_context: RequestContext = ...) -> None: ...
def websocket_send_binary(message: str | bytes | ReadOnlyBuffer, request_context: RequestContext = ...) -> None: ...
def worker_id() -> int: ...
