...
class postfork(Generic[_P, _T]):
    ...
    @overload
    def __init__(self: postfork[_P, _T], f: Callable[_P, _T]) -> None: ...  # pyright: ignore[reportGeneralTypeIssues]  #11780
    @overload
...
class mulefunc(Generic[_P, _T]):
    ...
    @overload
    def __init__(self: mulefunc[_P, _T], f: Callable[_P, _T]) -> None: ...  # pyright: ignore[reportGeneralTypeIssues]  #11780
