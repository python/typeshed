...
VBase = Any  # actually vobject.base.VBase
vCalAddress = Any  # actually icalendar.vCalAddress
...
class Principal(DAVObject):
    def __init__(self, client: DAVClient | None = ..., url: URL | None = ...) -> None: ...
    def calendars(self) -> list[Calendar]: ...
    def make_calendar(
        self, name: str | None = ..., cal_id: str | None = ..., supported_calendar_component_set: Any | None = ...
    ) -> Calendar: ...
...
class ScheduleMailbox(Calendar):
    def __init__(self, client: DAVClient | None = ..., principal: Principal | None = ..., url: URL | None = ...) -> None: ...
    def get_items(self): ...
...
class FreeBusy(CalendarObjectResource):
    def __init__(self, parent, data, url: URL | None = ..., id: Any | None = ...) -> None: ...
