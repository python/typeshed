...
_KeyFunction: TypeAlias = Callable[[_T], _KeyT]
...
class SortedList(MutableSequence[SupportsRichComparisonT], Generic[SupportsRichComparisonT]):
    ...
    @overload
    def __new__(cls, iterable: Iterable[_T] | None = ..., *, key: _KeyFunction) -> SortedKeyList[_T, _KeyT]: ...
    @property
    def key(self) -> None: ...
...
class SortedKeyList(SortedList[_T], Generic[_T, _KeyT]):  # type: ignore[type-var]
    def __init__(self, iterable: Iterable[_T] | None = ..., key: _KeyFunction = ...) -> None: ...
    def __new__(cls: type[Self], iterable: Iterable[_T] | None = ..., key: _KeyFunction = ...) -> Self: ...
    @property
