...
class SortedSet(
    ...
    @overload
    def __new__(
        cls, iterable: Iterable[_HashableT] | None = ..., *, key: Callable[[_HashableT], _KeyT]
    ) -> _SortedKeySet[_HashableT, _KeyT]: ...
    @overload
    def __init__(self, iterable: Iterable[_SupportsRichComparisonAndHashableT] | None = ..., key: None = ...) -> None: ...
    @overload
    def __init__(self, iterable: Iterable[_HashableT] | None = ..., *, key: Callable[[_HashableT], _KeyT]) -> None: ...
    @property
    def key(self) -> None: ...
