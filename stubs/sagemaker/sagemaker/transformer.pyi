...
class Transformer:
    ...
    def __init__(
        ...
        strategy: Optional[str | PipelineVariable] = None,
        assemble_with: Optional[str | PipelineVariable] = None,
        output_path: Optional[str | PipelineVariable] = None,
        output_kms_key: Optional[str | PipelineVariable] = None,
        accept: Optional[str | PipelineVariable] = None,
        max_concurrent_transforms: Optional[int | PipelineVariable] = None,
        max_payload: Optional[int | PipelineVariable] = None,
    ...
    def transform(
        ...
        compression_type: Optional[str | PipelineVariable] = None,
        split_type: Optional[str | PipelineVariable] = None,
        job_name: Optional[str] = None,
        input_filter: Optional[str | PipelineVariable] = None,
        output_filter: Optional[str | PipelineVariable] = None,
        join_source: Optional[str | PipelineVariable] = None,
        experiment_config: Optional[Dict[str, str]] = None,
        model_client_config: Optional[Dict[str, str | PipelineVariable]] = None,
