...
class _IsList(_DescriptorBase):
    ...
    max_size: Incomplete
    def __init__(self, item_type: object, max_size: Optional[int] = None) -> None: ...
    def validate(self, value: List): ...
    def require_decode(self, value: List): ...
...
class _IsModelCardObject(_DescriptorBase):
    ...
    def validate(self, value: dict | object): ...
    def require_decode(self, value: dict | object): ...
    def decode(self, value: dict): ...

class _MaxSizeArray(collections.abc.MutableSequence):
    list: Incomplete
    def __init__(self, max_size: int, item_type: Any, array: List = None) -> None: ...
