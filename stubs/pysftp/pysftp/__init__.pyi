...
class CnOpts:
    ...
    def get_hostkey(self, host: str): ...

_Callback = paramiko.sftp_client._Callback
...
class Connection:
    ...
    def cd(self, remotepath: Optional[_Path] = ...) -> None: ...
    ...
    def close(self) -> None: ...
    def open(self, remote_file: _Path, mode: str = ..., bufsize: int = ...): ...
    def exists(self, remotepath: _Path): ...
    def lexists(self, remotepath: _Path): ...
    def symlink(self, remote_src: _Path, remote_dest: _Path) -> None: ...
    def truncate(self, remotepath: _Path, size: Any): ...
    def walktree(self, remotepath: _Path, fcallback: Any, dcallback: Any, ucallback: Any, recurse: bool = ...) -> None: ...
    @property
