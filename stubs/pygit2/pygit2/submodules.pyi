...
class SubmoduleCollection:
    ...
    def add(self, url: str, path: str, link: bool = True, callbacks: RemoteCallbacks | None = None, depth: int = 0) -> Submodule: ...
    def init(self, submodules: Iterable[str] | None = None, overwrite: bool = False) -> None: ...
    def update(
        self, submodules: Iterable[str] | None = None, init: bool = False, callbacks: RemoteCallbacks | None = None, depth: int = 0
    ) -> None: ...
