...
class relativedelta:
    ...
    def __mul__(self, other: ConvertibleToFloat) -> Self: ...
    def __rmul__(self, other: ConvertibleToFloat) -> Self: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __div__(self, other: ConvertibleToFloat) -> Self: ...
    def __truediv__(self, other: ConvertibleToFloat) -> Self: ...
