...
class _TZFileReader(Protocol):
    # optional attribute:
    # name: str
    def __enter__(self) -> _TZFileReader: ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: Exception | None, traceback: TracebackType | None) -> bool | None: ...
    def read(self, __size: int) -> bytes: ...
    def seek(__target: int, __whence: Literal[1]) -> object: ...
...
class _ICalReader(Protocol):
    # optional attribute:
    # read: str
    def __enter__(self) -> _ICalReader: ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: Exception | None, traceback: TracebackType | None) -> bool | None: ...
    def read(self) -> str: ...
