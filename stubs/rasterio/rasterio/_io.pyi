...
from rasterio._typing import Colormap, CRSInput, Indexes, NumType, ShapeND, WindowInput
...
# `_gdal_typename`, `_get_gdal_dtype`, and `_is_complex_int` are Cython
# re-imports from `rasterio.dtypes`; declared here for stub-only callers
# that import them from `rasterio._io`.
def _is_complex_int(dtype: Any) -> bool: ...
def _getnpdtype(dtype: Any) -> Any: ...
def _gdal_typename(dt: Any) -> str: ...
def _get_gdal_dtype(type_name: Any) -> int: ...
