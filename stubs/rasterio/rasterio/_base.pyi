...
from rasterio._typing import Colormap, CRSInput
...
# Re-imported from `rasterio.transform` at runtime.
...
# Module-level helpers used internally by other rasterio modules.
_GDAL_AT_LEAST_3_10: Final[bool]

# Re-exported numpy dtype name constants (mirrors `rasterio.dtypes`); kept for
# compatibility with code that imports them from `rasterio._base`.
complex64: Final[str]
...
# The path-parsing helper; re-exported here for backwards compatibility.
