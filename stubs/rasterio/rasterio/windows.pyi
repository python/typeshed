...
class Window:
    ...
    def from_slices(
        ...
        cols: slice | Sequence[int],
        height: int = -1,
        width: int = -1,
        boundless: bool = False,
    ) -> Self: ...
    # The runtime accepts arbitrary kwargs (op, pixel_precision) for these
    # methods to preserve backwards compatibility while emitting deprecation
    # warnings. We type them as **kwds to match.
