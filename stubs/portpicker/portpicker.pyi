...
def pick_unused_port(pid: int | None = None, portserver_address: str | tuple[str, _Port] | None = None) -> _Port: ...
def get_port_from_port_server(portserver_address: str | tuple[str, _Port], pid: int | None = None) -> _Port | None: ...
