...
class __RL_SAFE_ENV__:
    ...
    def __rl_frozenset__(self, it: Incomplete = ()): ...
...
def __fix_set__(value: Incomplete, default: Incomplete = ...) -> Incomplete: ...
def rl_less_safe_eval(expr: Incomplete, NS: Incomplete) -> Incomplete: ...
