...
class BaseQuery(Query[_T]):
    ...
    def paginate(
        self, page: Incomplete | None = ..., per_page: Incomplete | None = ..., error_out: bool = ..., max_per_page: Incomplete | None = ...
    ) -> Pagination[_T]: ...
...
class Pagination(Generic[_T]):
    ...
    @property
    def pages(self) -> int: ...
    def prev(self: Self, error_out: bool = ...) -> Self: ...
    @property
    def prev_num(self) -> int | None: ...
    @property
    def has_prev(self) -> bool: ...
    def next(self: Self, error_out: bool = ...) -> Self: ...
    @property
