...
class exists_property:
    ...
    @overload
    def __get__(self, obj: None, type: _Type | None = ...) -> exists_property: ...
    @overload
...
class value_property(Generic[_T, _NoneLiteral]):
    ...
    none: _NoneLiteral
    type: str | None
    def __init__(self, prop: str, default: _T | None = ..., none: _NoneLiteral = ..., type: str | None = ...) -> None: ...
    @overload
    def __get__(self, obj: None, type: _Type | None = ...) -> value_property: ...
    @overload
