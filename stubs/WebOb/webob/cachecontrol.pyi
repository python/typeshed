...
class exists_property:
    prop: str
    type: str | None
    def __init__(self, prop: str, type: str | None = ...): ...
    @overload
    def __get__(self, obj: None, type: _Type | None = ...) -> Self: ...
    @overload
    def __get__(self, obj: Any, type: _Type | None = ...) -> bool: ...
...
class value_property(Generic[_T, _NoneLiteral]):
    ...
    type: str | None
    @overload
    def __init__(self, prop: str, default: None = ..., none: None = ..., type: str | None = ...): ...
    @overload
    def __init__(self, prop: str, default: _T, none: _NoneLiteral, type: str | None = ...): ...
    @overload
    def __get__(self, obj: None, type: _Type | None = ...) -> Self: ...
    @overload
    def __get__(self, obj: Any, type: _Type | None = ...) -> _T | _NoneLiteral | None: ...
...
class _BaseCacheControl:
    ...
    @classmethod
    @overload
    def parse(cls, header: str, updates_to: None = ..., type: None = ...) -> _AnyCacheControl: ...
    @classmethod
    @overload
