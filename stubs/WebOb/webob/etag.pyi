...
class _ETagProperty:
    ...
    @overload
    def __set__(self, __obj: Any, __value: str | bytes | None) -> None: ...
    @overload
    def __set__(self, __obj: Any, __value: _ETag) -> None: ...
    def __delete__(self, __obj: Any) -> None: ...

def etag_property(key: str, default: _ETag, rfc_section: str, strong: bool = ...) -> _ETagProperty: ...
...
class ETagMatcher:
    ...
    def __contains__(self, other: str) -> bool: ...
    @classmethod
    def parse(cls, value: str, strong: bool = ...) -> ETagMatcher | _AnyETag: ...
