...
class AcceptValidHeader(Accept):
    ...
    @overload
    def best_match(self, offers: Iterable[str | tuple[str, float] | list[Any]], default_match: None = ...) -> str | None: ...
    @overload
...
class AcceptCharsetValidHeader(AcceptCharset):
    ...
    @overload
    def best_match(self, offers: Iterable[str], default_match: None = ...) -> str | None: ...
    @overload
