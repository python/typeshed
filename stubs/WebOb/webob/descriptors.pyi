...
class _SimpleProperty(_AsymmetricPropertyWithDelete[str | None, _StringTypes | None]): ...
class _ListProperty(_AsymmetricPropertyWithDelete[tuple[str, ...] | None, Iterable[str | bytes] | _StringTypes | None]): ...
class _DateProperty(
    _AsymmetricPropertyWithDelete[
        datetime | None, date | datetime | timedelta | _TimeTuple | struct_time | float | _StringTypes | None
    ]
): ...
