...
class MultiDict(MutableMapping[_KT, _VT]):
    ...
    @overload
    def extend(self, other: None = ..., **kwargs: _VT) -> None: ...
...
class NestedMultiDict(MultiDict[_KT, _VT]):
    ...
    def pop(self, key: _KT, default: Any = ...) -> NoReturn: ...
...
class NoVars:
    ...
    def add(self, key: str, value: str) -> NoReturn: ...
    def setdefault(self, key: str, default: str | None = ...) -> NoReturn: ...
    def update(self, *args: Any, **kwargs: str) -> NoReturn: ...
    def clear(self) -> NoReturn: ...
    ...
    def getone(self, key: str) -> NoReturn: ...
