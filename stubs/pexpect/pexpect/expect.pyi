...
class searcher_string:
    ...
    def search(self, buffer, freshlen, searchwindowsize: int | None = None): ...
...
class Expecter:
    ...
    def __init__(self, spawn: SpawnBase, searcher: searcher_re | searcher_string, searchwindowsize: int | None = -1) -> None: ...
