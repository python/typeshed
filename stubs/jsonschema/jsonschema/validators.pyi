...
class _Validator:
    ...
    @overload
    def iter_errors(self, instance, _schema: None = None) -> Generator[Incomplete, None, None]: ...
    @overload
    @deprecated("Passing a schema to Validator.iter_errors is deprecated and will be removed in a future release.")
    def iter_errors(self, instance, _schema: Schema | None = None) -> Generator[Incomplete, None, None]: ...
    def descend(
    ...
    @overload
    def is_valid(self, instance, _schema: None = None) -> bool: ...
    @overload
    @deprecated("Passing a schema to Validator.is_valid is deprecated and will be removed in a future release.")
    def is_valid(self, instance, _schema: Schema | None = None) -> bool: ...
...
class RefResolver:
    ...
    def resolve(self, ref: str) -> tuple[Incomplete, Incomplete]: ...
