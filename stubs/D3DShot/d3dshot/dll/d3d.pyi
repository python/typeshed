...
class ID3D11Texture2D(ID3D11Resource):
    def GetDesc(self, pDesc: D3D11_TEXTURE2D_DESC) -> None: ...
...
class ID3D11DeviceContext(ID3D11DeviceChild):
    ...
    def CopyResource(self, pDstResource: ID3D11Resource, pSrcResource: ID3D11Resource) -> None: ...
...
class ID3D11Device(_IUnknown):
    ...
    def CreateTexture2D(self, pDesc: D3D11_TEXTURE2D_DESC, pInitialData: c_void_p, ppTexture2D: _CArgObject) -> _HRESULT: ...
    ...
    def GetImmediateContext(self, ppImmediateContext: _CArgObject) -> None: ...
