...
from ctypes import Structure, _CData, _Pointer, c_int32, c_uint, c_ulong, c_void_p
...
class ID3D11Texture2D(ID3D11Resource):
    def GetDesc(self, pDesc: _Pointer[D3D11_TEXTURE2D_DESC]) -> None: ...
...
class ID3D11DeviceContext(ID3D11DeviceChild):
    ...
    def CopySubresourceRegion(
        self,
        pDstResource: _Pointer[ID3D11Resource],
        DstSubresource: UINT,
        DstX: UINT,
        DstY: UINT,
        DstZ: UINT,
        pSrcResource: _Pointer[ID3D11Resource],
        SrcSubresource: UINT,
        pSrcBox: _Pointer[D3D11_BOX],
    ) -> None: ...
    def CopyResource(self, pDstResource: _Pointer[ID3D11Resource], pSrcResource: _Pointer[ID3D11Resource]) -> None: ...
...
class ID3D11Device(_IUnknown):
    ...
    def CreateTexture2D(
        self, pDesc: _Pointer[D3D11_TEXTURE2D_DESC], pInitialData: c_void_p, ppTexture2D: _Pointer[_Pointer[ID3D11Texture2D]]
    ) -> _HRESULT: ...
    ...
    def GetImmediateContext(self, ppImmediateContext: _Pointer[_Pointer[ID3D11DeviceContext]]) -> None: ...
