...
class CryptContext:
    @classmethod
    def from_string(cls, source: str | bytes, section: str = ..., encoding: str = ...) -> CryptContext: ...
    @classmethod
    def from_path(cls, path: str, section: str = ..., encoding: str = ...) -> CryptContext: ...
    ...
    policy: CryptPolicy
    def load_path(self, path: str, update: bool = ..., section: str = ..., encoding: str = ...) -> None: ...
    def load(self, source: str | bytes | dict[str, Any] | CryptContext, update: bool = ..., section: str = ..., encoding: str = ...) -> None: ...
    ...
    def needs_update(self, hash: str | bytes, scheme: str | None = None, category: str | None = None, secret: str | bytes | None = None) -> bool: ...
    ...
    def verify(self, secret: str | bytes, hash: str | bytes, scheme: str | None = None, category: str | None = None, **kwds: Any) -> bool: ...
    def verify_and_update(self, secret: str | bytes, hash: str | bytes, scheme: str | None = None, category: str | None = None, **kwds: Any) -> tuple[bool, str | None]: ...
