...
class CryptContext:
    ...
    def load(
        self, source: str | bytes | dict[str, Any] | CryptContext, update: bool = ..., section: str = ..., encoding: str = ...
    ) -> None: ...
    ...
    def verify(
        self, secret: str | bytes, hash: str | bytes, scheme: str | None = None, category: str | None = None, **kwds: Any
    ) -> bool: ...
