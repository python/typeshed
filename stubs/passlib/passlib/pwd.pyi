...
class SequenceGenerator:
    ...
    def __init__(self, entropy: Incomplete | None = ..., length: Incomplete | None = ..., rng: Incomplete | None = ..., **kwds) -> None: ...
    @property
...
class PhraseGenerator(SequenceGenerator):
    ...
    words: Any
    sep: str
    def __init__(self, wordset: Incomplete | None = ..., words: Incomplete | None = ..., sep: Incomplete | None = ..., **kwds) -> None: ...
    @property
    def symbol_count(self): ...
    def __next__(self): ...
