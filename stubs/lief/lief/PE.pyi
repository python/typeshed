...
class ACCELERATOR_FLAGS:
    ...
    @overload
    def __and__(self, arg0: ACCELERATOR_FLAGS) -> int: ...
    @overload
    ...
    @overload
    def __or__(self, arg0: ACCELERATOR_FLAGS) -> int: ...
    ...
    @overload
    def __xor__(self, arg0: ACCELERATOR_FLAGS) -> int: ...
    @property
    def name(self) -> str: ...
    @property
    def value(self) -> int: ...
...
class Binary(lief.Binary):
    class it_const_signatures:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> Signature: ...
    ...
    class it_data_directories:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> DataDirectory: ...
        def __iter__(self) -> Iterator: ...
        def __len__(self) -> int: ...
    ...
    class it_delay_imports:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> DelayImport: ...
        def __iter__(self) -> Iterator: ...
        def __len__(self) -> int: ...
    ...
    class it_imports:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> Import: ...
        def __iter__(self) -> Iterator: ...
        def __len__(self) -> int: ...
    ...
    class it_relocations:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> Relocation: ...
        def __iter__(self) -> Iterator: ...
        def __len__(self) -> int: ...
    ...
    class it_symbols:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> Symbol: ...
        def __iter__(self) -> Iterator: ...
        def __len__(self) -> int: ...
    ...
    def add_section(self, section: Section, type: SECTION_TYPES = ...) -> Section: ...
    def authentihash(self, algorithm: ALGORITHMS) -> bytes: ...
    def data_directory(self, type: DATA_DIRECTORY) -> DataDirectory: ...
    ...
    @overload
    def hook_function(self, function_name: str, hook_address: int) -> None: ...
    @overload
    def hook_function(self, library_name: str, function_name: str, hook_address: int) -> None: ...
    def predict_function_rva(self, library: str, function: str) -> int: ...
    def remove(self, section: Section, clear: bool = ...) -> None: ...
    ...
    @overload
    def verify_signature(self, checks: Signature.VERIFICATION_CHECKS = ...) -> Signature.VERIFICATION_FLAGS: ...
    @overload
    def verify_signature(self, signature: Signature, checks: Signature.VERIFICATION_CHECKS = ...) -> Signature.VERIFICATION_FLAGS: ...
    @overload
    def verify_signature(detached) -> Any: ...
...
class Builder:
    ...
    def build_dos_stub(self, enable: bool = ...) -> Builder: ...
    def build_imports(self, enable: bool = ...) -> Builder: ...
    def build_overlay(self, enable: bool = ...) -> Builder: ...
    def build_relocations(self, enable: bool = ...) -> Builder: ...
    def build_resources(self, enable: bool = ...) -> Builder: ...
    def build_tls(self, enable: bool = ...) -> Builder: ...
    def get_build(self) -> List[int]: ...
    def patch_imports(self, enable: bool = ...) -> Builder: ...
...
class CodeIntegrity(lief.Object):
    ...
    def __eq__(self, arg0: CodeIntegrity) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: CodeIntegrity) -> bool: ...

class CodeView(lief.Object):
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: CodeView) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: CodeView) -> bool: ...
    @property
    def cv_signature(self) -> CODE_VIEW_SIGNATURES: ...

class CodeViewPDB(CodeView):
    age: int
    filename: str
    signature: List[int[16]]
    def __init__(self) -> None: ...
    def __eq__(self, arg0: CodeViewPDB) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: CodeViewPDB) -> bool: ...
...
class DLL_CHARACTERISTICS:
    ...
    def __and__(self, arg0: int) -> int: ...
    @overload
    def __and__(self, arg0: DLL_CHARACTERISTICS) -> int: ...
    @overload
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __eq__(self, arg0: int) -> bool: ...
    ...
    def __or__(self, arg0: int) -> int: ...
    @overload
    def __or__(self, arg0: DLL_CHARACTERISTICS) -> int: ...
    def __rand__(self, arg0: int) -> int: ...
    def __ror__(self, arg0: int) -> int: ...
    def __rxor__(self, arg0: int) -> int: ...
    def __setstate__(self, state: int) -> None: ...
    ...
    def __xor__(self, arg0: int) -> int: ...
    @overload
    def __xor__(self, arg0: DLL_CHARACTERISTICS) -> int: ...
    @property
    def name(self) -> str: ...
    @property
    def value(self) -> int: ...
...
class DataDirectory(lief.Object):
    ...
    size: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: DataDirectory) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: DataDirectory) -> bool: ...
    @property
    def has_section(self) -> bool: ...
    @property
    def section(self) -> Any: ...
    @property
    def type(self) -> DATA_DIRECTORY: ...
...
class Debug(lief.Object):
    ...
    type: DEBUG_TYPES
    def __init__(self) -> None: ...
    def __eq__(self, arg0: Debug) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: Debug) -> bool: ...
    @property
...
class DelayImport(lief.Object):
    ...
    def __eq__(self, arg0: DelayImport) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: DelayImport) -> bool: ...
    @property
...
class DelayImportEntry(lief.Symbol):
    ...
    name: object
    def __init__(self) -> None: ...
    def __eq__(self, arg0: DelayImportEntry) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: DelayImportEntry) -> bool: ...
    @property
    def hint(self) -> int: ...
    @property
...
class DosHeader(lief.Object):
    ...
    def __init__(self) -> None: ...
    def __eq__(self, arg0: DosHeader) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: DosHeader) -> bool: ...
...
class Export(lief.Object):
    ...
    timestamp: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: Export) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: Export) -> bool: ...
    @property
...
class ExportEntry(lief.Symbol):
    ...
    ordinal: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: ExportEntry) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ExportEntry) -> bool: ...
    @property
...
class GUARD_CF_FLAGS:
    ...
    def __and__(self, arg0: int) -> int: ...
    @overload
    def __and__(self, arg0: GUARD_CF_FLAGS) -> int: ...
    @overload
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __eq__(self, arg0: int) -> bool: ...
    ...
    def __or__(self, arg0: int) -> int: ...
    @overload
    def __or__(self, arg0: GUARD_CF_FLAGS) -> int: ...
    def __rand__(self, arg0: int) -> int: ...
    def __ror__(self, arg0: int) -> int: ...
    def __rxor__(self, arg0: int) -> int: ...
    def __setstate__(self, state: int) -> None: ...
    ...
    def __xor__(self, arg0: int) -> int: ...
    @overload
    def __xor__(self, arg0: GUARD_CF_FLAGS) -> int: ...
    @property
    def name(self) -> str: ...
    @property
    def value(self) -> int: ...
...
class HEADER_CHARACTERISTICS:
    ...
    def __and__(self, arg0: int) -> int: ...
    @overload
    def __and__(self, arg0: HEADER_CHARACTERISTICS) -> int: ...
    @overload
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __eq__(self, arg0: int) -> bool: ...
    ...
    def __or__(self, arg0: int) -> int: ...
    @overload
    def __or__(self, arg0: HEADER_CHARACTERISTICS) -> int: ...
    def __rand__(self, arg0: int) -> int: ...
    def __ror__(self, arg0: int) -> int: ...
    def __rxor__(self, arg0: int) -> int: ...
    def __setstate__(self, state: int) -> None: ...
    ...
    def __xor__(self, arg0: int) -> int: ...
    @overload
    def __xor__(self, arg0: HEADER_CHARACTERISTICS) -> int: ...
    @property
    def name(self) -> str: ...
    @property
    def value(self) -> int: ...
...
class Header(lief.Object):
    ...
    machine: The target machine architecture
    numberof_sections: int
    numberof_symbols: int
    pointerto_symbol_table: int
    signature: List[int[4]]
    sizeof_optional_header: int
    time_date_stamps: int
    def __init__(self) -> None: ...
    def add_characteristic(self, characteristic: HEADER_CHARACTERISTICS) -> None: ...
    def has_characteristic(self, characteristic: HEADER_CHARACTERISTICS) -> bool: ...
    def remove_characteristic(self, characteristic: HEADER_CHARACTERISTICS) -> None: ...
    def __eq__(self, arg0: Header) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: Header) -> bool: ...
    @property
    def characteristics_list(self) -> Set[HEADER_CHARACTERISTICS]: ...
...
class Import(lief.Object):
    ...
    @overload
    def __init__(self, library_name: str) -> None: ...
    def add_entry(self, *args, **kwargs) -> Any: ...
    def get_entry(self, *args, **kwargs) -> Any: ...
    def get_function_rva_from_iat(self, function_name: str) -> int: ...
    def __eq__(self, arg0: Import) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: Import) -> bool: ...
    @property
...
class ImportEntry(lief.Symbol):
    ...
    def __eq__(self, arg0: ImportEntry) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ImportEntry) -> bool: ...
    @property
    def hint(self) -> int: ...
    @property
...
class LangCodeItem(lief.Object):
    ...
    key: str
    lang: RESOURCE_LANGS
    sublang: RESOURCE_SUBLANGS
    type: int
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: LangCodeItem) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LangCodeItem) -> bool: ...
...
class LoadConfiguration(lief.Object):
    ...
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfiguration) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfiguration) -> bool: ...
    @property
    def size(self) -> int: ...
    @property
...
class LoadConfigurationV0(LoadConfiguration):
    ...
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV0) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV0) -> bool: ...
...
class LoadConfigurationV1(LoadConfigurationV0):
    ...
    guard_flags: GUARD_CF_FLAGS
    def __init__(self) -> None: ...
    def has(self, flag: GUARD_CF_FLAGS) -> bool: ...
    def __contains__(self, arg0: GUARD_CF_FLAGS) -> bool: ...
    def __eq__(self, arg0: LoadConfigurationV1) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV1) -> bool: ...
    @property
    def guard_cf_flags_list(self) -> Set[GUARD_CF_FLAGS]: ...

class LoadConfigurationV2(LoadConfigurationV1):
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV2) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV2) -> bool: ...
    @property
...
class LoadConfigurationV3(LoadConfigurationV2):
    ...
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV3) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV3) -> bool: ...

class LoadConfigurationV4(LoadConfigurationV3):
    dynamic_value_reloc_table: int
    hybrid_metadata_pointer: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV4) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV4) -> bool: ...
...
class LoadConfigurationV5(LoadConfigurationV4):
    ...
    reserved2: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV5) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV5) -> bool: ...

class LoadConfigurationV6(LoadConfigurationV5):
    guard_rf_verify_stackpointer_function_pointer: int
    hotpatch_table_offset: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV6) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV6) -> bool: ...

class LoadConfigurationV7(LoadConfigurationV6):
    addressof_unicode_string: int
    reserved3: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: LoadConfigurationV7) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: LoadConfigurationV7) -> bool: ...
...
class OptionalHeader(lief.Object):
    ...
    def __init__(self) -> None: ...
    def add(self, characteristic: DLL_CHARACTERISTICS) -> None: ...
    def has(self, characteristics: DLL_CHARACTERISTICS) -> bool: ...
    def remove(self, characteristic: DLL_CHARACTERISTICS) -> None: ...
    def __contains__(self, arg0: DLL_CHARACTERISTICS) -> bool: ...
    def __eq__(self, arg0: OptionalHeader) -> bool: ...
    def __hash__(self) -> int: ...
    def __iadd__(self, arg0: DLL_CHARACTERISTICS) -> OptionalHeader: ...
    def __isub__(self, arg0: DLL_CHARACTERISTICS) -> OptionalHeader: ...
    def __ne__(self, arg0: OptionalHeader) -> bool: ...
    @property
    def computed_checksum(self) -> int: ...
    @property
    def dll_characteristics_lists(self) -> Set[DLL_CHARACTERISTICS]: ...
...
class Pogo(lief.Object):
    class it_entries:
        ...
        def __next__(self) -> Any: ...
    def __init__(self) -> None: ...
    def __eq__(self, arg0: Pogo) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: Pogo) -> bool: ...
    @property
    def entries(self) -> Pogo.it_entries: ...
    @property
    def signature(self) -> POGO_SIGNATURES: ...
...
class PogoEntry(lief.Object):
    ...
    start_rva: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: PogoEntry) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: PogoEntry) -> bool: ...
...
class RELOCATIONS_BASE_TYPES:
    ...
    MIPS_JMPADDR | ARM_MOV32A | ARM_MOV32 | RISCV_HI20: ClassVar[RELOCATIONS_BASE_TYPES] = ...
    MIPS_JMPADDR16: ClassVar[RELOCATIONS_BASE_TYPES] = ...
    REL | ARM_MOV32T | THUMB_MOV32 | RISCV_LOW12I: ClassVar[RELOCATIONS_BASE_TYPES] = ...
...
class RESOURCE_SUBLANGS:
    ...
    Out of range: ClassVar[RESOURCE_SUBLANGS] = ...
...
class RelocationEntry(lief.Relocation):
    ...
    def __init__(self) -> None: ...
    def __eq__(self, arg0: RelocationEntry) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: RelocationEntry) -> bool: ...

class ResourceAccelerator(lief.Object):
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: ResourceAccelerator) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceAccelerator) -> bool: ...
    @property
    def ansi(self) -> int: ...
    @property
    def flags(self) -> int: ...
...
class ResourceData(ResourceNode):
    ...
    def __eq__(self, arg0: ResourceData) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceData) -> bool: ...
    @property
    def offset(self) -> int: ...
...
class ResourceDialog(lief.Object):
    ...
    def __eq__(self, arg0: ResourceDialog) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceDialog) -> bool: ...
    @property
...
class ResourceDialogItem(lief.Object):
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: ResourceDialogItem) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceDialogItem) -> bool: ...
    @property
    def cx(self) -> int: ...
    @property
    def cy(self) -> int: ...
...
class ResourceDirectory(ResourceNode):
    ...
    time_date_stamp: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: ResourceDirectory) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceDirectory) -> bool: ...
...
class ResourceFixedFileInfo(lief.Object):
    ...
    struct_version: int
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: ResourceFixedFileInfo) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceFixedFileInfo) -> bool: ...
...
class ResourceIcon(lief.Object):
    ...
    def __eq__(self, arg0: ResourceIcon) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceIcon) -> bool: ...

class ResourceNode(lief.Object):
    class it_childs:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg0: int) -> ResourceNode: ...
        def __iter__(self) -> Iterator: ...
        def __len__(self) -> int: ...
    ...
    name: object
    def __init__(self, *args, **kwargs) -> None: ...
    def add_data_node(self, resource_data) -> ResourceNode: ...
    def add_directory_node(self, resource_directory) -> ResourceNode: ...
    @overload
    def delete_child(self, node: ResourceNode) -> None: ...
    @overload
    def delete_child(self, id: int) -> None: ...
    def sort_by_id(self) -> None: ...
    def __eq__(self, arg0: ResourceNode) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceNode) -> bool: ...
    @property
...
class ResourceStringFileInfo(lief.Object):
    ...
    type: int
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: ResourceStringFileInfo) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceStringFileInfo) -> bool: ...

class ResourceStringTable(lief.Object):
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: ResourceStringTable) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceStringTable) -> bool: ...
    @property
    def length(self) -> int: ...
    @property
    def name(self) -> str: ...
...
class ResourceVarFileInfo(lief.Object):
    ...
    type: int
    def __init__(self, *args, **kwargs) -> None: ...
    def __eq__(self, arg0: ResourceVarFileInfo) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceVarFileInfo) -> bool: ...

class ResourceVersion(lief.Object):
    fixed_file_info: Any
    key: str
    string_file_info: Any
    type: int
    var_file_info: Any
    def __init__(self, *args, **kwargs) -> None: ...
    ...
    def __eq__(self, arg0: ResourceVersion) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: ResourceVersion) -> bool: ...
    @property
...
class ResourcesManager(lief.Object):
    ...
    def change_icon(self, old_one, new_one) -> None: ...
    def get_node_type(self, *args, **kwargs) -> Any: ...
    def has_type(self, type: RESOURCE_TYPES) -> bool: ...
    @property
    ...
    @property
    def langs_available(self) -> Set[RESOURCE_LANGS]: ...
    @property
    def string_table(self) -> ResourcesManager.it_const_strings_table: ...
    @property
    def sublangs_available(self) -> Set[RESOURCE_SUBLANGS]: ...
    @property
    def types_available(self) -> Set[RESOURCE_TYPES]: ...
    @property
    def version(self) -> Any: ...
...
class RichEntry(lief.Object):
    ...
    def __eq__(self, arg0: RichEntry) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: RichEntry) -> bool: ...
...
class RichHeader:
    ...
    def __eq__(self, arg0: RichHeader) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: RichHeader) -> bool: ...
    @property
...
class SECTION_CHARACTERISTICS:
    ...
    def __and__(self, arg0: int) -> int: ...
    @overload
    def __and__(self, arg0: SECTION_CHARACTERISTICS) -> int: ...
    @overload
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __eq__(self, arg0: int) -> bool: ...
    ...
    def __or__(self, arg0: int) -> int: ...
    @overload
    def __or__(self, arg0: SECTION_CHARACTERISTICS) -> int: ...
    def __rand__(self, arg0: int) -> int: ...
    def __ror__(self, arg0: int) -> int: ...
    def __rxor__(self, arg0: int) -> int: ...
    def __setstate__(self, state: int) -> None: ...
    ...
    def __xor__(self, arg0: int) -> int: ...
    @overload
    def __xor__(self, arg0: SECTION_CHARACTERISTICS) -> int: ...
    @property
    def name(self) -> str: ...
    @property
    def value(self) -> int: ...
...
class Section(lief.Section):
    ...
    @property
    def characteristics_lists(self) -> Set[SECTION_CHARACTERISTICS]: ...
    @property
...
class Signature(lief.Object):
    class VERIFICATION_CHECKS:
        ...
        def __and__(self, arg0: int) -> int: ...
        @overload
        def __and__(self, arg0: Signature.VERIFICATION_CHECKS) -> int: ...
        @overload
        def __eq__(self, other: object) -> bool: ...
        @overload
        def __eq__(self, arg0: int) -> bool: ...
        ...
        def __or__(self, arg0: int) -> int: ...
        @overload
        def __or__(self, arg0: Signature.VERIFICATION_CHECKS) -> int: ...
        def __rand__(self, arg0: int) -> int: ...
        def __ror__(self, arg0: int) -> int: ...
        def __rxor__(self, arg0: int) -> int: ...
        def __setstate__(self, state: int) -> None: ...
        ...
        def __xor__(self, arg0: int) -> int: ...
        @overload
        def __xor__(self, arg0: Signature.VERIFICATION_CHECKS) -> int: ...
        @property
        def name(self) -> str: ...
        @property
        def value(self) -> int: ...
    ...
    class VERIFICATION_FLAGS:
        ...
        def __and__(self, arg0: int) -> int: ...
        @overload
        def __and__(self, arg0: Signature.VERIFICATION_FLAGS) -> int: ...
        @overload
        def __eq__(self, other: object) -> bool: ...
        @overload
        def __eq__(self, arg0: int) -> bool: ...
        ...
        def __or__(self, arg0: int) -> int: ...
        @overload
        def __or__(self, arg0: Signature.VERIFICATION_FLAGS) -> int: ...
        def __rand__(self, arg0: int) -> int: ...
        def __ror__(self, arg0: int) -> int: ...
        def __rxor__(self, arg0: int) -> int: ...
        def __setstate__(self, state: int) -> None: ...
        ...
        def __xor__(self, arg0: int) -> int: ...
        @overload
        def __xor__(self, arg0: Signature.VERIFICATION_FLAGS) -> int: ...
        @property
        def value(self) -> int: ...
    ...
    class it_const_signers_t:
        ...
        def __next__(self) -> Any: ...
    def __init__(self, *args, **kwargs) -> None: ...
    def check(self, checks: Signature.VERIFICATION_CHECKS = ...) -> Signature.VERIFICATION_FLAGS: ...
    def find_crt(self, *args, **kwargs) -> Any: ...
    def find_crt_issuer(self, *args, **kwargs) -> Any: ...
    def find_crt_subject(self, *args, **kwargs) -> Any: ...
    def parse(self, *args, **kwargs) -> Any: ...
    def __hash__(self) -> int: ...
    @property
    def certificates(self) -> Signature.it_const_crt: ...
    @property
    def content_info(self) -> Any: ...
    @property
    def digest_algorithm(self) -> ALGORITHMS: ...
    @property
    def raw_der(self) -> bytes: ...
    @property
    def signers(self) -> Return an iterator over the signers: ...
    @property
    def version(self) -> int: ...
...
class SignerInfo(lief.Object):
    class it_const_attributes_t:
        ...
        def __next__(self) -> Any: ...
    def __init__(self, *args, **kwargs) -> None: ...
    def get_attribute(self, *args, **kwargs) -> Any: ...
    def get_auth_attribute(self, *args, **kwargs) -> Any: ...
    def get_unauth_attribute(self, *args, **kwargs) -> Any: ...
    def __hash__(self) -> int: ...
    @property
...
class TLS(lief.Object):
    ...
    callbacks: List[int]
    characteristics: int
    data_template: List[int]
    sizeof_zero_fill: int
    def __init__(self) -> None: ...
    def __eq__(self, arg0: TLS) -> bool: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg0: TLS) -> bool: ...
    @property
    def directory(self) -> DataDirectory: ...
    @property
...
class x509(lief.Object):
    ...
    class VERIFICATION_FLAGS:
        ...
        def __and__(self, arg0: int) -> int: ...
        @overload
        def __and__(self, arg0: x509.VERIFICATION_FLAGS) -> int: ...
        @overload
        def __eq__(self, other: object) -> bool: ...
        @overload
        def __eq__(self, arg0: int) -> bool: ...
        ...
        def __or__(self, arg0: int) -> int: ...
        @overload
        def __or__(self, arg0: x509.VERIFICATION_FLAGS) -> int: ...
        def __rand__(self, arg0: int) -> int: ...
        def __ror__(self, arg0: int) -> int: ...
        def __rxor__(self, arg0: int) -> int: ...
        def __setstate__(self, state: int) -> None: ...
        ...
        def __xor__(self, arg0: int) -> int: ...
        @overload
        def __xor__(self, arg0: x509.VERIFICATION_FLAGS) -> int: ...
        @property
        def name(self) -> str: ...
        @property
        def value(self) -> int: ...
    def __init__(self, *args, **kwargs) -> None: ...
    @overload
    def is_trusted_by(self, ca_list: List[x509]) -> x509.VERIFICATION_FLAGS: ...
    @overload
    def is_trusted_by(microsoft_ca_bundle) -> Any: ...
    def parse(self, *args, **kwargs) -> Any: ...
    @overload
    def verify(self, ca: x509) -> x509.VERIFICATION_FLAGS: ...
    @overload
    def verify(signer) -> Any: ...
    def __hash__(self) -> int: ...
    @property
    ...
    @property
    def valid_from(self) -> List[int[6]]: ...
    @property
    def valid_to(self) -> List[int[6]]: ...
    @property
    def version(self) -> int: ...

def get_imphash(binary: Binary, mode: IMPHASH_MODE = ...) -> str: ...
@overload
...
def resolve_ordinals(import: Import, strict: bool = ..., use_std: bool = ...) -> Import: ...
