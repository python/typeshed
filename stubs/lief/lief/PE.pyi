...
class Binary(lief.Binary):
    ...
    def verify_signature(
        self, signature: Signature, checks: Signature.VERIFICATION_CHECKS = ...
...
class RELOCATIONS_BASE_TYPES(Enum):
    __members__: ClassVar[dict] = ...  # read-only
    ABSOLUTE = 0
    HIGH = 1
    LOW = 2
...
class Signature(lief.Object):
    ...
    @property
    def signers(self) -> it_const_signers_t: ...
    @property
    def version(self) -> int: ...
...
def resolve_ordinals(import_: Import, strict: bool = ..., use_std: bool = ...) -> Import: ...
