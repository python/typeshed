...
class TokenStreamRewriter:
    ...
    def insertAfterToken(self, token, text, program_name: Incomplete = ...) -> None: ...
    def insertAfter(self, index, text, program_name: Incomplete = ...) -> None: ...
    def insertBeforeIndex(self, index, text) -> None: ...
    def insertBeforeToken(self, token, text, program_name: Incomplete = ...) -> None: ...
    ...
    def replaceRangeTokens(
        self, from_token, to_token, text, program_name: Incomplete = ...
    ) -> None: ...
    ...
    def lastRewriteTokenIndex(self, program_name: Incomplete = ...): ...
