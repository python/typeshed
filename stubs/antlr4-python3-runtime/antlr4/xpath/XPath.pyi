...
class XPath:
    ...
    def split(self, path: str) -> Incomplete: ...
    def getXPathElement(self, wordToken: Token, anywhere: bool) -> Incomplete: ...
    @staticmethod
    def findAll(tree: ParseTree, xpath: str, parser: Parser) -> Incomplete: ...
    def evaluate(self, t: ParseTree) -> Incomplete: ...
