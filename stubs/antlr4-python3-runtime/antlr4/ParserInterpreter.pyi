...
class ParserInterpreter(Parser):
    ...
    state: Incomplete
    def parse(self, startRuleIndex: int) -> Incomplete: ...
    def enterRecursionRule(self, localctx: ParserRuleContext, state: int, ruleIndex: int, precedence: int) -> Incomplete: ...
    def getATNState(self) -> Incomplete: ...
    def visitState(self, p: ATNState) -> Incomplete: ...
    def visitRuleStopState(self, p: ATNState) -> Incomplete: ...
