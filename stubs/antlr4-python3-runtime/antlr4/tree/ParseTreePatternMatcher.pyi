...
class ParseTreePatternMatcher:
    ...
    def setDelimiters(self, start: str, stop: str, escapeLeft: str) -> Incomplete: ...
    def matchesRuleIndex(self, tree: ParseTree, pattern: str, patternRuleIndex: int) -> Incomplete: ...
    def matchesPattern(self, tree: ParseTree, pattern: ParseTreePattern) -> Incomplete: ...
    def matchRuleIndex(self, tree: ParseTree, pattern: str, patternRuleIndex: int) -> Incomplete: ...
    def matchPattern(self, tree: ParseTree, pattern: ParseTreePattern) -> Incomplete: ...
    def compileTreePattern(self, pattern: str, patternRuleIndex: int) -> Incomplete: ...
    def matchImpl(self, tree: ParseTree, patternTree: ParseTree, labels: dict[str, list[ParseTree]]) -> Incomplete: ...
    def map(self, labels: Incomplete, label: Incomplete, tree: Incomplete) -> None: ...
    def getRuleTagToken(self, tree: ParseTree) -> Incomplete: ...
    def tokenize(self, pattern: str) -> Incomplete: ...
    def split(self, pattern: str) -> Incomplete: ...
