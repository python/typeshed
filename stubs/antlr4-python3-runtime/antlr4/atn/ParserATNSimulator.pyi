...
class ParserATNSimulator(ATNSimulator):
    ...
    def __init__(self, parser: Parser, atn: ATN, decisionToDFA: list[DFA], sharedContextCache: PredictionContextCache) -> None: ...
    def reset(self) -> None: ...
    ...
    def reportAmbiguity(
        self, dfa: DFA, D: DFAState, startIndex: int, stopIndex: int, exact: bool, ambigAlts: set[Incomplete], configs: ATNConfigSet
    ): ...
