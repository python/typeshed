...
def merge(a: PredictionContext, b: PredictionContext, rootIsWildcard: bool, mergeCache: dict[tuple[Incomplete], SingletonPredictionContext]): ...
def mergeSingletons(a: SingletonPredictionContext, b: SingletonPredictionContext, rootIsWildcard: bool, mergeCache: dict[tuple[Incomplete], SingletonPredictionContext]): ...
def mergeRoot(a: SingletonPredictionContext, b: SingletonPredictionContext, rootIsWildcard: bool): ...
def mergeArrays(a: ArrayPredictionContext, b: ArrayPredictionContext, rootIsWildcard: bool, mergeCache: dict[tuple[Incomplete], SingletonPredictionContext]): ...
def combineCommonParents(parents: list[PredictionContext]): ...
def getCachedPredictionContext(context: PredictionContext, contextCache: PredictionContextCache, visited: dict[PredictionContext, PredictionContext]): ...
def getAllContextNodes(context: PredictionContext, nodes: list[Incomplete] = ..., visited: dict[PredictionContext, PredictionContext] = ...): ...
