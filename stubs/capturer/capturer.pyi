...
class CaptureOutput(MultiProcessHelper):
    ...
    def __init__(
        self, merged: bool = ..., encoding: str = ..., termination_delay: float = ..., chunk_size: int = ..., relay: bool = ...
    ) -> None: ...
    ...
    def get_handle(self, *args: Any, **kw: Any) -> Any: ...
    def get_bytes(self, *args: Any, **kw: Any) -> Any: ...
    def get_lines(self, *args: Any, **kw: Any) -> Any: ...
    def get_text(self, *args: Any, **kw: Any) -> Any: ...
    def save_to_handle(self, *args: Any, **kw: Any) -> Any: ...
    def save_to_path(self, *args: Any, **kw: Any) -> Any: ...
