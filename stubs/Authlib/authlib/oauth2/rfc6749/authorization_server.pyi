...
class AuthorizationServer:
    ...
    def create_authorization_response(self, request: object | None = None, grant_user: object | None = None) -> object: ...
    def create_token_response(self, request: object | None = None) -> _SERVER_RESPONSE: ...
