...
class AuthorizationServer:
    ...
    def create_authorization_response(self, request: Any | None = None, grant_user: Any | None = None) -> object: ...
    def create_token_response(self, request: Any | None = None) -> _SERVER_RESPONSE: ...
