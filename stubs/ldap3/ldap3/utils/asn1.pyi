...
def decode_bind_response(message, start, stop, context_decoders: _Unused = ...): ...
def decode_extended_response(message, start, stop, context_decoders: _Unused = ...): ...
def decode_intermediate_response(message, start, stop, context_decoders: _Unused = ...): ...
def decode_controls(message, start, stop, context_decoders: _Unused = ...): ...
