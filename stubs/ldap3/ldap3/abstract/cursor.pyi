...
class Reader(Cursor):
    ...
    def search_paged(self, paged_size, paged_criticality: bool = ..., generator: bool = ..., attributes: Incomplete | None = ...): ...
...
class Writer(Cursor):
    ...
    entry_initial_status: Any
    @staticmethod
    def from_cursor(cursor, connection: Incomplete | None = ..., object_def: Incomplete | None = ..., custom_validator: Incomplete | None = ...): ...
    @staticmethod
