...
class ResourceDB:
    ...
    def output(self) -> str: ...
    def getopt(self, name: str, argv: Sequence[str], opts: dict[str, Option]) -> Sequence[str]: ...

def bin_insert(list: list[_C], element: _C) -> None: ...
def update_db(dest: _DB, src: _DB) -> None: ...
def copy_group(group: tuple[_DB, ...]) -> tuple[_DB, ...]: ...
def copy_db(db: _DB) -> _DB: ...
def output_db(prefix: str, db: _DB) -> str: ...
...
def get_display_opts(options: dict[str, Option], argv: Sequence[str] = ...) -> tuple[Display, str, ResourceDB, Sequence[str]]: ...
