...
class SFTPClient(BaseSFTP, ClosingContextManager):
    ...
    def getfo(self, remotepath: bytes | str, fl: IO[bytes], callback: _Callback | None = None, prefetch: bool = True, max_concurrent_prefetch_requests: int | None = None) -> int: ...
    def get(
        self, remotepath: bytes | str, localpath: StrOrBytesPath, callback: _Callback | None = None, prefetch: bool = True, max_concurrent_prefetch_requests: int | None = None
    ) -> None: ...
