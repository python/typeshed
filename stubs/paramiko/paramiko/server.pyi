...
class ServerInterface:
    ...
    def check_channel_pty_request(
        self, channel: Channel, term: str | bytes, width: int, height: int, pixelwidth: int, pixelheight: int, modes: bytes
    ) -> bool: ...
    ...
    def check_channel_env_request(self, channel: Channel, name: str | bytes, value: str | bytes) -> bool: ...
