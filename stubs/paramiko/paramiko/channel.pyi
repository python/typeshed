...
class Channel(ClosingContextManager):
    ...
    def get_pty(
        self, term: bytes = ..., width: int = ..., height: int = ..., width_pixels: int = ..., height_pixels: int = ...
    ) -> None: ...
    ...
    def update_environment(self, environment: Mapping[bytes, bytes]) -> None: ...
    def set_environment_variable(self, name: bytes, value: bytes) -> None: ...
