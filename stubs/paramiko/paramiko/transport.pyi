...
class Transport(Thread, ClosingContextManager):
    ...
    def start_server(self, event: Event = None, server: ServerInterface | None = None) -> None: ...
    ...
    def open_x11_channel(self, src_addr: _Addr = None) -> Channel: ...
    ...
    def send_ignore(self, byte_count: int = None) -> None: ...
