...
class PKey:
    ...
    def write_private_key_file(
        self, filename: FileDescriptorOrPath, password: str | None = None, file_format: FileFormat = PEM,
    ) -> None: ...
    def write_private_key(
        self, file_obj: SupportsWrite[str], password: str | None = None, file_format: FileFormat = PEM,
    ) -> None: ...
