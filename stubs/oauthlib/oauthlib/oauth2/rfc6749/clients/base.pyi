...
class Client:
    ...
    def prepare_request_uri(self, *args, **kwargs) -> AnyStr: ...
    def prepare_request_body(self, *args, **kwargs) -> Any: ...
    def parse_request_uri_response(self, *args, **kwargs) -> Dict[AnyStr, AnyStr]: ...
    def add_token(
        self,
        uri,
        http_method: str = "GET",
