...
class Client:
    ...
    def prepare_authorization_request(
        self, authorization_url, state: Incomplete | None = ..., redirect_url: Incomplete | None = ..., scope: Incomplete | None = ..., **kwargs
    ): ...
    ...
    def prepare_refresh_body(self, body: str = ..., refresh_token: Incomplete | None = ..., scope: Incomplete | None = ..., **kwargs): ...
