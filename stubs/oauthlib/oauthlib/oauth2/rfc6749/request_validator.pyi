...
class RequestValidator:
    ...
    def save_token(self, token: _BearerToken | dict[str, Any], request: Request, *args, **kwargs) -> None: ...
    def save_bearer_token(self, token: _BearerToken, request: Request, *args, **kwargs) -> str: ...
