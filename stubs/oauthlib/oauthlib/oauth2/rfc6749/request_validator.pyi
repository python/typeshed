...
class RequestValidator:
    ...
    def confirm_redirect_uri(self, client_id: str, code: str, redirect_uri:str, client: Client, request: Request, *args, **kwargs) -> bool: ...
    ...
    def introspect_token(self, token: str, token_type_hint: str, request: Request, *args, **kwargs) -> Optional[Dict]: ...
    ...
    def validate_response_type(self, client_id: str, response_type: str, client: Client, request: Request, *args, **kwargs) -> bool: ...
