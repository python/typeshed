...
def quote(s: AnyStr, safe: bytes = b"/") -> str: ...
def unquote(s: AnyStr) -> str: ...
def urlencode(params: list[tuple[AnyStr, AnyStr]]) -> str: ...
def encode_params_utf8(params: list[tuple[AnyStr, AnyStr]]) -> list[tuple[bytes, bytes]]: ...
def decode_params_utf8(params: list[tuple[AnyStr, AnyStr]]) -> list[tuple[str, str]]: ...

urlencoded: Final[set[str]]

def urldecode(query: AnyStr) -> list[tuple[str, str]]: ...
def extract_params(raw: AnyStr | dict[str, str] | Iterable[tuple[str, str]]) -> list[tuple[str, str]] | None: ...
def generate_nonce() -> str: ...
def generate_timestamp() -> str: ...
def generate_token(length: int = 30, chars: Sequence[str] = ...) -> str: ...
def generate_signed_token(private_pem, request): ...
def verify_signed_token(public_pem, token): ...
def generate_client_id(length: int = 30, chars: Sequence[str] = ...) -> str: ...
...
@overload
def to_unicode(data: AnyStr, encoding: str = "UTF-8") -> str: ...
@overload
def to_unicode(data: Mapping[_K, _V], encoding: str = "UTF-8") -> dict[str, _V]: ...
@overload
...
class CaseInsensitiveDict(dict[str, Any]):
    ...
    def get(self, k: str, default: Any | None = None) -> Any | None: ...
