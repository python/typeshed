...
def generate_token(length: int = 30, chars='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'): ...
def generate_signed_token(private_pem, request): ...
def verify_signed_token(public_pem, token): ...
def generate_client_id(length: int = 30, chars=' !"#$%&\\\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}'): ...
...
class Request:
    ...
    validator_log: Any
    def __init__(
        self, uri, http_method: str = 'GET', body: Incomplete | None = None, headers: Incomplete | None = None, encoding: str = 'utf-8'
    ): ...
