...
def parse_iso8601(date_str: str, delimiter: str = "T", timezone: type[NO_DEFAULT] | object | None = None) -> int: ...
...
def deprecation_warning(
    msg: str, *, printer: Callable[..., object] | None = None, stacklevel: int = 0, **kwargs: object
) -> None: ...
...
class LazyList(Sequence[_T]):
    def __init__(self, iterable: Iterable[_T], *, reverse: bool = False, _cache: list[object] | None = None) -> None: ...
...
class PagedList:
    def __len__(self) -> int: ...
    def __init__(self, pagefunc: Callable[[int], Iterator[object]], pagesize: int, use_cache: bool = True) -> None: ...
...
class InAdvancePagedList(PagedList):
    def __init__(self, pagefunc: Callable[[int], Iterator[object]], pagecount: int, pagesize: int) -> None: ...
...
def cli_option(params: _Params, command_option: str, param: str, separator: str | None = None) -> object: ...
def cli_bool_option(
    params: _Params,
    command_option: str,
    param: bool | None,
...
def cli_valueless_option(params: _Params, command_option: str, param: str, expected_value: bool = True) -> object: ...
def cli_configuration_args(
    argdict: dict[str, object], keys: Iterable[str], default: object = ..., use_compat: bool = True
) -> object: ...
...
def join_nonempty(*values: str, delim: str = "-", from_dict: Mapping[str, object] | None = None) -> str: ...
def scale_thumbnails_to_max_format_width(
    formats: Iterable[Mapping[str, object]], thumbnails: Iterable[Mapping[str, object]], url_width_re: str | Pattern[str]
