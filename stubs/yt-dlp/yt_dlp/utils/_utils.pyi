...
def parse_resolution(s: str, *, lenient: bool = False, parse_fps: bool = False) -> dict[str, int]: ...
...
class _UnsafeExtensionError(Exception):
    ...
    @classmethod
    def sanitize_extension(cls, extension: str, /, *, prepend: bool = False, _allowed_exts: Iterable[str] = ()) -> str: ...
...
class Popen(subprocess.Popen[AnyStr]):
    ...
    @classmethod
    def run(cls, *args: Any, timeout: int | None = None, input: AnyStr | None = None, **kwargs: Any) -> tuple[AnyStr, AnyStr]: ...
