...
def decode_base(value: str, digits: str): ...
...
def process_communicate_or_kill(p: Popen[Any], *args: object, **kwargs: object): ...
def encodeFilename(s: str, for_subprocess: Unused = False): ...
def decodeFilename(b: bytes, for_subprocess: Unused = False): ...
