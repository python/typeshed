...
class InfoExtractor:
    ...
    def report_warning(
        self, msg: str, video_id: str | None = None, *args: object, only_once: bool = False, **kwargs: object
    ) -> None: ...
    ...
    def extract_subtitles(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    ...
    def _json_ld(
        self, json_ld: object, video_id: str, fatal: bool = True, expected_type: Iterable[str] | str | None = None
    ) -> dict[str, object]: ...
    def _search_nextjs_data(
        self, webpage: str, video_id: str, *, fatal: bool = True, default: type[NO_DEFAULT] | bool = ..., **kw: object
    ) -> object: ...
    ...
    @staticmethod
    def _hidden_inputs(html: str) -> dict[str, object]: ...
    def _form_hidden_inputs(self, form_id: str, html: str) -> dict[str, object]: ...
    def _check_formats(self, formats: list[dict[str, object]], video_id: str) -> None: ...
    @staticmethod
    def _remove_duplicate_formats(formats: list[dict[str, object]]) -> None: ...
    def _is_valid_url(self, url: str, video_id: str, item: str = "video", headers: Mapping[str, object] = ...) -> bool: ...
    ...
    def _extract_m3u8_formats(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    ...
    def _extract_smil_formats_and_subtitles(
        ...
        video_id: str,
        fatal: bool = True,
        f4m_params: Mapping[str, object] | None = None,
        transform_source: Callable[..., str] | None = None,
    ) -> tuple[list[dict[str, object]], list[dict[str, object]]]: ...
    def _extract_smil_formats(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    def _extract_smil_info(
        self, smil_url: str, video_id: str, fatal: bool = True, f4m_params: Mapping[str, object] | None = None
    ) -> dict[str, object]: ...
    def _download_smil(
        self, smil_url: str, video_id: str, fatal: bool = True, transform_source: Callable[..., str] | None = None
    ) -> ET.Element: ...
    def _parse_smil(
        self, smil: ET.Element, smil_url: str, video_id: str, f4m_params: Mapping[str, object] | None = None
    ) -> dict[str, object]: ...
    def _parse_smil_namespace(self, smil: str) -> str | None: ...
    def _parse_smil_formats(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    ...
    def _extract_xspf_playlist(self, xspf_url: str, playlist_id: str, fatal: bool = True) -> list[dict[str, object]]: ...
    def _parse_xspf(
        self, xspf_doc: ET.Element, playlist_id: str, xspf_url: str | None = None, xspf_base_url: str | None = None
    ) -> list[dict[str, object]]: ...
    def _extract_mpd_formats(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    ...
    def _merge_mpd_periods(self, periods: Iterable[Mapping[str, object]]) -> tuple[list[object], dict[str, object]]: ...
    def _parse_mpd_periods(
        self, mpd_doc: ET.Element, mpd_id: str | None = None, mpd_base_url: str = "", mpd_url: str | None = None
    ) -> tuple[list[object], dict[str, object]]: ...
    def _extract_ism_formats(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    ...
    def _extract_akamai_formats(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    def _extract_akamai_formats_and_subtitles(
        self, manifest_url: str, video_id: str, hosts: Mapping[str, object] = ...
    ) -> tuple[list[dict[str, object]], list[dict[str, object]]]: ...
    ...
    def _find_jwplayer_data(
        self, webpage: str, video_id: str | None = None, transform_source: Callable[..., object] = ...
    ) -> object | None: ...
    def _extract_jwplayer_data(
        self, webpage: str, video_id: str, *args: object, transform_source: Callable[..., object] = ..., **kwargs: object
    ) -> list[dict[str, object]]: ...
    def _parse_jwplayer_data(
        self,
        jwplayer_data: Mapping[str, object],
        video_id: str | None = None,
        require_title: bool = True,
        m3u8_id: str | None = None,
        mpd_id: str | None = None,
        rtmp_params: Mapping[str, object] | None = None,
        base_url: str | None = None,
    ) -> list[dict[str, object]]: ...
    def _parse_jwplayer_formats(
        self,
        jwplayer_sources_data: Iterable[Mapping[str, object]],
        video_id: str | None = None,
        m3u8_id: str | None = None,
        mpd_id: str | None = None,
        rtmp_params: Mapping[str, object] | None = None,
    ...
    def _int(self, v: object, name: str, fatal: bool = False, **kwargs: object) -> int | None: ...
    def _float(self, v: object, name: str, fatal: bool = False, **kwargs: object) -> float | None: ...
    def _set_cookie(
        self,
        domain: str,
        name: str,
    ...
    def _get_subtitles(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    def extract_comments(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    def _get_comments(self, *args: object, **kwargs: object) -> list[dict[str, object]]: ...
    @staticmethod
    def _merge_subtitle_items(
        subtitle_list1: Iterable[Mapping[str, object]], subtitle_list2: Iterable[Mapping[str, object]]
    ) -> list[dict[str, object]]: ...
    @classmethod
    def _merge_subtitles(cls, *dicts: dict[str, object], target: object | None = None) -> object: ...
    def extract_automatic_captions(self, *args: object, **kwargs: object) -> dict[str, object]: ...
    @cached_property
    ...
    def _extract_chapters_helper(
        self,
        chapter_list: Iterable[Mapping[str, object]],
        start_function: Callable[..., object],
        title_function: Callable[..., object],
        duration: float,
        strict: bool = True,
    ...
    def RetryManager(self, **kwargs: object) -> _RetryManager: ...
    @classmethod
    ...
    def _extract_generic_embeds(
        self, url: str, *args: object, info_dict: _InfoDict = ..., note: str = "Extracting generic embeds", **kwargs: object
    ) -> list[dict[str, object]]: ...
    @classmethod
