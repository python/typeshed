...
def make_socks_proxy_opts(socks_proxy: str) -> dict[str, object]: ...
...
def create_socks_proxy_socket(
    dest_addr: object, proxy_args, proxy_ip_addr: _IPAddress, timeout: float | None, source_address: _Address
) -> sockssocket: ...
def create_connection(
    ...
    *,
    _create_socket_func: Callable[[_IPAddress, int, object], sockssocket] = ...,
) -> sockssocket: ...
