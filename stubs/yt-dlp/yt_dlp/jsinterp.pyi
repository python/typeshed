...
class JSInterpreter:
    def __init__(self, code, objects: Mapping[str, object] | None = None) -> None: ...

    class Exception(ExtractorError):
        def __init__(self, msg, expr: str | None = None, *args: object, **kwargs: object) -> None: ...
    ...
    def extract_object(self, objname: str, *global_stack: object): ...
    def extract_function_code(self, funcname: str) -> tuple[list[str], tuple[str, str]]: ...
    def extract_function(self, funcname: str, *global_stack: object): ...
