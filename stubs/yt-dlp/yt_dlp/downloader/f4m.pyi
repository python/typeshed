...
class FlvReader(io.BytesIO):
    ...
    def read_asrt(self) -> dict[str, object]: ...
    def read_afrt(self) -> dict[str, object]: ...
    def read_abst(self) -> dict[str, object]: ...
    def read_bootstrap_info(self) -> dict[str, object]: ...

def read_bootstrap_info(bootstrap_bytes: bytes) -> dict[str, object]: ...
def build_fragments_list(boot_info: Mapping[str, object]) -> list[tuple[object, int]]: ...
...
def remove_encrypted_media(media: Iterable[Element]) -> list[object]: ...
