import datetime
from _typeshed import FileDescriptorOrPath, ReadableBuffer, Unused
...
def create_ipam_pool(*args: Unused, **kwargs: Unused) -> NoReturn: ...
@deprecated("utils.create_ipam_config has been removed. Please use a docker.types.IPAMConfig object instead.")
def create_ipam_config(*args: Unused, **kwargs: Unused) -> NoReturn: ...
...
def create_host_config(self, *args: Unused, **kwargs: Unused) -> NoReturn: ...
