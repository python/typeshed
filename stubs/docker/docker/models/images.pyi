...
class ImageCollection(Collection[Image]):
    ...
    def list(self, name: str | None = None, all: bool = False, filters: dict[str, Any] | None = None) -> list[Image]: ...
    ...
    @overload
    def pull(self, repository: str, tag: str | None = None, *, all_tags: Literal[True], **kwargs) -> list[Image]: ...
    @overload
    def pull(self, repository: str, tag: str | None, all_tags: Literal[True], **kwargs) -> list[Image]: ...
