...
class PrivateKeyEntry(AbstractKeystoreEntry):
    ...
    @classmethod
    def new(cls, alias: str, certs: Iterable[bytes], key: bytes, key_format: _KeyFormat = "pkcs8") -> Self: ...
...
class SecretKeyEntry(AbstractKeystoreEntry):
    ...
    @classmethod
    def new(cls, alias: str, sealed_obj: bool, algorithm: str, key: bytes, key_size: int) -> NoReturn: ...
    # Not implemented by pyjks
