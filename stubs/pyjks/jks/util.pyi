...
class AbstractKeystore:
    ...
    def __init__(self, store_type: str, entries: dict[str, AbstractKeystoreEntry]) -> None: ...
    @classmethod
    def load(cls, filename: str | bytes | Path, store_password: str | None, try_decrypt_keys: bool = True) -> Self: ...
    def save(self, filename: str | bytes | Path, store_password: str) -> None: ...

class AbstractKeystoreEntry:
    store_type: str | None
    alias: str
    timestamp: int
    def __init__(self, *, store_type: str = ..., alias: str = ..., timestamp: int = ..., **kwargs: Any) -> None: ...
    @classmethod
