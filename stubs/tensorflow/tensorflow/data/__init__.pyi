...
class Dataset(Generic[_T1], ABC):
    ...
    def flat_map(self, map_func: Callable[[Self], Dataset[_T2]], name: str | None = None) -> Dataset[_T2]: ...
    ...
    # Missing ones are ragged_batch, random, rejection_resample, sample_from_datasets,
    # scan, snapshot, sparse_batch, take_while, window
