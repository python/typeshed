...
from tensorflow.core.protobuf import data_service_pb2 as _data_service_pb2
...
@_typing.final
class DispatcherConfig(_message.Message):
    ...
    FAULT_TOLERANT_MODE_FIELD_NUMBER: _builtins.int
    WORKER_ADDRESSES_FIELD_NUMBER: _builtins.int
    DEPLOYMENT_MODE_FIELD_NUMBER: _builtins.int
    JOB_GC_CHECK_INTERVAL_MS_FIELD_NUMBER: _builtins.int
    JOB_GC_TIMEOUT_MS_FIELD_NUMBER: _builtins.int
    GC_DYNAMIC_SHARDING_JOBS_FIELD_NUMBER: _builtins.int
    CLIENT_TIMEOUT_MS_FIELD_NUMBER: _builtins.int
    WORKER_TIMEOUT_MS_FIELD_NUMBER: _builtins.int
    WORKER_MAX_CONCURRENT_SNAPSHOTS_FIELD_NUMBER: _builtins.int
    port: _builtins.int
    ...
    """
    fault_tolerant_mode: _builtins.bool
    """Whether to run in fault tolerant mode, where dispatcher state is saved
    across restarts. Requires that `work_dir` is nonempty.
    """
    deployment_mode: _data_service_pb2.DeploymentMode.ValueType
    ...
    """
    job_gc_check_interval_ms: _builtins.int
    ...
    runtime.
    """
    job_gc_timeout_ms: _builtins.int
    ...
    """
    gc_dynamic_sharding_jobs: _builtins.bool
    ...
    """
    client_timeout_ms: _builtins.int
    ...
    """
    worker_timeout_ms: _builtins.int
    ...
    """
    worker_max_concurrent_snapshots: _builtins.int
    ...
    """
    @_builtins.property
    def worker_addresses(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
    ...
    def __init__(
        ...
        *,
        ...
        work_dir: _builtins.str | None = ...,
        fault_tolerant_mode: _builtins.bool | None = ...,
        worker_addresses: _abc.Iterable[_builtins.str] | None = ...,
        deployment_mode: _data_service_pb2.DeploymentMode.ValueType | None = ...,
        job_gc_check_interval_ms: _builtins.int | None = ...,
        job_gc_timeout_ms: _builtins.int | None = ...,
        gc_dynamic_sharding_jobs: _builtins.bool | None = ...,
        client_timeout_ms: _builtins.int | None = ...,
        worker_timeout_ms: _builtins.int | None = ...,
        worker_max_concurrent_snapshots: _builtins.int | None = ...,
    ) -> None: ...
...
Global___DispatcherConfig: _TypeAlias = DispatcherConfig  # noqa: Y015
...
class WorkerConfig(_message.Message):
    ...
    PORT_FIELD_NUMBER: _builtins.int
    PROTOCOL_FIELD_NUMBER: _builtins.int
    DISPATCHER_ADDRESS_FIELD_NUMBER: _builtins.int
    WORKER_ADDRESS_FIELD_NUMBER: _builtins.int
    WORKER_TAGS_FIELD_NUMBER: _builtins.int
    HEARTBEAT_INTERVAL_MS_FIELD_NUMBER: _builtins.int
    DISPATCHER_TIMEOUT_MS_FIELD_NUMBER: _builtins.int
    DATA_TRANSFER_PROTOCOL_FIELD_NUMBER: _builtins.int
    DATA_TRANSFER_PORT_FIELD_NUMBER: _builtins.int
    DATA_TRANSFER_ADDRESS_FIELD_NUMBER: _builtins.int
    CROSS_TRAINER_CACHE_SIZE_BYTES_FIELD_NUMBER: _builtins.int
    SNAPSHOT_MAX_CHUNK_SIZE_BYTES_FIELD_NUMBER: _builtins.int
    SHUTDOWN_QUIET_PERIOD_MS_FIELD_NUMBER: _builtins.int
    port: _builtins.int
    ...
    dispatcher_address: _builtins.str
    """The address of the dispatcher to register with."""
    worker_address: _builtins.str
    ...
    `protocol`.
    """
    data_transfer_port: _builtins.int
    ...
    """
    data_transfer_address: _builtins.str
    ...
    """
    cross_trainer_cache_size_bytes: _builtins.int
    ...
    """
    snapshot_max_chunk_size_bytes: _builtins.int
    ...
    """
    shutdown_quiet_period_ms: _builtins.int
    ...
    """
    @_builtins.property
    def worker_tags(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
    ...
    def __init__(
        ...
        *,
        port: _builtins.int | None = ...,
        protocol: _builtins.str | None = ...,
        dispatcher_address: _builtins.str | None = ...,
        worker_address: _builtins.str | None = ...,
        worker_tags: _abc.Iterable[_builtins.str] | None = ...,
        heartbeat_interval_ms: _builtins.int | None = ...,
        dispatcher_timeout_ms: _builtins.int | None = ...,
        data_transfer_protocol: _builtins.str | None = ...,
        data_transfer_port: _builtins.int | None = ...,
        data_transfer_address: _builtins.str | None = ...,
        cross_trainer_cache_size_bytes: _builtins.int | None = ...,
        snapshot_max_chunk_size_bytes: _builtins.int | None = ...,
        shutdown_quiet_period_ms: _builtins.int | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _Never  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal[
...
Global___WorkerConfig: _TypeAlias = WorkerConfig  # noqa: Y015
