...
from tensorflow.core.protobuf import verifier_config_pb2 as _verifier_config_pb2
...
@_typing.final
class AutoParallelOptions(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor

    ENABLE_FIELD_NUMBER: _builtins.int
    NUM_REPLICAS_FIELD_NUMBER: _builtins.int
    enable: _builtins.bool
    num_replicas: _builtins.int
    def __init__(self, *, enable: _builtins.bool | None = ..., num_replicas: _builtins.int | None = ...) -> None: ...
    _HasFieldArgType: _TypeAlias = _Never  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["enable", b"enable", "num_replicas", b"num_replicas"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___AutoParallelOptions: _TypeAlias = AutoParallelOptions  # noqa: Y015

@_typing.final
class ScopedAllocatorOptions(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor

    ENABLE_OP_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def enable_op(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
        """If present, only perform optimization for these ops."""

    def __init__(self, *, enable_op: _abc.Iterable[_builtins.str] | None = ...) -> None: ...
    _HasFieldArgType: _TypeAlias = _Never  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["enable_op", b"enable_op"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___ScopedAllocatorOptions: _TypeAlias = ScopedAllocatorOptions  # noqa: Y015

@_typing.final
class RewriterConfig(_message.Message):
    ...
    class _ToggleEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[RewriterConfig._Toggle.ValueType], _builtins.type):
    ...
    class _CpuLayoutEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[RewriterConfig._CpuLayout.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _NumIterationsTypeEnumTypeWrapper(
        _enum_type_wrapper._EnumTypeWrapper[RewriterConfig._NumIterationsType.ValueType], _builtins.type
    ):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _MemOptTypeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[RewriterConfig._MemOptType.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    @_typing.final
    class CustomGraphOptimizer(_message.Message):
        """Message to describe custom graph optimizer and its parameters"""

        DESCRIPTOR: _descriptor.Descriptor

        @_typing.final
        class ParameterMapEntry(_message.Message):
            DESCRIPTOR: _descriptor.Descriptor
        ...
        PARAMETER_MAP_FIELD_NUMBER: _builtins.int
        name: _builtins.str
        @_builtins.property
        def parameter_map(self) -> _containers.MessageMap[_builtins.str, _attr_value_pb2.AttrValue]: ...
        def __init__(
            self,
            *,
            name: _builtins.str | None = ...,
            parameter_map: _abc.Mapping[_builtins.str, _attr_value_pb2.AttrValue] | None = ...,
        ) -> None: ...
        _HasFieldArgType: _TypeAlias = _Never  # noqa: Y015
        def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
        _ClearFieldArgType: _TypeAlias = _typing.Literal["name", b"name", "parameter_map", b"parameter_map"]  # noqa: Y015
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        def WhichOneof(self, oneof_group: _Never) -> None: ...

    CPU_LAYOUT_CONVERSION_FIELD_NUMBER: _builtins.int
    LAYOUT_OPTIMIZER_FIELD_NUMBER: _builtins.int
    CONSTANT_FOLDING_FIELD_NUMBER: _builtins.int
    SHAPE_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    REMAPPING_FIELD_NUMBER: _builtins.int
    COMMON_SUBGRAPH_ELIMINATION_FIELD_NUMBER: _builtins.int
    ARITHMETIC_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    DEPENDENCY_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    LOOP_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    FUNCTION_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    DEBUG_STRIPPER_FIELD_NUMBER: _builtins.int
    DISABLE_MODEL_PRUNING_FIELD_NUMBER: _builtins.int
    SCOPED_ALLOCATOR_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    PIN_TO_HOST_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    IMPLEMENTATION_SELECTOR_FIELD_NUMBER: _builtins.int
    AUTO_MIXED_PRECISION_FIELD_NUMBER: _builtins.int
    AUTO_MIXED_PRECISION_MKL_FIELD_NUMBER: _builtins.int
    AUTO_MIXED_PRECISION_ONEDNN_BFLOAT16_FIELD_NUMBER: _builtins.int
    AUTO_MIXED_PRECISION_CPU_FIELD_NUMBER: _builtins.int
    DISABLE_META_OPTIMIZER_FIELD_NUMBER: _builtins.int
    DISABLE_TFG_OPTIMIZER_FIELD_NUMBER: _builtins.int
    USE_PLUGIN_OPTIMIZERS_FIELD_NUMBER: _builtins.int
    EXPERIMENTAL_CONDITIONAL_CODE_MOTION_FIELD_NUMBER: _builtins.int
    META_OPTIMIZER_ITERATIONS_FIELD_NUMBER: _builtins.int
    MIN_GRAPH_NODES_FIELD_NUMBER: _builtins.int
    EXPERIMENTAL_DISABLE_COMPRESSED_TENSOR_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    EXPERIMENTAL_DISABLE_FOLDING_QUANTIZATION_EMULATION_FIELD_NUMBER: _builtins.int
    MEMORY_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    MEMORY_OPTIMIZER_TARGET_NODE_NAME_SCOPE_FIELD_NUMBER: _builtins.int
    META_OPTIMIZER_TIMEOUT_MS_FIELD_NUMBER: _builtins.int
    AUTO_PARALLEL_FIELD_NUMBER: _builtins.int
    FAIL_ON_OPTIMIZER_ERRORS_FIELD_NUMBER: _builtins.int
    SCOPED_ALLOCATOR_OPTS_FIELD_NUMBER: _builtins.int
    OPTIMIZERS_FIELD_NUMBER: _builtins.int
    CUSTOM_OPTIMIZERS_FIELD_NUMBER: _builtins.int
    INTER_OPTIMIZER_VERIFIER_CONFIG_FIELD_NUMBER: _builtins.int
    POST_OPTIMIZATION_VERIFIER_CONFIG_FIELD_NUMBER: _builtins.int
    ...
    disable_model_pruning: _builtins.bool
    ...
    Note that this can change the numerical stability of the graph.
    """
    disable_meta_optimizer: _builtins.bool
    """Disable the entire meta optimizer (off by default)."""
    disable_tfg_optimizer: _builtins.bool
    ...
    is once).
    """
    min_graph_nodes: _builtins.int
    """The minimum number of nodes in a graph to optimizer. For smaller graphs,
    optimization is skipped.
    0 means the system picks an appropriate number.
    < 0 means do not skip optimization.
    """
    experimental_disable_compressed_tensor_optimization: _builtins.bool
    """Disable optimizations that assume compressed tensors. Note that this flag
    is experimental and may be removed in the future.
    """
    experimental_disable_folding_quantization_emulation: _builtins.bool
    ...
    field.
    """
    memory_optimizer_target_node_name_scope: _builtins.str
    ...
    @_builtins.property
    def optimizers(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
    ...
    @_builtins.property
    def custom_optimizers(self) -> _containers.RepeatedCompositeFieldContainer[Global___RewriterConfig.CustomGraphOptimizer]:
        """list of CustomGraphOptimizers to apply."""

    @_builtins.property
    def inter_optimizer_verifier_config(self) -> _verifier_config_pb2.VerifierConfig:
        """VerifierConfig specifying the verifiers to be run after every optimizer."""

    @_builtins.property
    def post_optimization_verifier_config(self) -> _verifier_config_pb2.VerifierConfig:
    ...
    def __init__(
        ...
        *,
        ...
        disable_model_pruning: _builtins.bool | None = ...,
        ...
        disable_meta_optimizer: _builtins.bool | None = ...,
        disable_tfg_optimizer: _builtins.bool | None = ...,
        ...
        min_graph_nodes: _builtins.int | None = ...,
        experimental_disable_compressed_tensor_optimization: _builtins.bool | None = ...,
        experimental_disable_folding_quantization_emulation: _builtins.bool | None = ...,
        memory_optimization: Global___RewriterConfig.MemOptType.ValueType | None = ...,
        memory_optimizer_target_node_name_scope: _builtins.str | None = ...,
        meta_optimizer_timeout_ms: _builtins.int | None = ...,
        auto_parallel: Global___AutoParallelOptions | None = ...,
        fail_on_optimizer_errors: _builtins.bool | None = ...,
        scoped_allocator_opts: Global___ScopedAllocatorOptions | None = ...,
        optimizers: _abc.Iterable[_builtins.str] | None = ...,
        custom_optimizers: _abc.Iterable[Global___RewriterConfig.CustomGraphOptimizer] | None = ...,
        inter_optimizer_verifier_config: _verifier_config_pb2.VerifierConfig | None = ...,
        post_optimization_verifier_config: _verifier_config_pb2.VerifierConfig | None = ...,
    ) -> None: ...
...
Global___RewriterConfig: _TypeAlias = RewriterConfig  # noqa: Y015
