...
class AutotuneResult(google.protobuf.message.Message):
    ...
    class _FailureKindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[AutotuneResult._FailureKind.ValueType], builtins.type):  # noqa: F821
    ...
    class FailureResult(google.protobuf.message.Message):
        ...
        @property
        def reference_algorithm(self) -> tensorflow.compiler.xla.stream_executor.dnn_pb2.AlgorithmProto: ...
        ...
        def __init__(
            ...
            *,
            ...
            reference_algorithm: tensorflow.compiler.xla.stream_executor.dnn_pb2.AlgorithmProto | None = ...,
