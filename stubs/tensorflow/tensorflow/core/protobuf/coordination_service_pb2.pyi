...
import sys
import tensorflow.compiler.xla.pjrt.distributed.protocol_pb2
...
@typing_extensions.final
class TfDeviceList(google.protobuf.message.Message):
    ...
    @property
    def devices(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[tensorflow.core.framework.device_attributes_pb2.DeviceAttributes]: ...
    def __init__(
        self,
        *,
        devices: collections.abc.Iterable[tensorflow.core.framework.device_attributes_pb2.DeviceAttributes] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["devices", b"devices"]) -> None: ...

global___TfDeviceList = TfDeviceList

@typing_extensions.final
class XlaDeviceList(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    DEVICES_FIELD_NUMBER: builtins.int
    @property
    def devices(self) -> tensorflow.compiler.xla.pjrt.distributed.protocol_pb2.GlobalTopologyProto: ...
    def __init__(
        self,
        *,
        devices: tensorflow.compiler.xla.pjrt.distributed.protocol_pb2.GlobalTopologyProto | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["devices", b"devices"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["devices", b"devices"]) -> None: ...

global___XlaDeviceList = XlaDeviceList

@typing_extensions.final
class CoordinationServiceDeviceInfo(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    TF_FIELD_NUMBER: builtins.int
    XLA_FIELD_NUMBER: builtins.int
    @property
    def tf(self) -> global___TfDeviceList: ...
    @property
    def xla(self) -> global___XlaDeviceList: ...
    def __init__(
        self,
        *,
        tf: global___TfDeviceList | None = ...,
        xla: global___XlaDeviceList | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["tf", b"tf", "type", b"type", "xla", b"xla"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["tf", b"tf", "type", b"type", "xla", b"xla"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["tf", "xla"] | None: ...

global___CoordinationServiceDeviceInfo = CoordinationServiceDeviceInfo
...
class WaitForAllTasksRequest(google.protobuf.message.Message):
    ...
    LOCAL_DEVICE_INFO_FIELD_NUMBER: builtins.int
    SOURCE_TASK_FIELD_NUMBER: builtins.int
    @property
    def local_device_info(self) -> global___CoordinationServiceDeviceInfo:
    ...
    def __init__(
        self,
        *,
        local_device_info: global___CoordinationServiceDeviceInfo | None = ...,
        source_task: global___CoordinatedTask | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["local_device_info", b"local_device_info", "source_task", b"source_task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["local_device_info", b"local_device_info", "source_task", b"source_task"]) -> None: ...
...
class WaitForAllTasksResponse(google.protobuf.message.Message):
    ...
    LEADER_INCARNATION_FIELD_NUMBER: builtins.int
    CLUSTER_DEVICE_INFO_FIELD_NUMBER: builtins.int
    leader_incarnation: builtins.int
    @property
    def cluster_device_info(self) -> global___CoordinationServiceDeviceInfo:
        """All devices in the cluster."""
    def __init__(
        self,
        *,
        leader_incarnation: builtins.int | None = ...,
        cluster_device_info: global___CoordinationServiceDeviceInfo | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cluster_device_info", b"cluster_device_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_device_info", b"cluster_device_info", "leader_incarnation", b"leader_incarnation"]) -> None: ...
