...
class GraphDebugInfo(google.protobuf.message.Message):
    ...
    class FileLineCol(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[code, b"code", col, b"col", file_index, b"file_index", func, b"func", line, b"line"]) -> builtins.bool: ...
    ...
    class StackTrace(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[file_line_cols, b"file_line_cols", frame_id, b"frame_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[files, b"files", frames_by_id, b"frames_by_id", name_to_trace_id, b"name_to_trace_id", traces, b"traces", traces_by_id, b"traces_by_id"]) -> None: ...
