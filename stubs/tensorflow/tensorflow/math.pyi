...
@overload
def abs(input: SparseTensor, name: str | None = None) -> SparseTensor: ...
@overload
def abs(input: RaggedTensor, name: str | None = None) -> RaggedTensor: ...
@overload
def angle(x: TensorCompatible, name: str | None = None) -> Tensor: ...
@overload
def angle(x: RaggedTensor, name: str | None = None) -> RaggedTensor: ...
@overload
