...
import tensorflow.compiler.xla.autotuning_pb2
...
class AutotuneResults(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        hlo: builtins.str
        @property
        def result(self) -> tensorflow.compiler.xla.autotuning_pb2.AutotuneResult: ...
        def __init__(
            self,
            *,
            device: builtins.str | None = ...,
            hlo: builtins.str | None = ...,
            result: tensorflow.compiler.xla.autotuning_pb2.AutotuneResult | None = ...,
        ) -> None: ...
