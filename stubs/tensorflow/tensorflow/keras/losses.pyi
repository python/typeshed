...
class CategoricalHinge(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "categorical_hinge"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class CosineSimilarity(Loss):
    def __init__(self, axis: int = -1, reduction: _ReductionValues = ..., name: str | None = "cosine_similarity"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class Hinge(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "hinge"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class Huber(Loss):
    def __init__(self, delta: float = 1.0, reduction: _ReductionValues = ..., name: str | None = "huber_loss"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class KLDivergence(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "kl_divergence"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class LogCosh(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "log_cosh"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class MeanAbsoluteError(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "mean_absolute_error"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class MeanAbsolutePercentageError(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "mean_absolute_percentage_error"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class MeanSquaredError(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "mean_squared_error"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class MeanSquaredLogarithmicError(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "mean_squared_logarithmic_error"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...

class Poisson(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "poisson"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...
...
class SquaredHinge(Loss):
    def __init__(self, reduction: _ReductionValues = ..., name: str | None = "squared_hinge"): ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...
