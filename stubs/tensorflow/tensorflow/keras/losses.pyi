...
class CosineSimilarity(Loss):
    def __init__(self, axis: int = -1, reduction: _ReductionValues = 'sum_over_batch_size', name: str | None = "cosine_similarity") -> None: ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...
...
class Huber(Loss):
    def __init__(self, delta: float = 1.0, reduction: _ReductionValues = 'sum_over_batch_size', name: str | None = "huber_loss") -> None: ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...
...
class MeanAbsolutePercentageError(Loss):
    def __init__(self, reduction: _ReductionValues = 'sum_over_batch_size', name: str | None = "mean_absolute_percentage_error") -> None: ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...
...
class MeanSquaredLogarithmicError(Loss):
    def __init__(self, reduction: _ReductionValues = 'sum_over_batch_size', name: str | None = "mean_squared_logarithmic_error") -> None: ...
    def call(self, y_true: Tensor, y_pred: Tensor) -> Tensor: ...
