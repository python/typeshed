...
class Constant(Initializer):
    def __init__(self, value: _TensorCompatible) -> None: ...
...
class TruncatedNormal(Initializer):
    def __init__(self, mean: _TensorCompatible = 0.0, stddev: _TensorCompatible = 0.05, seed: int | None = None): ...

class RandomNormal(Initializer):
    def __init__(self, mean: _TensorCompatible = 0.0, stddev: _TensorCompatible = 0.05, seed: int | None = None): ...

class RandomUniform(Initializer):
    def __init__(self, minval: _TensorCompatible = 0.0, maxval: _TensorCompatible = 0.05, seed: int | None = None): ...
...
_Initializer: TypeAlias = str | Initializer | Callable[[_ShapeLike], Tensor] | dict[str, Any] | None
