...
def selu(x: Tensor | float | FloatArray | np.number[Any] | FloatDataSequence) -> Tensor: ...
def serialize(activation: Callable[..., Any], use_legacy_format: bool = False) -> str: ...
def sigmoid(x: Tensor | float | FloatArray | np.number[Any] | FloatDataSequence) -> Tensor: ...
def softmax(x: Tensor, axis: Integer = -1) -> Tensor: ...
def softplus(x: Tensor | float | FloatArray | np.number[Any] | FloatDataSequence) -> Tensor: ...
def softsign(x: Tensor | float | FloatArray | np.number[Any] | FloatDataSequence) -> Tensor: ...
def swish(x: Tensor | float | FloatArray | np.number[Any] | FloatDataSequence) -> Tensor: ...
def tanh(x: Tensor | float | FloatArray | np.number[Any] | FloatDataSequence) -> Tensor: ...
