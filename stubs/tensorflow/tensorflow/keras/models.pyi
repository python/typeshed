...
class Model(Layer[_InputT_contra, _OutputT_co]):
    ...
    def save_weights(self, filepath: str | Path, overwrite: bool = True, max_shard_size: float | None = None) -> None: ...
    ...
    def export(
        self, filepath: str | Path, format: str = "tf_saved_model", verbose: bool | None = None, input_signature=None, **kwargs
    ) -> None: ...
