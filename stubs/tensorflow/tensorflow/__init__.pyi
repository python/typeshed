...
@overload
def concat(values: Sequence[_TensorCompatible] | _TensorCompatible, axis: int, name: str | None = None) -> Tensor: ...
@overload
def concat(
    values: Sequence[RaggedTensor | _TensorCompatible] | RaggedTensor, axis: int, name: str | None = None
) -> RaggedTensor: ...
@overload
def squeeze(
