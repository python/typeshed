...
class IndexedSlices(metaclass=ABCMeta):
    ...
    @overload
    def __getitem__(self, key: slice) -> Iterable[Tensor]: ...
...
def expand_dims(input: Tensor, axis: int, name: None | str = None) -> Tensor: ...
# TODO: The "list"s below are from the TF doc, any Iterable or Sequence might be enough ?
def concat(values: Iterable[Tensor] | Tensor, axis: int, name: None | str = "concat") -> Tensor: ...
def squeeze(input: Tensor, axis: None | list[int] = None, name: None | str = None) -> Tensor: ...
def tensor_scatter_nd_update(tensor: Tensor, indices: Tensor, updates: Tensor, name: None | str = None) -> Tensor: ...
def constant(value: Sequence, dtype: None | _DTypeLike = None, shape: None | _ShapeLike = None, name: None | str = 'Const') -> Tensor: ...
def cast(x: Tensor | _, dtype, name: DType | str = None) -> Tensor: ...
