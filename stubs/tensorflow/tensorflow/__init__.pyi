...
def concat(values: Iterable[Tensor] | Tensor, axis: int | Tensor, name: None | str = "concat") -> Tensor: ...
...
def constant(value: _TensorCompatible, dtype: None | _DTypeLike = None, shape: None | _ShapeLike = None, name: None | str = 'Const') -> Tensor: ...
