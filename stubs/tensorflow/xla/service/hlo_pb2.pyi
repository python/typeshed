...
class HloInstructionProto(google.protobuf.message.Message):
    ...
    opcode: builtins.str
    @property
    def shape(self) -> xla.xla_data_pb2.ShapeProto: ...
    @property
    def metadata(self) -> xla.xla_data_pb2.OpMetadata: ...
    @property
    def literal(self) -> xla.xla_data_pb2.LiteralProto:
    ...
    def dimensions(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        ...
        """
    @property
    def window(self) -> xla.xla_data_pb2.Window:
        """Describes the window in a windowed operation such as convolution."""
    @property
    def convolution_dimension_numbers(self) -> xla.xla_data_pb2.ConvolutionDimensionNumbers:
    ...
    def dynamic_slice_sizes(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        ...
        """
    @property
    def padding_config(self) -> xla.xla_data_pb2.PaddingConfig:
        """The padding configuration that describes the edge padding and interior
        padding of this pad instruction. Only set for pad instructions.
        """
    outfeed_config: builtins.bytes
    """Outfeed configuration information, only present for kOutfeed."""
    distribution: xla.xla_data_pb2.RandomDistribution.ValueType
    ...
    """
    @property
    def outfeed_shape(self) -> xla.xla_data_pb2.ShapeProto:
        """Shape of outfeed request."""
    @property
    def dot_dimension_numbers(self) -> xla.xla_data_pb2.DotDimensionNumbers:
        """Describes the dimension numbers used for a dot operation"""
    fft_type: xla.xla_data_pb2.FftType.ValueType
    ...
    @property
    def gather_dimension_numbers(self) -> xla.xla_data_pb2.GatherDimensionNumbers:
    ...
    @property
    def sharding(self) -> xla.xla_data_pb2.OpSharding: ...
    backend_config: builtins.bytes
    """Backend configuration for the instruction. Has backend-specific meaning."""
    @property
    def replica_groups(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla.xla_data_pb2.ReplicaGroup]:
    ...
    @property
    def scatter_dimension_numbers(self) -> xla.xla_data_pb2.ScatterDimensionNumbers: ...
    @property
    def precision_config(self) -> xla.xla_data_pb2.PrecisionConfig:
        """Precision configuration for the instruction. Has backend-specific meaning."""
    @property
    def source_target_pairs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla.xla_data_pb2.SourceTarget]:
        """Collective permute field."""
    @property
    def domain_entry_sharding(self) -> xla.xla_data_pb2.OpSharding:
        """Sharding for kDomain instructions."""
    @property
    def domain_exit_sharding(self) -> xla.xla_data_pb2.OpSharding: ...
    ...
    """
    @property
    def operand_shapes_with_layout(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla.xla_data_pb2.ShapeProto]: ...
    @property
    def triangular_solve_options(self) -> xla.xla_data_pb2.TriangularSolveOptions:
        """Options for TriangularSolve"""
    @property
    def cholesky_options(self) -> xla.xla_data_pb2.CholeskyOptions:
        """Options for Cholesky"""
    @property
    def parameter_replication(self) -> xla.xla_data_pb2.ParameterReplication:
    ...
    """
    @property
    def output_operand_aliasing(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla.xla_data_pb2.OutputOperandAliasing]:
    ...
    """
    @property
    def frontend_attributes(self) -> xla.xla_data_pb2.FrontendAttributes:
    ...
    the caller.
    """
    rng_algorithm: xla.xla_data_pb2.RandomAlgorithm.ValueType
    ...
    padding_type: xla.xla_data_pb2.PaddingType.ValueType
    ...
    @property
    def statistics_viz(self) -> xla.xla_data_pb2.StatisticsViz:
        """Represents the information for tracking propagation of values within HLO
        graph.
        """
    @property
    def dot_sparsity(self) -> xla.xla_data_pb2.SparsityDescriptor:
    ...
    def __init__(
        ...
        *,
        ...
        shape: xla.xla_data_pb2.ShapeProto | None = ...,
        metadata: xla.xla_data_pb2.OpMetadata | None = ...,
        literal: xla.xla_data_pb2.LiteralProto | None = ...,
        ...
        window: xla.xla_data_pb2.Window | None = ...,
        convolution_dimension_numbers: xla.xla_data_pb2.ConvolutionDimensionNumbers | None = ...,
        ...
        padding_config: xla.xla_data_pb2.PaddingConfig | None = ...,
        outfeed_config: builtins.bytes | None = ...,
        distribution: xla.xla_data_pb2.RandomDistribution.ValueType | None = ...,
        ...
        outfeed_shape: xla.xla_data_pb2.ShapeProto | None = ...,
        dot_dimension_numbers: xla.xla_data_pb2.DotDimensionNumbers | None = ...,
        fft_type: xla.xla_data_pb2.FftType.ValueType | None = ...,
        fft_length: collections.abc.Iterable[builtins.int] | None = ...,
        comparison_direction: builtins.str | None = ...,
        gather_dimension_numbers: xla.xla_data_pb2.GatherDimensionNumbers | None = ...,
        ...
        sharding: xla.xla_data_pb2.OpSharding | None = ...,
        backend_config: builtins.bytes | None = ...,
        replica_groups: collections.abc.Iterable[xla.xla_data_pb2.ReplicaGroup] | None = ...,
        ...
        scatter_dimension_numbers: xla.xla_data_pb2.ScatterDimensionNumbers | None = ...,
        precision_config: xla.xla_data_pb2.PrecisionConfig | None = ...,
        source_target_pairs: collections.abc.Iterable[xla.xla_data_pb2.SourceTarget] | None = ...,
        domain_entry_sharding: xla.xla_data_pb2.OpSharding | None = ...,
        domain_exit_sharding: xla.xla_data_pb2.OpSharding | None = ...,
        constrain_layout: builtins.bool | None = ...,
        operand_shapes_with_layout: collections.abc.Iterable[xla.xla_data_pb2.ShapeProto] | None = ...,
        triangular_solve_options: xla.xla_data_pb2.TriangularSolveOptions | None = ...,
        cholesky_options: xla.xla_data_pb2.CholeskyOptions | None = ...,
        parameter_replication: xla.xla_data_pb2.ParameterReplication | None = ...,
        custom_call_has_side_effect: builtins.bool | None = ...,
        output_operand_aliasing: collections.abc.Iterable[xla.xla_data_pb2.OutputOperandAliasing] | None = ...,
        ...
        frontend_attributes: xla.xla_data_pb2.FrontendAttributes | None = ...,
        unique_indices: builtins.bool | None = ...,
        rng_algorithm: xla.xla_data_pb2.RandomAlgorithm.ValueType | None = ...,
        ...
        padding_type: xla.xla_data_pb2.PaddingType.ValueType | None = ...,
        ...
        statistics_viz: xla.xla_data_pb2.StatisticsViz | None = ...,
        dot_sparsity: xla.xla_data_pb2.SparsityDescriptor | None = ...,
    ) -> None: ...
...
class HloComputationProto(google.protobuf.message.Message):
    ...
    def instructions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___HloInstructionProto]:
        ...
        """
    @property
    def program_shape(self) -> xla.xla_data_pb2.ProgramShapeProto:
    ...
    def __init__(
        ...
        *,
        ...
        program_shape: xla.xla_data_pb2.ProgramShapeProto | None = ...,
        id: builtins.int | None = ...,
...
class HloBufferDonorProto(google.protobuf.message.Message):
    ...
    class BufferDonorEntryProto(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["parameter_number", b"parameter_number", "parameter_shape_index", b"parameter_shape_index"]) -> None: ...
...
class StackFrameIndexProto(google.protobuf.message.Message):
    ...
    class FileLocation(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["column", b"column", "file_name_id", b"file_name_id", "function_name_id", b"function_name_id", "line", b"line"]) -> None: ...
    ...
    class StackFrame(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["file_location_id", b"file_location_id", "parent_frame_id", b"parent_frame_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["file_locations", b"file_locations", "file_names", b"file_names", "function_names", b"function_names", "stack_frames", b"stack_frames"]) -> None: ...
...
class HloModuleProto(google.protobuf.message.Message):
    ...
    class ProfileInfo(google.protobuf.message.Message):
        ...
        profile_source: xla.xla_data_pb2.ProfileSource.ValueType
        """The source of the optimization profile that this module contains."""
        compilation_event: xla.xla_data_pb2.CompilationEvent.ValueType
        ...
        def __init__(
            ...
            *,
            ...
            profile_source: xla.xla_data_pb2.ProfileSource.ValueType | None = ...,
            compilation_event: xla.xla_data_pb2.CompilationEvent.ValueType | None = ...,
            fingerprint: builtins.str | None = ...,
        ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["compilation_event", b"compilation_event", "fingerprint", b"fingerprint", "profile_source", b"profile_source", "profile_type", b"profile_type", "relative_speedup", b"relative_speedup"]) -> None: ...
    ...
    def computations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___HloComputationProto]:
        ...
        """
    @property
    def host_program_shape(self) -> xla.xla_data_pb2.ProgramShapeProto:
    ...
    @property
    def spmd_output_sharding(self) -> xla.xla_data_pb2.OpSharding: ...
    @property
    def spmd_parameters_shardings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla.xla_data_pb2.OpSharding]: ...
    ...
    @property
    def device_assignment(self) -> xla.xla_data_pb2.DeviceAssignmentProto:
    ...
    def __init__(
        ...
        *,
        ...
        host_program_shape: xla.xla_data_pb2.ProgramShapeProto | None = ...,
        id: builtins.int | None = ...,
        ...
        spmd_output_sharding: xla.xla_data_pb2.OpSharding | None = ...,
        spmd_parameters_shardings: collections.abc.Iterable[xla.xla_data_pb2.OpSharding] | None = ...,
...
class HloSnapshot(google.protobuf.message.Message):
    ...
    def hlo(self) -> global___HloProto:
        """The hlo graph."""
    @property
    def arguments(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla.xla_data_pb2.LiteralProto]:
        """The arguments passed to the graph."""
    @property
    def result(self) -> xla.xla_data_pb2.LiteralProto:
    ...
    def __init__(
        ...
        *,
        ...
        arguments: collections.abc.Iterable[xla.xla_data_pb2.LiteralProto] | None = ...,
        result: xla.xla_data_pb2.LiteralProto | None = ...,
