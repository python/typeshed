...
import tsl.protobuf.status_pb2
...
class CompilationResult(google.protobuf.message.Message):
    ...
    @property
    def hlo_module(self) -> xla.service.hlo_pb2.HloModuleProto:
    ...
    def perf_stats(self) -> global___CompilerPerfStats:
        ...
        """
    @property
    def status(self) -> tsl.protobuf.status_pb2.StatusProto:
    ...
    def __init__(
        self,
        *,
        hlo_module: xla.service.hlo_pb2.HloModuleProto | None = ...,
        perf_stats: global___CompilerPerfStats | None = ...,
        status: tsl.protobuf.status_pb2.StatusProto | None = ...,
