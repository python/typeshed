...
class AutotuneResult(google.protobuf.message.Message):
    ...
    class FailureResult(google.protobuf.message.Message):
        ...
        @property
        def reference_algorithm(self) -> tsl.protobuf.dnn_pb2.AlgorithmProto: ...
        ...
        def __init__(
            ...
            *,
            ...
            reference_algorithm: tsl.protobuf.dnn_pb2.AlgorithmProto | None = ...,
    ...
    @typing_extensions.final
    class TritonGemmKey(google.protobuf.message.Message):
        ...
        BLOCK_M_FIELD_NUMBER: builtins.int
        BLOCK_N_FIELD_NUMBER: builtins.int
        BLOCK_K_FIELD_NUMBER: builtins.int
        SPLIT_K_FIELD_NUMBER: builtins.int
        NUM_STAGES_FIELD_NUMBER: builtins.int
        NUM_WARPS_FIELD_NUMBER: builtins.int
        block_m: builtins.int
        block_n: builtins.int
        block_k: builtins.int
        split_k: builtins.int
        num_stages: builtins.int
        num_warps: builtins.int
        def __init__(
            self,
            *,
            block_m: builtins.int | None = ...,
            block_n: builtins.int | None = ...,
            block_k: builtins.int | None = ...,
            split_k: builtins.int | None = ...,
            num_stages: builtins.int | None = ...,
            num_warps: builtins.int | None = ...,
        ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["block_k", b"block_k", "block_m", b"block_m", "block_n", b"block_n", "num_stages", b"num_stages", "num_warps", b"num_warps", "split_k", b"split_k"]) -> None: ...
    ...
    TRITON_FIELD_NUMBER: builtins.int
    ...
    @property
    def triton(self) -> global___AutotuneResult.TritonGemmKey: ...
    @property
    def cuda_conv_plan(self) -> global___AutotuneResult.CudaConvPlanKey: ...
    @property
    def algorithm(self) -> tsl.protobuf.dnn_pb2.AlgorithmProto: ...
    def __init__(
        self,
        *,
        ...
        triton: global___AutotuneResult.TritonGemmKey | None = ...,
        cuda_conv_plan: global___AutotuneResult.CudaConvPlanKey | None = ...,
        algorithm: tsl.protobuf.dnn_pb2.AlgorithmProto | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["algorithm", b"algorithm", "conv", b"conv", "cuda_conv_plan", b"cuda_conv_plan", "failure", b"failure", "gemm", b"gemm", "key", b"key", "run_time", b"run_time", "triton", b"triton"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["algorithm", b"algorithm", "conv", b"conv", "cuda_conv_plan", b"cuda_conv_plan", "failure", b"failure", "gemm", b"gemm", "key", b"key", "run_time", b"run_time", "scratch_bytes", b"scratch_bytes", "triton", b"triton"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["key", b"key"]) -> typing_extensions.Literal["conv", "gemm", "triton", "cuda_conv_plan", "algorithm"] | None: ...
