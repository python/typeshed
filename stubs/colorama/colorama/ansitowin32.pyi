...
class StreamWrapper:
    def __init__(self, wrapped: TextIO, converter: SupportsWrite) -> None: ...
...
WinTermCall = Callable[[Optional[int], bool, bool], None]
WinTermCallDict = Dict[int, Union[Tuple[WinTermCall], Tuple[WinTermCall, int], Tuple[WinTermCall, int, bool]]]
