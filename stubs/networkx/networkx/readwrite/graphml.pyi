...
def read_graphml(
    path, node_type=..., edge_key_type=..., force_multigraph: bool = False
): ...
def parse_graphml(
...
class GraphMLReader(GraphML):
    ...
    xml: Incomplete
    def __call__(
        self, path: Incomplete | None = None, string: Incomplete | None = None
    ) -> Generator[Incomplete, None, None]: ...
    def make_graph(
        self, graph_xml, graphml_keys, defaults, G: Incomplete | None = None
    ): ...
