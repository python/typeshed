...
@_dispatchable
def parse_graphml(graphml_string: str, node_type=..., edge_key_type=..., force_multigraph: bool = False): ...
...
class GraphMLWriter(GraphML):
    ...
    def add_nodes(self, G: Graph[Incomplete], graph_element) -> None: ...
    def add_edges(self, G: Graph[Incomplete], graph_element) -> None: ...
...
class GraphMLReader(GraphML):
    ...
    def add_node(self, G: Graph[Incomplete], node_xml, graphml_keys, defaults) -> None: ...
    def add_edge(self, G: Graph[Incomplete], edge_element, graphml_keys) -> None: ...
