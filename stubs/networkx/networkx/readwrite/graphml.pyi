...
class GraphMLWriter(GraphML):
    ...
    def add_nodes(self, G: Graph[_Node, _NodeData, _EdgeData], graph_element) -> None: ...
    def add_edges(self, G: Graph[_Node, _NodeData, _EdgeData], graph_element) -> None: ...
    def add_graph_element(self, G: Graph[_Node, _NodeData, _EdgeData]) -> None: ...
...
class GraphMLReader(GraphML):
    ...
    def add_node(self, G: Graph[_Node, _NodeData, _EdgeData], node_xml, graphml_keys, defaults) -> None: ...
    def add_edge(self, G: Graph[_Node, _NodeData, _EdgeData], edge_element, graphml_keys) -> None: ...
