...
def to_graph6_bytes(G: Graph[_Node], nodes: list[Incomplete] = None, header: bool = True): ...
@_dispatchable
def read_graph6(path: str) -> Graph[Incomplete]: ...
def write_graph6(G: Graph[_Node], path: str, nodes: list[Incomplete] = None, header: bool = True): ...
