...
def write_gexf(
    G: Graph[Incomplete], path, encoding: str = "utf-8", prettyprint: bool = True, version: str = "1.2draft"
) -> None: ...
def generate_gexf(
    G: Graph[Incomplete], encoding: str = "utf-8", prettyprint: bool = True, version: str = "1.2draft"
...
class GEXFReader(GEXF):
    ...
    def add_node(self, G: Graph[Incomplete], node_xml, node_attr, node_pid: Incomplete | None = None) -> None: ...
    def add_start_end(self, data, xml): ...
    def add_viz(self, data, node_xml): ...
    def add_parents(self, data, node_xml): ...
    def add_slices(self, data, node_or_edge_xml): ...
    def add_spells(self, data, node_or_edge_xml): ...
    def add_edge(self, G: Graph[Incomplete], edge_element, edge_attr) -> None: ...
    def decode_attr_elements(self, gexf_keys, obj_xml): ...
    def find_gexf_attributes(self, attributes_element): ...

def relabel_gexf_graph(G: Graph[Incomplete]): ...
