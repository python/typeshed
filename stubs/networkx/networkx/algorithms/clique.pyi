...
def number_of_cliques(
    G: Graph[_Node], nodes: list[Incomplete] | None = None, cliques: list[Incomplete] | None = None
) -> int | dict[Incomplete, Incomplete]: ...
@_dispatchable
def max_weight_clique(G: Graph[_Node], weight: str = "weight") -> tuple[list[Incomplete], int]: ...
