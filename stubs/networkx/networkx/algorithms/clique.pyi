...
@overload
def node_clique_number(
    G: Graph[_Node], nodes: _Node = None, cliques: Iterable[Incomplete] | None = None, separate_nodes=False
) -> int: ...
def number_of_cliques(G: Graph[Incomplete], nodes=None, cliques=None) -> int | dict[Incomplete, Incomplete]: ...
@_dispatchable
def max_weight_clique(G: Graph[Incomplete], weight="weight") -> tuple[list[Incomplete], int]: ...
