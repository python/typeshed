...
@_dispatchable
def vf2pp_isomorphism(G1, G2, node_label: str | None = None, default_label: float = None): ...
@_dispatchable
def vf2pp_is_isomorphic(G1, G2, node_label: str | None = None, default_label: float = None): ...
@_dispatchable
def vf2pp_all_isomorphisms(
    G1, G2, node_label: str | None = None, default_label: float = None
