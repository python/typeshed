...
@_dispatchable
def lexicographical_topological_sort(G: DiGraph[_Node], key: Callable | None = None) -> Generator[_Node, None, None]: ...
@_dispatchable
...
@_dispatchable
def transitive_closure_dag(G: DiGraph[_Node], topo_order: list | tuple | None = None) -> DiGraph[_Node]: ...
@_dispatchable
def transitive_reduction(G: DiGraph[_Node]) -> DiGraph[_Node]: ...
@_dispatchable
def antichains(G: DiGraph[_Node], topo_order: list | tuple | None = None) -> Generator[list[_Node], None, None]: ...
@_dispatchable
def dag_longest_path(
    G: DiGraph[_Node], weight: str | None = "weight", default_weight: int | None = 1, topo_order: list | tuple | None = None
) -> list[_Node]: ...
@_dispatchable
