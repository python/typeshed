...
def lexicographical_topological_sort(G: Incomplete, key: Incomplete | None = ...) -> Incomplete: ...
...
def dag_longest_path(G: Incomplete, weight: str = ..., default_weight: int = ...) -> Incomplete: ...
def dag_longest_path_length(G: Incomplete, weight: str = ..., default_weight: int = ...) -> Incomplete: ...
