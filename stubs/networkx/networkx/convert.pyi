...
@_dispatchable
def from_dict_of_lists(d: dict[_Node, Iterable[_Node]], create_using: Graph[Incomplete] | None = None) -> Graph[_Node]: ...
...
def from_dict_of_dicts(
    d: dict[Incomplete, Incomplete], create_using: Graph[Incomplete] | None = None, multigraph_input: bool = False
) -> Graph[Incomplete]: ...
@_dispatchable
def to_edgelist(G: Graph[_Node], nodelist: Collection[_Node] | None = None): ...
@_dispatchable
def from_edgelist(edgelist: list[Incomplete], create_using: Graph[Incomplete] | None = None) -> Graph[Incomplete]: ...
