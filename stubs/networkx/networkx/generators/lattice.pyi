...
@_dispatchable
def grid_2d_graph(m, n, periodic: bool = False, create_using: Graph[Incomplete] = None) -> Graph[Incomplete]: ...
@_dispatchable
...
def triangular_lattice_graph(
    m: int, n: int, periodic: bool = False, with_positions: bool = True, create_using: Graph[Incomplete] = None
) -> Graph[Incomplete]: ...
@_dispatchable
