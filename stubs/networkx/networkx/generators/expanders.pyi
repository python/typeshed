...
@_dispatchable
def margulis_gabber_galil_graph(n: int, create_using: MultiGraph[Incomplete] = None) -> Graph[Incomplete]: ...
@_dispatchable
def chordal_cycle_graph(p: int, create_using: Graph[Incomplete] = None) -> Graph[Incomplete]: ...
@_dispatchable
def paley_graph(p: int, create_using: Graph[Incomplete] = None) -> Graph[Incomplete]: ...
@_dispatchable
