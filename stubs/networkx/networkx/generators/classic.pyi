...
@_dispatchable
def empty_graph(n: int | Iterable[Incomplete] = 0, create_using=None, default=...): ...
@_dispatchable
...
@_dispatchable
def path_graph(n: int | Iterable[Incomplete], create_using=None): ...
@_dispatchable
def star_graph(n: int | Iterable[Incomplete], create_using=None): ...
@_dispatchable
...
@_dispatchable
def wheel_graph(n: int | Iterable[Incomplete], create_using=None): ...
@_dispatchable
