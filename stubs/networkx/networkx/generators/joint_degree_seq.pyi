...
@_dispatchable
def joint_degree_graph(joint_degrees, seed: Incomplete | None = None) -> Graph[Incomplete]: ...
@_dispatchable
def is_valid_directed_joint_degree(in_degrees, out_degrees, nkk) -> bool: ...
@_dispatchable
def directed_joint_degree_graph(in_degrees, out_degrees, nkk, seed: Incomplete | None = None) -> Graph[Incomplete]: ...
