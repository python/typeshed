...
@_dispatchable
def random_regular_graph(d, n: int, seed=None, *, create_using=None): ...
@_dispatchable
...
def dual_barabasi_albert_graph(
    n: int, m1, m2, p: float, seed=None, initial_graph: Graph[_Node] | None = None, *, create_using=None
) -> Graph[_Node]: ...
@_dispatchable
...
def random_lobster(n: int, p1: float, p2: float, seed=None, *, create_using=None): ...
@_dispatchable
...
@_dispatchable
def random_kernel_graph(n: int, kernel_integral, kernel_root=None, seed=None, *, create_using=None): ...
