...
@_dispatchable
def barabasi_albert_graph(n, m, seed=None, initial_graph=None) -> Graph[_Node]: ...
@_dispatchable
def dual_barabasi_albert_graph(n, m1, m2, p, seed=None, initial_graph=None) -> Graph[_Node]: ...
@_dispatchable
