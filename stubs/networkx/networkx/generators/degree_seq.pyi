...
def configuration_model(
    deg_sequence: list[int], create_using: MultiGraph[Incomplete] | None = None, seed=None
) -> MultiGraph[Incomplete]: ...
@_dispatchable
def directed_configuration_model(
    in_degree_sequence: list[int], out_degree_sequence: list[int], create_using: MultiDiGraph[Incomplete] | None = None, seed=None
) -> MultiDiGraph[Incomplete]: ...
@_dispatchable
def expected_degree_graph(w: list[Incomplete], seed=None, selfloops: bool = True) -> Graph[Incomplete]: ...
@_dispatchable
def havel_hakimi_graph(deg_sequence: list[int], create_using: Graph[Incomplete] | None = None): ...
@_dispatchable
def directed_havel_hakimi_graph(
    in_deg_sequence: list[int], out_deg_sequence: list[int], create_using: DiGraph[Incomplete] | None = None
) -> DiGraph[Incomplete]: ...
@_dispatchable
def degree_sequence_tree(deg_sequence, create_using: Graph[Incomplete] | None = None) -> Graph[Incomplete]: ...
@_dispatchable
