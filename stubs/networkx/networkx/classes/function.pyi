...
@overload
def set_node_attributes(G: Graph[_Node], values: dict[_Node, dict[Incomplete, Incomplete]], name: None = None) -> None: ...
def get_node_attributes(G: Graph[_Node], name: str) -> dict[_Node, Incomplete]: ...
@overload
def set_edge_attributes(G: Graph[_Node], values: dict[tuple[_Node, _Node], Incomplete], name: str) -> None: ...
@overload
...
def is_weighted(G: Graph[_Node], edge: tuple[_Node, _Node] | None = None, weight: str | None = "weight") -> bool: ...
def is_negatively_weighted(G: Graph[_Node], edge: tuple[_Node, _Node] | None = None, weight: str | None = "weight"): ...
