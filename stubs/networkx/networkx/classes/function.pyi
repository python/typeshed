...
def is_frozen(G: Graph[_Node]) -> bool: ...
...
def subgraph(G: Graph[_Node], nbunch: _NBunch[_Node]): ...
def induced_subgraph(G: Graph[_Node], nbunch: _NBunch[_Node]) -> Graph[_Node]: ...
def edge_subgraph(G: Graph[_Node], edges: Iterable[Incomplete]): ...
def restricted_view(G: Graph[_Node], nodes: Iterable[Incomplete], edges: Iterable[Incomplete]): ...
...
def path_weight(G: Graph[_Node], path: Iterable[Incomplete], weight: str) -> int: ...
