...
PaHostApiInfo = Mapping[str, Union[str, int]]
PaDeviceInfo = Mapping[str, Union[str, int, float]]
StreamCallback = Callable[[Optional[bytes], int, Mapping[str, float], int], Tuple[Optional[bytes], int]]
Width = Literal[1, 2, 3, 4]

def get_format_from_width(width: Width, unsigned: bool = ...) -> int: ...
...
class PyAudio:
    ...
    def get_default_host_api_info(self) -> PaHostApiInfo: ...
    def get_default_input_device_info(self) -> PaDeviceInfo: ...
    def get_default_output_device_info(self) -> PaDeviceInfo: ...
    def get_device_count(self) -> int: ...
    def get_device_info_by_host_api_device_index(self, host_api_index: int, host_api_device_index: int) -> PaDeviceInfo: ...
    def get_device_info_by_index(self, device_index: int) -> PaDeviceInfo: ...
    def get_format_from_width(self, width: Width, unsigned: bool = ...) -> int: ...
