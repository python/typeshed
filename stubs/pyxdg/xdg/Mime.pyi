...
def lookup(media: str, subtype: str | None = None): ...

class MIMEtype:
    def __new__(cls, media: str, subtype: str | None = None): ...
...
class MagicRule:
    ...
    word: int
    range: int
    def __init__(self, start: int, value: bytes, mask, word: int, range: int) -> None: ...
    rule_ending_re: re.Pattern
    @classmethod
    def from_file(cls, f: BytesIO) -> tuple[int, MagicRule]: ...
    def maxlen(self) -> int: ...
    def match(self, buffer: SupportsLenAndGetItem) -> bool: ...
    def match0(self, buffer: SupportsLenAndGetItem) -> bool: ...

class MagicMatchAny:
    rules: Collection[MagicRule]
    def __init__(self, rules) -> None: ...
    def match(self, buffer: SupportsLenAndGetItem): ...
    def maxlen(self) -> int: ...
    @classmethod
...
class GlobDB:
    ...
    globs: list[tuple[re.Pattern, MIMEtype, int]]
