...
class IconTheme(IniFile):
    ...
    type: str
    def parse(self, file: PathLike[str]) -> None: ...  # type: ignore[override]
    def getDir(self) -> str: ...
    ...
    def getSize(self, directory: PathLike[str]) -> int: ...
    def getContext(self, directory: PathLike[str]) -> str: ...
    def getType(self, directory: PathLike[str]) -> str: ...
    def getMaxSize(self, directory: PathLike[str]) -> int: ...
    def getMinSize(self, directory: PathLike[str]) -> int: ...
    def getThreshold(self, directory: PathLike[str]) -> int: ...
    def getScale(self, directory: PathLike[str]) -> int: ...
