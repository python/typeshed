...
class IconTheme(IniFile):
    ...
    type: str
    def parse(self, file: PathLike[AnyStr]) -> None: ...  # type: ignore[override]
    def getDir(self) -> str: ...
    ...
    def getSize(self, directory: PathLike[AnyStr]) -> int: ...
    def getContext(self, directory: PathLike[AnyStr]) -> str: ...
    def getType(self, directory: PathLike[AnyStr]) -> str: ...
    def getMaxSize(self, directory: PathLike[AnyStr]) -> int: ...
    def getMinSize(self, directory: PathLike[AnyStr]) -> int: ...
    def getThreshold(self, directory: PathLike[AnyStr]) -> int: ...
    def getScale(self, directory: PathLike[AnyStr]) -> int: ...
