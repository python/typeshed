...
class Rule:
    ...
    @classmethod
    def fromFilename(cls, type: Literal[0, 1], filename: str): ...
    Type: Literal[0, 1]
    expression: ast.Expression
    code: CodeType
    def __init__(self, type: Literal[0, 1], expression: str) -> None: ...
    def apply(self, menuentries: Iterable[MenuEntry], run: int): ...
...
class XMLMenuBuilder:
    ...
    def parse_menu(self, node: xml.dom.Node, filename: str): ...
    def parse_node(self, node: xml.dom.Node, filename: str, parent: Menu | None = None) -> None: ...
    def parse_layout(self, node: xml.dom.Node): ...
    def parse_move(self, node: xml.dom.Node): ...
    def parse_rule(self, node: xml.dom.Node): ...
    def parse_bool_op(self, node: xml.dom.Node, operator: ast.And | ast.Or): ...
    def parse_rule_node(self, node: xml.dom.Node): ...
    ...
    def merge_legacy_dir(self, dir_: str, prefix: str, filename: str, parent: str): ...
