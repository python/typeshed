...
class DesktopEntry(IniFile):
    ...
    def __init__(self, filename: PathLike[AnyStr] | None = None) -> None: ...
    ...
    def getOnlyShowIn(self) -> str: ...
    def getNotShowIn(self) -> str: ...
    def getTryExec(self) -> str: ...
    def getExec(self) -> str: ...
    def getPath(self) -> str: ...
    def getTerminal(self) -> bool: ...
    def getMimeType(self) -> list[re.Pattern]: ...
    ...
    def getFilePattern(self) -> re.Pattern: ...
