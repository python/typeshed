...
from .Image import Image, Resampling, _Size
...
def contain(image: Image, size: _Size, method: Resampling = ...) -> Image: ...
def pad(
    image: Image, size: _Size, method: Resampling = ..., color: Any | None = ..., centering: Iterable[float] = ...
) -> Image: ...
def crop(image: Image, border: _Border = ...) -> Image: ...
def scale(image: Image, factor: float, resample: Resampling = ...) -> Image: ...
def deform(image: Image, deformer: _Deformer, resample: Resampling = ...) -> Image: ...
def equalize(image: Image, mask: Any | None = ...) -> Image: ...
def expand(image: Image, border: _Border = ..., fill: _Ink = ...) -> Image: ...
def fit(image: Image, size: _Size, method: Resampling = ..., bleed: float = ..., centering: Iterable[float] = ...) -> Image: ...
