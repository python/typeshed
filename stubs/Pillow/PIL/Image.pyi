...
class Image:
    ...
    def draft(self, mode: Mode_, size: _Size) -> None: ...
    ...
    def point(self, lut, mode: Mode_ | None = ...) -> Image: ...
    def putalpha(self, alpha: Image | int) -> None: ...
    def putdata(self, data: Sequence[int], scale: float = ..., offset: float = ...) -> None: ...
    def putpalette(self, data: ImagePalette | bytes | Iterable[int] | SupportsBytes, rawmode: Mode_ | None = ...) -> None: ...
...
def merge(mode: Mode_, bands: Sequence[Image]) -> Image: ...
...
def linear_gradient(mode: Mode_) -> Image: ...
def radial_gradient(mode: Mode_) -> Image: ...
