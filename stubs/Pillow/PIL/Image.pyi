...
class Image:
    ...
    def putpalette(self, data: ImagePalette | bytes | str | Iterable[int] | SupportsBytes, rawmode: str | None = ...) -> None: ...
    def putpixel(self, xy: tuple[int, int], value: _Color) -> None: ...
