...
from typing import Any, ClassVar, Protocol, SupportsBytes, Tuple, Union
...
class Image:
    ...
    def paste(self, im: Union[Image, Tuple[int], int], box: tuple[float, float] | _Box | None = ..., mask: Image | None = ...) -> None: ...
