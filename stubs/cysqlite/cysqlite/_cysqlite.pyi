import types
from _typeshed import Incomplete, sentinel
...
_AdaptedInputData: TypeAlias = _SqliteData | Any  # There can be registered types with cysqlite.
...
class Connection(_callable_context_manager):
    ...
    def execute_simple(self, sql: str, callback: Callable[..., Any] | None = None) -> None: ...
    def executemany(self, sql: str, seq_of_params: Sequence[_Parameters]) -> Cursor: ...
...
class Cursor:
    ...
    def executemany(self, sql: str, seq_of_params: Sequence[_Parameters] | None = None) -> Self: ...
...
class TableFunction:
    ...
    columns: ClassVar[list[tuple[str, str]] | None] = ...
    name: ClassVar[str | None] = ...
    params: ClassVar[list[str] | None] = ...
    ...
    # NOTE: initialize goes hand & hand with the values added to the class variable
    # params SEE: https://cysqlite.readthedocs.io/en/latest/api.html#tablefunction
    def initialize(self) -> None: ...
    # NOTE: Values of insert can be any row of a given tuple-like object
    # or Sequence hence adding both options.
    def insert(self, rowid: int, values: Sequence[_AdaptedInputData] | tuple[_AdaptedInputData, ...]) -> int: ...
...
class _callable_context_manager:
    ...
    def __setstate_cython__(self, __pyx_state: Any, /) -> None: ...
