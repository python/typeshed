...
class Env:
    ...
    def __call__(
        self, var: _Str, cast: _Cast[_T] | None = None, default: _T | NoValue = NOTSET, parse_default: _Bool = False
    ) -> _T: ...
    ...
    def list(self, var: _Str, cast: _Cast[_List] | None = None, default: _List | NoValue = NOTSET) -> _List: ...
    def tuple(self, var: _Str, cast: _Cast[_Tuple] | None = None, default: _Tuple | NoValue = NOTSET) -> _Tuple: ...
    def dict(self, var: _Str, cast: _Cast[_Dict] | None = None, default: _Dict | NoValue = NOTSET) -> _Dict: ...
