...
class Env:
    ...
    @overload
    def __call__(
        self, var: _str, cast: CastDict, default: _dict | NoValue = ..., parse_default: _bool = False
    ) -> _dict[Any, Any]: ...
    @overload
    def __call__(
        self, var: _str, cast: type[_list], default: _list[_str] | NoValue = ..., parse_default: _bool = False
    ) -> _list[_str]: ...
    @overload
    def __call__(
        self, var: _str, cast: type[_tuple], default: _tuple[_str, ...] | NoValue = ..., parse_default: _bool = False
    ) -> _tuple[_str, ...]: ...
    @overload
    def __call__(
    ...
    def dict(self, var: _str, cast: _Cast[_T] | None = ..., default: _dict[Any, _T] | NoValue = ...) -> _dict[Any, _T]: ...
    ...
    @classmethod
    @overload
    def parse_value(cls, value: _str, cast: type[_list]) -> _list[_str]: ...
    @classmethod
    @overload
    def parse_value(cls, value: _str, cast: type[_tuple]) -> _tuple[_str]: ...
    @classmethod
    @overload
    def parse_value(cls, value: _str, cast: type[_dict]) -> _dict[_str, _str]: ...
    @classmethod
