# Note: modulegraph is vendored by PyInstaller.
# We're only typing the bare-minimum for PyInstaller itself to be complete.
# This also avoids having to whitelist modulegraph as a third-party dependency in stub-uploader
