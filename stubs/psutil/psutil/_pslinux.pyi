...
def readlink(path: StrOrBytesPath) -> str: ...
def file_flags_to_mode(flags: str) -> str: ...
def is_storage_device(name: str) -> bool: ...
def set_scputimes_ntuple(procfs_path) -> None: ...
def cat(fname, fallback=..., binary: bool = ...) -> str: ...
...
class scputimes(NamedTuple):
    ...
    irq: Any
    softirq: Any
    steal: Any  # Only available on Linux >= 2.6.11
    guest: Any  # Only available on Linux >= 2.6.24
    guest_nice: Any  # Only available on Linux >= 3.2.0

def prlimit(pid: int, resource_, limits: Any | None = ...) -> tuple[c_longlong, c_longlong]: ...
def calculate_avail_vmem(mems) -> int: ...
def virtual_memory() -> svmem: ...
def swap_memory() -> sswap: ...
def cpu_times() -> pcputimes: ...
def per_cpu_times() -> list[scputimes]: ...
def cpu_count_logical() -> int: ...
def cpu_count_physical() -> int: ...
def cpu_stats() -> scpustats: ...
def cpu_freq() -> list[scpufreq]: ...
