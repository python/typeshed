...
_FdOrPathType = int | path._PathType

def usage_percent(used, total, round_: Optional[int] = ...) -> float: ...
def memoize(fun: _Func) -> _Func: ...
def memoize_when_activated(fun: _Func) -> _Func: ...
def isfile_strict(path: _FdOrPathType) -> bool: ...
def path_exists_strict(path: _FdOrPathType) -> bool: ...
