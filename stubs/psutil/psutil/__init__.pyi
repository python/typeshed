...
class Process:
    ...
    def as_dict(self, attrs: Any | None = ..., ad_value: Any | None = ...) -> dict[str, Any]: ...
    ...
    def cpu_percent(self, interval: float | int | None = ...) -> float: ...
    ...
    def kill(self) -> None: ...
    def wait(self, timeout: float | int | None = ...) -> int: ...
...
def cpu_times(percpu: bool = ...) -> pcputimes: ...
