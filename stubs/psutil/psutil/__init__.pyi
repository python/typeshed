...
class Process:
    ...
    def __ne__(self, other: Process) -> bool: ...
    def __hash__(self) -> int: ...
    @property
    def pid(self) -> int: ...
    def oneshot(self) -> ContextManager[None]: ...
    def as_dict(self, attrs: list[str] | None = ..., ad_value: Any | None = ...) -> dict[str, Any]: ...
...
def process_iter(attrs: list[str] | None = ..., ad_value: Any | None = ...) -> Iterator[Process]: ...
def wait_procs(
