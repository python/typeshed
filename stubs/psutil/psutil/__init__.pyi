...
_as_dict_attrs = list[str] | tuple[str, ...] | set[str] | frozenset[str]
...
class Process:
    ...
    def as_dict(self, attrs: _as_dict_attrs | None = ..., ad_value: Any | None = ...) -> dict[str, Any]: ...
...
def process_iter(attrs: _as_dict_attrs | None = ..., ad_value: Any | None = ...) -> Iterator[Process]: ...
def wait_procs(
