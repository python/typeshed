...
class Process:
    ...
    def uids(self) -> NamedTuple: ...
    def gids(self) -> NamedTuple: ...
    def terminal(self) -> str: ...
    def num_fds(self) -> int: ...
    if sys.platform != "darwin":
        def io_counters(self) -> NamedTuple: ...
        def ionice(self, ioclass: Any | None = ..., value: Any | None = ...) -> NamedTuple: ...
    if sys.platform == "linux":
        def rlimit(self, resource, limits: Any | None = ...): ...
    if sys.platform != "darwin":
        def cpu_affinity(self, cpus: Any | None = ...) -> list[int]: ...
    if sys.platform == "linux":
        def cpu_num(self) -> int: ...
    def environ(self) -> dict: ...
    if sys.platform == "win32":
        def num_handles(self) -> int: ...
    def num_ctx_switches(self) -> NamedTuple: ...
    def num_threads(self) -> int: ...
    def threads(self) -> list[NamedTuple]: ...
    ...
    def memory_info_ex(self) -> NamedTuple: ...
    def memory_full_info(self) -> NamedTuple: ...
    def memory_percent(self, memtype: str = ...) -> float: ...
    if sys.platform != "darwin":
        def memory_maps(self, grouped: bool = ...) -> list[NamedTuple]: ...
