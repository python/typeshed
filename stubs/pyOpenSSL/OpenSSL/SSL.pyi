...
class _OSCPCallback(Protocol):
    def __call__(self, __connection: Connection, __bytestring: bytes, __expected: bytes | None = ...) -> bool: ...
...
class Context:
    ...
    def set_ocsp_server_callback(self, callback: _OSCPCallback, data: bytes | None = ...) -> None: ...
    def set_ocsp_client_callback(self, callback: _OSCPCallback, data: bytes | None = ...) -> None: ...
