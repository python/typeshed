...
class Connection:
    ...
    def send(self, buf: ReadableBuffer, flags: int = ...) -> int: ...
    write = send
    def sendall(self, buf: ReadableBuffer, flags: int = ...) -> int: ...
    def recv(self, bufsiz: int, flags: int | None = ...) -> bytes: ...
    read = recv
    def recv_into(self, buffer: bytearray, nbytes: int | None = ..., flags: int | None = ...) -> int: ...
    ...
    def makefile(self, *args: Any, **kwargs: Any) -> NoReturn: ...
    ...
    def export_keying_material(self, label: Any, olen: Any, context: Any = ...) -> Any: ...  # TODO: type, see RFC-5705
