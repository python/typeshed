...
class Context:
    ...
    def set_ocsp_server_callback(self, callback: Callable[[Connection, bytes | None], bytes], data: bytes | None = ...) -> None: ...
    def set_ocsp_client_callback(self, callback: Callable[[Connection, bytes, bytes | None], bool], data: bytes | None = ...) -> None: ...
