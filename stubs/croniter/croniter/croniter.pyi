...
class croniter(Iterator[Any]):
    ...
    def get_next(self, ret_type: _RetType | None = None, start_time: float | datetime.datetime | None = None, update_current: bool = True) -> Any: ...
    def get_prev(self, ret_type: _RetType | None = None, start_time: float | datetime.datetime | None = None, update_current: bool = True) -> Any: ...
    ...
    def next(
        self, ret_type: _RetType | None = None, start_time: float | datetime.datetime | None = None, is_prev: bool | None = None, update_current: bool | None = None
    ) -> Any: ...
    __next__ = next
    def all_next(self, ret_type: _RetType | None = None, start_time: float | datetime.datetime | None = None, update_current: bool | None = None) -> Iterator[Any]: ...
    def all_prev(self, ret_type: _RetType | None = None, start_time: float | datetime.datetime | None = None, update_current: bool | None = None) -> Iterator[Any]: ...
