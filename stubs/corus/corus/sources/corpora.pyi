...
def parse_grams(xml) -> Generator[Incomplete, None, None]: ...
def parse_forms(xml) -> Generator[Incomplete, None, None]: ...
def parse_tokens(xml) -> Generator[Incomplete, None, None]: ...
def parse_sents(xml) -> Generator[Incomplete, None, None]: ...
def parse_pars(xml) -> Generator[Incomplete, None, None]: ...
def parse_tags(xml) -> Generator[Incomplete, None, None]: ...
def parse_text(xml): ...
def load_corpora(path) -> Generator[Incomplete, None, None]: ...
