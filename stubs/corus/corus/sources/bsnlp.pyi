...
def walk(dir): ...
def load_ids(dir, langs) -> Generator[Incomplete, None, None]: ...
def select_type(ids, type) -> Generator[Incomplete, None, None]: ...

RAW_PATTERN: Incomplete

def parse_raw(name, text): ...
def load_raw(records) -> Generator[Incomplete, None, None]: ...

ANNOTATED_PATTERN: Incomplete

def parse_substrings(lines) -> Generator[Incomplete, None, None]: ...
def parse_annotated(name, lines): ...
def load_annotated(records) -> Generator[Incomplete, None, None]: ...
def merge(raw, annotated) -> Generator[Incomplete, None, None]: ...
