...
def load_tar(path, offset: int = 0) -> Generator[Incomplete, None, None]: ...
def load_zip(path, offset: int = 0) -> Generator[Incomplete, None, None]: ...
def parse_meta(file, encoding: str = "utf8") -> Generator[Incomplete, None, None]: ...
def load_metas(path, pattern, offset, count, load) -> Generator[Incomplete, None, None]: ...
def load_tar_metas(path, pattern, offset, count): ...
def load_zip_metas(path, pattern, offset, count): ...
def load_texts(path, pattern, offset, count, parse_id, load, encoding: str = "utf8") -> Generator[Incomplete, None, None]: ...
...
def merge_metas(records, metas: Incomplete | None = None) -> Generator[Incomplete, None, None]: ...
