...
def findMatchingBraces(text, ldelim: int = 0) -> Generator[Incomplete, None, None]: ...
def findBalanced(text, openDelim=["[["], closeDelim=["]]"]) -> Generator[Incomplete, None, None]: ...
def if_empty(*rest): ...
...
def pages_from(input) -> Generator[Incomplete, None, None]: ...
