...
class Stats:
    ...
    default: float
    def __init__(
        self, data: list[int | float], default: float = ..., use_copy: bool = ..., is_sorted: bool = ...
    ) -> NoReturn: ...
...
def describe(
    data: list[int | float], quantiles: list[float] | None = ..., format: str | None = ...
...
def format_histogram_counts(
    bin_counts: list[int | float], width: int | None = ..., format_bin: Callable[..., Any] | None = ...
) -> str: ...
