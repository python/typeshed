...
class Callpoint:
    ...
    @classmethod
    def from_current(cls, level: int = ...) -> Self: ...
    @classmethod
...
class TracebackInfo:
    ...
    @classmethod
    def from_frame(cls, frame: FrameType | None = ..., level: int = ..., limit: int | None = ...) -> Self: ...
    @classmethod
    def from_traceback(cls, tb: TracebackType | None = ..., limit: int | None = ...) -> Self: ...
    @classmethod
