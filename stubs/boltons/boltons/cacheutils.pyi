...
class LRI(dict[_KT, _VT]):
    ...
    @overload
    def get(self, key: _KT, default: _T | _VT = ...) -> _T | _VT: ...
    def __delitem__(self, key: _KT) -> NoReturn: ...
    def pop(self, key: _KT, default: _T | _VT = ...) -> _T | _VT: ...
    ...
    def update(self, E, **F) -> None: ...  # type: ignore[override]
...
def make_cache_key(
    ...
    typed: bool = ...,
    kwarg_mark: object = ...,
    fasttypes: frozenset[int | str | bytes | frozenset[Any] | None] = ...,
): ...
...
class MinIDMap(Generic[_T]):
    ...
    def __len__(self) -> int: ...
    def iteritems(self) -> Generator[_T, None, None]: ...
