...
class FrozenDict(dict[_KT, _VT]):
    ...
    def __ior__(self, *a, **kw) -> Never: ...  # type: ignore[misc] # noqa: Y034 # Signature conflicts with superclass
    def __setitem__(self, *a, **kw) -> Never: ...
    def __delitem__(self, *a, **kw) -> Never: ...
    def update(self, *a, **kw) -> Never: ...
    def pop(self, *a, **kw) -> Never: ...
    def popitem(self, *a, **kw) -> Never: ...
    def setdefault(self, *a, **kw) -> Never: ...
    def clear(self, *a, **kw) -> Never: ...
