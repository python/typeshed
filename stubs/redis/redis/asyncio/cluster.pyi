...
class RedisCluster(AbstractRedis, AbstractRedisCluster, AsyncRedisClusterCommands, Generic[_StrType]): ...
    def __init__(
        self,
        host: str | None = ...,
        port: str | int = ...,
    ...
    def pipeline(self) -> ClusterPipeline[_StrType]: ...
    @classmethod
...
class ClusterPipeline(AbstractRedis, AbstractRedisCluster, AsyncRedisClusterCommands, Generic[_StrType]):
    ...
    def execute_command(
        self: Self, *args: KeyT | EncodableT, **kwargs: Any
    ) -> Self: ...
    async def execute(
        self, raise_on_error: bool = ..., allow_redirections: bool = ...
    ) -> list[Any]:
    def mset_nonatomic(
        self: Self, mapping: Mapping[AnyKeyT, EncodableT]
    ) -> Self: ...
