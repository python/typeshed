...
class BaseParser:
    ...
    async def read_response(self, disable_decoding: bool = False, disconnect_on_error: bool = True) -> EncodableT | ResponseError | list[EncodableT] | None: ...
...
class Connection:
    ...
    @overload
    async def read_response(self, disable_decoding: bool, timeout: float, disconnect_on_error: bool = True) -> Incomplete | None: ...
    @overload
