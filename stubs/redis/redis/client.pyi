...
class Redis(Generic[_StrType]):
    ...
    @overload
    def hset(self, name: _Key, key: _Key, value: _Value, mapping: Optional[Mapping[_Value, _Value]] = ...) -> int: ...
    @overload
    def hset(self, name: _Key, key: None, value: None, mapping: Mapping[_Value, _Value]) -> int: ...
    @overload
    def hset(self, name: _Key, *, mapping: Mapping[_Value, _Value]) -> int: ...
...
class Pipeline(Redis):
    ...
    def hset(self, name: _Key, key: _Key, value: _Value, mapping: Optional[Mapping[_Value, _Value]] = ...) -> Pipeline: ...
    @overload  # type: ignore [override]
    def hset(self, name: _Key, key: None, value: None, mapping: Mapping[_Value, _Value]) -> int: ...
    @overload  # type: ignore [override]
    def hset(self, name: _Key, *, mapping: Mapping[_Value, _Value]) -> Pipeline: ...
