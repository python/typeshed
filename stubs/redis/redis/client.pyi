...
class Redis(Generic[_StrType]):
    ...
    def zlexcount(self, name: _Key, min: _Value, max: _Value): ...
    def zpopmax(self, name: _Key, count: int = ...) -> List[_StrType]: ...
    def zpopmin(self, name: _Key, count: int = ...) -> List[_StrType]: ...
    @overload
    ...
    def zrangebylex(self, name: _Key, min: _Value, max: _Value, start: Optional[int] = ..., num: int = ...) -> List[_StrType]: ...
    @overload
    def zrangebyscore(
        self,
        name: _Key,
    ...
    def zrevrangebylex(
        self, name: _Key, min: _Value, max: _Value, start: Optional[int] = ..., num: int = ...
    ) -> List[_StrType]: ...
