import builtins
import threading
from _typeshed import SupportsItems, Self
from datetime import datetime, timedelta
from typing import Any, Callable, Dict, Generic, Iterable, Iterator, Mapping, Pattern, Sequence, Type, TypeVar, Union, overload, ClassVar
...
class Redis(RedisModuleCommands, CoreCommands[_StrType], SentinelCommands, Generic[_StrType]):
    ...
    def scan(self, cursor: int = ..., match: _Key | None = ..., count: int | None = ..., _type: str | None = ...) -> tuple[int, list[_StrType]]: ...
    def scan_iter(self, match: str | None = ..., count: int | None = ..., _type: str | None = ...) -> Iterator[_StrType]: ...
    def sscan(self, name: _Key, cursor: int = ..., match: str | None = ..., count: int | None = ...) -> tuple[int, list[_StrType]]: ...
