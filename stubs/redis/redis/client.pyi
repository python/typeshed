...
class Pipeline(Redis):
    ...
    def lock(self, name, timeout=..., sleep=..., blocking_timeout=..., lock_class=..., thread_local=...): ...
    def pubsub(self, shard_hint: Any = ..., ignore_subscribe_messages: bool = ...) -> PubSub: ...
    def acl_cat(self, category: Optional[Text] = ...) -> Pipeline: ...
    def acl_deluser(self, username: Text) -> Pipeline: ...
    def acl_genpass(self) -> Pipeline: ...
    def acl_getuser(self, username: Text) -> Pipeline: ...
    ...
    def bgrewriteaof(self) -> Pipeline: ...
    def bgsave(self) -> Pipeline: ...
    def client_id(self) -> Pipeline: ...
    def client_kill(self, address: Text) -> Pipeline: ...
    def client_list(self) -> Pipeline: ...
    def client_getname(self) -> Pipeline: ...
    def client_setname(self, name: Text) -> Pipeline: ...
    def readwrite(self) -> Pipeline: ...
    def readonly(self) -> Pipeline: ...
    def config_get(self, pattern=...) -> Pipeline: ...
    def config_set(self, name, value) -> Pipeline: ...
    def config_resetstat(self) -> Pipeline: ...
    def config_rewrite(self) -> Pipeline: ...
    def dbsize(self) -> Pipeline: ...
    def debug_object(self, key) -> Pipeline: ...
    def echo(self, value) -> Pipeline: ...
    def flushall(self) -> Pipeline: ...
    def flushdb(self) -> Pipeline: ...
    def info(self, section: Optional[_Key] = ...) -> Pipeline: ...
    ...
    def sentinel_get_master_addr_by_name(self, service_name) -> Pipeline: ...
    def sentinel_master(self, service_name) -> Pipeline: ...
    def sentinel_masters(self) -> Pipeline: ...
    def sentinel_monitor(self, name, ip, port, quorum) -> Pipeline: ...
    def sentinel_remove(self, name) -> Pipeline: ...
    def sentinel_sentinels(self, service_name) -> Pipeline: ...
    def sentinel_set(self, name, option, value) -> Pipeline: ...
    def sentinel_slaves(self, service_name) -> Pipeline: ...
    def shutdown(self) -> None: ...
    def slaveof(self, host=..., port=...) -> Pipeline: ...
    def slowlog_get(self, num=...) -> Pipeline: ...
    def slowlog_len(self) -> Pipeline: ...
    def slowlog_reset(self) -> Pipeline: ...
    def time(self) -> Pipeline: ...
    def append(self, key, value) -> Pipeline: ...
    def bitcount(self, key: _Key, start: Optional[int] = ..., end: Optional[int] = ...) -> Pipeline: ...
    def bitop(self, operation, dest, *keys) -> Pipeline: ...
    def bitpos(self, key, bit, start=..., end=...) -> Pipeline: ...
    def decr(self, name, amount=...) -> Pipeline: ...
    def delete(self, *names: _Key) -> Pipeline: ...
    def __delitem__(self, _Key) -> None: ...
    def dump(self, name) -> Pipeline: ...
    def exists(self, *names: _Key) -> Pipeline: ...
    def __contains__(self, *names: _Key) -> Pipeline: ...
    def expire(self, name: _Key, time: Union[int, timedelta]) -> Pipeline: ...
    def expireat(self, name, when) -> Pipeline: ...
    def get(self, name: _Key) -> Pipeline: ...
    def __getitem__(self, name) -> Pipeline: ...
    def getbit(self, name: _Key, offset: int) -> Pipeline: ...
    def getrange(self, key, start, end) -> Pipeline: ...
    def getset(self, name, value) -> Pipeline: ...
    def incr(self, name, amount=...) -> Pipeline: ...
    def incrby(self, name, amount=...) -> Pipeline: ...
    def incrbyfloat(self, name, amount=...) -> Pipeline: ...
    def keys(self, pattern=...) -> Pipeline: ...
    def mget(self, keys, *args) -> Pipeline: ...
    def mset(self, *args, **kwargs) -> Pipeline: ...
    def msetnx(self, *args, **kwargs) -> Pipeline: ...
    def move(self, name, db) -> Pipeline: ...
    def persist(self, name) -> Pipeline: ...
    def pexpire(self, name, time) -> Pipeline: ...
    def pexpireat(self, name, when) -> Pipeline: ...
    def psetex(self, name, time_ms, value) -> Pipeline: ...
    def pttl(self, name) -> Pipeline: ...
    def randomkey(self) -> Pipeline: ...
    def rename(self, src, dst) -> Pipeline: ...
    def renamenx(self, src, dst) -> Pipeline: ...
    def restore(self, name, ttl, value) -> Pipeline: ...
    def set(
        self,
        name: _Key,
        value: _Value,
    ...
    def setbit(self, name: _Key, offset: int, value: int) -> Pipeline: ...
    def setex(self, name: _Key, time: Union[int, timedelta], value: _Value) -> Pipeline: ...
    def setnx(self, name, value) -> Pipeline: ...
    def setrange(self, name, offset, value) -> Pipeline: ...
    def strlen(self, name) -> Pipeline: ...
    def substr(self, name, start, end=...) -> Pipeline: ...
    def ttl(self, name: _Key) -> Pipeline: ...
    def type(self, name) -> Pipeline: ...
    def unlink(self, *names: _Key) -> Pipeline: ...
    def blpop(self, keys: Union[_Value, Iterable[_Value]], timeout: float = ...) -> Pipeline: ...
    def brpop(self, keys: Union[_Value, Iterable[_Value]], timeout: float = ...) -> Pipeline: ...
    def brpoplpush(self, src, dst, timeout=...) -> Pipeline: ...
    def lindex(self, name: _Key, index: int) -> Pipeline: ...
    def linsert(
        self, name: _Key, where: Literal["BEFORE", "AFTER", "before", "after"], refvalue: _Value, value: _Value
    ) -> Pipeline: ...
    def llen(self, name: _Key) -> Pipeline: ...
    def lpop(self, name) -> Pipeline: ...
    def lpush(self, name: _Value, *values: _Value) -> Pipeline: ...
    def lpushx(self, name, value) -> Pipeline: ...
    def lrange(self, name: _Key, start: int, end: int) -> Pipeline: ...
    def lrem(self, name: _Key, count: int, value: _Value) -> Pipeline: ...
    def lset(self, name: _Key, index: int, value: _Value) -> Pipeline: ...
    def ltrim(self, name: _Key, start: int, end: int) -> Pipeline: ...
    def rpop(self, name) -> Pipeline: ...
    def rpoplpush(self, src, dst) -> Pipeline: ...
    def rpush(self, name: _Value, *values: _Value) -> Pipeline: ...
    def rpushx(self, name, value) -> Pipeline: ...
    def sort(
        self,
        name: _Key,
        start: Optional[int] = ...,
    ...
    def sscan(self, name: _Key, cursor: int = ..., match: Text = ..., count: int = ...) -> Pipeline: ...
    def sscan_iter(self, name, match=..., count=...) -> Iterator[Any]: ...
    def hscan(self, name: _Key, cursor: int = ..., match: Text = ..., count: int = ...) -> Pipeline: ...
    def hscan_iter(self, name, match=..., count=...) -> Iterator[Any]: ...
    def zscan(self, name, cursor=..., match=..., count=..., score_cast_func=...) -> Pipeline: ...
    def zscan_iter(self, name, match=..., count=..., score_cast_func=...) -> Iterator[Any]: ...
    def sadd(self, name: _Key, *values: _Value) -> Pipeline: ...
    def scard(self, name: _Key) -> Pipeline: ...
    def sdiff(self, keys, *args) -> Pipeline: ...
    def sdiffstore(self, dest, keys, *args) -> Pipeline: ...
    def sinter(self, keys: _Key, *args: _Key) -> Pipeline: ...
    def sinterstore(self, dest, keys, *args) -> Pipeline: ...
    def sismember(self, name: _Key, value: _Value) -> Pipeline: ...
    ...
    def srem(self, name: _Key, *values: _Value) -> Pipeline: ...
    def sunion(self, keys, *args) -> Pipeline: ...
    def sunionstore(self, dest, keys, *args) -> Pipeline: ...
    def xack(self, name, groupname, *ids) -> Pipeline: ...
    def xadd(self, name, fields, id=..., maxlen=..., approximate=...) -> Pipeline: ...
    def xclaim(
        self,
        name,
        groupname,
    ...
    def xdel(self, name, *ids) -> Pipeline: ...
    def xgroup_create(self, name, groupname, id=..., mkstream=...) -> Pipeline: ...
    def xgroup_delconsumer(self, name, groupname, consumername) -> Pipeline: ...
    def xgroup_destroy(self, name, groupname) -> Pipeline: ...
    def xgroup_setid(self, name, groupname, id) -> Pipeline: ...
    def xinfo_consumers(self, name, groupname) -> Pipeline: ...
    def xinfo_groups(self, name) -> Pipeline: ...
    def xinfo_stream(self, name) -> Pipeline: ...
    def xlen(self, name: _Key) -> Pipeline: ...
    def xpending(self, name, groupname) -> Pipeline: ...
    def xpending_range(self, name, groupname, min, max, count, consumername=...) -> Pipeline: ...
    def xrange(self, name, min=..., max=..., count=...) -> Pipeline: ...
    def xread(self, streams, count=..., block=...) -> Pipeline: ...
    def xreadgroup(self, groupname, consumername, streams, count=..., block=..., noack=...) -> Pipeline: ...
    def xrevrange(self, name, max=..., min=..., count=...) -> Pipeline: ...
    def xtrim(self, name, maxlen, approximate=...) -> Pipeline: ...
    def zadd(
        self, name: _Key, mapping: Mapping[_Key, _Value], nx: bool = ..., xx: bool = ..., ch: bool = ..., incr: bool = ...
    ) -> Pipeline: ...
    def zcard(self, name) -> Pipeline: ...
    def zcount(self, name: _Key, min: _Value, max: _Value) -> Pipeline: ...
    def zincrby(self, name, value, amount=...) -> Pipeline: ...
    def zinterstore(self, dest, keys, aggregate=...) -> Pipeline: ...
    def zlexcount(self, name, min, max) -> Pipeline: ...
    def zpopmax(self, name, count=...) -> Pipeline: ...
    def zpopmin(self, name, count=...) -> Pipeline: ...
    def bzpopmax(self, keys, timeout=...) -> Pipeline: ...
    def bzpopmin(self, keys, timeout=...) -> Pipeline: ...
    def zrange(self, name, start, end, desc=..., withscores=..., score_cast_func=...) -> Pipeline: ...
    def zrangebylex(self, name, min, max, start=..., num=...) -> Pipeline: ...
    def zrangebyscore(self, name, min, max, start=..., num=..., withscores=..., score_cast_func=...) -> Pipeline: ...
    def zrank(self, name: _Key, value: _Key) -> Pipeline: ...
    def zrem(self, name, *values) -> Pipeline: ...
    def zremrangebylex(self, name, min, max) -> Pipeline: ...
    def zremrangebyrank(self, name, min, max) -> Pipeline: ...
    def zremrangebyscore(self, name: _Key, min: _Value, max: _Value) -> Pipeline: ...
    def zrevrange(self, name, start, end, withscores=..., score_cast_func=...) -> Pipeline: ...
    def zrevrangebyscore(self, name, max, min, start=..., num=..., withscores=..., score_cast_func=...) -> Pipeline: ...
    def zrevrank(self, name, value) -> Pipeline: ...
    def zscore(self, name, value) -> Pipeline: ...
    def zunionstore(self, dest, keys, aggregate=...) -> Pipeline: ...
    def pfadd(self, name: _Key, *values: _Value) -> Pipeline: ...
    def pfcount(self, name: _Key) -> Pipeline: ...
    def pfmerge(self, dest: _Key, *sources: _Key) -> Pipeline: ...
    def hdel(self, name: _Key, *keys: _Key) -> Pipeline: ...
    def hexists(self, name: _Key, key: _Key) -> Pipeline: ...
    def hget(self, name: _Key, key: _Key) -> Pipeline: ...
    def hgetall(self, name: _Key) -> Pipeline: ...
    def hincrby(self, name: _Key, key: _Key, amount: int = ...) -> Pipeline: ...
    def hincrbyfloat(self, name: _Key, key: _Key, amount: float = ...) -> Pipeline: ...
    def hkeys(self, name: _Key) -> Pipeline: ...
    def hlen(self, name: _Key) -> Pipeline: ...
    def hset(
        self, name: _Key, key: Optional[_Key], value: Optional[_Value], mapping: Optional[Mapping[_Value, _Value]] = ...
    ) -> Pipeline: ...
    def hsetnx(self, name: _Key, key: _Key, value: _Value) -> Pipeline: ...
    def hmset(self, name: _Key, mapping: Mapping[_Value, _Value]) -> Pipeline: ...
    def hmget(self, name: _Key, keys: Union[_Key, Iterable[_Key]], *args: _Key) -> Pipeline: ...
    def hvals(self, name: _Key) -> Pipeline: ...
    def publish(self, channel: _Key, message: _Key) -> Pipeline: ...
    def eval(self, script, numkeys, *keys_and_args) -> Pipeline: ...
    def evalsha(self, sha, numkeys, *keys_and_args) -> Pipeline: ...
    def script_exists(self, *args) -> Pipeline: ...
