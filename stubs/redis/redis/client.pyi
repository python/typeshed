...
from typing import Any, Callable, Generic, Iterable, Iterator, Mapping, Sequence, Type, TypeVar, Union, overload, Pattern, Dict
...
class Pipeline(Redis[_StrType], Generic[_StrType]):
    ...
    def hscan(self, name: _Key, cursor: int = ..., match: str | None = ..., count: int = ...) -> Pipeline[_StrType]: ...  # type: ignore[override]
