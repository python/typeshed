...
class Commands:
    ...
    def migrate(
        self, host, port, keys, destination_db, timeout, copy: bool = ..., replace: bool = ..., auth: Any | None = ...
    ): ...
    ...
    def xpending_range(self, name, groupname, min, max, count, consumername: Any | None = ..., idle: Any | None = ...): ...
    ...
    def zrange(self, name, start, end, desc: bool = ..., withscores: bool = ..., score_cast_func=...): ...
    ...
    def zrangebyscore(
        self, name, min, max, start: Any | None = ..., num: Any | None = ..., withscores: bool = ..., score_cast_func=...
    ): ...
    ...
    def zrevrangebyscore(
        self, name, max, min, start: Any | None = ..., num: Any | None = ..., withscores: bool = ..., score_cast_func=...
    ): ...
