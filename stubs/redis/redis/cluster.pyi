...
from redis.exceptions import RedisError, MovedError
...
class ClusterNode:
    ...
    redis_connection: Redis[Any] | None
    def __init__(self, host: str, port: int, server_type: str | None = ..., redis_connection: Redis[Any] | None = ...) -> None: ...
...
class NodesManager:
    ...
    def populate_startup_nodes(self, nodes: list[ClusterNode]) -> None: ...
    ...
    def create_redis_node(self, host: str, port: int, **kwargs: Any) -> Redis[Any]: ...
