...
class HashCommands(Generic[_StrType]):
    ...
    @overload
    def hset(self, name: _Key, key: None, value: None, mapping: Mapping[_Key, _Value], items: Incomplete | None = None) -> int: ...
    @overload
...
class AsyncFunctionCommands:
    ...
    async def function_list(self, library: str | None = '*', withcode: bool | None = False) -> Awaitable[list[Any]] | list[Any]: ...
