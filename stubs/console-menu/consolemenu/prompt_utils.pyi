...
class PromptUtils:
    ...
    def printf(self, *args: list[Any]) -> None: ...
    def println(self, *args: list[Any]) -> None: ...
    ...
    def prompt_for_numbered_choice(self, choices: list[str], title: str | None = ..., prompt: str = ...) -> int: ...
