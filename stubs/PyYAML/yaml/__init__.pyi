...
def scan(stream, Loader: type[_Loader] = ...): ...
def parse(stream, Loader: type[_Loader] = ...): ...
def compose(stream, Loader: type[_Loader] = ...): ...
def compose_all(stream, Loader: type[_Loader] = ...): ...
def load(stream: _ReadStream, Loader: type[_Loader]) -> Any: ...
def load_all(stream: _ReadStream, Loader: type[_Loader]) -> Iterator[Any]: ...
