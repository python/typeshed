...
@overload
def add_constructor(tag: _Str, constructor: Callable[[Loader | FullLoader | UnsafeLoader, Node], Any]) -> None: ...
@overload
def add_constructor(tag: _Str, constructor: Callable[[_Constructor, Node], Any], Loader: Type[_Constructor] = ...) -> None: ...
@overload
def add_multi_constructor(
    tag_prefix: _Str, multi_constructor: Callable[[Loader | FullLoader | UnsafeLoader, _Str, Node], Any]
) -> None: ...
@overload
def add_multi_constructor(
