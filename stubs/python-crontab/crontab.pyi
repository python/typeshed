...
class CronTab:
    ...
    def append(self, item: CronItem, line: str = ..., read: bool = ...) -> None: ...
    ...
    def run_pending(self, **kwars: Any) -> Iterator[str]: ...
    # There are two known kwargs and others are unused:
    def run_scheduler(self, timeout: int = ..., *, warp: object = ..., cadence: int = ..., **kwargs) -> Iterator[str]: ...
    def render(self, errors: bool = ..., specials: bool | None = ...) -> str: ...
    def new(self, command: str = ..., comment: str = ..., user: _User = ..., pre_comment: bool = ...) -> CronItem: ...
    ...
    def remove_all(self, *, command: str | re.Pattern[str] = ..., comment: str | re.Pattern[str] = ..., time: Any = ..., **kwargs): ...
...
class CronItem:
    ...
    def clear(self) -> None: ...
    def frequency(self, year: int | None = ...): ...
...
def get_cronvalue(value: int, enums) -> int | CronValue: ...
