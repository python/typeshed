...
class Process:
    ...
    def __init__(self, *args: str, posix: bool = ..., env: subprocess._ENV = ..., **flags: object | None) -> None: ...
    def run(self) -> Self: ...
...
class CronTab:
    ...
    def run_scheduler(self, timeout: int = ..., warp: object = ..., cadence: int = ...) -> Iterator[str]: ...
...
class CronSlice:
    ...
    def render(self, specials: bool = False) -> str: ...
    def __eq__(self, arg: object) -> bool: ...
