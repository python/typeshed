...
class Process:
    ...
    def __init__(self, *args: str, posix: bool = ..., env: subprocess._ENV | None = ..., **flags: object | None) -> None: ...
    def run(self) -> Self: ...
...
class CronTab:
    ...
    def run_scheduler(self, timeout: int = ..., cadence: int = ..., warp: object = ...) -> Iterator[str]: ...
