...
class Timestamp:
    ...
    def __add__(self, value: tAny) -> datetime: ...
    def __radd__(self, value: tAny) -> datetime: ...
    def __sub__(self, value: tAny) -> datetime | timedelta: ...
    def __rsub__(self, dt: tAny) -> timedelta: ...
...
class Duration:
    ...
    def __add__(self, value: tAny) -> datetime | timedelta: ...
    def __radd__(self, value: tAny) -> datetime | timedelta: ...
    def __sub__(self, value: tAny) -> timedelta: ...
    def __rsub__(self, value: tAny) -> datetime | timedelta: ...

class FieldMask:
    __slots__ = ()
    def ToJsonString(self) -> str: ...
    def FromJsonString(self, value: tAny) -> None: ...
    def IsValidForDescriptor(self, message_descriptor: tAny) -> bool: ...
