...
class BaseContainer(Sequence[_T]):
    ...
    @overload
    def __getitem__(self, key: slice[Any, Any, Any]) -> list[_T]: ...
...
class RepeatedScalarFieldContainer(BaseContainer[_ScalarV]):
    ...
    @overload
    def __setitem__(self, key: slice[Any, Any, Any], value: Iterable[_ScalarV]) -> None: ...
    def __delitem__(self, key: int | slice[Any, Any, Any]) -> None: ...
