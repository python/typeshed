...
class InvokableScriptsApi(_BaseQueryApi):
    ...
    def invoke_script(self, script_id: str, params: dict[Incomplete, Incomplete] = ...) -> TableList: ...
    def invoke_script_stream(
        self, script_id: str, params: dict[Incomplete, Incomplete] = ...
    ) -> Generator["FluxRecord", Any, None]: ...
    def invoke_script_data_frame(
        self, script_id: str, params: dict[Incomplete, Incomplete] = ..., data_frame_index: list[str] = ...
    ): ...
    def invoke_script_data_frame_stream(
        self, script_id: str, params: dict[Incomplete, Incomplete] = ..., data_frame_index: list[str] = ...
    ): ...
    def invoke_script_csv(self, script_id: str, params: dict[Incomplete, Incomplete] = ...) -> CSVIterator: ...
    def invoke_script_raw(self, script_id: str, params: dict[Incomplete, Incomplete] = ...) -> Iterator[list[str]]: ...
