...
class QueryOptions:
    ...
    def __init__(self, profilers: list[str] | None = None, profiler_callback: Callable[..., Incomplete] | None = None) -> None: ...

class QueryApi(_BaseQueryApi):
    def __init__(self, influxdb_client, query_options=...) -> None: ...
    def query_csv(
        self, query: str, org: Incomplete | None = None, dialect: Dialect = ..., params: dict[Incomplete, Incomplete] | None = None
    ) -> CSVIterator: ...
    def query_raw(
        self, query: str, org: Incomplete | None = None, dialect=..., params: dict[Incomplete, Incomplete] | None = None
    ): ...
    def query(self, query: str, org: Incomplete | None = None, params: dict[Incomplete, Incomplete] | None = None) -> TableList: ...
    def query_stream(
