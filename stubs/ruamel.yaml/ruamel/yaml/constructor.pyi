...
from typing import Any, ClassVar, Final, NoReturn, Protocol, Self, TypeVar, overload
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_yaml_str(self, node: ScalarNode) -> str | TaggedScalar: ...
    ...
    def construct_mapping(self, node: MappingNode, maptyp: CommentedMap[Any, Any], deep: bool = False) -> None: ...
    ...
    def construct_yaml_set(self, node: MappingNode) -> Iterator[CommentedSet[Any]]: ...
    @overload
