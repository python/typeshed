...
from typing import Any, Final, Generic, NoReturn, TypeAlias, TypeVar
...
class Comment:
    ...
    @deprecated("RTSC functionality is experimental, unsupported, and known to fail")
    def get(self, item: _Index | _Key, pos: int): ...
    @deprecated("RTSC functionality is experimental, unsupported, and known to fail")
    def set(self, item: _Index | _Key, pos: int, value: list[int]): ...
...
class LineCol:
    ...
    def key(self, k: _Key, /) -> tuple[int, int] | None: ...
    def value(self, k: _Key, /) -> tuple[int, int] | None: ...
...
class CommentedMap(ordereddict[_KT, _VT], CommentedBase):
    ...
    def mlget(self, key: list[_Index | _Key], default: object = None, list_ok: bool = False) -> object: ...
