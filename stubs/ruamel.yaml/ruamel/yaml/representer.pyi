...
class BaseRepresenter:
    ...
    def __init__(
        self, default_style: _ScalarStyle | None = None, default_flow_style: bool | None = None, dumper: YAML | None = None
    ) -> None: ...
    @property
    ...
    def represent_scalar(
        self, tag: Tag | str, value: str, style: _ScalarStyle | None = None, anchor: Anchor | None = None
    ) -> ScalarNode: ...
    def represent_sequence(self, tag: Tag | str, sequence: Collection[Any], flow_style: bool | None = None) -> SequenceNode: ...
    def represent_omap(self, tag: Tag | str, omap: OrderedDict[Any, Any], flow_style: bool | None = None) -> SequenceNode: ...
    def represent_mapping(self, tag: Tag | str, mapping: Mapping[Any, Any], flow_style: bool | None = None) -> MappingNode: ...
...
class SafeRepresenter(BaseRepresenter):
    ...
    def represent_yaml_object(self, tag: Tag | str, data: Any, cls: Unused, flow_style: bool | None = None) -> MappingNode: ...
