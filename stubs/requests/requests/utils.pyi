...
from typing import Any, AnyStr, ContextManager
...
def set_environ(env_name: str, value: None) -> ContextManager[None]: ...
def should_bypass_proxies(url: _Uri, no_proxy: Iterable[AnyStr] | None) -> bool: ...
def get_environ_proxies(url: _Uri, no_proxy: Iterable[AnyStr] | None = ...) -> dict[Any, Any]: ...
