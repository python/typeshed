...
from typing import IO, Any, Callable, Iterable, List, Mapping, MutableMapping, Text, Tuple, TypeVar, Union
...
_Data = Union[None, Text, bytes, Mapping[str, Any], Mapping[Text, Any], Iterable[Tuple[Text, Text | None]], IO[Any]]
