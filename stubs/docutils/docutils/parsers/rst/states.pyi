...
class Body(RSTState):
    ...
    def anonymous(self, match: Match[str], context: Unused, next_state: str) -> tuple[list[Incomplete], str, EmptyList]: ...
    def anonymous_target(self, match: Match[str]) -> tuple[list[nodes.target], bool]: ...
    def line(self, match: Match[str], context: Unused, next_state: str) -> tuple[list[Incomplete], str, EmptyList]: ...
    def text(self, match: Match[str], context: Unused, next_state: Unused) -> tuple[list[str], Literal["Text"], EmptyList]: ...
