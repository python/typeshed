...
class RFC2822Body(Body):
    ...
    def rfc2822(self, match: Match[str], context: Unused, next_state: _NextState) -> tuple[list[Any], _NextState, list[str]]: ...
...
class BulletList(SpecializedBody):
    def bullet(self, match: Match[str], context: Unused, next_state: _NextState) -> tuple[list[Any], _NextState, list[Any]]: ...  # type: ignore[override]

class DefinitionList(SpecializedBody):
    def text(
        self, match: Match[str], context: Unused, next_state: Unused
    ) -> tuple[list[str], Literal["Definition"], list[Any]]: ...  # type: ignore[override]
...
class EnumeratedList(SpecializedBody):
    ...
    ) -> tuple[list[Any], _NextState, list[Any]]: ...  # type: ignore[override]
...
class LineBlock(SpecializedBody):
    ...
    def blank(self, match: Unused = None, context: Unused = None, next_state: Unused = None) -> Never: ...
    def line_block(
        self, match: Match[Any], context: Unused, next_state: _NextState
    ) -> tuple[list[Any], _NextState, list[Any]]: ...  # type: ignore[override]
...
class Text(RSTState):
    ...
    def blank(self, match: Unused, context, next_state: Unused) -> tuple[list[Any], Literal["Body"], list[Any]]: ...
    def eof(self, context): ...
    def indent(self, match: Unused, context, next_state: Unused) -> tuple[list[Any], Literal["Body"], list[Any]]: ...
    def underline(
        self, match: Match[Any], context: Sequence[str], next_state: _NextState
    ) -> tuple[list[Any], _NextState, list[Any]]: ...
    def text(self, match: Unused, context, next_state: _NextState) -> tuple[list[Any], _NextState, list[Any]]: ...
...
class Definition(SpecializedText):
    def eof(self, context: Unused) -> list[Any]: ...
...
class Line(SpecializedText):
    ...
    def blank(self, match: Unused, context: Any, next_state: Unused) -> tuple[list[Any], Literal["Body"], list[Any]]: ...  # type: ignore[override]
    def text(self, match: Match[str], context: list[str], next_state: Unused) -> tuple[list[Any], Literal["Body"], list[Any]]: ...  # type: ignore[override]
    def indent(
        self, match: Match[str], context: list[str], next_state: Unused
    ) -> tuple[list[Any], Literal["Body"], list[Any]]: ...  # type: ignore[override]
    def underline(
        self, match: Unused, context: list[str], next_state: Unused
    ) -> tuple[list[Any], Literal["Body"], list[Any]]: ...  # type: ignore[override]
    def short_overline(self, context: list[Any], blocktext: Unused, lineno: int | None, lines: int = 1) -> None: ...
