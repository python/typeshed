...
class Publisher:
    ...
    def set_reader(self, reader, parser: Incomplete | None = None, parser_name: Incomplete | None = None) -> None: ...
    ...
    def set_source(self, source: Incomplete | None = None, source_path: str | os.PathLike[str] | None = None) -> None: ...
    def set_destination(self, destination: str | None = None, destination_path: str | os.PathLike[str] | None = None) -> None: ...
...
def publish_cmdline(
    reader: Incomplete | None = None,
    reader_name: Incomplete | None = None,
    parser: Incomplete | None = None,
    parser_name: Incomplete | None = None,
    writer: Incomplete | None = None,
    writer_name: Incomplete | None = None,
    settings: Incomplete | None = None,
    settings_spec: Incomplete | None = None,
    settings_overrides: Incomplete | None = None,
    config_section: Incomplete | None = None,
