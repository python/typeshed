...
class Element(Node):
    ...
    @overload
    def get(self, key: str, failobj: None) -> Any | None: ...
    def get(self, key: str, failobj: _T | None) -> _T | None: ...
    def hasattr(self, attr: str) -> bool: ...
    def delattr(self, attr: str) -> None: ...
    @overload
    def setdefault(self, key: str, failobj: _T) -> _T: ...
    @overload
    def setdefault(self, key: str, failobj: None) -> Any | None: ...
    def setdefault(self, key: str, failobj: _T | None) -> _T | None: ...
    ...
    def update_all_atts(
        ...
        update_fun: Callable[[str, Any, bool], None] = ...,
        replace: bool = True,
    ...
    def update_all_atts_coercion(self, dict_: dict[str, Any] | Node, replace: bool = True, and_source: bool = False) -> None: ...
    def update_all_atts_convert(self, dict_: dict[str, Any] | Node, and_source: bool = False) -> None: ...
    def clear(self) -> None: ...
