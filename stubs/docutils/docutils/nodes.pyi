...
class document(Root, Structural, Element):
    ...
    def asdom(self, dom: Any = ...) -> Any: ...
    def set_id(self, node: Element, msgnode: Element | None = ..., suggested_prefix: str | None = ...) -> str: ...
    def set_name_id_map(self, node: Element, id: str, msgnode: Element | None = ..., explicit: bool | None = ...) -> None: ...
    def set_duplicate_name_id(self, node: Element, id: str, name: str, msgnode: Element, explicit: bool) -> None: ...
    def has_name(self, name: str) -> bool: ...
    def note_implicit_target(self, target: Element, msgnode: Element | None = ...) -> None: ...
    def note_explicit_target(self, target: Element, msgnode: Element | None = ...) -> None: ...
    ...
    def note_substitution_def(self, subdef: substitution_definition, def_name: str, msgnode: Element | None = ...) -> None: ...
    def note_substitution_ref(self, subref: substitution_reference, refname: str) -> None: ...
    def note_pending(self, pending: pending, priority: int | None = ...) -> None: ...
