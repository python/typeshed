...
class Element(Node):
    ...
    def update_basic_atts(self, dict_: dict[str, Any] | Node) -> None: ...
    def append_attr_list(self, attr: str, values: Sequence[Any]) -> None: ...
    ...
    def update_all_atts(self, dict_: dict[str, Any] | Node, update_fun: Callable[[str, Any, bool], None] = ..., replace: bool = True, and_source: bool = False) -> None: ...
    def update_all_atts_consistantly(self, dict_: Any, replace: bool = True, and_source: bool = False) -> None: ...
    def update_all_atts_concatenating(self, dict_: Any, replace: bool = True, and_source: bool = False) -> None: ...
    def update_all_atts_coercion(self, dict_: Any, replace: bool = True, and_source: bool = False) -> None: ...
    def update_all_atts_convert(self, dict_: Any, and_source: bool = False) -> None: ...
    def clear(self) -> None: ...
    def replace(self, old: Node, new: Node | list[Node]) -> None: ...
    def replace_self(self, new: Node | list[Node]) -> None: ...
    def first_child_matching_class(self, childclass: type[Node] | tuple[type[Node], ...], start: int = 0, end: int = sys.maxsize) -> int: ...
    def first_child_not_matching_class(self, childclass: type[Node] | tuple[type[Node], ...], start: int = 0, end: int = sys.maxsize) -> int: ...
    def pformat(self, indent: str = "    ", level: int = 0) -> str: ...
    def copy(self) -> Self: ...
    def deepcopy(self) -> Self: ...
