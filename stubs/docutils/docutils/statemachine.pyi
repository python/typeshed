...
class StateMachine(Generic[_Context]):
    ...
    def check_line(
        self, context: list[str], state: State[_Context], transitions: list[str] | None = ...
...
class State(Generic[_Context]):
    ...
    def no_match(
        self, context: list[str], transitions: tuple[list[str], dict[str, tuple[Pattern[str], _TransitionMethod[_Context], str]]]
    ) -> _TransitionResult[_Context]: ...
    def bof(self, context: list[str]) -> tuple[list[str], list[str]]: ...
    def eof(self, context: list[str]) -> list[str]: ...
    def nop(self, match: Match[str], context: list[str], next_state: str) -> _TransitionResult[_Context]: ...
...
class StateWS(State[_Context]):
    ...
    def __init__(self, state_machine: StateMachine[_Context], debug: bool = False) -> None: ...
    def add_initial_transitions(self) -> None: ...
    def blank(self, match: Match[str], context: list[str], next_state: str) -> _TransitionResult[_Context]: ...
    def indent(self, match: Match[str], context: list[str], next_state: str) -> _TransitionResult[_Context]: ...
    def known_indent(self, match: Match[str], context: list[str], next_state: str) -> _TransitionResult[_Context]: ...
    def first_known_indent(self, match: Match[str], context: list[str], next_state: str) -> _TransitionResult[_Context]: ...
