...
class StateMachine:
    ...
    def __init__(self, state_classes: Iterable[type[State]], initial_state: str, debug: bool = False) -> None: ...
    ...
    def add_states(self, state_classes: Iterable[type[State]]) -> None: ...
...
class ViewList(Generic[_Data]):
    ...
    def __init__(
        self,
        initlist: ViewList[_Data] | Sequence[_Data] | None = None,
    ...
    @overload
    def __getitem__(self, i: SupportsIndex) -> _Data: ...
    @overload
    def __setitem__(self, i: slice, item: ViewList[_Data]) -> None: ...
    @overload
    def __setitem__(self, i: SupportsIndex, item: _Data) -> None: ...
    def __delitem__(self, i: SupportsIndex) -> None: ...
    def __add__(self, other: ViewList[_Data]) -> Self: ...
    def __radd__(self, other: ViewList[_Data]) -> Self: ...
