...
_TransitionResult: TypeAlias = tuple[Any, str | None, list[str]]
_TransitionMethod: TypeAlias = Callable[[Match[str], Any, str], _TransitionResult]
...
class StateMachine:
    ...
    def check_line(
        self, context: Any, state: State, transitions: list[str] | None = ...
    ) -> _TransitionResult: ...
...
class State:
    ...
    ) -> tuple[Pattern[str], _TransitionMethod, str]: ...
    def make_transitions(
        self, name_list: list[str | tuple[str] | tuple[str, str]]
    ) -> tuple[list[str], dict[str, tuple[Pattern[str], _TransitionMethod, str]]]: ...
    def no_match(
        self, context: Any, transitions: tuple[list[str], dict[str, tuple[Pattern[str], _TransitionMethod, str]]]
    ) -> _TransitionResult: ...
    def bof(self, context: Any) -> tuple[Any, list[str]]: ...
    def eof(self, context: Any) -> list[str]: ...
    def nop(self, match: Match[str], context: Any, next_state: str) -> _TransitionResult: ...
...
class StateWS(State):
    ...
    def __init__(self, state_machine: StateMachine, debug: bool = False) -> None: ...
    def add_initial_transitions(self) -> None: ...
    def blank(self, match: Match[str], context: Any, next_state: str) -> _TransitionResult: ...
    def indent(self, match: Match[str], context: Any, next_state: str) -> _TransitionResult: ...
    def known_indent(self, match: Match[str], context: Any, next_state: str) -> _TransitionResult: ...
    def first_known_indent(self, match: Match[str], context: Any, next_state: str) -> _TransitionResult: ...
