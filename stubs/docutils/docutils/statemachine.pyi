...
class StateMachine(Generic[_Context]):
    ...
    ) -> tuple[_Context, str | None, list[str]]: ...
...
class State(Generic[_Context]):
    ...
    ) -> tuple[Pattern[str], Callable[[Match[str], _Context, str], tuple[_Context, str | None, list[str]]], str]: ...
    def make_transitions(
        self, name_list: list[str | tuple[str] | tuple[str, str]]
    ) -> tuple[
        list[str],
        dict[str, tuple[Pattern[str], Callable[[Match[str], _Context, str], tuple[_Context, str | None, list[str]]], str]],
    ]: ...
    def no_match(
        self,
        context: Any,
    ...
    def nop(self, match: Match[str], context: _Context, next_state: str) -> tuple[_Context, str | None, list[str]]: ...
...
class StateWS(State[_Context]):
    ...
    def __init__(self, state_machine: StateMachine[_Context], debug: bool = False) -> None: ...
    def add_initial_transitions(self) -> None: ...
    def blank(self, match: Match[str], context: _Context, next_state: str) -> tuple[_Context, str | None, list[str]]: ...
    def indent(self, match: Match[str], context: _Context, next_state: str) -> tuple[_Context, str | None, list[str]]: ...
    def known_indent(self, match: Match[str], context: _Context, next_state: str) -> tuple[_Context, str | None, list[str]]: ...
