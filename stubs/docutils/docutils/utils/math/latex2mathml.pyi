...
from docutils.utils.math.mathml_elements import mover, msub, msubsup, msup, mtd, munder, munderover
...
def parse_latex_math(root, source: str): ...
def handle_cmd(name: str, node, string: str) -> tuple[Incomplete, str]: ...
def handle_math_alphabet(name: str, node, string: str) -> tuple[Incomplete, str]: ...
def handle_script_or_limit(node, c: str, limits: str = "") -> munderover | msubsup | munder | msub | mover | msup: ...
def begin_environment(node, string: str) -> tuple[mtd, str]: ...
def end_environment(node, string: str) -> tuple[Incomplete, str]: ...
