...
def clean_rcs_keywords(paragraph: nodes.paragraph, keyword_substitutions: list[tuple[Pattern[str], str]]) -> None: ...
...
def find_file_in_dirs(path: StrPath, dirs: list[StrPath]) -> str: ...
