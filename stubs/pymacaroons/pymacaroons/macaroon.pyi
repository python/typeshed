...
from pymacaroons.serializers import BaseSerializer
...
class Macaroon:
    ...
    @classmethod
    def deserialize(cls, serialized: str | bytes | bytearray, serializer: BaseSerializer | None = None): ...
    @property
    ...
    def serialize(self, serializer: BaseSerializer | None = None): ...
