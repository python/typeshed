...
class Verifier:
    ...
    def verify(self, macaroon: Macaroon, key: bytes | bytearray, discharge_macaroons: Iterable[Macaroon] | None = None) -> Literal[True]: ...
    def verify_discharge(self, root: Macaroon, discharge: Macaroon, key: bytes | bytearray, discharge_macaroons: Iterable[Macaroon] | None = None) -> Literal[True]: ...
