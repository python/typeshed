...
def ZSTD_compress(data: ReadableBuffer, level: int | None, threads: int | None) -> bytes: ...
def ZSTD_external() -> int: ...
def ZSTD_uncompress(data: ReadableBuffer) -> bytes: ...
def ZSTD_version() -> str: ...
def ZSTD_version_number() -> int: ...
def compress(data: ReadableBuffer, level: int | None, threads: int | None) -> bytes: ...
def decompress(data: ReadableBuffer) -> bytes: ...
def dumps(data: ReadableBuffer, level: int | None, threads: int | None) -> bytes: ...
