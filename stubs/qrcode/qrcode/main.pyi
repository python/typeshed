...
from typing import Any, Generic, NamedTuple, TextIO, TypeVar, overload
...
class QRCode(Generic[GenericImage]):
    ...
    def print_tty(self, out: TextIO | None = None) -> None: ...
    def print_ascii(self, out: TextIO | None = None, tty: bool = False, invert: bool = False) -> None: ...
