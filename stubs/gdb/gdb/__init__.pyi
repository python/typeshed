...
def rbreak(regex: str, minisyms: bool = ..., throttle: int = ..., symtabs: Iterator[Symtab] = ...) -> list[Breakpoint]: ...
...
class Value:
    ...
    def __init__(self, val: _ValueOrNative): ...
...
class FrameFilter:
    ...
    def filter(iterator: Iterator[_FrameDecorator]) -> Iterator[_FrameDecorator]: ...
...
class UnwindInfo:
    def add_saved_register(self, reg: str | RegisterDescriptor | int, value: Value): ...

class Unwinder:
    name: str
    enabled: bool

    def __call__(self, frame: Frame) -> UnwindInfo | None: ...
...
class Command:
    def __init__(self, name: str, command_class: int, completer_class: int = ..., prefix: bool = ...): ...
...
class Parameter:
    ...
    def __init__(self, name: str, command_class: int, parameter_class: int, enum_sequence: Sequence[str] = ...): ...
...
class Function:
    def __init__(self, name: str): ...
    def invoke(*args: Value) -> _ValueOrNative: ...
...
class FinishBreakpoint(Breakpoint):
    ...
    def __init__(self, frame: Frame = ..., internal: bool = ...): ...
