...
class Value:
    ...
    def __lt__(self, other: _ValueOrInt) -> bool: ...  # type: ignore[override]
    def __le__(self, other: _ValueOrInt) -> bool: ...  # type: ignore[override]
    def __gt__(self, other: _ValueOrInt) -> bool: ...  # type: ignore[override]
    def __ge__(self, other: _ValueOrInt) -> bool: ...  # type: ignore[override]
