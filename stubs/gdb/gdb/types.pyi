...
def get_basic_type(type: gdb.Type) -> gdb.Type: ...
def has_field(type: gdb.Type, field: str) -> bool: ...
def make_enum_dict(type: gdb.Type) -> dict[str, int]: ...
def deep_items(type: gdb.Type) -> Iterator[tuple[str, gdb.Field]]: ...
