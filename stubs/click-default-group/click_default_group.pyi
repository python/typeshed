...
class DefaultGroup(click.Group):
    ...
    def __init__(
        ...
        *,
        ...
        chain: bool = False,
        result_callback: Callable[..., Any] | None = None,  # Any is specified in click lib, and next also
...
class DefaultCommandFormatter:
    ...
    def __getattr__(self, attr: str) -> Any: ...  # return type depends on click.HelpFormatter attribute
