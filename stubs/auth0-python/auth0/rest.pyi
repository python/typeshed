...
class RestClient:
    ...
    def file_post(self, url: str, data: RequestData | None = None, files: dict[str, Incomplete] | None = None) -> Incomplete: ...
    def patch(self, url: str, data: RequestData | None = None) -> Incomplete: ...
    def put(self, url: str, data: RequestData | None = None) -> Incomplete: ...
    def delete(self, url: str, params: dict[str, Incomplete] | None = None, data: RequestData | None = None) -> Incomplete: ...

class Response:
    def __init__(self, status_code: int, content: Incomplete, headers: Mapping[str, str]) -> None: ...
