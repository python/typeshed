...
class AuthenticationBase:
    ...
    protocol: Incomplete
    client: Incomplete
    def __init__(self, domain: str, client_id: str, client_secret: str | None = None, client_assertion_signing_key: str | None = None, client_assertion_signing_alg: str | None = None, telemetry: bool = True, timeout: TimeoutType = 5.0, protocol: str = 'https') -> None: ...
