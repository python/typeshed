...
class AuthenticationBase:
    ...
    def post(self, url: str, data: RequestData | None = None, headers: dict[str, str] | None = None) -> Incomplete: ...
    def authenticated_post(self, url: str, data: dict[str, Incomplete], headers: dict[str, str] | None = None) -> Incomplete: ...
    def get(self, url: str, params: dict[str, Incomplete] | None = None, headers: dict[str, str] | None = None) -> Incomplete: ...
