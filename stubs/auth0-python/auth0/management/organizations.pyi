...
class Organizations:
    ...
    def delete_organization(self, id: str) -> Incomplete: ...
    async def delete_organization_async(self, id: str) -> Incomplete: ...
    ...
    async def update_organization_connection_async(self, id: str, connection_id: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
    def delete_organization_connection(self, id: str, connection_id: str) -> Incomplete: ...
    async def delete_organization_connection_async(self, id: str, connection_id: str) -> Incomplete: ...
    ...
    def delete_organization_members(self, id: str, body: dict[str, Incomplete]) -> Incomplete: ...
    async def delete_organization_members_async(self, id: str, body: dict[str, Incomplete]) -> Incomplete: ...
    ...
    async def create_organization_member_roles_async(self, id: str, user_id: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
    def delete_organization_member_roles(self, id: str, user_id: str, body: dict[str, Incomplete]) -> Incomplete: ...
    async def delete_organization_member_roles_async(self, id: str, user_id: str, body: dict[str, Incomplete]) -> Incomplete: ...
    ...
    def delete_organization_invitation(self, id: str, invitation_id: str) -> Incomplete: ...
    async def delete_organization_invitation_async(self, id: str, invitation_id: str) -> Incomplete: ...
