...
class Branding:
    ...
    def delete_template_universal_login(self) -> Incomplete: ...
    async def delete_template_universal_login_async(self) -> Incomplete: ...
    ...
    def delete_branding_theme(self, theme_id: str) -> Incomplete: ...
    async def delete_branding_theme_async(self, theme_id: str) -> Incomplete: ...
