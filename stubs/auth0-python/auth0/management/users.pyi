...
class Users:
    ...
    def delete_user_authentication_methods(self, id: str): ...
    async def delete_user_authentication_methods_async(self, id: str): ...
    def delete_user_authentication_method(self, id: str, auth_method_id: str): ...
    async def delete_user_authentication_method_async(self, id: str, auth_method_id: str): ...
