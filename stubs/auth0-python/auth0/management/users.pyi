...
class Users:
    ...
    def get(self, id: str, fields: _list[str] | None = None, include_fields: bool = True) -> dict[str, Any]: ...
    async def get_async(self, id: str, fields: _list[str] | None = None, include_fields: bool = True) -> dict[str, Any]: ...
    ...
    def list_organizations(self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True) -> dict[str, Any]: ...
    ...
    def remove_roles(self, id: str, roles: _list[str]) -> Any: ...
    async def remove_roles_async(self, id: str, roles: _list[str]) -> Any: ...
    def add_roles(self, id: str, roles: _list[str]) -> dict[str, Any]: ...
    async def add_roles_async(self, id: str, roles: _list[str]) -> dict[str, Any]: ...
    def list_permissions(self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True) -> dict[str, Any]: ...
    async def list_permissions_async(
        self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True
    ) -> dict[str, Any]: ...
    def remove_permissions(self, id: str, permissions: _list[str]) -> Any: ...
    async def remove_permissions_async(self, id: str, permissions: _list[str]) -> Any: ...
    def add_permissions(self, id: str, permissions: _list[str]) -> dict[str, Any]: ...
    async def add_permissions_async(self, id: str, permissions: _list[str]) -> dict[str, Any]: ...
    ...
    def link_user_account(self, user_id: str, body: dict[str, Any]) -> _list[dict[str, Any]]: ...
    async def link_user_account_async(self, user_id: str, body: dict[str, Any]) -> _list[dict[str, Any]]: ...
