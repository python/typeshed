...
class Users:
    ...
    async def get_async(self, id: str, fields: _list[str] | None = None, include_fields: bool = True) -> dict[str, Incomplete]: ...
    ...
    def list_organizations(self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True) -> dict[str, Incomplete]: ...
    ...
    async def unlink_user_account_async(self, user_id: str, provider: str, secondary_user_id: str) -> _list[dict[str, Incomplete]]: ...
    ...
    def get_log_events(self, id: str, page: int = 0, per_page: int = 50, sort: str | None = None, include_totals: bool = True) -> dict[str, Incomplete]: ...
    async def get_log_events_async(self, id: str, page: int = 0, per_page: int = 50, sort: str | None = None, include_totals: bool = True) -> dict[str, Incomplete]: ...
    ...
    async def get_authentication_method_by_id_async(self, user_id: str, authentication_method_id: str) -> dict[str, Incomplete]: ...
    ...
    def list_user_authentication_methods(self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True) -> dict[str, Incomplete]: ...
    async def list_user_authentication_methods_async(self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True) -> dict[str, Incomplete]: ...
    ...
    def update_user_authentication_methods(self, id: str, auth_method_id: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
    async def update_user_authentication_methods_async(self, id: str, auth_method_id: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
