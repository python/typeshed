...
class Actions:
    ...
    def delete_action(self, id: str, force: bool = False) -> Incomplete: ...
    async def delete_action_async(self, id: str, force: bool = False) -> Incomplete: ...
    ...
    def get_action_version(self, id: str, version_id: str) -> dict[str, Incomplete]: ...
    async def get_action_version_async(self, id: str, version_id: str) -> dict[str, Incomplete]: ...
    def deploy_action(self, id: str) -> dict[str, Incomplete]: ...
    async def deploy_action_async(self, id: str) -> dict[str, Incomplete]: ...
    def rollback_action_version(self, id: str, version_id: str) -> dict[str, Incomplete]: ...
    async def rollback_action_version_async(self, id: str, version_id: str) -> dict[str, Incomplete]: ...
    ...
    def deploy_draft_version(self, id: str) -> dict[str, Incomplete]: ...
    async def deploy_draft_version_async(self, id: str) -> dict[str, Incomplete]: ...
    def get_bindings(self, trigger_id: str, page: int | None = None, per_page: int | None = None) -> dict[str, Incomplete]: ...
    async def get_bindings_async(self, trigger_id: str, page: int | None = None, per_page: int | None = None) -> dict[str, Incomplete]: ...
    def update_bindings(self, trigger_id: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
    async def update_bindings_async(self, trigger_id: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
