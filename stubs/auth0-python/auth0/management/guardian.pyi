...
class Guardian:
    ...
    def delete_enrollment(self, id: str) -> Incomplete: ...
    async def delete_enrollment_async(self, id: str) -> Incomplete: ...
    ...
    async def update_factor_providers_async(self, factor_name: str, name: str, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
