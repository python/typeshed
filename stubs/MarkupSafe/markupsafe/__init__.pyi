...
class Markup(text_type):
    ...
    def split(self, sep: text_type | None = ..., maxsplit: SupportsIndex = ...) -> list[Markup]: ...  
    def rsplit(self, sep: text_type | None = ..., maxsplit: SupportsIndex = ...) -> list[Markup]: ...  
    def splitlines(self, keepends: bool = ...) -> list[Markup]: ...  
