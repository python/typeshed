...
from typing import Any, Callable, Iterable, Mapping, NoReturn, Optional, Sequence, Tuple, TypeVar, Union
...
def augment_usage_errors(ctx: Context, param: Parameter | None = ...) -> AbstractContextManager[None]: ...
...
class Context:
    ...
    def scope(self, cleanup: bool = ...) -> AbstractContextManager[Context]: ...
