...
from typing import IO, Any, BinaryIO, Iterable, Mapping, Text
...
class CliRunner:
    ...
    ) -> AbstractContextManager[tuple[io.BytesIO, io.BytesIO | Literal[False]]]: ...
    def invoke(
        self,
        cli: BaseCommand,
    ...
    def isolated_filesystem(self) -> AbstractContextManager[str]: ...
