...
positionals: tuple[
    Literal[_ParameterKind.POSITIONAL_ONLY],
...
def parse_address(netloc: str, default_port: str = "8000") -> str | int | tuple[LiteralString, int]: ...
...
def import_app(module: str) -> WSGIApp: ...
def getcwd() -> str: ...
...
def make_fail_app(msg: str) -> WSGIApp: ...
