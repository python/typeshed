...
def aliased_parameter(
    name: str, *aliases: str, removed_in_version: str | None, position: int | None = ..., raise_on_multiple: bool = ...
) -> Callable[..., Any]: ...
def generate_parameter_deprecation_message(
    to_be_removed_in_version: str, old_parameter_name: str, new_parameter_name: str | None = ..., extra_notes: str | None = ...
) -> str: ...
def generate_method_deprecation_message(
    to_be_removed_in_version: str, old_method_name: str, method_name: str | None = ..., module_name: str | None = ...
) -> str: ...
def generate_property_deprecation_message(
    to_be_removed_in_version: str, old_name: str, new_name: str, new_attribute: str, module_name: str = ...
) -> str: ...
def getattr_with_deprecated_properties(obj: object, item: str, deprecated_properties: dict[str, _DeprecateProperty]) -> Any: ...
def deprecated_method(to_be_removed_in_version: str, new_method: Callable[..., Any] | None = ...) -> Callable[..., Any]: ...
