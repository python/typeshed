...
class EncodingDetector:
    ...
    def __init__(self, markup, override_encodings: Any | None = ..., is_html: bool = ..., exclude_encodings: Any | None = ...) -> None: ...
    @property
...
class UnicodeDammit:
    ...
    def __init__(self, markup, override_encodings=..., smart_quotes_to: Any | None = ..., is_html: bool = ..., exclude_encodings=...) -> None: ...
    @property
