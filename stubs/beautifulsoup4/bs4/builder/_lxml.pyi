...
class LXMLTreeBuilderForXML(TreeBuilder):
    ...
    def prepare_markup(  # the order of the parameters is different
        self,
        markup,
...
class LXMLTreeBuilder(HTMLTreeBuilder, LXMLTreeBuilderForXML):  # argument disparities between base classes
    NAME: Any
    ALTERNATE_NAMES: Any
    features: Any
    is_xml: bool
