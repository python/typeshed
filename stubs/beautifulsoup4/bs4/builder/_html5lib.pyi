...
class HTML5TreeBuilder(HTMLTreeBuilder):
    ...
    def prepare_markup(  # type: ignore[override]  # user_specified_encoding doesn't have a default
        self, markup, user_specified_encoding, document_declared_encoding: Incomplete | None = ..., exclude_encodings: Incomplete | None = ...
    ) -> None: ...
...
class TreeBuilderForHtml5lib(treebuilder_base.TreeBuilder):
    ...
    def __init__(self, namespaceHTMLElements, soup: Incomplete | None = ..., store_line_numbers: bool = ..., **kwargs) -> None: ...
