...
class Tag(PageElement):
    ...
    def encode(
        self, encoding: str = 'utf-8', indent_level: int | None = None, formatter: str | Formatter = 'minimal', errors: str = 'xmlcharrefreplace'
    ) -> bytes: ...
    def decode(self, indent_level: int | None = None, eventual_encoding: str = 'utf-8', formatter: str | Formatter = 'minimal') -> str: ...
    @overload
    ...
    def encode_contents(self, indent_level: int | None = None, encoding: str = 'utf-8', formatter: str | Formatter = 'minimal') -> bytes: ...
