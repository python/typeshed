...
class RelativeLengthInMath(ValueError): ...
...
def get_single_keyword(tokens: Sequence[_Token]) -> Incomplete | None: ...
...
def comma_separated_list(function: Callable[Concatenate[Sequence[_Token], _P], _T]) -> Callable[Concatenate[Sequence[_Token], _P], tuple[_T, ...] | None]: ...
