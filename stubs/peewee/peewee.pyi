...
from typing import Any, ClassVar, NamedTuple, TypeVar, Type
...
class Database(_callable_context_manager):
    ...
    def get_indexes(self, table, schema: str | None = None) -> None: ...
    def get_columns(self, table, schema: str | None = None) -> None: ...
    def get_primary_keys(self, table, schema: str | None = None) -> None: ...
    def get_foreign_keys(self, table, schema: str | None = None) -> None: ...
