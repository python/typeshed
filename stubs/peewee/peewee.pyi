...
# __set__/__get__ value types. Bare Field defaults to Field[Any, Any].
...
class Field(ColumnBase, Generic[_S, _G]):
    @overload
    def __get__(self, instance: None, owner: Any) -> Self: ...
    @overload
    def __get__(self, instance: object, owner: Any) -> _G: ...

    def __set__(self, instance: object, value: _S) -> None: ...
...
class IntegerField(Field[_S, _G]):
    @overload
    def __new__(cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]) -> IntegerField[int | None, int | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> IntegerField[int, int]: ...

    def adapt(self, value): ...

class BigIntegerField(IntegerField[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> BigIntegerField[int | None, int | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> BigIntegerField[int, int]: ...

class SmallIntegerField(IntegerField[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> SmallIntegerField[int | None, int | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> SmallIntegerField[int, int]: ...

class AutoField(IntegerField[_S, _G]):
    auto_increment: bool
    def __new__(cls, *args: Any, **kwargs: Unpack[_FieldKwargs]) -> AutoField[int, int]: ...

class BigAutoField(AutoField[_S, _G]):
    def __new__(cls, *args: Any, **kwargs: Unpack[_FieldKwargs]) -> BigAutoField[int, int]: ...

class IdentityField(AutoField[_S, _G]):
    def __new__(cls, *args: Any, **kwargs: Unpack[_FieldKwargs]) -> IdentityField[int, int]: ...

class PrimaryKeyField(AutoField[_S, _G]):
    def __new__(cls, *args: Any, **kwargs: Unpack[_FieldKwargs]) -> PrimaryKeyField[int, int]: ...

class FloatField(Field[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> FloatField[float | None, float | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> FloatField[float, float]: ...

    def adapt(self, value): ...

class DoubleField(FloatField[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> DoubleField[float | None, float | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> DoubleField[float, float]: ...

class DecimalField(Field[_S, _G]):
    ...
    ) -> DecimalField[Decimal | None, Decimal | None]: ...
    @overload
    def __new__(
        cls,
        max_digits: int = ...,
...
class FixedCharField(CharField[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> FixedCharField[str | None, str | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> FixedCharField[str, str]: ...

    def adapt(self, value) -> str: ...

class TextField(_StringField[_S, _G]):
    @overload
    def __new__(cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]) -> TextField[str | None, str | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> TextField[str, str]: ...

class FieldDatabaseHook:
    def bind(self, model, name, set_attribute: bool = True): ...

class BlobField(FieldDatabaseHook, Field[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> BlobField[bytes | None, bytes | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> BlobField[bytes, bytes]: ...
...
class BitField(BitwiseMixin, BigIntegerField[_S, _G]):
    def __new__(cls, *args: Any, **kwargs: Unpack[_FieldKwargs]) -> BitField[int, int]: ...
...
class BigBitField(BlobField[_S, _G]):
    accessor_class: Incomplete
    def __new__(cls, *args: Any, **kwargs: Unpack[_FieldKwargs]) -> BigBitField[bytes, BigBitFieldData]: ...
    def db_value(self, value): ...

class UUIDField(Field[_S, _G]):
    @overload
    def __new__(cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]) -> UUIDField[UUID | None, UUID | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> UUIDField[UUID, UUID]: ...

    def db_value(self, value): ...
    def python_value(self, value) -> UUID | None: ...

class BinaryUUIDField(BlobField[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> BinaryUUIDField[UUID | None, UUID | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> BinaryUUIDField[UUID, UUID]: ...

    def db_value(self, value): ...
    def python_value(self, value) -> UUID | None: ...

class _BaseFormattedField(Field[_S, _G]):
    formats: Incomplete
    def __init__(self, formats=None, *args, **kwargs) -> None: ...

class DateTimeField(_BaseFormattedField[_S, _G]):
    @overload
    def __new__(
        cls, formats: Any = ..., *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> DateTimeField[datetime | None, datetime | None]: ...
    @overload
    def __new__(
...
class DateField(_BaseFormattedField[_S, _G]):
    @overload
    def __new__(
        cls, formats: Any = ..., *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> DateField[date | None, date | None]: ...
    @overload
    def __new__(
        cls, formats: Any = ..., *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]
    ) -> DateField[date, date]: ...
...
class TimeField(_BaseFormattedField[_S, _G]):
    @overload
    def __new__(
        cls, formats: Any = ..., *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> TimeField[time | None, time | None]: ...
    @overload
    def __new__(
        cls, formats: Any = ..., *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]
    ) -> TimeField[time, time]: ...
...
class TimestampField(BigIntegerField[_S, _G]):
    ...
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> TimestampField[datetime | None, datetime | None]: ...
    @overload
    def __new__(
        cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]
    ) -> TimestampField[datetime, datetime]: ...
...
class IPField(BigIntegerField[_S, _G]):
    @overload
    def __new__(cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]) -> IPField[str | None, str | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> IPField[str, str]: ...

    def db_value(self, val): ...
    def python_value(self, val) -> str | None: ...

class BooleanField(Field[_S, _G]):
    @overload
    def __new__(
        cls, *args: Any, null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> BooleanField[bool | None, bool | None]: ...
    @overload
    def __new__(cls, *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]) -> BooleanField[bool, bool]: ...
...
class ForeignKeyField(Field[_S, _G]):
    accessor_class: Incomplete
    ...
    ) -> ForeignKeyField[_M | None, _M | None]: ...
    @overload
    def __new__(
        cls, model: type[_M], *args: Any, null: Literal[False] = ..., **kwargs: Unpack[_FKKwargs]
    ) -> ForeignKeyField[_M, _M]: ...
    @overload
    def __new__(cls, model: Any = ..., *args: Any, **kwargs: Unpack[_FKKwargs]) -> ForeignKeyField[Any, Any]: ...
