...
class Source(Node):
    ...
    def alias(self, name) -> Self: ...  # type: ignore[misc]
...
class BaseQuery(Node):
    ...
    def objects(self, constructor: Incomplete | None = ...) -> Self: ...  # type: ignore[misc]
    def __sql__(self, ctx) -> None: ...
    def sql(self): ...
...
class Select(SelectBase):
    ...
    def left_outer_join(self, dest, on: Incomplete | None = ...): ...
    def group_by(self, *columns) -> Self: ...  # type: ignore[misc]
