...
class BitwiseMixin:
    def __and__(self: Self, other: Any) -> Expression: ...
    def __or__(self: Self, other: Any) -> Expression: ...
    def __sub__(self: Self, other: Any) -> Expression: ...
    def __invert__(self: Self) -> BitwiseNegated: ...
