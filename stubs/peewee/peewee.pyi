...
class Function(ColumnBase):
    ...
    def __init__(
        self, name: str, arguments: tuple[Incomplete, ...], coerce: bool = ..., python_value: _ConvFunc | None = ...
    ): ...
...
class Database(_callable_context_manager):
    ...
    def execute_sql(
        self, sql: str, params: tuple[Incomplete, ...] | None = ..., commit: bool | _TSentinel = ...
    ) -> __ICursor: ...
...
class ManyToManyFieldAccessor(FieldAccessor):
    ...
    @overload
    def __get__(
        self, instance: _T, instance_type: type[Incomplete] = ..., force_query: bool = ...
    ) -> list[str] | ManyToManyQuery: ...
...
class Metadata:
    ...
    def get_rel_for_model(
        self, model: type[Model] | ModelAlias[Incomplete]
    ) -> tuple[list[ForeignKeyField], list[type[Model]]]: ...
...
class ModelCursorWrapper(BaseModelCursorWrapper[_ModelT]):
    ...
    src_to_dest: list[
        tuple[Incomplete, Incomplete, Incomplete, bool, Incomplete]
    ]  # TODO -- tuple[<from list type>, join_type[1], join_type[0], bool, join_type[3]]
