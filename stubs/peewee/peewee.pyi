...
class Function(ColumnBase):
    name: str
    arguments: tuple
    def __init__(self, name: str, arguments: tuple, coerce: bool = ..., python_value: _ConvFunc | None = ...): ...
...
class Database(_callable_context_manager):
    ...
    def get_sql_context(self, **context_options: object) -> _ContextClassT: ...
...
class ForeignKeyAccessor(FieldAccessor):
    ...
    def __set__(self, instance: _ModelT, obj: object) -> None: ...
...
class VirtualField(MetaField, Generic[_FieldT]):
    ...
    def __init__(self, field_class: type[_FieldT] | None = ..., *args: object, **kwargs: object): ...
    def db_value(self, value: object) -> Any: ...
    def python_value(self, value: object) -> Any: ...
    def bind(self, model: type[Model], name: str, set_attribute: bool = ...) -> None: ...
...
_TModelOrTable: TypeAlias = Union[type[Model], ModelAlias, Table]
...
class ModelRaw(_ModelQueryHelper, RawQuery, Generic[_ModelT]):
    model: type[_ModelT]
    def __init__(self, model: type[_ModelT], sql: str, params: tuple, **kwargs: object): ...
