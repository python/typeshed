...
class State:
    def __new__(cls, scope=1, parentheses: bool = False, **kwargs): ...
...
class Node:
    ...
    @staticmethod
    def copy(method): ...
    def coerce(self, _coerce: bool = True): ...
    def is_alias(self): ...
    def unwrap(self): ...
...
class Source(Node):
    ...
    def join(self, dest, join_type="INNER JOIN", on=None): ...
    def left_outer_join(self, dest, on=None): ...
    def cte(self, name, recursive: bool = False, columns=None, materialized=None): ...
...
class Select(SelectBase):
    ...
    def join(self, dest, join_type="INNER JOIN", on=None) -> Self: ...
    def left_outer_join(self, dest, on=None): ...
...
class Database(_callable_context_manager):
    ...
    def bind_ctx(self, models: Iterable[type[Model]], bind_refs: bool = True, bind_backrefs: bool = True): ...
...
class Field(ColumnBase):
    ...
    def to_value(self, value, case: bool = False): ...
    def get_sort_key(self, ctx): ...
    def __sql__(self, ctx): ...
...
class Metadata:
    ...
    def model_graph(self, refs: bool = True, backrefs: bool = True, depth_first: bool = True): ...
...
class Model(metaclass=ModelBase):
    ...
    @classmethod
    def insert(cls, data=None, /, **insert): ...
    @classmethod
    ...
    def __sql__(self, ctx): ...
    @classmethod
    def bind(cls, database, bind_refs: bool = True, bind_backrefs: bool = True, _exclude=None): ...
    @classmethod
    def bind_ctx(cls, database, bind_refs: bool = True, bind_backrefs: bool = True): ...
    @classmethod
...
class ModelSelect(BaseModelSelect, Select):  # type: ignore[misc]
    ...
    def join(self, dest, join_type="INNER JOIN", on=None, src=None, attr=None) -> Self: ...
    def left_outer_join(self, dest, on=None, src=None, attr=None): ...
    def join_from(self, src, dest, join_type="INNER JOIN", on=None, attr=None): ...
