...
_ContextClassT = TypeVar("_ContextClassT", bound=Context)
_FieldT = TypeVar("_FieldT", bound=Field)
_NodeT = TypeVar("_NodeT", bound=Node)
_P = ParamSpec("_P")

_ConvFunc: TypeAlias = Callable[[Any], Any]
...
class __ICursor(Protocol):
    ...
    rowcount: int
    def fetchone(self) -> tuple[Incomplete, ...] | None: ...
    def fetchmany(self, size: int = ...) -> Iterable[tuple[Incomplete, ...]]: ...
    def fetchall(self) -> Iterable[tuple[Incomplete, ...]]: ...
...
class __ITableFunction(Protocol):
    ...
    def iterate(self, idx: int) -> tuple[Incomplete, ...]: ...
    @classmethod
...
SNAKE_CASE_STEP1: Pattern[str]
SNAKE_CASE_STEP2: Pattern[str]

MODEL_BASE: str

# TODO (dargueta)
class _callable_context_manager:
    def __call__(self, fn: _FuncT) -> _FuncT: ...

class Proxy:
    obj: Any
    def initialize(self, obj: object) -> None: ...
    def attach_callback(self, callback: _ConvFunc) -> _ConvFunc: ...
    @staticmethod  # This is technically inaccurate but that's how it's used
    def passthrough(method: _FuncT) -> _FuncT: ...
...
class Context:
    ...
    def value(self, value: object, converter: _ConvFunc | None = ..., add_param: bool = ...) -> Context: ...
    def __sql__(self, ctx: Context) -> Context: ...
    def parse(self, node: Node) -> tuple[str, tuple[Incomplete, ...] | None]: ...
    def query(self) -> tuple[str, tuple[Incomplete, ...] | None]: ...
...
class ColumnBase(Node):
    _converter: _ConvFunc | None
    def converter(self: Self, converter: _ConvFunc | None = ...) -> Self: ...
    @overload
    ...
    def __invert__(self) -> WrappedNode[Incomplete]: ...
...
class WrappedNode(ColumnBase, Generic[_NodeT]):
    node: _NodeT
    _coerce: bool
    _converter: _ConvFunc | None
    def __init__(self, node: _NodeT): ...
    def is_alias(self) -> bool: ...
    def unwrap(self) -> _NodeT: ...
...
class Alias(WrappedNode[Incomplete]):
...
class Negated(WrappedNode[Incomplete]):
...
class BitwiseNegated(BitwiseMixin, WrappedNode[Incomplete]):
    def __invert__(self) -> Node: ...
    def __sql__(self, ctx: Context) -> Context: ...

class Value(ColumnBase):
    value: object
    converter: _ConvFunc | None
    multi: bool
    def __init__(self, value: object, converter: _ConvFunc | None = ..., unpack: bool = ...): ...
    def __sql__(self, ctx: Context) -> Context: ...

def AsIs(value: object) -> Value: ...

class Cast(WrappedNode[Incomplete]):
    def __init__(self, node: Node, cast: str): ...
    def __sql__(self, ctx: Context) -> Context: ...

class Ordering(WrappedNode[Incomplete]):
    direction: str
    collation: str | None
    nulls: str | None
...
class _SupportsSQLOrdering(Protocol):
    def __call__(self, node: Node, collation: str | None = ..., nulls: str | None = ...) -> Ordering: ...
...
class Function(ColumnBase):
    name: str
    arguments: tuple[Incomplete, ...]
    def __init__(self, name: str, arguments: tuple[Incomplete, ...], coerce: bool = ..., python_value: _ConvFunc | None = ...): ...
    ...
    def python_value(self: Self, func: _ConvFunc | None = ...) -> Self: ...
    def over(
        self,
...
class QualifiedNames(WrappedNode[Incomplete]):
    def __sql__(self, ctx: Context) -> Context: ...
...
class BaseQuery(Node):
    ...
    def objects(self: Self, constructor: _ConvFunc | None = ...) -> Self: ...
    def __sql__(self, ctx: Context) -> Context: ...
    def sql(self) -> tuple[str, tuple[Incomplete, ...] | None]: ...
    def execute(self, database: Database | None = ...) -> CursorWrapper[Incomplete]: ...
    def iterator(self, database: Database | None = ...) -> Iterator[Incomplete]: ...
...
class RawQuery(BaseQuery):
    ...
    def __init__(self, sql: str | None = ..., params: tuple[Incomplete, ...] | None = ..., **kwargs: object): ...
    def __sql__(self, ctx: Context) -> Context: ...
...
class SelectBase(_HashableSource, Source, SelectQuery):
    ...
    @overload
    def scalar(self, database: Database | None = ..., as_tuple: Literal[True] = ...) -> tuple[Incomplete, ...]: ...
...
class _WriteQuery(Query):
    ...
    def execute_returning(self, database: Database) -> CursorWrapper[Incomplete]: ...
...
class Database(_callable_context_manager):
    context_class: ClassVar[type[Incomplete]]
    ...
    def execute_sql(self, sql: str, params: tuple[Incomplete, ...] | None = ..., commit: bool | _TSentinel = ...) -> __ICursor: ...
    ...
    def get_sql_context(self, **context_options: object): ...
...
class SqliteDatabase(Database):
    ...
    def aggregate(self, name: str | None = ..., num_params: int = ...) -> Callable[[_ClassT], _ClassT]: ...
    def register_collation(self, fn: Callable[..., Incomplete], name: str | None = ...) -> None: ...
    def collation(self, name: str | None = ...) -> Callable[[_FuncT], _FuncT]: ...
    def register_function(self, fn: Callable[Incomplete, ...], name: str | None = ..., num_params: int = ...) -> int: ...
    def func(self, name: str | None = ..., num_params: int = ...) -> Callable[[_FuncT], _FuncT]: ...
    def register_window_function(self, klass: type, name: str | None = ..., num_params: int = ...) -> None: ...
    def window_function(self, name: str | None = ..., num_params: int = ...) -> Callable[[_ClassT], _ClassT]: ...
...
class CursorWrapper(Generic[_T]):
    ...
    def process_row(self, row: tuple[Incomplete, ...]) -> _T: ...
...
class NamedTupleCursorWrapper(CursorWrapper[tuple[Incomplete, ...]]):
    tuple_class: type[tuple[Incomplete, ...]]

class ObjectCursorWrapper(DictCursorWrapper, Generic[_T]):
    constructor: Callable[..., _T]
    def __init__(self, cursor: __ICursor, constructor: Callable[..., _T]) -> None: ...
...
class ForeignKeyAccessor(FieldAccessor):
    ...
    @overload
    def __get__(self, instance: _ModelT, instance_type: type[_ModelT]) -> ForeignKeyField: ...
    def __set__(self, instance: Model, obj: object) -> None: ...
...
class ObjectIdAccessor:
    ...
    @overload
    def __get__(self, instance: _ModelT, instance_type: type[_ModelT] = ...) -> Any: ...
...
class BigBitFieldAccessor(FieldAccessor):
    @overload
    def __get__(self, instance: None, instance_type: type[_ModelT]) -> Field: ...
    @overload
    def __get__(self, instance: _ModelT, instance_type: type[_ModelT]) -> BigBitFieldData: ...
...
def format_date_time(value: str, formats: Iterable[str], post_process: _ConvFunc | None = ...) -> str: ...
@overload
def simple_date_time(value: str) -> datetime.datetime: ...
@overload
...
class BareField(Field):
    ...
    adapt: _ConvFunc | None
    def __init__(self, adapt: _ConvFunc | None = ..., *args: object, **kwargs: object): ...
...
class ManyToManyFieldAccessor(FieldAccessor):
    ...
    def __init__(self, model: type[Model], field: ForeignKeyField, name: str): ...
    @overload
    def __get__(self, instance: None, instance_type: type[Incomplete] = ..., force_query: bool = ...) -> Field: ...
    @overload
    def __get__(self, instance: _T, instance_type: type[Incomplete] = ..., force_query: bool = ...) -> list[str] | ManyToManyQuery: ...
...
class VirtualField(MetaField, Generic[_FieldT]):
    field_class: type[_FieldT]
    field_instance: _FieldT | None
    def __init__(self, field_class: type[Incomplete] | None = ..., *args: object, **kwargs: object): ...
    def db_value(self, value: object) -> Any: ...
    def python_value(self, value: object) -> Any: ...
    def bind(self, model: type[Model], name: str, set_attribute: bool = ...) -> None: ...
...
class CompositeKey(MetaField):
    ...
    @overload
    def __get__(self, instance: _T, instance_type: type[_T]) -> tuple[Incomplete, ...]: ...
    def __set__(self, instance: Model, value: list[Incomplete] | tuple[Incomplete, ...]) -> None: ...
...
class Metadata:
    ...
    def get_rel_for_model(self, model: type[Model] | ModelAlias[Incomplete]) -> tuple[list[ForeignKeyField], list[type[Model]]]: ...
...
class Model(Node, metaclass=ModelBase):
    ...
    @classmethod
    def alias(cls, alias: str | None = ...) -> ModelAlias[Incomplete]: ...
    @classmethod
    def select(cls, *fields: Field) -> ModelSelect[Incomplete]: ...
    @classmethod
    ...
    @overload
    @classmethod
    def insert_many(cls, rows: Iterable[tuple[Incomplete, ...]], fields: Sequence[Field]) -> ModelInsert: ...
    @classmethod
    ...
    @classmethod
    def replace_many(cls, rows: Iterable[tuple[Incomplete, ...]], fields: Sequence[Field] | None = ...) -> OnConflict: ...
    @classmethod
    def raw(cls, sql: str, *params: object) -> ModelRaw[Incomplete]: ...
    @classmethod
    ...
    @classmethod
    def get(cls, *query: object, **filters: object) -> ModelSelect[Incomplete]: ...
    @classmethod
    def get_or_none(cls, *query: object, **filters: object) -> ModelSelect[Incomplete] | None: ...
    @classmethod
    def get_by_id(cls, pk: object) -> ModelSelect[Incomplete]: ...
    # TODO (dargueta) I'm 99% sure of return value for this one
    @classmethod
    def set_by_id(cls, key, value) -> CursorWrapper[Incomplete]: ...
    # TODO (dargueta) I'm also not 100% about this one's return value.
    @classmethod
    def delete_by_id(cls, pk: object) -> CursorWrapper[Incomplete]: ...
    @classmethod
...
class ModelAlias(Node, Generic[_ModelT]):
    model: type[_ModelT]
    alias: str | None
    def __init__(self, model: type[_ModelT], alias: str | None = ...): ...
    def __getattr__(self, attr: str) -> Any: ...
    def __setattr__(self, attr: str, value: object) -> NoReturn: ...
    def get_field_aliases(self) -> list[Field]: ...
    def select(self, *selection: Field) -> ModelSelect[Incomplete]: ...
    def __call__(self, **kwargs) -> _ModelT: ...
    def __sql__(self, ctx: Context) -> Context: ...

_TModelOrTable: TypeAlias = Union[type[Model], ModelAlias[Incomplete], Table]
_TSubquery: TypeAlias = Union[tuple[Query, type[Model]], type[Model], ModelAlias[Incomplete]]
...
class FieldAlias(Field):
    ...
    @classmethod
    def create(cls, source: ModelAlias[Incomplete], field: str) -> FieldAlias: ...
...
class ModelRaw(_ModelQueryHelper, RawQuery, Generic[_ModelT]):
    model: type[_ModelT]
    def __init__(self, model: type[_ModelT], sql: str, params: tuple[Incomplete, ...], **kwargs: object): ...
    def get(self) -> _ModelT: ...

class BaseModelSelect(_ModelQueryHelper):
    def union_all(self, rhs: object) -> ModelCompoundSelectQuery[Incomplete]: ...
    __add__ = union_all
    def union(self, rhs: object) -> ModelCompoundSelectQuery[Incomplete]: ...
    __or__ = union
    def intersect(self, rhs: object) -> ModelCompoundSelectQuery[Incomplete]: ...
    __and__ = intersect
    def except_(self, rhs: object) -> ModelCompoundSelectQuery[Incomplete]: ...
    __sub__ = except_
    def __iter__(self) -> Iterator[Any]: ...
...
class ModelCompoundSelectQuery(BaseModelSelect, CompoundSelectQuery, Generic[_ModelT]):
    model: type[_ModelT]
    def __init__(self, model: type[_ModelT], *args: object, **kwargs: object): ...

class ModelSelect(BaseModelSelect, Select, Generic[_ModelT]):
    model: type[_ModelT]
    def __init__(self, model: type[_ModelT], fields_or_models: Iterable[_TFieldOrModel], is_default: bool = ...): ...
    def clone(self: Self) -> Self: ...
    ...
    def join(  # type: ignore
        self: Self,
        dest: type[Model] | Table | ModelAlias[Incomplete] | ModelSelect[Incomplete],
        join_type: int = ...,
        on: Column | Expression | Field | None = ...,
        src: type[Model] | Table | ModelAlias[Incomplete] | ModelSelect[Incomplete] | None = ...,
        attr: str | None = ...,
    ) -> Self: ...
    def join_from(
        self,
        src: type[Model] | Table | ModelAlias[Incomplete] | ModelSelect[Incomplete],
        dest: type[Model] | Table | ModelAlias[Incomplete] | ModelSelect[Incomplete],
        join_type: int = ...,
        on: Column | Expression | Field | None = ...,
        attr: str | None = ...,
    ) -> ModelSelect[Incomplete]: ...
    def ensure_join(
...
class ManyToManyQuery(ModelSelect[Incomplete]):
    def __init__(
...
class BaseModelCursorWrapper(DictCursorWrapper, Generic[_ModelT]):
    ncols: int
    columns: list[str]
    converters: list[_ConvFunc]
    fields: list[Field]
    model: type[_ModelT]
    select: Sequence[str]
    def __init__(self, cursor: __ICursor, model: type[_ModelT], columns: Sequence[str] | None): ...
    def process_row(self, row: tuple) -> Mapping[str, object]: ...  # type: ignore

class ModelDictCursorWrapper(BaseModelCursorWrapper[_ModelT]):
    def process_row(self, row: tuple[Incomplete, ...]) -> dict[str, Any]: ...

class ModelTupleCursorWrapper(ModelDictCursorWrapper[_ModelT]):
    constructor: ClassVar[Callable[[Sequence[Any]], tuple[Incomplete, ...]]]
    def process_row(self, row: tuple[Incomplete, ...]) -> tuple[Incomplete, ...]: ...  # type: ignore

class ModelNamedTupleCursorWrapper(ModelTupleCursorWrapper[_ModelT]): ...

class ModelObjectCursorWrapper(ModelDictCursorWrapper[_ModelT]):
    constructor: type[_ModelT] | Callable[[Any], _ModelT]
    is_model: bool
...
class ModelCursorWrapper(BaseModelCursorWrapper[_ModelT]):
    # TODO (dargueta) -- Iterable[Union[Join, ...]]
    from_list: Iterable[Incomplete]
    # TODO (dargueta) -- Mapping[<from list type>, tuple[?, ?, Callable[..., _ModelT], int?]]
    joins: Mapping[Hashable, tuple[object, object, Callable[..., _ModelT], int]]
    key_to_constructor: dict[type[_ModelT], Callable[..., _ModelT]]
    src_is_dest: dict[type[Model], bool]
    src_to_dest: list[tuple[Incomplete, Incomplete, Incomplete, bool, Incomplete]]  # TODO -- tuple[<from list type>, join_type[1], join_type[0], bool, join_type[3]]
