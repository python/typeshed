...
class State:
    ...
    scope: Incomplete
    parentheses: bool
    def __init__(self, scope=1, parentheses: bool = False, settings=None) -> None: ...
...
class _ConnectionState:
    ...
    commit_callbacks: list[Incomplete]
    def reset(self) -> None: ...
...
class Database(_callable_context_manager):
    ...
    query_hooks: list[Callable[[QueryEvent], Incomplete]]
    ...
    def get_sql_context(self, **context_options) -> context_class: ...  # pyrefly: ignore [unknown-name]
    ...
    def after_commit(self, fn: Callable[[], _R]) -> Callable[[], _R]: ...
    def atomic(self, *args, **kwargs) -> _atomic: ...
    def manual_commit(self) -> _manual: ...
    def transaction(self, *args, **kwargs) -> _transaction: ...
    def savepoint(self) -> _savepoint: ...
    ...
    def sequence_exists(self, seq, schema: str | None = None) -> bool: ...
    def create_tables(self, models: Iterable[type[_Model]], **options) -> None: ...
    def drop_tables(self, models: Iterable[type[_Model]], **kwargs) -> None: ...
    def extract_date(self, date_part, date_field): ...
    def truncate_date(self, date_part, date_field): ...
    def to_timestamp(self, date_field): ...
    def from_timestamp(self, date_field): ...
    def random(self): ...
    def bind(self, models: Iterable[type[_Model]], bind_refs: bool = True, bind_backrefs: bool = True) -> None: ...
    def bind_ctx(
        self, models: Iterable[type[_Model]], bind_refs: bool = True, bind_backrefs: bool = True
    ) -> _BoundModelsContext: ...
...
class SqliteDatabase(Database):
    ...
    def __init__(
        ...
        database: str | None,
        pragmas=None,
        regexp_function: bool = False,
        rank_functions: bool = False,
        lock_type=None,
        *args,
        **kwargs,
    ) -> None: ...
...
class PostgresqlDatabase(Database):
    ...
    def get_primary_keys(self, table, schema: str | None = None) -> list[Incomplete]: ...
    def get_foreign_keys(self, table, schema: str | None = None) -> list[ForeignKeyMetadata]: ...
    def sequence_exists(self, sequence, schema: str | None = None) -> bool: ...
    def get_binary_type(self) -> type[Incomplete]: ...
