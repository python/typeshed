...
class SqliteDatabase(Database):
    ...
    def register_function(self, fn, name: Incomplete | None = ..., num_params: int = ..., deterministic: bool | None = None) -> None: ...
    def func(self, name: Incomplete | None = ..., num_params: int = ..., deterministic: bool | None = None) -> Callable[[_F], _F]: ...
