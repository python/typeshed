...
class Table(_HashableSource, BaseTable):
    ...
    def bind(self, database: Database | None = ...) -> Table: ...
...
class ColumnBase(Node):
    ...
    def converter(self, converter: _TConvFunc | None = ...) -> ColumnBase: ...
    @overload
...
class Function(ColumnBase):
    ...
    def filter(self, where: Expression | None = ...) -> Function: ...
    def order_by(self, *ordering: Field | Expression) -> Function: ...
    def python_value(self, func: _TConvFunc | None = ...) -> Function: ...
    def over(
        self,
...
class Window(Node):
    ...
    def alias(self, alias: str | None = ...) -> Window: ...
    def as_range(self) -> Window: ...
    def as_rows(self) -> Window: ...
    def as_groups(self) -> Window: ...
    def extends(self, window: Window | WindowAlias | str | None = ...) -> Window: ...
    def exclude(self, frame_exclusion: str | SQL | None = ...) -> Window: ...
    @staticmethod
...
class OnConflict(Node):
    ...
    def update(self, _data: Mapping[str, object] | None = ..., **kwargs: object) -> OnConflict: ...
...
class BaseQuery(Node):
    ...
    def bind(self, database: Database | None = ...) -> BaseQuery: ...
    ...
    def objects(self, constructor: _TConvFunc | None = ...) -> BaseQuery: ...
    def __sql__(self, ctx: Context) -> Context: ...
...
class Query(BaseQuery):
    ...
    def limit(self, value: int | None = ...) -> Query: ...
    def offset(self, value: int | None = ...) -> Query: ...
...
class Select(SelectBase):
    ...
    def columns(self, *columns: Column | Field, **kwargs: object) -> Select: ...
    def select(self, *columns: Column | Field, **kwargs: object) -> Select: ...
    def select_extend(self, *columns) -> Select: ...
    # TODO (dargueta): Is `sources` right?
    def from_(self, *sources: Source | type[Model]) -> Select: ...
    def join(self, dest: type[Model], join_type: int = ..., on: Expression | None = ...) -> Select: ...
    def group_by(self, *columns: Table | Field) -> Select: ...
    def group_by_extend(self, *values: Table | Field) -> Select: ...
    ...
    def for_update(
        self, for_update: bool = ..., of: Table | Iterable[Table] | None = ..., nowait: bool | None = ...
    ) -> Select: ...
...
class _WriteQuery(Query):
    ...
    def returning(self, *returning: type[Model] | Field) -> _WriteQuery: ...
...
class Index(Node):
    ...
    def using(self, _using: str | None = ...) -> Index: ...
    def __sql__(self, ctx: Context) -> Context: ...
...
class _ModelQueryHelper:
    default_row_type: ClassVar[int]
    def objects(self, constructor: Callable[..., Any] | None = ...) -> _ModelQueryHelper: ...
...
class BaseModelSelect(_ModelQueryHelper):
    ...
    def group_by(self, *columns: type[Model] | Table | Field) -> BaseModelSelect: ...
...
class ModelSelect(BaseModelSelect, Select, Generic[_TModel]):
    ...
    def switch(self, ctx: type[Model] | None = ...) -> ModelSelect: ...
