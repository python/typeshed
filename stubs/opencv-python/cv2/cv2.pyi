...
@overload
def findCirclesGrid(
    image: _Mat, patternSize, flags: int, blobDetector, parameters, centers=...
...
def grabCut(
    img: _Mat, mask: _Mat | None, rect, bgdModel, fgdModel, iterCount, mode=...
) -> tuple[_mask, _bgdModel, _fgdModel]: ...
...
def warpPerspective(
    src: _Mat, M, dsize: _Size, _dst: _Mat = ..., _flags: int = ..., _borderMode=..., _borderValue=...
) -> _dst: ...
