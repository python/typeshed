...
def FarnebackOpticalFlow_create(
    numLevels=..., pyrScale=..., fastPyramids=..., winSize=..., numIters=..., polyN=..., polySigma=..., flags: int | None = ...
): ...
...
def SparsePyrLKOpticalFlow_create(winSize=..., maxLevel=..., crit=..., flags: int | None = ..., minEigThreshold=...): ...
...
def calibrateCamera(
    objectPoints, imagePoints, imageSize, cameraMatrix, distCoeffs, rvecs=..., tvecs=..., flags: int | None = ..., criteria=...
...
def findChessboardCorners(image: Mat, patternSize, corners=..., flags: int | None = ...) -> tuple[Incomplete, _corners]: ...
def findChessboardCornersSB(image: Mat, patternSize, corners=..., flags: int | None = ...) -> tuple[Incomplete, _corners]: ...
...
def solvePnP(
    objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec=..., tvec=..., useExtrinsicGuess=..., flags: int | None = ...
