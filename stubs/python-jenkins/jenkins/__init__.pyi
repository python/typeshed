...
class Jenkins:
    ...
    def get_job_info(self, name: str, depth: int = 0, fetch_all_builds: bool = False) -> dict[Any, Any]: ...
    ...
    def get_queue_item(self, number: int, depth: int = 0) -> dict[Any, Any]: ...
    def get_build_info(self, name: str, number: int, depth: int = 0) -> dict[Any, Any]: ...
    def get_build_env_vars(self, name: str, number: int, depth: int = 0) -> dict[Any, Any] | None: ...
    def get_build_test_report(self, name: str, number: int, depth: int = 0) -> dict[Any, Any] | None: ...
    def get_build_artifact(self, name: str, number: int, artifact: str) -> dict[Any, Any]: ...
    def get_build_artifact_as_bytes(self, name: str, number: int, artifact: str) -> bytes: ...
    def get_build_stages(self, name: str, number: int) -> dict[Any, Any]: ...
    def get_queue_info(self) -> dict[Any, Any]: ...
    def cancel_queue(self, id: int) -> None: ...
    def get_info(self, item: str = "", query: str | None = None) -> dict[Any, Any]: ...
    def get_whoami(self, depth: int = 0) -> dict[Any, Any]: ...
    def get_version(self) -> str: ...
    def get_plugins_info(self, depth: int = 2) -> dict[Any, Any]: ...
    def get_plugin_info(self, name: str, depth: int = 2) -> dict[Any, Any]: ...
    def get_plugins(self, depth: int = 2) -> dict[Any, Any]: ...
    def get_jobs(
    ...
    @overload
    def build_job_url(self, name: str, parameters: dict[str, Any] | list[tuple[str, Any]] | None, token: str) -> str: ...
    @overload
    def build_job_url(
    ...
    @overload
    def build_job(self, name: str, parameters: dict[str, Any] | list[tuple[str, Any]] | None, token: str) -> int: ...
    @overload
    ...
    def get_nodes(self, depth: int = 0) -> list[dict[str, Any]]: ...
    def get_node_info(self, name: str, depth: int = 0) -> dict[str, Any]: ...
    ...
    def get_views(self) -> list[dict[Any, Any]]: ...
    ...
    def get_promotions_info(self, job_name: str, depth: int = 0) -> dict[str, Any]: ...
    def get_promotions(self, job_name: str) -> list[dict[str, Any]]: ...
    ...
    def get_credential_info(self, name: str, folder_name: str, domain_name: str = "_") -> dict[Any, Any]: ...
    ...
    def list_credentials(self, folder_name: str, domain_name: str = "_") -> list[Any]: ...
