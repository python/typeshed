...
class ChannelzServicer(_channelz_pb2_grpc.ChannelzServicer):
    @staticmethod
    def GetTopChannels(request: _channelz_pb2.GetTopChannelsRequest, context: ServicerContext) -> _channelz_pb2.GetTopChannelsResponse:
        ...
    ...
    @staticmethod
    def GetServerSockets(request: _channelz_pb2.GetServerSocketsRequest, context: ServicerContext) -> _channelz_pb2.GetServerSocketsResponse:
        ...
    ...
    @staticmethod
    def GetSubchannel(request: _channelz_pb2.GetSubchannelRequest, context: ServicerContext) -> _channelz_pb2.GetSubchannelResponse:
        ...
