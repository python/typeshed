...
# Note: Don't use these, use `int` instead. Or an overload with a deprecation message.
...
class PyIStream:
    ...
    def write(self, data: str, /) -> None: ...
    def Seek(self, offset, origin, /) -> int: ...
    def SetSize(self, newSize: ULARGE_INTEGER, /) -> None: ...
    def CopyTo(self, stream: PyIStream, cb: ULARGE_INTEGER, /) -> int: ...
