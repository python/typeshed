...
class PyNETRESOURCE:
    ...
    @dwScope.setter
    def dwScope(self, value: int | bool) -> None: ...
    @property
    def dwType(self) -> int: ...
    @dwType.setter
    def dwType(self, value: int | bool) -> None: ...
    @property
    def dwDisplayType(self) -> int: ...
    @dwDisplayType.setter
    def dwDisplayType(self, value: int | bool) -> None: ...
    @property
    def dwUsage(self) -> int: ...
    @dwUsage.setter
    def dwUsage(self, value: int | bool) -> None: ...
    lpComment: str | None
