...
def FindWindow(_ClassName: _win32typing.PyResourceId | str | None, _WindowName: str | None) -> int: ...
def FindWindowEx(
    _Parent: int | None, _ChildAfter: int | None, _ClassName: _win32typing.PyResourceId | str, _WindowName: str
) -> int: ...
...
def IsWindowVisible(_hwnd: int | None) -> int: ...
def IsWindowEnabled(_hwnd: int | None) -> int: ...
...
def GetWindowPlacement(_hwnd: int) -> tuple[int, int, tuple[int, int], tuple[int, int], tuple[int, int, int, int]]: ...
...
def GetMenuItemRect(_hWnd: int | None, _hMenu: int | None, _uItem: int) -> tuple[int, tuple[int, int, int, int]]: ...
