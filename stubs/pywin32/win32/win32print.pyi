...
def OpenPrinter(printer: str, Defaults: _win32typing.PRINTER_DEFAULTS | None = None, /) -> _win32typing.PyPrinterHANDLE: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, /) -> _win32typing.PRINTER_INFO_2_TUPLE: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[1], /) -> _win32typing.PRINTER_INFO_1: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[2], /) -> _win32typing.PRINTER_INFO_2: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[3], /) -> _win32typing.PRINTER_INFO_3: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[4], /) -> _win32typing.PRINTER_INFO_4: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[5], /) -> _win32typing.PRINTER_INFO_5: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[6], /) -> _win32typing.PRINTER_INFO_6: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[7], /) -> _win32typing.PRINTER_INFO_7: ...
@overload
def GetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[8, 9], /) -> _win32typing.PRINTER_INFO_8_9: ...
@overload
def SetPrinter(hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[0], pPrinter: int | None, Command: int, /) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[2], pPrinter: _win32typing.PRINTER_INFO_2, Command: Literal[0], /
) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[3], pPrinter: _win32typing.PRINTER_INFO_3, Command: Literal[0], /
) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[4], pPrinter: _win32typing.PRINTER_INFO_4, Command: Literal[0], /
) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[5], pPrinter: _win32typing.PRINTER_INFO_5, Command: Literal[0], /
) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[6], pPrinter: _win32typing.PRINTER_INFO_6, Command: Literal[0], /
) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[7], pPrinter: _win32typing.PRINTER_INFO_7, Command: Literal[0], /
) -> None: ...
@overload
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level: Literal[8, 9], pPrinter: _win32typing.PRINTER_INFO_8_9, Command: Literal[0], /
) -> None: ...
...
@overload
def EnumPrinters(
    flags: int, name: str | None = None, level: Literal[1] = 1, /
) -> tuple[_win32typing.PRINTER_INFO_1_TUPLE, ...]: ...
@overload
def EnumPrinters(flags: int, name: str | None, level: Literal[2], /) -> tuple[_win32typing.PRINTER_INFO_2, ...]: ...
@overload
def EnumPrinters(flags: int, name: str | None, level: Literal[4], /) -> tuple[_win32typing.PRINTER_INFO_4, ...]: ...
@overload
def EnumPrinters(flags: int, name: str | None, level: Literal[5], /) -> tuple[_win32typing.PRINTER_INFO_5, ...]: ...
...
) -> tuple[_win32typing.JOB_INFO_1, ...]: ...
@overload
def EnumJobs(
    hPrinter: _win32typing.PyPrinterHANDLE, FirstJob: int, NoJobs: int, Level: Literal[2], /
) -> tuple[_win32typing.JOB_INFO_2, ...]: ...
@overload
def EnumJobs(
    hPrinter: _win32typing.PyPrinterHANDLE, FirstJob: int, NoJobs: int, Level: Literal[3], /
) -> tuple[_win32typing.JOB_INFO_3, ...]: ...
@overload
def GetJob(hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[1] = 1, /) -> _win32typing.JOB_INFO_1: ...
@overload
def GetJob(hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[2], /) -> _win32typing.JOB_INFO_2: ...
@overload
def GetJob(hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[3], /) -> _win32typing.JOB_INFO_3: ...
@overload
def SetJob(hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[0], JobInfo: None, Command: int, /) -> None: ...
@overload
def SetJob(
    hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[1], JobInfo: _win32typing.JOB_INFO_1, Command: int, /
) -> None: ...
@overload
def SetJob(
    hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[2], JobInfo: _win32typing.JOB_INFO_2, Command: int, /
) -> None: ...
@overload
def SetJob(
    hPrinter: _win32typing.PyPrinterHANDLE, JobID: int, Level: Literal[3], JobInfo: _win32typing.JOB_INFO_3, Command: int, /
) -> None: ...
...
) -> tuple[_win32typing.DRIVER_INFO_1, ...]: ...
@overload
def EnumPrinterDrivers(
    Server: str | None, Environment: str | None, Level: Literal[2], /
) -> tuple[_win32typing.DRIVER_INFO_2, ...]: ...
@overload
def EnumPrinterDrivers(
    Server: str | None, Environment: str | None, Level: Literal[3], /
) -> tuple[_win32typing.DRIVER_INFO_3, ...]: ...
@overload
def EnumPrinterDrivers(
    Server: str | None, Environment: str | None, Level: Literal[4], /
) -> tuple[_win32typing.DRIVER_INFO_4, ...]: ...
@overload
def EnumPrinterDrivers(
    Server: str | None, Environment: str | None, Level: Literal[5], /
) -> tuple[_win32typing.DRIVER_INFO_5, ...]: ...
@overload
def EnumPrinterDrivers(
    Server: str | None, Environment: str | None, Level: Literal[6], /
) -> tuple[_win32typing.DRIVER_INFO_6, ...]: ...
def EnumForms(hprinter: _win32typing.PyPrinterHANDLE, /) -> tuple[_win32typing.FORM_INFO_1, ...]: ...
def AddForm(hprinter: _win32typing.PyPrinterHANDLE, Form: _win32typing.FORM_INFO_1, /) -> None: ...
def DeleteForm(hprinter: _win32typing.PyPrinterHANDLE, FormName: str, /) -> None: ...
def GetForm(hprinter: _win32typing.PyPrinterHANDLE, FormName: str, /) -> _win32typing.FORM_INFO_1: ...
def SetForm(hprinter: _win32typing.PyPrinterHANDLE, FormName: str, Form: _win32typing.FORM_INFO_1, /) -> None: ...
...
@overload
def EnumMonitors(Name: str | None, Level: Literal[1], /) -> tuple[_win32typing.MONITOR_INFO_1, ...]: ...
@overload
def EnumMonitors(Name: str | None, Level: Literal[2], /) -> tuple[_win32typing.MONITOR_INFO_2, ...]: ...
@overload
def EnumPorts(Name: str | None, Level: Literal[1], /) -> tuple[_win32typing.PORT_INFO_1, ...]: ...
@overload
def EnumPorts(Name: str | None, Level: Literal[2], /) -> tuple[_win32typing.PORT_INFO_2, ...]: ...
...
def AddPrinter(Name: str | None, Level: Literal[2], pPrinter: _win32typing.PRINTER_INFO_2, /) -> _win32typing.PyPrinterHANDLE: ...
