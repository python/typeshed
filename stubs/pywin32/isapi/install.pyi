...
def InstallModule(conf_module_name: StrPath, params, options, log: Callable[[int, str], None] = ...) -> None: ...
def UninstallModule(conf_module_name: StrPath, params, options, log: Callable[[int, str], None] = ...) -> None: ...

standard_arguments: dict[Literal["install", "remove"], Incomplete]
