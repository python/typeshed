...
class GraphicsStateMixin:
    ...
    @draw_color.setter
    def draw_color(self, v: Union[DeviceGray, DeviceRGB]) -> None: ...
    @property
    def fill_color(self) -> DeviceGray | DeviceRGB: ...
    @fill_color.setter
    def fill_color(self, v: Union[DeviceGray, DeviceRGB]) -> None: ...
    @property
    def text_color(self) -> DeviceGray | DeviceRGB: ...
    @text_color.setter
    def text_color(self, v: Union[DeviceGray, DeviceRGB]) -> None: ...
    @property
    def underline(self): ...
    @underline.setter
