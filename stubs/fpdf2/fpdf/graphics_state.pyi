...
class GraphicsStateMixin:
    ...
    @property
    def draw_color(self) -> DeviceGray: ...
    @draw_color.setter
    def draw_color(self, v: DeviceGray) -> None: ...
    @property
    def fill_color(self) -> DeviceGray: ...
    @fill_color.setter
    def fill_color(self, v: DeviceGray) -> None: ...
    @property
    def text_color(self) -> DeviceGray: ...
    @text_color.setter
    def text_color(self, v: DeviceGray) -> None: ...
    @property
    def underline(self): ...
    @underline.setter
