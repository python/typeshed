...
class FPDF(GraphicsStateMixin):
    ...
    def get_fallback_font(self, char: str, style: str = "") -> Incomplete | None: ...
    ...
    def preload_image(self, name: str | Image.Image | BytesIO, dims: Incomplete | None = None) -> tuple[str, Any, ImageInfo]: ...
    ...
    def output(  # type: ignore[misc]
        ...
        output_producer_class: Callable[[FPDF], Incomplete] = ...,
    ) -> None: ...
    @overload
    def output(
        self, name: str, dest: Unused = "", linearize: bool = False, output_producer_class: Callable[[FPDF], Incomplete] = ...
    ) -> bytearray: ...
