...
class SubsetMap:
    ...
    def pick(self, unicode: int) -> int | None: ...
...
class FPDF:
    ...
    zoom_mode: str | float
    def set_display_mode(self, zoom: str | float, layout: str = ...) -> None: ...
    compress: bool
    ...
    def link(self, x: float, y: float, w: float, h: float, link, alt_text: str | None = ...) -> None: ...
    ...
    def rect_clip(self, x: float, y: float, w: float, h) -> _GeneratorContextManager[None]: ...
