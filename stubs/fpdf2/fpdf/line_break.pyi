...
class Fragment:
    ...
    def render_pdf_text(
        self,
        frag_ws: Incomplete,
        current_ws: Incomplete,
        word_spacing: Incomplete,
        adjust_x: Incomplete,
        adjust_y: Incomplete,
        h: Incomplete,
    ): ...
    def render_pdf_text_ttf(self, frag_ws: Incomplete, word_spacing: Incomplete): ...
    def render_with_text_shaping(
        self, pos_x: Incomplete, pos_y: Incomplete, h: Incomplete, word_spacing: Incomplete, text_shaping_parms: Incomplete
    ): ...
    def render_pdf_text_core(self, frag_ws: Incomplete, current_ws: Incomplete): ...
