...
def get_instance_metadata(
    version: str = 'latest', url: str = 'http://169.254.169.254', data: str = 'meta-data/', timeout: int | None = None, num_retries: int = 5
...
def get_instance_userdata(
    version: str = 'latest', sep: str | None = None, url: str = 'http://169.254.169.254', timeout: int | None = None, num_retries: int = 5
) -> Mapping[str, str]: ...
...
def compute_hash(fp: IO[Any], buf_size: int = 8192, size: int | None = None, hash_algorithm: Any = ...) -> tuple[str, str, int]: ...
