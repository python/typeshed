...
class Bucket:
    ...
    def delete_key(
        self, key_name, headers: dict[str, str] | None = ..., version_id: Incomplete | None = ..., mfa_token: Incomplete | None = ...
    ): ...
    def copy_key(
        self,
        new_key_name,
    ...
    def set_acl(self, acl_or_str, key_name: str = ..., headers: dict[str, str] | None = ..., version_id: Incomplete | None = ...): ...
    ...
    def add_user_grant(
        self, permission, user_id, recursive: bool = ..., headers: dict[str, str] | None = ..., display_name: Incomplete | None = ...
    ): ...
