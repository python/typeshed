...
class Transition:
    ...
    date: Any
    storage_class: Any
    def __init__(self, days: Incomplete | None = ..., date: Incomplete | None = ..., storage_class: Incomplete | None = ...) -> None: ...
    def to_xml(self): ...
...
class Transitions(list[Transition]):
    ...
    def endElement(self, name, value, connection): ...
    def to_xml(self): ...
    def add_transition(self, days: Incomplete | None = ..., date: Incomplete | None = ..., storage_class: Incomplete | None = ...): ...
    @property
    def days(self): ...
    @property
    def date(self): ...
