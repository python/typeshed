...
class Client:
    ...
    @on_connect.setter
    def on_connect(self, func: _OnConnect | _OnConnectV5) -> None: ...
    ...
    @on_subscribe.setter
    def on_subscribe(self, func: _OnSubscribe | _OnSubscribeV5) -> None: ...
    ...
    def on_unsubscribe(self, func: _OnUnsubscribe | _OnUnsubscribeV5) -> None: ...
    ...
    def on_disconnect(self, func: _OnDisconnect | _OnDisconnectV5) -> None: ...
