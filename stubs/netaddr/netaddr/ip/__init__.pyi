...
class IPListMixin:
    ...
    @overload
    def __getitem__(self, index: slice[Any, Any, Any]) -> Iterator[IPAddress]: ...
    @overload
    def __getitem__(self, index: SupportsIndex | slice[Any, Any, Any]) -> IPAddress | Iterator[IPAddress]: ...
