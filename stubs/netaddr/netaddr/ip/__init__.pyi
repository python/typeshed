...
from netaddr.core import INET_PTON as INET_PTON, NOHOST as NOHOST, ZEROFILL as ZEROFILL, DictDotLookup, N as N, P as P, Z as Z
...
class IPListMixin:
    ...
    @overload
    def __getitem__(self, index: int | slice) -> IPAddress | Iterator[IPAddress]: ...
...
class IPNetwork(BaseIP, IPListMixin):
    ...
    def subnet(self: Self, prefixlen: int, count: int | None = ..., fmt: object | None = ...) -> Generator[Self, None, None]: ...
...
def iter_unique_ips(*args: IPRange | _IPNetworkAddr) -> Generator[IPAddress, None, None]: ...
...
def iter_iprange(
    start: _IPAddressAddr, end: _IPAddressAddr, step: SupportsInt | SupportsIndex = ...
