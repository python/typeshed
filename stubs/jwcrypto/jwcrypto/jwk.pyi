...
class JWKSet(dict[Literal["keys"], set[JWK]]):
    ...
    @overload
    def export(self, private_keys: bool = True, as_dict: Literal[False] = ...) -> str: ...
    @overload
    def export(self, private_keys: bool = True, as_dict: Literal[True] = ...) -> dict[str, Any]: ...
    @overload
    def export(self, private_keys: bool = True, as_dict: bool = False) -> str | dict[str, Any]: ...
