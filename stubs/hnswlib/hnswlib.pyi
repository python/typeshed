...
class Index:
    ...
    def add_items(
        self, data: object, ids: object | None = None, num_threads: int = -1, replace_deleted: bool = False
    ) -> None: ...
    def get_current_count(self) -> int: ...
    def get_ids_list(self) -> list[int]: ...
    @overload
    def get_items(self, ids: object | None = ..., return_type: Literal["list"] = ...) -> list[float]: ...
    @overload
    def get_items(self, ids: object | None = ..., return_type: Literal["numpy"] = ...) -> NDArray[np.float32]: ...
    @overload
    def get_items(
        self, ids: object | None = None, return_type: Literal["numpy", "list"] = "numpy"
    ...
    def knn_query(
        self, data: object, k: int = 1, num_threads: int = -1, filter: Callable[[int], bool] | None = None
