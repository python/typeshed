...
class Ontario(BoxingDayMixin, ThanksgivingMixin, VictoriaDayMixin,
              LateFamilyDayMixin, AugustCivicHolidayMixin, Canada):
...
class BritishColumbia(
        VictoriaDayMixin, AugustCivicHolidayMixin, ThanksgivingMixin, Canada):
    include_good_friday: ClassVar[bool]
    FIXED_HOLIDAYS: Incomplete
...
class Manitoba(LateFamilyDayMixin, VictoriaDayMixin,
               AugustCivicHolidayMixin, ThanksgivingMixin, Canada):
    include_good_friday: ClassVar[bool]
    def get_variable_days(self, year): ...
...
class NorthwestTerritories(RemembranceDayShiftMixin,
                           VictoriaDayMixin, ThanksgivingMixin, Canada):
    FIXED_HOLIDAYS: Incomplete
    include_good_friday: ClassVar[bool]
    def get_variable_days(self, year): ...


class Nunavut(VictoriaDayMixin, ThanksgivingMixin,
              RemembranceDayShiftMixin, Canada):
    include_good_friday: ClassVar[bool]
    def get_variable_days(self, year): ...
