...
def set_resource_file_existence_checking(v) -> None: ...
def set_auto_register_library(v) -> None: ...
...
class Resource(Renderable, Asset):
    ...
    def fullpath(self, path: str | None = ...) -> str: ...
    def compile(self, force: bool = False) -> None: ...
    def render(self, library_url: str) -> str: ...
    def mode(self, mode: str | None) -> Resource: ...
    def need(self, slots: dict[Slot, Resource] | None = ...) -> None: ...
