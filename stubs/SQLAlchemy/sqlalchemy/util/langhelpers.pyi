...
def generic_repr(
    obj,
    additional_kw: Iterable[tuple[Incomplete, Incomplete]] = ...,
    to_inspect: Incomplete | None = ...,
    omit_kwarg: Container[Incomplete] = ...,
): ...
...
class _symbol(int):
    def __new__(cls: type[Self], name, doc: Incomplete | None = ..., canonical: Incomplete | None = ...) -> Self: ...
    def __reduce__(self): ...

class symbol:
    symbols: dict[str, _symbol]
    # Runtime really does return _symbol
    def __new__(cls, name, doc: Incomplete | None = ..., canonical: Incomplete | None = ...) -> _symbol: ...  # type: ignore[misc]
    @classmethod
