...
class DefaultDialect(interfaces.Dialect):
    ...
    def has_table(self, connection, table_name, schema: Incomplete | None = None, **kw) -> NoReturn | bool: ...
    def has_index(self, connection, table_name, index_name, schema: Incomplete | None = None) -> bool: ...
