...
class Dialect:
    ...
    @abstractmethod
    def has_table(self, connection, table_name, schema: Incomplete | None = None, **kw) -> bool: ...
    @abstractmethod
    def has_index(self, connection, table_name, index_name, schema: Incomplete | None = None) -> bool: ...
    # Meant to be overriden, but not all instanciable subtypes overrides it
    def has_sequence(self, connection, sequence_name, schema: Incomplete | None = None, **kw) -> bool: ...
    ...
    @abstractmethod
    def is_disconnect(self, e, connection, cursor) -> bool | None: ...
