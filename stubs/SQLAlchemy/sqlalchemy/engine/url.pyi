...
class URL(_URLTuple):
    ...
    def update_query_string(self: Self, query_string: str, append: bool = False) -> Self: ...
    def update_query_pairs(self: Self, key_value_pairs: Iterable[tuple[str, str]], append: bool = False) -> Self: ...
    def update_query_dict(
        self: Self, query_parameters: SupportsItems[str, str | Sequence[str]], append: bool = False
    ) -> Self: ...
