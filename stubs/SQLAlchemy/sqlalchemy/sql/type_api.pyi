...
class TypeEngine(Traversible):
    class Comparator(operators.ColumnOperators[_T], Generic[_T]):
        ...
        def __contains__(self, other: _Unused) -> NoReturn: ...
        def __lshift__(self, other: _Unused) -> NoReturn | BinaryExpression: ...
        def __rshift__(self, other: _Unused) -> NoReturn | BinaryExpression: ...
    ...
    def evaluates_none(self: Self) -> Self: ...
    ...
    def coerce_compared_value(self: Self, op: _Unused, value) -> TypeEngine | Self: ...
...
class UserDefinedType(ExternalType, TypeEngine, metaclass=VisitableCheckKWArg):
    __visit_name__: str
    ensure_kwarg: str
    def coerce_compared_value(self: Self, op: _Unused, value: _Unused) -> Self: ...
...
class NativeForEmulated:
    ...
    @classmethod
    def adapt_emulated_to_native(cls: type[Self], impl: _Unused, **kw) -> Self: ...
...
class TypeDecorator(ExternalType, SchemaEventTarget, TypeEngine):
    ...
    def coerce_compared_value(self: Self, op: _Unused, value: _Unused) -> Self | TypeEngine: ...
    def copy(self: Self, **kw: _Unused) -> Self: ...
...
class Variant(TypeDecorator):
    ...
    def coerce_compared_value(self: Self, operator, value) -> Self | TypeEngine: ...
    def load_dialect_impl(self, dialect: Dialect) -> TypeEngine: ...
...
@overload
def to_instance(typeobj: None, *arg: _Unused, **kw: _Unused) -> None: ...
@overload
def to_instance(typeobj: Callable[_P, _T], *arg: _P.args, **kw: _P.kwargs) -> _T: ...
@overload
def to_instance(typeobj: _T, *arg: _Unused, **kw: _Unused) -> _T: ...
