from _typeshed import Incomplete, ReadableBuffer, Self, SupportsTrunc
...
class FunctionElement(Executable, ColumnElement[Any], FromClause, Generative):  # type: ignore[misc]
    ...
    def __init__(self, *clauses, **kwargs: _Unused) -> None: ...
    def scalar_table_valued(self, name, type_: type[TypeEngine] | TypeEngine | None = ...): ...
    ...
    def within_group_type(self, within_group: _Unused) -> None: ...
...
class ScalarFunctionColumn(NamedColumn):
    ...
    def __init__(self, fn, name, type_: TypeEngine | _type[TypeEngine] | None = ...) -> None: ...
