...
class DDLElement(roles.DDLRole, Executable, _DDLCompiles):
    ...
    state: Any
    def execute_if(self, dialect: Incomplete | None = ..., callable_: Incomplete | None = ..., state: Incomplete | None = ...) -> None: ...
...
class _CreateDropBase(DDLElement):
    ...
    if_not_exists: Any
    def __init__(
        self, element, bind: Incomplete | None = ..., if_exists: bool = ..., if_not_exists: bool = ..., _legacy_bind: Incomplete | None = ...
    ) -> None: ...
    @property
...
class CreateTable(_CreateDropBase):
    ...
    def __init__(
        self, element, bind: Incomplete | None = ..., include_foreign_key_constraints: Incomplete | None = ..., if_not_exists: bool = ...
    ) -> None: ...
...
class SchemaGenerator(DDLBase):
    ...
    def visit_table(
        self, table, create_ok: bool = ..., include_foreign_key_constraints: Incomplete | None = ..., _is_metadata_operation: bool = ...
    ) -> None: ...
