...
class ColumnCollection:
    def __init__(self, columns: Iterable[Column] | None = None) -> None: ...
    def keys(self): ...
    def values(self): ...
    def items(self): ...
    ...
    def add(self, column: Column, key: Incomplete | None = None) -> None: ...
    def contains_column(self, col: Column) -> bool: ...
    def as_immutable(self) -> ImmutableColumnCollection: ...
    def corresponding_column(self, column: Column, require_embedded: bool = False): ...
