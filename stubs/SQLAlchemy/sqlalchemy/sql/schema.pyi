...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    def __init__(self, *args: _Unused, **kw: _Unused) -> None: ...
    @property
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def copy(self, schema: str | _symbol | symbol | None = ..., **kw: _Unused) -> ForeignKey: ...
    @property
...
class Constraint(DialectKWArgs, SchemaItem):
    ...
    # Deprecated
    def copy(self, **kw: _Unused) -> NoReturn: ...
...
class ColumnCollectionConstraint(ColumnCollectionMixin, Constraint):
    ...
    def copy(self: Self, target_table: Incomplete | None = ..., **kw: _Unused) -> Self: ...  # type: ignore[override]
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    def copy(self, target_table: Table | None = ..., **kw: _Unused) -> CheckConstraint: ...  # type: ignore[override]
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    def copy(self, schema: str | None = ..., target_table: Table | None = ..., **kw: _Unused) -> ForeignKeyConstraint: ...  # type: ignore[override]
...
class Index(DialectKWArgs, ColumnCollectionMixin, SchemaItem):
    ...
    @property
    def bind(self) -> Engine | Connection | None: ...
    def create(self: Self, bind: Engine | Connection | None = ..., checkfirst: bool = ...) -> Self: ...
    def drop(self, bind: Engine | Connection | None = ..., checkfirst: bool = ...) -> None: ...
...
class Computed(FetchedValue, SchemaItem):
    ...
    def copy(self, target_table: Incomplete | None = ..., **kw: _Unused) -> Computed: ...
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    def copy(self, **kw: _Unused) -> Identity: ...
