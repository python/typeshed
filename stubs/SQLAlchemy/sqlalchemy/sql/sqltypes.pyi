...
class Numeric(_LookupExpressionAdapter, TypeEngine):
    ...
    asdecimal: bool
    def __init__(
        self, precision: int | None = ..., scale: int | None = ..., decimal_return_scale: int | None = ..., asdecimal: bool = ...
    ) -> None: ...
    def get_dbapi_type(self, dbapi): ...
    def literal_processor(self, dialect: Dialect) -> Callable[[float | decimal.Decimal], str]: ...
    @property
    def python_type(self) -> type[float] | type[decimal.Decimal]: ...
...
class Float(Numeric):
    ...
    asdecimal: bool
    decimal_return_scale: int | None
    def __init__(self, precision: int | None = ..., asdecimal: bool = ..., decimal_return_scale: int | None = ...) -> None: ...
    def result_processor(
        self, dialect: Dialect, coltype
    ) -> Callable[[Incomplete | None], float | decimal.Decimal | None] | None: ...
...
class _Binary(TypeEngine):
    ...
    def coerce_compared_value(self: Self, op, value) -> Self | TypeEngine: ...
    def get_dbapi_type(self, dbapi): ...
...
class SchemaType(SchemaEventTarget):
    ...
    def copy(self: Self, **kw: _Unused) -> Self: ...
...
class PickleType(TypeDecorator):
    ...
    def __init__(
        ...
        impl: type[Incomplete] | Incomplete | None = ...,
    ) -> None: ...
    def __reduce__(self): ...
...
class Boolean(Emulated, TypeEngine, SchemaType):  # type: ignore[misc]
    ...
    def __init__(self, create_constraint: bool = ..., name: str | None = ..., _create_events: bool = ...) -> None: ...
    @property
...
class Interval(Emulated, _AbstractInterval, TypeDecorator):  # type: ignore[misc]
    ...
    def __init__(self, native: bool = ..., second_precision: float | None = ..., day_precision: float | None = ...) -> None: ...
    @property
...
class JSON(Indexable, TypeEngine):
    ...
    class Comparator(Indexable.Comparator[_T], Concatenable.Comparator[_T]):
        ...
        def as_numeric(self, precision, scale, asdecimal: bool = ...) -> BinaryExpression: ...
        def as_json(self): ...
    comparator_factory: Callable[[Incomplete], Comparator[Incomplete]]
    @property
    def python_type(self) -> type: ...
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine):
    ...
    class Comparator(Indexable.Comparator[_T], Concatenable.Comparator[_T], Generic[_T]):
        ...
        def any(self, other, operator: Incomplete | None = ...) -> BinaryExpression: ...
        def all(self, other, operator: Incomplete | None = ...) -> BinaryExpression: ...
...
class NullType(TypeEngine):
    __visit_name__: str
    def literal_processor(self, dialect: _Unused) -> None: ...
