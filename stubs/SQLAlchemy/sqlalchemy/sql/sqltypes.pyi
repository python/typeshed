...
class Numeric(_LookupExpressionAdapter, TypeEngine):
    ...
    asdecimal: Any
    def __init__(
        self, precision: Incomplete | None = ..., scale: Incomplete | None = ..., decimal_return_scale: Incomplete | None = ..., asdecimal: bool = ...
    ) -> None: ...
    def get_dbapi_type(self, dbapi): ...
    def literal_processor(self, dialect): ...
    @property
...
class Float(Numeric):
    ...
    asdecimal: Any
    decimal_return_scale: Any
    def __init__(self, precision: Incomplete | None = ..., asdecimal: bool = ..., decimal_return_scale: Incomplete | None = ...) -> None: ...
    def result_processor(self, dialect, coltype): ...
...
class PickleType(TypeDecorator):
    ...
    pickler: Any
    comparator: Any
    def __init__(self, protocol=..., pickler: Incomplete | None = ..., comparator: Incomplete | None = ..., impl: Incomplete | None = ...) -> None: ...
    def __reduce__(self): ...
    def bind_processor(self, dialect): ...
    def result_processor(self, dialect, coltype): ...
...
class Boolean(Emulated, TypeEngine, SchemaType):  # type: ignore[misc]
    ...
    name: Any
    def __init__(self, create_constraint: bool = ..., name: Incomplete | None = ..., _create_events: bool = ...) -> None: ...
    @property
    def python_type(self): ...
    def literal_processor(self, dialect): ...
    def bind_processor(self, dialect): ...
...
class Interval(Emulated, _AbstractInterval, TypeDecorator):  # type: ignore[misc]
    ...
    day_precision: Any
    def __init__(self, native: bool = ..., second_precision: Incomplete | None = ..., day_precision: Incomplete | None = ...) -> None: ...
    @property
    def python_type(self): ...
    def adapt_to_emulated(self, impltype, **kw): ...
    def bind_processor(self, dialect): ...
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine):
    ...
    as_tuple: Any
    dimensions: Any
    def __init__(self, item_type, as_tuple: bool = ..., dimensions: Incomplete | None = ..., zero_indexes: bool = ...) -> None: ...
    @property
    def hashable(self): ...
    @property
    def python_type(self): ...
