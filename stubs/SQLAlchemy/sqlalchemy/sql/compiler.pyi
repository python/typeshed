...
class Compiled:
    ...
    def construct_params(
        ...
        extracted_parameters: Incomplete | None = ...,
        escape_names: bool = ...,
...
class SQLCompiler(Compiled):
    ...
    def visit_grouping(self, grouping, asfrom: bool = ..., **kwargs) -> str: ...
    def visit_select_statement_grouping(self, grouping, **kwargs) -> str: ...
    def visit_label_reference(self, element, within_columns_clause: bool = ..., **kwargs) -> str: ...
    def visit_textual_label_reference(self, element, within_columns_clause: bool = ..., **kwargs) -> str: ...
    def visit_label(
        self,
        label,
    ...
    def visit_textclause(self, textclause, add_to_result_map: Incomplete | None = ..., **kw) -> str: ...
    def visit_textual_select(self, taf, compound_index: int | None = ..., asfrom: bool = ..., **kw) -> str: ...
    ...
    def visit_function(self, func, add_to_result_map: Incomplete | None = ..., **kwargs) -> str: ...
    ...
    compile_state: Incomplete
    def visit_compound_select(self, cs, asfrom: bool = ..., compound_index: int | None = ..., **kwargs) -> str: ...
    def visit_unary(self, unary, add_to_result_map: Incomplete | None = ..., result_map_targets=..., **kw) -> str: ...
    ...
    def visit_tablesample(self, tablesample, asfrom: bool = ..., **kw) -> str: ...
    def visit_values(self, element, asfrom: bool = ..., from_linter: Incomplete | None = ..., **kw) -> str: ...
    ...
    def visit_join(self, join, asfrom: bool = ..., from_linter: Incomplete | None = ..., **kwargs) -> str: ...
...
class DDLCompiler(Compiled):
    ...
    def visit_create_column(self, create, first_pk: bool = ..., **kw) -> str: ...
    def create_table_constraints(self, table, _include_foreign_key_constraints: Incomplete | None = ..., **kw) -> str: ...
    def visit_drop_table(self, drop, **kw) -> str: ...
    def visit_drop_view(self, drop, **kw) -> str: ...
    def visit_create_index(self, create, include_schema: bool = ..., include_table_schema: bool = ..., **kw) -> str: ...
    ...
    def visit_create_sequence(self, create, prefix: Incomplete | None = ..., **kw) -> str: ...
...
class IdentifierPreparer:
    ...
    def quote_schema(self, schema: quoted_name, force: None = ...) -> str: ...
    def quote(self, ident, force: None = ...) -> str: ...
    def format_collation(self, collation_name: _Q) -> _Q: ...
    def format_sequence(self, sequence, use_schema: bool = ...) -> str: ...
    def format_label(self, label, name: str | None = ...) -> str: ...
    def format_alias(self, alias, name: str | None = ...) -> str: ...
    def format_savepoint(self, savepoint, name: str | None = ...) -> str: ...
    def format_constraint(self, constraint, _alembic_quote: bool = ...) -> str: ...
    def truncate_and_render_index_name(self, name: str, _alembic_quote: bool = ...) -> str: ...
    def truncate_and_render_constraint_name(self, name: str, _alembic_quote: bool = ...) -> str: ...
    def format_index(self, index) -> str: ...
    def format_table(self, table, use_schema: bool = ..., name: str | None = ...) -> str: ...
    def format_schema(self, name: str) -> str: ...
    def format_label_name(self, name: str, anon_map: Incomplete | None = ...) -> str: ...
    def format_column(
        self,
        column,
        use_table: bool = ...,
    ...
    def format_table_seq(self, table, use_schema: bool = ...) -> str: ...
