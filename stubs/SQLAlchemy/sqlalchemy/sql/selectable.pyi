...
class Join(roles.DMLTableRole, FromClause):
    ...
    def description(self) -> str: ...
    def is_derived_from(self, fromclause: FromClause) -> bool: ...
    def self_group(self, against: Unused = ...) -> FromGrouping: ...  # type: ignore[override]  # Actual return type
    def select(self, whereclause: bool | str | visitors.Traversible | None = ..., **kwargs) -> Select: ...
    @property
...
class CTE(roles.DMLTableRole, roles.IsCTERole, Generative, HasPrefixes, HasSuffixes, AliasedReturnsRows, metaclass=ABCMeta):
    __visit_name__: str
    def alias(self, name: str | None = ..., flat: Unused = ...) -> CTE: ...  # type: ignore[override]
...
class SelectBase(
    ...
    def alias(self, name: Incomplete | None = ..., flat: Unused = ...) -> Subquery: ...
...
class CompoundSelect(HasCompileState, GenerativeSelect):
    ...
    def self_group(self, against: Unused = ...) -> SelectStatementGrouping: ...  # type: ignore[override]  # Actual return type
    def is_derived_from(self, fromclause: FromClause) -> bool: ...
    @property
    def selected_columns(self): ...
    @property
