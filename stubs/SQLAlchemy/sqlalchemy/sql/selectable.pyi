...
class HasHints:
    ...
    def with_hint(self: Self, selectable: _CoercibleElement | None, text: str, dialect_name: str = ...) -> Self: ...
...
class ForUpdateArg(ClauseElement):
    ...
    def __init__(
        ...
        nowait: bool = ...,
        read: bool = ...,
        of: Iterable[_CoercibleElement] | None = ...,
        skip_locked: bool = ...,
        key_share: bool = ...,
    ) -> None: ...
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def order_by(self: Self, *clauses: _CoercibleElement | None) -> Self: ...
    def group_by(self: Self, *clauses: _CoercibleElement | None) -> Self: ...
...
class Select(
    ...
    def distinct(self: Self, *expr: _CoercibleElement) -> Self: ...
    def select_from(self: Self, *froms: _CoercibleElement) -> Self: ...
    def correlate(self: Self, *fromclauses: _CoercibleElement) -> Self: ...
    def correlate_except(self: Self, *fromclauses: _CoercibleElement) -> Self: ...
    @HasMemoized.memoized_attribute
    def selected_columns(self): ...
...
class TextualSelect(SelectBase):
    ...
    column_args: Any
    positional: Any
    def __init__(self, text: TextClause, columns: Iterable[_CoercibleElement], positional: bool = ...) -> None: ...
    @HasMemoized.memoized_attribute
    def selected_columns(self): ...
