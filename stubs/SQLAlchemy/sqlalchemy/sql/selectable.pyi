...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    def join(
        self, right: FromClause, onclause: _CoercibleElement | None = None, isouter: bool = False, full: bool = False
    ) -> Join: ...
    def outerjoin(self, right: FromClause, onclause: _CoercibleElement | None = None, full: bool = False) -> Join: ...
...
class Join(roles.DMLTableRole, FromClause):
    ...
    def __init__(
        ...
        left: FromClause,
        right: FromClause,
        onclause: _CoercibleElement | None = None,
        isouter: bool = False,
        full: bool = False,
    ) -> None: ...
    @property
