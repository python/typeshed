...
class Values(Generative, FromClause):
    ...
    def lateral(self: Self, name: Incomplete | None = None) -> Self: ...
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def fetch(self: Self, count: Incomplete | None, with_ties: bool = False, percent: bool = False) -> Self: ...
...
class Select(
    ...
    def join(self: Self, target, onclause: Incomplete | None = None, isouter: bool = False, full: bool = False) -> Self: ...
    def outerjoin_from(self, from_, target, onclause: Incomplete | None = None, full: bool = False): ...
    def join_from(
        self: Self, from_, target, onclause: Incomplete | None = None, isouter: bool = False, full: bool = False
    ) -> Self: ...
