...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def with_for_update(
        self: Self, nowait: bool = ..., read: bool = ..., of: Incomplete | None = ..., skip_locked: bool = ..., key_share: bool = ...
    ) -> Self: ...
    def get_label_style(self): ...
...
class Select(
    ...
    def join_from(self: Self, from_, target, onclause: Incomplete | None = ..., isouter: bool = ..., full: bool = ...) -> Self: ...
