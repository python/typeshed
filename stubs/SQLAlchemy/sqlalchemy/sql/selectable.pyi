...
class Values(Generative, FromClause):
    ...
    def alias(self, name: Incomplete | None, **kw: _Unused) -> Self: ...  # type: ignore[override]
    def lateral(self, name: Incomplete | None = ...) -> Self: ...  # type: ignore[override]
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def fetch(self, count: int | str | visitors.Traversible | None, with_ties: bool = ..., percent: bool = ...) -> Self: ...
...
class Select(
    ...
    def reduce_columns(self, only_synonyms: bool = ...) -> Self: ...
...
class ScalarSelect(roles.InElementRole, Generative, Grouping):
    ...
    def self_group(self, **kwargs: _Unused) -> Self: ...  # type: ignore[override]  # supertype has overloads
