...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    def join(self, right: FromClause, onclause: ClauseElement | None = None, isouter: bool = False, full: bool = False) -> Join: ...
...
class Join(roles.DMLTableRole, FromClause):
    ...
    full: bool
    def __init__(
        self, left: FromClause, right: FromClause, onclause: ClauseElement | None = None, isouter: bool = False, full: bool = False
    ) -> None: ...
    @property
    def description(self) -> str: ...
    def is_derived_from(self, fromclause: FromClause) -> bool: ...
