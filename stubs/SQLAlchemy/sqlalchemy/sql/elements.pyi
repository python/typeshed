...
class BinaryExpression(ColumnElement[Any]):
    ...
    modifiers: Any
    def __init__(
        self, left, right, operator, type_: Incomplete | None = ..., negate: Incomplete | None = ..., modifiers: Incomplete | None = ...
    ) -> None: ...
    def __bool__(self) -> bool: ...
    def __nonzero__(self) -> bool: ...
    @property
...
class WithinGroup(ColumnElement[Any]):
    ...
    def __reduce__(self): ...
    def over(
        self, partition_by: Incomplete | None = ..., order_by: Incomplete | None = ..., range_: Incomplete | None = ..., rows: Incomplete | None = ...
    ): ...
    @memoized_property
    def type(self): ...
...
class ColumnClause(roles.DDLReferredColumnRole, roles.LabeledColumnExprRole, roles.StrAsPlainColumnRole, Immutable, NamedColumn):
    ...
    key: Any
    type: Any
    def __init__(self, text, type_: Incomplete | None = ..., is_literal: bool = ..., _selectable: Incomplete | None = ...) -> None: ...
