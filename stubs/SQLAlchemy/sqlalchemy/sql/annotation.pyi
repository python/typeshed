...
# Cannot make generic because pytype will think this is typing.Annotated when using
# and will throw ParseError: 'Name' object has no attribute 'elts'
class Annotated:
    __dict__: dict[str, Any]
    __element: _SupportsDict[Any]
    def __init__(self, element: _SupportsDict[Any], values) -> None: ...
    def __reduce__(self): ...
...
annotated_classes: dict[type[Incomplete], type[Annotated]] = ...
