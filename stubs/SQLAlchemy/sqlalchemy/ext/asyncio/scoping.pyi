...
class async_scoped_session(ScopedSessionMixin):
    ...
    def get_bind(self, mapper: Incomplete | None = None, clause: Incomplete | None = None, bind: Incomplete | None = None, **kw): ...
    def is_modified(self, instance, include_collections: bool = True) -> bool: ...
