...
class ColumnAssociationProxyInstance(ColumnOperators[Incomplete], AssociationProxyInstance):
    def __eq__(self, other) -> BooleanClauseList | ColumnElement[Incomplete] | Exists: ...  # type: ignore[override]
    def operate(self, op: Callable[_P, Incomplete], *other: _P.args, **kwargs: _P.kwargs) -> Exists: ...  # type: ignore[override]
...
class _AssociationDict(_AssociationCollection):
    ...
    def copy(self) -> dict[Incomplete, Incomplete]: ...
    def __hash__(self) -> int: ...
