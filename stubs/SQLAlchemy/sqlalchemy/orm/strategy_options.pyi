...
class Load(Generative, LoaderOption):
    ...
    def set_relationship_strategy(self, attr, strategy, propagate_to_loaders: bool = ...) -> Self: ...
    def set_column_strategy(self, attrs, strategy, opts: Incomplete | None = ..., opts_only: bool = ...) -> Self: ...
    ...
    def contains_eager(loadopt, attr, alias: Incomplete | None = ...) -> Self: ...
    def load_only(loadopt, *attrs) -> Self: ...
    def joinedload(loadopt, attr, innerjoin: Incomplete | None = ...) -> Self: ...
    ...
    def raiseload(loadopt, attr, sql_only: bool = ...) -> Self: ...
    def defaultload(loadopt, attr) -> Self: ...
    def defer(loadopt, key, raiseload: bool = ...) -> Self: ...
