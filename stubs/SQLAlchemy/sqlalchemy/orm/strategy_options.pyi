...
class Load(Generative, LoaderOption):
    ...
    def set_relationship_strategy(self: Self, attr, strategy, propagate_to_loaders: bool = True) -> Self: ...
    def set_column_strategy(self: Self, attrs, strategy, opts: Incomplete | None = None, opts_only: bool = False) -> Self: ...
    ...
    def baked_lazyload(loadopt: Self, attr) -> Self: ...
