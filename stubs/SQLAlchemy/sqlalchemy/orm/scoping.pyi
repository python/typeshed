...
class scoped_session(ScopedSessionMixin):
    ...
    def connection(
        self, bind_arguments: Incomplete | None = ..., close_with_result: bool = ..., execution_options: Incomplete | None = ..., **kw
    ): ...
    ...
    def scalar(self, statement, params: Incomplete | None = ..., execution_options=..., bind_arguments: Incomplete | None = ..., **kw): ...
    def scalars(self, statement, params: Incomplete | None = ..., execution_options=..., bind_arguments: Incomplete | None = ..., **kw): ...
