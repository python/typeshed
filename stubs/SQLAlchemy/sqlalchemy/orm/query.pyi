...
class Query(_SelectFromElements, SupportsCloneAnnotations, HasPrefixes, HasSuffixes, HasHints, Executable, Generic[_T]):
    ...
    def with_for_update(
        self, read: bool = False, nowait: bool = False, of: Incomplete | None = None, skip_locked: bool = False, key_share: bool = False
    ) -> Self: ...
    ...
    def update(self, values, synchronize_session: _SynchronizeSessionArgument = 'evaluate', update_args: Incomplete | None = None): ...
