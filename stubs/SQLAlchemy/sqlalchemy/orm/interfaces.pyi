...
class PropComparator(operators.ColumnOperators[_T], Generic[_T]):
    ...
    @staticmethod
    def any_op(a, b, **kwargs) -> NoReturn | Incomplete: ...
    @staticmethod
    def has_op(a, b, **kwargs) -> NoReturn | Incomplete: ...
    @staticmethod
    def of_type_op(a, class_) -> NoReturn | Incomplete: ...
    def of_type(self, class_) -> NoReturn | Incomplete: ...
    def and_(self, *criteria) -> NoReturn | Incomplete: ...
    def any(self, criterion: Incomplete | None = None, **kwargs) -> NoReturn | Incomplete: ...
    def has(self, criterion: Incomplete | None = None, **kwargs) -> NoReturn | Incomplete: ...
