...
def parse_requirements(strs: str | Iterable[str]) -> map[Requirement]: ...
...
def load_entry_point(dist: _EPDistType, group: str, name: str) -> types.ModuleType: ...
@overload
...
class EntryPoint:
    ...
    @overload
    def load(self, require: Literal[False], *args: Unused, **kwargs: Unused) -> types.ModuleType: ...
    def resolve(self) -> types.ModuleType: ...
...
class Distribution(NullProvider):
    ...
    @classmethod
    def from_location(cls, location: str, basename: str, metadata: _MetadataType = None, **kw: int) -> Distribution: ...
    @property
    ...
    def load_entry_point(self, group: str, name: str) -> types.ModuleType: ...
    @overload
