...
class Environment:
    ...
    @overload
    def obtain(self, requirement: Requirement, installer: _InstallerType = None) -> None: ...
...
class EntryPoint:
    ...
    def load(self, require: bool = True, env: Environment | None = None, installer: _InstallerType = None) -> Any: ...
