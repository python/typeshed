...
class ScriptWriter:
    ...
    @classmethod
    def get_script_args(cls, dist, executable: Any | None = ..., wininst: bool = ...) -> Iterable[tuple[str, str]]: ...
    @classmethod
    ...
    @classmethod
    def get_writer(cls, force_windows: bool) -> ScriptWriter: ...
    @classmethod
    def best(cls) -> ScriptWriter: ...
    @classmethod
