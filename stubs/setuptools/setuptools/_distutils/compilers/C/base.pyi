...
class Compiler:
    ...
    def call(self, cmd: MutableSequence[bytes | StrPath], *, env: _ENV | None = None, **kwargs) -> None: ...
    def spawn(self, cmd: MutableSequence[bytes | StrPath], *, env: _ENV | None = None, **kwargs) -> None: ...
