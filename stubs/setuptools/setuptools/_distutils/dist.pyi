...
class Distribution:
    ...
    @overload
    def reinitialize_command(self, command: str, reinit_subcommands: int = 0) -> Command: ...
    @overload
    def reinitialize_command(self, command: _CommandT, reinit_subcommands: int = 0) -> _CommandT: ...
