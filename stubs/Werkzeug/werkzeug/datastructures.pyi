...
class ImmutableList(ImmutableListMixin[_V], List[_V]): ...  
...
class CombinedMultiDict(ImmutableMultiDictMixin, MultiDict[_K, _V]):  
    def __reduce_ex__(self, protocol): ...
    dicts: Any
...
class ImmutableDict(ImmutableDictMixin, Dict[_K, _V]):  
    def copy(self): ...
    def __copy__(self): ...

class ImmutableMultiDict(ImmutableMultiDictMixin, MultiDict[_K, _V]):  
    def copy(self): ...
    def __copy__(self): ...

class ImmutableOrderedMultiDict(ImmutableMultiDictMixin, OrderedMultiDict[_K, _V]):  
    def copy(self): ...
    def __copy__(self): ...
