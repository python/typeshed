...
class vtkViewNode(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetViewNodeFor(
        self, __a: vtkmodules.vtkCommonCore.vtkObject) -> vtkViewNode: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkViewNode: ...

    def SetMyFactory(self, __a: vtkViewNodeFactory) -> None: ...
    def SetParent(self, __a: vtkViewNode) -> None: ...
    def SetRenderable(
        self, __a: vtkmodules.vtkCommonCore.vtkObject) -> None: ...
...
class vtkActorNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkActorNode: ...
...
class vtkCameraNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCameraNode: ...
...
class vtkLightNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLightNode: ...
...
class vtkMapperNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMapperNode: ...
...
class vtkPolyDataMapperNode(vtkMapperNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataMapperNode: ...
...
class vtkRendererNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRendererNode: ...
...
class vtkViewNodeFactory(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkViewNodeFactory: ...
...
class vtkVolumeMapperNode(vtkMapperNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeMapperNode: ...
...
class vtkVolumeNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeNode: ...
...
class vtkWindowNode(vtkViewNode):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkWindowNode: ...
