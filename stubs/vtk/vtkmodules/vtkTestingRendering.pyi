...
class vtkTesting(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def RegressionTest(
        self, imageSource: vtkmodules.vtkCommonExecutionModel.vtkAlgorithm, thresh: float) -> int: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTesting: ...

    def SetBorderOffset(self, _arg: int) -> None: ...
    def SetDataRoot(self, _arg: str) -> None: ...
    def SetFrontBuffer(self, frontBuffer: int) -> None: ...
    def SetRenderWindow(
        self, rw: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> None: ...
...
class vtkTestingInteractor(vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTestingInteractor: ...
...
class vtkTestingObjectFactory(vtkmodules.vtkCommonCore.vtkObjectFactory):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTestingObjectFactory: ...
