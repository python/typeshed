...
class vtkGL2PSExporter(vtkmodules.vtkIOExport.vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGL2PSExporter: ...
...
class vtkOpenGLGL2PSExporter(vtkGL2PSExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLGL2PSExporter: ...
