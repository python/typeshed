...
class vtkBlueObeliskData(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetElectronAffinities(
        self) -> vtkmodules.vtkCommonCore.vtkFloatArray: ...
    def GetElectronicConfigurations(
    ...
    def GetPaulingElectronegativities(
        self) -> vtkmodules.vtkCommonCore.vtkFloatArray: ...
    def GetPeriodicTableBlocks(
        self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBlueObeliskData: ...
...
class vtkBlueObeliskDataParser(vtkmodules.vtkIOXMLParser.vtkXMLParser):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBlueObeliskDataParser: ...
...
class vtkMoleculeMapper(vtkmodules.vtkRenderingCore.vtkMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMoleculeMapper: ...
    ...
    def SetInputData(
        self, in_: vtkmodules.vtkCommonDataModel.vtkMolecule) -> None: ...
...
class vtkMoleculeToPolyDataFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMoleculeToPolyDataFilter: ...
...
class vtkMoleculeToAtomBallFilter(vtkMoleculeToPolyDataFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMoleculeToAtomBallFilter: ...
...
class vtkMoleculeToBondStickFilter(vtkMoleculeToPolyDataFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMoleculeToBondStickFilter: ...
...
class vtkMoleculeToLinesFilter(vtkMoleculeToPolyDataFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMoleculeToLinesFilter: ...
...
class vtkPeriodicTable(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetDefaultRGBTuple(self, atomicNum: int,
                           rgb: MutableSequence[float]) -> None: ...

    @overload
    def GetDefaultRGBTuple(
        self, atomicNum: int) -> vtkmodules.vtkCommonDataModel.vtkColor3f: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPeriodicTable: ...
...
class vtkPointSetToMoleculeFilter(vtkmodules.vtkCommonExecutionModel.vtkMoleculeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPointSetToMoleculeFilter: ...
...
class vtkProgrammableElectronicData(vtkmodules.vtkCommonDataModel.vtkAbstractElectronicData):
    ...
    def GetElectronDensity(
        self) -> vtkmodules.vtkCommonDataModel.vtkImageData: ...
    def GetMO(
        self, orbitalNumber: int) -> vtkmodules.vtkCommonDataModel.vtkImageData: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProgrammableElectronicData: ...

    def SetElectronDensity(
        self, __a: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
    def SetMO(self, orbitalNumber: int,
              data: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkProteinRibbonFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProteinRibbonFilter: ...
...
class vtkSimpleBondPerceiver(vtkmodules.vtkCommonExecutionModel.vtkMoleculeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSimpleBondPerceiver: ...
