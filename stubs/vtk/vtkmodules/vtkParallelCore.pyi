...
class vtkCommunicator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def AllGatherVoidArray(self, sendBuffer: _Pointer, recvBuffer: _Pointer, length: int, type: int) -> int: ...
    @overload
    ...
    def AllReduceVoidArray(self, sendBuffer: _Pointer, recvBuffer: _Pointer, length: int, type: int, operation: int) -> int: ...
    ...
    @overload
    def Broadcast(self, data: vtkmodules.vtkCommonDataModel.vtkDataObject, srcProcessId: int) -> int: ...
    @overload
    def Broadcast(self, data: vtkmodules.vtkCommonCore.vtkDataArray, srcProcessId: int) -> int: ...
    @overload
    def Broadcast(self, stream: vtkMultiProcessStream, srcProcessId: int) -> int: ...
    def BroadcastVoidArray(self, data: _Pointer, length: int, type: int, srcProcessId: int) -> int: ...
    @overload
    ...
    def GatherVoidArray(self, sendBuffer: _Pointer, recvBuffer: _Pointer, length: int, type: int, destProcessId: int) -> int: ...
    ...
    @overload
    def Receive(self, data: vtkmodules.vtkCommonDataModel.vtkDataObject, remoteHandle: int, tag: int) -> int: ...
    @overload
    def Receive(self, data: vtkmodules.vtkCommonCore.vtkDataArray, remoteHandle: int, tag: int) -> int: ...
    @overload
    ...
    def ReceiveDataObject(self, remoteHandle: int, tag: int) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    def ReceiveVoidArray(self, data: _Pointer, maxlength: int, type: int, remoteHandle: int, tag: int) -> int: ...
    @overload
    def Reduce(
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCommunicator: ...
    @overload
    ...
    def ScatterVoidArray(self, sendBuffer: _Pointer, recvBuffer: _Pointer, length: int, type: int, srcProcessId: int) -> int: ...
    @overload
    def Send(self, data: vtkmodules.vtkCommonDataModel.vtkDataObject, remoteHandle: int, tag: int) -> int: ...
    @overload
    def Send(self, data: vtkmodules.vtkCommonCore.vtkDataArray, remoteHandle: int, tag: int) -> int: ...
    @overload
    ...
    def SendVoidArray(self, data: _Pointer, length: int, type: int, remoteHandle: int, tag: int) -> int: ...
    ...
    @overload
    @staticmethod
    def UnMarshalDataObject(buffer: vtkmodules.vtkCommonCore.vtkCharArray) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
...
class vtkDummyCommunicator(vtkCommunicator):
    ...
    def ReceiveVoidArray(self, __a: _Pointer, __b: int, __c: int, __d: int, __e: int) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDummyCommunicator: ...
    def SendVoidArray(self, __a: _Pointer, __b: int, __c: int, __d: int, __e: int) -> int: ...
...
class vtkMultiProcessController(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def BroadcastTriggerRMIOnAllChildren(self, arg: _Pointer, argLength: int, tag: int) -> None: ...
    ...
    def Receive(self, data: MutableSequence[int], maxLength: int, remoteProcessId: int, tag: int) -> int: ...
    @overload
    def Receive(self, data: vtkmodules.vtkCommonDataModel.vtkDataObject, remoteId: int, tag: int) -> int: ...
    @overload
    def Receive(self, data: vtkmodules.vtkCommonCore.vtkDataArray, remoteId: int, tag: int) -> int: ...
    @overload
    def Receive(self, stream: vtkMultiProcessStream, remoteId: int, tag: int) -> int: ...
    def ReceiveDataObject(self, remoteId: int, tag: int) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    @overload
    def Reduce(
        self, sendBuffer: Sequence[int], recvBuffer: MutableSequence[int], length: int, operation: int, destProcessId: int
    ) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMultiProcessController: ...
    @overload
    def Scatter(self, sendBuffer: Sequence[int], recvBuffer: MutableSequence[int], length: int, srcProcessId: int) -> int: ...
    @overload
    def Scatter(self, sendBuffer: str, recvBuffer: str, length: int, srcProcessId: int) -> int: ...
    ...
    @overload
    def Send(self, data: vtkmodules.vtkCommonDataModel.vtkDataObject, remoteId: int, tag: int) -> int: ...
    @overload
    def Send(self, data: vtkmodules.vtkCommonCore.vtkDataArray, remoteId: int, tag: int) -> int: ...
    @overload
    def Send(self, stream: vtkMultiProcessStream, remoteId: int, tag: int) -> int: ...
    ...
    @overload
    def TriggerRMI(self, remoteProcessId: int, arg: _Pointer, argLength: int, tag: int) -> None: ...
    @overload
    def TriggerRMI(self, remoteProcessId: int, arg: str, tag: int) -> None: ...
    @overload
    def TriggerRMI(self, remoteProcessId: int, tag: int) -> None: ...
    @overload
    def TriggerRMIOnAllChildren(self, arg: _Pointer, argLength: int, tag: int) -> None: ...
    @overload
...
class vtkDummyController(vtkMultiProcessController):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDummyController: ...
...
class vtkFieldDataSerializer(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def Deserialize(bytestream: vtkMultiProcessStream, fieldData: vtkmodules.vtkCommonDataModel.vtkFieldData) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFieldDataSerializer: ...
    @staticmethod
    def Serialize(fieldData: vtkmodules.vtkCommonDataModel.vtkFieldData, bytestream: vtkMultiProcessStream) -> None: ...
    @staticmethod
    def SerializeMetaData(fieldData: vtkmodules.vtkCommonDataModel.vtkFieldData, bytestream: vtkMultiProcessStream) -> None: ...
    @staticmethod
...
class vtkPDirectory(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPDirectory: ...
...
class vtkPSystemTools(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPSystemTools: ...
...
class vtkProcess(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProcess: ...
...
class vtkProcessGroup(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProcessGroup: ...
...
class vtkSocketCommunicator(vtkCommunicator):
    ...
    def ReceiveVoidArray(self, data: _Pointer, length: int, type: int, remoteHandle: int, tag: int) -> int: ...
    def ReduceVoidArray(
        self, sendBuffer: _Pointer, recvBuffer: _Pointer, length: int, type: int, operation: int, destProcessId: int
    ) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSocketCommunicator: ...
    def ScatterVVoidArray(
        self,
        sendBuffer: _Pointer,
        recvBuffer: _Pointer,
    ...
    def SetSocket(self, __a: vtkmodules.vtkCommonSystem.vtkClientSocket) -> None: ...
    @overload
    def WaitForConnection(self, port: int) -> int: ...
    @overload
    def WaitForConnection(self, socket: vtkmodules.vtkCommonSystem.vtkServerSocket, msec: int = 0) -> int: ...
...
class vtkSocketController(vtkMultiProcessController):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSocketController: ...
...
class vtkSubCommunicator(vtkCommunicator):
    ...
    def ReceiveVoidArray(self, data: _Pointer, length: int, type: int, remoteHandle: int, tag: int) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSubCommunicator: ...
    def SendVoidArray(self, data: _Pointer, length: int, type: int, remoteHandle: int, tag: int) -> int: ...
...
class vtkSubGroup(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSubGroup: ...
