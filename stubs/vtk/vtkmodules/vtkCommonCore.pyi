from typing import Any, Callable, MutableSequence, Sequence, Tuple, TypeVar, Union, overload
...
class vtkObject(vtkObjectBase):
    def AddObserver(self, event: int, command: Callback,
...
class vtkAbstractArray(vtkObject):
    ...
    def CopyInformation(self, infoFrom: vtkInformation,
                        deep: int = 1) -> int: ...
    ...
    @overload
    def GetTuples(self, tupleIds: vtkIdList,
                  output: vtkAbstractArray) -> None: ...

    @overload
    def GetTuples(self, p1: int, p2: int,
                  output: vtkAbstractArray) -> None: ...
    ...
    def InsertNextTuple(self, srcTupleIdx: int,
                        source: vtkAbstractArray) -> int: ...

    def InsertTuple(self, dstTupleIdx: int, srcTupleIdx: int,
                    source: vtkAbstractArray) -> None: ...

    @overload
    def InsertTuples(self, dstIds: vtkIdList, srcIds: vtkIdList,
                     source: vtkAbstractArray) -> None: ...

    @overload
    def InsertTuples(self, dstStart: int, n: int, srcStart: int,
                     source: vtkAbstractArray) -> None: ...
    def InsertTuplesStartingAt(
        self, dstStart: int, srcIds: vtkIdList, source: vtkAbstractArray) -> None: ...
    ...
    def SetTuple(self, dstTupleIdx: int, srcTupleIdx: int,
                 source: vtkAbstractArray) -> None: ...
    ...
    @overload
    def SetVoidArray(self, array: Pointer, size: int,
                     save: int, deleteMethod: int) -> None: ...
...
class vtkAnimationCue(vtkObject):
    ...
    def Tick(self, currenttime: float, deltatime: float,
             clocktime: float) -> None: ...
...
class vtkArchiver(vtkObject):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def InsertIntoArchive(self, relativePath: str,
                          data: str, size: int) -> None: ...
...
class vtkArray(vtkObject):
    ...
    @overload
    def CopyValue(self, source: vtkArray, source_index: int,
                  target_coordinates: vtkArrayCoordinates) -> None: ...

    @overload
    def CopyValue(self, source: vtkArray,
                  source_coordinates: vtkArrayCoordinates, target_index: int) -> None: ...

    @staticmethod
    def CreateArray(StorageType: int, ValueType: int) -> vtkArray: ...
    def DeepCopy(self) -> vtkArray: ...
    def GetCoordinatesN(
        self, n: int, coordinates: vtkArrayCoordinates) -> None: ...
    ...
    @overload
    def GetVariantValue(
        self, coordinates: vtkArrayCoordinates) -> vtkVariant: ...
    ...
    @overload
    def Resize(self, i: vtkArrayRange, j: vtkArrayRange,
               k: vtkArrayRange) -> None: ...
    ...
    @overload
    def SetVariantValue(self, i: int, j: int, k: int,
                        value: vtkVariant) -> None: ...

    @overload
    def SetVariantValue(self, coordinates: vtkArrayCoordinates,
                        value: vtkVariant) -> None: ...
...
class vtkArrayExtents:
    ...
    @overload
    def __init__(self, i: vtkArrayRange, j: vtkArrayRange,
                 k: vtkArrayRange) -> None: ...
    ...
    def GetLeftToRightCoordinatesN(
        self, n: int, coordinates: vtkArrayCoordinates) -> None: ...
    def GetRightToLeftCoordinatesN(
        self, n: int, coordinates: vtkArrayCoordinates) -> None: ...
...
class vtkArrayExtentsList:
    ...
    @overload
    def __init__(self, i: vtkArrayExtents, j: vtkArrayExtents,
                 k: vtkArrayExtents) -> None: ...

    @overload
    def __init__(self, i: vtkArrayExtents, j: vtkArrayExtents,
                 k: vtkArrayExtents, l: vtkArrayExtents) -> None: ...
...
class vtkArrayIteratorTemplate_I10vtkVariantE(vtkArrayIterator):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkArrayIteratorTemplate_I10vtkVariantE: ...
...
class vtkArrayIteratorTemplate_I12vtkStdStringE(vtkArrayIterator):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkArrayIteratorTemplate_I12vtkStdStringE: ...
...
class vtkDataArray(vtkAbstractArray):
    ...
    def CopyComponent(self, dstComponent: int,
                      src: vtkDataArray, srcComponent: int) -> None: ...
    def CopyInformation(self, infoFrom: vtkInformation,
                        deep: int = 1) -> int: ...
    ...
    def GetData(self, tupleMin: int, tupleMax: int, compMin: int,
    ...
    @overload
    def GetFiniteRange(
        self, range: MutableSequence[float], comp: int) -> None: ...

    @overload
    def GetFiniteRange(
        self, range: MutableSequence[float], comp: int, ghosts: Sequence[int], ghostsToSkip: int) -> None: ...
    ...
    @overload
    def GetRange(self, range: MutableSequence[float], comp: int,
                 ghosts: Sequence[int], ghostsToSkip: int) -> None: ...
    ...
    def GetTuple4(self, tupleIdx: int) -> Tuple[float,
                                                float, float, float]: ...

    def GetTuple6(self, tupleIdx: int) -> Tuple[float,
                                                float, float, float, float, float]: ...

    def GetTuple9(self, tupleIdx: int) -> Tuple[float, float,
    ...
    def InsertComponent(self, tupleIdx: int, compIdx: int,
                        value: float) -> None: ...
    ...
    def InsertNextTuple3(self, val0: float, val1: float,
                         val2: float) -> None: ...

    def InsertNextTuple4(self, val0: float, val1: float,
                         val2: float, val3: float) -> None: ...

    def InsertNextTuple6(self, val0: float, val1: float, val2: float,
    ...
    def InsertTuple2(self, tupleIdx: int, val0: float,
                     val1: float) -> None: ...

    def InsertTuple3(self, tupleIdx: int, val0: float,
                     val1: float, val2: float) -> None: ...

    def InsertTuple4(self, tupleIdx: int, val0: float,
    ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
    ...
    def SetTuple3(self, tupleIdx: int, val0: float,
                  val1: float, val2: float) -> None: ...

    def SetTuple4(self, tupleIdx: int, val0: float, val1: float,
                  val2: float, val3: float) -> None: ...

    def SetTuple6(self, tupleIdx: int, val0: float, val1: float,
...
class vtkBitArray(vtkDataArray):
    ...
    @overload
    def InsertTuple(self, i: int, j: int,
                    source: vtkAbstractArray) -> None: ...
...
class vtkGaussianRandomSequence(vtkRandomSequence):
    def GetNextScaledValue(
        self, mean: float, standardDeviation: float) -> float: ...

    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetScaledValue(self, mean: float,
...
class vtkBoxMuellerRandomSequence(vtkGaussianRandomSequence):
    ...
    def SetUniformSequence(
        self, uniformSequence: vtkRandomSequence) -> None: ...
...
class vtkByteSwap(vtkObject):
    ...
    @staticmethod
    def SwapVoidRange(buffer: Pointer, numWords: int,
                      wordSize: int) -> None: ...
...
class vtkCommand(vtkObjectBase):
    ...
    def Execute(self, caller: vtkObject, eventId: int,
...
class vtkCallbackCommand(vtkCommand):
    ...
    def Execute(self, caller: vtkObject, eid: int,
                callData: Pointer) -> None: ...
...
class vtkCharArray(vtkDataArray):
    ...
    @overload
    def SetArray(self, array: Buffer, size: int,
                 save: int, deleteMethod: int) -> None: ...
...
class vtkDataArraySelection(vtkObject):
    ...
    @overload
    def Union(self, other: vtkDataArraySelection,
              skipModified: bool) -> None: ...
...
class vtkTypedArray_I10vtkVariantE(vtkArray):
    ...
    @overload
    def SetValue(self, coordinates: vtkArrayCoordinates,
                 value: vtkVariant) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIaEaE(vtkDataArray):
    ...
    @overload
    def GetFiniteValueRange(
        self, range: MutableSequence[int], comp: int) -> None: ...
    ...
    def GetTypedTuple(self, tupleIdx: int,
                      tuple: MutableSequence[int]) -> None: ...

    def GetValue(self, valueIdx: int) -> int: ...

    @overload
    def GetValueRange(self, range: MutableSequence[int], comp: int,
                      ghosts: Sequence[int], ghostsToSkip: int = 0xFF) -> None: ...
    ...
    def InsertTuplesStartingAt(
        self, dstStart: int, srcIds: vtkIdList, source: vtkAbstractArray) -> None: ...
    def InsertTypedComponent(
        self, tupleIdx: int, compIdx: int, val: int) -> None: ...
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIaEaE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIaEaE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
    ...
    @overload
    def SetTuple(self, tupleIdx: int, tuple: Sequence[float]) -> None: ...
    def SetTypedComponent(self, tupleIdx: int,
                          compIdx: int, value: int) -> None: ...
    ...
    @overload
    def SetVoidArray(self, __a: Pointer, __b: int,
                     __c: int, __d: int) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIcEcE(vtkDataArray):
    ...
    @overload
    def GetFiniteValueRange(
        self, range: MutableSequence[str], comp: int) -> None: ...
    ...
    def GetTypedTuple(self, tupleIdx: int,
                      tuple: MutableSequence[str]) -> None: ...

    def GetValue(self, valueIdx: int) -> str: ...

    @overload
    def GetValueRange(self, range: MutableSequence[str], comp: int,
                      ghosts: Sequence[int], ghostsToSkip: int = 0xFF) -> None: ...
    ...
    def InsertTuplesStartingAt(
        self, dstStart: int, srcIds: vtkIdList, source: vtkAbstractArray) -> None: ...
    def InsertTypedComponent(
        self, tupleIdx: int, compIdx: int, val: str) -> None: ...
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIcEcE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIcEcE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIdEdE(vtkDataArray):
    ...
    def InsertTuplesStartingAt(
        self, dstStart: int, srcIds: vtkIdList, source: vtkAbstractArray) -> None: ...
    def InsertTypedComponent(
        self, tupleIdx: int, compIdx: int, val: float) -> None: ...
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIdEdE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIdEdE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIfEfE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIfEfE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIfEfE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIhEhE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIhEhE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIhEhE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIiEiE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIiEiE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIiEiE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIjEjE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIjEjE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIjEjE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIlElE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIlElE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIlElE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateImEmE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateImEmE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateImEmE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIsEsE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIsEsE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIsEsE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateItEtE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateItEtE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateItEtE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIxExE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIxExE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIxExE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkGenericDataArray_I23vtkSOADataArrayTemplateIyEyE(vtkDataArray):
    ...
    def LookupValue(self, value: vtkVariant, valueIds: vtkIdList) -> None: ...
    def NewInstance(
        self) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIyEyE: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkGenericDataArray_I23vtkSOADataArrayTemplateIyEyE: ...
    def SetComponent(self, tupleIdx: int, compIdx: int,
                     value: float) -> None: ...
...
class vtkIdList(vtkObject):
    ...
    def SetArray(
        self, array: MutableSequence[int], size: int, save: bool = True) -> None: ...
...
class vtkInformation(vtkObject):
    ...
    @overload
    def Append(self, key: vtkInformationIntegerVectorKey,
               value: int) -> None: ...

    @overload
    def Append(self, key: vtkInformationStringVectorKey,
               value: str) -> None: ...

    @overload
    def Append(self, key: vtkInformationDoubleVectorKey,
               value: float) -> None: ...

    @overload
    def Append(self, key: vtkInformationVariantVectorKey,
               value: vtkVariant) -> None: ...

    @overload
    def Append(self, key: vtkInformationKeyVectorKey,
    ...
    @overload
    def AppendUnique(self, key: vtkInformationKeyVectorKey,
                     value: vtkInformationKey) -> None: ...
    ...
    def CopyEntries(self, from_: vtkInformation,
                    key: vtkInformationKeyVectorKey, deep: int = 0) -> None: ...

    @overload
    def CopyEntry(self, from_: vtkInformation,
                  key: vtkInformationKey, deep: int = 0) -> None: ...
    ...
    @overload
    def Get(self, key: vtkInformationIntegerVectorKey,
            value: MutableSequence[int]) -> None: ...
    ...
    @overload
    def Get(self, key: vtkInformationIntegerPointerKey,
            value: MutableSequence[int]) -> None: ...
    ...
    @overload
    def Get(self, key: vtkInformationDoubleVectorKey,
            value: MutableSequence[float]) -> None: ...

    @overload
    def Get(self, key: vtkInformationVariantVectorKey,
            idx: int) -> vtkVariant: ...

    @overload
    def Get(self, key: vtkInformationKeyVectorKey,
            idx: int) -> vtkInformationKey: ...
    ...
    @overload
    def Remove(self, key: vtkInformationKeyVectorKey,
               value: vtkInformationKey) -> None: ...
    ...
    @overload
    def Set(self, key: vtkInformationVariantKey,
            value: vtkVariant) -> None: ...

    @overload
    def Set(self, key: vtkInformationIntegerVectorKey,
            value: Sequence[int], length: int) -> None: ...

    @overload
    def Set(self, key: vtkInformationIntegerVectorKey,
            value1: int, value2: int, value3: int) -> None: ...
    ...
    @overload
    def Set(self, key: vtkInformationStringVectorKey,
            value: str, idx: int = 0) -> None: ...

    @overload
    def Set(self, key: vtkInformationIntegerPointerKey,
            value: MutableSequence[int], length: int) -> None: ...

    @overload
    def Set(self, key: vtkInformationUnsignedLongKey, value: int) -> None: ...

    @overload
    def Set(self, key: vtkInformationDoubleVectorKey,
            value: Sequence[float], length: int) -> None: ...
...
class vtkInformationKey(vtkObjectBase):
    def CopyDefaultInformation(self, request: vtkInformation,
    ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NeedToExecute(self, pipelineInfo: vtkInformation,
    ...
    def Report(self, info: vtkInformation,
               collector: vtkGarbageCollector) -> None: ...

    @staticmethod
    def SafeDownCast(o: vtkObjectBase) -> vtkInformationKey: ...

    def ShallowCopy(self, from_: vtkInformation,
                    to: vtkInformation) -> None: ...
    def StoreMetaData(self, request: vtkInformation,
                      pipelineInfo: vtkInformation, dobjInfo: vtkInformation) -> None: ...


class vtkInformationDataObjectKey(vtkInformationKey):
    def Get(
        self, info: vtkInformation) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    ...
    def Set(self, info: vtkInformation,
            __b: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
    def ShallowCopy(self, from_: vtkInformation,
                    to: vtkInformation) -> None: ...
...
class vtkInformationDoubleVectorKey(vtkInformationKey):
    ...
    @overload
    def Get(self, info: vtkInformation,
            value: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def MakeKey(name: str, location: str, length: int = -
                1) -> vtkInformationDoubleVectorKey: ...
...
class vtkInformationInformationVectorKey(vtkInformationKey):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkInformationInformationVectorKey: ...
...
class vtkInformationIntegerVectorKey(vtkInformationKey):
    ...
    @staticmethod
    def MakeKey(name: str, location: str, length: int = -
                1) -> vtkInformationIntegerVectorKey: ...
...
class vtkInformationKeyVectorKey(vtkInformationKey):
    def Append(self, info: vtkInformation,
               value: vtkInformationKey) -> None: ...
    def AppendUnique(self, info: vtkInformation,
                     value: vtkInformationKey) -> None: ...
    ...
    def RemoveItem(self, info: vtkInformation,
                   value: vtkInformationKey) -> None: ...
...
class vtkInformationObjectBaseKey(vtkInformationKey):
    ...
    @staticmethod
    def MakeKey(name: str, location: str,
                requiredClass: str = ...) -> vtkInformationObjectBaseKey: ...
...
class vtkInformationObjectBaseVectorKey(vtkInformationKey):
    ...
    @staticmethod
    def MakeKey(name: str, location: str,
                requiredClass: str = ...) -> vtkInformationObjectBaseVectorKey: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkObjectBase) -> vtkInformationObjectBaseVectorKey: ...

    def Set(self, info: vtkInformation,
            value: vtkObjectBase, i: int) -> None: ...
    def ShallowCopy(self, source: vtkInformation,
                    dest: vtkInformation) -> None: ...
...
class vtkInformationStringVectorKey(vtkInformationKey):
    ...
    @staticmethod
    def MakeKey(name: str, location: str, length: int = -
                1) -> vtkInformationStringVectorKey: ...
...
class vtkInformationVariantVectorKey(vtkInformationKey):
    ...
    @staticmethod
    def MakeKey(name: str, location: str, length: int = -
                1) -> vtkInformationVariantVectorKey: ...
...
class vtkInformationVector(vtkObject):
    ...
    def SetInformationObject(
        self, index: int, info: vtkInformation) -> None: ...
...
class vtkLogger(vtkObjectBase):
    ...
    @staticmethod
    def Log(verbosity: Verbosity, fname: str,
            lineno: int, txt: str) -> None: ...

    @staticmethod
    def LogToFile(path: str, filemode: FileMode,
    ...
    @staticmethod
    def StartScope(verbosity: Verbosity, id: str,
                   fname: str, lineno: int) -> None: ...
...
class vtkScalarsToColors(vtkObject):
    ...
    def GetAnnotationColor(self, val: vtkVariant,
                           rgba: MutableSequence[float]) -> None: ...
    ...
    @overload
    def IsOpaque(self, scalars: vtkAbstractArray,
    ...
    @overload
    def MapScalarsThroughTable(self, scalars: vtkDataArray,
                               output: MutableSequence[int], outputFormat: int) -> None: ...

    @overload
    def MapScalarsThroughTable(
        self, scalars: vtkDataArray, output: MutableSequence[int]) -> None: ...
    ...
    def SetAnnotations(self, values: vtkAbstractArray,
...
class vtkLookupTable(vtkScalarsToColors):
    ...
    @staticmethod
    def ApplyLogScale(
        v: float, range: Sequence[float], log_range: Sequence[float]) -> float: ...
    ...
    @staticmethod
    def GetColorAsUnsignedChars(
        colorIn: Sequence[float], colorOut: MutableSequence[int]) -> None: ...
    ...
    @staticmethod
    def GetLogRange(
        range: Sequence[float], log_range: MutableSequence[float]) -> None: ...
    ...
    @overload
    def GetTableValue(self, indx: int) -> Tuple[float,
                                                float, float, float]: ...

    @overload
    def GetTableValue(
        self, indx: int, rgba: MutableSequence[float]) -> None: ...
    ...
    @overload
    def SetAboveRangeColor(self, _arg1: float, _arg2: float,
    ...
    @overload
    def SetBelowRangeColor(self, _arg1: float, _arg2: float,
                           _arg3: float, _arg4: float) -> None: ...
    ...
    @overload
    def SetTableValue(self, indx: int, r: float, g: float,
...
class vtkMath(vtkObject):
    ...
    def AngleBetweenVectors(
        v1: Sequence[float], v2: Sequence[float]) -> float: ...
    ...
    @staticmethod
    def BoundsIsWithinOtherBounds(
        bounds1: Sequence[float], bounds2: Sequence[float], delta: Sequence[float]) -> int: ...
    ...
    @staticmethod
    def ClampAndNormalizeValue(
        value: float, range: Sequence[float]) -> float: ...

    @overload
    @staticmethod
    def ClampValue(
        value: MutableSequence[float], range: Sequence[float]) -> None: ...

    @overload
    @staticmethod
    def ClampValue(
        value: float, range: Sequence[float], clamped_value: MutableSequence[float]) -> None: ...

    @overload
    @staticmethod
    def ClampValues(
        values: MutableSequence[float], nb_values: int, range: Sequence[float]) -> None: ...
    ...
    @staticmethod
    def Determinant3x3(
        c1: Sequence[float], c2: Sequence[float], c3: Sequence[float]) -> float: ...
    ...
    @staticmethod
    def Distance2BetweenPoints(
        p1: Sequence[float], p2: Sequence[float]) -> float: ...
    ...
    @staticmethod
    def ExtentIsWithinOtherExtent(
        extent1: Sequence[int], extent2: Sequence[int]) -> int: ...
    ...
    @overload
    @staticmethod
    def GaussianAmplitude(
        variance: float, distanceFromMean: float) -> float: ...

    @overload
    @staticmethod
    def GaussianAmplitude(mean: float, variance: float,
    ...
    @overload
    @staticmethod
    def GaussianWeight(mean: float, variance: float,
                       position: float) -> float: ...

    @staticmethod
    def GetAdjustedScalarRange(
        array: vtkDataArray, comp: int, range: MutableSequence[float]) -> int: ...
    ...
    @staticmethod
    def GetScalarTypeFittingRange(
        range_min: float, range_max: float, scale: float = 1.0, shift: float = 0.0) -> int: ...
    ...
    @overload
    @staticmethod
    def HSVToRGB(hsv: Sequence[float],
                 rgb: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def Invert3x3(A: Sequence[Sequence[float]],
                  AI: MutableSequence[MutableSequence[float]]) -> None: ...
    ...
    @staticmethod
    def LUFactor3x3(
        A: MutableSequence[MutableSequence[float]], index: MutableSequence[int]) -> None: ...

    @staticmethod
    def LUSolve3x3(A: Sequence[Sequence[float]],
                   index: Sequence[int], x: MutableSequence[float]) -> None: ...

    @overload
    @staticmethod
    def LabToRGB(lab: Sequence[float],
                 rgb: MutableSequence[float]) -> None: ...
    ...
    @overload
    @staticmethod
    def LabToXYZ(lab: Sequence[float],
                 xyz: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def LinearSolve3x3(A: Sequence[Sequence[float]],
                       x: Sequence[float], y: MutableSequence[float]) -> None: ...

    @staticmethod
    def Matrix3x3ToQuaternion(
        A: Sequence[Sequence[float]], quat: MutableSequence[float]) -> None: ...

    @overload
    @staticmethod
    def Multiply3x3(A: Sequence[Sequence[float]],
                    v: Sequence[float], u: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def MultiplyQuaternion(
        q1: Sequence[float], q2: Sequence[float], q: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def NextCombination(
        m: int, n: int, combination: MutableSequence[int]) -> int: ...
    ...
    @staticmethod
    def Orthogonalize3x3(
        A: Sequence[Sequence[float]], B: MutableSequence[MutableSequence[float]]) -> None: ...

    @staticmethod
    def Outer(a: Sequence[float], b: Sequence[float],
              c: MutableSequence[MutableSequence[float]]) -> None: ...

    @staticmethod
    def Outer2D(x: Sequence[float], y: Sequence[float],
                A: MutableSequence[MutableSequence[float]]) -> None: ...

    @staticmethod
    def Perpendiculars(v1: Sequence[float], v2: MutableSequence[float],
                       v3: MutableSequence[float], theta: float) -> None: ...

    @staticmethod
    def Pi() -> float: ...

    @staticmethod
    def PlaneIntersectsAABB(
        bounds: Sequence[float], normal: Sequence[float], point: Sequence[float]) -> int: ...

    @staticmethod
    def PointIsWithinBounds(
        point: Sequence[float], bounds: Sequence[float], delta: Sequence[float]) -> int: ...

    @staticmethod
    def ProjectVector(a: Sequence[float], b: Sequence[float],
                      projection: MutableSequence[float]) -> bool: ...

    @staticmethod
    def ProjectVector2D(a: Sequence[float], b: Sequence[float],
                        projection: MutableSequence[float]) -> bool: ...

    @staticmethod
    def QuadraticRoot(a: float, b: float, c: float, min: float,
                      max: float, u: MutableSequence[float]) -> int: ...

    @staticmethod
    def QuaternionToMatrix3x3(
        quat: Sequence[float], A: MutableSequence[MutableSequence[float]]) -> None: ...

    @overload
    @staticmethod
    def RGBToHSV(rgb: Sequence[float],
                 hsv: MutableSequence[float]) -> None: ...
    ...
    @overload
    @staticmethod
    def RGBToLab(rgb: Sequence[float],
                 lab: MutableSequence[float]) -> None: ...
    ...
    @overload
    @staticmethod
    def RGBToXYZ(rgb: Sequence[float],
                 xyz: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def RotateVectorByNormalizedQuaternion(
        v: Sequence[float], q: Sequence[float], r: MutableSequence[float]) -> None: ...

    @staticmethod
    def RotateVectorByWXYZ(
        v: Sequence[float], q: Sequence[float], r: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def SignedAngleBetweenVectors(
        v1: Sequence[float], v2: Sequence[float], vn: Sequence[float]) -> float: ...
    ...
    @staticmethod
    def Subtract(a: Sequence[float], b: Sequence[float],
                 c: MutableSequence[float]) -> None: ...

    @staticmethod
    def Transpose3x3(A: Sequence[Sequence[float]],
                     AT: MutableSequence[MutableSequence[float]]) -> None: ...
    ...
    @overload
    @staticmethod
    def XYZToLab(xyz: Sequence[float],
                 lab: MutableSequence[float]) -> None: ...
    ...
    @overload
    @staticmethod
    def XYZToRGB(xyz: Sequence[float],
                 rgb: MutableSequence[float]) -> None: ...
...
class vtkObjectFactory(vtkObject):
    @staticmethod
    def CreateAllInstance(
        vtkclassname: str, retList: vtkCollection) -> None: ...

    @staticmethod
    def CreateInstance(vtkclassname: str,
                       isAbstract: bool = False) -> vtkObject: ...
    ...
    @staticmethod
    def GetOverrideInformation(
        name: str, __b: vtkOverrideInformationCollection) -> None: ...
    ...
    @overload
    @staticmethod
    def SetAllEnableFlags(flag: int, className: str,
                          subclassName: str) -> None: ...
    def SetEnableFlag(self, flag: int, className: str,
                      subclassName: str) -> None: ...
...
class vtkOldStyleCallbackCommand(vtkCommand):
    def Execute(self, invoker: vtkObject, eid: int,
                calldata: Pointer) -> None: ...
...
class vtkPoints(vtkObject):
    ...
    @overload
    def InsertPoints(self, dstIds: vtkIdList, srcIds: vtkIdList,
                     source: vtkPoints) -> None: ...

    @overload
    def InsertPoints(self, dstStart: int, n: int,
                     srcStart: int, source: vtkPoints) -> None: ...
...
class vtkRandomPool(vtkObject):
    ...
    @overload
    def PopulateDataArray(self, da: vtkDataArray,
                          minRange: float, maxRange: float) -> None: ...

    @overload
    def PopulateDataArray(self, da: vtkDataArray, compNumber: int,
                          minRange: float, maxRange: float) -> None: ...
...
class vtkSOADataArrayTemplate_IaE(vtkGenericDataArray_I23vtkSOADataArrayTemplateIaEaE):
    ...
    def SetArray(
        self, comp: int, array: Buffer, size: int, updateMaxId: bool = False, save: bool = False, deleteMethod: int = ...
    ) -> None: ...
    def SetNumberOfComponents(self, numComps: int) -> None: ...
    def SetTypedComponent(self, tupleIdx: int, comp: int,
                          value: int) -> None: ...
...
class vtkSortDataArray(vtkObject):
    ...
    def GenerateSortIndices(
        dataType: int, dataIn: Pointer, numKeys: int, numComp: int, k: int, idx: MutableSequence[int]
    ) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    ...
    @staticmethod
    def ShuffleArray(
        idx: MutableSequence[int], dataType: int, numKeys: int, numComp: int, arr: vtkAbstractArray, dataIn: Pointer, dir: int
    ) -> None: ...
    ...
    @overload
    @staticmethod
    def Sort(keys: vtkAbstractArray,
             values: vtkAbstractArray, dir: int) -> None: ...
    ...
    @overload
    @staticmethod
    def SortArrayByComponent(arr: vtkAbstractArray,
                             k: int, dir: int) -> None: ...
...
class vtkStringArray(vtkAbstractArray):
    ...
    @overload
    def GetTuples(self, ptIds: vtkIdList,
                  output: vtkAbstractArray) -> None: ...
...
class vtkTimePointUtility(vtkObject):
    ...
    @staticmethod
    def DateTimeToTimePoint(year: int, month: int, day: int, hour: int,
    ...
    @staticmethod
    def GetDateTime(time: int, year: int, month: int, day: int,
                    hour: int, minute: int, second: int, millis: int) -> None: ...
    ...
    @staticmethod
    def GetTime(time: int, hour: int, minute: int,
                second: int, millis: int) -> None: ...

    @staticmethod
    def GetYear(time: int) -> int: ...

    @staticmethod
    def ISO8601ToTimePoint(
        str: str, ok: MutableSequence[bool] = ...) -> int: ...
    ...
    @staticmethod
    def TimeToTimePoint(hour: int, minute: int, second: int,
                        millis: int = 0) -> int: ...
...
class vtkVariantArray(vtkAbstractArray):
    ...
    @overload
    def SetVoidArray(self, arr: Pointer, size: int,
                     save: int, deleteM: int) -> None: ...
...
class vtkWindow(vtkObject):
    ...
    @overload
    def GetPixelData(self, __a: int, __b: int, __c: int,
                     __d: int, __e: int, __f: int) -> Pointer: ...

    @overload
    def GetPixelData(self, __a: int, __b: int, __c: int, __d: int,
    ...
    @overload
    def SetTileViewport(self, _arg1: float, _arg2: float,
                        _arg3: float, _arg4: float) -> None: ...
