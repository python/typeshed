...
class vtkImageAccumulate(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageAccumulate: ...

    @overload
    def SetComponentExtent(self, extent: MutableSequence[int]) -> None: ...

    @overload
    def SetComponentExtent(self, minX: int, maxX: int, minY: int,
                           maxY: int, minZ: int, maxZ: int) -> None: ...

    @overload
    def SetComponentOrigin(
...
class vtkImageHistogram(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageHistogram: ...
...
class vtkImageHistogramStatistics(vtkImageHistogram):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageHistogramStatistics: ...

    @overload
    def SetAutoRangeExpansionFactors(
