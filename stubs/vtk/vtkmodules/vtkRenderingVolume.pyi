...
class vtkEncodedGradientShader(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetBlueDiffuseShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> Pointer: ...
    def GetBlueSpecularShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> Pointer: ...
    def GetGreenDiffuseShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> Pointer: ...
    def GetGreenSpecularShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> Pointer: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetRedDiffuseShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> Pointer: ...
    def GetRedSpecularShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> Pointer: ...
