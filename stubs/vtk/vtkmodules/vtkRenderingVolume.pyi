...
class vtkDirectionEncoder(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetDecodedGradientTable(self) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDirectionEncoder: ...
...
class vtkEncodedGradientEstimator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetCircleLimits(self) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEncodedGradientEstimator: ...
    @overload
...
class vtkEncodedGradientShader(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetBlueDiffuseShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> _Pointer: ...
    def GetBlueSpecularShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> _Pointer: ...
    def GetGreenDiffuseShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> _Pointer: ...
    def GetGreenSpecularShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> _Pointer: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetRedDiffuseShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> _Pointer: ...
    def GetRedSpecularShadingTable(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEncodedGradientShader: ...
...
class vtkFiniteDifferenceGradientEstimator(vtkEncodedGradientEstimator):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFiniteDifferenceGradientEstimator: ...
...
class vtkFixedPointRayCastImage(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointRayCastImage: ...
    @overload
...
class vtkFixedPointVolumeRayCastHelper(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastHelper: ...
...
class vtkFixedPointVolumeRayCastCompositeGOHelper(vtkFixedPointVolumeRayCastHelper):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastCompositeGOHelper: ...
...
class vtkFixedPointVolumeRayCastCompositeGOShadeHelper(vtkFixedPointVolumeRayCastHelper):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastCompositeGOShadeHelper: ...
...
class vtkFixedPointVolumeRayCastCompositeHelper(vtkFixedPointVolumeRayCastHelper):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastCompositeHelper: ...
...
class vtkFixedPointVolumeRayCastCompositeShadeHelper(vtkFixedPointVolumeRayCastHelper):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastCompositeShadeHelper: ...
...
class vtkFixedPointVolumeRayCastMIPHelper(vtkFixedPointVolumeRayCastHelper):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastMIPHelper: ...
...
class vtkVolumeMapper(vtkmodules.vtkRenderingCore.vtkAbstractVolumeMapper):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeMapper: ...
    @overload
...
class vtkFixedPointVolumeRayCastMapper(vtkVolumeMapper):
    ...
    @overload
    def ComputeRequiredImageSampleDistance(self, desiredTime: float, ren: vtkmodules.vtkRenderingCore.vtkRenderer) -> float: ...
    @overload
    ...
    def GetColorTable(self, c: int) -> _Pointer: ...
    ...
    def GetDiffuseShadingTable(self, c: int) -> _Pointer: ...
    @overload
    def GetEstimatedRenderTime(
        self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, vol: vtkmodules.vtkRenderingCore.vtkVolume
    ) -> float: ...
    @overload
    def GetEstimatedRenderTime(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer) -> float: ...
    ...
    def GetGradientOpacityTable(self, c: int) -> _Pointer: ...
    def GetImageSampleDistance(self) -> float: ...
    ...
    def GetRowBounds(self) -> _Pointer: ...
    def GetSampleDistance(self) -> float: ...
    def GetScalarOpacityTable(self, c: int) -> _Pointer: ...
    def GetShadingRequired(self) -> int: ...
    def GetSpecularShadingTable(self, c: int) -> _Pointer: ...
    ...
    def InitializeRayInfo(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFixedPointVolumeRayCastMapper: ...
    ...
    def ShouldUseNearestNeighborInterpolation(self, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> int: ...
    @overload
...
class vtkGPUVolumeRayCastMapper(vtkVolumeMapper):
    ...
    def GPURender(self, __a: vtkmodules.vtkRenderingCore.vtkRenderer, __b: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    def GetAutoAdjustSampleDistances(self) -> int: ...
    def GetAutoAdjustSampleDistancesMaxValue(self) -> int: ...
    def GetAutoAdjustSampleDistancesMinValue(self) -> int: ...
    ...
    def GetDepthPassContourValues(self) -> vtkmodules.vtkCommonMisc.vtkContourValues: ...
    def GetFinalColorLevel(self) -> float: ...
    def GetFinalColorWindow(self) -> float: ...
    ...
    def GetTransformedInput(self, port: int = 0) -> vtkmodules.vtkCommonDataModel.vtkDataSet: ...
    ...
    def ReleaseGraphicsResources(self, __a: vtkmodules.vtkCommonCore.vtkWindow) -> None: ...
    @overload
    def RemoveInputConnection(self, port: int, input: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    @overload
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGPUVolumeRayCastMapper: ...
    def SetAutoAdjustSampleDistances(self, _arg: int) -> None: ...
    ...
    def SetMaskInput(self, mask: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkMultiVolume(vtkmodules.vtkRenderingCore.vtkVolume):
    ...
    def GetDataBounds(self) -> _Pointer: ...
    def GetDataGeometry(self) -> _Pointer: ...
    ...
    def GetVolume(self, port: int = 0) -> vtkmodules.vtkRenderingCore.vtkVolume: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkMultiVolume: ...
    def RemoveVolume(self, port: int) -> None: ...
    def RenderVolumetricGeometry(self, vp: vtkmodules.vtkRenderingCore.vtkViewport) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMultiVolume: ...
    def SetProperty(self, property: vtkmodules.vtkRenderingCore.vtkVolumeProperty) -> None: ...
    def SetVolume(self, volume: vtkmodules.vtkRenderingCore.vtkVolume, port: int = 0) -> None: ...
...
class vtkOSPRayVolumeInterface(vtkVolumeMapper):
    ...
    def Render(self, __a: vtkmodules.vtkRenderingCore.vtkRenderer, __b: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOSPRayVolumeInterface: ...
...
class vtkUnstructuredGridVolumeMapper(vtkmodules.vtkRenderingCore.vtkAbstractVolumeMapper):
    ...
    def Render(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridVolumeMapper: ...
    def SetBlendMode(self, _arg: int) -> None: ...
    def SetBlendModeToComposite(self) -> None: ...
    def SetBlendModeToMaximumIntensity(self) -> None: ...
    @overload
    def SetInputData(self, __a: vtkmodules.vtkCommonDataModel.vtkUnstructuredGridBase) -> None: ...
    @overload
    def SetInputData(self, __a: vtkmodules.vtkCommonDataModel.vtkDataSet) -> None: ...
...
class vtkProjectedTetrahedraMapper(vtkUnstructuredGridVolumeMapper):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetVisibilitySort(self) -> vtkmodules.vtkRenderingCore.vtkVisibilitySort: ...
    def IsA(self, type: str) -> int: ...
    def IsSupported(self, __a: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> bool: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProjectedTetrahedraMapper: ...
    def SetVisibilitySort(self, sort: vtkmodules.vtkRenderingCore.vtkVisibilitySort) -> None: ...
    @staticmethod
    def TransformPoints(
...
class vtkRayCastImageDisplayHelper(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRayCastImageDisplayHelper: ...
...
class vtkRecursiveSphereDirectionEncoder(vtkDirectionEncoder):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRecursiveSphereDirectionEncoder: ...
...
class vtkSphericalDirectionEncoder(vtkDirectionEncoder):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSphericalDirectionEncoder: ...
...
class vtkUnstructuredGridVolumeRayCastFunction(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def Initialize(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridVolumeRayCastFunction: ...
...
class vtkUnstructuredGridBunykRayCastFunction(vtkUnstructuredGridVolumeRayCastFunction):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetPoints(self) -> _Pointer: ...
    def GetViewToWorldMatrix(self) -> vtkmodules.vtkCommonMath.vtkMatrix4x4: ...
    def Initialize(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    ...
    def NewIterator(self) -> vtkUnstructuredGridVolumeRayCastIterator: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridBunykRayCastFunction: ...
...
class vtkUnstructuredGridVolumeRayIntegrator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridVolumeRayIntegrator: ...
...
class vtkUnstructuredGridHomogeneousRayIntegrator(vtkUnstructuredGridVolumeRayIntegrator):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridHomogeneousRayIntegrator: ...
...
class vtkUnstructuredGridLinearRayIntegrator(vtkUnstructuredGridVolumeRayIntegrator):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridLinearRayIntegrator: ...
...
class vtkUnstructuredGridPartialPreIntegration(vtkUnstructuredGridVolumeRayIntegrator):
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    @staticmethod
    def GetPsiTable(size: int) -> _Pointer: ...
    def Initialize(
        self, volume: vtkmodules.vtkRenderingCore.vtkVolume, scalars: vtkmodules.vtkCommonCore.vtkDataArray
    ) -> None: ...
    def Integrate(
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridPartialPreIntegration: ...
...
class vtkUnstructuredGridPreIntegration(vtkUnstructuredGridVolumeRayIntegrator):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetPreIntegrationTable(self, component: int = 0) -> _Pointer: ...
    def GetTableEntry(self, scalar_front: float, scalar_back: float, length: float, component: int = 0) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridPreIntegration: ...
...
class vtkUnstructuredGridVolumeRayCastIterator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridVolumeRayCastIterator: ...
    @overload
...
class vtkUnstructuredGridVolumeRayCastMapper(vtkUnstructuredGridVolumeMapper):
    ...
    def Render(self, __a: vtkmodules.vtkRenderingCore.vtkRenderer, __b: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridVolumeRayCastMapper: ...
    def SetAutoAdjustSampleDistances(self, _arg: int) -> None: ...
    def SetImageSampleDistance(self, _arg: float) -> None: ...
    def SetIntermixIntersectingGeometry(self, _arg: int) -> None: ...
    def SetMaximumImageSampleDistance(self, _arg: float) -> None: ...
...
class vtkUnstructuredGridVolumeZSweepMapper(vtkUnstructuredGridVolumeMapper):
    ...
    def Render(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, vol: vtkmodules.vtkRenderingCore.vtkVolume) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridVolumeZSweepMapper: ...
    def SetAutoAdjustSampleDistances(self, _arg: int) -> None: ...
    def SetImageSampleDistance(self, _arg: float) -> None: ...
    def SetIntermixIntersectingGeometry(self, _arg: int) -> None: ...
...
class vtkVolumeOutlineSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeOutlineSource: ...
    @overload
...
class vtkVolumePicker(vtkmodules.vtkRenderingCore.vtkCellPicker):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumePicker: ...
...
class vtkVolumeRayCastSpaceLeapingImageFilter(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetMinMaxVolume(self, dims: MutableSequence[int]) -> _Pointer: ...
    def GetMinNonZeroGradientMagnitudeIndex(self) -> _Pointer: ...
    def GetMinNonZeroScalarIndex(self) -> _Pointer: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeRayCastSpaceLeapingImageFilter: ...
    def SetCache(self, imageCache: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
    def SetComputeGradientOpacity(self, _arg: int) -> None: ...
    def SetComputeMinMax(self, _arg: int) -> None: ...
    def SetCurrentScalars(self, __a: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...
