...
class vtkGeoJSONFeature(vtkmodules.vtkCommonDataModel.vtkDataObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeoJSONFeature: ...

    def SetOutlinePolygons(self, _arg: bool) -> None: ...


class vtkGeoJSONReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    def AddFeatureProperty(
        self, name: str, typeAndDefaultValue: vtkmodules.vtkCommonCore.vtkVariant) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeoJSONReader: ...
...
class vtkGeoJSONWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeoJSONWriter: ...

    def SetFileName(self, _arg: str) -> None: ...
    def SetLookupTable(
        self, lut: vtkmodules.vtkCommonCore.vtkLookupTable) -> None: ...
