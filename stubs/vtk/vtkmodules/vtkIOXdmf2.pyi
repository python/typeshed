...
class vtkSILBuilder(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSILBuilder: ...
    def SetSIL(
        self, __a: vtkmodules.vtkCommonDataModel.vtkMutableDirectedGraph) -> None: ...
...
class vtkXdmfDataArray(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXdmfDataArray: ...
    ...
    def ToXdmfArray(self, DataArray: vtkmodules.vtkCommonCore.vtkDataArray = ...,
                    CopyShape: int = 1) -> str: ...
...
class vtkXdmfReader(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXdmfReader: ...
...
class vtkXdmfWriter(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXdmfWriter: ...

    def SetFileName(self, _arg: str) -> None: ...
    def SetHeavyDataFileName(self, _arg: str) -> None: ...
    def SetHeavyDataGroupName(self, _arg: str) -> None: ...
    def SetInputData(
        self, dobj: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
