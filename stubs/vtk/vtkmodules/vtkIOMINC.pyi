...
class vtkMINCImageAttributes(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetAttributeNames(
        self, variable: str) -> vtkmodules.vtkCommonCore.vtkStringArray: ...

    def GetAttributeValueAsArray(
        self, variable: str, attribute: str) -> vtkmodules.vtkCommonCore.vtkDataArray: ...
    def GetAttributeValueAsDouble(
        self, variable: str, attribute: str) -> float: ...

    def GetAttributeValueAsInt(self, variable: str, attribute: str) -> int: ...
    def GetAttributeValueAsString(
        self, variable: str, attribute: str) -> str: ...

    def GetDataType(self) -> int: ...
    def GetDimensionLengths(
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMINCImageAttributes: ...

    def SetAttributeValueAsArray(self, variable: str, attribute: str,
                                 array: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...

    def SetAttributeValueAsDouble(
        self, variable: str, attribute: str, value: float) -> None: ...

    def SetAttributeValueAsInt(
        self, variable: str, attribute: str, value: int) -> None: ...
    def SetAttributeValueAsString(
        self, variable: str, attribute: str, value: str) -> None: ...

    def SetDataType(self, _arg: int) -> None: ...

    def SetImageMax(
        self, imageMax: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...
    def SetImageMin(
        self, imageMin: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...
    ...
    def ValidateAttribute(self, varname: str, attname: str,
                          array: vtkmodules.vtkCommonCore.vtkDataArray) -> int: ...
...
class vtkMINCImageReader(vtkmodules.vtkIOImage.vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMINCImageReader: ...
...
class vtkMINCImageWriter(vtkmodules.vtkIOImage.vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMINCImageWriter: ...
    def SetDirectionCosines(
        self, matrix: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...

    def SetFileName(self, name: str) -> None: ...
    def SetHistoryAddition(self, _arg: str) -> None: ...
    def SetImageAttributes(
        self, attributes: vtkMINCImageAttributes) -> None: ...
...
class vtkMNIObjectReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMNIObjectReader: ...
...
class vtkMNIObjectWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMNIObjectWriter: ...
    ...
    def SetLookupTable(
        self, table: vtkmodules.vtkCommonCore.vtkLookupTable) -> None: ...

    def SetMapper(
        self, mapper: vtkmodules.vtkRenderingCore.vtkMapper) -> None: ...
    def SetProperty(
        self, property: vtkmodules.vtkRenderingCore.vtkProperty) -> None: ...
...
class vtkMNITagPointReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMNITagPointReader: ...
...
class vtkMNITagPointWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMNITagPointWriter: ...

    def SetComments(self, _arg: str) -> None: ...
    def SetFileName(self, _arg: str) -> None: ...

    def SetLabelText(
        self, a: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...

    def SetPatientIds(
        self, a: vtkmodules.vtkCommonCore.vtkIntArray) -> None: ...

    @overload
    def SetPoints(self, port: int,
                  points: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
    ...
    def SetStructureIds(
        self, a: vtkmodules.vtkCommonCore.vtkIntArray) -> None: ...
    def SetWeights(
        self, a: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...
...
class vtkMNITransformReader(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    def GetFileName(self) -> str: ...
    def GetNthTransform(
        self, i: int) -> vtkmodules.vtkCommonTransforms.vtkAbstractTransform: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMNITransformReader: ...
...
class vtkMNITransformWriter(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMNITransformWriter: ...
