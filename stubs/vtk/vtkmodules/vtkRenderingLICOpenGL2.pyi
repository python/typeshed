...
class vtkCompositeSurfaceLICMapper(vtkmodules.vtkRenderingOpenGL2.vtkCompositePolyDataMapper2):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeSurfaceLICMapper: ...
...
class vtkImageDataLIC2D(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageDataLIC2D: ...
    def SetContext(
        self, context: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> int: ...

    def SetMagnification(self, _arg: int) -> None: ...
    def SetStepSize(self, _arg: float) -> None: ...
    def SetSteps(self, _arg: int) -> None: ...
    def TranslateInputExtent(
        self, inExt: Sequence[int], inWholeExtent: Sequence[int], outExt: MutableSequence[int]) -> None: ...
...
class vtkLineIntegralConvolution2D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLineIntegralConvolution2D: ...
    ...
    def SetContext(
        self, context: vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow) -> None: ...
    ...
    @staticmethod
    def SetNoiseTexParameters(
        noise: vtkmodules.vtkRenderingOpenGL2.vtkTextureObject) -> None: ...
    ...
    @staticmethod
    def SetVectorTexParameters(
        vectors: vtkmodules.vtkRenderingOpenGL2.vtkTextureObject) -> None: ...
...
class vtkStructuredGridLIC2D(vtkmodules.vtkCommonExecutionModel.vtkStructuredGridAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStructuredGridLIC2D: ...
    def SetContext(
        self, context: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> int: ...
...
class vtkSurfaceLICComposite(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetCompositeExtent(
        self, i: int = 0) -> vtkmodules.vtkCommonDataModel.vtkPixelExtent: ...

    def GetContext(
        self) -> vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow: ...

    def GetDataSetExtent(
        self) -> vtkmodules.vtkCommonDataModel.vtkPixelExtent: ...

    def GetDisjointGuardExtent(
        self, i: int = 0) -> vtkmodules.vtkCommonDataModel.vtkPixelExtent: ...
    def GetGuardExtent(
        self, i: int = 0) -> vtkmodules.vtkCommonDataModel.vtkPixelExtent: ...
    ...
    def GetWindowExtent(
        self) -> vtkmodules.vtkCommonDataModel.vtkPixelExtent: ...
    def InitializeCompositeExtents(
        self, vectors: MutableSequence[float]) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSurfaceLICComposite: ...
    def SetContext(
        self, __a: vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow) -> None: ...
...
class vtkSurfaceLICInterface(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def CanRenderSurfaceLIC(
        self, actor: vtkmodules.vtkRenderingCore.vtkActor) -> bool: ...
    ...
    @staticmethod
    def IsSupported(
        context: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSurfaceLICInterface: ...
    ...
    def SetNoiseDataSet(
        self, data: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkSurfaceLICMapper(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLPolyDataMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSurfaceLICMapper: ...
    def ShallowCopy(
        self, __a: vtkmodules.vtkRenderingCore.vtkAbstractMapper) -> None: ...
