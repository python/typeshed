...
class vtkOpenGLContextActor(vtkmodules.vtkRenderingContext2D.vtkContextActor):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLContextActor: ...
...
class vtkOpenGLContextBufferId(vtkmodules.vtkRenderingContext2D.vtkAbstractContextBufferId):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLContextBufferId: ...
    def SetContext(
...
class vtkOpenGLContextDevice2D(vtkmodules.vtkRenderingContext2D.vtkContextDevice2D):
    ...
    def BufferIdModeBegin(
        self, bufferId: vtkmodules.vtkRenderingContext2D.vtkAbstractContextBufferId) -> None: ...
    ...
    def DrawPoly(self, f: MutableSequence[float], n: int,
                 colors: MutableSequence[int] = ..., nc_comps: int = 0) -> None: ...
    ...
    def DrawQuadStrip(
        self, points: MutableSequence[float], n: int) -> None: ...
    def DrawString(
        self, point: MutableSequence[float], string: str) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLContextDevice2D: ...
...
class vtkOpenGLContextDevice3D(vtkmodules.vtkRenderingContext2D.vtkContextDevice3D):
    ...
    def DrawLines(self, verts: Sequence[float], n: int,
                  colors: Sequence[int], nc: int) -> None: ...

    def DrawPoints(
        self, verts: Sequence[float], n: int, colors: Sequence[int], nc: int) -> None: ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def Initialize(self, __a: vtkmodules.vtkRenderingCore.vtkRenderer,
                   __b: vtkOpenGLContextDevice2D) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLContextDevice3D: ...
    def SetClipping(
...
class vtkOpenGLPropItem(vtkmodules.vtkRenderingContext2D.vtkPropItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLPropItem: ...
