...
class vtkEnSightWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSightWriter: ...
    ...
    def SetInputData(self, input: vtkmodules.vtkCommonDataModel.vtkUnstructuredGrid) -> None: ...
...
class vtkMultiBlockPLOT3DReader(vtkmodules.vtkCommonExecutionModel.vtkParallelReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMultiBlockPLOT3DReader: ...
...
class vtkPChacoReader(vtkmodules.vtkIOGeometry.vtkChacoReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPChacoReader: ...
    def SetController(self, c: vtkmodules.vtkParallelCore.vtkMultiProcessController) -> None: ...
...
class vtkPDataSetReader(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPDataSetReader: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkPDataSetWriter(vtkmodules.vtkIOLegacy.vtkDataSetWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPDataSetWriter: ...
...
class vtkPImageWriter(vtkmodules.vtkIOImage.vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPImageWriter: ...
...
class vtkPOpenFOAMReader(vtkmodules.vtkIOGeometry.vtkOpenFOAMReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPOpenFOAMReader: ...
...
class vtkPlot3DMetaReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPlot3DMetaReader: ...
    def SetFileName(self, _arg: str) -> None: ...
