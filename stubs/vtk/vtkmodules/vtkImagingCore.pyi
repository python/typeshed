...
class vtkAbstractImageInterpolator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ComputeSupportSize(
        self, matrix: Sequence[float], support: MutableSequence[int]) -> None: ...
    ...
    @overload
    def Interpolate(self, x: float, y: float, z: float,
                    component: int) -> float: ...

    @overload
    def Interpolate(
        self, point: Sequence[float], value: MutableSequence[float]) -> bool: ...
    def InterpolateIJK(
        self, point: Sequence[float], value: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractImageInterpolator: ...
...
class vtkExtractVOI(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExtractVOI: ...
    ...
    @overload
    def SetVOI(self, _arg1: int, _arg2: int, _arg3: int,
...
class vtkImageInterpolator(vtkAbstractImageInterpolator):
    def ComputeSupportSize(
        self, matrix: Sequence[float], size: MutableSequence[int]) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageInterpolator: ...
...
class vtkGenericImageInterpolator(vtkImageInterpolator):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericImageInterpolator: ...
...
class vtkImageAppendComponents(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageAppendComponents: ...
...
class vtkImageBSplineCoefficients(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def Evaluate(self, point: Sequence[float],
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageBSplineCoefficients: ...
...
class vtkImageBSplineInternals:
    ...
    @staticmethod
    def GetInterpolationWeights(
        weights: MutableSequence[float], w: float, degree: int) -> int: ...

    @staticmethod
    def GetPoleValues(
        poles: MutableSequence[float], numPoles: int, degree: int) -> int: ...
...
class vtkImageBSplineInterpolator(vtkAbstractImageInterpolator):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageBSplineInterpolator: ...
...
class vtkImageBlend(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageBlend: ...
...
class vtkImageCacheFilter(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageCacheFilter: ...
...
class vtkImageCast(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageCast: ...
...
class vtkImageChangeInformation(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @overload
    def SetOutputOrigin(self, _arg1: float, _arg2: float,
                        _arg3: float) -> None: ...
    ...
    @overload
    def SetOutputSpacing(self, _arg1: float, _arg2: float,
                         _arg3: float) -> None: ...
    ...
    @overload
    def SetSpacingScale(self, _arg1: float, _arg2: float,
                        _arg3: float) -> None: ...
...
class vtkImageClip(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageClip: ...
...
class vtkImagePadFilter(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImagePadFilter: ...
...
class vtkImageConstantPad(vtkImagePadFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageConstantPad: ...

    def SetConstant(self, _arg: float) -> None: ...


class vtkImageDataStreamer(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    def GetExtentTranslator(
        self) -> vtkmodules.vtkCommonExecutionModel.vtkExtentTranslator: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageDataStreamer: ...
    def SetExtentTranslator(
        self, __a: vtkmodules.vtkCommonExecutionModel.vtkExtentTranslator) -> None: ...
...
class vtkImageIterateFilter(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageIterateFilter: ...
...
class vtkImageDecomposeFilter(vtkImageIterateFilter):
    ...
    def PermuteIncrements(
        self, increments: MutableSequence[int], inc0: int, inc1: int, inc2: int) -> None: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageDecomposeFilter: ...
...
class vtkImageDifference(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageDifference: ...
    ...
    def SetImageConnection(
        self, output: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetImageData(
        self, image: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
...
class vtkImageExtractComponents(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageExtractComponents: ...
...
class vtkImageReslice(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def GetResliceAxesDirectionCosines(
        self, xyz: MutableSequence[float]) -> None: ...

    @overload
    def GetResliceAxesDirectionCosines(
        self) -> Tuple[float, float, float, float, float, float, float, float, float]: ...

    @overload
    def GetResliceAxesOrigin(self, xyz: MutableSequence[float]) -> None: ...
    @overload
    def GetResliceAxesOrigin(self) -> Tuple[float, float, float]: ...
    def GetResliceTransform(
    ...
    def ReportReferences(
        self, __a: vtkmodules.vtkCommonCore.vtkGarbageCollector) -> None: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageReslice: ...

    def SetAutoCropOutput(self, _arg: int) -> None: ...

    @overload
    def SetBackgroundColor(self, _arg1: float, _arg2: float,
    ...
    def SetInterpolator(
        self, sampler: vtkAbstractImageInterpolator) -> None: ...
    ...
    @overload
    def SetOutputExtent(self, a: int, b: int, c: int,
                        d: int, e: int, f: int) -> None: ...
    ...
    @overload
    def SetResliceAxesDirectionCosines(
        self, x: Sequence[float], y: Sequence[float], z: Sequence[float]) -> None: ...
...
class vtkImageFlip(vtkImageReslice):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageFlip: ...
...
class vtkImageMagnify(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageMagnify: ...

    def SetInterpolate(self, _arg: int) -> None: ...

    @overload
    def SetMagnificationFactors(
        self, _arg1: int, _arg2: int, _arg3: int) -> None: ...
...
class vtkImageMapToColors(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageMapToColors: ...
    ...
    @overload
    def SetNaNColor(self, _arg1: int, _arg2: int,
...
class vtkImageMask(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageMask: ...

    def SetImageInputData(
    ...
    def SetMaskInputData(
        self, in_: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...

    @overload
    def SetMaskedOutputValue(
        self, num: int, v: MutableSequence[float]) -> None: ...
    ...
    @overload
    def SetMaskedOutputValue(
        self, v1: float, v2: float, v3: float) -> None: ...
...
class vtkImageMirrorPad(vtkImagePadFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageMirrorPad: ...
...
class vtkImagePermute(vtkImageReslice):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImagePermute: ...
...
class vtkImageProbeFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageProbeFilter: ...

    def SetInterpolator(
        self, interpolator: vtkAbstractImageInterpolator) -> None: ...
...
class vtkImageResample(vtkImageReslice):
    def GetAxisMagnificationFactor(
        self, axis: int, inInfo: vtkmodules.vtkCommonCore.vtkInformation = ...) -> float: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageResample: ...
    ...
    @overload
    def SetMagnificationFactors(
        self, fx: float, fy: float, fz: float) -> None: ...
...
class vtkImageResize(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetCroppingRegion(self) -> Tuple[float,
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageResize: ...

    def SetBorder(self, _arg: int) -> None: ...
    def SetCropping(self, _arg: int) -> None: ...

    @overload
    def SetCroppingRegion(self, _arg1: float, _arg2: float, _arg3: float,
    ...
    @overload
    def SetOutputDimensions(self, _arg1: int, _arg2: int,
                            _arg3: int) -> None: ...
...
class vtkImageResliceToColors(vtkImageReslice):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageResliceToColors: ...

    def SetBypass(self, bypass: int) -> None: ...
    def SetLookupTable(
        self, table: vtkmodules.vtkCommonCore.vtkScalarsToColors) -> None: ...
...
class vtkImageShiftScale(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageShiftScale: ...
...
class vtkImageShrink3D(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageShrink3D: ...
...
class vtkImageSincInterpolator(vtkAbstractImageInterpolator):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageSincInterpolator: ...
...
class vtkImageStencilAlgorithm(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageStencilAlgorithm: ...
...
class vtkImageStencilData(vtkmodules.vtkCommonDataModel.vtkDataObject):
    ...
    def CopyInformationToPipeline(
        self, info: vtkmodules.vtkCommonCore.vtkInformation) -> None: ...
    def DeepCopy(
        self, o: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
    ...
    @staticmethod
    def GetData(
        info: vtkmodules.vtkCommonCore.vtkInformation) -> vtkImageStencilData: ...

    @overload
    @staticmethod
    def GetData(v: vtkmodules.vtkCommonCore.vtkInformationVector,
                i: int = 0) -> vtkImageStencilData: ...

    def GetDataObjectType(self) -> int: ...
    def GetExtent(self) -> Tuple[int, int, int, int, int, int]: ...
    def GetExtentType(self) -> int: ...
    def GetNextExtent(self, r1: int, r2: int, xMin: int,
                      xMax: int, yIdx: int, zIdx: int, iter: int) -> int: ...
    ...
    def InsertAndMergeExtent(self, r1: int, r2: int,
                             yIdx: int, zIdx: int) -> None: ...
    def InsertNextExtent(self, r1: int, r2: int,
                         yIdx: int, zIdx: int) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageStencilData: ...
    ...
    def ShallowCopy(
        self, f: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
...
class vtkImageStencilRaster:
    ...
    def FillStencilData(self, data: vtkImageStencilData,
                        extent: Sequence[int], xj: int = 0, yj: int = 1) -> None: ...

    def GetTolerance(self) -> float: ...

    def InsertLine(self, pt1: Sequence[float],
                   pt2: Sequence[float]) -> None: ...
    def PrepareForNewData(
        self, allocateExtent: Sequence[int] = ...) -> None: ...
...
class vtkImageStencilSource(vtkImageStencilAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageStencilSource: ...
    ...
    @overload
    def SetOutputWholeExtent(self, _arg1: int, _arg2: int,
                             _arg3: int, _arg4: int, _arg5: int, _arg6: int) -> None: ...
...
class vtkImageThreshold(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageThreshold: ...
...
class vtkImageTranslateExtent(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageTranslateExtent: ...
...
class vtkImageWrapPad(vtkImagePadFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageWrapPad: ...
...
class vtkRTAnalyticSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRTAnalyticSource: ...
    ...
    def SetWholeExtent(self, xMinx: int, xMax: int, yMin: int,
