...
class vtkDataReader(vtkmodules.vtkCommonExecutionModel.vtkSimpleReader):
    ...
    def ReadArray(self, dataType: str, numTuples: int,
                  numComp: int) -> vtkmodules.vtkCommonCore.vtkAbstractArray: ...

    def ReadArrays(self, __a: int, __b: int, __c: int, __d: int,
                   __e: vtkmodules.vtkCommonDataModel.vtkDataObject) -> int: ...

    def ReadArraysSimple(
        self, __a: str, __b: vtkmodules.vtkCommonDataModel.vtkDataObject) -> int: ...

    def ReadCellData(
        self, ds: vtkmodules.vtkCommonDataModel.vtkDataSet, numCells: int) -> int: ...

    def ReadCells(
        self, cellArray: vtkmodules.vtkCommonDataModel.vtkCellArray) -> int: ...

    @overload
    def ReadCellsLegacy(
        self, size: int, data: MutableSequence[int]) -> int: ...

    @overload
    def ReadCellsLegacy(
        self, size: int, data: MutableSequence[int], skip1: int, read2: int, skip3: int) -> int: ...

    def ReadCoordinates(self, rg: vtkmodules.vtkCommonDataModel.vtkRectilinearGrid,
                        axes: int, numCoords: int) -> int: ...

    def ReadEdgeData(
        self, g: vtkmodules.vtkCommonDataModel.vtkGraph, numEdges: int) -> int: ...
    def ReadFieldData(
        self, fieldType: vtkmodules.vtkIOXML.FieldType = ...) -> vtkmodules.vtkCommonDataModel.vtkFieldData: ...
    ...
    @overload
    def ReadPointCoordinates(
        self, ps: vtkmodules.vtkCommonDataModel.vtkPointSet, numPts: int) -> int: ...

    @overload
    def ReadPointCoordinates(
        self, g: vtkmodules.vtkCommonDataModel.vtkGraph, numPts: int) -> int: ...

    def ReadPointData(
        self, ds: vtkmodules.vtkCommonDataModel.vtkDataSet, numPts: int) -> int: ...

    def ReadPoints(self, __a: int, __b: int, __c: int, __d: int,
                   __e: vtkmodules.vtkCommonDataModel.vtkDataObject) -> int: ...

    def ReadPointsSimple(
        self, __a: str, __b: vtkmodules.vtkCommonDataModel.vtkDataObject) -> int: ...
    def ReadRowData(self, t: vtkmodules.vtkCommonDataModel.vtkTable,
                    numEdges: int) -> int: ...
    ...
    def ReadVertexData(
        self, g: vtkmodules.vtkCommonDataModel.vtkGraph, numVertices: int) -> int: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataReader: ...
    ...
    def SetInputArray(
        self, __a: vtkmodules.vtkCommonCore.vtkCharArray) -> None: ...
...
class vtkCompositeDataReader(vtkDataReader):
    ...
    @overload
    def GetOutput(
        self, idx: int) -> vtkmodules.vtkCommonDataModel.vtkCompositeDataSet: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeDataReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkCompositeDataSet) -> None: ...
...
class vtkDataWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataWriter: ...
...
class vtkCompositeDataWriter(vtkDataWriter):
    ...
    @overload
    def GetInput(
        self, port: int) -> vtkmodules.vtkCommonDataModel.vtkCompositeDataSet: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeDataWriter: ...
...
class vtkDataObjectReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataObjectReader: ...
    def SetOutput(
...
class vtkDataObjectWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataObjectWriter: ...
...
class vtkDataSetReader(vtkDataReader):
    ...
    def ReadMetaDataSimple(
        self, fname: str, metadata: vtkmodules.vtkCommonCore.vtkInformation) -> int: ...

    def ReadOutputType(self) -> int: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataSetReader: ...
...
class vtkDataSetWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataSetWriter: ...
...
class vtkGenericDataObjectReader(vtkDataReader):
    ...
    def GetTreeOutput(self) -> vtkmodules.vtkCommonDataModel.vtkTree: ...
    def GetUnstructuredGridOutput(
        self) -> vtkmodules.vtkCommonDataModel.vtkUnstructuredGrid: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericDataObjectReader: ...
...
class vtkGenericDataObjectWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericDataObjectWriter: ...
...
class vtkGraphReader(vtkDataReader):
    ...
    @overload
    def GetOutput(
        self, idx: int) -> vtkmodules.vtkCommonDataModel.vtkGraph: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphReader: ...
...
class vtkGraphWriter(vtkDataWriter):
    ...
    @overload
    def GetInput(
        self, port: int) -> vtkmodules.vtkCommonDataModel.vtkGraph: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphWriter: ...
...
class vtkPixelExtentIO:
    ...
    @staticmethod
    def Write(commRank: int, fileName: str,
              ext: vtkmodules.vtkCommonDataModel.vtkPixelExtent) -> None: ...
...
class vtkPolyDataReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
...
class vtkPolyDataWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataWriter: ...
...
class vtkRectilinearGridReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRectilinearGridReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkRectilinearGrid) -> None: ...
...
class vtkRectilinearGridWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRectilinearGridWriter: ...
...
class vtkSimplePointsReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSimplePointsReader: ...
...
class vtkSimplePointsWriter(vtkDataSetWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSimplePointsWriter: ...
...
class vtkStructuredGridReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStructuredGridReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkStructuredGrid) -> None: ...
...
class vtkStructuredGridWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStructuredGridWriter: ...
...
class vtkStructuredPointsReader(vtkDataReader):
    ...
    @overload
    def GetOutput(
        self, idx: int) -> vtkmodules.vtkCommonDataModel.vtkStructuredPoints: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStructuredPointsReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkStructuredPoints) -> None: ...
...
class vtkStructuredPointsWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStructuredPointsWriter: ...
...
class vtkTableReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTableReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkTable) -> None: ...
...
class vtkTableWriter(vtkDataWriter):
    ...
    @overload
    def GetInput(
        self, port: int) -> vtkmodules.vtkCommonDataModel.vtkTable: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTableWriter: ...
...
class vtkTreeReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
...
class vtkTreeWriter(vtkDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeWriter: ...
...
class vtkUnstructuredGridReader(vtkDataReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridReader: ...
    def SetOutput(
        self, output: vtkmodules.vtkCommonDataModel.vtkUnstructuredGrid) -> None: ...
...
class vtkUnstructuredGridWriter(vtkDataWriter):
    ...
    @overload
    def GetInput(
        self, port: int) -> vtkmodules.vtkCommonDataModel.vtkUnstructuredGridBase: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUnstructuredGridWriter: ...
