...
class vtkXMLParser(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLParser: ...
...
class vtkXMLDataParser(vtkXMLParser):
    ...
    def GetRootElement(
        self) -> vtkmodules.vtkCommonDataModel.vtkXMLDataElement: ...
    ...
    @overload
    def ReadAppendedData(self, offset: int, buffer: Pointer,
                         startWord: int, numWords: int, wordType: int) -> int: ...

    @overload
    def ReadAppendedData(self, offset: int, buffer: str,
                         startWord: int, numWords: int) -> int: ...

    def ReadAsciiData(self, buffer: Pointer, startWord: int,
                      numWords: int, wordType: int) -> int: ...

    def ReadBinaryData(self, buffer: Pointer, startWord: int,
                       maxWords: int, wordType: int) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLDataParser: ...
...
class vtkXMLUtilities(vtkmodules.vtkCommonCore.vtkObject):
    @staticmethod
    def FactorElements(
        tree: vtkmodules.vtkCommonDataModel.vtkXMLDataElement) -> None: ...
    ...
    @staticmethod
    def ReadElementFromFile(
        filename: str, encoding: int = ...) -> vtkmodules.vtkCommonDataModel.vtkXMLDataElement: ...

    @staticmethod
    def ReadElementFromString(
        str: str, encoding: int = ...) -> vtkmodules.vtkCommonDataModel.vtkXMLDataElement: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLUtilities: ...

    @staticmethod
    def UnFactorElements(
        tree: vtkmodules.vtkCommonDataModel.vtkXMLDataElement) -> None: ...
