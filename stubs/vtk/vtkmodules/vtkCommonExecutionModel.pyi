...
class vtkStreamingDemandDrivenPipeline(vtkDemandDrivenPipeline):
    ...
    @overload
    @staticmethod
    def GetUpdateExtent(__a: vtkmodules.vtkCommonCore.vtkInformation) -> _Pointer: ...
    @staticmethod
...
class vtkInformationExecutivePortVectorKey(vtkmodules.vtkCommonCore.vtkInformationKey):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetPorts(self, info: vtkmodules.vtkCommonCore.vtkInformation) -> _Pointer: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
...
class vtkScalarTree(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetCellBatch(self, batchNum: int, numCells: int) -> _Pointer: ...
...
class vtkSphereTree(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetCellSpheres(self) -> _Pointer: ...
    def GetDataSet(self) -> vtkmodules.vtkCommonDataModel.vtkDataSet: ...
    def GetMaxLevel(self) -> int: ...
    def GetMaxLevelMaxValue(self) -> int: ...
    def GetMaxLevelMinValue(self) -> int: ...
    ...
    def GetResolutionMaxValue(self) -> int: ...
    def GetResolutionMinValue(self) -> int: ...
    def GetTreeSpheres(self, level: int, numSpheres: int) -> _Pointer: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    ...
    @overload
    def SelectLine(self, origin: MutableSequence[float], ray: MutableSequence[float], numSelected: int) -> _Pointer: ...
    @overload
    def SelectLine(
        self, origin: MutableSequence[float], ray: MutableSequence[float], cellIds: vtkmodules.vtkCommonCore.vtkIdList
    ) -> None: ...
    @overload
    def SelectPlane(self, origin: MutableSequence[float], normal: MutableSequence[float], numSelected: int) -> _Pointer: ...
    @overload
    def SelectPlane(
        self, origin: MutableSequence[float], normal: MutableSequence[float], cellIds: vtkmodules.vtkCommonCore.vtkIdList
    ) -> None: ...
    @overload
    def SelectPoint(self, point: MutableSequence[float], numSelected: int) -> _Pointer: ...
    @overload
