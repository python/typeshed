...
class vtkCellDistanceSelector(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCellDistanceSelector: ...
    ...
    def SetInputSelection(
        self, obj: vtkmodules.vtkCommonDataModel.vtkSelection) -> None: ...
    def SetInputSelectionConnection(
        self, in_: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
...
class vtkKdTreeSelector(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    ...
    def GetSelectionBounds(self) -> Tuple[float,
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkKdTreeSelector: ...
    def SetKdTree(
        self, tree: vtkmodules.vtkCommonDataModel.vtkKdTree) -> None: ...

    def SetSelectionAttribute(self, _arg: int) -> None: ...

    @overload
    def SetSelectionBounds(self, _arg1: float, _arg2: float, _arg3: float,
...
class vtkLinearSelector(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLinearSelector: ...

    @overload
    def SetEndPoint(self, _arg1: float, _arg2: float,
                    _arg3: float) -> None: ...
    ...
    @overload
    def SetStartPoint(self, _arg1: float, _arg2: float,
                      _arg3: float) -> None: ...
