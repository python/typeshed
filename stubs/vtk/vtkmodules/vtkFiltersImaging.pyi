...
class vtkComputeHistogram2DOutliers(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkComputeHistogram2DOutliers: ...

    def SetInputHistogramImageDataConnection(
        self, cxn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...

    def SetInputHistogramMultiBlockConnection(
        self, cxn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetInputTableConnection(
        self, cxn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
...
class vtkExtractHistogram2D(vtkmodules.vtkFiltersStatistics.vtkStatisticsAlgorithm):
    ...
    @overload
    def GetBinRange(self, binX: int, binY: int,
    ...
    def GetCustomHistogramExtents(self) -> Tuple[float,
                                                 float, float, float]: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExtractHistogram2D: ...
...
class vtkPairwiseExtractHistogram2D(vtkmodules.vtkFiltersStatistics.vtkStatisticsAlgorithm):
    ...
    @overload
    def GetBinRange(self, idx: int, binX: int, binY: int,
                    range: MutableSequence[float]) -> int: ...

    @overload
    def GetBinRange(self, idx: int, bin: int,
                    range: MutableSequence[float]) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPairwiseExtractHistogram2D: ...

    @overload
    def SetCustomColumnRange(
        self, col: int, range: MutableSequence[float]) -> None: ...

    @overload
    def SetCustomColumnRange(
        self, col: int, rmin: float, rmax: float) -> None: ...
