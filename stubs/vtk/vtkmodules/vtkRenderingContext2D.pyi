...
class vtkAbstractContextBufferId(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractContextBufferId: ...
    def SetContext(
...
class vtkAbstractContextItem(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetPickedItem(
        self, mouse: vtkContextMouseEvent) -> vtkAbstractContextItem: ...
    ...
    def MapFromParent(
        self, point: vtkmodules.vtkCommonDataModel.vtkVector2f) -> vtkmodules.vtkCommonDataModel.vtkVector2f: ...
    ...
    def MouseWheelEvent(self, mouse: vtkContextMouseEvent,
                        delta: int) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractContextItem: ...
...
class vtkContextItem(vtkAbstractContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextItem: ...
...
class vtkBlockItem(vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBlockItem: ...

    def SetAutoComputeDimensions(self, _arg: bool) -> None: ...

    @overload
    def SetDimensions(self, _arg1: float, _arg2: float,
...
class vtkBrush(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBrush: ...
    ...
    def SetTexture(
        self, image: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkContext2D(vtkmodules.vtkCommonCore.vtkObject):
    def AppendTransform(
        self, transform: vtkmodules.vtkCommonTransforms.vtkTransform2D) -> None: ...
    ...
    def BufferIdModeBegin(
        self, bufferId: vtkAbstractContextBufferId) -> None: ...

    def BufferIdModeEnd(self) -> None: ...

    def ComputeFontSizeForBoundedString(
        self, string: str, width: float, height: float) -> int: ...
    ...
    def ComputeStringBounds(
        self, string: str, bounds: vtkmodules.vtkCommonCore.vtkPoints2D) -> None: ...

    @overload
    def ComputeStringBounds(
        self, string: str, bounds: MutableSequence[float]) -> None: ...

    def DrawArc(self, x: float, y: float, r: float,
                startAngle: float, stopAngle: float) -> None: ...

    def DrawEllipse(self, x: float, y: float,
    ...
    @overload
    def DrawImage(self, x: float, y: float,
                  image: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...

    @overload
    def DrawImage(self, x: float, y: float, scale: float,
                  image: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
    ...
    @overload
    def DrawLine(
        self, points: vtkmodules.vtkCommonCore.vtkPoints2D) -> None: ...
    ...
    @overload
    def DrawMarkers(self, shape: int, highlight: bool,
                    points: MutableSequence[float], n: int) -> None: ...

    @overload
    def DrawMarkers(self, shape: int, highlight: bool,
                    points: vtkmodules.vtkCommonCore.vtkPoints2D) -> None: ...
    ...
    def DrawMathTextString(
        self, point: vtkmodules.vtkCommonCore.vtkPoints2D, string: str) -> None: ...

    @overload
    def DrawMathTextString(self, x: float, y: float, string: str) -> None: ...

    @overload
    def DrawMathTextString(self, point: vtkmodules.vtkCommonCore.vtkPoints2D,
                           string: str, fallback: str) -> None: ...

    @overload
    def DrawMathTextString(self, x: float, y: float,
                           string: str, fallback: str) -> None: ...
    ...
    @overload
    def DrawPoints(
        self, x: MutableSequence[float], y: MutableSequence[float], n: int) -> None: ...
    ...
    def DrawPoly(self, points: MutableSequence[float], n: int,
                 colors: MutableSequence[int], nc_comps: int) -> None: ...
    ...
    @overload
    def DrawPolygon(self, points: vtkmodules.vtkCommonCore.vtkPoints2D,
                    color: MutableSequence[int], nc_comps: int) -> None: ...

    @overload
    def DrawPolygon(self, points: MutableSequence[float], n: int,
                    color: MutableSequence[int], nc_comps: int) -> None: ...

    @overload
    def DrawQuad(self, x1: float, y1: float, x2: float, y2: float,
    ...
    @overload
    def DrawStringRect(
        self, rect: vtkmodules.vtkCommonCore.vtkPoints2D, string: str) -> None: ...

    @overload
    def DrawStringRect(self, rect: Sequence[float], string: str) -> None: ...
    def DrawWedge(self, x: float, y: float, outRadius: float,
                  inRadius: float, startAngle: float, stopAngle: float) -> None: ...
    ...
    def GetTransform(
        self) -> vtkmodules.vtkCommonTransforms.vtkTransform2D: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContext2D: ...
...
class vtkContext3D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DrawPoint(
        self, point: vtkmodules.vtkCommonDataModel.vtkVector3f) -> None: ...

    @overload
    def DrawPoints(self, points: Sequence[float], n: int) -> None: ...

    @overload
    def DrawPoints(self, points: Sequence[float], n: int,
                   colors: MutableSequence[int], nc_comps: int) -> None: ...

    def DrawPoly(self, points: Sequence[float], n: int) -> None: ...

    def DrawTriangleMesh(
        self, mesh: Sequence[float], n: int, colors: Sequence[int], nc: int) -> None: ...
    def EnableClippingPlane(
        self, i: int, planeEquation: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContext3D: ...
    def SetTransform(
        self, transform: vtkmodules.vtkCommonTransforms.vtkTransform) -> None: ...
...
class vtkContextActor(vtkmodules.vtkRenderingCore.vtkProp):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextActor: ...
...
class vtkContextClip(vtkAbstractContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextClip: ...
    def SetClip(self, x: float, y: float, width: float,
                height: float) -> None: ...
...
class vtkContextDevice2D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextDevice2D: ...
...
class vtkContextDevice3D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DrawLines(self, verts: Sequence[float], n: int,
                  colors: Sequence[int] = ..., nc: int = 0) -> None: ...

    def DrawPoints(self, verts: Sequence[float], n: int,
                   colors: Sequence[int] = ..., nc: int = 0) -> None: ...

    def DrawPoly(self, verts: Sequence[float], n: int,
                 colors: Sequence[int] = ..., nc: int = 0) -> None: ...
    def DrawTriangleMesh(
        self, mesh: Sequence[float], n: int, colors: Sequence[int], nc: int) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextDevice3D: ...
    def SetClipping(
        self, rect: vtkmodules.vtkCommonDataModel.vtkRecti) -> None: ...
...
class vtkContextKeyEvent:
    ...
    def GetInteractor(
        self) -> vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor: ...
    ...
    def SetPosition(
        self, position: vtkmodules.vtkCommonDataModel.vtkVector2i) -> None: ...
...
class vtkContextMapper2D(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextMapper2D: ...
    def SetInputData(
...
class vtkContextMouseEvent:
    ...
    def GetLastScreenPos(
        self) -> vtkmodules.vtkCommonDataModel.vtkVector2i: ...
...
class vtkContextScene(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextScene: ...
...
class vtkContextTransform(vtkAbstractContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextTransform: ...
...
class vtkImageItem(vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageItem: ...
    def SetImage(
        self, image: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkPolyDataItem(vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataItem: ...

    def SetMappedColors(
        self, colors: vtkmodules.vtkCommonCore.vtkUnsignedCharArray) -> None: ...
    def SetPolyData(
        self, polyData: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
...
class vtkLabeledContourPolyDataItem(vtkPolyDataItem):
    ...
    def GetTextProperties(
        self) -> vtkmodules.vtkRenderingCore.vtkTextPropertyCollection: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabeledContourPolyDataItem: ...

    def SetLabelVisibility(self, _arg: bool) -> None: ...
    def SetSkipDistance(self, _arg: float) -> None: ...

    def SetTextProperties(
        self, coll: vtkmodules.vtkRenderingCore.vtkTextPropertyCollection) -> None: ...
...
class vtkMarkerUtilities(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def GenerateMarker(data: vtkmodules.vtkCommonDataModel.vtkImageData,
                       style: int, width: int) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMarkerUtilities: ...
...
class vtkPropItem(vtkAbstractContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPropItem: ...
    def SetPropObject(
        self, PropObject: vtkmodules.vtkRenderingCore.vtkProp) -> None: ...
...
class vtkTooltipItem(vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTooltipItem: ...
