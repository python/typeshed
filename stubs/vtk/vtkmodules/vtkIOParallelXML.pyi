...
class vtkXMLCompositeDataSetWriterHelper(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLCompositeDataSetWriterHelper: ...

    def SetWriter(
        self, writer: vtkmodules.vtkIOXML.vtkXMLWriterBase) -> None: ...
    def WriteDataSet(self, path: str, prefix: str,
                     data: vtkmodules.vtkCommonDataModel.vtkDataObject) -> str: ...


class vtkXMLDataWriterHelper(vtkmodules.vtkIOXML.vtkXMLWriter):
    def AddGlobalFieldData(
        self, dataset: vtkmodules.vtkCommonDataModel.vtkCompositeDataSet) -> bool: ...
    def AddXML(
        self, xmlElement: vtkmodules.vtkCommonDataModel.vtkXMLDataElement) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLDataWriterHelper: ...
...
class vtkXMLPDataObjectWriter(vtkmodules.vtkIOXML.vtkXMLWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPDataObjectWriter: ...
    def SetController(
...
class vtkXMLPDataWriter(vtkXMLPDataObjectWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPDataWriter: ...
...
class vtkXMLPDataSetWriter(vtkXMLPDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPDataSetWriter: ...
...
class vtkXMLPUniformGridAMRWriter(vtkmodules.vtkIOXML.vtkXMLUniformGridAMRWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPUniformGridAMRWriter: ...
    def SetController(
        self, __a: vtkmodules.vtkParallelCore.vtkMultiProcessController) -> None: ...
...
class vtkXMLPHierarchicalBoxDataWriter(vtkXMLPUniformGridAMRWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPHierarchicalBoxDataWriter: ...
...
class vtkXMLPHyperTreeGridWriter(vtkXMLPDataObjectWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPHyperTreeGridWriter: ...
...
class vtkXMLPStructuredDataWriter(vtkXMLPDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPStructuredDataWriter: ...
...
class vtkXMLPImageDataWriter(vtkXMLPStructuredDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPImageDataWriter: ...
...
class vtkXMLPMultiBlockDataWriter(vtkmodules.vtkIOXML.vtkXMLMultiBlockDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPMultiBlockDataWriter: ...
    def SetController(
        self, __a: vtkmodules.vtkParallelCore.vtkMultiProcessController) -> None: ...
...
class vtkXMLWriter2(vtkmodules.vtkIOXML.vtkXMLWriterBase):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLWriter2: ...
    def SetController(
...
class vtkXMLPartitionedDataSetWriter(vtkXMLWriter2):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPartitionedDataSetWriter: ...
    def SetInputData(
        self, pd: vtkmodules.vtkCommonDataModel.vtkPartitionedDataSet) -> None: ...
...
class vtkXMLPPartitionedDataSetWriter(vtkXMLPartitionedDataSetWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPPartitionedDataSetWriter: ...
...
class vtkXMLPUnstructuredDataWriter(vtkXMLPDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPUnstructuredDataWriter: ...
...
class vtkXMLPPolyDataWriter(vtkXMLPUnstructuredDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPPolyDataWriter: ...
...
class vtkXMLPRectilinearGridWriter(vtkXMLPStructuredDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPRectilinearGridWriter: ...
...
class vtkXMLPStructuredGridWriter(vtkXMLPStructuredDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPStructuredGridWriter: ...
...
class vtkXMLPTableWriter(vtkXMLPDataObjectWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPTableWriter: ...
...
class vtkXMLPUnstructuredGridWriter(vtkXMLPUnstructuredDataWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPUnstructuredGridWriter: ...
...
class vtkXMLPartitionedDataSetCollectionWriter(vtkXMLWriter2):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkXMLPartitionedDataSetCollectionWriter: ...

    def SetInputData(
        self, pd: vtkmodules.vtkCommonDataModel.vtkPartitionedDataSetCollection) -> None: ...
