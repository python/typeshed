...
class vtkContourValues(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContourValues: ...
...
class vtkExprTkFunctionParser(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetVectorVariableValue(
        self, variableName: str) -> Tuple[float, float, float]: ...

    @overload
    def GetVectorVariableValue(
        self, variableName: str, value: MutableSequence[float]) -> None: ...
    ...
    @overload
    def GetVectorVariableValue(
        self, i: int, value: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExprTkFunctionParser: ...
    ...
    @overload
    def SetScalarVariableValue(
        self, variableName: str, value: float) -> None: ...

    @overload
    def SetScalarVariableValue(self, i: int, value: float) -> None: ...

    @overload
    def SetVectorVariableValue(
        self, variableName: str, xValue: float, yValue: float, zValue: float) -> None: ...

    @overload
    def SetVectorVariableValue(
        self, variableName: str, values: MutableSequence[float]) -> None: ...

    @overload
    def SetVectorVariableValue(
        self, i: int, xValue: float, yValue: float, zValue: float) -> None: ...

    @overload
    def SetVectorVariableValue(
        self, i: int, values: MutableSequence[float]) -> None: ...
...
class vtkFunctionParser(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFunctionParser: ...
    ...
    @overload
    def SetVectorVariableValue(
        self, variableName: str, values: Sequence[float]) -> None: ...
    ...
    @overload
    def SetVectorVariableValue(
        self, i: int, values: Sequence[float]) -> None: ...
...
class vtkHeap(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Reset(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHeap: ...
...
class vtkPolygonBuilder:
    ...
    def GetPolygons(
        self, polys: vtkmodules.vtkCommonCore.vtkIdListCollection) -> None: ...
...
class vtkResourceFileLocator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def Locate(self, anchor: str, landmark: str,
               defaultDir: str = ...) -> str: ...

    @overload
    def Locate(self, anchor: str, landmark_prefixes:
               Sequence[str], landmark: str, defaultDir: str = ...) -> str: ...

    def NewInstance(self) -> vtkResourceFileLocator: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkResourceFileLocator: ...
