...
class vtkContourValues(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContourValues: ...
...
class vtkExprTkFunctionParser(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExprTkFunctionParser: ...
    @staticmethod
...
class vtkFunctionParser(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ReplaceInvalidValuesOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFunctionParser: ...
    def SetFunction(self, function: str) -> None: ...
    def SetReplaceInvalidValues(self, _arg: int) -> None: ...
    def SetReplacementValue(self, _arg: float) -> None: ...
    @overload
...
class vtkHeap(vtkmodules.vtkCommonCore.vtkObject):
    def AllocateMemory(self, n: int) -> _Pointer: ...
...
class vtkPolygonBuilder:
    ...
    def GetPolygons(self, polys: vtkmodules.vtkCommonCore.vtkIdListCollection) -> None: ...
...
class vtkResourceFileLocator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkResourceFileLocator: ...
