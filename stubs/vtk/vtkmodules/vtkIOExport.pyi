...
class vtkExporter(vtkmodules.vtkCommonCore.vtkObject):
    def GetActiveRenderer(self) -> vtkmodules.vtkRenderingCore.vtkRenderer: ...
    def GetInput(self) -> vtkmodules.vtkRenderingCore.vtkRenderWindow: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExporter: ...
    def SetActiveRenderer(self, __a: vtkmodules.vtkRenderingCore.vtkRenderer) -> None: ...
    def SetEndWrite(self, f: Callback) -> None: ...
    def SetInput(self, renWin: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> None: ...
...
class vtkGLTFExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGLTFExporter: ...
...
class vtkIVExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkIVExporter: ...
    def SetFileName(self, _arg: str) -> None: ...

class vtkJSONDataSetWriter(vtkmodules.vtkIOCore.vtkWriter):
    @staticmethod
    def ComputeMD5(content: Sequence[int], size: int, hash: str) -> None: ...
    def GetArchiver(self) -> vtkmodules.vtkCommonCore.vtkArchiver: ...
    @overload
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    @staticmethod
    def GetShortType(input: vtkmodules.vtkCommonCore.vtkDataArray, needConversion: bool) -> str: ...
    @staticmethod
    def GetUID(__a: vtkmodules.vtkCommonCore.vtkDataArray, needConversion: bool) -> str: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONDataSetWriter: ...
    def SetArchiver(self, __a: vtkmodules.vtkCommonCore.vtkArchiver) -> None: ...
    @overload
    def Write(self, __a: vtkmodules.vtkCommonDataModel.vtkDataSet) -> None: ...
    @overload
    def Write(self) -> int: ...
    @staticmethod
    def WriteArrayAsRAW(__a: vtkmodules.vtkCommonCore.vtkDataArray, filePath: str) -> bool: ...
    def WriteArrayContents(self, __a: vtkmodules.vtkCommonCore.vtkDataArray, relativeFilePath: str) -> bool: ...
...
class vtkJSONRenderWindowExporter(vtkExporter):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSerializer(self) -> vtkmodules.vtkRenderingVtkJS.vtkVtkJSSceneGraphSerializer: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkJSONRenderWindowExporter: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONRenderWindowExporter: ...
    def SetArchiver(self, __a: vtkmodules.vtkCommonCore.vtkArchiver) -> None: ...
    def SetCompactOutput(self, _arg: bool) -> None: ...
    def SetSerializer(self, __a: vtkmodules.vtkRenderingVtkJS.vtkVtkJSSceneGraphSerializer) -> None: ...
...
class vtkJSONSceneExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONSceneExporter: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkOBJExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOBJExporter: ...
...
class vtkOOGLExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOOGLExporter: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkPOVExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPOVExporter: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkRIBExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRIBExporter: ...
...
class vtkRIBLight(vtkmodules.vtkRenderingCore.vtkLight):
    ...
    def Render(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, index: int) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRIBLight: ...
...
class vtkRIBProperty(vtkmodules.vtkRenderingCore.vtkProperty):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRIBProperty: ...
...
class vtkSVGContextDevice2D(vtkmodules.vtkRenderingContext2D.vtkContextDevice2D):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSVGContextDevice2D: ...
    ...
    def SetSVGContext(
        self, context: vtkmodules.vtkCommonDataModel.vtkXMLDataElement, defs: vtkmodules.vtkCommonDataModel.vtkXMLDataElement
    ) -> None: ...
...
class vtkSVGExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSVGExporter: ...
...
class vtkSingleVTPExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSingleVTPExporter: ...
...
class vtkVRMLExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRMLExporter: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkX3DExporter(vtkExporter):
    ...
    def GetBinaryOutputString(self) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporter: ...
...
class vtkX3DExporterWriter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def RegisterAndGetOutputString(self) -> str: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporterWriter: ...
    @overload
    ...
    @overload
    def SetField(self, attributeID: int, type: int, a: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...
    @overload
...
class vtkX3DExporterFIWriter(vtkX3DExporterWriter):
    ...
    def OpenStream(self) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporterFIWriter: ...
    def SetFastest(self, _arg: int) -> None: ...
    @overload
    ...
    def SetField(self, attributeID: int, values: Sequence[float], size: int) -> None: ...
    @overload
    def SetField(self, attributeID: int, type: int, a: vtkmodules.vtkCommonDataModel.vtkCellArray) -> None: ...
    @overload
    def SetField(self, attributeID: int, values: Sequence[int], size: int, image: bool = False) -> None: ...
    def StartDocument(self) -> None: ...
...
class vtkX3DExporterXMLWriter(vtkX3DExporterWriter):
    ...
    def OpenStream(self) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporterXMLWriter: ...
    @overload
