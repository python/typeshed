...
class vtkExporter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExporter: ...
    def SetActiveRenderer(
...
class vtkGLTFExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGLTFExporter: ...
...
class vtkIVExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkIVExporter: ...
...
class vtkJSONDataSetWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def GetShortType(input: vtkmodules.vtkCommonCore.vtkDataArray,
                     needConversion: bool) -> str: ...

    @staticmethod
    def GetUID(__a: vtkmodules.vtkCommonCore.vtkDataArray,
               needConversion: bool) -> str: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONDataSetWriter: ...
    def SetArchiver(
        self, __a: vtkmodules.vtkCommonCore.vtkArchiver) -> None: ...
    ...
    @staticmethod
    def WriteArrayAsRAW(
        __a: vtkmodules.vtkCommonCore.vtkDataArray, filePath: str) -> bool: ...
    def WriteArrayContents(
        self, __a: vtkmodules.vtkCommonCore.vtkDataArray, relativeFilePath: str) -> bool: ...
...
class vtkJSONRenderWindowExporter(vtkExporter):
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSerializer(
        self) -> vtkmodules.vtkRenderingVtkJS.vtkVtkJSSceneGraphSerializer: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONRenderWindowExporter: ...
    def SetArchiver(
        self, __a: vtkmodules.vtkCommonCore.vtkArchiver) -> None: ...

    def SetCompactOutput(self, _arg: bool) -> None: ...
    def SetSerializer(
        self, __a: vtkmodules.vtkRenderingVtkJS.vtkVtkJSSceneGraphSerializer) -> None: ...
...
class vtkJSONSceneExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONSceneExporter: ...
...
class vtkOBJExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOBJExporter: ...
...
class vtkOOGLExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOOGLExporter: ...
...
class vtkPOVExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPOVExporter: ...
...
class vtkRIBExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRIBExporter: ...
...
class vtkRIBLight(vtkmodules.vtkRenderingCore.vtkLight):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRIBLight: ...
...
class vtkRIBProperty(vtkmodules.vtkRenderingCore.vtkProperty):
    def AddDisplacementShaderParameter(
        self, parameter: str, value: str) -> None: ...

    def AddParameter(self, parameter: str, value: str) -> None: ...
    def AddSurfaceShaderParameter(
        self, parameter: str, value: str) -> None: ...
...
class vtkSVGContextDevice2D(vtkmodules.vtkRenderingContext2D.vtkContextDevice2D):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSVGContextDevice2D: ...
...
class vtkSVGExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSVGExporter: ...
...
class vtkSingleVTPExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSingleVTPExporter: ...
...
class vtkVRMLExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRMLExporter: ...
...
class vtkX3DExporter(vtkExporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporter: ...
...
class vtkX3DExporterWriter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporterWriter: ...

    @overload
    def SetField(self, attributeID: int, value: str,
                 mfstring: bool = False) -> None: ...
    ...
    @overload
    def SetField(self, attributeID: int, type: int,
                 a: Sequence[float]) -> None: ...

    @overload
    def SetField(self, attributeID: int, type: int,
                 a: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...

    @overload
    def SetField(self, attributeID: int,
                 values: Sequence[float], size: int) -> None: ...

    @overload
    def SetField(self, attributeID: int,
                 values: Sequence[int], size: int, image: bool = False) -> None: ...
...
class vtkX3DExporterFIWriter(vtkX3DExporterWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporterFIWriter: ...

    def SetFastest(self, _arg: int) -> None: ...

    @overload
    def SetField(self, attributeID: int, __b: str,
                 mfstring: bool = False) -> None: ...
    ...
    @overload
    def SetField(self, attributeID: int, type: int,
                 a: vtkmodules.vtkCommonDataModel.vtkCellArray) -> None: ...
...
class vtkX3DExporterXMLWriter(vtkX3DExporterWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkX3DExporterXMLWriter: ...

    @overload
    def SetField(self, attributeID: int, __b: str,
                 mfstring: bool = True) -> None: ...
