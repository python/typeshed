...
class vtkSocket(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Receive(self, data: _Pointer, length: int, readFully: int = 1) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSocket: ...
    @staticmethod
    def SelectSockets(sockets_to_select: Sequence[int], size: int, msec: int, selected_index: MutableSequence[int]) -> int: ...
    def Send(self, data: _Pointer, length: int) -> int: ...
...
class vtkClientSocket(vtkSocket):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkClientSocket: ...
...
class vtkDirectory(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDirectory: ...
...
class vtkExecutableRunner(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExecutableRunner: ...
...
class vtkServerSocket(vtkSocket):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkServerSocket: ...
...
class vtkSocketCollection(vtkmodules.vtkCommonCore.vtkCollection):
    ...
    @overload
    def RemoveItem(self, __a: vtkmodules.vtkCommonCore.vtkObject) -> None: ...
    def ReplaceItem(self, i: int, __b: vtkmodules.vtkCommonCore.vtkObject) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSocketCollection: ...
...
class vtkThreadMessager(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkThreadMessager: ...
...
class vtkTimerLog(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ResetLog() -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTimerLog: ...
    @staticmethod
