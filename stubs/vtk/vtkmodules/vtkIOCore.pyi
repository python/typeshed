...
class vtkTextCodec(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTextCodec: ...
...
class vtkASCIITextCodec(vtkTextCodec):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkASCIITextCodec: ...
...
class vtkWriter(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkWriter: ...
    @overload
...
class vtkAbstractParticleWriter(vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractParticleWriter: ...
...
class vtkAbstractPolyDataReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractPolyDataReader: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkArrayDataReader(vtkmodules.vtkCommonExecutionModel.vtkArrayDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkArrayDataReader: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkArrayDataWriter(vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkArrayDataWriter: ...
    ...
    @overload
    @staticmethod
    def Write(array: vtkmodules.vtkCommonDataModel.vtkArrayData, file_name: str, WriteBinary: bool = False) -> bool: ...
    @overload
    def Write(self, WriteBinary: bool) -> str: ...
    @overload
    @staticmethod
    def Write(array: vtkmodules.vtkCommonDataModel.vtkArrayData, WriteBinary: bool = False) -> str: ...
...
class vtkArrayReader(vtkmodules.vtkCommonExecutionModel.vtkArrayDataAlgorithm):
    ...
    def ReadFromInputStringOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkArrayReader: ...
    def SetFileName(self, _arg: str) -> None: ...
    def SetInputString(self, string: str) -> None: ...
    def SetReadFromInputString(self, _arg: bool) -> None: ...
...
class vtkArrayWriter(vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkArrayWriter: ...
    def SetBinary(self, _arg: int) -> None: ...
    def SetFileName(self, _arg: str) -> None: ...
    def SetWriteToOutputString(self, _arg: bool) -> None: ...
    @overload
    ...
    @overload
    @staticmethod
    def Write(array: vtkmodules.vtkCommonCore.vtkArray, file_name: str, WriteBinary: bool = False) -> bool: ...
    @overload
    def Write(self, WriteBinary: bool) -> str: ...
    @overload
    @staticmethod
    def Write(array: vtkmodules.vtkCommonCore.vtkArray, WriteBinary: bool = False) -> str: ...
    def WriteToOutputStringOff(self) -> None: ...
    def WriteToOutputStringOn(self) -> None: ...
...
class vtkInputStream(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Read(self, data: _Pointer, length: int) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkInputStream: ...
...
class vtkBase64InputStream(vtkInputStream):
    ...
    def Read(self, data: _Pointer, length: int) -> int: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBase64InputStream: ...
    def Seek(self, offset: int) -> int: ...
    def StartReading(self) -> None: ...
...
class vtkOutputStream(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOutputStream: ...
    def StartWriting(self) -> int: ...
    def Write(self, data: _Pointer, length: int) -> int: ...
...
class vtkBase64OutputStream(vtkOutputStream):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBase64OutputStream: ...
    def StartWriting(self) -> int: ...
    def Write(self, data: _Pointer, length: int) -> int: ...
...
class vtkBase64Utilities(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBase64Utilities: ...
...
class vtkDataCompressor(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataCompressor: ...
...
class vtkDelimitedTextWriter(vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDelimitedTextWriter: ...
...
class vtkGlobFileNames(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Reset(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGlobFileNames: ...
...
class vtkJavaScriptDataWriter(vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJavaScriptDataWriter: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkLZ4DataCompressor(vtkDataCompressor):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLZ4DataCompressor: ...
...
class vtkLZMADataCompressor(vtkDataCompressor):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLZMADataCompressor: ...
    def SetCompressionLevel(self, compressionLevel: int) -> None: ...
...
class vtkSortFileNames(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetNthGroup(self, i: int) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSortFileNames: ...
    def SetGrouping(self, _arg: int) -> None: ...
    def SetIgnoreCase(self, _arg: int) -> None: ...
    def SetInputFileNames(self, input: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
...
class vtkTextCodecFactory(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTextCodecFactory: ...
    @staticmethod
...
class vtkUTF16TextCodec(vtkTextCodec):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUTF16TextCodec: ...
...
class vtkUTF8TextCodec(vtkTextCodec):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkUTF8TextCodec: ...
...
class vtkZLibDataCompressor(vtkDataCompressor):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkZLibDataCompressor: ...
    def SetCompressionLevel(self, compressionLevel: int) -> None: ...
