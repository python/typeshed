...
class vtkCesium3DTilesWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCesium3DTilesWriter: ...
...
class vtkCesiumPointCloudWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCesiumPointCloudWriter: ...

    def SetFileName(self, _arg: str) -> None: ...

    def SetPointIds(
        self, _arg: vtkmodules.vtkCommonCore.vtkIdList) -> None: ...
