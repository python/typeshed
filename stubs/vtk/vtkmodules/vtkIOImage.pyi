...
class vtkImageReader2(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetMemoryBuffer(self) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageReader2: ...
    ...
    def SetFileNames(self, __a: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
    def SetFilePattern(self, __a: str) -> None: ...
    def SetFilePrefix(self, __a: str) -> None: ...
    def SetHeaderSize(self, size: int) -> None: ...
    def SetMemoryBuffer(self, __a: _Pointer) -> None: ...
...
class vtkImageReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageReader: ...
...
class vtkBMPReader(vtkImageReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBMPReader: ...
...
class vtkImageWriter(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageWriter: ...
    def SetFileDimensionality(self, _arg: int) -> None: ...
...
class vtkBMPWriter(vtkImageWriter):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetResult(self) -> vtkmodules.vtkCommonCore.vtkUnsignedCharArray: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBMPWriter: ...
    def SetResult(self, __a: vtkmodules.vtkCommonCore.vtkUnsignedCharArray) -> None: ...
...
class vtkDEMReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDEMReader: ...
...
class vtkDICOMImageReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDICOMImageReader: ...
...
class vtkMedicalImageReader2(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMedicalImageReader2: ...
...
class vtkGESignaReader(vtkMedicalImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGESignaReader: ...
...
class vtkHDRReader(vtkImageReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHDRReader: ...

class vtkImageExport(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    @overload
    def Export(self) -> None: ...
    @overload
    def Export(self, __a: _Pointer) -> None: ...
    def GetCallbackUserData(self) -> _Pointer: ...
    @overload
    ...
    def GetExportVoidPointer(self) -> _Pointer: ...
    def GetImageLowerLeft(self) -> int: ...
    def GetInput(self) -> vtkmodules.vtkCommonDataModel.vtkImageData: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetPointerToData(self) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageExport: ...
    def SetExportVoidPointer(self, __a: _Pointer) -> None: ...
    def SetImageLowerLeft(self, _arg: int) -> None: ...

class vtkImageImport(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    def CopyImportVoidPointer(self, ptr: _Pointer, size: int) -> None: ...
    def GetCallbackUserData(self) -> _Pointer: ...
    def GetDataDirection(self) -> tuple[float, float, float, float, float, float, float, float, float]: ...
    def GetDataExtent(self) -> tuple[int, int, int, int, int, int]: ...
    def GetDataOrigin(self) -> tuple[float, float, float]: ...
    ...
    def GetDataScalarTypeAsString(self) -> str: ...
    def GetDataSpacing(self) -> tuple[float, float, float]: ...
    def GetImportVoidPointer(self) -> _Pointer: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetNumberOfScalarComponents(self) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageImport: ...
    def SetCallbackUserData(self, _arg: _Pointer) -> None: ...
    def SetDataDirection(self, data: Sequence[float]) -> None: ...
    @overload
    def SetDataExtent(self, _arg1: int, _arg2: int, _arg3: int, _arg4: int, _arg5: int, _arg6: int) -> None: ...
    @overload
    ...
    def SetDataSpacing(self, _arg: Sequence[float]) -> None: ...
    @overload
    def SetImportVoidPointer(self, ptr: _Pointer) -> None: ...
    @overload
    def SetImportVoidPointer(self, ptr: _Pointer, save: int) -> None: ...
    def SetNumberOfScalarComponents(self, _arg: int) -> None: ...
    def SetScalarArrayName(self, _arg: str) -> None: ...
    @overload
...
class vtkImageImportExecutive(vtkmodules.vtkCommonExecutionModel.vtkStreamingDemandDrivenPipeline):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageImportExecutive: ...
...
class vtkImageReader2Collection(vtkmodules.vtkCommonCore.vtkCollection):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageReader2Collection: ...
...
class vtkImageReader2Factory(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageReader2Factory: ...
...
class vtkJPEGReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJPEGReader: ...
...
class vtkJPEGWriter(vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJPEGWriter: ...
...
class vtkJSONImageWriter(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkJSONImageWriter: ...
...
class vtkMRCReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMRCReader: ...
    def SetFileName(self, _arg: str) -> None: ...
...
class vtkMedicalImageProperties(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMedicalImageProperties: ...
...
class vtkMetaImageReader(vtkImageReader2):
    ...
    def GetHeight(self) -> int: ...
    def GetImageNumber(self) -> str: ...
    def GetImagePositionPatient(self) -> _Pointer: ...
    def GetModality(self) -> str: ...
    def GetNumberOfComponents(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    ...
    def GetPatientName(self) -> str: ...
    def GetPixelRepresentation(self) -> int: ...
    def GetPixelSpacing(self) -> _Pointer: ...
    def GetRescaleOffset(self) -> float: ...
    def GetRescaleSlope(self) -> float: ...
    def GetSeries(self) -> str: ...
    def GetStudyID(self) -> str: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMetaImageReader: ...
...
class vtkMetaImageWriter(vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMetaImageWriter: ...
...
class vtkNIFTIImageHeader(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkNIFTIImageHeader: ...
...
class vtkNIFTIImageReader(vtkImageReader2):
    ...
    def GetQFormMatrix(self) -> vtkmodules.vtkCommonMath.vtkMatrix4x4: ...
    def GetRescaleIntercept(self) -> float: ...
    def GetRescaleSlope(self) -> float: ...
    def GetSFormMatrix(self) -> vtkmodules.vtkCommonMath.vtkMatrix4x4: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkNIFTIImageReader: ...
...
class vtkNIFTIImageWriter(vtkImageWriter):
    ...
    def PlanarRGBOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkNIFTIImageWriter: ...
    ...
    def SetQFormMatrix(self, __a: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    def SetRescaleIntercept(self, _arg: float) -> None: ...
    def SetRescaleSlope(self, _arg: float) -> None: ...
    def SetSFormMatrix(self, __a: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
...
class vtkNrrdReader(vtkImageReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkNrrdReader: ...
...
class vtkTIFFReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTIFFReader: ...
...
class vtkOMETIFFReader(vtkTIFFReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOMETIFFReader: ...
...
class vtkPNGReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPNGReader: ...
...
class vtkPNGWriter(vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPNGWriter: ...
...
class vtkPNMReader(vtkImageReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPNMReader: ...
...
class vtkPNMWriter(vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPNMWriter: ...
...
class vtkPostScriptWriter(vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPostScriptWriter: ...
...
class vtkSEPReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetAllRanges(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetDataOrigin(self) -> _Pointer: ...
    def GetDataSpacing(self) -> _Pointer: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSEPReader: ...
...
class vtkSLCReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSLCReader: ...
...
class vtkTGAReader(vtkImageReader2):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTGAReader: ...
...
class vtkTIFFWriter(vtkImageWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTIFFWriter: ...
...
class vtkVolumeReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetFilePattern(self) -> str: ...
    def GetFilePrefix(self) -> str: ...
    def GetImage(self, ImageNumber: int) -> vtkmodules.vtkCommonDataModel.vtkImageData: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeReader: ...
    @overload
    def SetDataOrigin(self, _arg1: float, _arg2: float, _arg3: float) -> None: ...
    @overload
    def SetDataOrigin(self, _arg: Sequence[float]) -> None: ...
...
class vtkVolume16Reader(vtkVolumeReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolume16Reader: ...
    def SetDataByteOrder(self, __a: int) -> None: ...
    def SetDataByteOrderToBigEndian(self) -> None: ...
    def SetDataByteOrderToLittleEndian(self) -> None: ...
    @overload
