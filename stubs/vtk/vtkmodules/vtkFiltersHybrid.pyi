...
class vtkAdaptiveDataSetSurfaceFilter(vtkmodules.vtkFiltersGeometry.vtkGeometryFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAdaptiveDataSetSurfaceFilter: ...
...
class vtkBSplineTransform(vtkmodules.vtkCommonTransforms.vtkWarpTransform):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBSplineTransform: ...
...
class vtkDSPFilterDefinition(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def IsA(self, type: str) -> int: ...
    def IsThisInputVariableInstanceNeeded(
        self, a_timestep: int, a_outputTimestep: int) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDSPFilterDefinition: ...
...
class vtkDSPFilterGroup(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def AddInputVariableInstance(self, a_name: str, a_timestep: int,
                                 a_data: vtkmodules.vtkCommonCore.vtkFloatArray) -> None: ...

    def Copy(self, other: vtkDSPFilterGroup) -> None: ...

    def GetCachedInput(self, a_whichFilter: int,
                       a_whichTimestep: int) -> vtkmodules.vtkCommonCore.vtkFloatArray: ...
    def GetCachedOutput(self, a_whichFilter: int,
                        a_whichTimestep: int) -> vtkmodules.vtkCommonCore.vtkFloatArray: ...
    ...
    def IsThisInputVariableInstanceCached(
        self, a_name: str, a_timestep: int) -> bool: ...
    def IsThisInputVariableInstanceNeeded(
        self, a_name: str, a_timestep: int, a_outputTimestep: int) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDSPFilterGroup: ...
...
class vtkDepthSortPolyData(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDepthSortPolyData: ...
    def SetCamera(
...
class vtkEarthSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEarthSource: ...
...
class vtkFacetReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFacetReader: ...
...
class vtkForceTime(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkForceTime: ...
...
class vtkGenerateTimeSteps(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    def GenerateTimeStepValues(
        self, begin: float, end: float, step: float) -> None: ...

    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetNumberOfTimeSteps(self) -> int: ...
    def GetTimeStepValues(
        self, timeStepValues: MutableSequence[float]) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenerateTimeSteps: ...
    def SetTimeStepValues(
        self, count: int, timeStepValues: Sequence[float]) -> None: ...
...
class vtkGreedyTerrainDecimation(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGreedyTerrainDecimation: ...
...
class vtkGridTransform(vtkmodules.vtkCommonTransforms.vtkWarpTransform):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGridTransform: ...

    def SetDisplacementGridConnection(
        self, __a: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetDisplacementGridData(
        self, __a: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkImageToPolyDataFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageToPolyDataFilter: ...
...
class vtkImplicitModeller(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def ComputeModelBounds(
        self, input: vtkmodules.vtkCommonDataModel.vtkDataSet = ...) -> float: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImplicitModeller: ...
    ...
    @overload
    def SetModelBounds(self, _arg1: float, _arg2: float, _arg3: float,
...
class vtkPCAAnalysisFilter(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPCAAnalysisFilter: ...
...
class vtkPolyDataSilhouette(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataSilhouette: ...
...
class vtkProcrustesAlignmentFilter(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProcrustesAlignmentFilter: ...
...
class vtkProjectedTerrainPath(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProjectedTerrainPath: ...
    ...
    def SetSourceData(
        self, source: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkRenderLargeImage(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderLargeImage: ...
    def SetInput(
...
class vtkTemporalArrayOperatorFilter(vtkmodules.vtkCommonExecutionModel.vtkMultiTimeStepAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalArrayOperatorFilter: ...
...
class vtkTemporalDataSetCache(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalDataSetCache: ...
...
class vtkTemporalFractal(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalFractal: ...
...
class vtkTemporalInterpolator(vtkmodules.vtkCommonExecutionModel.vtkMultiTimeStepAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalInterpolator: ...
...
class vtkTemporalShiftScale(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalShiftScale: ...
...
class vtkTemporalSnapToTimeStep(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalSnapToTimeStep: ...
...
class vtkTransformToGrid(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTransformToGrid: ...

    @overload
    def SetGridExtent(self, _arg1: int, _arg2: int, _arg3: int,
    ...
    @overload
    def SetGridOrigin(self, _arg1: float, _arg2: float,
                      _arg3: float) -> None: ...
    ...
    @overload
    def SetGridSpacing(self, _arg1: float, _arg2: float,
                       _arg3: float) -> None: ...
...
class vtkWeightedTransformFilter(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    ...
    def GetTransform(
        self, num: int) -> vtkmodules.vtkCommonTransforms.vtkAbstractTransform: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkWeightedTransformFilter: ...
    ...
    def SetTransform(
        self, transform: vtkmodules.vtkCommonTransforms.vtkAbstractTransform, num: int) -> None: ...
