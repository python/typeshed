...
class vtkLODActor(vtkmodules.vtkRenderingCore.vtkActor):
    ...
    def GetLODMappers(
        self) -> vtkmodules.vtkRenderingCore.vtkMapperCollection: ...

    def GetLowResFilter(
        self) -> vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm: ...
    def GetMediumResFilter(
        self) -> vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLODActor: ...

    def SetLowResFilter(
        self, __a: vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm) -> None: ...
    def SetMediumResFilter(
        self, __a: vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm) -> None: ...
...
class vtkQuadricLODActor(vtkmodules.vtkRenderingCore.vtkActor):
    ...
    def GetLODFilter(
        self) -> vtkmodules.vtkFiltersCore.vtkQuadricClustering: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkQuadricLODActor: ...
    def SetCamera(
    ...
    def SetLODFilter(
        self, lodFilter: vtkmodules.vtkFiltersCore.vtkQuadricClustering) -> None: ...
