...
class vtkOpenGLAvatar(vtkmodules.vtkRenderingCore.vtkAvatar):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLAvatar: ...
...
class vtkVRCamera(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLCamera):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRCamera: ...

    def SetCameraFromDeviceToWorldMatrix(
        self, mat: vtkmodules.vtkCommonMath.vtkMatrix4x4, distance: float) -> None: ...
    def SetCameraFromWorldToDeviceMatrix(
        self, mat: vtkmodules.vtkCommonMath.vtkMatrix4x4, distance: float) -> None: ...
...
class vtkVRControlsHelper(vtkmodules.vtkRenderingCore.vtkProp):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRControlsHelper: ...
    def SetDevice(
        self, val: vtkmodules.vtkCommonCore.vtkEventDataDevice) -> None: ...
    ...
    def SetTooltipInfo(self, s: str, buttonSide: int,
                       drawSide: int, txt: str) -> None: ...
...
class vtkVRFollower(vtkmodules.vtkRenderingCore.vtkFollower):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRFollower: ...
...
class vtkVRHMDCamera(vtkVRCamera):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRHMDCamera: ...
...
class vtkVRHardwarePicker(vtkmodules.vtkRenderingCore.vtkPropPicker):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRHardwarePicker: ...
...
class vtkVRInteractorStyle(vtkmodules.vtkRenderingCore.vtkInteractorStyle3D):
    ...
    def Elevation3D(
        self, __a: vtkmodules.vtkCommonCore.vtkEventDataDevice3D) -> None: ...
    ...
    def GetInteractionState(
        self, device: vtkmodules.vtkCommonCore.vtkEventDataDevice) -> int: ...
    ...
    def GroundMovement3D(
        self, __a: vtkmodules.vtkCommonCore.vtkEventDataDevice3D) -> None: ...

    def HideBillboard(self) -> None: ...
    def HidePickActor(self) -> None: ...
    def HideRay(
        self, controller: vtkmodules.vtkCommonCore.vtkEventDataDevice) -> None: ...
    ...
    @overload
    def MapInputToAction(self, eid: vtkCommand.EventIds,
                         state: int) -> None: ...

    @overload
    def MapInputToAction(
        self, eid: vtkCommand.EventIds, action: vtkmodules.vtkCommonCore.vtkEventDataAction, state: int
    ) -> None: ...
    def NewInstance(self) -> vtkVRInteractorStyle: ...

    def OnElevation3D(
        self, edata: vtkmodules.vtkCommonCore.vtkEventData) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRInteractorStyle: ...

    def SetDrawControls(self, __a: bool) -> None: ...
    def SetGrabWithRay(self, _arg: bool) -> None: ...
    def SetHoverPick(self, _arg: bool) -> None: ...
    def SetInteractor(
        self, iren: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
    ...
    def ShowPickCell(self, cell: vtkmodules.vtkCommonDataModel.vtkCell,
                     __b: vtkmodules.vtkRenderingCore.vtkProp3D) -> None: ...

    def ShowPickSphere(self, pos: MutableSequence[float], radius: float,
                       __c: vtkmodules.vtkRenderingCore.vtkProp3D) -> None: ...
    ...
    def StartLoadCamPose(
        self, __a: vtkmodules.vtkCommonCore.vtkEventDataDevice3D) -> None: ...

    def StartMovement3D(self, interactionState: int,
                        __b: vtkmodules.vtkCommonCore.vtkEventDataDevice3D) -> None: ...

    def StartPick(
        self, __a: vtkmodules.vtkCommonCore.vtkEventDataDevice3D) -> None: ...
    def StartPositionProp(
        self, __a: vtkmodules.vtkCommonCore.vtkEventDataDevice3D) -> None: ...
...
class vtkVRMenuRepresentation(vtkmodules.vtkInteractionWidgets.vtkWidgetRepresentation):
    ...
    def PushFrontMenuItem(self, name: str, text: str,
                          cmd: vtkmodules.vtkCommonCore.vtkCommand) -> None: ...
    def ReleaseGraphicsResources(
        self, __a: vtkmodules.vtkCommonCore.vtkWindow) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRMenuRepresentation: ...
...
class vtkVRMenuWidget(vtkmodules.vtkInteractionWidgets.vtkAbstractWidget):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRMenuWidget: ...
...
class vtkVRModel(vtkmodules.vtkCommonCore.vtkObject):
    def Build(
        self, win: vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRModel: ...
...
class vtkVRPanelRepresentation(vtkmodules.vtkInteractionWidgets.vtkWidgetRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRPanelRepresentation: ...
...
class vtkVRPanelWidget(vtkmodules.vtkInteractionWidgets.vtkAbstractWidget):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRPanelWidget: ...
...
class vtkVRRay(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRRay: ...
...
class vtkVRRenderWindow(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow):
    ...
    def GetHelperWindow(
        self) -> vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow: ...

    def GetInitialized(self) -> bool: ...
    def GetModelForDevice(
        self, idx: vtkmodules.vtkCommonCore.vtkEventDataDevice) -> vtkVRModel: ...
    ...
    def MakeRenderWindowInteractor(
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRRenderWindow: ...

    def SetBaseStationVisibility(self, _arg: bool) -> None: ...
    def SetHelperWindow(
        self, val: vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow) -> None: ...

    def SetPhysicalScale(self, __a: float) -> None: ...

    def SetPhysicalToWorldMatrix(
        self, matrix: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    ...
    @overload
    def SetPhysicalViewDirection(
        self, __a: MutableSequence[float]) -> None: ...
...
class vtkVRRenderWindowInteractor(vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor3D):
    ...
    def DoOneEvent(self, renWin: vtkVRRenderWindow,
    ...
    def GetPhysicalTranslation(
        self, __a: vtkmodules.vtkRenderingCore.vtkCamera) -> Pointer: ...

    def GetPhysicalViewDirection(self) -> Pointer: ...
    def GetPhysicalViewUp(self) -> Pointer: ...

    def GetPointerDevice(
        self) -> vtkmodules.vtkCommonCore.vtkEventDataDevice: ...
    def GetStartingPhysicalToWorldMatrix(
        self, startingPhysicalToWorldMatrix: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRRenderWindowInteractor: ...
    ...
    def SetPhysicalTranslation(self, __a: vtkmodules.vtkRenderingCore.vtkCamera,
                               __b: float, __c: float, __d: float) -> None: ...
...
class vtkVRRenderer(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderer):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRRenderer: ...
