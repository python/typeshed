...
class vtkAbstractInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    def GetLastDataSet(self) -> vtkmodules.vtkCommonDataModel.vtkDataSet: ...
    ...
    def Initialize(self, compDS: vtkmodules.vtkCommonDataModel.vtkCompositeDataSet, initStrategy: int = ...) -> None: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkAbstractInterpolatedVelocityField: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractInterpolatedVelocityField: ...
...
class vtkAMRInterpolatedVelocityField(vtkAbstractInterpolatedVelocityField):
    ...
    @staticmethod
    def FindGrid(
        q: MutableSequence[float], amrds: vtkmodules.vtkCommonDataModel.vtkOverlappingAMR, level: int, gridId: int
    ) -> bool: ...
    @overload
    def FunctionValues(self, x: MutableSequence[float], f: MutableSequence[float]) -> int: ...
    @overload
    def FunctionValues(self, x: MutableSequence[float], f: MutableSequence[float], userData: _Pointer) -> int: ...
    def GetAmrDataSet(self) -> vtkmodules.vtkCommonDataModel.vtkOverlappingAMR: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRInterpolatedVelocityField: ...
    def SetAMRData(self, amr: vtkmodules.vtkCommonDataModel.vtkOverlappingAMR) -> None: ...
    def SetAmrDataSet(self, __a: vtkmodules.vtkCommonDataModel.vtkOverlappingAMR) -> None: ...
    @overload
    def SetLastCellId(self, c: int) -> None: ...
    @overload
    def SetLastCellId(self, c: int, dataindex: int) -> None: ...
...
class vtkCachingInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCachingInterpolatedVelocityField: ...
    def SelectVectors(self, fieldName: str) -> None: ...
    def SetDataSet(
        self,
        I: int,
        dataset: vtkmodules.vtkCommonDataModel.vtkDataSet,
        staticdataset: bool,
        locator: vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator,
    ) -> None: ...
...
class vtkCompositeInterpolatedVelocityField(vtkAbstractInterpolatedVelocityField):
    def AddDataSet(self, dataset: vtkmodules.vtkCommonDataModel.vtkDataSet, maxCellSize: int = 0) -> None: ...
    def CopyParameters(self, from_: vtkAbstractInterpolatedVelocityField) -> None: ...
    @overload
    def FunctionValues(self, x: MutableSequence[float], f: MutableSequence[float]) -> int: ...
    @overload
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeInterpolatedVelocityField: ...
    @overload
    def SetLastCellId(self, c: int, dataindex: int) -> None: ...
    @overload
    def SetLastCellId(self, c: int) -> None: ...
...
class vtkCellLocatorInterpolatedVelocityField(vtkCompositeInterpolatedVelocityField):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCellLocatorInterpolatedVelocityField: ...
...
class vtkEvenlySpacedStreamlines2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetIntegrator(self) -> vtkmodules.vtkCommonMath.vtkInitialValueProblemSolver: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEvenlySpacedStreamlines2D: ...
    ...
    def SetIntegrator(self, __a: vtkmodules.vtkCommonMath.vtkInitialValueProblemSolver) -> None: ...
...
class vtkInterpolatedVelocityField(vtkCompositeInterpolatedVelocityField):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkInterpolatedVelocityField: ...

class vtkIntervalInformation:
    @overload
...
class vtkLagrangianBasicIntegrationModel(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    def AddDataSet(
        self, dataset: vtkmodules.vtkCommonDataModel.vtkDataSet, surface: bool = False, surfaceFlatIndex: int = 0
    ) -> None: ...
    def ClearDataSets(self, surface: bool = False) -> None: ...
    def FinalizeOutputs(
        self,
        particlePathsOutput: vtkmodules.vtkCommonDataModel.vtkPolyData,
        interractionOutput: vtkmodules.vtkCommonDataModel.vtkDataObject,
    ) -> bool: ...
    @overload
    def FunctionValues(self, x: MutableSequence[float], f: MutableSequence[float], userData: _Pointer) -> int: ...
    @overload
    ...
    def GetSeedArray(
        self, idx: int, pointData: vtkmodules.vtkCommonDataModel.vtkPointData
    ) -> vtkmodules.vtkCommonCore.vtkAbstractArray: ...
    def GetSeedArrayComps(self) -> vtkmodules.vtkCommonCore.vtkIntArray: ...
    def GetSeedArrayNames(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetSeedArrayTypes(self) -> vtkmodules.vtkCommonCore.vtkIntArray: ...
    def GetSurfaceArrayComps(self) -> vtkmodules.vtkCommonCore.vtkIntArray: ...
    def GetSurfaceArrayDefaultValues(self) -> vtkmodules.vtkCommonCore.vtkDoubleArray: ...
    def GetSurfaceArrayEnumValues(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetSurfaceArrayNames(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetSurfaceArrayTypes(self) -> vtkmodules.vtkCommonCore.vtkIntArray: ...
    def GetTolerance(self) -> float: ...
    def GetUseInitialIntegrationTime(self) -> bool: ...
    def GetWeightsSize(self) -> int: ...
    def InitializeInteractionData(self, data: vtkmodules.vtkCommonDataModel.vtkFieldData) -> None: ...
    def InitializeParticleData(self, particleData: vtkmodules.vtkCommonDataModel.vtkFieldData, maxTuples: int = 0) -> None: ...
    def InitializePathData(self, data: vtkmodules.vtkCommonDataModel.vtkFieldData) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLagrangianBasicIntegrationModel: ...
    def SetInputArrayToProcess(self, idx: int, port: int, connection: int, fieldAssociation: int, name: str) -> None: ...
    def SetLocator(self, locator: vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator) -> None: ...
...
class vtkLagrangianMatidaIntegrationModel(vtkLagrangianBasicIntegrationModel):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLagrangianMatidaIntegrationModel: ...
...
class vtkLagrangianParticle:
    ...
    def __init__(
        ...
        seedId: int,
        particleId: int,
        seedArrayTupleIndex: int,
        integrationTime: float,
        seedData: vtkmodules.vtkCommonDataModel.vtkPointData,
        numberOfTrackedUserData: int,
    ) -> None: ...
    def GetEquationVariables(self) -> _Pointer: ...
    def GetId(self) -> int: ...
    def GetIntegrationTime(self) -> float: ...
    def GetInteraction(self) -> int: ...
    def GetLastSurfaceCellId(self) -> int: ...
    def GetLastSurfaceDataSet(self) -> vtkmodules.vtkCommonDataModel.vtkDataSet: ...
    def GetNextEquationVariables(self) -> _Pointer: ...
    def GetNextPosition(self) -> _Pointer: ...
    def GetNextTrackedUserData(self) -> tuple[float, float]: ...
    def GetNextUserVariables(self) -> _Pointer: ...
    def GetNextVelocity(self) -> _Pointer: ...
    ...
    def GetPrevEquationVariables(self) -> _Pointer: ...
    def GetPrevIntegrationTime(self) -> float: ...
    def GetPrevPosition(self) -> _Pointer: ...
    def GetPrevTrackedUserData(self) -> tuple[float, float]: ...
    def GetPrevUserVariables(self) -> _Pointer: ...
    def GetPrevVelocity(self) -> _Pointer: ...
    def GetSeedArrayTupleIndex(self) -> int: ...
    def GetSeedData(self) -> vtkmodules.vtkCommonDataModel.vtkPointData: ...
    ...
    def GetUserVariables(self) -> _Pointer: ...
    def GetVelocity(self) -> _Pointer: ...
    def MoveToNextPosition(self) -> None: ...
    def SetIntegrationTime(self, time: float) -> None: ...
    def SetInteraction(self, interaction: int) -> None: ...
    def SetLastSurfaceCell(self, dataset: vtkmodules.vtkCommonDataModel.vtkDataSet, cellId: int) -> None: ...
...
class vtkLagrangianParticleTracker(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    ...
    def GetSurface(self) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkLagrangianParticleTracker: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLagrangianParticleTracker: ...
    ...
    def SetIntegrator(self, integrator: vtkmodules.vtkCommonMath.vtkInitialValueProblemSolver) -> None: ...
    ...
    def SetSurfaceConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetSurfaceData(self, source: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
...
class vtkLinearTransformCellLocator(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLinearTransformCellLocator: ...
    def SetCellLocator(self, locator: vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator) -> None: ...
...
class vtkModifiedBSPTree(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    ...
    def FreeSearchStructure(self) -> None: ...
    def GenerateRepresentation(self, level: int, pd: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
    def GenerateRepresentationLeafs(self, pd: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
    def GetLeafNodeCellInformation(self) -> vtkmodules.vtkCommonCore.vtkIdListCollection: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    @overload
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkModifiedBSPTree: ...
    def ShallowCopy(self, locator: vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator) -> None: ...
...
class vtkParallelVectors(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelVectors: ...
...
class vtkParticleTracerBase(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    UNKNOWN: Solvers
    def AddSourceConnection(self, input: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    ...
    def GetParticleWriter(self) -> vtkmodules.vtkIOCore.vtkAbstractParticleWriter: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParticleTracerBase: ...
    ...
    def SetParticleWriter(self, pw: vtkmodules.vtkIOCore.vtkAbstractParticleWriter) -> None: ...
...
class vtkParticlePathFilter(vtkParticleTracerBase):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParticlePathFilter: ...
...
class vtkParticleTracer(vtkParticleTracerBase):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParticleTracer: ...
...
class vtkStreaklineFilter(vtkParticleTracerBase):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStreaklineFilter: ...
...
class vtkStreamTracer(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def CalculateVorticity(
        self,
        cell: vtkmodules.vtkCommonDataModel.vtkGenericCell,
        pcoords: MutableSequence[float],
        cellVectors: vtkmodules.vtkCommonCore.vtkDoubleArray,
        vorticity: MutableSequence[float],
    ) -> None: ...
    def ConvertIntervals(self, step: float, minStep: float, maxStep: float, direction: int, cellLength: float) -> None: ...
    def ForceSerialExecutionOff(self) -> None: ...
    def ForceSerialExecutionOn(self) -> None: ...
    def GenerateNormals(
        self, output: vtkmodules.vtkCommonDataModel.vtkPolyData, firstNormal: MutableSequence[float], vecName: str
    ) -> None: ...
    def GetComputeVorticity(self) -> bool: ...
    def GetForceSerialExecution(self) -> bool: ...
    def GetInitialIntegrationStep(self) -> float: ...
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetRotationScale(self) -> float: ...
    def GetSource(self) -> vtkmodules.vtkCommonDataModel.vtkDataSet: ...
    def GetStartPosition(self) -> tuple[float, float, float]: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStreamTracer: ...
    def SetComputeVorticity(self, _arg: bool) -> None: ...
    def SetForceSerialExecution(self, _arg: bool) -> None: ...
    def SetInitialIntegrationStep(self, _arg: float) -> None: ...
    ...
    def SetSourceConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetSourceData(self, source: vtkmodules.vtkCommonDataModel.vtkDataSet) -> None: ...
    @overload
    def SetStartPosition(self, _arg1: float, _arg2: float, _arg3: float) -> None: ...
    @overload
    def SetStartPosition(self, _arg: Sequence[float]) -> None: ...
...
class vtkStreamSurface(vtkStreamTracer):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStreamSurface: ...
...
class vtkTemporalInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    SAME_TOPOLOGY: MeshOverTimeTypes
    STATIC: MeshOverTimeTypes
    def AddDataSetAtTime(self, N: int, T: float, dataset: vtkmodules.vtkCommonDataModel.vtkDataSet) -> None: ...
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def Initialize(
        self, t0: vtkmodules.vtkCommonDataModel.vtkCompositeDataSet, t1: vtkmodules.vtkCommonDataModel.vtkCompositeDataSet
    ) -> None: ...
    @overload
    def InterpolatePoint(
        self,
        outPD1: vtkmodules.vtkCommonDataModel.vtkPointData,
        outPD2: vtkmodules.vtkCommonDataModel.vtkPointData,
        outIndex: int,
    ) -> bool: ...
    @overload
    def InterpolatePoint(self, T: int, outPD1: vtkmodules.vtkCommonDataModel.vtkPointData, outIndex: int) -> bool: ...
    def IsA(self, type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTemporalInterpolatedVelocityField: ...
    def SelectVectors(self, fieldName: str) -> None: ...
    def SetCachedCellIds(self, id: MutableSequence[int], ds: MutableSequence[int]) -> None: ...
    def SetDataSetAtTime(
        self, __a: int, __b: int, __c: float, __d: vtkmodules.vtkCommonDataModel.vtkDataSet, __e: bool
    ) -> None: ...
    def SetFindCellStrategy(self, __a: vtkmodules.vtkCommonDataModel.vtkFindCellStrategy) -> None: ...
...
class vtkVectorFieldTopology(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVectorFieldTopology: ...
...
class vtkVortexCore(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVortexCore: ...
