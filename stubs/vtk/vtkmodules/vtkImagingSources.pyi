...
class vtkImageCanvasSource2D(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @overload
    def DrawImage(self, x0: int, y0: int,
                  i: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...

    @overload
    def DrawImage(
        self, x0: int, y0: int, __c: vtkmodules.vtkCommonDataModel.vtkImageData, sx: int, sy: int, width: int, height: int
    ) -> None: ...
    ...
    @overload
    def DrawSegment3D(
        self, p0: MutableSequence[float], p1: MutableSequence[float]) -> None: ...

    @overload
    def DrawSegment3D(self, x1: float, y1: float, z1: float,
    ...
    def FillTriangle(self, x0: int, y0: int, x1: int,
                     y1: int, x2: int, y2: int) -> None: ...
    def FillTube(self, x0: int, y0: int, x1: int,
                 y1: int, radius: float) -> None: ...
    ...
    def InitializeCanvasVolume(
        self, volume: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageCanvasSource2D: ...

    def SetDefaultZ(self, _arg: int) -> None: ...

    @overload
    def SetDrawColor(self, _arg1: float, _arg2: float,
...
class vtkImageEllipsoidSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageEllipsoidSource: ...
    ...
    @overload
    def SetWholeExtent(self, minX: int, maxX: int, minY: int,
...
class vtkImageGaussianSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageGaussianSource: ...
...
class vtkImageGridSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageGridSource: ...
...
class vtkImageMandelbrotSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def CopyOriginAndSample(
        self, source: vtkImageMandelbrotSource) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageMandelbrotSource: ...

    def SetConstantSize(self, _arg: int) -> None: ...
    def SetMaximumNumberOfIterations(self, _arg: int) -> None: ...

    @overload
    def SetOriginCX(self, _arg1: float, _arg2: float,
                    _arg3: float, _arg4: float) -> None: ...
    ...
    @overload
    def SetSampleCX(self, _arg1: float, _arg2: float,
                    _arg3: float, _arg4: float) -> None: ...

    @overload
    def SetSampleCX(self, _arg: Sequence[float]) -> None: ...
    def SetSizeCX(self, cReal: float, cImag: float,
                  xReal: float, xImag: float) -> None: ...
...
class vtkImageNoiseSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageNoiseSource: ...
...
class vtkImageSinusoidSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageSinusoidSource: ...
