...
class vtkContextInteractorStyle(vtkmodules.vtkRenderingCore.vtkInteractorStyle):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextInteractorStyle: ...
    def SetScene(
...
class vtkContextView(vtkmodules.vtkViewsCore.vtkRenderViewBase):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContextView: ...

    def SetContext(
        self, context: vtkmodules.vtkRenderingContext2D.vtkContext2D) -> None: ...
