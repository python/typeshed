...
class vtkDepthImageToPointCloud(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDepthImageToPointCloud: ...
    def SetCamera(
...
class vtkImageResliceMapper(vtkmodules.vtkRenderingCore.vtkImageMapper3D):
    ...
    def GetInterpolator(
        self) -> vtkmodules.vtkImagingCore.vtkAbstractImageInterpolator: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageResliceMapper: ...
    ...
    def SetInterpolator(
        self, interpolator: vtkmodules.vtkImagingCore.vtkAbstractImageInterpolator) -> None: ...
...
class vtkImageSliceCollection(vtkmodules.vtkRenderingCore.vtkPropCollection):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageSliceCollection: ...
...
class vtkImageStack(vtkmodules.vtkRenderingCore.vtkImageSlice):
    def AddImage(
        self, prop: vtkmodules.vtkRenderingCore.vtkImageSlice) -> None: ...
    ...
    def HasImage(
        self, prop: vtkmodules.vtkRenderingCore.vtkImageSlice) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageStack: ...
