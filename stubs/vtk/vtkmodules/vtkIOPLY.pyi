...
class vtkPLY:
    ...
    @staticmethod
    def get_ascii_item(
        __a: str, __b: int, __c: MutableSequence[int], __d: MutableSequence[int], __e: MutableSequence[float]
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def get_stored_item(
        __a: Pointer, __b: int, __c: MutableSequence[int], __d: MutableSequence[int], __e: MutableSequence[float]
    ) -> None: ...
    @staticmethod
    def my_alloc(__a: int, __b: int, __c: str) -> Pointer: ...

    @staticmethod
    def store_item(__a: str, __b: int, __c: int,
...
class vtkPLYReader(vtkmodules.vtkIOCore.vtkAbstractPolyDataReader):
    ...
    def GetComments(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPLYReader: ...
...
class vtkPLYWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPLYWriter: ...
