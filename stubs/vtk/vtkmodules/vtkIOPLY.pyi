...
class vtkPLY:
    ...
    @staticmethod
    def get_stored_item(
        __a: _Pointer, __b: int, __c: MutableSequence[int], __d: MutableSequence[int], __e: MutableSequence[float]
    ) -> None: ...
    @staticmethod
    def my_alloc(__a: int, __b: int, __c: str) -> _Pointer: ...
    @staticmethod
...
class vtkPLYReader(vtkmodules.vtkIOCore.vtkAbstractPolyDataReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPLYReader: ...
...
class vtkPLYWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPLYWriter: ...
