...
class vtkGenericClip(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericClip: ...
...
class vtkGenericContourFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericContourFilter: ...
...
class vtkGenericCutter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericCutter: ...
    def SetCutFunction(
        self, __a: vtkmodules.vtkCommonDataModel.vtkImplicitFunction) -> None: ...
...
class vtkGenericDataSetTessellator(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericDataSetTessellator: ...
...
class vtkGenericGeometryFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericGeometryFilter: ...
...
class vtkGenericGlyph3DFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericGlyph3DFilter: ...
...
class vtkGenericOutlineFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericOutlineFilter: ...
...
class vtkGenericProbeFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSource(self) -> vtkmodules.vtkCommonDataModel.vtkGenericDataSet: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericProbeFilter: ...
    def SetSourceData(
        self, source: vtkmodules.vtkCommonDataModel.vtkGenericDataSet) -> None: ...
...
class vtkGenericStreamTracer(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    UNKNOWN: Solvers
    def AddInputData(
        self, in_: vtkmodules.vtkCommonDataModel.vtkGenericDataSet) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericStreamTracer: ...
    ...
    def SetInterpolatorPrototype(
        self, ivf: vtkmodules.vtkCommonDataModel.vtkGenericInterpolatedVelocityField) -> None: ...
