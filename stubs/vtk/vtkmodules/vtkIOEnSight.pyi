...
class vtkGenericEnSightReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    def GetTimeSets(
        self) -> vtkmodules.vtkCommonCore.vtkDataArrayCollection: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGenericEnSightReader: ...
...
class vtkEnSightReader(vtkGenericEnSightReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSightReader: ...
...
class vtkEnSight6BinaryReader(vtkEnSightReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSight6BinaryReader: ...
...
class vtkEnSight6Reader(vtkEnSightReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSight6Reader: ...
...
class vtkEnSightGoldBinaryReader(vtkEnSightReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSightGoldBinaryReader: ...
...
class vtkEnSightGoldReader(vtkEnSightReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSightGoldReader: ...
...
class vtkEnSightMasterServerReader(vtkGenericEnSightReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEnSightMasterServerReader: ...
