...
class vtkColorSeries(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def AddColor(self, color: vtkmodules.vtkCommonDataModel.vtkColor3ub) -> None: ...
    def BuildLookupTable(self, lkup: vtkmodules.vtkCommonCore.vtkLookupTable, lutIndexing: int = ...) -> None: ...
    def ClearColors(self) -> None: ...
    def CreateLookupTable(self, lutIndexing: int = ...) -> vtkmodules.vtkCommonCore.vtkLookupTable: ...
    def DeepCopy(self, chartColors: vtkColorSeries) -> None: ...
    def GetColor(self, index: int) -> vtkmodules.vtkCommonDataModel.vtkColor3ub: ...
    def GetColorRepeating(self, index: int) -> vtkmodules.vtkCommonDataModel.vtkColor3ub: ...
    ...
    def InsertColor(self, index: int, color: vtkmodules.vtkCommonDataModel.vtkColor3ub) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkColorSeries: ...
    def SetColor(self, index: int, color: vtkmodules.vtkCommonDataModel.vtkColor3ub) -> None: ...
...
class vtkNamedColors(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetColor(self, name: str, rgba: vtkmodules.vtkCommonDataModel.vtkColor4ub) -> None: ...
    @overload
    ...
    @overload
    def GetColor(self, name: str, rgba: vtkmodules.vtkCommonDataModel.vtkColor4d) -> None: ...
    @overload
    def GetColor(self, name: str, r: float, g: float, b: float) -> None: ...
    @overload
    def GetColor(self, name: str, rgb: vtkmodules.vtkCommonDataModel.vtkColor3ub) -> None: ...
    @overload
    def GetColor(self, name: str, rgb: vtkmodules.vtkCommonDataModel.vtkColor3d) -> None: ...
    def GetColor3d(self, name: str) -> vtkmodules.vtkCommonDataModel.vtkColor3d: ...
    def GetColor3ub(self, name: str) -> vtkmodules.vtkCommonDataModel.vtkColor3ub: ...
    def GetColor4d(self, name: str) -> vtkmodules.vtkCommonDataModel.vtkColor4d: ...
    def GetColor4ub(self, name: str) -> vtkmodules.vtkCommonDataModel.vtkColor4ub: ...
    @overload
    def GetColorNames(self) -> str: ...
    @overload
    def GetColorNames(self, colorNames: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
    ...
    def HTMLColorToRGB(self, colorString: str) -> vtkmodules.vtkCommonDataModel.vtkColor3ub: ...
    def HTMLColorToRGBA(self, colorString: str) -> vtkmodules.vtkCommonDataModel.vtkColor4ub: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkNamedColors: ...
    def RGBAToHTMLColor(self, rgba: vtkmodules.vtkCommonDataModel.vtkColor4ub) -> str: ...
    def RGBToHTMLColor(self, rgb: vtkmodules.vtkCommonDataModel.vtkColor3ub) -> str: ...
    def RemoveColor(self, name: str) -> None: ...
    def ResetColors(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkNamedColors: ...
    @overload
    ...
    @overload
    def SetColor(self, name: str, rgba: vtkmodules.vtkCommonDataModel.vtkColor4ub) -> None: ...
    @overload
    def SetColor(self, name: str, rgb: vtkmodules.vtkCommonDataModel.vtkColor3ub) -> None: ...
    @overload
    def SetColor(self, name: str, rgba: Sequence[float]) -> None: ...
    @overload
    def SetColor(self, name: str, rgba: vtkmodules.vtkCommonDataModel.vtkColor4d) -> None: ...
    @overload
    def SetColor(self, name: str, rgb: vtkmodules.vtkCommonDataModel.vtkColor3d) -> None: ...
    @overload
