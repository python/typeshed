...
class vtkCompositePolyDataMapper2(vtkOpenGLPolyDataMapper):
    ...
    def GetBlockColor(self, index: int) -> _Pointer: ...
...
class vtkOpenGLRenderWindow(vtkmodules.vtkRenderingCore.vtkRenderWindow):
    ...
    @overload
    def DrawPixels(self, x1: int, y1: int, x2: int, y2: int, numComponents: int, dataType: int, data: _Pointer) -> None: ...
    @overload
    def DrawPixels(
        self,
        dstXmin: int,
    ...
    @overload
    def DrawPixels(self, srcWidth: int, srcHeight: int, numComponents: int, dataType: int, data: _Pointer) -> None: ...
    def End(self) -> None: ...
    def Frame(self) -> None: ...
    ...
    @overload
    def GetPixelData(self, x: int, y: int, x2: int, y2: int, front: int, right: int) -> _Pointer: ...
    @overload
    def GetPixelData(
        self, x: int, y: int, x2: int, y2: int, front: int, data: vtkmodules.vtkCommonCore.vtkUnsignedCharArray, right: int
    ) -> int: ...
    @overload
    def GetRGBACharPixelData(self, x: int, y: int, x2: int, y2: int, front: int, right: int = 0) -> _Pointer: ...
    @overload
    ...
    @overload
    def GetRGBAPixelData(self, x: int, y: int, x2: int, y2: int, front: int, right: int = 0) -> _Pointer: ...
    @overload
    ...
    @overload
    def GetZbufferData(self, x1: int, y1: int, x2: int, y2: int) -> _Pointer: ...
    @overload
...
class vtkOpenGLCellToVTKCellMap(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetPrimitiveOffsets(self) -> _Pointer: ...
...
class vtkOpenGLImageMapper(vtkmodules.vtkRenderingCore.vtkImageMapper):
    def DrawPixels(
        self, viewport: vtkmodules.vtkRenderingCore.vtkViewport, width: int, height: int, numComponents: int, data: _Pointer
    ) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
...
class vtkPixelBufferObject(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Download1D(self, type: int, data: _Pointer, dim: int, numcomps: int, increment: int) -> bool: ...
    def Download2D(
        self, type: int, data: _Pointer, dims: MutableSequence[int], numcomps: int, increments: MutableSequence[int]
    ) -> bool: ...
    def Download3D(
        self, type: int, data: _Pointer, dims: MutableSequence[int], numcomps: int, increments: MutableSequence[int]
    ) -> bool: ...
    ...
    def IsTypeOf(type: str) -> int: ...
    @overload
    def MapBuffer(self, type: int, numtuples: int, comps: int, mode: BufferType) -> _Pointer: ...
    @overload
    def MapBuffer(self, numbytes: int, mode: BufferType) -> _Pointer: ...
    @overload
    def MapBuffer(self, mode: BufferType) -> _Pointer: ...
    @overload
    def MapPackedBuffer(self) -> _Pointer: ...
    @overload
    def MapPackedBuffer(self, type: int, numtuples: int, comps: int) -> _Pointer: ...
    @overload
    def MapPackedBuffer(self, numbytes: int) -> _Pointer: ...
    @overload
    def MapUnpackedBuffer(self) -> _Pointer: ...
    @overload
    def MapUnpackedBuffer(self, type: int, numtuples: int, comps: int) -> _Pointer: ...
    @overload
    def MapUnpackedBuffer(self, numbytes: int) -> _Pointer: ...
    ...
    def Upload1D(self, type: int, data: _Pointer, numtuples: int, comps: int, increment: int) -> bool: ...
    def Upload2D(
        self, type: int, data: _Pointer, dims: MutableSequence[int], comps: int, increments: MutableSequence[int]
    ) -> bool: ...
    def Upload3D(
        self,
        type: int,
...
class vtkTextureObject(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Create1DFromRaw(self, width: int, numComps: int, dataType: int, data: _Pointer) -> bool: ...
    @overload
    def Create2D(
    ...
    def Create2DFromRaw(self, width: int, height: int, numComps: int, dataType: int, data: _Pointer) -> bool: ...
    @overload
    def Create3D(
    ...
    def Create3DFromRaw(self, width: int, height: int, depth: int, numComps: int, dataType: int, data: _Pointer) -> bool: ...
    def CreateDepth(self, width: int, height: int, internalFormat: int, pbo: vtkPixelBufferObject) -> bool: ...
    def CreateDepthFromRaw(self, width: int, height: int, internalFormat: int, rawType: int, raw: _Pointer) -> bool: ...
...
class vtkValuePass(vtkOpenGLRenderPass):
    ...
    def GetFloatImageData(self, format: int, width: int, height: int, data: _Pointer) -> None: ...
...
class vtkXOpenGLRenderWindow(vtkOpenGLRenderWindow):
    ...
    def GetGenericDisplayId(self) -> _Pointer: ...
    def GetGenericDrawable(self) -> _Pointer: ...
    def GetGenericFBConfig(self) -> _Pointer: ...
    def GetGenericParentId(self) -> _Pointer: ...
    def GetGenericWindowId(self) -> _Pointer: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
