...
class vtkConvertSelectionDomain(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkConvertSelectionDomain: ...


class vtkDataRepresentation(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    @overload
    def Annotate(self, view: vtkView,
                 annotations: vtkmodules.vtkCommonDataModel.vtkAnnotationLayers) -> None: ...

    @overload
    def Annotate(self, view: vtkView,
                 annotations: vtkmodules.vtkCommonDataModel.vtkAnnotationLayers, extend: bool) -> None: ...
    ...
    def GetInputConnection(
        self, port: int = 0, index: int = 0) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...

    @overload
    def GetInternalAnnotationOutputPort(
        self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...

    @overload
    def GetInternalAnnotationOutputPort(
        self, port: int) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...

    @overload
    def GetInternalAnnotationOutputPort(
        self, port: int, conn: int) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...

    @overload
    def GetInternalOutputPort(
        self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    ...
    @overload
    def GetInternalSelectionOutputPort(
        self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDataRepresentation: ...

    @overload
    def Select(self, view: vtkView,
               selection: vtkmodules.vtkCommonDataModel.vtkSelection) -> None: ...

    @overload
    def Select(self, view: vtkView,
               selection: vtkmodules.vtkCommonDataModel.vtkSelection, extend: bool) -> None: ...
    ...
    def UpdateAnnotations(
        self, annotations: vtkmodules.vtkCommonDataModel.vtkAnnotationLayers) -> None: ...

    @overload
    def UpdateAnnotations(
        self, annotations: vtkmodules.vtkCommonDataModel.vtkAnnotationLayers, extend: bool) -> None: ...

    @overload
    def UpdateSelection(
        self, selection: vtkmodules.vtkCommonDataModel.vtkSelection) -> None: ...

    @overload
    def UpdateSelection(
        self, selection: vtkmodules.vtkCommonDataModel.vtkSelection, extend: bool) -> None: ...
...
class vtkEmptyRepresentation(vtkDataRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkEmptyRepresentation: ...


class vtkView(vtkmodules.vtkCommonCore.vtkObject):
    def AddRepresentation(self, rep: vtkDataRepresentation) -> None: ...

    def AddRepresentationFromInput(
        self, input: vtkmodules.vtkCommonDataModel.vtkDataObject) -> vtkDataRepresentation: ...
    ...
    def RegisterProgress(
        self, algorithm: vtkmodules.vtkCommonCore.vtkObject, message: str = ...) -> None: ...
    ...
    @overload
    def RemoveRepresentation(
        self, rep: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    ...
    def SetRepresentationFromInput(
        self, input: vtkmodules.vtkCommonDataModel.vtkDataObject) -> vtkDataRepresentation: ...

    def SetRepresentationFromInputConnection(
        self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput
    ) -> vtkDataRepresentation: ...
    def UnRegisterProgress(
        self, algorithm: vtkmodules.vtkCommonCore.vtkObject) -> None: ...
...
class vtkRenderViewBase(vtkView):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderViewBase: ...
...
class vtkViewTheme(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def LookupMatchesCellTheme(
        self, s2c: vtkmodules.vtkCommonCore.vtkScalarsToColors) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkViewTheme: ...
    ...
    @overload
    def SetCellColor(self, _arg1: float, _arg2: float,
                     _arg3: float) -> None: ...
    ...
    @overload
    def SetOutlineColor(self, _arg1: float, _arg2: float,
                        _arg3: float) -> None: ...
    ...
    @overload
    def SetPointColor(self, _arg1: float, _arg2: float,
                      _arg3: float) -> None: ...
