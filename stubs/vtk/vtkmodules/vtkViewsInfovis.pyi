...
class vtkApplyColors(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkApplyColors: ...
...
class vtkApplyIcons(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkApplyIcons: ...
    ...
    @overload
    def SetIconType(self, v: vtkmodules.vtkCommonCore.vtkVariant,
                    icon: int) -> None: ...
...
class vtkDendrogramItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def ComputeLabelWidth(
        self, painter: vtkmodules.vtkRenderingContext2D.vtkContext2D) -> None: ...
    ...
    def GetPositionOfVertex(self, vertexName: str,
                            position: MutableSequence[float]) -> bool: ...
    def GetPositionVector(
        self) -> vtkmodules.vtkCommonDataModel.vtkVector2f: ...

    def GetPrunedTree(self) -> vtkmodules.vtkCommonDataModel.vtkTree: ...
    def GetTextAngleForOrientation(self, orientation: int) -> float: ...
    def GetTree(self) -> vtkmodules.vtkCommonDataModel.vtkTree: ...
    ...
    def MouseDoubleClickEvent(
        self, event: vtkmodules.vtkRenderingContext2D.vtkContextMouseEvent) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDendrogramItem: ...
    ...
    def SetTree(self, tree: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
...
class vtkGraphItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def GetLayout(
        self) -> vtkmodules.vtkInfovisLayout.vtkIncrementalForceLayout: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphItem: ...

    def SetGraph(
        self, graph: vtkmodules.vtkCommonDataModel.vtkGraph) -> None: ...
    def StartLayoutAnimation(
        self, interactor: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
...
class vtkRenderView(vtkmodules.vtkViewsCore.vtkRenderViewBase):
    ...
    def AddLabels(
        self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def ApplyViewTheme(
        self, theme: vtkmodules.vtkViewsCore.vtkViewTheme) -> None: ...
    ...
    def GetIconTexture(self) -> vtkmodules.vtkRenderingCore.vtkTexture: ...
    def GetInteractionMode(self) -> int: ...
    def GetInteractorStyle(
        self) -> vtkmodules.vtkRenderingCore.vtkInteractorObserver: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderView: ...
    ...
    def SetIconTexture(
        self, texture: vtkmodules.vtkRenderingCore.vtkTexture) -> None: ...
    ...
    def SetInteractor(
        self, interactor: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
    def SetInteractorStyle(
        self, style: vtkmodules.vtkRenderingCore.vtkInteractorObserver) -> None: ...
    ...
    def SetTransform(
        self, transform: vtkmodules.vtkCommonTransforms.vtkAbstractTransform) -> None: ...
...
class vtkGraphLayoutView(vtkRenderView):
    ...
    def GetEdgeLayoutStrategy(
        self) -> vtkmodules.vtkInfovisLayout.vtkEdgeLayoutStrategy: ...
    ...
    def GetLayoutStrategy(
        self) -> vtkmodules.vtkInfovisLayout.vtkGraphLayoutStrategy: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphLayoutView: ...
    ...
    @overload
    def SetEdgeLayoutStrategy(
        self, s: vtkmodules.vtkInfovisLayout.vtkEdgeLayoutStrategy) -> None: ...
    ...
    def SetLayoutStrategy(
        self, s: vtkmodules.vtkInfovisLayout.vtkGraphLayoutStrategy) -> None: ...
...
class vtkHeatmapItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def GetRowNames(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetTable(self) -> vtkmodules.vtkCommonDataModel.vtkTable: ...
    def GetTextAngleForOrientation(self, orientation: int) -> float: ...
    def Hit(
        self, mouse: vtkmodules.vtkRenderingContext2D.vtkContextMouseEvent) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHeatmapItem: ...
...
class vtkHierarchicalGraphPipeline(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ConvertSelection(
        self, rep: vtkmodules.vtkViewsCore.vtkDataRepresentation, sel: vtkmodules.vtkCommonDataModel.vtkSelection
    ) -> vtkmodules.vtkCommonDataModel.vtkSelection: ...
    def GetActor(self) -> vtkmodules.vtkRenderingCore.vtkActor: ...
    ...
    def GetLabelActor(self) -> vtkmodules.vtkRenderingCore.vtkActor2D: ...
    ...
    def PrepareInputConnections(
        self,
        graphConn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput,
        treeConn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput,
        annConn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput,
    ) -> None: ...
    def RegisterProgress(self, view: vtkRenderView) -> None: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHierarchicalGraphPipeline: ...
...
class vtkHierarchicalGraphView(vtkGraphLayoutView):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHierarchicalGraphView: ...
    ...
    def SetGraphFromInput(
        self, input: vtkmodules.vtkCommonDataModel.vtkDataObject
    ) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...

    def SetGraphFromInputConnection(
        self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput
    ) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...
    def SetGraphVisibility(self, vis: bool) -> None: ...

    def SetHierarchyFromInput(
        self, input: vtkmodules.vtkCommonDataModel.vtkDataObject
    ) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...

    def SetHierarchyFromInputConnection(
        self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput
    ) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...
...
class vtkTreeAreaView(vtkRenderView):
    ...
    def GetLayoutStrategy(
        self) -> vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeAreaView: ...
    ...
    def SetGraphFromInput(
        self, input: vtkmodules.vtkCommonDataModel.vtkGraph
    ) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...
    ...
    def SetLayoutStrategy(
        self, strategy: vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy) -> None: ...

    def SetShrinkPercentage(self, value: float) -> None: ...

    def SetTreeFromInput(
        self, input: vtkmodules.vtkCommonDataModel.vtkTree) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...

    def SetTreeFromInputConnection(
        self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput
    ) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...
...
class vtkIcicleView(vtkTreeAreaView):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkIcicleView: ...
...
class vtkInteractorStyleAreaSelectHover(vtkmodules.vtkInteractionStyle.vtkInteractorStyleRubberBand2D):
    ...
    def GetLayout(self) -> vtkmodules.vtkInfovisLayout.vtkAreaLayout: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetUseRectangularCoordinates(self) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkInteractorStyleAreaSelectHover: ...
    ...
    def SetLayout(
        self, layout: vtkmodules.vtkInfovisLayout.vtkAreaLayout) -> None: ...
...
class vtkInteractorStyleTreeMapHover(vtkmodules.vtkInteractionStyle.vtkInteractorStyleImage):
    def GetHighLightWidth(self) -> float: ...
    def GetLabelField(self) -> str: ...
    def GetLayout(self) -> vtkmodules.vtkInfovisLayout.vtkTreeMapLayout: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSelectionWidth(self) -> float: ...
    def GetTreeMapToPolyData(
        self) -> vtkmodules.vtkInfovisLayout.vtkTreeMapToPolyData: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkInteractorStyleTreeMapHover: ...
    ...
    def SetLabelField(self, _arg: str) -> None: ...
    def SetLayout(
        self, layout: vtkmodules.vtkInfovisLayout.vtkTreeMapLayout) -> None: ...

    def SetSelectionLightColor(self, r: float, g: float, b: float) -> None: ...
    def SetSelectionWidth(self, lw: float) -> None: ...
    def SetTreeMapToPolyData(
        self, filter: vtkmodules.vtkInfovisLayout.vtkTreeMapToPolyData) -> None: ...
...
class vtkRenderedRepresentation(vtkmodules.vtkViewsCore.vtkDataRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedRepresentation: ...
...
class vtkParallelCoordinatesRepresentation(vtkRenderedRepresentation):
    ...
    def GetHoverString(
        self, view: vtkmodules.vtkViewsCore.vtkView, x: int, y: int) -> str: ...
    ...
    def GetPositionAndSize(
        self, position: MutableSequence[float], size: MutableSequence[float]) -> int: ...

    def GetPositionNearXCoordinate(self, xcoord: float) -> int: ...
    def GetRangeAtPosition(self, position: int,
                           range: MutableSequence[float]) -> int: ...

    def GetUseCurves(self) -> int: ...
    def GetXCoordinateOfPosition(self, axis: int) -> float: ...
    def GetXCoordinatesOfPositions(
        self, coords: MutableSequence[float]) -> None: ...

    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def LassoSelect(self, brushClass: int, brushOperator: int,
                    brushPoints: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelCoordinatesRepresentation: ...

    def SetAngleBrushThreshold(self, _arg: float) -> None: ...

    @overload
    def SetAxisColor(self, _arg1: float, _arg2: float,
                     _arg3: float) -> None: ...
    ...
    @overload
    def SetAxisLabelColor(self, _arg1: float, _arg2: float,
                          _arg3: float) -> None: ...
    ...
    @overload
    def SetAxisTitles(
        self, __a: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
    ...
    @overload
    def SetLineColor(self, _arg1: float, _arg2: float,
                     _arg3: float) -> None: ...
    ...
    def SetPositionAndSize(
        self, position: MutableSequence[float], size: MutableSequence[float]) -> int: ...
    def SetRangeAtPosition(self, position: int,
                           range: MutableSequence[float]) -> int: ...

    def SetUseCurves(self, _arg: int) -> None: ...
    def SetXCoordinateOfPosition(
        self, position: int, xcoord: float) -> int: ...
...
class vtkParallelCoordinatesHistogramRepresentation(vtkParallelCoordinatesRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelCoordinatesHistogramRepresentation: ...

    @overload
    def SetHistogramLookupTableRange(
...
class vtkParallelCoordinatesView(vtkRenderView):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelCoordinatesView: ...
...
class vtkRenderedGraphRepresentation(vtkRenderedRepresentation):
    ...
    def ComputeSelectedGraphBounds(
    ...
    def GetEdgeLayoutStrategyName(self) -> str: ...
    def GetEdgeScalarBar(
        self) -> vtkmodules.vtkInteractionWidgets.vtkScalarBarWidget: ...
    ...
    def GetVertexLabelTextProperty(
        self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...

    def GetVertexLabelVisibility(self) -> bool: ...
    def GetVertexScalarBar(
        self) -> vtkmodules.vtkInteractionWidgets.vtkScalarBarWidget: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedGraphRepresentation: ...
    ...
    @overload
    def SetEdgeLayoutStrategy(
        self, strategy: vtkmodules.vtkInfovisLayout.vtkEdgeLayoutStrategy) -> None: ...

    @overload
    def SetEdgeLayoutStrategy(self, name: str) -> None: ...
    def SetEdgeLayoutStrategyToArcParallel(self) -> None: ...
    def SetEdgeLayoutStrategyToGeo(
        self, explodeFactor: float = 0.2) -> None: ...
    ...
    @overload
    def SetLayoutStrategy(
        self, strategy: vtkmodules.vtkInfovisLayout.vtkGraphLayoutStrategy) -> None: ...

    @overload
    def SetLayoutStrategy(self, name: str) -> None: ...
    def SetLayoutStrategyToAssignCoordinates(
        self, xarr: str, yarr: str = ..., zarr: str = ...) -> None: ...
    ...
    @overload
    def SetLayoutStrategyToCosmicTree(
        self, nodeSizeArrayName: str, sizeLeafNodesOnly: bool = True, layoutDepth: int = 0, layoutRoot: int = -1
    ) -> None: ...
    def SetLayoutStrategyToFast2D(self) -> None: ...
    def SetLayoutStrategyToForceDirected(self) -> None: ...
    def SetLayoutStrategyToPassThrough(self) -> None: ...
    ...
    @overload
    def SetLayoutStrategyToTree(
        self, radial: bool, angle: float = 90, leafSpacing: float = 0.9, logSpacing: float = 1.0
    ) -> None: ...
    ...
    def SetVertexLabelTextProperty(
        self, p: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...
...
class vtkRenderedHierarchyRepresentation(vtkRenderedGraphRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedHierarchyRepresentation: ...
...
class vtkRenderedSurfaceRepresentation(vtkRenderedRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedSurfaceRepresentation: ...
...
class vtkRenderedTreeAreaRepresentation(vtkRenderedRepresentation):
    ...
    def GetAreaHoverArrayName(self) -> str: ...
    def GetAreaLabelArrayName(self) -> str: ...
    def GetAreaLabelMapper(
        self) -> vtkmodules.vtkRenderingLabel.vtkLabeledDataMapper: ...

    def GetAreaLabelPriorityArrayName(self) -> str: ...
    def GetAreaLabelTextProperty(
        self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...

    def GetAreaLabelVisibility(self) -> bool: ...
    def GetAreaLayoutStrategy(
        self) -> vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy: ...

    def GetAreaSizeArrayName(self) -> str: ...
    def GetAreaToPolyData(
    ...
    @overload
    def GetGraphEdgeLabelTextProperty(
        self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...

    @overload
    def GetGraphEdgeLabelTextProperty(
        self, idx: int) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedTreeAreaRepresentation: ...

    def SetAreaColorArrayName(self, name: str) -> None: ...
    def SetAreaHoverArrayName(self, _arg: str) -> None: ...
    def SetAreaLabelArrayName(self, name: str) -> None: ...
    def SetAreaLabelMapper(
        self, mapper: vtkmodules.vtkRenderingLabel.vtkLabeledDataMapper) -> None: ...

    def SetAreaLabelPriorityArrayName(self, name: str) -> None: ...
    def SetAreaLabelTextProperty(
        self, tp: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...

    def SetAreaLabelVisibility(self, vis: bool) -> None: ...
    def SetAreaLayoutStrategy(
        self, strategy: vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy) -> None: ...

    def SetAreaSizeArrayName(self, name: str) -> None: ...
    def SetAreaToPolyData(
        self, areaToPoly: vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm) -> None: ...
    ...
    @overload
    def SetGraphEdgeLabelTextProperty(
        self, tp: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...

    @overload
    def SetGraphEdgeLabelTextProperty(
        self, tp: vtkmodules.vtkRenderingCore.vtkTextProperty, idx: int) -> None: ...
...
class vtkSCurveSpline(vtkmodules.vtkCommonDataModel.vtkSpline):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSCurveSpline: ...
...
class vtkTanglegramItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTanglegramItem: ...
    ...
    def SetTable(
        self, table: vtkmodules.vtkCommonDataModel.vtkTable) -> None: ...
    def SetTree1(
        self, tree: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
...
class vtkTreeHeatmapItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def GetColumnTree(self) -> vtkmodules.vtkCommonDataModel.vtkTree: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeHeatmapItem: ...
    def SetColumnTree(
        self, tree: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
...
class vtkTreeMapView(vtkTreeAreaView):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeMapView: ...

    def SetFontSizeRange(self, maxSize: int, minSize: int,
                         delta: int = 4) -> None: ...

    @overload
    def SetLayoutStrategy(
        self, s: vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy) -> None: ...
...
class vtkTreeRingView(vtkTreeAreaView):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeRingView: ...
...
class vtkViewUpdater(vtkmodules.vtkCommonCore.vtkObject):
    def AddAnnotationLink(
        self, link: vtkmodules.vtkFiltersGeneral.vtkAnnotationLink) -> None: ...

    def AddView(self, view: vtkmodules.vtkViewsCore.vtkView) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def IsA(self, type: str) -> int: ...
    ...
    def RemoveView(self, view: vtkmodules.vtkViewsCore.vtkView) -> None: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkViewUpdater: ...
