...
class vtkApplyColors(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkApplyColors: ...
...
class vtkApplyIcons(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkApplyIcons: ...
    ...
    @overload
    def SetIconType(self, v: vtkmodules.vtkCommonCore.vtkVariant, icon: int) -> None: ...
    @overload
...
class vtkDendrogramItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def ComputeLabelWidth(self, painter: vtkmodules.vtkRenderingContext2D.vtkContext2D) -> None: ...
    ...
    def GetPositionVector(self) -> vtkmodules.vtkCommonDataModel.vtkVector2f: ...
    ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def MouseDoubleClickEvent(self, event: vtkmodules.vtkRenderingContext2D.vtkContextMouseEvent) -> bool: ...
    def NewInstance(self) -> vtkDendrogramItem: ...
    def Paint(self, painter: vtkmodules.vtkRenderingContext2D.vtkContext2D) -> bool: ...
    def PrepareToPaint(self, painter: vtkmodules.vtkRenderingContext2D.vtkContext2D) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDendrogramItem: ...
    ...
    @overload
    def SetPosition(self, pos: vtkmodules.vtkCommonDataModel.vtkVector2f) -> None: ...
...
class vtkGraphItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def GetLayout(self) -> vtkmodules.vtkInfovisLayout.vtkIncrementalForceLayout: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def IsA(self, type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphItem: ...
    def SetGraph(self, graph: vtkmodules.vtkCommonDataModel.vtkGraph) -> None: ...
    def StartLayoutAnimation(self, interactor: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
...
class vtkRenderView(vtkmodules.vtkViewsCore.vtkRenderViewBase):
    ...
    def AddLabels(self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def ApplyViewTheme(self, theme: vtkmodules.vtkViewsCore.vtkViewTheme) -> None: ...
    ...
    def RemoveLabels(self, conn: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def Render(self) -> None: ...
    def RenderOnMouseMoveOff(self) -> None: ...
    def RenderOnMouseMoveOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderView: ...
    ...
    def SetIconTexture(self, texture: vtkmodules.vtkRenderingCore.vtkTexture) -> None: ...
    def SetInteractionMode(self, mode: int) -> None: ...
    def SetInteractionModeTo2D(self) -> None: ...
    def SetInteractionModeTo3D(self) -> None: ...
    def SetInteractor(self, interactor: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
    def SetInteractorStyle(self, style: vtkmodules.vtkRenderingCore.vtkInteractorObserver) -> None: ...
...
class vtkGraphLayoutView(vtkRenderView):
    ...
    def GetLayoutStrategy(self) -> vtkmodules.vtkInfovisLayout.vtkGraphLayoutStrategy: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphLayoutView: ...
    ...
    @overload
    def SetEdgeLayoutStrategy(self, s: vtkmodules.vtkInfovisLayout.vtkEdgeLayoutStrategy) -> None: ...
    ...
    @overload
    def SetLayoutStrategy(self, s: vtkmodules.vtkInfovisLayout.vtkGraphLayoutStrategy) -> None: ...
...
class vtkHeatmapItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def MouseDoubleClickEvent(self, event: vtkmodules.vtkRenderingContext2D.vtkContextMouseEvent) -> bool: ...
    def MouseMoveEvent(self, event: vtkmodules.vtkRenderingContext2D.vtkContextMouseEvent) -> bool: ...
    def NewInstance(self) -> vtkHeatmapItem: ...
    def Paint(self, painter: vtkmodules.vtkRenderingContext2D.vtkContext2D) -> bool: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHeatmapItem: ...
    ...
    @overload
    def SetPosition(self, pos: vtkmodules.vtkCommonDataModel.vtkVector2f) -> None: ...
    def SetTable(self, table: vtkmodules.vtkCommonDataModel.vtkTable) -> None: ...
...
class vtkHierarchicalGraphPipeline(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHierarchicalGraphPipeline: ...
    ...
    def SetLabelTextProperty(self, prop: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...
...
class vtkHierarchicalGraphView(vtkGraphLayoutView):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHierarchicalGraphView: ...
    def SetBundlingStrength(self, strength: float) -> None: ...
...
class vtkTreeAreaView(vtkRenderView):
    ...
    def GetLayoutStrategy(self) -> vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeAreaView: ...
    ...
    def SetLayoutStrategy(self, strategy: vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy) -> None: ...
    def SetShrinkPercentage(self, value: float) -> None: ...
    def SetTreeFromInput(self, input: vtkmodules.vtkCommonDataModel.vtkTree) -> vtkmodules.vtkViewsCore.vtkDataRepresentation: ...
...
class vtkIcicleView(vtkTreeAreaView):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkIcicleView: ...
...
class vtkInteractorStyleAreaSelectHover(vtkmodules.vtkInteractionStyle.vtkInteractorStyleRubberBand2D):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkInteractorStyleAreaSelectHover: ...
    def SetHighLightColor(self, r: float, g: float, b: float) -> None: ...
    def SetHighLightWidth(self, lw: float) -> None: ...
    def SetInteractor(self, rwi: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
    def SetLabelField(self, _arg: str) -> None: ...
    def SetLayout(self, layout: vtkmodules.vtkInfovisLayout.vtkAreaLayout) -> None: ...
...
class vtkInteractorStyleTreeMapHover(vtkmodules.vtkInteractionStyle.vtkInteractorStyleImage):
    ...
    def GetTreeMapToPolyData(self) -> vtkmodules.vtkInfovisLayout.vtkTreeMapToPolyData: ...
    ...
    def OnMouseMove(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkInteractorStyleTreeMapHover: ...
    def SetHighLightColor(self, r: float, g: float, b: float) -> None: ...
    def SetHighLightWidth(self, lw: float) -> None: ...
    def SetInteractor(self, rwi: vtkmodules.vtkRenderingCore.vtkRenderWindowInteractor) -> None: ...
    def SetLabelField(self, _arg: str) -> None: ...
    ...
    def SetTreeMapToPolyData(self, filter: vtkmodules.vtkInfovisLayout.vtkTreeMapToPolyData) -> None: ...
...
class vtkRenderedRepresentation(vtkmodules.vtkViewsCore.vtkDataRepresentation):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedRepresentation: ...
...
class vtkParallelCoordinatesRepresentation(vtkRenderedRepresentation):
    ...
    def GetHoverString(self, view: vtkmodules.vtkViewsCore.vtkView, x: int, y: int) -> str: ...
    ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def LassoSelect(self, brushClass: int, brushOperator: int, brushPoints: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelCoordinatesRepresentation: ...
    ...
    @overload
    def SetAxisTitles(self, __a: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
    @overload
    def SetAxisTitles(self, __a: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
...
class vtkParallelCoordinatesHistogramRepresentation(vtkParallelCoordinatesRepresentation):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelCoordinatesHistogramRepresentation: ...
    @overload
...
class vtkParallelCoordinatesView(vtkRenderView):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelCoordinatesView: ...
...
class vtkRenderedGraphRepresentation(vtkRenderedRepresentation):
    ...
    def GetEdgeLabelTextProperty(self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    def GetEdgeLabelVisibility(self) -> bool: ...
    def GetEdgeLayoutStrategy(self) -> vtkmodules.vtkInfovisLayout.vtkEdgeLayoutStrategy: ...
    def GetEdgeLayoutStrategyName(self) -> str: ...
    ...
    def GetVertexLabelTextProperty(self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    def GetVertexLabelVisibility(self) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedGraphRepresentation: ...
    ...
    def SetEdgeLabelTextProperty(self, p: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...
    def SetEdgeLabelVisibility(self, b: bool) -> None: ...
    @overload
    def SetEdgeLayoutStrategy(self, strategy: vtkmodules.vtkInfovisLayout.vtkEdgeLayoutStrategy) -> None: ...
    @overload
    def SetEdgeLayoutStrategy(self, name: str) -> None: ...
    def SetEdgeLayoutStrategyToArcParallel(self) -> None: ...
    ...
    @overload
    def SetLayoutStrategy(self, strategy: vtkmodules.vtkInfovisLayout.vtkGraphLayoutStrategy) -> None: ...
    @overload
    def SetLayoutStrategy(self, name: str) -> None: ...
    ...
    def SetVertexLabelTextProperty(self, p: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...
...
class vtkRenderedHierarchyRepresentation(vtkRenderedGraphRepresentation):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedHierarchyRepresentation: ...
    @overload
    def SetBundlingStrength(self, strength: float) -> None: ...
    @overload
...
class vtkRenderedSurfaceRepresentation(vtkRenderedRepresentation):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedSurfaceRepresentation: ...
...
class vtkRenderedTreeAreaRepresentation(vtkRenderedRepresentation):
    ...
    def GetAreaLabelTextProperty(self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    def GetAreaLabelVisibility(self) -> bool: ...
    def GetAreaLayoutStrategy(self) -> vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy: ...
    def GetAreaSizeArrayName(self) -> str: ...
    def GetAreaToPolyData(self) -> vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm: ...
    ...
    def GetGraphEdgeLabelArrayName(self, idx: int) -> str: ...
    @overload
    def GetGraphEdgeLabelTextProperty(self) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    @overload
    def GetGraphEdgeLabelTextProperty(self, idx: int) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    @overload
    def GetGraphEdgeLabelVisibility(self) -> bool: ...
    @overload
    def GetGraphEdgeLabelVisibility(self, idx: int) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRenderedTreeAreaRepresentation: ...
    def SetAreaColorArrayName(self, name: str) -> None: ...
    def SetAreaHoverArrayName(self, _arg: str) -> None: ...
    def SetAreaLabelArrayName(self, name: str) -> None: ...
    def SetAreaLabelMapper(self, mapper: vtkmodules.vtkRenderingLabel.vtkLabeledDataMapper) -> None: ...
    def SetAreaLabelPriorityArrayName(self, name: str) -> None: ...
    def SetAreaLabelTextProperty(self, tp: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...
    def SetAreaLabelVisibility(self, vis: bool) -> None: ...
    def SetAreaLayoutStrategy(self, strategy: vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy) -> None: ...
    def SetAreaSizeArrayName(self, name: str) -> None: ...
    def SetAreaToPolyData(self, areaToPoly: vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm) -> None: ...
    ...
    def SetGraphEdgeLabelArrayName(self, name: str, idx: int) -> None: ...
    @overload
    def SetGraphEdgeLabelTextProperty(self, tp: vtkmodules.vtkRenderingCore.vtkTextProperty) -> None: ...
    @overload
    def SetGraphEdgeLabelTextProperty(self, tp: vtkmodules.vtkRenderingCore.vtkTextProperty, idx: int) -> None: ...
    @overload
    def SetGraphEdgeLabelVisibility(self, vis: bool) -> None: ...
    @overload
    def SetGraphEdgeLabelVisibility(self, vis: bool, idx: int) -> None: ...
...
class vtkSCurveSpline(vtkmodules.vtkCommonDataModel.vtkSpline):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSCurveSpline: ...
...
class vtkTanglegramItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTanglegramItem: ...
    ...
    def SetOrientation(self, orientation: int) -> None: ...
    def SetTable(self, table: vtkmodules.vtkCommonDataModel.vtkTable) -> None: ...
    def SetTree1(self, tree: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
    def SetTree1Label(self, _arg: str) -> None: ...
    def SetTree2(self, tree: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
...
class vtkTreeHeatmapItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeHeatmapItem: ...
    def SetColumnTree(self, tree: vtkmodules.vtkCommonDataModel.vtkTree) -> None: ...
...
class vtkTreeMapView(vtkTreeAreaView):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeMapView: ...
    def SetFontSizeRange(self, maxSize: int, minSize: int, delta: int = 4) -> None: ...
    @overload
    def SetLayoutStrategy(self, s: vtkmodules.vtkInfovisLayout.vtkAreaLayoutStrategy) -> None: ...
    @overload
    def SetLayoutStrategy(self, name: str) -> None: ...
...
class vtkTreeRingView(vtkTreeAreaView):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeRingView: ...
...
class vtkViewUpdater(vtkmodules.vtkCommonCore.vtkObject):
    def AddAnnotationLink(self, link: vtkmodules.vtkFiltersGeneral.vtkAnnotationLink) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkViewUpdater: ...
