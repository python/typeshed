...
class vtkImageData(vtkDataSet):
    ...
    def GetArrayPointer(self, array: vtkmodules.vtkCommonCore.vtkDataArray, coordinates: MutableSequence[int]) -> Pointer: ...
    def GetArrayPointerForExtent(self, array: vtkmodules.vtkCommonCore.vtkDataArray, extent: MutableSequence[int]) -> Pointer: ...
