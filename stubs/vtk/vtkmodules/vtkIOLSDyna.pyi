...
class vtkLSDynaReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLSDynaReader: ...
    @overload
...
class vtkLSDynaSummaryParser(vtkmodules.vtkIOXMLParser.vtkXMLParser):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLSDynaSummaryParser: ...
