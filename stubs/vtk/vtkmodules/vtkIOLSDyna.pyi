...
class vtkLSDynaReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @overload
    def GetNumberOfComponentsInCellArray(
        self, cellType: int, arr: int) -> int: ...

    @overload
    def GetNumberOfComponentsInCellArray(
        self, cellType: int, arrName: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLSDynaReader: ...
    ...
    @overload
    def SetCellArrayStatus(self, cellType: int, arr: int,
                           status: int) -> None: ...

    @overload
    def SetCellArrayStatus(self, cellType: int,
                           arrName: str, status: int) -> None: ...
...
class vtkLSDynaSummaryParser(vtkmodules.vtkIOXMLParser.vtkXMLParser):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLSDynaSummaryParser: ...
