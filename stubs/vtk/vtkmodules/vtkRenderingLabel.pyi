...
class vtkLabeledDataMapper(vtkmodules.vtkRenderingCore.vtkMapper2D):
    ...
    def GetLabelPosition(
        self, label: int, pos: MutableSequence[float]) -> None: ...
    ...
    @overload
    def GetLabelTextProperty(
        self, type: int) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabeledDataMapper: ...
    ...
    @overload
    def SetLabelTextProperty(
        self, p: vtkmodules.vtkRenderingCore.vtkTextProperty, type: int) -> None: ...
...
class vtkDynamic2DLabelMapper(vtkLabeledDataMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDynamic2DLabelMapper: ...
...
class vtkLabelRenderStrategy(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def RenderLabel(
        self, x: MutableSequence[int], tprop: vtkmodules.vtkRenderingCore.vtkTextProperty, label: str) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelRenderStrategy: ...

    def SetDefaultTextProperty(
...
class vtkFreeTypeLabelRenderStrategy(vtkLabelRenderStrategy):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFreeTypeLabelRenderStrategy: ...
...
class vtkLabelHierarchy(vtkmodules.vtkCommonDataModel.vtkPointSet):
    ...
    @overload
    def GetCell(self, __a: int,
                __b: vtkmodules.vtkCommonDataModel.vtkGenericCell) -> None: ...

    @overload
    def GetCell(self, i: int, j: int,
                k: int) -> vtkmodules.vtkCommonDataModel.vtkCell: ...
    def GetCellPoints(
        self, __a: int, __b: vtkmodules.vtkCommonCore.vtkIdList) -> None: ...

    def GetCellType(self, __a: int) -> int: ...
    def GetCenterPts(self) -> vtkmodules.vtkCommonCore.vtkPoints: ...

    def GetCoincidentPoints(
        self) -> vtkmodules.vtkFiltersGeneral.vtkCoincidentPoints: ...
    ...
    @staticmethod
    def GetPathForNodalCoordinates(
        path: MutableSequence[int], ijk: MutableSequence[int], level: int) -> bool: ...
    def GetPointCells(
        self, __a: int, __b: vtkmodules.vtkCommonCore.vtkIdList) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelHierarchy: ...

    def SetBoundedSizes(
        self, arr: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...

    def SetIconIndices(
        self, arr: vtkmodules.vtkCommonCore.vtkIntArray) -> None: ...
    def SetLabels(
...
class vtkLabelHierarchyAlgorithm(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelHierarchyAlgorithm: ...
...
class vtkLabelHierarchyIterator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetNodeGeometry(
        self, ctr: MutableSequence[float], size: float) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelHierarchyIterator: ...

    def SetAllBounds(self, _arg: int) -> None: ...
    def SetTraversedBounds(
        self, __a: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
...
class vtkLabelHierarchyCompositeIterator(vtkLabelHierarchyIterator):
    ...
    @overload
    def AddIterator(self, it: vtkLabelHierarchyIterator,
                    count: int) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelHierarchyCompositeIterator: ...
...
class vtkLabelPlacementMapper(vtkmodules.vtkRenderingCore.vtkMapper2D):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelPlacementMapper: ...
...
class vtkLabelPlacer(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelPlacer: ...
...
class vtkLabelSizeCalculator(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    def GetDPI(self) -> int: ...
    def GetFontProperty(
        self, type: int = 0) -> vtkmodules.vtkRenderingCore.vtkTextProperty: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabelSizeCalculator: ...

    def SetDPI(self, _arg: int) -> None: ...
    def SetFontProperty(
        self, fontProp: vtkmodules.vtkRenderingCore.vtkTextProperty, type: int = 0) -> None: ...
...
class vtkLabeledTreeMapDataMapper(vtkLabeledDataMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLabeledTreeMapDataMapper: ...
...
class vtkPointSetToLabelHierarchy(vtkLabelHierarchyAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPointSetToLabelHierarchy: ...
