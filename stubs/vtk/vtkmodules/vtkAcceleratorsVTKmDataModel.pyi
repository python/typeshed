from typing import Callable, MutableSequence, Sequence, Tuple, TypeAlias, TypeVar, Union, overload
...
class vtkmDataSet(vtkmodules.vtkCommonDataModel.vtkDataSet):
    ...
    def DeepCopy(
        self, src: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
    ...
    @overload
    def GetCell(self, cellId: int,
                cell: vtkmodules.vtkCommonDataModel.vtkGenericCell) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkmDataSet: ...
    def ShallowCopy(
        self, src: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
