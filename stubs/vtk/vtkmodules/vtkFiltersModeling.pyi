...
class vtkAdaptiveSubdivisionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAdaptiveSubdivisionFilter: ...
...
class vtkBandedPolyDataContourFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetContourEdgesOutput(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBandedPolyDataContourFilter: ...
...
class vtkButterflySubdivisionFilter(vtkmodules.vtkFiltersGeneral.vtkInterpolatingSubdivisionFilter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkButterflySubdivisionFilter: ...
...
class vtkCollisionDetectionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetContactCells(self, i: int) -> vtkmodules.vtkCommonCore.vtkIdTypeArray: ...
    def GetContactsOutput(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    def GetContactsOutputPort(self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    def GetGenerateScalars(self) -> int: ...
    def GetInputData(self, i: int) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    def GetMTime(self) -> int: ...
    def GetMatrix(self, i: int) -> vtkmodules.vtkCommonMath.vtkMatrix4x4: ...
    ...
    def GetTransform(self, i: int) -> vtkmodules.vtkCommonTransforms.vtkLinearTransform: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCollisionDetectionFilter: ...
    ...
    def SetInputData(self, i: int, model: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
    def SetMatrix(self, i: int, matrix: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    def SetNumberOfCellsPerNode(self, _arg: int) -> None: ...
    def SetOpacity(self, _arg: float) -> None: ...
    def SetTransform(self, i: int, transform: vtkmodules.vtkCommonTransforms.vtkLinearTransform) -> None: ...
...
class vtkContourLoopExtraction(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContourLoopExtraction: ...
...
class vtkCookieCutter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def CreateDefaultLocator(self) -> None: ...
    def GetLocator(self) -> vtkmodules.vtkCommonDataModel.vtkIncrementalPointLocator: ...
    def GetLoops(self) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    def GetLoopsConnection(self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCookieCutter: ...
    def SetLocator(self, locator: vtkmodules.vtkCommonDataModel.vtkIncrementalPointLocator) -> None: ...
    def SetLoopsConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetLoopsData(self, loops: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
...
class vtkGeodesicPath(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeodesicPath: ...
...
class vtkGraphGeodesicPath(vtkGeodesicPath):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGraphGeodesicPath: ...
...
class vtkDijkstraGraphGeodesicPath(vtkGraphGeodesicPath):
    def GetCumulativeWeights(self, weights: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...
    def GetIdList(self) -> vtkmodules.vtkCommonCore.vtkIdList: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetRepelPathFromVertices(self) -> int: ...
    def GetRepelVertices(self) -> vtkmodules.vtkCommonCore.vtkPoints: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDijkstraGraphGeodesicPath: ...
    def SetRepelPathFromVertices(self, _arg: int) -> None: ...
    def SetRepelVertices(self, __a: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
...
class vtkDijkstraImageGeodesicPath(vtkDijkstraGraphGeodesicPath):
    ...
    def GetInputAsImageData(self) -> vtkmodules.vtkCommonDataModel.vtkImageData: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def IsA(self, type: str) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDijkstraImageGeodesicPath: ...
...
class vtkFillHolesFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFillHolesFilter: ...
...
class vtkFitToHeightMapFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def GetHeightMap(self) -> vtkmodules.vtkCommonDataModel.vtkImageData: ...
    @overload
    def GetHeightMap(
        self, sourceInfo: vtkmodules.vtkCommonCore.vtkInformationVector
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkFitToHeightMapFilter: ...
    ...
    def SetHeightMapConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetHeightMapData(self, idata: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkHausdorffDistancePointSetFilter(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHausdorffDistancePointSetFilter: ...
...
class vtkHyperTreeGridOutlineFilter(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHyperTreeGridOutlineFilter: ...
...
class vtkImageDataOutlineFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageDataOutlineFilter: ...
    def SetGenerateFaces(self, _arg: int) -> None: ...
    def SetOutputPointsPrecision(self, _arg: int) -> None: ...
...
class vtkImprintFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetDebugOutput(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    def GetDebugOutputType(self) -> int: ...
    def GetDebugOutputTypeMaxValue(self) -> int: ...
    def GetDebugOutputTypeMinValue(self) -> int: ...
    def GetImprint(self) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    def GetImprintConnection(self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    ...
    def GetPointInterpolationMaxValue(self) -> int: ...
    def GetPointInterpolationMinValue(self) -> int: ...
    def GetTarget(self) -> vtkmodules.vtkCommonDataModel.vtkDataObject: ...
    def GetTargetConnection(self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    ...
    def PassPointDataOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImprintFilter: ...
    ...
    def SetImprintConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetImprintData(self, imprint: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
    ...
    def SetTargetConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetTargetData(self, target: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...
...
class vtkLinearCellExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLinearCellExtrusionFilter: ...
...
class vtkLinearExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLinearExtrusionFilter: ...
...
class vtkLinearSubdivisionFilter(vtkmodules.vtkFiltersGeneral.vtkInterpolatingSubdivisionFilter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLinearSubdivisionFilter: ...
...
class vtkLoopSubdivisionFilter(vtkmodules.vtkFiltersGeneral.vtkApproximatingSubdivisionFilter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLoopSubdivisionFilter: ...
...
class vtkOutlineFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOutlineFilter: ...
...
class vtkPolyDataPointSampler(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataPointSampler: ...
...
class vtkProjectedTexture(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkProjectedTexture: ...
    @overload
...
class vtkQuadRotationalExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkQuadRotationalExtrusionFilter: ...
...
class vtkRibbonFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRibbonFilter: ...
...
class vtkRotationalExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRotationalExtrusionFilter: ...
    def SetAngle(self, _arg: float) -> None: ...
    def SetCapping(self, _arg: int) -> None: ...
    def SetDeltaRadius(self, _arg: float) -> None: ...
    def SetResolution(self, _arg: int) -> None: ...
...
class vtkRuledSurfaceFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRuledSurfaceFilter: ...
...
class vtkSectorSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSectorSource: ...
...
class vtkSelectEnclosedPoints(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    @overload
    def GetSurface(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    @overload
    def GetSurface(
        self, sourceInfo: vtkmodules.vtkCommonCore.vtkInformationVector
    ...
    def GetToleranceMaxValue(self) -> float: ...
    def GetToleranceMinValue(self) -> float: ...
    def Initialize(self, surface: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
    ...
    def IsInsideSurface(
        ...
        surface: vtkmodules.vtkCommonDataModel.vtkPolyData,
        bds: MutableSequence[float],
        length: float,
        tol: float,
        ...
        counter: vtkmodules.vtkCommonDataModel.vtkIntersectionCounter,
        poole: vtkmodules.vtkCommonCore.vtkRandomPool = ...,
        seqIdx: int = 0,
    ) -> int: ...
    @staticmethod
    def IsSurfaceClosed(surface: vtkmodules.vtkCommonDataModel.vtkPolyData) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkSelectEnclosedPoints: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSelectEnclosedPoints: ...
    ...
    def SetSurfaceData(self, pd: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
    def SetTolerance(self, _arg: float) -> None: ...
...
class vtkSelectPolyData(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSelectionEdges(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    ...
    def GetUnselectedOutput(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    def GetUnselectedOutputPort(self) -> vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput: ...
    def InsideOutOff(self) -> None: ...
    def InsideOutOn(self) -> None: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSelectPolyData: ...
    @overload
...
class vtkSpherePuzzle(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def Reset(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSpherePuzzle: ...
...
class vtkSpherePuzzleArrows(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSpherePuzzleArrows: ...
    @overload
...
class vtkSubdivideTetra(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSubdivideTetra: ...
...
class vtkTrimmedExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    @overload
    def GetTrimSurface(self) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    @overload
    def GetTrimSurface(
        self, sourceInfo: vtkmodules.vtkCommonCore.vtkInformationVector
    ) -> vtkmodules.vtkCommonDataModel.vtkPolyData: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTrimmedExtrusionFilter: ...
    def SetCapping(self, _arg: int) -> None: ...
    ...
    def SetTrimSurfaceConnection(self, algOutput: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetTrimSurfaceData(self, pd: vtkmodules.vtkCommonDataModel.vtkPolyData) -> None: ...
...
class vtkVolumeOfRevolutionFilter(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeOfRevolutionFilter: ...
    @overload
