...
class vtkAbstractTransform(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAbstractTransform: ...
    ...
    def TransformPoints(self, inPts: vtkmodules.vtkCommonCore.vtkPoints, outPts: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
    @overload
...
class vtkWarpTransform(vtkAbstractTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkWarpTransform: ...
...
class vtkCylindricalTransform(vtkWarpTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCylindricalTransform: ...

class vtkGeneralTransform(vtkAbstractTransform):
    def CircuitCheck(self, transform: vtkAbstractTransform) -> int: ...
    @overload
    def Concatenate(self, matrix: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    @overload
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeneralTransform: ...
    @overload
...
class vtkHomogeneousTransform(vtkAbstractTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHomogeneousTransform: ...
    def TransformPoints(self, inPts: vtkmodules.vtkCommonCore.vtkPoints, outPts: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
...
class vtkLinearTransform(vtkHomogeneousTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLinearTransform: ...
    @overload
...
class vtkIdentityTransform(vtkLinearTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkIdentityTransform: ...
    def TransformNormals(
        self, inNms: vtkmodules.vtkCommonCore.vtkDataArray, outNms: vtkmodules.vtkCommonCore.vtkDataArray
    ) -> None: ...
    def TransformPoints(self, inPts: vtkmodules.vtkCommonCore.vtkPoints, outPts: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
...
class vtkLandmarkTransform(vtkLinearTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLandmarkTransform: ...
    ...
    def SetSourceLandmarks(self, source: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
    def SetTargetLandmarks(self, target: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
...
class vtkMatrixToHomogeneousTransform(vtkHomogeneousTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMatrixToHomogeneousTransform: ...
...
class vtkMatrixToLinearTransform(vtkLinearTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMatrixToLinearTransform: ...
    def SetInput(self, __a: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
...
class vtkPerspectiveTransform(vtkHomogeneousTransform):
    ...
    def RotateZ(self, angle: float) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPerspectiveTransform: ...
    @overload
    def Scale(self, x: float, y: float, z: float) -> None: ...
    @overload
    def Scale(self, s: Sequence[float]) -> None: ...
...
class vtkSphericalTransform(vtkWarpTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSphericalTransform: ...
...
class vtkThinPlateSplineTransform(vtkWarpTransform):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkThinPlateSplineTransform: ...
...
class vtkTransform(vtkLinearTransform):
    ...
    @overload
    def GetInverse(self, inverse: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    @overload
    def GetInverse(self) -> vtkAbstractTransform: ...
    def GetInverseFlag(self) -> int: ...
    def GetMTime(self) -> int: ...
    ...
    def GetTranspose(self, transpose: vtkmodules.vtkCommonMath.vtkMatrix4x4) -> None: ...
    def Identity(self) -> None: ...
    def Inverse(self) -> None: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    ...
    def RotateZ(self, angle: float) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTransform: ...
    @overload
    def Scale(self, x: float, y: float, z: float) -> None: ...
    @overload
    def Scale(self, s: Sequence[float]) -> None: ...
...
class vtkTransform2D(vtkmodules.vtkCommonCore.vtkObject):
    def GetInverse(self, inverse: vtkmodules.vtkCommonMath.vtkMatrix3x3) -> None: ...
    def GetMTime(self) -> int: ...
    @overload
    def GetMatrix(self) -> vtkmodules.vtkCommonMath.vtkMatrix3x3: ...
    @overload
    def GetMatrix(self, matrix: vtkmodules.vtkCommonMath.vtkMatrix3x3) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type: str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetPosition(self, pos: MutableSequence[float]) -> None: ...
    def GetScale(self, scale: MutableSequence[float]) -> None: ...
    def GetTranspose(self, transpose: vtkmodules.vtkCommonMath.vtkMatrix3x3) -> None: ...
    def Identity(self) -> None: ...
    def Inverse(self) -> None: ...
    @overload
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTransform2D: ...
    @overload
    def Scale(self, x: float, y: float) -> None: ...
    @overload
    def Scale(self, s: Sequence[float]) -> None: ...
    @overload
    def SetMatrix(self, matrix: vtkmodules.vtkCommonMath.vtkMatrix3x3) -> None: ...
    @overload
    def SetMatrix(self, elements: Sequence[float]) -> None: ...
    @overload
...
class vtkTransformCollection(vtkmodules.vtkCommonCore.vtkCollection):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTransformCollection: ...
