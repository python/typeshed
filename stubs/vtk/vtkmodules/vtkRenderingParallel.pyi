...
class vtkClientServerCompositePass(vtkmodules.vtkRenderingCore.vtkRenderPass):
    ...
    def GetPostProcessingRenderPass(
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkClientServerCompositePass: ...
    ...
    def SetPostProcessingRenderPass(
...
class vtkSynchronizedRenderers(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def CollectiveExpandForVisiblePropBounds(
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSynchronizedRenderers: ...
...
class vtkClientServerSynchronizedRenderers(vtkSynchronizedRenderers):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkClientServerSynchronizedRenderers: ...
...
class vtkCompositeRGBAPass(vtkmodules.vtkRenderingCore.vtkRenderPass):
    ...
    def IsA(self, type: str) -> int: ...
    def IsSupported(
        self, context: vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderWindow) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeRGBAPass: ...

    def SetController(
        self, controller: vtkmodules.vtkParallelCore.vtkMultiProcessController) -> None: ...
    def SetKdtree(
        self, kdtree: vtkmodules.vtkFiltersParallel.vtkPKdTree) -> None: ...
...
class vtkParallelRenderManager(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ComputeVisiblePropBounds(
        self, ren: vtkmodules.vtkRenderingCore.vtkRenderer, bounds: MutableSequence[float]) -> None: ...
    ...
    @overload
    def GetPixelData(
        self, data: vtkmodules.vtkCommonCore.vtkUnsignedCharArray) -> None: ...

    @overload
    def GetPixelData(self, x1: int, y1: int, x2: int, y2: int,
                     data: vtkmodules.vtkCommonCore.vtkUnsignedCharArray) -> None: ...
    ...
    def ResetCameraClippingRange(
        self, ren: vtkmodules.vtkRenderingCore.vtkRenderer) -> None: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkParallelRenderManager: ...
    ...
    def SetImageReductionFactorForUpdateRate(
        self, DesiredUpdateRate: float) -> None: ...
...
class vtkCompositeRenderManager(vtkParallelRenderManager):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeRenderManager: ...
...
class vtkCompositeZPass(vtkmodules.vtkRenderingCore.vtkRenderPass):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositeZPass: ...
    def SetController(
        self, controller: vtkmodules.vtkParallelCore.vtkMultiProcessController) -> None: ...
...
class vtkCompositedSynchronizedRenderers(vtkSynchronizedRenderers):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositedSynchronizedRenderers: ...
...
class vtkCompositer(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def ResizeFloatArray(fa: vtkmodules.vtkCommonCore.vtkFloatArray,
                         numComp: int, size: int) -> None: ...

    @staticmethod
    def ResizeUnsignedCharArray(
        uca: vtkmodules.vtkCommonCore.vtkUnsignedCharArray, numComp: int, size: int) -> None: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompositer: ...
    def SetController(
        self, __a: vtkmodules.vtkParallelCore.vtkMultiProcessController) -> None: ...
...
class vtkCompressCompositer(vtkCompositer):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompressCompositer: ...
...
class vtkImageRenderManager(vtkParallelRenderManager):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageRenderManager: ...
...
class vtkPHardwareSelector(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLHardwareSelector):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPHardwareSelector: ...
...
class vtkSynchronizedRenderWindows(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSynchronizedRenderWindows: ...
...
class vtkTreeCompositer(vtkCompositer):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTreeCompositer: ...
