...
class vtkDatabaseToTableReader(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDatabaseToTableReader: ...
...
class vtkRowQuery(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def NextRow(self, rowArray: vtkmodules.vtkCommonCore.vtkVariantArray) -> bool: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRowQuery: ...
...
class vtkRowQueryToTable(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRowQueryToTable: ...
...
class vtkSQLDatabase(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetRecord(self, table: str) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLDatabase: ...
    @staticmethod
...
class vtkSQLDatabaseSchema(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Reset(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLDatabaseSchema: ...
...
class vtkSQLDatabaseTableSource(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLDatabaseTableSource: ...
...
class vtkSQLQuery(vtkRowQuery):
    ...
    @overload
    def BindParameter(self, index: int, var: vtkmodules.vtkCommonCore.vtkVariant) -> bool: ...
    @overload
    def BindParameter(self, index: int, data: _Pointer, length: int) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLQuery: ...
...
class vtkSQLiteDatabase(vtkSQLDatabase):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLiteDatabase: ...
...
class vtkSQLiteQuery(vtkSQLQuery):
    ...
    def BindParameter(self, index: int, string: str) -> bool: ...
    @overload
    def BindParameter(self, index: int, value: vtkmodules.vtkCommonCore.vtkVariant) -> bool: ...
    @overload
    def BindParameter(self, index: int, data: _Pointer, length: int) -> bool: ...
    def ClearParameterBindings(self) -> bool: ...
    def CommitTransaction(self) -> bool: ...
    ...
    def RollbackTransaction(self) -> bool: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLiteQuery: ...
    def SetQuery(self, query: str) -> bool: ...
...
class vtkSQLiteToTableReader(vtkDatabaseToTableReader):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLiteToTableReader: ...
...
class vtkTableToDatabaseWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTableToDatabaseWriter: ...
    def SetDatabase(self, db: vtkSQLDatabase) -> bool: ...
    def SetTableName(self, name: str) -> bool: ...
...
class vtkTableToSQLiteWriter(vtkTableToDatabaseWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTableToSQLiteWriter: ...
