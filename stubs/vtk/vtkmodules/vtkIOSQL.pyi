...
class vtkDatabaseToTableReader(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDatabaseToTableReader: ...
...
class vtkRowQuery(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DataValue(self, c: int) -> vtkmodules.vtkCommonCore.vtkVariant: ...
    ...
    @overload
    def NextRow(
        self, rowArray: vtkmodules.vtkCommonCore.vtkVariantArray) -> bool: ...

    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRowQuery: ...
...
class vtkRowQueryToTable(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkRowQueryToTable: ...
...
class vtkSQLDatabase(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def DATABASE() -> vtkmodules.vtkCommonCore.vtkInformationObjectBaseKey: ...

    def EffectSchema(self, __a: vtkSQLDatabaseSchema,
                     dropIfExists: bool = False) -> bool: ...
    def GetColumnSpecification(
        self, schema: vtkSQLDatabaseSchema, tblHandle: int, colHandle: int) -> str: ...

    def GetDatabaseType(self) -> str: ...
    def GetIndexSpecification(self, schema: vtkSQLDatabaseSchema,
    ...
    def GetRecord(
        self, table: str) -> vtkmodules.vtkCommonCore.vtkStringArray: ...

    def GetTablePreamble(self, __a: bool) -> str: ...
    def GetTables(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetTriggerSpecification(
        self, schema: vtkSQLDatabaseSchema, tblHandle: int, trgHandle: int) -> str: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLDatabase: ...
...
class vtkSQLDatabaseSchema(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def AddColumnToIndex(self, tblHandle: int,
                         idxHandle: int, colHandle: int) -> int: ...

    @overload
    def AddColumnToIndex(self, tblName: str, idxName: str,
                         colName: str) -> int: ...

    @overload
    def AddColumnToTable(self, tblHandle: int, colType: int,
                         colName: str, colSize: int, colOpts: str) -> int: ...

    @overload
    def AddColumnToTable(self, tblName: str, colType: int,
                         colName: str, colSize: int, colAttribs: str) -> int: ...

    @overload
    def AddIndexToTable(self, tblHandle: int, idxType: int,
                        idxName: str) -> int: ...

    @overload
    def AddIndexToTable(self, tblName: str, idxType: int,
                        idxName: str) -> int: ...

    @overload
    def AddOptionToTable(self, tblHandle: int, optText: str,
                         optBackend: str = ...) -> int: ...

    @overload
    def AddOptionToTable(self, tblName: str, optStr: str,
                         optBackend: str = ...) -> int: ...
    def AddPreamble(self, preName: str, preAction: str,
                    preBackend: str = ...) -> int: ...
    ...
    @overload
    def AddTriggerToTable(self, tblHandle: int, trgType: int,
                          trgName: str, trgAction: str, trgBackend: str = ...) -> int: ...

    @overload
    def AddTriggerToTable(self, tblName: str, trgType: int, trgName: str,
                          trgAction: str, trgBackend: str = ...) -> int: ...
    def GetColumnAttributesFromHandle(
        self, tblHandle: int, colHandle: int) -> str: ...

    def GetColumnHandleFromName(self, tblName: str, colName: str) -> int: ...

    def GetColumnNameFromHandle(
        self, tblHandle: int, colHandle: int) -> str: ...

    def GetColumnSizeFromHandle(
        self, tblHandle: int, colHandle: int) -> int: ...

    def GetColumnTypeFromHandle(
        self, tblHandle: int, colHandle: int) -> int: ...
    def GetIndexColumnNameFromHandle(
        self, tblHandle: int, idxHandle: int, cnmHandle: int) -> str: ...

    def GetIndexHandleFromName(self, tblName: str, idxName: str) -> int: ...

    def GetIndexNameFromHandle(
        self, tblHandle: int, idxHandle: int) -> str: ...
    def GetIndexTypeFromHandle(
        self, tblHandle: int, idxHandle: int) -> int: ...

    def GetName(self) -> str: ...
    def GetNumberOfColumnNamesInIndex(
        self, tblHandle: int, idxHandle: int) -> int: ...
    ...
    def GetOptionBackendFromHandle(
        self, tblHandle: int, optHandle: int) -> str: ...
    def GetOptionTextFromHandle(
        self, tblHandle: int, optHandle: int) -> str: ...
    ...
    def GetTriggerActionFromHandle(
        self, tblHandle: int, trgHandle: int) -> str: ...
    def GetTriggerBackendFromHandle(
        self, tblHandle: int, trgHandle: int) -> str: ...

    def GetTriggerHandleFromName(self, tblName: str, trgName: str) -> int: ...

    def GetTriggerNameFromHandle(
        self, tblHandle: int, trgHandle: int) -> str: ...
    def GetTriggerTypeFromHandle(
        self, tblHandle: int, trgHandle: int) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLDatabaseSchema: ...
...
class vtkSQLDatabaseTableSource(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLDatabaseTableSource: ...
...
class vtkSQLQuery(vtkRowQuery):
    ...
    @overload
    def BindParameter(self, index: int, stringValue: str,
                      length: int) -> bool: ...
    ...
    @overload
    def BindParameter(self, index: int,
                      var: vtkmodules.vtkCommonCore.vtkVariant) -> bool: ...

    @overload
    def BindParameter(self, index: int, data: Pointer,
                      length: int) -> bool: ...

    def ClearParameterBindings(self) -> bool: ...
    def CommitTransaction(self) -> bool: ...
    def EscapeString(
        self, s: str, addSurroundingQuotes: bool = True) -> str: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLQuery: ...
...
class vtkSQLiteDatabase(vtkSQLDatabase):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLiteDatabase: ...
...
class vtkSQLiteQuery(vtkSQLQuery):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLiteQuery: ...
...
class vtkSQLiteToTableReader(vtkDatabaseToTableReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSQLiteToTableReader: ...
...
class vtkTableToDatabaseWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTableToDatabaseWriter: ...
...
class vtkTableToSQLiteWriter(vtkTableToDatabaseWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkTableToSQLiteWriter: ...
