...
class vtkImageConnectivityFilter(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetExtractedRegionExtents(
        self) -> vtkmodules.vtkCommonCore.vtkIntArray: ...

    def GetExtractedRegionLabels(
        self) -> vtkmodules.vtkCommonCore.vtkIdTypeArray: ...

    def GetExtractedRegionSeedIds(
        self) -> vtkmodules.vtkCommonCore.vtkIdTypeArray: ...
    def GetExtractedRegionSizes(
        self) -> vtkmodules.vtkCommonCore.vtkIdTypeArray: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageConnectivityFilter: ...
    ...
    def SetStencilConnection(
        self, port: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetStencilData(
        self, data: vtkmodules.vtkImagingCore.vtkImageStencilData) -> None: ...
...
class vtkImageConnector(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageConnector: ...
...
class vtkImageContinuousDilate3D(vtkmodules.vtkImagingGeneral.vtkImageSpatialAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageContinuousDilate3D: ...
...
class vtkImageContinuousErode3D(vtkmodules.vtkImagingGeneral.vtkImageSpatialAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageContinuousErode3D: ...
...
class vtkImageDilateErode3D(vtkmodules.vtkImagingGeneral.vtkImageSpatialAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageDilateErode3D: ...
...
class vtkImageIslandRemoval2D(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageIslandRemoval2D: ...
...
class vtkImageNonMaximumSuppression(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageNonMaximumSuppression: ...

    def SetDimensionality(self, _arg: int) -> None: ...
    def SetHandleBoundaries(self, _arg: int) -> None: ...

    def SetMagnitudeInputData(
...
class vtkImageOpenClose3D(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageOpenClose3D: ...
...
class vtkImageSeedConnectivity(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageSeedConnectivity: ...
...
class vtkImageSkeleton2D(vtkmodules.vtkImagingCore.vtkImageIterateFilter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageSkeleton2D: ...
...
class vtkImageThresholdConnectivity(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageThresholdConnectivity: ...
