...
class vtkCompassRepresentation(vtkmodules.vtkInteractionWidgets.vtkContinuousValueWidgetRepresentation):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompassRepresentation: ...
...
class vtkCompassWidget(vtkmodules.vtkInteractionWidgets.vtkAbstractWidget):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCompassWidget: ...
...
class vtkGeoProjection(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeoProjection: ...
...
class vtkGeoTransform(vtkmodules.vtkCommonTransforms.vtkAbstractTransform):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGeoTransform: ...

    def SetDestinationProjection(self, dest: vtkGeoProjection) -> None: ...
    def SetSourceProjection(self, source: vtkGeoProjection) -> None: ...

    def TransformPoints(self, src: vtkmodules.vtkCommonCore.vtkPoints,
                        dst: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
