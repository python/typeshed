...
class vtkMultiBlockUnstructuredGridVolumeMapper(vtkmodules.vtkRenderingVolume.vtkUnstructuredGridVolumeMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMultiBlockUnstructuredGridVolumeMapper: ...
...
class vtkMultiBlockVolumeMapper(vtkmodules.vtkRenderingVolume.vtkVolumeMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMultiBlockVolumeMapper: ...
    ...
    @overload
    def SetCroppingRegionPlanes(self, arg1: float, arg2: float,
                                arg3: float, arg4: float, arg5: float, arg6: float) -> None: ...
...
class vtkOpenGLGPUVolumeRayCastMapper(vtkmodules.vtkRenderingVolume.vtkGPUVolumeRayCastMapper):
    ...
    def GetColorImage(
        self, im: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
    def GetColorTexture(
        self) -> vtkmodules.vtkRenderingOpenGL2.vtkTextureObject: ...
    ...
    def PreLoadData(self, ren: vtkmodules.vtkRenderingCore.vtkRenderer,
                    vol: vtkmodules.vtkRenderingCore.vtkVolume) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLGPUVolumeRayCastMapper: ...

    def SetPartitions(self, x: int, y: int, z: int) -> None: ...
    def SetSharedDepthTexture(
        self, nt: vtkmodules.vtkRenderingOpenGL2.vtkTextureObject) -> None: ...
...
class vtkOpenGLProjectedTetrahedraMapper(vtkmodules.vtkRenderingVolume.vtkProjectedTetrahedraMapper):
    ...
    def IsA(self, type: str) -> int: ...
    def IsSupported(
        self, context: vtkmodules.vtkRenderingCore.vtkRenderWindow) -> bool: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLProjectedTetrahedraMapper: ...
...
class vtkOpenGLRayCastImageDisplayHelper(vtkmodules.vtkRenderingVolume.vtkRayCastImageDisplayHelper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOpenGLRayCastImageDisplayHelper: ...
...
class vtkSmartVolumeMapper(vtkmodules.vtkRenderingVolume.vtkVolumeMapper):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkSmartVolumeMapper: ...
...
class vtkVolumeTexture(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def GetScaleAndBias(
        scalarType: int, scalarRange: MutableSequence[float], scale: float, bias: float) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVolumeTexture: ...
