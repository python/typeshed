...
class vtkImageStencil(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageStencil: ...
    ...
    def SetStencilConnection(
        self, outputPort: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetStencilData(
...
class vtkImageStencilToImage(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageStencilToImage: ...
...
class vtkImageToImageStencil(vtkmodules.vtkImagingCore.vtkImageStencilAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImageToImageStencil: ...
    def SetInputData(
        self, input: vtkmodules.vtkCommonDataModel.vtkImageData) -> None: ...
...
class vtkImplicitFunctionToImageStencil(vtkmodules.vtkImagingCore.vtkImageStencilSource):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImplicitFunctionToImageStencil: ...
    def SetInput(
...
class vtkLassoStencilSource(vtkmodules.vtkImagingCore.vtkImageStencilSource):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLassoStencilSource: ...
    def SetPoints(
    ...
    def SetSlicePoints(
        self, i: int, points: vtkmodules.vtkCommonCore.vtkPoints) -> None: ...
...
class vtkPolyDataToImageStencil(vtkmodules.vtkImagingCore.vtkImageStencilSource):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPolyDataToImageStencil: ...
    def SetInputData(
...
class vtkROIStencilSource(vtkmodules.vtkImagingCore.vtkImageStencilSource):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkROIStencilSource: ...
