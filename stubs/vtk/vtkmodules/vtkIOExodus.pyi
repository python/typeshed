...
class vtkCPExodusIIElementBlock(vtkmodules.vtkCommonDataModel.vtkUnstructuredGridBase):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCPExodusIIElementBlock: ...
...
class vtkCPExodusIIElementBlockImpl(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCPExodusIIElementBlockImpl: ...
    def SetExodusConnectivityArray(
        self, elements: MutableSequence[int], type: str, numElements: int, nodesPerElement: int
    ) -> bool: ...
...
class vtkCPExodusIIInSituReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCPExodusIIInSituReader: ...
...
class vtkExodusIICache(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Insert(self, key: vtkExodusIICacheKey, value: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...
    @overload
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIICache: ...
...
class vtkExodusIICacheEntry:
    ...
    @overload
    def __init__(self, arr: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...
    @overload
    def __init__(self, other: vtkExodusIICacheEntry) -> None: ...
    def GetValue(self) -> vtkmodules.vtkCommonCore.vtkDataArray: ...
...
class vtkExodusIIReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    def Dump(self) -> None: ...
    @staticmethod
    def GLOBAL_TEMPORAL_VARIABLE() -> vtkmodules.vtkCommonCore.vtkInformationIntegerKey: ...
    @staticmethod
    def GLOBAL_VARIABLE() -> vtkmodules.vtkCommonCore.vtkInformationIntegerKey: ...
    ...
    @overload
    @staticmethod
    def GetGlobalEdgeID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int) -> int: ...
    @overload
    @staticmethod
    def GetGlobalEdgeID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int, searchType: int) -> int: ...
    @staticmethod
    def GetGlobalEdgeIdArrayName() -> str: ...
    @overload
    @staticmethod
    def GetGlobalElementID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int) -> int: ...
    @overload
    @staticmethod
    def GetGlobalElementID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int, searchType: int) -> int: ...
    @staticmethod
    def GetGlobalElementIdArrayName() -> str: ...
    @overload
    @staticmethod
    def GetGlobalFaceID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int) -> int: ...
    @overload
    @staticmethod
    def GetGlobalFaceID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int, searchType: int) -> int: ...
    @staticmethod
    def GetGlobalFaceIdArrayName() -> str: ...
    @overload
    @staticmethod
    def GetGlobalNodeID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int) -> int: ...
    @overload
    @staticmethod
    def GetGlobalNodeID(data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int, searchType: int) -> int: ...
    @staticmethod
    ...
    def GetTimeSeriesData(self, ID: int, vName: str, vType: str, result: vtkmodules.vtkCommonCore.vtkFloatArray) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIIReader: ...
...
class vtkExodusIIReaderParser(vtkmodules.vtkIOXMLParser.vtkXMLParser):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIIReaderParser: ...
...
class vtkExodusIIWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIIWriter: ...
...
class vtkModelMetadata(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetBlockAttributes(self) -> _Pointer: ...
    def GetBlockAttributesIndex(self) -> _Pointer: ...
    def GetBlockElementIdList(self) -> _Pointer: ...
    def GetBlockElementIdListIndex(self) -> _Pointer: ...
    def GetBlockIds(self) -> _Pointer: ...
    def GetBlockNodesPerElement(self) -> _Pointer: ...
    def GetBlockNumberOfAttributesPerElement(self) -> _Pointer: ...
    def GetBlockNumberOfElements(self) -> _Pointer: ...
    def GetBlockPropertyValue(self) -> _Pointer: ...
    def GetDimension(self) -> int: ...
    def GetElementVariableNumberOfComponents(self) -> _Pointer: ...
    def GetElementVariableTruthTable(self) -> _Pointer: ...
    def GetGlobalVariableValue(self) -> _Pointer: ...
    def GetMapToOriginalElementVariableNames(self) -> _Pointer: ...
    def GetMapToOriginalNodeVariableNames(self) -> _Pointer: ...
    def GetNodeSetDistributionFactorIndex(self) -> _Pointer: ...
    def GetNodeSetDistributionFactors(self) -> _Pointer: ...
    def GetNodeSetIds(self) -> _Pointer: ...
    def GetNodeSetNames(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetNodeSetNodeIdList(self) -> _Pointer: ...
    def GetNodeSetNodeIdListIndex(self) -> _Pointer: ...
    def GetNodeSetNumberOfDistributionFactors(self) -> _Pointer: ...
    def GetNodeSetPropertyValue(self) -> _Pointer: ...
    def GetNodeSetSize(self) -> _Pointer: ...
    def GetNodeVariableNumberOfComponents(self) -> _Pointer: ...
    ...
    def GetSideSetDistributionFactorIndex(self) -> _Pointer: ...
    def GetSideSetDistributionFactors(self) -> _Pointer: ...
    def GetSideSetElementList(self) -> _Pointer: ...
    def GetSideSetIds(self) -> _Pointer: ...
    def GetSideSetListIndex(self) -> _Pointer: ...
    def GetSideSetNames(self) -> vtkmodules.vtkCommonCore.vtkStringArray: ...
    def GetSideSetNumDFPerSide(self) -> _Pointer: ...
    def GetSideSetNumberOfDistributionFactors(self) -> _Pointer: ...
    def GetSideSetPropertyValue(self) -> _Pointer: ...
    def GetSideSetSideList(self) -> _Pointer: ...
    def GetSideSetSize(self) -> _Pointer: ...
    ...
    def GetTimeStepValues(self) -> _Pointer: ...
    def GetTitle(self) -> str: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    ...
    def Reset(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkModelMetadata: ...
    ...
    def SetNodeSetNames(self, names: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
    ...
    def SetSideSetNames(self, names: vtkmodules.vtkCommonCore.vtkStringArray) -> None: ...
