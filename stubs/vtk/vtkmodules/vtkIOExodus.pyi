...
from typing import overload, Callable, TypeVar, Union
...
class vtkCPExodusIIElementBlock(vtkmodules.vtkCommonDataModel.vtkUnstructuredGridBase):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCPExodusIIElementBlock: ...
...
class vtkCPExodusIIElementBlockImpl(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCPExodusIIElementBlockImpl: ...
...
class vtkCPExodusIIInSituReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCPExodusIIInSituReader: ...
...
class vtkExodusIICache(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Insert(self, key: vtkExodusIICacheKey,
               value: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...

    @overload
    def Invalidate(self, key: vtkExodusIICacheKey) -> int: ...

    @overload
    def Invalidate(self, key: vtkExodusIICacheKey,
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIICache: ...
...
class vtkExodusIICacheKey:
    ...
    @overload
    def __init__(self, time: int, objType: int,
                 objId: int, arrId: int) -> None: ...

    @overload
    def __init__(self, src: vtkExodusIICacheKey) -> None: ...
    def match(self, other: vtkExodusIICacheKey,
...
class vtkExodusIIReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def GetGlobalEdgeID(
        data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int) -> int: ...

    @overload
    @staticmethod
    def GetGlobalEdgeID(data: vtkmodules.vtkCommonDataModel.vtkDataSet,
                        localID: int, searchType: int) -> int: ...
    ...
    @overload
    @staticmethod
    def GetGlobalElementID(
        data: vtkmodules.vtkCommonDataModel.vtkDataSet, localID: int) -> int: ...

    @overload
    @staticmethod
    def GetGlobalElementID(data: vtkmodules.vtkCommonDataModel.vtkDataSet,
                           localID: int, searchType: int) -> int: ...
    ...
    @overload
    @staticmethod
    def GetGlobalFaceID(data: vtkmodules.vtkCommonDataModel.vtkDataSet,
                        localID: int, searchType: int) -> int: ...
    ...
    @overload
    @staticmethod
    def GetGlobalNodeID(data: vtkmodules.vtkCommonDataModel.vtkDataSet,
                        localID: int, searchType: int) -> int: ...
    ...
    def GetNumberOfEntriesInObject(
        self, objectType: int, objectIndex: int) -> int: ...
    ...
    def GetNumberOfObjectArrayComponents(
        self, objectType: int, arrayIndex: int) -> int: ...

    def GetNumberOfObjectArrays(self, objectType: int) -> int: ...
    def GetNumberOfObjectAttributes(
        self, objectType: int, objectIndex: int) -> int: ...
    ...
    @overload
    def GetObjectArrayStatus(self, objectType: int,
                             arrayIndex: int) -> int: ...

    @overload
    def GetObjectArrayStatus(self, objectType: int, arrayName: str) -> int: ...

    def GetObjectAttributeIndex(
        self, objectType: int, objectIndex: int, attribName: str) -> int: ...

    def GetObjectAttributeName(
        self, objectType: int, objectIndex: int, attribIndex: int) -> str: ...

    @overload
    def GetObjectAttributeStatus(
        self, objectType: int, objectIndex: int, attribIndex: int) -> int: ...
    ...
    def GetTimeSeriesData(self, ID: int, vName: str, vType: str,
                          result: vtkmodules.vtkCommonCore.vtkFloatArray) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIIReader: ...
    ...
    @overload
    def SetObjectArrayStatus(self, objectType: int,
                             arrayIndex: int, status: int) -> None: ...

    @overload
    def SetObjectArrayStatus(self, objectType: int,
                             arrayName: str, status: int) -> None: ...

    @overload
    def SetObjectAttributeStatus(
        self, objectType: int, objectIndex: int, attribIndex: int, status: int) -> None: ...

    @overload
    def SetObjectAttributeStatus(
        self, objectType: int, objectIndex: int, attribName: str, status: int) -> None: ...

    @overload
    def SetObjectStatus(self, objectType: int,
                        objectIndex: int, status: int) -> None: ...

    @overload
    def SetObjectStatus(self, objectType: int,
                        objectName: str, status: int) -> None: ...
...
class vtkExodusIIReaderParser(vtkmodules.vtkIOXMLParser.vtkXMLParser):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIIReaderParser: ...
...
class vtkExodusIIWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExodusIIWriter: ...
...
class vtkModelMetadata(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkModelMetadata: ...
    ...
    def SetBlockNumberOfAttributesPerElement(
        self, natts: MutableSequence[int]) -> int: ...
    ...
    def SetSideSetDistributionFactors(
        self, __a: MutableSequence[float]) -> None: ...
    ...
    def SetSideSetNumDFPerSide(
        self, numNodes: MutableSequence[int]) -> None: ...
    def SetSideSetNumberOfDistributionFactors(
        self, df: MutableSequence[int]) -> int: ...
    ...
    def SetTimeSteps(self, numberOfTimeSteps: int,
                     timeStepValues: MutableSequence[float]) -> None: ...
