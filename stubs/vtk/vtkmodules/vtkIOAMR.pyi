...
class vtkAMRBaseParticlesReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    def GetParticleDataArraySelection(
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRBaseParticlesReader: ...
    def SetController(
    ...
    def SetMaxLocation(self, maxx: float, maxy: float,
                       maxz: float) -> None: ...
    def SetMinLocation(self, minx: float, miny: float,
                       minz: float) -> None: ...
...
class vtkAMRBaseReader(vtkmodules.vtkCommonExecutionModel.vtkOverlappingAMRAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRBaseReader: ...
...
class vtkAMRDataSetCache(vtkmodules.vtkCommonCore.vtkObject):
    def GetAMRBlock(
        self, compositeIdx: int) -> vtkmodules.vtkCommonDataModel.vtkUniformGrid: ...

    def GetAMRBlockCellData(
        self, compositeIdx: int, dataName: str) -> vtkmodules.vtkCommonCore.vtkDataArray: ...
    def GetAMRBlockPointData(
        self, compositeIdx: int, dataName: str) -> vtkmodules.vtkCommonCore.vtkDataArray: ...
    ...
    def InsertAMRBlock(self, compositeIdx: int,
                       amrGrid: vtkmodules.vtkCommonDataModel.vtkUniformGrid) -> None: ...

    def InsertAMRBlockCellData(
        self, compositeIdx: int, dataArray: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...
    def InsertAMRBlockPointData(
        self, compositeIdx: int, dataArray: vtkmodules.vtkCommonCore.vtkDataArray) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRDataSetCache: ...
...
class vtkAMREnzoParticlesReader(vtkAMRBaseParticlesReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMREnzoParticlesReader: ...
...
class vtkAMREnzoReader(vtkAMRBaseReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMREnzoReader: ...
...
class vtkAMRFlashParticlesReader(vtkAMRBaseParticlesReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRFlashParticlesReader: ...
...
class vtkAMRFlashReader(vtkAMRBaseReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRFlashReader: ...
...
class vtkAMRVelodyneReader(vtkAMRBaseReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMRVelodyneReader: ...
...
class vtkAMReXGridReader(vtkAMRBaseReader):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMReXGridReader: ...
...
class vtkAMReXParticlesReader(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAMReXParticlesReader: ...
    def SetController(
