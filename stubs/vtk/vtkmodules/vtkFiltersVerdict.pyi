...
class vtkCellQuality(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    def PixelArea(
        self, __a: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCellQuality: ...
...
class vtkCellSizeFilter(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCellSizeFilter: ...
...
class vtkMatrixMathFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMatrixMathFilter: ...
...
class vtkMeshQuality(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def HexDistortion(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def HexEdgeRatio(cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def HexEquiangleSkew(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def HexMedAspectFrobenius(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def HexNodalJacobianRatio(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def HexRelativeSizeSquared(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def HexScaledJacobian(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def QuadMaxAspectFrobenius(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def QuadMaxEdgeRatio(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def QuadMedAspectFrobenius(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def QuadRelativeSizeSquared(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def QuadScaledJacobian(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMeshQuality: ...
    ...
    @staticmethod
    def TetEquiangleSkew(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TetEquivolumeSkew(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def TetRelativeSizeSquared(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TetScaledJacobian(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def TriangleAspectFrobenius(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleAspectRatio(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleCondition(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleDistortion(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleEdgeRatio(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleEquiangleSkew(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleMaxAngle(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleMinAngle(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleNormalizedInradius(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleRadiusRatio(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleRelativeSizeSquared(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def TriangleScaledJacobian(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
    ...
    @staticmethod
    def WedgeMeanAspectFrobenius(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...

    @staticmethod
    def WedgeScaledJacobian(
        cell: vtkmodules.vtkCommonDataModel.vtkCell) -> float: ...
