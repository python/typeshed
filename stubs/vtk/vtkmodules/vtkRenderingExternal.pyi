...
class ExternalVTKWidget(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> ExternalVTKWidget: ...
    def SetRenderWindow(
        self, renWin: vtkExternalOpenGLRenderWindow) -> None: ...
...
class vtkExternalLight(vtkmodules.vtkRenderingCore.vtkLight):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExternalLight: ...
...
class vtkExternalOpenGLCamera(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLCamera):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExternalOpenGLCamera: ...
    def SetProjectionTransformMatrix(
        self, elements: Sequence[float]) -> None: ...
...
class vtkExternalOpenGLRenderWindow(vtkmodules.vtkRenderingOpenGL2.vtkGenericOpenGLRenderWindow):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExternalOpenGLRenderWindow: ...
...
class vtkExternalOpenGLRenderer(vtkmodules.vtkRenderingOpenGL2.vtkOpenGLRenderer):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExternalOpenGLRenderer: ...
