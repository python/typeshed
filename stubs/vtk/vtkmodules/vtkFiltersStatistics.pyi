...
class vtkStatisticsAlgorithm(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStatisticsAlgorithm: ...
    def SetAssessNames(
    ...
    def SetInputModelConnection(
        self, model: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...

    def SetLearnOption(self, _arg: bool) -> None: ...

    def SetLearnOptionParameterConnection(
        self, params: vtkmodules.vtkCommonExecutionModel.vtkAlgorithmOutput) -> None: ...
    def SetLearnOptionParameters(
        self, params: vtkmodules.vtkCommonDataModel.vtkDataObject) -> None: ...

    def SetNumberOfPrimaryTables(self, _arg: int) -> None: ...
    def SetParameter(self, parameter: str, index: int,
                     value: vtkmodules.vtkCommonCore.vtkVariant) -> bool: ...
...
class vtkAutoCorrelativeStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkAutoCorrelativeStatistics: ...
...
class vtkBivariateLinearTableThreshold(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @overload
    def AddLineEquation(
        self, p: MutableSequence[float], slope: float) -> None: ...
    ...
    @staticmethod
    def ComputeImplicitLineFunction(
        p: MutableSequence[float], slope: float, abc: MutableSequence[float]) -> None: ...

    def GetColumnRanges(self) -> Tuple[float, float]: ...
    def GetColumnToThreshold(self, idx: int, column: int,
                             component: int) -> None: ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSelectedRowIds(
        self, selection: int = 0) -> vtkmodules.vtkCommonCore.vtkIdTypeArray: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkBivariateLinearTableThreshold: ...
...
class vtkComputeQuantiles(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkComputeQuantiles: ...
...
class vtkComputeQuartiles(vtkComputeQuantiles):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkComputeQuartiles: ...
...
class vtkContingencyStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkContingencyStatistics: ...
...
class vtkCorrelativeStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkCorrelativeStatistics: ...
...
class vtkDescriptiveStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkDescriptiveStatistics: ...
...
class vtkExtractFunctionalBagPlot(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExtractFunctionalBagPlot: ...
...
class vtkExtractHistogram(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkExtractHistogram: ...
...
class vtkHighestDensityRegionsStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkHighestDensityRegionsStatistics: ...

    def SetSigma(self, sigma: float) -> None: ...
    def SetSigmaMatrix(self, s11: float, s12: float,
                       s21: float, s22: float) -> None: ...
...
class vtkKMeansDistanceFunctor(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetEmptyTuple(
        self, dimension: int) -> vtkmodules.vtkCommonCore.vtkVariantArray: ...
    ...
    def PackElements(self, curTable: vtkmodules.vtkCommonDataModel.vtkTable,
                     vElements: Pointer) -> None: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkKMeansDistanceFunctor: ...
    ...
    def UnPackElements(
        ...
        vLocalElements: Pointer,
        vGlobalElements: Pointer,
        np: int,
    ) -> None: ...

    @overload
    def UnPackElements(
        self, curTable: vtkmodules.vtkCommonDataModel.vtkTable, vLocalElements: Pointer, numRows: int, numCols: int
    ) -> None: ...


class vtkKMeansDistanceFunctorCalculator(vtkKMeansDistanceFunctor):
    def GetDistanceExpression(self) -> str: ...
    def GetFunctionParser(
        self) -> vtkmodules.vtkCommonMisc.vtkFunctionParser: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkKMeansDistanceFunctorCalculator: ...

    def SetDistanceExpression(self, _arg: str) -> None: ...
    def SetFunctionParser(
        self, __a: vtkmodules.vtkCommonMisc.vtkFunctionParser) -> None: ...
...
class vtkKMeansStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkKMeansStatistics: ...
...
class vtkLengthDistribution(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkLengthDistribution: ...
...
class vtkMultiCorrelativeStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkMultiCorrelativeStatistics: ...
...
class vtkOrderStatistics(vtkStatisticsAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOrderStatistics: ...
...
class vtkPCAStatistics(vtkMultiCorrelativeStatistics):
    ...
    @overload
    def GetEigenvalues(
        self, request: int, __b: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...

    @overload
    def GetEigenvalues(
        self, __a: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...

    @overload
    def GetEigenvector(
        self, i: int, eigenvector: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...

    @overload
    def GetEigenvector(self, request: int, i: int,
                       eigenvector: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...

    @overload
    def GetEigenvectors(
        self, request: int, eigenvectors: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...

    @overload
    def GetEigenvectors(
        self, eigenvectors: vtkmodules.vtkCommonCore.vtkDoubleArray) -> None: ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type: str) -> int: ...
    def GetSpecifiedNormalization(
        self) -> vtkmodules.vtkCommonDataModel.vtkTable: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkPCAStatistics: ...
...
class vtkStrahlerMetric(vtkmodules.vtkCommonExecutionModel.vtkTreeAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStrahlerMetric: ...
...
class vtkStreamingStatistics(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkStreamingStatistics: ...
