...
class vtkImporter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImporter: ...
...
class vtk3DSImporter(vtkImporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtk3DSImporter: ...
...
class vtkGLTFImporter(vtkImporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGLTFImporter: ...
...
class vtkOBJImporter(vtkImporter):
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOBJImporter: ...
...
class vtkVRMLImporter(vtkImporter):
    ...
    def GetVRMLDEFObject(
        self, name: str) -> vtkmodules.vtkCommonCore.vtkObject: ...
    ...
    @staticmethod
    def SafeDownCast(
        o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRMLImporter: ...
