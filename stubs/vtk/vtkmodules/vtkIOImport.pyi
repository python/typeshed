...
class vtk3DSColour_t:
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __a: vtk3DSColour_t) -> None: ...

class vtk3DSColour_t_24:
    @overload
    def __init__(self) -> None: ...
    @overload
...
class vtkImporter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetTemporalInformation(
        self,
        animationIndex: int,
        frameRate: float,
        nbTimeSteps: int,
        timeRange: MutableSequence[float],
        timeSteps: vtkmodules.vtkCommonCore.vtkDoubleArray,
    ) -> bool: ...
    ...
    def Read(self) -> None: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkImporter: ...
...
class vtk3DSImporter(vtkImporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtk3DSImporter: ...
...
class vtk3DSMatProp_t:
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __a: vtk3DSMatProp_t) -> None: ...

class vtk3DSMaterial_t:
    @overload
    def __init__(self) -> None: ...
    @overload
...
class vtkGLTFImporter(vtkImporter):
    ...
    def EnableAnimation(self, animationIndex: int) -> None: ...
    def GetAnimationName(self, animationIndex: int) -> str: ...
    def GetCamera(self, id: int) -> vtkmodules.vtkRenderingCore.vtkCamera: ...
    def GetCameraName(self, camIndex: int) -> str: ...
    def GetFileName(self) -> str: ...
    def GetNumberOfAnimations(self) -> int: ...
    def GetNumberOfCameras(self) -> int: ...
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkGLTFImporter: ...
    def SetCamera(self, camIndex: int) -> None: ...
    def SetFileName(self, _arg: str) -> None: ...
    def UpdateTimeStep(self, timestep: float) -> None: ...
...
class vtkOBJImporter(vtkImporter):
    ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkOBJImporter: ...
...
class vtkVRMLImporter(vtkImporter):
    ...
    def GetVRMLDEFObject(self, name: str) -> vtkmodules.vtkCommonCore.vtkObject: ...
    def IsA(self, type: str) -> int: ...
    @staticmethod
    def IsTypeOf(type: str) -> int: ...
    def NewInstance(self) -> vtkVRMLImporter: ...
    @staticmethod
    def SafeDownCast(o: vtkmodules.vtkCommonCore.vtkObjectBase) -> vtkVRMLImporter: ...
    def SetFileName(self, _arg: str) -> None: ...
