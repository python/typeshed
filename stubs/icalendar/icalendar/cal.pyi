...
class Component(CaselessDict[Incomplete]):
    ...
    @overload
    def add(
        self, name: str, value: Any, parameters: SupportsItems[str, str | None] | None = None, encode: bool = True
    ) -> None: ...
    ...
    @classmethod
    def from_ical(cls, st: str, multiple: bool = False) -> Component: ...  # or any of its subclasses
