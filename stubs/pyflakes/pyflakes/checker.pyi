...
class Checker:
    ...
    def NAMEDEXPR(self, node: _NamedExpr, tree, omit: _OmitType = ...) -> None: ...
    ...
    def MATCH(self, node: _Match, tree, omit: _OmitType = ...) -> None: ...
    def MATCH_CASE(self, node: _MatchCase, tree, omit: _OmitType = ...) -> None: ...
    def MATCHCLASS(self, node: _MatchClass, tree, omit: _OmitType = ...) -> None: ...
    def MATCHOR(self, node: _MatchOr, tree, omit: _OmitType = ...) -> None: ...
    def MATCHSEQUENCE(self, node: _MatchSequence, tree, omit: _OmitType = ...) -> None: ...
    def MATCHSINGLETON(self, node: _MatchSingleton, tree, omit: _OmitType = ...) -> None: ...
    def MATCHVALUE(self, node: _MatchValue, tree, omit: _OmitType = ...) -> None: ...
