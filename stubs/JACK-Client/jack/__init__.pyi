...
class Client:
    ...
    def set_shutdown_callback(self, callback: Callable[[Status, str], Any]) -> None: ...
    def set_process_callback(self, callback: Callable[[int], Any]) -> None: ...
    def set_freewheel_callback(self, callback: Callable[[bool], Any]) -> None: ...
    def set_blocksize_callback(self, callback: Callable[[int], Any]) -> None: ...
    def set_samplerate_callback(self, callback: Callable[[int], Any]) -> None: ...
    def set_client_registration_callback(self, callback: Callable[[str, bool], Any]) -> None: ...
    def set_port_registration_callback(
        self, callback: Callable[[Port, bool], Any] | None = ..., only_available: bool = ...
    ) -> None: ...
    def set_port_connect_callback(
        self, callback: Callable[[Port, Port, bool], Any] | None = ..., only_available: bool = ...
    ) -> None: ...
    def set_port_rename_callback(
        self, callback: Callable[[Port, str, str], Any] | None = ..., only_available: bool = ...
    ) -> None: ...
    def set_graph_order_callback(self, callback: Callable[[], Any]) -> None: ...
    def set_xrun_callback(self, callback: Callable[[float], Any]) -> None: ...
    def set_sync_callback(self, callback: Callable[[int, _JackPositionT], Any] | None) -> None: ...
    def release_timebase(self) -> None: ...
    def set_timebase_callback(
        self, callback: Callable[[int, int, _JackPositionT, bool], Any] | None = ..., conditional: bool = ...
    ) -> bool: ...
    def set_property_change_callback(self, callback: Callable[[int, str, int], Any]) -> None: ...
...
def set_error_function(callback: Callable[[str], Any] | None = ...) -> None: ...
def set_info_function(callback: Callable[[str], Any] | None = ...) -> None: ...
