...
def setdefaultproxy(*args, **kwargs) -> None: ...
...
class socksocket(_BaseSocket):
    ...
    def __init__(
        self, family: socket.AddressFamily = ..., type: socket.SocketKind = ..., proto: int = 0, *args, **kwargs
    ) -> None: ...
    ...
    def setproxy(self, *args, **kwargs) -> None: ...
    def bind(self, *pos, **kw) -> None: ...
    def sendto(self, bytes: ReadableBuffer, *args, **kwargs) -> int: ...
    def send(self, bytes: ReadableBuffer, flags: int = 0, **kwargs) -> int: ...
    def recvfrom(self, bufsize: int, flags: int = 0) -> tuple[bytes, _Endpoint]: ...
    def recv(self, *pos, **kw) -> bytes: ...
    def close(self) -> None: ...
