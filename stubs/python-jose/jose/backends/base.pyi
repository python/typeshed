...
class Key:
    ...
    def decrypt(self, cipher_text: str | bytes, iv: str | bytes | None = ..., aad: bytes | None = ..., tag: bytes = ...) -> bytes: ...
    def wrap_key(self, key_data: str | bytes) -> bytes: ...
    def unwrap_key(self, wrapped_key: str | bytes) -> bytes: ...
