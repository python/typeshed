...
class Connection(AbstractBase, metaclass=abc.ABCMeta):
    ...
    def add_on_connection_blocked_callback(self: Self, callback: Callable[[Self, Method[SpecConnection.Blocked]], object]) -> None: ...
    def add_on_connection_unblocked_callback(self: Self, callback: Callable[[Self, Method[SpecConnection.Unblocked]], object]) -> None: ...
