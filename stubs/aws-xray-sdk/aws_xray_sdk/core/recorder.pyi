...
class AWSXRayRecorder:
    ...
    def in_segment(self, name: str | None = ..., **segment_kwargs) -> Segment: ...
    def in_subsegment(self, name: str | None = ..., **subsegment_kwargs) -> Subsegment: ...
    def begin_segment(
    ...
    def current_subsegment(self) -> Subsegment | None: ...
