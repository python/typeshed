...
class NonCallableMock(Base, Any):  # type: ignore
    ...
    if sys.version_info >= (3, 8):
        ...
        def assert_called_with(_mocked_self, *args: Any, **kwargs: Any) -> None: ...
        def assert_not_called(_mocked_self) -> None: ...
        def assert_called_once_with(_mocked_self, *args: Any, **kwargs: Any) -> None: ...

    if sys.version_info >= (3, 8):
        def assert_called_once(self) -> None: ...
    elif sys.version_info >= (3, 6):
        def assert_called_once(_mocked_self) -> None: ...
