...
def want_bytes(s: Union[str, bytes], encoding: str = ..., errors: str = ...) -> bytes: ...
def is_text_serializer(serializer: _serializer) -> bool: ...
def constant_time_compare(val1: _C, val2: _C) -> bool: ...
...
def bytes_to_int(bytestr: Union[str, bytes]) -> bytes: ...

class SigningAlgorithm(object):
    def get_signature(self, key: bytes, value: bytes) -> bytes: ...
    def verify_signature(self, key: bytes, value: bytes, sig: Union[bytes, str]) -> bool: ...
...
class Signer(object):
    ...
    def __init__(self, secret_key: Union[str, bytes], salt: Optional[Union[str, bytes]] = ...,
    ...
    def verify_signature(self, value: bytes, sig: Union[str, bytes]) -> bool: ...
    def unsign(self, signed_value: bytes) -> bytes: ...
    def validate(self, signed_value: Union[str, bytes]) -> bool: ...

class TimestampSigner(Signer):
    def get_timestamp(self) -> int: ...
    def timestamp_to_datetime(self, ts: int) -> datetime: ...
    def sign(self, value: bytes) -> bytes: ...
    def unsign(self, value: Union[str, bytes], max_age: Optional[int] = ..., return_timestamp: bool = ...) -> Any: ...
    def validate(self, signed_value: Union[str, bytes], max_age: Optional[int] = ...) -> bool: ...
...
class Serializer(object):
    ...
    def make_signer(self, salt: Optional[Union[str, bytes]] = ...) -> Signer: ...
    def dumps(self, obj: Any, salt: Optional[Union[str, bytes]] = ...) -> Any: ...  # morally -> Union[str, bytes]
    def dump(self, obj: Any, f: IO[Any], salt: Optional[Union[str, bytes]] = ...) -> None: ...
    def loads(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ...) -> Any: ...
    def load(self, f: IO[Any], salt: Optional[Union[str, bytes]] = ...): ...
    def loads_unsafe(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ...) -> Tuple[bool, Any]: ...
    def load_unsafe(self, f: IO[Any], *args, **kwargs) -> Tuple[bool, Any]: ...

class TimedSerializer(Serializer):
    default_signer = ...  # type: Callable[..., TimestampSigner]
    def loads(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ..., max_age: Optional[int] = ...,
              return_timestamp: bool = ...) -> Any: ...
    def loads_unsafe(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ...,
...
class JSONWebSignatureSerializer(Serializer):
    ...
    def make_signer(self, salt: Optional[Union[str, bytes]] = ..., algorithm_name: Optional[str] = ...) -> Signer: ...
    def make_header(self, header_fields: Optional[MutableMapping]) -> MutableMapping: ...
    def dumps(self, obj: Any, salt: Optional[Union[str, bytes]] = ..., header_fields: Optional[MutableMapping] = ...) -> str: ...
    def loads(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ..., return_header: bool = ...) -> Any: ...
    def loads_unsafe(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ...,
...
class TimedJSONWebSignatureSerializer(JSONWebSignatureSerializer):
    ...
    expires_in = ...  # type: int
    def __init__(self, secret_key: Union[str, bytes], expires_in: Optional[int] = ..., **kwargs) -> None: ...
    def make_header(self, header_fields=Optional[MutableMapping]) -> MutableMapping: ...
    def loads(self, s: Union[str, bytes], salt: Optional[Union[str, bytes]] = ..., return_header: bool = ...) -> Any: ...
...
class _URLSafeSerializerMixin(object):
    def load_payload(self, payload: Any, serializer: Any = ..., *args: Any, **kwargs: Any) -> Any: ...
    def dump_payload(self, *args, **kwargs) -> bytes: ...
