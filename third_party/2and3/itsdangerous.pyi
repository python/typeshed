...
class Serializer(object):
    ...
    def loads(self, s: Union[Text, bytes], salt: Optional[Union[Text, bytes]] = ...) -> Optional[Exception]: ...
    def load(self, f: IO[Any], salt: Optional[Union[Text, bytes]] = ...) -> Optional[Exception]: ...
