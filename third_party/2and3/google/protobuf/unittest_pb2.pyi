...
class TestIsInitialized(Message):
    class SubMessage(Message):
        class SubGroup(Message):
            ...
            @classmethod
            def FromString(cls, s: bytes) -> TestIsInitialized.SubMessage.SubGroup: ...
        @property
...
class TestNestedMessageHasBits(Message):
    class NestedMessage(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestNestedMessageHasBits.NestedMessage: ...
    @property
...
class TestExtensionOrderings2(Message):
    class TestExtensionOrderings3(Message):
        ...
        def __init__(self, my_string: Optional[Text] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestExtensionOrderings2.TestExtensionOrderings3: ...
    my_string: Text
    def __init__(self, my_string: Optional[Text] = ...) -> None: ...
    @classmethod
...
class TestDynamicExtensions(Message):
    ...
    class DynamicMessageType(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestDynamicExtensions.DynamicMessageType: ...
...
class TestParsingMerge(Message):
    class RepeatedFieldsGenerator(Message):
        class Group1(Message):
            ...
            @classmethod
            def FromString(cls, s: bytes) -> TestParsingMerge.RepeatedFieldsGenerator.Group1: ...
        class Group2(Message):
            @property
            def field1(self) -> TestAllTypes: ...
            def __init__(self, field1: Optional[TestAllTypes] = ...) -> None: ...
            @classmethod
            def FromString(cls, s: bytes) -> TestParsingMerge.RepeatedFieldsGenerator.Group2: ...
        @property
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestParsingMerge.RepeatedFieldsGenerator: ...
    class OptionalGroup(Message):
        @property
...
class TestHugeFieldNumbers(Message):
    ...
    class StringStringMapEntry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestHugeFieldNumbers.StringStringMapEntry: ...
    optional_int32: int
    fixed_32: int
    repeated_int32: RepeatedScalarFieldContainer[int]
    packed_int32: RepeatedScalarFieldContainer[int]
