...
class MyMessage(google___protobuf___message___Message):
    ...
    repeated_packed_unexpected_e: google___protobuf___internal___containers___RepeatedScalarFieldContainer[type___MyEnumValue] = ...
    ...
    def __init__(self,
        *,
        ...
        repeated_packed_unexpected_e : typing___Optional[typing___Iterable[type___MyEnumValue]] = None,
        oneof_e_1 : typing___Optional[type___MyEnumValue] = None,
        oneof_e_2 : typing___Optional[type___MyEnumValue] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"e",b"e",u"o",b"o",u"oneof_e_1",b"oneof_e_1",u"oneof_e_2",b"oneof_e_2"]) -> builtin___bool: ...
