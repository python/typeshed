...
class TestAllTypesProto2(Message):
    ...
    class MapInt32Int32Entry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapInt32Int32Entry: ...
    class MapInt64Int64Entry(Message):
        key: int
        value: int
        def __init__(self, key: Optional[int] = ..., value: Optional[int] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapInt64Int64Entry: ...
    class MapUint32Uint32Entry(Message):
        key: int
        value: int
        def __init__(self, key: Optional[int] = ..., value: Optional[int] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapUint32Uint32Entry: ...
    ...
    class MapSint32Sint32Entry(Message):
        ...
        def __init__(self, key: Optional[int] = ..., value: Optional[int] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapSint32Sint32Entry: ...
    class MapSint64Sint64Entry(Message):
        key: int
        value: int
        def __init__(self, key: Optional[int] = ..., value: Optional[int] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapSint64Sint64Entry: ...
    class MapFixed32Fixed32Entry(Message):
        key: int
        value: int
        def __init__(self, key: Optional[int] = ..., value: Optional[int] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapFixed32Fixed32Entry: ...
    ...
    class MapInt32DoubleEntry(Message):
        ...
        def __init__(self, key: Optional[int] = ..., value: Optional[float] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapInt32DoubleEntry: ...
    ...
    class MapStringBytesEntry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapStringBytesEntry: ...
    class MapStringNestedMessageEntry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapStringNestedMessageEntry: ...
    class MapStringForeignMessageEntry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapStringForeignMessageEntry: ...
    class MapStringNestedEnumEntry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapStringNestedEnumEntry: ...
    class MapStringForeignEnumEntry(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MapStringForeignEnumEntry: ...
    class Data(Message):
        group_int32: int
        group_uint32: int
    ...
    class MessageSetCorrect(Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> TestAllTypesProto2.MessageSetCorrect: ...
    class MessageSetCorrectExtension1(Message):
        bytes: Text
        def __init__(self, bytes: Optional[Text] = ...) -> None: ...
        @classmethod
        def FromString(cls, s: builtins.bytes) -> TestAllTypesProto2.MessageSetCorrectExtension1: ...
