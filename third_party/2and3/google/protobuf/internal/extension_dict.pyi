...
class _ExtensionDict(Generic[_ContainerMessageT]):
    ...
    @overload
    def __delitem__(self, extension_handle: _ExtensionFieldDescriptor[_ContainerMessageT, Any]) -> None: ...
    @overload
    def __delitem__(self, extension_handle: FieldDescriptor) -> None: ...
    @overload
    def __contains__(self, extension_handle: _ExtensionFieldDescriptor[_ContainerMessageT, Any]) -> bool: ...
    @overload
