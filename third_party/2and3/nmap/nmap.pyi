import sys
from typing import Callable, Dict, Iterator, List, Optional, Sequence, Text, Tuple, TypeVar
...
_T = TypeVar("_T")
_Callback = Callable[[str, _Result], None]
...
class PortScanner:
    def __init__(self, nmap_search_path: Sequence[str] = ...) -> None: ...
...
def __scan_progressive__(self, hosts: Text, ports: Text, arguments: Text, callback: _Callback, sudo: bool) -> None: ...
...
class PortScannerYield(PortScannerAsync):
    ...
    ) -> Iterator[Tuple[str, _Result]]: ...  # type: ignore
    def stop(self) -> None: ...
    def wait(self, timeout: Optional[int] = ...) -> None: ...
    def still_scanning(self) -> bool: ...
