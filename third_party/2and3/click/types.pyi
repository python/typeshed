...
class File(ParamType):
    ...
    def __call__(self, value: Optional[str], param: Optional[Parameter] = ..., ctx: Optional[Context] = ...) -> IO: ...
    def convert(self, value: str, param: Optional[Parameter], ctx: Optional[Context]) -> IO: ...
