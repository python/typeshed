...
def compute_hmac(key: bytes, message: bytes, digest_class: Any) -> bytes: ...
...
class Packetizer:
    ...
    def set_outbound_compressor(self, compressor: Callable[[bytes], bytes]) -> None: ...
    def set_inbound_compressor(self, compressor: Callable[[bytes], bytes]) -> None: ...
    def close(self) -> None: ...
    ...
    def set_keepalive(self, interval: int, callback: Callable[[], Any]) -> None: ...
