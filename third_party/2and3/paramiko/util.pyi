...
from typing import IO, AnyStr, Callable, Generic, List, Optional, Text, Type, TypeVar
...
def generate_key_bytes(hash_alg: _Hash, salt: bytes, key: bytes, nbytes: int) -> bytes: ...
def load_host_keys(filename: str) -> SSHConfig: ...
