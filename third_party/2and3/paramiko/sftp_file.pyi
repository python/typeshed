...
class SFTPFile(BufferedFile):
    ...
    handle: SFTPHandle
    pipelined: bool
    def __init__(self, sftp: SFTPClient, handle: SFTPHandle, mode: str = ..., bufsize: int = ...) -> None: ...
    ...
    def check(self, hash_algorithm: str, offset: int = ..., length: int = ..., block_size: int = ...) -> str: ...
