...
@overload
def parse_options_header(value: Optional[_Str], multiple: bool = ...) -> Tuple[_Str, Dict[_Str, Optional[_Str]]]: ...
@overload
...
def parse_age(value: Any = ...) -> Optional[timedelta]: ...
...
def is_resource_modified(environ: WSGIEnvironment, etag: Optional[Text] = ..., data: Optional[_ETagData] = ...,
                         last_modified: Optional[Text] = ..., ignore_if_range: bool = ...) -> bool: ...
def remove_entity_headers(headers: Union[List[Tuple[Text, Text]], Headers], allowed: Iterable[str] = ...) -> None: ...
...
@overload
def parse_cookie(header: Union[None, WSGIEnvironment, Text, bytes], charset: str = ...,
                 errors: str = ...) -> TypeConversionDict: ...
@overload
def parse_cookie(header: Union[None, WSGIEnvironment, Text, bytes], charset: str = ...,
                 errors: str = ..., cls: Optional[Callable[[Iterable[Tuple[Text, Text]]], _T]] = ...) -> _T: ...
def dump_cookie(key: _ToBytes, value: _ToBytes = ..., max_age: Union[None, float, timedelta] = ...,
                ...
                domain: Union[None, str, bytes] = ..., secure: bool = ..., httponly: bool = ..., charset: str = ...,
                sync_expires: bool = ...) -> bytes: ...
