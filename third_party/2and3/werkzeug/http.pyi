...
def unquote_header_value(value: _S, is_filename: bool = ...) -> _S: ...
def dump_options_header(header: Optional[_S], options: Mapping[_S, Any]) -> _S: ...
def dump_header(iterable: Union[Iterable[Any], Dict[_S, Any]], allow_token: bool = ...) -> _S: ...
def parse_list_header(value: _S) -> List[_S]: ...
@overload
...
@overload
def parse_options_header(value: _S) -> Tuple[_S, Dict[_S, Optional[_S]]]: ...
# actually returns Tuple[_S, Dict[_S, Optional[_S]], ...]
@overload
def parse_options_header(value: _S, multiple: bool = ...) -> Tuple[Any, ...]: ...
@overload
def parse_accept_header(value: Optional[Text]) -> Accept: ...
@overload
def parse_accept_header(value: Optional[_S], cls: Callable[[Optional[_S]], _T]) -> _T: ...
@overload
...
def quote_etag(etag: _S, weak: bool = ...) -> _S: ...
def unquote_etag(etag: Optional[_S]) -> Tuple[Optional[_S], Optional[_S]]: ...
