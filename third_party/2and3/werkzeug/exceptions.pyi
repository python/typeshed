from typing import Any, Dict, NoReturn, Optional, Protocol, Type, Union
...
class HTTPException(Exception):
    ...
    @classmethod
    def wrap(cls: Any, exception: Type[Exception], name: Optional[str]=...) -> Any: ...
    @property
    def name(self) -> str: ...
    ...
    def __call__(self, environ: WSGIEnvironment, start_response: Any) -> Response: ...
