...
_OC = TypeVar('_OC', bound=Callable[[], Any])
_S = TypeVar('_S', bound=BaseResponse)
...
class BaseResponse:
    ...
    def call_on_close(self, func: _OC) -> _OC: ...
    @classmethod
    def force_type(cls: Type[_S], response: object, environ: Optional[WSGIEnvironment] = ...) -> _S: ...
    @classmethod
    def from_app(cls: Type[_S], app: Any, environ: WSGIEnvironment, buffered: bool = ...) -> _S: ...
    # TODO: once Literal types are supported, overload with as_text
