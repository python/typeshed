...
class TypeConversionDict(Dict[_K, _V]):
    ...
    @overload
    def get(self, key: None, *, type: None = ...) -> Optional[_V]: ...
    @overload
    def get(self, key: None, default: _D, type: None = ...) -> Union[_V, _D]: ...
    @overload
    def get(self, key: None, *, type: Callable[[_V], _R]) -> Optional[_R]: ...
    @overload
    def get(self, key: None, default: _D, type: Callable[[_V], _R]) -> Union[_R, _D]: ...
