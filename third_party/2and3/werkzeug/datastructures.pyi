import collections
from typing import Any, Optional, Mapping, Dict, TypeVar, Callable, overload
...
class TypeConversionDict(Dict[_K, _V]):
    ...
    def get(self, key: _K, default: _V, type: None = ...) -> _V: ...
    @overload
    def get(self, key: _K, default: Optional[_V] = ..., type: None = ...) -> Optional[_V]: ...
    @overload
    def get(self, key: _K, *, type: Callable[[_V], _T]) -> Optional[_T]: ...
    @overload
    def get(self, key: _K, default: None, type: Callable[[_V], _T]) -> Optional[_T]: ...
    @overload
    def get(self, key: _K, default: _T, type: Callable[[_V], _T]) -> _T: ...
