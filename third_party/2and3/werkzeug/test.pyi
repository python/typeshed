import sys
from typing import Any, Generic, Optional, Mapping, Text, Tuple, Type, TypeVar, Union, overload
...
class Client(Generic[_ResponseWrapper]):
    ...
    @overload
    def open(self, *args, **kwargs) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def get(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
            ...
            environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def get(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def patch(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
              ...
              environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def patch(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def post(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
             ...
             environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def post(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def head(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
             ...
             environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def head(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def put(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
            ...
            environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def put(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def delete(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
               ...
               environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def delete(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def options(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
                ...
                environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def options(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
    ...
    def trace(self, *args, buffered: Optional[bool] = ..., follow_redirects: Optional[bool] = ...,
              ...
              environ_base: Optional[Any] = ..., environ_overrides: Optional[Any] = ..., charset: Text = ...) -> _ResponseWrapper: ...
    @overload
    def trace(self, *args, **kw) -> Union[_ResponseWrapper, Tuple[Mapping[str, Any], _ResponseWrapper]]: ...
