from typing import Any, Dict, Iterable, Iterator, Mapping, MutableMapping, Optional, Text, Tuple, TypeVar, Union, Generic
...
class LookupDict(Dict[str, _VT]):
    ...
    def __getattr__(self, attr: Text) -> _VT: ...
    def __setattr__(self, attr: Text, value: _VT) -> None: ...
