...
def should_bypass_proxies(url, no_proxy: Iterable[AnyStr]) -> bool: ...
def get_environ_proxies(url, no_proxy: Iterable[AnyStr] = ...) -> Dict[Any, Any]: ...
def select_proxy(url, proxies: Dict[Any, Any]): ...
...
def check_header_validity(header: Tuple[AnyStr, ...]) -> None: ...
