...
class Context:
    ...
    def subquery(
        self,
    ) -> Any: ...  # TODO (dargueta): Figure out type of "self.state.subquery"
...
class Table(_HashableSource, BaseTable):
    ...
    def insert(
        self,
        insert: Union[Mapping[str, object], Iterable[Mapping[str, object]]],
        **kwargs: object,
    ): ...
    @overload
...
class Function(ColumnBase):
    ...
    def __init__(
        ...
        arguments: tuple,
        coerce: bool = ...,
        python_value: Optional[_TConvFunc] = ...,
    ): ...
...
def Case(
    ...
    expression_tuples: Iterable[Tuple[Expression, Any]],
    default: object = ...,
) -> NodeList: ...
...
class Select(SelectBase):
    ...
    def for_update(
        self,
        for_update: bool = ...,
        of: Optional[Union[Table, Iterable[Table]]] = ...,
        nowait: Optional[bool] = ...,
    ) -> Select: ...
...
class _WriteQuery(Query):
    ...
    def __init__(
        self,
        table: Table,
        returning: Optional[Iterable[Union[Type[Model], Field]]] = ...,
        **kwargs: object,
    ): ...
...
class IntegerField(Field):
    @overload
    def adapt(self, value: Union[int, str, float, bool]) -> int: ...  # type: ignore
    @overload
    def adapt(self, value: T) -> T: ...
...
class FloatField(Field):
    @overload
    def adapt(self, value: Union[str, int, float, bool]) -> float: ...  # type: ignore
    @overload
    def adapt(self, value: T) -> T: ...
...
class DecimalField(Field):
    ...
    @overload
    def db_value(self, value: Union[int, float, decimal.Decimal]) -> decimal.Decimal: ...  # type: ignore
    @overload
    def db_value(self, value: T) -> T: ...
    @overload
...
class BigBitFieldAccessor(FieldAccessor):
    ...
    def __set__(
        self,
        instance: Any,
        value: Union[memoryview, bytearray, BigBitFieldData, str, bytes],
    ) -> None: ...
...
class VirtualField(MetaField, Generic[_TField]):
    ...
    def __init__(
        self,
        field_class: Optional[Type[_TField]] = ...,
        *args: object,
        **kwargs: object,
    ): ...
    def db_value(self, value: object) -> Any: ...
...
class Model(Node, metaclass=ModelBase):
    ...
    def save(
        self,
        force_insert: bool = ...,
        only: Optional[Iterable[Union[str, Field]]] = ...,
...
class ModelSelect(BaseModelSelect, Select, Generic[_TModel]):
    ...
    def __init__(
        self,
        model: Type[_TModel],
        fields_or_models: Iterable[_TFieldOrModel],
        is_default: bool = ...,
    ): ...
...
class ManyToManyQuery(ModelSelect):
    def __init__(
        self,
        instance: Model,
        accessor: ManyToManyFieldAccessor,
        rel: _TFieldOrModel,
        *args: object,
        **kwargs: object,
    ): ...
    def add(
        self,
        value: Union[SelectQuery, Type[Model], Iterable[str]],
        clear_existing: bool = ...,
    ) -> None: ...
...
class PrefetchQuery(__PrefetchQuery):
    ...
    def store_instance(
        self,
        instance: Model,
        id_map: MutableMapping[Tuple[object, object], List[Model]],
    ) -> None: ...
