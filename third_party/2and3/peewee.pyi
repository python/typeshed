...
class CTE(_HashableSource, Source):
    def __init__(
                self, name: Any, query: Any, recursive: bool = ..., columns: Optional[Any] = ..., materialized: Optional[Any] = ...
    ) -> None: ...
...
class ColumnBase(Node):
    ...
    def get_sort_key(self, ctx: Any) -> Tuple[str]: ...
...
class ModelSelect(BaseModelSelect, Select):
    ...
    def join(
                self, dest: Any, join_type: str = ..., on: Optional[Any] = ..., src: Optional[Any] = ..., attr: Optional[Any] = ...
    ) -> None: ...
