...
class Node:
    ...
    @staticmethod
    def copy(method: Callable[[_F], _F]): ...
...
class Table(_HashableSource, BaseTable):
    ...
    def bind(self: _SelfT, database: Optional[Database] = ...) -> _SelfT: ...

    def bind_ctx(self, database: Optional[Any] = ...) -> _BoundTableContext: ...

    def select(self, *columns: Any) -> Select: ...

    def insert(self, insert: Optional[Any] = ..., columns: Optional[Any] = ..., **kwargs: Any) -> Insert: ...

    def replace(self, insert: Optional[Any] = ..., columns: Optional[Any] = ..., **kwargs: Any) -> Insert: ...

    def update(self, update: Optional[Any] = ..., **kwargs: Any) -> Update: ...
...
class WrappedNode(ColumnBase, Generic[_NodeLike]):
    ...
    def unwrap(self) -> _NodeLike: ...  # type: ignore[override]
...
class Ordering(WrappedNode):
    ...
    def __init__(
        self, node: ColumnBase, direction: _order, collation: Optional[str] = ...,
        nulls: Optional[_sort_nulls] = ...
    ) -> None: ...

    def collate(self, collation: Optional[str] = ...) -> Ordering: ...  # type: ignore[override]
...
class NodeList(ColumnBase, Generic[_NodeLike]):
    nodes: Iterator[_NodeLike]
    glue: str
    parens: bool

    def __init__(self, nodes: Iterator[_NodeLike], glue: str = ..., parens: bool = ...) -> None: ...

    def __sql__(self, ctx: Context) -> Context: ...


def Case(
    predicate: ColumnBase,
    expression_tuples: List[TupleT[Any, Any]],
    default: Optional[Any] = ...,
) -> NodeList[Union[ColumnBase]]: ...
...
class DQ(ColumnBase):
    ...
    def __invert__(self: _SelfT) -> _SelfT: ...  # type: ignore[override]
...
class Field(ColumnBase):
    ...
    default: Any
    primary_key: bool
    constraints: List[SQL]
    sequence: str
    collation: str
    unindexed: bool
    choices: list[TupleT[Any, Any]]
    help_text: str
    verbose_name: str
    index_type: str
    model: Model
    ...
    def bind(self, model: Model, name: str, set_attribute: bool = ...) -> None: ...
    ...
    def ddl(self, ctx: Context) -> NodeList[SQL]: ...
...
class BlobField(Field):
    ...
    def bind(self, model: Union[Model, Proxy], name: str, set_attribute: bool = ...) -> None: ...

    def db_value(self, value: Any) -> Optional[bytearray]: ...
...
class BitField(BitwiseMixin, BigIntegerField):
    ...
    def flag(self, value: Optional[int] = ...) -> FlagDescriptor: ...
...
class BinaryUUIDField(BlobField):
    ...
    def db_value(self, value: Any) -> bytearray: ...

    def python_value(self, value: Any) -> uuid.UUID: ...
...
class TimestampField(BigIntegerField):
    valid_resolutions: ClassVar[List[int]]
    resolution: int
    ticks_to_microsecond: bool
    utc: int

    def __init__(self, *args: Any, **kwargs: Any) -> None: ...

    def local_to_utc(self, dt: Any) -> datetime.datetime: ...

    def utc_to_local(self, dt: Any) -> datetime.datetime: ...

    def get_timestamp(self, value: Any) -> float: ...

    def db_value(self, value: Any) -> int: ...

    def python_value(self, value: Any) -> datetime.datetime: ...

    def from_timestamp(self) -> Function: ...
...
class IPField(BigIntegerField):
    def db_value(self, val: Any) -> Optional[int]: ...

    def python_value(self, val: Any) -> Optional[str]: ...
