...
class ObjectCursorWrapper(DictCursorWrapper, Generic[T]):
...
class SchemaManager:
    ...
    def __init__(self, model: Type[Model], database: Optional[Database] = None, **context_options: object): ...
    @property
...
class ModelSelect(BaseModelSelect, Select, Generic[_TModel]):
    ...
    def select(self, *fields_or_models: _TFieldOrModel) -> ModelSelect: ...
