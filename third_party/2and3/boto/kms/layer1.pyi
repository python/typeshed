...
class KMSConnection(AWSQueryConnection):
    ...
    def create_grant(self, key_id: str, grantee_principal: str, retiring_principal: Optional[str] = ..., operations: Optional[List[str]] = ..., constraints: Optional[Dict[Dict[str, str]]] = ..., grant_tokens: Optional[List[str]] = ...) -> Optional[Mapping[str, Any]]: ...
    ...
    def make_request(self, action: str, body: str): ...
