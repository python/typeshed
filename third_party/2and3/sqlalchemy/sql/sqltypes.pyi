...
from .elements import quoted_name as quoted_name, _defer_name as _defer_name, Slice as Slice, _literal_as_binds as _literal_as_binds
...
class ARRAY(Indexable, Concatenable, TypeEngine):
    ...
    class Comparator(Indexable.Comparator, Concatenable.Comparator):
        def any(self, elements, other, operator: Optional[Any] = ...): ...
        def all(self, elements, other, operator: Optional[Any] = ...): ...
    comparator_factory = ...  # type: Any
    item_type = ...  # type: Any
    as_tuple = ...  # type: Any
    dimensions = ...  # type: Any
