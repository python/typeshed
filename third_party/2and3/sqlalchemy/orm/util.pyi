...
class AliasedClass:
    __name__ = ...  # type: Any
    def __init__(self, cls, alias: Optional[Any] = ..., name: Optional[Any] = ..., flat: bool = ..., adapt_on_names: bool = ..., with_polymorphic_mappers: Any = ..., with_polymorphic_discriminator: Optional[Any] = ..., base_alias: Optional[Any] = ..., use_mapper_path: bool = ...) -> None: ...
...
def aliased(element, alias: Optional[Any] = ..., name: Optional[Any] = ..., flat: bool = ..., adapt_on_names: bool = ...): ...
