...
from .util import CascadeOptions as CascadeOptions, _orm_annotate as _orm_annotate, _orm_deannotate as _orm_deannotate
from ..sql.util import ClauseAdapter as ClauseAdapter, join_condition as join_condition, _shallow_annotate as _shallow_annotate, visit_binary_product as visit_binary_product, _deep_deannotate as _deep_deannotate, selectables_overlap as selectables_overlap, adapt_criterion_to_null as adapt_criterion_to_null
...
class RelationshipProperty(StrategizedProperty):
    ...
    def cascade_iterator(self, type_, state, dict_, visited_states, halt_on: Optional[Any] = ...): ...
    def mapper(self): ...
    def table(self): ...
    def do_init(self): ...
