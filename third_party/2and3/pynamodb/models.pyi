...
class Model(metaclass=MetaModel):
    ...
    @classmethod
    def batch_get(cls: Type[_T], items: List[Union[KeyType, Iterable[KeyType]]], consistent_read: Optional[bool] = ..., attributes_to_get: Optional[List[Text]] = ...) -> Iterable[_T]: ...
    @classmethod
    ...
    @classmethod
    def query(cls: Type[_T], hash_key: KeyType, consistent_read: bool = ..., index_name: Optional[Text] = ..., scan_index_forward: Optional[Any] = ..., conditional_operator: Optional[Text] = ..., limit: Optional[int] = ..., last_evaluated_key: Optional[Any] = ..., attributes_to_get: Optional[Iterable[Text]] = ..., page_size: Optional[int] = ..., **filters) -> Iterable[_T]: ...
    @classmethod
    def scan(cls: Type[_T], segment: Optional[Any] = ..., total_segments: Optional[Any] = ..., limit: Optional[int] = ..., conditional_operator: Optional[Text] = ..., last_evaluated_key: Optional[Any] = ..., page_size: Optional[int] = ..., **filters) -> Iterable[_T]: ...
    @classmethod
