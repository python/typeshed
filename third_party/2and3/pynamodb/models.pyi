...
class Model(metaclass=MetaModel):
    ...
    @classmethod
    def batch_get(cls: Type[_T], items: Iterable[Union[KeyType, Iterable[KeyType]]], consistent_read: Optional[bool] = ..., attributes_to_get: Optional[List[Text]] = ...) -> Iterator[_T]: ...
    @classmethod
    ...
    @classmethod
    def scan(cls: Type[_T], segment: Optional[Any] = ..., total_segments: Optional[Any] = ..., limit: Optional[int] = ..., conditional_operator: Optional[Text] = ..., last_evaluated_key: Optional[Any] = ..., page_size: Optional[int] = ..., **filters) -> Iterator[_T]: ...
    @classmethod
