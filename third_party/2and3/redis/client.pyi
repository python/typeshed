...
from typing import Any, Optional, Text, Dict, Union, Callable, Type, TypeVar, Iterable, AnyStr
...
class StrictRedis:
    ...
    def hmget(self, name: str, keys: Union[AnyStr, Iterable[AnyStr]], *args: AnyStr): ...
