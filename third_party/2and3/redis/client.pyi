...
_InputValue = Union[bytes, Text, int, float]
SYM_EMPTY: Any
...
class Redis(object):
    ...
    def unwatch(self): ...
    def blpop(self, keys: Union[Text, Iterable[Text]], timeout: int = ...) -> Optional[Tuple[bytes, bytes]]: ...
    def brpop(self, keys: Union[Text, Iterable[Text]], timeout: int = ...) -> Optional[Tuple[bytes, bytes]]: ...
    def brpoplpush(self, src, dst, timeout=...): ...
    def lindex(self, name, index): ...
    def linsert(self, name, where, refvalue, value): ...
    def llen(self, name): ...
    def lpop(self, name): ...
    def lpush(self, name: Text, *values: Text) -> int: ...
    ...
    def rpush(self, name: Text, *values: Text) -> int: ...
    ...
    def hvals(self, name): ...
    def publish(self, channel: Text, message: _InputValue) -> int: ...
