...
class Redis(object):
    ...
    def hdel(self, name: _Key, *keys: Iterable[_Key]) -> int: ...
    ...
    def hmset(self, name: _Key, mapping: Dict[_Str, _Str]) -> bool: ...
    def hmget(self, name: _Key, keys: Iterable[_Key], *args: Iterable[_Key]) -> List[Optional[bytes]]: ...
