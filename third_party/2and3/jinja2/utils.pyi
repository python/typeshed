from typing import Any, Callable, Io, Iterable, Optional, TypeVar
...
def contextfunction(f: Callable[..., T]) -> ContextFunction: ...
def evalcontextfunction(f: Callable[..., T]) -> EvalContextFunction: ...
def environmentfunction(f: Callable[..., T]) -> EnvironmentFunction: ...
def internalcode(f, Callable[..., T]) -> Callable[..., T]: ...
...
def import_string(import_name: str, silent: bool = ...): ...
