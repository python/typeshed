...
class Environment:
    ...
    def install_gettext_translations(self, translations: Any, newstyle: Optional[bool] = None): ...
    def install_null_translations(self, newstyle: Optional[bool] = None): ...
    def install_gettext_callables(self, gettext: Callable[..., Any], ngettext: Callable[..., Any], newstyle: Optional[bool] = None): ...
