...
text_type = str
binary_type = bytes
binary_input_type = Union[binary_type, bytearray]
...
def byte2int(bs: binary_input_type) -> int: ...
def indexbytes(buf: binary_input_type, i: int) -> int: ...
def iterbytes(buf: binary_input_type) -> typing.Iterator[int]: ...
