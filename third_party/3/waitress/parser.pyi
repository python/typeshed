...
from waitress.utilities import BadRequest, RequestEntityTooLarge, RequestHeaderFieldsTooLarge, ServerNotImplemented, find_double_newline, Error
...
def get_header_lines(header: bytes) -> List[bytes]: ...
