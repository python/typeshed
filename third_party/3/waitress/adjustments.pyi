...
from typing import Any, Mapping, Sequence, Optional, Set, Tuple, Union
...
def aslist_cronly(value: str) -> Sequence[str]: ...
def aslist(value: str) -> Sequence[str]: ...
def asset(value: str) -> Set[str]: ...
def slash_fixed_str(s: str) -> str: ...
def str_iftruthy(s: str) -> Optional[str]: ...
def as_socket_list(sockets: Sequence[Any]) -> Sequence[SocketType]: ...
...
class Adjustments:
    ...
    ipv4: bool = ...
    ipv6: bool = ...
    sockets: Sequence[SocketType] = ...
    def __init__(self, **kw: str) -> None: ...
    @classmethod
    def parse_args(cls, argv: str) -> Tuple[Mapping[str, Any], Any]: ...
    @classmethod
    def check_sockets(cls, sockets: Sequence[SocketType]) -> None: ...
