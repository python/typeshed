...
socket_map: Dict[int, SocketType]
map: Dict[int, SocketType]
...
def poll(timeout: float = ..., map: Optional[Dict[int, SocketType]] = ...) -> None: ...
def poll2(timeout: float = ..., map: Optional[Dict[int, SocketType]] = ...) -> None: ...
poll3 = poll2

def loop(timeout: float = ..., use_poll: bool = ..., map: Optional[Dict[int, SocketType]] = ..., count: Optional[int] = ...) -> None: ...
...
class dispatcher:
    ...
    def __init__(self, sock: Optional[SocketType] = ..., map: Optional[Dict[int, SocketType]] = ...) -> None: ...
    ...
    def set_socket(self, sock: SocketType, map: Optional[Dict[int, SocketType]] = ...) -> None: ...
...
def close_all(map: Optional[Dict[int, SocketType]] = ..., ignore_all: bool = ...) -> None: ...
...
class file_dispatcher(dispatcher):
    connected: bool = ...
    def __init__(self, fd: BytesIO, map: Optional[Dict[int, SocketType]] = ...) -> None: ...
    socket: SocketType = ...
