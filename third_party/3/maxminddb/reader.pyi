...
class Reader:
    ...
    def get(self, ip_address: Union[IPv4Address, IPv6Address]) -> Any: ...
    def close(self) -> None: ...
    def __enter__(self) -> 'Reader': ...
    def __exit__(self, exc_type: Optional[Type[BaseException]] = None, exc_val: Optional[BaseException] = None, exc_tb: Optional[TracebackType] = None) -> None: ...
