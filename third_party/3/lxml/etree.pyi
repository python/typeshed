...
class _Element(Iterable['_Element']):
    ...
    def clear(self) -> None: ...
    def get(self, key: _AnyStr, default: Optional[_AnyStr] = None) -> _AnyStr: ...
    def xpath(self, _path: _AnyStr, namespaces: Optional[_DictAnyStr] = None, extensions: Any = None, smart_strings: bool = True, **_variables) -> Any: ...
