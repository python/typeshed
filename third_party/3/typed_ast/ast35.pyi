...
def parse(source: Union[str, bytes], filename: Union[str, bytes] = '<unknown>', mode: str = 'exec') -> AST: ...
def copy_location(new_node: AST, old_node: AST) -> AST: ...
def dump(node: AST, annotate_fields: bool = True, include_attributes: bool = True) -> str: ...
def fix_missing_locations(node: AST) -> AST: ...
def get_docstring(node: AST, clean: bool = True) -> str: ...
