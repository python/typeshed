...
class AsyncBufferedIOBase(AsyncBase[bytes], Generic[_FileName]):
...
class AsyncBufferedReader(AsyncBufferedIOBase, Generic[_FileName]):
    async def peek(self, __size: int = ...) -> bytes: ...
    @property
    def name(self) -> _FileName: ...

class AsyncFileIO(AsyncBase[bytes], Generic[_FileName]):
    async def close(self) -> None: ...
    async def flush(self) -> None: ...
    async def isatty(self) -> bool: ...
    async def read(self, __size: int = ...) -> Optional[bytes]: ...
